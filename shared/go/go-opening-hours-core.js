 ...
 */
export function parseGoOpeningHours(raw) {
...
export function resolveGoOpeningWindowsForDay(parsed, weekday = "") {
...
export function readGoOpeningWindows(record = {}, weekday = "") {
