...
import { GO_PARTY_SIZE_MAX, GO_PARTY_SIZE_MIN } from "./go-feature-config.js";

export const GO_COMMISSION_CURRENCY = "EUR";
...
export const GO_COMMISSION_VERSION = "2026-08";
...
export function isGoCommissionVersion(value = "") {
 ...
 */
export function resolveGoCommissionVersion(version = "") {
 ...
 */
export function goCommissionCents(partySize = 1, version = GO_COMMISSION_VERSION) {
 ...
 */
export function resolveGoCommission({ partySize = 1, version = "" } = {}) {
 ...
 * trennt das Komma.
 */
export function formatGoCommission(amountCents = 0) {
 ...
 */
export function sumGoCommissionCents(entries = []) {
