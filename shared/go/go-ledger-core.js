...
export const GO_LEDGER_COLLECTION = "goLedger";

export const GO_LEDGER_KIND = Object.freeze({
  charge: "charge",
  payment: "payment",
...
export const GO_PAYMENT_METHODS = Object.freeze(["cash", "bank", "other"]);

export function normalizeGoPaymentMethod(value = "") {
 ...
 */
export function buildGoChargeEntry({
  restaurantId = "",
  bookingId = "",
  amountCents = 0,
  commissionVersion = "",
 ...
 */
export function buildGoPaymentEntry({
  restaurantId = "",
  amountCents = 0,
  method = "other",
  actorUid = "",
 ...
 */
export function buildGoAllocationEntry({
  restaurantId = "",
  paymentId = "",
  chargeId = "",
  bookingId = "",
 ...
 * wurde.
 */
export function buildGoReversalEntry({
  restaurantId = "",
  targetId = "",
  targetKind = "",
  amountCents = 0,
 ...
 */
export function allocateGoPaymentFifo({ openCharges = [], amountCents = 0 } = {}) {
 ...
 * verschwinden.
 */
export function sumGoLedgerBalance(entries = []) {
 ...
 */
export function buildGoLedgerHistory(entries = [], { limit = 60 } = {}) {
