...
export const GO_BOOKINGS_COLLECTION = "goBookings";
export const GO_CAPACITY_COLLECTION = "goCapacity";
export const GO_GUEST_SESSIONS_COLLECTION = "goGuestSessions";
 ...
 */
export function createGoShortCode(randomBytes, length = GO_SHORT_CODE_LENGTH) {
 ...
 * Bedingungen selbst.
 */
export function buildGoBookingSnapshot({
  offer = {},
  business = {},
  request = {},
  nowMs = Date.now()
 ...
 */
export function buildGoBookingRecord({
  bookingId = "",
  snapshot = {},
  request = {},
  guest = {},
...
// anzulegen.
export function buildGoIdempotencyKey({ guestId = "", offerId = "", clientKey = "" } = {}) {
  const parts = [
