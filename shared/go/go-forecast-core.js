...
import { toGoMillis } from "./go-time-core.js";
...
export const GO_FORECAST_SHRINKAGE = 20;
...
export const GO_FORECAST_FALLBACK = Object.freeze({
 ...
 */
export function smoothGoRate({ part = 0, whole = 0, globalRate = 0, shrinkage = GO_FORECAST_SHRINKAGE } = {}) {
 ...
 */
export function goFinalizationRates({ own = {}, global = {} } = {}) {
 ...
 * finalisiert?
 */
export function goMedianFinalizationLatency(bookings = []) {
 ...
 */
export function goExpectedRevenueCents({
  openBookings = [],
  rates = {},
  commissionFor = () => 0
} = {}) {
 ...
 */
export function buildGoForecast({ earnedCents = 0, expectedCents = 0, rates = {} } = {}) {
