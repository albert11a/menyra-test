// apps/menyra-restaurants/guest/_shared/guest.js
// =========================================================
// MENYRA System 1 – Guest App (Karte + Detajet + Porosia)
// Ziel: 1 JS für alle 3 Seiten, gleiche UX, extrem wenige Reads.
// =========================================================
//
// PAGE-DETECTION:
...
(function init() {
  // Always update FAB once
  updateFab(loadCart());

  if (isKarte) initKarte();
  else if (isDetajet) initDetajet();
  else if (isPorosia) initPorosia();
})();
