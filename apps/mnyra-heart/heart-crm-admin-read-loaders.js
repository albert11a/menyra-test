...
function normalizeLeadDoc(docSnap = {}) {
  ...
  return withLeadSearchKey({
    ...
    titleImageUrl: data.titleImageUrl || data.coverImageUrl || data.coverUrl || data.heroUrl || "",
    coverImageUrl: data.coverImageUrl || data.titleImageUrl || data.coverUrl || data.heroUrl || "",
    coverUrl: data.coverUrl || data.titleImageUrl || data.coverImageUrl || data.heroUrl || "",
    heroUrl: data.heroUrl || data.titleImageUrl || data.coverImageUrl || data.coverUrl || "",
...
function normalizeLeadFromRestaurant(rest = {}) {
  ...
  return withLeadSearchKey({
    ...
    titleImageUrl: rest.titleImageUrl || rest.coverImageUrl || rest.coverUrl || rest.heroUrl || "",
    coverImageUrl: rest.coverImageUrl || rest.titleImageUrl || rest.coverUrl || rest.heroUrl || "",
    coverUrl: rest.coverUrl || rest.titleImageUrl || rest.coverImageUrl || rest.heroUrl || "",
    heroUrl: rest.heroUrl || rest.titleImageUrl || rest.coverImageUrl || rest.coverUrl || "",
    openingHours: rest.openingHours || rest.hours || "",
    hours: rest.hours || rest.openingHours || "",
    restaurantFeatures: rest.restaurantFeatures || {},
    features: Array.isArray(rest.features) ? rest.features : [],
    gardenTerraceText: rest.gardenTerraceText || "",
    accessibilityText: rest.accessibilityText || "",
