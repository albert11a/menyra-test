...
const profileData = {
  mine: {
    ...
    following: 320,
    posts: [
      { url: "", likes: 240, comments: 12 },
      { url: "", likes: 512, comments: 38 },
      { url: "", likes: 98, comments: 6 },
      { url: "", likes: 180, comments: 20, wide: true }
    ]
  },
  public: {
    name: "Menyra Bistro",
    ...
    following: 64,
    posts: [
      { url: "", likes: 320, comments: 26 },
      { url: "", likes: 210, comments: 14 },
      { url: "", likes: 430, comments: 40 },
      { url: "", likes: 112, comments: 9, wide: true }
    ]
  }
};
