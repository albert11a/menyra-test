import{f as he,g as Jn,i as ft,h as Xn,j as es,k as xe,b as ts}from"../entry/social-app.js";import{t as as}from"./domain-app-events-rkgdN7NR.js";import"./domain-auth-GDqJX7rW.js";import"./firebase-config-DgqKKOmY.js";import"./vendor-firebase-DSh1wwGb.js";import"./domain-push-BPmJ5TmW.js";import"./startup-route-runtime-context-D7ndoYKY.js";import"./domain-follow-BXoKfGG0.js";import"./domain-notifications-CLcv8atr.js";import"./domain-feed-BJBzhbCL.js";import"./domain-public-profile-BW4dw-Ab.js";import"./domain-stories-8eONgnHA.js";import"./domain-business-accounts-Czo_hlVf.js";import"./domain-leads-DKLm0wNx.js";import"./domain-map-BjqpyoLm.js";function xs(y={}){const d=y.state,ia=y.resolvePostCountsFn,n=y.escapeHtmlFn,U=y.getOptimizedImageUrlFn,x=y.iconFn,oa=y.isLocalBusinessProfileFn,la=typeof y.isCeoUserFn=="function"?y.isCeoUserFn:(()=>!1),gt=y.normalizeHandleFn,He=y.logoFitClassFn,B=y.formatCountFn,mt=y.renderProfileShopCartViewFn,bt=y.renderProfileShopFavoritesViewFn,da=typeof y.ensurePostsDataForProfileFn=="function"?y.ensurePostsDataForProfileFn:(()=>{}),ca=y.ensureMenuDataForProfileFn,ua=typeof y.ensureEditorMenuDataForProfileFn=="function"?y.ensureEditorMenuDataForProfileFn:(()=>{}),ve=y.ensureFocusDataForProfileFn,pa=typeof y.ensureAdsDataForProfileFn=="function"?y.ensureAdsDataForProfileFn:(()=>{}),ht=y.ensureTableQrStateForProfileFn,Q=y.isShopCatalogProfileFn,fa=y.getBusinessCatalogLabelFn,oe=y.normalizeMenuTypeFn,ga=y.primeMenuItemCountsFn,ma=typeof y.hydrateMenuCardViewerLikesFn=="function"?y.hydrateMenuCardViewerLikesFn:(()=>Promise.resolve()),ba=y.renderShopProductListFn,ha=y.getMenuLayoutThemeFn,xa=y.menuLayoutColors,Z=y.resolveMenuItemHeroFn,O=y.isPlaceholderUrlFn,N=y.placeholderImage,va=y.getFirebaseStorageUrlFn,wa=y.isDirectImageUrlFn,xt=y.formatPriceFn,ya=typeof y.resolveCurrencyCodeForMenuItemFn=="function"?y.resolveCurrencyCodeForMenuItemFn:(()=>""),vt=y.getMenuItemImagesFn,V=y.getMenuItemObjectPositionFn,we=y.getMenuItemSocialIdFn,wt=y.menuItemMetaKeyFn,yt=y.ensureMenuItemMetaFn,$t=y.resolveMenuItemCountsFn,ye=y.getFocusStateForRestaurantFn,$a=typeof y.getAdsStateForRestaurantFn=="function"?y.getAdsStateForRestaurantFn:(()=>({items:[],enabled:!0,loading:!1,same:!1})),$e=y.getTableQrStateForRestaurantFn,le=y.getFocusItemObjectPositionFn,Oe=y.getFocusCardClassFn,ka=y.getFocusIndexFn,se=y.isRestaurantCafeProfileFn,Ve=typeof y.getBusinessProfileTypeFn=="function"?y.getBusinessProfileTypeFn:(()=>""),pe=y.getRestaurantMetaByIdFn,Sa=y.buildUrlFn,Ia=y.normalizeSearchKeyFn,Ca=y.normalizeFollowHandleFn,ee={key:"",inFlightKey:""},kt=new Set,ke=()=>{try{if(globalThis?.__MENYRA_DEBUG_MENU_STATE__===!0||globalThis?.__MENYRA_DEBUG_PROFILE_RENDER__===!0)return!0;const e=new URLSearchParams(globalThis?.location?.search||"");return e.get("debug-menu-state")==="1"||e.get("debug-profile-render")==="1"}catch{return!1}},Pa=({profile:e=null,routePayload:t=null,surface:a=null,decision:s=null}={})=>{if(!ke())return;const i=a&&typeof a=="object"?a:{},r=i.menu&&typeof i.menu=="object"?i.menu:{},o=e&&typeof e=="object"?e:{},l=t&&typeof t=="object"?t:{},c=l?.businessSnapshot?.identity||l?.identity||{},f=String(i.authoritativeRestaurantId||i.restaurantId||r.restaurantId||"").trim(),u=String(o.publicSlug||o.landingSlug||o.handle||c.publicSlug||c.landingSlug||c.handle||"").trim(),p=`${f||"pending"}::${u||"no-slug"}`;if(kt.has(p))return;kt.add(p);const m=Array.isArray(r.items)?r.items:[],b=new Set(m.map(v=>String(v?.category||"").trim()).filter(Boolean)).size,k=String(r.rawTruthState||r.truthState||"").trim();console.debug("[mnyra][public-menu.first-render]",{businessId:f,slug:u,itemsLength:m.length,categoriesLength:b,menuStatus:String(r.status||"loading"),truthState:k,isLoading:s?.isLoading===!0,isHydrating:r.hydrating===!0||k.toLowerCase()==="hydrating",confirmedEmpty:r.confirmedEmpty===!0,canRenderItems:r.canRenderItems===!0,shouldRenderNoProducts:s?.shouldRenderNoProducts===!0,source:String(r.source||"")})},ja=()=>{try{return String(globalThis?.__MNYRA_BUILD_TOKEN__||globalThis?.__MENYRA_SOCIAL_APP_VERSION__||"").trim()}catch{return""}},Ke=(e="")=>n(String(e||"")),de=(e="")=>n(String(e??"")),W=({renderer:e="profile-menu-focus-render-controller",skeleton:t="",source:a=""}={})=>{if(!ke())return"";const s=[e?`data-debug-renderer="${Ke(e)}"`:"",t?`data-debug-skeleton="${Ke(t)}"`:"",a?`data-debug-source="${Ke(a)}"`:""].filter(Boolean);return s.length?` ${s.join(" ")}`:""},Fa=(e={},t=[])=>{const a=Xn(e,t);return` ${[`data-menu-state="${de(a.menuState)}"`,`data-menu-item-count="${de(a.menuItemCount)}"`,`data-focus-state="${de(a.focusState)}"`,`data-focus-business-id="${de(a.focusBusinessId)}"`,`data-focus-item-count="${de(a.focusItemCount)}"`,`data-focus-source="${de(a.focusSource)}"`,`data-focus-stale="${a.focusStale?"true":"false"}"`].join(" ")}`},St=({component:e="profile-menu-focus-render-controller",functionName:t="",profile:a=null,routePayload:s=null,surface:i=null,decision:r=null,items:o=null,rawItems:l=null,filteredItems:c=null,renderDecision:f="",source:u=""}={})=>{const p=i&&typeof i=="object"?i:{},m=p.menu&&typeof p.menu=="object"?p.menu:{},b=p.focus&&typeof p.focus=="object"?p.focus:{},k=a&&typeof a=="object"?a:d?.profileView?.profile&&typeof d.profileView.profile=="object"?d.profileView.profile:{},v=s&&typeof s=="object"?s:d?.profileView?.routePayload&&typeof d.profileView.routePayload=="object"?d.profileView.routePayload:{},S=v?.businessSnapshot&&typeof v.businessSnapshot=="object"?v.businessSnapshot:{},P=S?.identity&&typeof S.identity=="object"?S.identity:v?.identity&&typeof v.identity=="object"?v.identity:{},w=d?.__webDirectEntry&&typeof d.__webDirectEntry=="object"?d.__webDirectEntry:{},I=String(k.publicSlug||k.landingSlug||k.handle||P.publicSlug||P.landingSlug||P.handle||w.publicSlug||"").trim(),F=String(k.restaurantId||v.restaurantId||w.restaurantId||"").trim(),A=String(k.canonicalRestaurantId||v.canonicalRestaurantId||p.authoritativeRestaurantId||w.canonicalRestaurantId||S.restaurantId||"").trim();let L="";k.canonicalRestaurantId?L="profile.canonicalRestaurantId":v.canonicalRestaurantId?L="routePayload.canonicalRestaurantId":p.authoritativeRestaurantId?L="surface.authoritativeRestaurantId":w.canonicalRestaurantId?L="webDirectEntry.canonicalRestaurantId":S.restaurantId?L="routeSnapshot.restaurantId":k.restaurantId?L="profile.restaurantId":v.restaurantId?L="routePayload.restaurantId":w.restaurantId&&(L="webDirectEntry.restaurantId");const $=String(A||p.restaurantId||m.restaurantId||F||"").trim(),_=Array.isArray(l)?l:Array.isArray(m.items)?m.items:[],z=Array.isArray(o)?o:_,R=Array.isArray(c)?c:z,h=new Set(R.map(re=>String(re?.category||"").trim()).filter(Boolean)).size,j=String(m.status||(r?.isLoading?"loading":"")||"").trim(),T=String(m.rawTruthState||m.truthState||"").trim(),M=m.confirmedEmpty===!0||r?.confirmedEmpty===!0,E=r?.hasError===!0||j==="error"||!!String(m.error||"").trim(),q=!(R.length>0||r?.hasItems===!0)&&!M&&!E,G=A||F||$||"";return{component:e,functionName:t,slug:I,businessId:$,requestedRestaurantId:F,canonicalRestaurantId:A,restaurantIdSource:L,menuReadPath:G?`restaurants/${G}/public/menu`:"",activeTab:String(d?.activeTab||"").trim(),profileTopTab:String(d?.profileTopTab||"").trim(),profileContentTab:String(d?.profileContentTab||"").trim(),itemsLength:z.length,rawItemsLength:_.length,filteredItemsLength:R.length,categoriesLength:h,focusItemsLength:Array.isArray(b.items)?b.items.length:0,loading:m.loading===!0||r?.isLoading===!0||j==="loading",pending:q,hydrating:m.hydrating===!0||T.toLowerCase()==="hydrating",status:j,truthState:T,confirmedEmpty:M,canRenderItems:m.canRenderItems===!0,renderDecision:f||(r?.shouldRenderNoProducts?"no-products":r?.isLoading?"loading":""),source:u||String(m.source||""),buildToken:ja()}},Se=(e={})=>{ke()&&console.warn("[mnyra:no-products-render]",{...St(e),stack:new Error().stack})},Ie=(e="",t={})=>{ke()&&console.info("[mnyra:skeleton-render]",{skeletonName:e,...St({...t,renderDecision:t.renderDecision||"skeleton"}),reason:String(t.reason||"").trim()})},g=(e,t=e,a={})=>as(e,{fallback:t,params:a}),Aa=(e="")=>{const t=String(e||"").trim();if(!t)return g("nav.menu","Menue");const a=t.toLowerCase();return a==="menue"||a==="menu"||a==="menü"?g("nav.menu",t):a==="shop"?"Shop":t},It=(e="")=>{const t=String(e||"").trim();if(!t)return"";const a=t.toLowerCase();return["speisen","food","getraenke","getränke","drink","drinks","beverage","beverages"].includes(a)?g("menu.products","Produkte"):t},La=(e="food",t=!1)=>t?g("menu.products","Produkte"):String(e||"").trim().toLowerCase()==="drink"?g("menu.drinks","Getraenke"):g("menu.food","Speisen"),Ct=(e={},t=!1)=>{const a=oe(e?.type||"food");return t?g("menu.product","Produkt"):a==="drink"?g("menu.drinkItem","Getraenk"):g("menu.foodItem","Speise")},qe=(e="",t="#111827")=>{const a=String(e||"").trim();return/^#[0-9a-fA-F]{6}$/.test(a)?a:t};function Ta(e=null,t=null){return he(d,{profile:e,routePayload:t,webDirectEntry:d?.__webDirectEntry}).restaurantId}function Pt(e=null,t=""){if(!e||typeof e!="object")return e;const a=String(t||"").trim();if(!a)return e;const s=String(e.canonicalRestaurantId||"").trim();return String(e.restaurantId||"").trim()===a&&s?e:{...e,restaurantId:a,...s?{canonicalRestaurantId:s}:{}}}function _a(e=""){const t=String(e||"").trim();return t?he(d,{profile:d?.profileView?.profile||d?.userProfile,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:t}).focus.canRenderFocus:!1}function fe(e={}){const t=String(ya(e)||"").trim();return t?xt(e?.price,t):xt(e?.price)}function za(e=[],t="",a=""){const s=String(t||"").trim(),i=String(a||"").trim();if(!s||!i)return"";const r=Array.isArray(e)?e:[];if(!r.length)return`${s}|${i}|empty`;const o=[];return r.forEach(l=>{const c=String(we(l)||l?.id||"").trim();c&&o.push(c)}),o.length?(o.sort(),`${s}|${i}|${o.join(",")}`):`${s}|${i}|empty`}function Ra(e=[],t=""){const a=String(d.user?.uid||"").trim(),s=za(e,t,a);s&&ee.inFlightKey!==s&&ee.key!==s&&(ee.key=s,ee.inFlightKey=s,ma(e,t).catch(i=>{console.error(i),ee.key===s&&(ee.key="")}).finally(()=>{ee.inFlightKey===s&&(ee.inFlightKey="")}))}function Ma(e={}){const t=String(e?.uid||"").trim();if(t&&d.followingTargetIds.includes(t))return!0;const a=String(e?.restaurantId||"").trim();if(a&&d.followingTargetIds.includes(a))return!0;const s=Ca(e?.handle||"");return!!(s&&d.followingHandles.includes(s))}function jt(e={}){if(e?.specialEnabled===!0)return!0;if(e?.specialEnabled===!1)return!1;const t=String(e?.restaurantId||"").trim();if(!t)return!1;const a=typeof pe=="function"&&pe(t)||null;return a?.specialEnabled===!0?!0:(a?.specialEnabled===!1,!1)}function Ea(e={}){return ne(e)==="testfirst_special"?!0:String(e?.category||"").trim().toLowerCase()==="special"}function Ft(e,t,a=!0,{includeImageKey:s=!0}={}){const i=ia(e),r=e.id?String(e.id):"",o=r?`data-open-post="${n(r)}"`:"",l=r?`data-post-like-count="${n(r)}"`:"",c=r?`data-post-comment-count="${n(r)}"`:"",f=s&&r?`data-img-key="profile-post:${n(r)}"`:"",u=e.type==="wide"||e.type==="hero",p=t&&u?"col-span-2":"",m=t&&u?"aspect-[1.8/1]":"aspect-[4/5]",b=U(e.url,u?"large":"medium",{stableKey:r?`profile-post:${r}`:"",variantGroup:"post-detail"}),k=u?800:400,v=u?400:500;return`
  ...
  `}function Ge(e,t,a=!0,{includeImageKeys:s=!0}={}){const i=t==="grid";if(!e.length)return`
    ...
    `;const r=e.map(l=>Ft(l,i,a,{includeImageKey:s})),o=e.reduce((l,c)=>{const f=c?.type==="wide"||c?.type==="hero";return l+(f?2:1)},0);return i&&o%2===1&&r.unshift(`
      ...
      ${a?`
        ...
        <div data-hotel-card-editor="${n(a)}" data-hotel-card-details-panel class="${I?"":"hidden "}bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
            ...
            <div class="grid grid-cols-1 gap-4">
              ...
              ${Ye({id:"hotelCardFeatureTwoText",iconName:"waves",label:"Shezlongë",value:p,options:Ya})}
...
`))}</textarea>
  ...
  `}function Ut(e={},t={}){const a=t.mode==="self"?"self":"public",s=t.disabledBlockClass||"",i=un(e,a),r=a==="self"?"avatar:self":`avatar:public:${i}`,o=t.avatarUrl||U(e.avatar||"","avatar",{stableKey:r}),l=t.avatarFit||He(!!e.restaurantId),c=String(d?.profileCardInfoOpen||"")===i,f=Number(d?.profileCardInfoHeights?.[i]||0),u=c&&Number.isFinite(f)&&f>0?`height:${Math.ceil(f)}px;`:"",p=t.avatarImgKeyAttr||(a==="self"?'data-img-key="avatar:self"':`data-img-key="avatar:public:${n(i)}"`),m=t.renderAvatarImage===!0?!!String(o||"").trim()&&!O(o):t.renderAvatarImage!==!1&&!!String(o||"").trim()&&!O(o)&&!!String(e?.avatar||"").trim(),b=!!t.identityPending,k=t.followersLabel??B(e.followers),v=D(e?.name)||"User",S=D(t.typeLabel||e?.customerType||e?.type||"Business"),P=D(e?.location||"-"),w=a==="public"?`${P} / ${S}`:P,I=t.bioHtml||n(e?.bio||"").replace(/\n/g,"<br>")||n(g("profile.noBio","Noch keine Bio.")),F=`business-cover:${i}`,A=ln(e,i),L=gn(e,{cacheKeys:A,stableKey:F,allowCacheFallback:t.allowTitleImageCacheFallback===!0}),$=bn(e),_=pn(e),z=Le(_?{buttonAttrs:`data-marketplace-open-map="${n(_)}"`,label:g("profile.openMap","Karte oeffnen"),iconName:"map"}:{href:$,label:g("profile.openMap","Karte oeffnen"),iconName:"map"}),R=Et(e?.instagramUrl||e?.instagram||e?.insta||"","instagram"),h=Et(e?.tiktokUrl||e?.tiktok||e?.tikTok||"","tiktok"),j=D(e?.phone||e?.telephone||e?.contactPhone||""),T=mn(j),M=D(e?.address||e?.locationLabel||[e?.place||e?.locationPlace,e?.location||e?.city].map(q=>D(q)).filter(Boolean).join(", ")),E=[Te({href:R,iconName:"instagram",eyebrow:"Instagram",value:e?.instagram||e?.instagramUrl||e?.insta||""}),Te({href:h,iconName:"music-2",eyebrow:"TikTok",value:e?.tiktok||e?.tiktokUrl||e?.tikTok||""})].filter(Boolean).join(""),H=a==="self"?`
  ...
  `}function _e(e={},t=[],{topTabOverride:a="",tutorialMode:s=!1,contentTabOverride:i="",landingHideContent:r=!1,collapseIdentity:o=!1,contentReveal:l=!1,landingMode:c=!1}={}){const f=Ma(e),u=!!e.privateAccount&&e.uid&&String(e.uid)!==String(d.user?.uid||"")&&!f,p=!!e.pendingFollowRequest&&!f,m=e.restaurantId?"Business":g("nav.user","User"),b=String(e.handle||gt(e.name||"user")).replace(/^@/,""),v=n(e.bio||"").replace(/\n/g,"<br>")||n(g("profile.noBio","Noch keine Bio.")),S=Ce(e),P=String(a||Ze(e)).trim().toLowerCase()||"profile",w=String(i||Ae(e)).trim().toLowerCase()||"posts",I=w==="menu",F=w==="checkins",A=t,$={...d?.profileView&&typeof d.profileView=="object"?d.profileView:{},profile:e,posts:Array.isArray(A)?A:[]},_=es(d,{profileView:$,profileTopTab:P,profileContentTab:w}),z=String(_?.header?.status||"").trim().toLowerCase()||"loading",R=String(_?.posts?.status||"").trim().toLowerCase()||"loading",h=e.uid||e.restaurantId||b||"public",j=`avatar:public:${h}`,T=String(e?.avatar||"").trim(),M=U(T,"avatar",{stableKey:j}),E=He(!!e.restaurantId),H=c?"":`data-img-key="avatar:public:${n(h)}"`,q=!T&&!!String(M||"").trim()&&!O(M),G=!!T||q&&xe(z),re=pt=>{if(pt==null)return!1;const ra=Number(pt);return Number.isFinite(ra)&&ra>=0},ut=G||re(e?.followers)||re(e?.following),J=xe(z)&&!ut,ie=!!String(M||"").trim()&&!O(M)&&G,Ee=J?"...":B(e.followers),Ue=J?"...":B(e.following),Be=S?"pt-2":"pt-10",Ne=f?g("profile.following","Following"):p?g("profile.requested","Requested"):u?g("profile.request","Request"):g("profile.follow","Follow"),me=f?"bg-slate-100 text-slate-600 shadow-none border border-slate-200":p?"bg-amber-50 text-amber-700 shadow-none border border-amber-200":"bg-gradient-to-r from-slate-900 to-slate-800 text-white border border-transparent",be=s?"select-none":"app-main-content-safe",X=s?"pointer-events-none":"",Y=!o,na=!r,De=l?c?"transition-opacity duration-200":"animate-in fade-in duration-300":"",sa=w==="posts"&&A.length>0,Yn=w!=="posts"||sa||R==="empty"||R==="error",Zn=w==="posts"&&!sa&&R==="error";return!s&&(w==="posts"||w==="media")&&e?.restaurantId&&xe(R)&&da(e),`
    <div class="${be}" ${s?'data-landing-tutorial-surface="true"':""}>
              ...
              <div class="flex justify-between items-start mb-8">
                ...
                <div class="flex items-center gap-6 pt-3 pr-2">
                   ...
                   <div class="flex flex-col items-center">
                      <span class="font-black text-2xl ${J?"text-slate-300":"text-slate-900"} leading-none mb-1">${n(Ue)}</span>
      ...
      `:`
        ...
        ${na?I?`
          <div class="${X} ${De}">
            ${Pe(e)?Tt(e):Me(e,{mode:c?"landing":"profile",allowAutoEnsure:!c})}
          </div>
        `:F?`
          <div class="${X} ${De}">
            ${Qe()}
  ...
  `}function nt(e,{mode:t="profile",variant:a="food",priorityIndex:s=-1}={}){const i=Z(e),r=t==="profile"?ue(e,{index:0}):"",o=a==="drink",{safeImg:l,fallbackImg:c,imageAttrs:f,lazyAttrs:u}=ae(i,{mode:t,priorityIndex:s,stableKey:r,preferredSize:o?"small":"medium",candidateSizes:o?["small","medium"]:["small","medium","large"],variant:o?"grid":"hero"}),p=fe(e),m=d.activeTab==="menu"?d.userProfile:d.profileView?.profile||d.userProfile,b=Q(m),k=Ct(e,b),v=b?It(e.category):e.category||"",S=e.description||"",P=t==="profile"?`data-menu-open="${n(e.id)}" role="button"`:"",w=d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"",I=we(e),F=wt(w,I),A=F?yt(F):{likes:[],comments:[],counts:{likes:0,comments:0}},L=$t(A),$=`
        ...
        ${t.map((r,o)=>{const l=r.imageUrl||"",c=String(r.menuItemId||r.id||"").trim(),{safeImg:f,fallbackImg:u,imageAttrs:p,lazyAttrs:m}=ae(l,{mode:a,priorityIndex:o,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:c?`menu-focus:${s}:${c}`:""}),b=String(r.menuItemId||"").trim(),k=a==="profile"&&b?`data-menu-open="${n(b)}" role="button"`:"";return`
            <div ${k} class="min-w-[85%] sm:min-w-[300px] snap-center bg-white rounded-[2rem] p-2.5 border border-slate-100 flex flex-col group relative mb-2 ${k?"cursor-pointer":""}" style="box-shadow:0 4px 14px rgba(0,0,0,0.03);">
              <div class="w-full aspect-[16/9] rounded-[1.5rem] overflow-hidden bg-slate-100 relative" style="aspect-ratio:16 / 9;">
                ...
                ${Re(r,{poster:f,objectPosition:r.objectPosition||"50% 50%",badge:!1})}
  ...
  `}function Yt(e,{mode:t="profile",priorityIndex:a=-1}={}){const s=fe(e),i=t==="profile"?`data-menu-open="${n(e.id)}" role="button"`:"",r=Pn(e),l=(r.length?r:[Z(e)||""]).filter(Boolean),c=l.length?l.slice(0,12):[""],f=c.length>1,{itemId:u,counts:p,isLiked:m}=Vt(e),b=B(Math.max(0,Number(p.likes)||0)),k=B(Math.max(0,Number(p.comments)||0));return`
  ...
  `}function zn(e,t,{mode:a="profile",publicMenuSurfaceState:s=null,focusFallbackHtml:i=""}={}){const r=ze(Array.isArray(t)?t:[]),o=String(e?.restaurantId||"").trim(),l=a==="admin"||_a(o),c=s?.focus?.canRenderFocus?{items:Array.isArray(s.focus.items)?s.focus.items:[],enabled:!0}:o&&l?ye(o):{items:[],enabled:!1},f=c.enabled?(Array.isArray(c.items)?c.items:[]).map(h=>rt({...h,objectPosition:le(h)})):[],u=r.filter(h=>ne(h)==="testfirst_focus"&&!et(h)).map(h=>rt(h,{menuItemId:h.id||""})).filter(Boolean),p=new Set,m=[...f,...u].filter(h=>{const j=String(h.menuItemId||h.id||`${h.title}|${h.text}|${h.imageUrl}`);return!j||p.has(j)?!1:(p.add(j),!0)}),b=r.filter(h=>!et(h)),k=b.filter(h=>ne(h)!=="testfirst_focus"),v=k.length?k:b,S=k.length?m:[],P=v.filter(h=>ge(h)==="drink"),w=v.filter(h=>ge(h)!=="drink"),I=(h=[])=>{const j=[],T=[];return h.forEach(M=>{const E=ne(M);E==="testfirst_food"||E==="testfirst_special"&&tt(M)==="food"?T.push(M):j.push(M)}),{gridItems:j,foodItems:T}},F=(h,j=-1)=>ne(h)==="testfirst_special"?it(h,{mode:a,priorityIndex:j}):Wt(h,{mode:a,priorityIndex:j});let A=0;const L=()=>{const h=A;return A+=1,h},$=new Set,_=(h,j)=>!j.gridItems.length&&!j.foodItems.length?"":`
      <section class="menu-type-block relative" data-menu-type-block="${n(h)}">
        ...
        ${j.foodItems.length?`
          <div class="menu-category-section pb-6 pt-4" data-menu-type="${n(h)}">
            <div class="app-content-inline">
              ${ce(j.foodItems,T=>{const M=ne(T),E=L();return M==="testfirst_special"?it(T,{mode:a,size:"food",priorityIndex:E}):Yt(T,{mode:a,priorityIndex:E})},$)}
            </div>
          </div>
        `:""}
      </section>
  ...
  `:""}function Xt(e,{mode:t="profile"}={}){if(t==="admin"){const a=String(d?.menu?.filter||"all").trim().toLowerCase(),s=Q(d.userProfile),i=g("menu.products","Produkte"),r=e.filter(u=>oe(u?.type)==="drink"),o=e.filter(u=>oe(u?.type)!=="drink"),l=(u,p,{addType:m=""}={})=>`
      <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
        <div class="flex items-center justify-between mb-4">
          <div>
  ...
  `}function Kn(e){if(!st(e)||!jt(e))return"";const a=ze((d.menu.items||[]).filter(s=>ne(s)==="testfirst_special"));return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(s=>{const i=U(Z(s),"thumb"),r=O(i)?N:i,o=Ht(s),l=o.type==="link"?"Link":o.type==="product"?"Produkt-Modal":"Diese Karte",c=tt(s)==="food"?"Food-Size":"Normal",f=La(ge(s));return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `:c?Me(l):`
    ...
    `;const l=Pt(e,o),c=Q(l),f=se(l)&&!c;f&&(r=he(d,{profile:l,routePayload:s,webDirectEntry:i,restaurantId:o}));const u=String(i?.canonicalRestaurantId||i?.restaurantId||"").trim(),p=new Set(r.targetIds),m=r.menu.status==="ready",b=r.focus.canRenderFocus,k=m&&f,v=r.focus.matches===!0&&r.focus.loading===!0,P=String(d?.profileView?.menuAccessSource||i?.menuAccessSource||s?.menuAccessSource||"").trim().toLowerCase()==="qr",w=i?.active===!0&&i?.webPriority===!0&&i?.menuFirst===!0&&String(d?.activeTab||"").trim().toLowerCase()==="profile"&&String(d?.profileTopTab||"").trim().toLowerCase()==="menu"&&(u===o||p.has(o)),I=w&&!P,F=["ready","empty","error"].includes(r.menu.status),A=w&&F,L=w&&(!k||r.menu.status!=="ready"),$=!k||r.focus.settled===!0||r.focus.confirmedEmpty===!0||r.menu.status!=="ready";a&&!A&&!F&&ca(l),a&&!L&&!$&&!v&&m&&(!I||F)&&ve(l);const z=r.menu.canRenderItems?ze(Bt(r.menu.items,{filter:"all",query:""})).filter(Y=>!et(Y)):[],R=r.menu.error||"",h=Jn(r.menu,z),{hasItems:j,hasError:T,isLoading:M,shouldRenderNoProducts:E}=h;Pa({profile:l,routePayload:s,surface:r,decision:h});const H={profile:l,routePayload:s,surface:r,decision:h,rawItems:r.menu.items,items:z,filteredItems:z,source:"public-menu"},q=Fa(r,z),G=z.filter(Y=>ge(Y)==="drink"),re=z.filter(Y=>ge(Y)!=="drink"),ut=0,J=G.length,ie=st(e),Ee=ie||c,Ue=new Set;j&&o&&(ga(z,o),Ra(z,o));const Be=o&&b?(Array.isArray(r.focus.items)?r.focus.items:[]).map(Y=>rt({...Y,objectPosition:le(Y)})).filter(Boolean):[],Ne=r.focus.status==="empty"||r.focus.status==="error",me=f&&!b&&!Ne&&r.menu.status!=="empty"&&r.menu.status!=="error",be=Be.length?Qt(l,Be,{mode:t}):me?Fn({...H,reason:"focus-truth-pending"}):"",X=Ee?be:ta(l,{restaurantId:o,suppressLoading:!0,allowAutoEnsure:m&&(!I||F),requirePublicMenuTruth:!0})||(me?jn({...H,reason:"focus-truth-pending"}):"");return ie?`
      <div class="app-main-content-safe"${q}>
        ${M?`
          ${be}
          ${Kt({...H,reason:"menu-loading"})}
        `:`
          ${j?zn(l,z,{mode:t,publicMenuSurfaceState:r,focusFallbackHtml:be}):T?`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${n(g("menu.loadError","Menu konnte nicht geladen werden"))}</div>`:E?(Se({...H,functionName:"renderProfileMenuView",renderDecision:"testfirst-no-products"}),`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300"${W({source:"public-menu:no-products"})}>${n(g("menu.noProducts","Keine Produkte"))}</div>`):Kt({...H,reason:"menu-not-confirmed-empty"})}
          ...
          `:`
            ${G.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="drink">
                ...
                <div data-menu-type="drink">
                  ${Zt(G,{mode:t,useTestfirstCardUi:ie,seenCategories:Ue,priorityOffset:ut})}
                </div>
              </section>
            `:""}
            ${re.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="food">
                ...
                <div data-menu-type="food">
                  ${Jt(re,{mode:t,useTestfirstCardUi:ie,seenCategories:Ue,priorityOffset:J})}
                </div>
              </section>
            `:""}
          `}
  ...
  `}function Wn(){const e=d.userProfile,t=oa(e),a=t?d.businessPosts:d.userPosts,s=String(d.user?.uid||e?.uid||"").trim(),i=String(e?.restaurantId||"").trim(),r=String(d.__userPostsLoadingUid||"").trim(),o=String(d.__businessPostsLoadingRestaurantId||"").trim(),l=String(d.__authBootstrapInFlightUid||"").trim(),c=!!s&&r===s,f=!!i&&o===i,u=!!s&&l===s,p=t?f||u&&!a.length:c||u&&!a.length,m=String(e.handle||gt(e.name||"user")).replace(/^@/,""),k=n(e.bio||"").replace(/\n/g,"<br>")||n(g("profile.noBio","Noch keine Bio.")),v=Ae(e),S=v==="menu",P=v==="checkins",w=a,I=U(e.avatar,"avatar"),F=He(t),A=Ze(e);return`
    <div class="app-main-content-safe">
      ...
      <div class="app-content-inline pb-2 ${t?"pt-2":"pt-10"}">
        ...
        ${t?Ut(e,{mode:"self",avatarUrl:I,avatarFit:F,followersLabel:B(e.followers),bioHtml:k}):`
  ...
  `}return{renderProfilePostCardFancy:Ft,renderProfilePostsFancy:Ge,renderProfileCheckins:Qe,renderProfileTabs:Je,renderProfileViewControls:Xe,renderPublicProfileView:xn,renderMenuFilterRow:Ot,renderMenuLayoutSection:Cn,renderMenuItemCard:at,renderMenuItemCardStacked:nt,renderMenuDrinkGrid:Zt,renderMenuFoodList:Jt,renderMenuList:Xt,renderFocusAdminSection:ot,renderFocusCarousel:ta,renderMenuQrCard:aa,renderMenuAdminView:Qn,renderProfileMenuView:Me,renderProfileView:Wn}}export{xs as createProfileMenuFocusRenderController};
