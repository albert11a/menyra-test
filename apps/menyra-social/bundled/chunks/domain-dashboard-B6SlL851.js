const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/business-composer-controller-D1Zp5-64.js","chunks/domain-feed-social-eager-CHXL-Rm2.js","chunks/domain-auth-Aq-4Vdvh.js","chunks/domain-public-profile-mLQti0eH.js","chunks/domain-media-eager-DAUyCk2O.js","chunks/domain-menu-eager-BbljZUrM.js","chunks/profile-post-card-markup-utils-HwqIiXgP.js"])))=>i.map(i=>d[i]);
import{_ as ge}from"./domain-auth-Aq-4Vdvh.js";import{f as R,r as be,l as _e,s as q}from"./domain-analytics-jv5B-kA2.js";const ve=20,xe=8;function y(e=""){return e==null?"":String(e).trim()}function E(e){if(e==null||e==="")return null;const t=Number(String(e).replace(",","."));return Number.isFinite(t)&&t>0?t:null}function we(e=Date.now(),t=Math.random()){const a=Math.max(0,Number(e)||0).toString(36),s=Math.floor(Math.max(0,Math.min(.999999,Number(t)||0))*36**6).toString(36).padStart(6,"0");return`room_${a}_${s}`}function ke(e={}){const t=e&&typeof e=="object"?e:{},a=[...Array.isArray(t.images)?t.images:[],y(t.imageUrl??t.image??t.photoUrl)],s=[];return a.forEach(i=>{const l=y(i);l&&!s.includes(l)&&s.push(l)}),s.slice(0,xe)}function Pe(e={},{index:t=0}={}){const a=e&&typeof e=="object"?e:{},s=E(a.persons??a.guests??a.capacity),i=E(a.size??a.sizeSqm??a.area),l=ke(a);return{id:y(a.id)||we(Date.now()+t),title:y(a.title??a.name),description:y(a.description??a.text).slice(0,400),imageUrl:l[0]||"",images:l,price:E(a.price??a.pricePerNight),currency:y(a.currency??a.currencyCode).toUpperCase()||"EUR",persons:s==null?null:Math.min(20,Math.round(s)),beds:y(a.beds??a.bedsLabel).slice(0,60),size:i==null?null:Math.min(500,Math.round(i)),tag:y(a.tag??a.badge).slice(0,40),active:a.active!==!1}}function Se(e=[]){return(Array.isArray(e)?e:[]).slice(0,ve).map((t,a)=>Pe(t,{index:a}))}function Ce(e={}){return Se((e&&typeof e=="object"?e:{}).hotelRooms).filter(a=>a.title)}function We(e={}){const t=[];return Number.isFinite(e?.persons)&&e.persons>0&&t.push({icon:"users",label:`${e.persons} persona`}),y(e?.beds)&&t.push({icon:"bed",label:y(e.beds)}),Number.isFinite(e?.size)&&e.size>0&&t.push({icon:"size",label:`${e.size} m²`}),t}function et(e={}){const t=Number(e?.price);if(!Number.isFinite(t)||t<=0)return"";const a=y(e?.currency).toUpperCase()||"EUR",s=Number.isInteger(t)?String(t):t.toFixed(2);return a==="EUR"?`€${s}`:`${s} ${a}`}const V="mnyraDashboardStyles",ze=`
.mnyra-dash {
...
`;function De(e=typeof document>"u"?null:document){if(!(!e||e.getElementById(V)))try{const t=e.createElement("style");t.id=V,t.textContent=ze,e.head?.appendChild(t)}catch{}}function m(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function P(e,t,a=""){if(typeof e!="function")return"";try{return e(t,a)||""}catch{return""}}const Fe=Object.freeze(["hotel","motel","hostel","resort","accommodation","travel"]);function $e({businessType:e="",isShopCatalog:t=!1}={}){if(t)return"shop";const a=String(e||"").trim().toLowerCase();return Fe.includes(a)?"hotel":"restaurant"}function je({kind:e="restaurant",isOwner:t=!1,canAccessOrders:a=!1}={}){const s=[{nav:"upload",uploadIntent:"chooser",iconName:"plus",label:"Neuer Beitrag",sub:"Posto foto ose video"},{nav:"upload",uploadIntent:"story",iconName:"camera",label:"Story",sub:"E dukshme 24h"}];return e==="hotel"?s.push({nav:"menu",iconName:"bed-double",label:"Hotel & Dhoma",sub:"Detaje, dhoma, oferta"}):e==="shop"?s.push({nav:"menu",iconName:"shopping-bag",label:"Ndrysho dyqanin",sub:"Produkte & Stok"}):s.push({nav:"menu",iconName:"utensils",label:"Ndrysho menune",sub:"Produkte & Kategorien"}),s.push({nav:"menu",iconName:"megaphone",label:"Oferta & Reklama",sub:"Im Editor verwalten"}),e!=="hotel"&&a&&s.push({nav:"orders",iconName:"shopping-cart",label:"Porosite",sub:"Hyrje & Status"}),s.push({nav:"analytics",iconName:"bar-chart-3",label:"Analytics",sub:"Te gjitha statistikat"}),t&&s.push({nav:"businessAccounts",iconName:"users-round",label:"Team & Staff",sub:"Zugänge verwalten"}),s.push({nav:"settings",iconName:"settings",label:"Cilesimet",sub:"Profili & Kontakti"}),s}function Re(e="restaurant"){const t=[{key:"profileViews",label:"Profilaufrufe"},{key:"postImpressions",label:"Shtrirja e postimeve"},{key:"contactClicks",label:"Kontakt-Klicks"}];return e==="shop"?t.concat([{key:"ordersCompleted",label:"Porosite"},{key:"revenue",label:"Umsatz",unit:"€"},{key:"productViews",label:"Produkt-Aufrufe"}]):e==="hotel"?t.concat([{key:"uniqueVisitors",label:"Vizitore"},{key:"postLikes",label:"Likes"},{key:"feedImpressions",label:"Shtrirja ne feed"}]):t.concat([{key:"ordersCompleted",label:"Porosite"},{key:"revenue",label:"Umsatz",unit:"€"},{key:"qrScans",label:"QR-Scans"}])}function J(e=0,t=""){const a=R(e);return t?`${a} ${t}`:a}function Ne(e=new Date().getHours()){const t=Number.isFinite(Number(e))?(Math.trunc(Number(e))%24+24)%24:12;return t>=5&&t<=10?{dayPart:"mengjes",text:"Ju urojmë një mëngjes të mbarë!"}:t>=11&&t<=17?{dayPart:"dite",text:"Ju urojmë një ditë të mbarë!"}:t>=18&&t<=21?{dayPart:"mbremje",text:"Ju urojmë një mbrëmje të mbarë!"}:{dayPart:"nate",text:"Ju urojmë një natë të mbarë!"}}function Ie({name:e="",logoUrl:t="",hour:a=new Date().getHours(),iconFn:s}={}){const i=Ne(a);return`
  ...
  `}function Be({kpiDefs:e=[],week:t={},today:a={}}={}){return`
  ...
  `}function Oe({posts:e=[],iconFn:t}={}){const a=Array.isArray(e)?e:[];let s="";return a.length?(s=a.map(i=>{const l=[i.dateLabel,`${R(i.likesCount||0)} Likes`,`${R(i.commentsCount||0)} Kommentare`];return Number(i.impressions||0)>0&&l.push(`${R(i.impressions)} shtrirje (7 dite)`),`
        <div class="mnyra-dash__post">
          <div class="mnyra-dash__post-thumb">
            ${i.thumbUrl?`<img src="${m(i.thumbUrl)}" alt="" loading="lazy" decoding="async" onerror="this.style.display='none'" />`:P(t,i.mediaType==="video"?"play":"image","w-5 h-5")}
          </div>
  ...
  `}function He(){return'<div class="mnyra-dash__skeleton" style="min-height:44px; border-radius:14px; margin: 4px 0 16px;"></div>'}function Ke({message:e=""}={}){return`
    <div class="mnyra-dash__section">
  ...
  `}const Ue="menyra_social_dashboard_cache_v1::",Q="menyra_social_composer_products_v1::",Ae=2500,qe=1200,Ve=6,Je=3;function M(e){const t=Number(e);return Number.isFinite(t)?t:0}function Ge(e={}){const t=String(e.createdAtClient||"").trim();if(t){const s=new Date(t);if(!Number.isNaN(s.getTime()))return s}const a=e.createdAt;if(a&&typeof a.toDate=="function")try{const s=a.toDate();if(s instanceof Date&&!Number.isNaN(s.getTime()))return s}catch{}return null}function Qe(e="",t={}){const a=Array.isArray(t.media)&&t.media.length?t.media[0]:{},s=String(a.type||t.mediaType||"image").trim().toLowerCase()==="video"?"video":"image",i=String(a.thumbUrl||(s==="image"?a.url:"")||t.thumbUrl||"").trim(),l=Ge(t);return{id:String(e||"").trim(),caption:String(t.caption||"").trim(),mediaType:s,thumbUrl:i,likesCount:M(t.likesCount),commentsCount:M(t.commentsCount),impressions:0,dateLabel:l?l.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit"}):"",createdAtMs:l?l.getTime():0}}function Ze({days:e=[],todayKey:t="",rawPosts:a=[]}={}){const s=Array.isArray(e)?e:[],i=q(s),l=s.find(u=>String(u?.date||u?.id||"").trim()===String(t||"").trim()),b=q(l?[l]:[]),N=i.merged?.posts&&typeof i.merged.posts=="object"?i.merged.posts:{},_=(Array.isArray(a)?a:[]).map(u=>Qe(u?.id,u?.data||{})).filter(u=>u.id).sort((u,S)=>S.createdAtMs-u.createdAtMs).slice(0,Je).map(u=>({...u,impressions:M(N[u.id]?.impressions)}));return{day:String(t||"").trim(),week:i.summary,today:b.summary,posts:_}}function tt({state:e,renderFn:t,documentObj:a,firestoreApi:s={},profileApi:i={},composerApi:l={},iconFn:b,storageObj:N}={}){const _=a||(typeof document>"u"?null:document),u=_?.defaultView||(typeof window>"u"?null:window),S=typeof t=="function"?t:()=>{},v=N||(typeof localStorage>"u"?null:localStorage),Z=typeof i.getBusinessProfileTypeFn=="function"?i.getBusinessProfileTypeFn:(()=>""),X=typeof i.isShopCatalogProfileFn=="function"?i.isShopCatalogProfileFn:(()=>!1),Y=typeof i.isBusinessOwnerProfileFn=="function"?i.isBusinessOwnerProfileFn:(()=>!1),W=typeof i.canAccessRestaurantOrdersFn=="function"?i.canAccessRestaurantOrdersFn:(()=>!1),I=typeof i.getRestaurantMetaByIdFn=="function"?i.getRestaurantMetaByIdFn:(()=>null),ee=typeof i.resolveRestaurantLogoFn=="function"?i.resolveRestaurantLogoFn:(()=>""),te=typeof i.resolveOwnAvatarUrlFn=="function"?i.resolveOwnAvatarUrlFn:(()=>"");let C=0,B=!1,x=null,z=null,D="",O=!1,H=()=>null;const ae=300;function T(){const n=e?.userProfile||{};return $e({businessType:Z(n),isShopCatalog:X(n)})}function ne(n=""){const r=I(n)||{};return Ce(r).map(o=>({id:o.id,name:o.title,price:o.price??"",category:o.beds||o.tag||"",type:"room",imageUrl:o.imageUrl||""}))}function re(n=""){if(!v)return null;try{const r=v.getItem(`${Q}${n}`);if(!r)return null;const o=JSON.parse(r),d=Array.isArray(o?.items)?o.items:null;return d&&d.length?d:null}catch{return null}}function se(n="",r=[]){if(v)try{v.setItem(`${Q}${n}`,JSON.stringify({savedAt:Date.now(),items:r}))}catch{}}async function oe(n=""){const{db:r,collectionFn:o,queryFn:d,limitFn:c,getDocsFn:p}=s;if(!r||typeof o!="function"||typeof p!="function")throw new Error("Produktet nuk u ngarkuan.");const f=o(r,"restaurants",n,"menuItems"),g=typeof d=="function"&&typeof c=="function"?d(f,c(ae)):f,k=await p(g),h=[];return k.forEach(w=>{const j=H(w?.id,w?.data?.()||{});j&&h.push(j)}),h.sort((w,j)=>w.name.localeCompare(j.name,"sq")),h}async function ie(n="",r){const o=String(n||"").trim();if(!o)throw new Error("Produktet nuk u ngarkuan.");if(T()==="hotel")return ne(o);const d=oe(o).then(p=>(se(o,p),p)),c=re(o);return c?(typeof r=="function"?d.then(p=>r(p)).catch(()=>{}):d.catch(()=>{}),c):d}function K(){return x?Promise.resolve(x):(z||(z=ge(()=>import("./business-composer-controller-D1Zp5-64.js"),__vite__mapDeps([0,1,2,3,4,5,6])).then(n=>(H=typeof n?.normalizeComposerProductCore=="function"?n.normalizeComposerProductCore:(()=>null),x=n.createBusinessComposerController({documentObj:_,windowObj:_?.defaultView||null,api:{getRestaurantIdFn:()=>F(),getBusinessMetaFn:()=>{const r=F();if(!r)return{name:"",logoUrl:"",city:""};const o=A(r),d=I(r)||{};return{name:o.name,logoUrl:o.logoUrl,city:String(d.city||"").trim()}},loadProductsFn:(r,o)=>ie(r,o),getBusinessKindFn:()=>T(),uploadImageFn:l.uploadImageFn,uploadVideoFn:l.uploadVideoFn,captureVideoPosterFn:l.captureVideoPosterFn,createPostFn:l.createPostFn,createStoryFn:l.createStoryFn,formatPriceFn:l.formatPriceFn,getOptimizedImageUrlFn:l.getOptimizedImageUrlFn,escapeHtmlFn:l.escapeHtmlFn,iconFn:typeof b=="function"?b:void 0,afterPublishFn:async r=>{try{await $({force:!0})}catch{}typeof l.afterPublishFn=="function"&&await l.afterPublishFn(r)}}}),x)).catch(n=>{throw z=null,console.error("[mnyra][dashboard] composer load failed",n),n})),z)}function de(){const n=u?.navigator?.connection;return!n||typeof n!="object"?!1:n.saveData===!0?!0:/(^|-)2g$/.test(String(n.effectiveType||"").trim().toLowerCase())}function le(){if(O||x||!u||de())return;O=!0;const n=()=>{if(K().catch(()=>{}),typeof l.prewarmFn=="function")try{l.prewarmFn()}catch{}};if(typeof u.requestIdleCallback=="function"){u.requestIdleCallback(n,{timeout:Ae});return}u.setTimeout?.(n,qe)}function ce(n="post"){const r=String(n||"").trim().toLowerCase(),o=r==="story"||r==="profile"?r:"post";if(typeof l.prewarmFn=="function")try{l.prewarmFn()}catch{}if(x){x.open(o);return}D=o,K().then(d=>{const c=D||o;D="",d?.open?.(c)}).catch(()=>{D=""})}function L(){return(!e.dashboardView||typeof e.dashboardView!="object")&&(e.dashboardView={status:"idle",error:"",model:null,loadedSignature:""}),e.dashboardView}function F(){const n=e?.userProfile||{};return String(n.restaurantId||n.staffRestaurantId||"").trim()}function ue(){const n=String(e?.user?.uid||"").trim();if(!n)return!1;const r=String(e?.__authBootstrapInFlightUid||"").trim();return!!e?.__authProfileLoadPromise||r===n}function U(n=""){return`${Ue}${n}`}function me(n="",r=""){if(!v||!n)return null;try{const o=v.getItem(U(n));if(!o)return null;const d=JSON.parse(o);return!d||typeof d!="object"||String(d.day||"").trim()!==String(r||"").trim()||!d.model||typeof d.model!="object"?null:d.model}catch{return null}}function pe(n="",r=null){if(!(!v||!n||!r))try{v.setItem(U(n),JSON.stringify({day:r.day,model:r}))}catch{}}async function he(n=""){const{db:r,collectionFn:o,queryFn:d,orderByFn:c,limitFn:p,getDocsFn:f}=s;if(!r||typeof o!="function"||typeof d!="function"||typeof c!="function"||typeof p!="function"||typeof f!="function")return[];const g=o(r,"restaurants",n,"socialPosts");return(await f(d(g,c("createdAt","desc"),p(Ve)))).docs.map(h=>({id:h.id,data:h.data()||{}})).filter(h=>{const w=String(h.data.status||"active").trim().toLowerCase();return w!=="deleted"&&w!=="hidden"})}async function $({force:n=!1}={}){const r=L(),o=F();if(!o)return;const d=be({rangeKey:"7d"});if(!d)return;const c=`${o}::${d.toDay}`;if(!n&&r.loadedSignature===c&&r.status==="ready")return;if(!r.model){const g=me(o,d.toDay);g&&(r.model=g,r.status="ready",S())}C+=1;const p=C;r.model||(r.status="loading",r.error="",S());try{const g={db:s.db,collectionFn:s.collectionFn,queryFn:s.queryFn,whereFn:s.whereFn,documentIdFn:s.documentIdFn,getDocsFn:s.getDocsFn,restaurantId:o},[k,h]=await Promise.allSettled([_e({...g,fromDay:d.fromDay,toDay:d.toDay}),he(o)]);if(p!==C)return;if(k.status==="rejected")throw k.reason;h.status==="rejected"&&console.error("[mnyra][dashboard] recent posts load failed",h.reason),r.model=Ze({days:k.value,todayKey:d.toDay,rawPosts:h.status==="fulfilled"?h.value:[]}),r.status="ready",r.error="",r.loadedSignature=c,pe(o,r.model)}catch(g){if(p!==C)return;console.error("[mnyra][dashboard] load failed",g),r.model||(r.status="error",r.error="Ju lutem kontrollo lidhjen dhe provo perseri.")}S()}function fe(){B||!_||(B=!0,_.addEventListener("click",n=>{try{if(String(e?.activeTab||"").trim().toLowerCase()!=="dashboard")return;if(n.target?.closest?.("[data-dashboard-retry]")){$({force:!0});return}const r=n.target?.closest?.("[data-dashboard-composer]");r&&(n.preventDefault(),ce(r.getAttribute("data-dashboard-composer")))}catch{}}))}function A(n=""){const r=e?.userProfile||{},o=n?I(n)||{}:{},d=String(o.name||o.restaurantName||r.name||"").trim()||"Business";let c="";try{c=String(te()||"").trim()}catch{}if(!c)try{c=String(ee(o)||"").trim()}catch{}return{name:d,logoUrl:c,kind:T()}}function ye(){De(_),fe();const n=L(),r=F();let o="";if(!r)o=ue()?`${He()}${G({kpiCount:6})}`:Le();else{le();const d=A(r),c=je({kind:d.kind,isOwner:Y(e?.userProfile),canAccessOrders:W(e?.userProfile)}),p=Re(d.kind);n.status==="idle"&&(n.status="loading",queueMicrotask(()=>{$({force:!1})}));let f="";n.model?f=`
          ${Be({kpiDefs:p,week:n.model.week,today:n.model.today})}
          ${Oe({posts:n.model.posts,iconFn:b})}
        `:n.status==="error"?f=Ke({message:n.error}):f=G({kpiCount:p.length}),o=`
