const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/business-composer-controller-DbKb1kKN.js","chunks/domain-feed-social-eager-OhR3O8wA.js","chunks/domain-auth-Aq-4Vdvh.js","chunks/domain-public-profile-mLQti0eH.js","chunks/domain-media-eager-DAUyCk2O.js","chunks/domain-menu-eager-CYfDPyJD.js","chunks/profile-post-card-markup-utils-HwqIiXgP.js"])))=>i.map(i=>d[i]);
import{_ as ke}from"./domain-auth-Aq-4Vdvh.js";import{f as C,r as xe,l as Se,s as W}from"./domain-analytics-iIt7l8AQ.js";import{b as ze}from"./domain-business-accounts-D8NpUhi6.js";const De=20,Pe=8;function z(e=""){return e==null?"":String(e).trim()}function M(e){if(e==null||e==="")return null;const a=Number(String(e).replace(",","."));return Number.isFinite(a)&&a>0?a:null}function Fe(e=Date.now(),a=Math.random()){const t=Math.max(0,Number(e)||0).toString(36),o=Math.floor(Math.max(0,Math.min(.999999,Number(a)||0))*36**6).toString(36).padStart(6,"0");return`room_${t}_${o}`}function Ce(e={}){const a=e&&typeof e=="object"?e:{},t=[...Array.isArray(a.images)?a.images:[],z(a.imageUrl??a.image??a.photoUrl)],o=[];return t.forEach(n=>{const l=z(n);l&&!o.includes(l)&&o.push(l)}),o.slice(0,Pe)}function Be(e={},{index:a=0}={}){const t=e&&typeof e=="object"?e:{},o=M(t.persons??t.guests??t.capacity),n=M(t.size??t.sizeSqm??t.area),l=Ce(t);return{id:z(t.id)||Fe(Date.now()+a),title:z(t.title??t.name),description:z(t.description??t.text).slice(0,400),imageUrl:l[0]||"",images:l,price:M(t.price??t.pricePerNight),currency:z(t.currency??t.currencyCode).toUpperCase()||"EUR",persons:o==null?null:Math.min(20,Math.round(o)),beds:z(t.beds??t.bedsLabel).slice(0,60),size:n==null?null:Math.min(500,Math.round(n)),tag:z(t.tag??t.badge).slice(0,40),active:t.active!==!1}}function $e(e=[]){return(Array.isArray(e)?e:[]).slice(0,De).map((a,t)=>Be(a,{index:t}))}function Re(e={}){return $e((e&&typeof e=="object"?e:{}).hotelRooms).filter(t=>t.title)}function fa(e={}){const a=[];return Number.isFinite(e?.persons)&&e.persons>0&&a.push({icon:"users",label:`${e.persons} persona`}),z(e?.beds)&&a.push({icon:"bed",label:z(e.beds)}),Number.isFinite(e?.size)&&e.size>0&&a.push({icon:"size",label:`${e.size} m²`}),a}function ya(e={}){const a=Number(e?.price);if(!Number.isFinite(a)||a<=0)return"";const t=z(e?.currency).toUpperCase()||"EUR",o=Number.isInteger(a)?String(a):a.toFixed(2);return t==="EUR"?`€${o}`:`${o} ${t}`}const J="mnyraDashboardStyles",je=`
.mnyra-dash {
...
`;function Ee(e=typeof document>"u"?null:document){if(!(!e||e.getElementById(J)))try{const a=e.createElement("style");a.id=J,a.textContent=je,e.head?.appendChild(a)}catch{}}function c(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function v(e,a,t=""){if(typeof e!="function")return"";try{return e(a,t)||""}catch{return""}}const Ke=Object.freeze(["hotel","motel","hostel","resort","accommodation","travel"]);function Te({businessType:e="",isShopCatalog:a=!1}={}){if(a)return"shop";const t=String(e||"").trim().toLowerCase();return Ke.includes(t)?"hotel":"restaurant"}function Ue({kind:e="restaurant",isOwner:a=!1}={}){const t=[];return e==="hotel"?t.push({nav:"menu",iconName:"bed-double",label:"Hotel & Dhoma",sub:"Detaje, dhoma, oferta"}):e==="shop"?t.push({nav:"menu",iconName:"shopping-bag",label:"Ndrysho dyqanin",sub:"Produkte & Stok"}):t.push({nav:"menu",iconName:"utensils",label:"Ndrysho menune",sub:"Produkte & Kategorien"}),t.push({nav:"menu",iconName:"megaphone",label:"Oferta & Reklama",sub:"Im Editor verwalten"}),a&&t.push({nav:"businessAccounts",iconName:"users-round",label:"Team & Staff",sub:"Zugänge verwalten"}),t.push({nav:"settings",iconName:"settings",label:"Cilesimet",sub:"Profili & Kontakti"}),t}function Ae(e=new Date().getHours()){const a=Number.isFinite(Number(e))?(Math.trunc(Number(e))%24+24)%24:12;return a>=5&&a<=10?{dayPart:"mengjes",text:"Ju urojmë një mëngjes të mbarë!"}:a>=11&&a<=17?{dayPart:"dite",text:"Ju urojmë një ditë të mbarë!"}:a>=18&&a<=21?{dayPart:"mbremje",text:"Ju urojmë një mbrëmje të mbarë!"}:{dayPart:"nate",text:"Ju urojmë një natë të mbarë!"}}function Ie({name:e="",logoUrl:a="",hour:t=new Date().getHours(),iconFn:o}={}){const n=Ae(t),l=c(e||"Business");return`
  ...
  `}function He({actions:e=[],iconFn:a}={}){return`<div class="mnyra-dash__actions">${(Array.isArray(e)?e:[]).map(o=>`
    ...
    `}).join("");return`
    <div class="mnyra-dash__hl" data-dashboard-metrics="${c(Ve(t))}">
      ${o}
      <span class="mnyra-dash__hl-tail" aria-hidden="true"></span>
    </div>
  `}function Ve(e=[]){return(Array.isArray(e)?e:[]).filter(a=>a&&a.key).map(a=>[a.key,a.label||"",a.value||"",a.emptyText||"",a.imageUrl||"",a.videoUrl||"",a.iconName||"",a.panelTab||"",a.composer||"",a.pending?"p":"",a.loading?"l":"",a.locked?"x":"",a.withEye?"e":""].join("~")).join("|")}const ee=Object.freeze([Object.freeze({id:"funksionet",label:"Funksionet",iconName:"layout-grid"}),Object.freeze({id:"analitika",label:"Analitika",iconName:"bar-chart-3"}),Object.freeze({id:"opsionet",label:"Opsionet",iconName:"settings"})]);function T(e=""){const a=String(e||"").trim().toLowerCase();return ee.some(t=>t.id===a)?a:"funksionet"}function qe({activeTab:e="funksionet",iconFn:a}={}){const t=T(e);return`<div class="mnyra-dash__tabs" role="tablist" data-dashboard-panel-tabs>${ee.map(n=>{const l=n.id===t;return`
      <button
        type="button"
        role="tab"
    ...
    `}).join("")}</div>`}function Ge(e=""){return`
    <div class="mnyra-dash__bento" data-dashboard-bento>
      ${e}
    </div>
  `}function We({posts:e=[],iconFn:a}={}){const t=Array.isArray(e)?e:[];let o="";return t.length?(o=t.map(n=>{const l=[n.dateLabel,`${C(n.likesCount||0)} Likes`,`${C(n.commentsCount||0)} Kommentare`];return Number(n.impressions||0)>0&&l.push(`${C(n.impressions)} shtrirje (7 dite)`),`
  ...
  `}function Ye(){return'<div class="mnyra-dash__skeleton" style="min-height:44px; border-radius:14px; margin: 4px 0 16px;"></div>'}function Qe({message:e=""}={}){return`
  ...
  `}const ea="menyra_social_dashboard_cache_v1::",X="menyra_social_composer_products_v1::",aa=2500,ta=1200,na=6,ra=3,sa=Object.freeze({menuImageUrl:"/apps/menyra-social/assets/panel/menu-scan.jpg",qrImageUrl:"/apps/menyra-social/assets/panel/qr-stand.jpg"}),ia=Object.freeze({menuOpens:"Menü-Aufrufe",qrScans:"QR-Scans"});function _(e){const a=Number(e);return Number.isFinite(a)?a:0}function oa(e={}){const a=String(e.createdAtClient||"").trim();if(a){const o=new Date(a);if(!Number.isNaN(o.getTime()))return o}const t=e.createdAt;if(t&&typeof t.toDate=="function")try{const o=t.toDate();if(o instanceof Date&&!Number.isNaN(o.getTime()))return o}catch{}return null}function da(e="",a={}){const t=Array.isArray(a.media)&&a.media.length?a.media[0]:{},o=String(t.type||a.mediaType||"image").trim().toLowerCase()==="video"?"video":"image",n=String(t.thumbUrl||(o==="image"?t.url:"")||a.thumbUrl||"").trim(),l=o==="video"?String(t.url||a.mediaUrl||"").trim():"",m=oa(a);return{id:String(e||"").trim(),caption:String(a.caption||"").trim(),mediaType:o,thumbUrl:n,videoUrl:l,likesCount:_(a.likesCount),commentsCount:_(a.commentsCount),impressions:0,dateLabel:m?m.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit"}):"",createdAtMs:m?m.getTime():0}}function la({days:e=[],todayKey:a="",rawPosts:t=[]}={}){const o=Array.isArray(e)?e:[],n=W(o),l=o.find(p=>String(p?.date||p?.id||"").trim()===String(a||"").trim()),m=W(l?[l]:[]),u=n.merged?.posts&&typeof n.merged.posts=="object"?n.merged.posts:{},k=(Array.isArray(t)?t:[]).map(p=>da(p?.id,p?.data||{})).filter(p=>p.id).map(p=>({...p,impressions:_(u[p.id]?.impressions)})),D=k.slice().sort((p,f)=>f.createdAtMs-p.createdAtMs).slice(0,ra);return{day:String(a||"").trim(),week:n.summary,today:m.summary,posts:D,latestPost:ca(k)}}function ca(e=[]){const a=(Array.isArray(e)?e:[]).filter(t=>t&&t.id);return a.length?a.slice().sort((t,o)=>_(o.createdAtMs)-_(t.createdAtMs)||_(o.impressions)-_(t.impressions)||_(o.likesCount)-_(t.likesCount))[0]:null}function ha({profile:e={},restaurant:a={}}={}){return ze({profile:e,restaurant:a,feature:"qr"})}function ua(e={}){const a=e&&typeof e=="object"?e:{};return String(a.titleImageUrl||a.coverImageUrl||a.coverUrl||a.heroUrl||a.bannerUrl||"").trim()}function ma({model:e=null,coverUrl:a="",subscribed:t=!1,assets:o={}}={}){const n=e?.today||{},l=!e,m=e?.latestPost||null,u=[];if(l)u.push({key:"latestPost",label:"Postimi fundit",pending:!0});else if(!m)u.push({key:"latestPost",label:"Postimi fundit",emptyText:"S'ka postim",iconName:"image",composer:"post"});else{const k=String(m.thumbUrl||"").trim();u.push({key:"latestPost",label:"Postimi fundit",value:C(_(m.impressions)),withEye:!0,imageUrl:k,videoUrl:k?"":String(m.videoUrl||"").trim(),iconName:"image",panelTab:"analitika"})}return u.push({key:"profileViews",label:"Vizitor n'profil",value:C(_(n.profileViews)),withEye:!0,loading:l,imageUrl:String(a||"").trim(),iconName:"user",panelTab:"analitika"}),u.push({key:"menuOpens",label:"Vizitor n'meny",value:C(_(n.menuOpens)),withEye:!0,loading:l&&t,locked:!t,imageUrl:String(o.menuImageUrl||"").trim(),iconName:"book-open",panelTab:"analitika"}),u.push({key:"qrScans",label:"Skanime n'tavolina",value:C(_(n.qrScans)),withEye:!0,loading:l&&t,locked:!t,imageUrl:String(o.qrImageUrl||"").trim(),iconName:"layout-grid",panelTab:"analitika"}),u}function _a({state:e,renderFn:a,documentObj:t,firestoreApi:o={},profileApi:n={},composerApi:l={},viewApi:m={},iconFn:u,storageObj:k}={}){const D=t||(typeof document>"u"?null:document),p=D?.defaultView||(typeof window>"u"?null:window),f=typeof a=="function"?a:()=>{},y=k||(typeof localStorage>"u"?null:localStorage),U=typeof n.getBusinessProfileTypeFn=="function"?n.getBusinessProfileTypeFn:(()=>""),ae=typeof n.isShopCatalogProfileFn=="function"?n.isShopCatalogProfileFn:(()=>!1),te=typeof n.isBusinessOwnerProfileFn=="function"?n.isBusinessOwnerProfileFn:(()=>!1),A=typeof n.getRestaurantMetaByIdFn=="function"?n.getRestaurantMetaByIdFn:(()=>null),ne=typeof n.resolveRestaurantLogoFn=="function"?n.resolveRestaurantLogoFn:(()=>""),re=typeof n.resolveOwnAvatarUrlFn=="function"?n.resolveOwnAvatarUrlFn:(()=>""),se=typeof m.renderAnalyticsViewFn=="function"?m.renderAnalyticsViewFn:(()=>""),ie=typeof m.renderSettingsViewFn=="function"?m.renderSettingsViewFn:(()=>"");let B=0,L=!1,F=null,$=null,R="",O=!1,H=()=>null;const oe=300;function I(){const r=e?.userProfile||{};return Te({businessType:U(r),isShopCatalog:ae(r)})}function de(r=""){const s=A(r)||{};return Re(s).map(i=>({id:i.id,name:i.title,price:i.price??"",category:i.beds||i.tag||"",type:"room",imageUrl:i.imageUrl||""}))}function le(r=""){if(!y)return null;try{const s=y.getItem(`${X}${r}`);if(!s)return null;const i=JSON.parse(s),d=Array.isArray(i?.items)?i.items:null;return d&&d.length?d:null}catch{return null}}function ce(r="",s=[]){if(y)try{y.setItem(`${X}${r}`,JSON.stringify({savedAt:Date.now(),items:s}))}catch{}}async function he(r=""){const{db:s,collectionFn:i,queryFn:d,limitFn:h,getDocsFn:g}=o;if(!s||typeof i!="function"||typeof g!="function")throw new Error("Produktet nuk u ngarkuan.");const x=i(s,"restaurants",r,"menuItems"),w=typeof d=="function"&&typeof h=="function"?d(x,h(oe)):x,S=await g(w),b=[];return S.forEach(P=>{const K=H(P?.id,P?.data?.()||{});K&&b.push(K)}),b.sort((P,K)=>P.name.localeCompare(K.name,"sq")),b}async function ue(r="",s){const i=String(r||"").trim();if(!i)throw new Error("Produktet nuk u ngarkuan.");if(I()==="hotel")return de(i);const d=he(i).then(g=>(ce(i,g),g)),h=le(i);return h?(typeof s=="function"?d.then(g=>s(g)).catch(()=>{}):d.catch(()=>{}),h):d}function Z(){return F?Promise.resolve(F):($||($=ke(()=>import("./business-composer-controller-DbKb1kKN.js"),__vite__mapDeps([0,1,2,3,4,5,6])).then(r=>(H=typeof r?.normalizeComposerProductCore=="function"?r.normalizeComposerProductCore:(()=>null),F=r.createBusinessComposerController({documentObj:D,windowObj:D?.defaultView||null,api:{getRestaurantIdFn:()=>j(),getBusinessMetaFn:()=>{const s=j();if(!s)return{name:"",logoUrl:"",city:""};const i=G(s),d=A(s)||{};return{name:i.name,logoUrl:i.logoUrl,city:String(d.city||"").trim()}},loadProductsFn:(s,i)=>ue(s,i),getBusinessKindFn:()=>I(),uploadImageFn:l.uploadImageFn,uploadVideoFn:l.uploadVideoFn,captureVideoPosterFn:l.captureVideoPosterFn,createPostFn:l.createPostFn,createStoryFn:l.createStoryFn,formatPriceFn:l.formatPriceFn,getOptimizedImageUrlFn:l.getOptimizedImageUrlFn,escapeHtmlFn:l.escapeHtmlFn,iconFn:typeof u=="function"?u:void 0,afterPublishFn:async s=>{try{await E({force:!0})}catch{}typeof l.afterPublishFn=="function"&&await l.afterPublishFn(s)}}}),F)).catch(r=>{throw $=null,console.error("[mnyra][dashboard] composer load failed",r),r})),$)}function me(){const r=p?.navigator?.connection;return!r||typeof r!="object"?!1:r.saveData===!0?!0:/(^|-)2g$/.test(String(r.effectiveType||"").trim().toLowerCase())}function pe(){if(O||F||!p||me())return;O=!0;const r=()=>{if(Z().catch(()=>{}),typeof l.prewarmFn=="function")try{l.prewarmFn()}catch{}};if(typeof p.requestIdleCallback=="function"){p.requestIdleCallback(r,{timeout:aa});return}p.setTimeout?.(r,ta)}function ge(r="post"){const s=String(r||"").trim().toLowerCase(),i=s==="story"||s==="profile"?s:"post";if(typeof l.prewarmFn=="function")try{l.prewarmFn()}catch{}if(F){F.open(i);return}R=i,Z().then(d=>{const h=R||i;R="",d?.open?.(h)}).catch(()=>{R=""})}function N(){return(!e.dashboardView||typeof e.dashboardView!="object")&&(e.dashboardView={status:"idle",error:"",model:null,loadedSignature:"",restaurantId:"",paywall:""}),e.dashboardView}function V(r=""){const s=N(),i=String(r||"").trim();return String(s.restaurantId||"")===i||(s.restaurantId=i,s.model=null,s.status="idle",s.error="",s.loadedSignature="",s.paywall="",B+=1),s}function j(){const r=e?.userProfile||{};return String(r.restaurantId||r.staffRestaurantId||"").trim()}function be(){const r=String(e?.user?.uid||"").trim();if(!r)return!1;const s=String(e?.__authBootstrapInFlightUid||"").trim();return!!e?.__authProfileLoadPromise||s===r}function q(r=""){return`${ea}${r}`}function fe(r="",s=""){if(!y||!r)return null;try{const i=y.getItem(q(r));if(!i)return null;const d=JSON.parse(i);return!d||typeof d!="object"||String(d.day||"").trim()!==String(s||"").trim()||!d.model||typeof d.model!="object"?null:d.model}catch{return null}}function ye(r="",s=null){if(!(!y||!r||!s))try{y.setItem(q(r),JSON.stringify({day:s.day,model:s}))}catch{}}async function _e(r=""){const{db:s,collectionFn:i,queryFn:d,orderByFn:h,limitFn:g,getDocsFn:x}=o;if(!s||typeof i!="function"||typeof d!="function"||typeof h!="function"||typeof g!="function"||typeof x!="function")return[];const w=i(s,"restaurants",r,"socialPosts");return(await x(d(w,h("createdAt","desc"),g(na)))).docs.map(b=>({id:b.id,data:b.data()||{}})).filter(b=>{const P=String(b.data.status||"active").trim().toLowerCase();return P!=="deleted"&&P!=="hidden"})}async function E({force:r=!1}={}){const s=j(),i=V(s);if(!s)return;const d=xe({rangeKey:"7d"});if(!d)return;const h=`${s}::${d.toDay}`;if(!r&&i.loadedSignature===h&&i.status==="ready")return;if(!i.model){const w=fe(s,d.toDay);w&&(i.model=w,i.status="ready",f())}B+=1;const g=B;i.model||(i.status="loading",i.error="",f());try{const w={db:o.db,collectionFn:o.collectionFn,queryFn:o.queryFn,whereFn:o.whereFn,documentIdFn:o.documentIdFn,getDocsFn:o.getDocsFn,restaurantId:s},[S,b]=await Promise.allSettled([Se({...w,fromDay:d.fromDay,toDay:d.toDay}),_e(s)]);if(g!==B)return;if(S.status==="rejected")throw S.reason;b.status==="rejected"&&console.error("[mnyra][dashboard] recent posts load failed",b.reason),i.model=la({days:S.value,todayKey:d.toDay,rawPosts:b.status==="fulfilled"?b.value:[]}),i.status="ready",i.error="",i.loadedSignature=h,ye(s,i.model)}catch(w){if(g!==B)return;console.error("[mnyra][dashboard] load failed",w),i.model||(i.status="error",i.error="Ju lutem kontrollo lidhjen dhe provo perseri.")}f()}function ve(){L||!D||(L=!0,D.addEventListener("click",r=>{try{if(String(e?.activeTab||"").trim().toLowerCase()!=="dashboard")return;if(r.target?.closest?.("[data-dashboard-retry]")){E({force:!0});return}if(r.target?.closest?.("[data-dashboard-paywall-close]")){r.preventDefault(),N().paywall="",f();return}const s=r.target?.closest?.("[data-dashboard-metric-locked]");if(s){r.preventDefault(),N().paywall=String(s.getAttribute("data-dashboard-metric-locked")||"").trim(),f();return}const i=r.target?.closest?.("[data-dashboard-composer]");if(i){r.preventDefault(),ge(i.getAttribute("data-dashboard-composer"));return}const d=r.target?.closest?.("[data-dashboard-panel-tab]");if(d){r.preventDefault();const h=T(d.getAttribute("data-dashboard-panel-tab"));if(h===T(e?.dashboardPanelTab))return;e.dashboardPanelTab=h,f()}}catch{}}))}function G(r=""){const s=e?.userProfile||{},i=r?A(r)||{}:{},d=String(i.name||i.restaurantName||s.name||"").trim()||"Business";let h="";try{h=String(re()||"").trim()}catch{}if(!h)try{h=String(ne(i)||"").trim()}catch{}return{name:d,logoUrl:h,kind:I(),coverUrl:ua(i),subscribed:ha({profile:s,restaurant:i})}}function we(){Ee(D),ve();const r=j(),s=V(r);let i="";if(!r)i=be()?`${Ye()}${Q()}`:Xe();else{pe();const d=G(r),h=Ue({kind:d.kind,isOwner:te(e?.userProfile)}),g=T(e?.dashboardPanelTab);s.status==="idle"&&(s.status="loading",queueMicrotask(()=>{E({force:!1})}));let x="";s.model?x=We({posts:s.model.posts,iconFn:u}):s.status==="error"?x=Qe({message:s.error}):x=Q();const w=`
        ${Ne({iconFn:u})}
        ${Me({iconFn:u,showEditor:!!r})}
        ${Oe({iconFn:u,kind:d.kind,showEditor:!!r})}
        ${He({actions:h,iconFn:u})}
        ${x}
      `;let S;g==="analitika"?S=`<div class="mnyra-dash__embed">${se()}</div>`:g==="opsionet"?S=`<div class="mnyra-dash__embed">${ie()}</div>`:S=w;const b=ma({model:s.model,coverUrl:d.coverUrl,subscribed:d.subscribed,assets:sa}),P=String(s.paywall||"").trim();i=`
        ${Ie({name:d.name,logoUrl:d.logoUrl,iconFn:u})}
        ${Ze({cards:b,iconFn:u})}
        ${Ge(`
          ${qe({activeTab:g,iconFn:u})}
          ${S}
        `)}
        ${P?Je({title:ia[P]||"Me pagesë"}):""}
      `}return`
      <section class="mnyra-dash" data-dashboard-root>
        ${i}
      </section>
    `}return Object.freeze({renderDashboardView:we,loadDashboard:E})}export{Pe as M,_a as a,Re as b,Fe as c,fa as d,ya as f,$e as n};
