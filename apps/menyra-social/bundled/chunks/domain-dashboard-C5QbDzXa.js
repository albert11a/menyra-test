const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/business-composer-controller-okdh5aGB.js","chunks/domain-feed-social-eager-BA1YPbQa.js","chunks/domain-auth-B1kS5TG-.js","chunks/domain-public-profile-mLQti0eH.js","chunks/domain-media-eager-DAUyCk2O.js","chunks/domain-menu-eager-CbFu4CLi.js","chunks/profile-post-card-markup-utils-HwqIiXgP.js"])))=>i.map(i=>d[i]);
import{_ as Tt}from"./domain-auth-B1kS5TG-.js";import{f as ee,r as Nt,l as Gt,s as Ke}from"./domain-analytics-i6lAJYIg.js";import{b as It}from"./domain-business-accounts-D8NpUhi6.js";import{i as Lt,e as Ut,a as Ht}from"./domain-feed-social-eager-BA1YPbQa.js";const Zt=20,Vt=8;function K(e=""){return e==null?"":String(e).trim()}function ye(e){if(e==null||e==="")return null;const t=Number(String(e).replace(",","."));return Number.isFinite(t)&&t>0?t:null}function Wt(e=Date.now(),t=Math.random()){const a=Math.max(0,Number(e)||0).toString(36),n=Math.floor(Math.max(0,Math.min(.999999,Number(t)||0))*36**6).toString(36).padStart(6,"0");return`room_${a}_${n}`}function qt(e={}){const t=e&&typeof e=="object"?e:{},a=[...Array.isArray(t.images)?t.images:[],K(t.imageUrl??t.image??t.photoUrl)],n=[];return a.forEach(r=>{const i=K(r);i&&!n.includes(i)&&n.push(i)}),n.slice(0,Vt)}function Qt(e={},{index:t=0}={}){const a=e&&typeof e=="object"?e:{},n=ye(a.persons??a.guests??a.capacity),r=ye(a.size??a.sizeSqm??a.area),i=qt(a);return{id:K(a.id)||Wt(Date.now()+t),title:K(a.title??a.name),description:K(a.description??a.text).slice(0,400),imageUrl:i[0]||"",images:i,price:ye(a.price??a.pricePerNight),currency:K(a.currency??a.currencyCode).toUpperCase()||"EUR",persons:n==null?null:Math.min(20,Math.round(n)),beds:K(a.beds??a.bedsLabel).slice(0,60),size:r==null?null:Math.min(500,Math.round(r)),tag:K(a.tag??a.badge).slice(0,40),active:a.active!==!1}}function Yt(e=[]){return(Array.isArray(e)?e:[]).slice(0,Zt).map((t,a)=>Qt(t,{index:a}))}function Jt(e={}){return Yt((e&&typeof e=="object"?e:{}).hotelRooms).filter(a=>a.title)}function Mn(e={}){const t=[];return Number.isFinite(e?.persons)&&e.persons>0&&t.push({icon:"users",label:`${e.persons} persona`}),K(e?.beds)&&t.push({icon:"bed",label:K(e.beds)}),Number.isFinite(e?.size)&&e.size>0&&t.push({icon:"size",label:`${e.size} m²`}),t}function Rn(e={}){const t=Number(e?.price);if(!Number.isFinite(t)||t<=0)return"";const a=K(e?.currency).toUpperCase()||"EUR",n=Number.isInteger(t)?String(t):t.toFixed(2);return a==="EUR"?`€${n}`:`${n} ${a}`}const tt="all",Xt=Object.freeze([{key:tt,label:"Krejt",icon:"sparkles"},{key:"coffee",label:"Kafe",icon:"coffee"},{key:"drinks",label:"Pije",icon:"cup-soda"},{key:"food",label:"Ushqim",icon:"utensils"},{key:"dessert",label:"Ëmbëlsira",icon:"cake-slice"}]),ea=Object.freeze(Xt.map(e=>e.key)),ta="food",aa="drinks",na="unsure",at=Object.freeze([Object.freeze({key:ta,label:"Ushqim",hint:"Mëngjes, drekë, darkë, ëmbëlsirë",icon:"utensils",categories:Object.freeze(["food","dessert"])}),Object.freeze({key:aa,label:"Pije",hint:"Kafe, lëngje dhe pije të tjera",icon:"cup-soda",categories:Object.freeze(["coffee","drinks"])}),Object.freeze({key:na,label:"Nuk e di",hint:"Gjitha ofertat për rreth teje.",icon:"sparkles",categories:Object.freeze([])})]);Object.freeze(at.map(e=>e.key));const En=1,Te=10,Bn=2,re=Object.freeze([{key:"1-2",min:1,max:2,label:"1–2"},{key:"3-4",min:3,max:4,label:"3–4"},{key:"5-6",min:5,max:6,label:"5–6"},{key:"7+",min:7,max:99,label:"7+"}]),ra=Object.freeze([{key:"2-4",min:2,max:4,label:"2–4"},{key:"4-6",min:4,max:6,label:"4–6"},{key:"6+",min:6,max:99,label:"6+"}]);function Kn(e=[]){const t=Array.isArray(e)?e:e?[e]:[],a=[];return t.forEach(n=>{const r=ze(n);r&&re.forEach(i=>{i.min>r.max||i.max<r.min||a.includes(i.key)||a.push(i.key)})}),re.filter(n=>a.includes(n.key)).map(n=>n.key)}function ze(e=""){const t=String(e||"").trim().toLowerCase();return re.find(a=>a.key===t)||ra.find(a=>a.key===t)||null}const ie="Europe/Belgrade",nt=1440,I=["mon","tue","wed","thu","fri","sat","sun"],ia=Object.freeze({mon:"Hën",tue:"Mar",wed:"Mër",thu:"Enj",fri:"Pre",sat:"Sht",sun:"Die"});function ve(e=""){const t=String(e||"").trim().toLowerCase();return ia[t]||t}function sa(e=[]){const t=Array.isArray(e)?e:[],a=I.filter(r=>t.includes(r));if(!a.length||a.length===I.length)return"";const n=[];return a.forEach(r=>{const i=I.indexOf(r),d=n[n.length-1];if(d&&d.end===i-1){d.end=i;return}n.push({start:i,end:i})}),n.map(r=>{const i=ve(I[r.start]),d=ve(I[r.end]);return r.start===r.end?i:r.end===r.start+1?`${i}, ${d}`:`${i}–${d}`}).join(", ")}const Ne=new Map;function rt(e){const t=String(e||"").trim()||ie,a=Ne.get(t);if(a)return a;let n=null;try{n=new Intl.DateTimeFormat("en-GB",{timeZone:t,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",weekday:"short"})}catch{n=rt(ie)}return Ne.set(t,n),n}const oa={mon:"mon",tue:"tue",wed:"wed",thu:"thu",fri:"fri",sat:"sat",sun:"sun"};function Ae(e){if(e==null||e==="")return 0;if(typeof e=="number")return Number.isFinite(e)?e:0;if(e instanceof Date){const n=e.getTime();return Number.isNaN(n)?0:n}if(typeof e=="object"){if(typeof e.toDate=="function")try{const n=e.toDate(),r=n instanceof Date?n.getTime():NaN;return Number.isNaN(r)?0:r}catch{return 0}return Number.isFinite(Number(e.seconds))?Math.round(Number(e.seconds)*1e3):Number.isFinite(Number(e._seconds))?Math.round(Number(e._seconds)*1e3):0}const a=new Date(String(e)).getTime();return Number.isNaN(a)?0:a}function C(e){const t=Ae(e);return t?new Date(t).toISOString():""}function we(e,t=ie){const a=Ae(e)||Date.now(),n=rt(t).formatToParts(new Date(a)),r=m=>{const g=n.find(w=>w.type===m);return g?g.value:""},i=r("year"),d=r("month"),c=r("day"),b=r("hour")==="24"?"00":r("hour"),x=r("minute"),p=String(r("weekday")||"").slice(0,3).toLowerCase();return{ms:a,dayKey:i&&d&&c?`${i}-${d}-${c}`:"",weekday:oa[p]||"",minutes:(Number(b)||0)*60+(Number(x)||0),timeZone:String(t||"").trim()||ie}}function da(e){const t=String(e??"").trim();if(!t)return-1;const a=t.match(/^(\d{1,2})\s*[:.：]?\s*(\d{2})?$/);if(!a)return-1;const n=Number(a[1]),r=a[2]===void 0?0:Number(a[2]);return!Number.isFinite(n)||!Number.isFinite(r)||n>24||r>59?-1:n*60+r}function ke(e){const t=Math.max(0,Math.round(Number(e)||0))%nt,a=Math.floor(t/60),n=t%60;return`${String(a).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function Ge(e){return typeof e=="number"?Number.isFinite(e)?Math.max(0,Math.round(e)):-1:da(e)}function la(e,t){const a=Ge(e);let n=Ge(t);return a<0||n<0||n===a?null:(n<a&&(n+=nt),{start:a,end:n})}function ca(e=[]){const t=Array.isArray(e)?e:[],a=[];return t.forEach(n=>{if(!n||typeof n!="object")return;const r=la(n.start??n.from,n.end??n.to);r&&a.push(r)}),ha(a)}function ha(e=[]){const t=(Array.isArray(e)?e:[]).filter(n=>n&&Number.isFinite(n.start)&&Number.isFinite(n.end)&&n.end>n.start).slice().sort((n,r)=>n.start-r.start||n.end-r.end),a=[];return t.forEach(n=>{const r=a[a.length-1];if(r&&n.start<=r.end){r.end=Math.max(r.end,n.end);return}a.push({start:n.start,end:n.end})}),a}const ua="active",Ie="paused",Le="archived",Ue="go",pa="public",Q="percent",Y="bundle",ae="freeItem",ne="specialPrice",ma=Object.freeze([Q,Y,ae,ne]),it=Object.freeze(["all","food","drinks"]),fa=Object.freeze(["food","drink","any_order","custom"]),ga=Object.freeze({all:"",food:"në ushqim",drinks:"në pije"}),ba=Object.freeze({food:"me porosi ushqimi",drink:"me porosi të pijes",any_order:"me çdo porosi"});function y(e="",t=240){return String(e??"").trim().slice(0,t)}function ya(e=""){const t=y(e,500);return t&&(t.startsWith("/")&&!t.startsWith("//")||/^https:\/\/[^\s]+$/i.test(t))?t:""}const $e=9999999;function _a(e){if(typeof e=="number")return!Number.isFinite(e)||e<=0?0:Math.min($e,Math.round(e*100));const t=String(e??"").trim().replace(/[^\d.,]/g,"");if(!t)return 0;const a=Math.max(t.lastIndexOf(","),t.lastIndexOf(".")),n=a<0?"":t.slice(a+1),i=n.length===1||n.length===2?`${t.slice(0,a).replace(/[.,]/g,"")}.${n}`:t.replace(/[.,]/g,""),d=Number.parseFloat(i);return!Number.isFinite(d)||d<=0?0:Math.min($e,Math.round(d*100))}function me(e=0){const t=Math.max(0,Math.trunc(Number(e)||0));return t?`${(t/100).toFixed(2).replace(".",",")} €`:""}function He(e=0){const t=Math.max(0,Math.trunc(Number(e)||0));return t?(t/100).toFixed(2).replace(".",","):""}function te(e,t=0){const a=Math.trunc(Number(e));return!Number.isFinite(a)||a<0?t:a}function xa(e=""){const t=String(e||"").trim().toLowerCase();return t===Ie?Ie:t===Le?Le:ua}function va(e=""){const t=String(e||"").trim().toLowerCase();return ea.includes(t)?t:tt}function st(e="",t=0){const a=String(e||"").trim().toLowerCase();return a==="percent"||a==="discount"?Q:a==="bundle"?Y:a==="freeitem"||a==="free_item"?ae:a==="specialprice"||a==="special_price"?ne:a==="table"?"table":a==="custom"?"custom":t>0?Q:"custom"}function Se(e,t){const a=Math.trunc(Number(e));return Number.isFinite(a)&&a>0?Math.min($e,a):_a(t)}function Pe(e={}){const t=e&&typeof e=="object"?e:{},a=Math.min(90,Math.max(0,te(t.percent??t.discountPercent,0))),n=st(t.kind||t.type||t.offerType,a),r=String(t.scope||t.discountScope||"").trim().toLowerCase(),i=String(t.conditionType||t.condition||"").trim().toLowerCase(),d=Se(t.regularPriceCents,t.regularPrice),c=Se(t.goPriceCents,t.goPrice),b=c>0&&d>c?d-c:0,x={kind:n,percent:a,scope:it.includes(r)?r:"all",itemId:y(t.itemId,180),itemName:y(t.itemName||t.item||t.bundleTitle||t.productName||t.freeItem,160),priceText:y(t.priceText||t.price,60),regularPriceCents:d,goPriceCents:c,savingCents:b,savingPercent:b>0&&d>0?Math.round(b/d*1e4)/100:0,conditionType:fa.includes(i)?i:"",customCondition:y(t.customCondition,120),text:y(t.text,160)};return x.label=wa(x),x}function ot(e=""){const t=String(e||"").trim().toLowerCase();return ga[t]||""}function dt(e={}){const t=e&&typeof e=="object"?e:{},a=String(t.conditionType||"").trim().toLowerCase();return a==="custom"?y(t.customCondition,120):ba[a]||""}function lt(e={}){return me(Se(e.goPriceCents,e.goPrice))||y(e.priceText,60)}function wa(e={}){const t=e&&typeof e=="object"?e:{},a=y(t.text,160);if(a)return a;const n=te(t.percent,0),r=st(t.kind,n),i=y(t.itemName,160);if(r===Q)return n<=0?"":[`-${n}%`,ot(t.scope)].filter(Boolean).join(" ");if(r===ae)return i?[`${i} FALAS`,dt(t)].filter(Boolean).join(" "):"";if(r===Y||r===ne){const d=lt(t);return i?[i,d].filter(Boolean).join(" "):d}return r==="table"?"Tavolinë e rezervuar":""}function ct(e={}){const t=e&&typeof e=="object"&&e.label!==void 0?e:Pe(e),a={kind:t.kind||"",eyebrow:"",headline:t.label||"",note:"",priceRegular:"",priceGo:"",savingLabel:""},n=y(t.itemName,160);if(t.kind===Q){const r=te(t.percent,0);return a.headline=r>0?`-${r}%`:"",a.note=ot(t.scope),a}if(t.kind===ae)return a.headline=n?`${n} FALAS`:"",a.note=dt(t),a;if(t.kind===Y||t.kind===ne){a.eyebrow=t.kind===Y?"Paketë GO":"Çmim special GO",a.headline=n,a.priceRegular=me(t.regularPriceCents),a.priceGo=lt(t);const r=me(t.savingCents);return a.savingLabel=r?`Kursen ${r}`:"",a}return a}function ht(e){const t=Array.isArray(e)?e:e?[e]:[],a=[];return t.forEach(n=>{const r=String(n||"").trim().toLowerCase();ze(r)&&!a.includes(r)&&a.push(r)}),a.length?a:re.map(n=>n.key)}function ka(e=[]){const t=ht(e);let a=Number.POSITIVE_INFINITY,n=0;return t.forEach(r=>{const i=ze(r);i&&(a=Math.min(a,i.min),n=Math.max(n,i.max))}),!Number.isFinite(a)||!n?{min:1,max:99}:{min:a,max:n}}function $a(e={}){const t=e&&typeof e=="object"?e:{},a=String(t.mode||"").trim().toLowerCase()==="windows"?"windows":"always",n=[];(Array.isArray(t.days)?t.days:[]).forEach(d=>{const c=String(d||"").trim().toLowerCase();I.includes(c)&&!n.includes(c)&&n.push(c)});const i=ca((Array.isArray(t.windows)?t.windows:[]).map(d=>({start:d?.start??d?.from,end:d?.end??d?.to})));return a==="always"||!n.length&&!i.length?{mode:"always",days:I.slice(),windows:[]}:{mode:"windows",days:n.length?n:I.slice(),windows:i}}function Sa(e={}){const t=e&&typeof e=="object"?e:{},a=i=>{const d=y(i,10);return/^\d{4}-\d{2}-\d{2}$/.test(d)?d:""},n=a(t.startDate||t.from),r=a(t.endDate||t.to);return n&&r&&r<n?{startDate:r,endDate:n}:{startDate:n,endDate:r}}function za(e={}){const t=e&&typeof e=="object"?e:{};return{dailyGroups:te(t.dailyGroups??t.maxGroupsPerDay,0),totalRedemptions:te(t.totalRedemptions??t.maxRedemptions,0)}}function Aa(e){const t=Array.isArray(e)?e:[],a=[];return t.forEach(n=>{const r=String(n||"").trim().toLowerCase();(r===Ue||r===pa)&&!a.includes(r)&&a.push(r)}),a.length?a:[Ue]}function fe(e={},t=""){const a=e&&typeof e=="object"?e:{},n=ht(a.partyRanges||a.partySizes),r=ka(n),i=Pe(a.benefit);return{id:y(a.id||t,180),restaurantId:y(a.restaurantId,180),locationId:y(a.locationId,180)||"main",title:y(a.title,120),description:y(a.description||a.text,400),terms:y(a.terms||a.conditions,400),imageUrl:ya(a.imageUrl||a.image?.url||a.photoUrl),benefit:i,benefitLabel:i.label,category:va(a.category),partyRanges:n,minParty:r.min,maxParty:r.max,schedule:$a(a.schedule),dateRange:Sa(a.dateRange),limits:za(a.limits),channels:Aa(a.channels),status:xa(a.status),sponsored:a.sponsored===!0||a.sponsored?.active===!0,sponsoredUntil:C(a.sponsored?.until),priceLevel:Math.min(4,Math.max(0,te(a.priceLevel,0))),redeemedCount:te(a.redeemedCount,0),createdAt:C(a.createdAt),updatedAt:C(a.updatedAt)}}function Tn(e={},{serverTimestamp:t=null}={}){const a=fe(e),n={restaurantId:a.restaurantId,locationId:a.locationId,title:a.title,description:a.description,terms:a.terms,imageUrl:a.imageUrl,benefit:a.benefit,benefitLabel:a.benefitLabel,category:a.category,partyRanges:a.partyRanges,minParty:a.minParty,maxParty:a.maxParty,schedule:a.schedule,dateRange:a.dateRange,limits:a.limits,channels:a.channels,status:a.status,sponsored:a.sponsored,priceLevel:a.priceLevel};return t&&(n.updatedAt=t,a.createdAt||(n.createdAt=t)),n}function Pa(e={}){const t=e&&typeof e=="object"&&e.label!==void 0?e:Pe(e),a=[],n=y(t.itemName,160),r=(i="")=>{n||a.push({field:"benefitItem",message:i}),!(t.priceText&&!t.regularPriceCents&&!t.goPriceCents)&&(t.regularPriceCents||a.push({field:"regularPrice",message:"Shkruaj çmimin normal."}),t.goPriceCents||a.push({field:"goPrice",message:"Shkruaj çmimin GO."}),t.regularPriceCents&&t.goPriceCents&&t.goPriceCents>=t.regularPriceCents&&a.push({field:"goPrice",message:"Çmimi GO duhet të jetë më i ulët se çmimi normal."}))};return t.kind===Q?(t.percent<=0&&a.push({field:"benefitPercent",message:"Shkruaj zbritjen."}),it.includes(t.scope)||a.push({field:"benefitScope",message:"Zgjidh ku vlen zbritja."}),a):t.kind===ae?(n||a.push({field:"benefitItem",message:"Shkruaj çka merr klienti falas."}),t.conditionType?t.conditionType==="custom"&&!t.customCondition&&a.push({field:"benefitCondition",message:"Shkruaj kushtin e ofertës."}):a.push({field:"benefitCondition",message:"Zgjidh kushtin e ofertës."}),a):t.kind===Y?(r("Shkruaj çka përfshin paketa."),a):t.kind===ne?(r("Shkruaj produktin."),a):(t.label||a.push({field:"benefit",message:"Shkruaj çka po ofron."}),a)}function Da(e={}){const t=fe(e),a=[];return t.restaurantId||a.push({field:"restaurantId",message:"Lokali mungon."}),a.push(...Pa(t.benefit)),t.partyRanges.length||a.push({field:"partyRanges",message:"Zgjidh sa persona."}),t.schedule.mode==="windows"&&(t.schedule.days.length||a.push({field:"schedule",message:"Zgjidh ditët."}),t.schedule.windows.length||a.push({field:"schedule",message:"Zgjidh orarin."})),{ok:a.length===0,errors:a,offer:t}}function ut(e={}){const a=(e&&e.schedule?e:fe(e)).schedule;if(a.mode==="always")return"Gjithmonë";const n=sa(a.days),r=a.windows.map(i=>`${ke(i.start)}-${ke(i.end)}`).join(", ");return[n,r].filter(Boolean).join(" · ")}function pt(e={}){const t=e&&e.partyRanges?e:fe(e);return t.minParty<=1&&t.maxParty>=Te?"Të gjithë":`${t.maxParty>=Te?`${t.minParty}+`:`${t.minParty}–${t.maxParty}`} persona`}const mt=Object.freeze({x:[["path",{d:"M18 6 6 18"}],["path",{d:"m6 6 12 12"}]],users:[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"}],["circle",{cx:"9",cy:"7",r:"4"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87"}],["path",{d:"M16 3.13a4 4 0 0 1 0 7.75"}]],sparkles:[["path",{d:"M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"}],["path",{d:"M20 3v4"}],["path",{d:"M22 5h-4"}],["path",{d:"M4 17v2"}],["path",{d:"M5 18H3"}]],coffee:[["path",{d:"M10 2v2"}],["path",{d:"M14 2v2"}],["path",{d:"M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1h14a4 4 0 1 1 0 8h-1"}],["path",{d:"M6 2v2"}]],"cup-soda":[["path",{d:"m6 8 1.75 12.28a2 2 0 0 0 2 1.72h4.54a2 2 0 0 0 2-1.72L18 8"}],["path",{d:"M5 8h14"}],["path",{d:"M7 15a6.47 6.47 0 0 1 5 0 6.47 6.47 0 0 0 5 0"}],["path",{d:"m12 8 1-6h2"}]],utensils:[["path",{d:"M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"}],["path",{d:"M7 2v20"}],["path",{d:"M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7"}]],"cake-slice":[["circle",{cx:"9",cy:"7",r:"2"}],["path",{d:"M7.2 7.9 3 11v9c0 .6.4 1 1 1h16c.6 0 1-.4 1-1v-9c0-2-3-6-7-8l-3.6 2.6"}],["path",{d:"M16 13H3"}],["path",{d:"M16 17H3"}]],zap:[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"}]],timer:[["line",{x1:"10",x2:"14",y1:"2",y2:"2"}],["line",{x1:"12",x2:"15",y1:"14",y2:"11"}],["circle",{cx:"12",cy:"14",r:"8"}]],clock:[["circle",{cx:"12",cy:"12",r:"10"}],["polyline",{points:"12 6 12 12 16 14"}]],"calendar-clock":[["path",{d:"M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3.5"}],["path",{d:"M16 2v4"}],["path",{d:"M8 2v4"}],["path",{d:"M3 10h5"}],["path",{d:"M17.5 17.5 16 16.3V14"}],["circle",{cx:"16",cy:"16",r:"6"}]],"map-pin":[["path",{d:"M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"}],["circle",{cx:"12",cy:"10",r:"3"}]],search:[["circle",{cx:"11",cy:"11",r:"8"}],["path",{d:"m21 21-4.3-4.3"}]],"badge-percent":[["path",{d:"M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"}],["path",{d:"m15 9-6 6"}],["path",{d:"M9 9h.01"}],["path",{d:"M15 15h.01"}]],"check-check":[["path",{d:"M18 6 7 17l-5-5"}],["path",{d:"m22 10-7.5 7.5L13 16"}]],"party-popper":[["path",{d:"M5.8 11.3 2 22l10.7-3.79"}],["path",{d:"M4 3h.01"}],["path",{d:"M22 8h.01"}],["path",{d:"M15 2h.01"}],["path",{d:"M22 20h.01"}],["path",{d:"m22 2-2.24.75a2.9 2.9 0 0 0-1.96 3.12c.1.86-.57 1.63-1.45 1.63h-.38c-.86 0-1.6.6-1.76 1.44L14 10"}],["path",{d:"m22 13-.82-.33c-.86-.34-1.82.2-1.98 1.11c-.11.7-.72 1.22-1.43 1.22H17"}],["path",{d:"m11 2 .33.82c.34.86-.2 1.82-1.11 1.98C9.52 4.9 9 5.52 9 6.23V7"}],["path",{d:"M11 13c1.93 1.93 2.83 4.17 2 5-.83.83-3.07-.07-5-2-1.93-1.93-2.83-4.17-2-5 .83-.83 3.07.07 5 2Z"}]],gift:[["rect",{x:"3",y:"8",width:"18",height:"4",rx:"1"}],["path",{d:"M12 8v13"}],["path",{d:"M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7"}],["path",{d:"M7.5 8a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 8a4.8 8 0 0 1 4.5-5 2.5 2.5 0 0 1 0 5"}]],"shield-check":[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"}],["path",{d:"m9 12 2 2 4-4"}]],"ticket-percent":[["path",{d:"M2 9a3 3 0 1 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 1 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"}],["path",{d:"M9 9h.01"}],["path",{d:"m15 9-6 6"}],["path",{d:"M15 15h.01"}]],store:[["path",{d:"m2 7 4.41-4.41A2 2 0 0 1 7.83 2h8.34a2 2 0 0 1 1.42.59L22 7"}],["path",{d:"M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"}],["path",{d:"M15 22v-4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v4"}],["path",{d:"M2 7h20"}],["path",{d:"M22 7v3a2 2 0 0 1-2 2a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 16 12a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 12 12a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 8 12a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 4 12a2 2 0 0 1-2-2V7"}]],pencil:[["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"}],["path",{d:"m15 5 4 4"}]],armchair:[["path",{d:"M19 9V6a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v3"}],["path",{d:"M3 16a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5a2 2 0 0 0-4 0v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V11a2 2 0 0 0-4 0z"}],["path",{d:"M5 18v2"}],["path",{d:"M19 18v2"}]],"circle-check-big":[["path",{d:"M21.801 10A10 10 0 1 1 17 3.335"}],["path",{d:"m9 11 3 3L22 4"}]],"book-open":[["path",{d:"M12 7v14"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"}]],navigation:[["polygon",{points:"3 11 22 2 13 21 11 13 3 11"}]],"log-in":[["path",{d:"M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"}],["polyline",{points:"10 17 15 12 10 7"}],["line",{x1:"15",x2:"3",y1:"12",y2:"12"}]],"rotate-ccw":[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}],["path",{d:"M3 3v5h5"}]],"arrow-left":[["path",{d:"m12 19-7-7 7-7"}],["path",{d:"M19 12H5"}]],"chevron-right":[["path",{d:"m9 18 6-6-6-6"}]],"triangle-alert":[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"}],["path",{d:"M12 9v4"}],["path",{d:"M12 17h.01"}]],link:[["path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}],["path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"}]],copy:[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"}]],check:[["path",{d:"M20 6 9 17l-5-5"}]],hash:[["line",{x1:"4",x2:"20",y1:"9",y2:"9"}],["line",{x1:"4",x2:"20",y1:"15",y2:"15"}],["line",{x1:"10",x2:"8",y1:"3",y2:"21"}],["line",{x1:"16",x2:"14",y1:"3",y2:"21"}]],ban:[["circle",{cx:"12",cy:"12",r:"10"}],["path",{d:"m4.9 4.9 14.2 14.2"}]]}),ja=Object.freeze({xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":"true",focusable:"false"});function Ze(e={}){return Object.entries(e).map(([t,a])=>` ${t}="${a}"`).join("")}Object.freeze(Object.keys(mt));function ce(e="",t=""){const a=mt[String(e||"").trim()];if(!a)return"";const n=a.map(([i,d])=>`<${i}${Ze(d)}></${i}>`).join(""),r=String(t||"").trim();return`<svg${Ze(ja)}${r?` class="${r}"`:""}>${n}</svg>`}const Ve=Object.freeze({offering:"po ju ofron",forGroup:"për grupin tuaj",accept:"Prano ofertën",sponsored:"Sponsored",onlyGo:"Vetëm me Mnyra GO",tableIncluded:"Tavolinë",peopleSuffix:"persona"}),ft="clean",De="hero",je="compact",Fa=[ft,De,je];function Ca({imageUrl:e="",variant:t=""}={}){if(!String(e||"").trim())return ft;const a=String(t||"").trim().toLowerCase();return Fa.includes(a)?a:De}const gt=`
...
`;function F(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function bt({businessName:e="",logoUrl:t="",imageUrl:a="",variant:n="",benefitLabel:r="",benefitView:i=null,sponsored:d=!1,meta:c=[],ctaLabel:b="",ctaIcon:x="check-check",ctaDisabled:p=!1,cardAttrs:m="",ctaAttrs:g="",texts:w=Ve}={}){const A={...Ve,...w||{}},O=(Array.isArray(c)?c:[]).filter(V=>V&&V.label),M=String(b||A.accept),_=i&&typeof i=="object"?i:{},B=String(_.headline||r||""),U=String(_.priceGo||""),v=String(_.priceRegular||""),R=String(a||"").trim(),T=Ca({imageUrl:R,variant:n}),J=T===je,N=R?`<img class="mnyra-go-page__card-photo" src="${F(R)}" alt="" loading="lazy" decoding="async" />`:"",H=`
  ...
  `,Z=`
    <div class="mnyra-go-page__card-meta">
      ${O.map(V=>`<span>${ce(V.icon||"")}${F(V.label)}</span>`).join("")}
    </div>
  ...
  `}const S=Object.freeze({accepted:"accepted",activated:"activated",finalized:"finalized",cancelled:"cancelled",expired:"expired"}),We=Object.freeze({confirmed:S.accepted,checked_in:S.finalized,completed:S.finalized,cancelled_by_user:S.cancelled,cancelled_by_business:S.cancelled,not_arrived:S.expired});Object.freeze([S.accepted,S.activated]);Object.freeze({[S.accepted]:[S.activated,S.cancelled,S.expired],[S.activated]:[S.finalized,S.expired],[S.finalized]:[],[S.cancelled]:[],[S.expired]:[]});function yt(e=""){const t=String(e||"").trim().toLowerCase();return Object.values(S).includes(t)?t:We[t]?We[t]:S.accepted}function Nn({atMs:e=Date.now(),timeZone:t=ie}={}){return we(e,t).dayKey}function Oa(e={},t=""){const a=e&&typeof e=="object"?e:{},n=a.snapshot&&typeof a.snapshot=="object"?a.snapshot:{};return{id:y(a.id||t,180),restaurantId:y(a.restaurantId||n.restaurantId,180),locationId:y(a.locationId||n.locationId,180)||"main",offerId:y(a.offerId||n.offerId,180),guestId:y(a.guestId,180),uid:y(a.uid,180),shortCode:y(a.shortCode,12).toUpperCase(),status:yt(a.status),partySizeRequested:Math.max(1,Math.trunc(Number(a.partySizeRequested||a.partySize||n.partySize)||1)),partySizeVerified:Number.isFinite(Number(a.partySizeVerified))&&Number(a.partySizeVerified)>0?Math.trunc(Number(a.partySizeVerified)):null,dayKey:y(a.dayKey,10),timeZone:y(a.timeZone,60)||ie,snapshot:n,businessName:y(n.businessName,120),benefitLabel:y(n.benefitLabel,160),logoUrl:y(n.logoUrl,500),businessSeenAt:C(a.businessSeenAt),acceptedAt:C(a.acceptedAt||a.createdAt),activationDeadline:C(a.activationDeadline),activatedAt:C(a.activatedAt),finalizationDeadline:C(a.finalizationDeadline),finalizedAt:C(a.finalizedAt||a.completedAt),cancelledAt:C(a.cancelledAt),expiredAt:C(a.expiredAt),expiredReason:y(a.expiredReason,40),commissionVersion:y(a.commissionVersion,40),commission:a.commission&&typeof a.commission=="object"?{version:y(a.commission.version,40),currency:y(a.commission.currency,8),partySize:Math.max(1,Math.trunc(Number(a.commission.partySize)||1)),amountCents:Math.max(0,Math.trunc(Number(a.commission.amountCents)||0)),status:y(a.commission.status,20),confirmedAt:C(a.commission.confirmedAt)}:null,createdAt:C(a.createdAt),updatedAt:C(a.updatedAt)}}function Ma(e={}){const t=yt(e?.status);return t===S.accepted?"Ka pranuar":t===S.activated?"Aktivizuar":t===S.finalized?"Finalizuar":t===S.cancelled?"Anuluar nga klienti":"Skaduar"}function Gn(e={},{nowMs:t=Date.now()}={}){const a=Oa(e),n=Ae(a.activationDeadline);if(!n)return"";const r=a.timeZone,i=we(n,r),d=we(t,r),c=ke(i.minutes);return i.dayKey===d.dayKey?`E vlefshme deri sot, ${c}`:`E vlefshme deri nesër, ${c}`}function Ra(e=0){const t=Math.max(0,Math.trunc(Number(e)||0)),a=Math.trunc(t/100),n=String(t%100).padStart(2,"0");return`${a},${n} €`}const s=Object.freeze({brand:"Mnyra GO",mark:"⚡",editor:"Editori",brandMnyra:"MNYRA",brandGo:"GO",emptyTitle:"Merr klientë kur ata janë gati të dalin.",emptyAction:"Aktivizo ofertën e parë",cardIdle:"Krijo oferta për klientët që kërkojnë tani.",cardManage:"Menaxho GO",tabs:{active:"Aktiv",offers:"Ofertat",archive:"Arkiv",options:"Opsionet"},statNew:"Të reja",statActive:"Aktive",statToday:"Sot",guests:"Mysafirë",goOn:"GO Aktiv",pause:"Pauzo GO",resume:"Aktivizo GO",pausedUntil:"Pauzuar deri",createOffer:"Ofertë e re GO",editorHint:"Krijoje ofertën një herë. Mnyra ua shfaq automatikisht klientëve që përputhen.",scanOffer:"Skano ofertën",seenToday:"Ofertën e kanë parë sot",acceptedToday:"E kanë pranuar sot",editOffer:"Ndrysho ofertën",preview:"Kështu e sheh klienti",activate:"Aktivizo",save:"Ruaj ofertën",saving:"Po ruhet...",close:"Mbyll",edit:"Edit",offering:"po ju ofron",forGroup:"për grupin tuaj",accept:"Prano ofertën",finalizeTitle:"Finalizo ofertën",benefitQuestion:"Çka po ofron?",benefitHint:"Zgjidh çfarë dëshiron t'i ofrosh klientit.",benefitPercent:"Zbritje %",benefitBundle:"Paketë GO",benefitFree:"Falas",benefitSpecial:"Çmim special",benefitLegacy:"Zgjidh llojin e ofertës.",discountQuestion:"Sa zbritje po ofron?",discountOther:"Tjetër",discountPlaceholder:"Shkruaj zbritjen",scopeQuestion:"Ku vlen zbritja?",scopeAll:"Krejt fatura",scopeFood:"Ushqim",scopeDrinks:"Pije",bundleQuestion:"Çka përfshin paketa?",bundlePlaceholder:"p.sh. 2 Burger + 2 Pije",freeQuestion:"Çka merr falas?",freePlaceholder:"p.sh. 1 Pije",conditionQuestion:"Kur e merr falas?",conditionFood:"Me ushqim",conditionDrink:"Me pije",conditionAny:"Me çdo porosi",conditionCustom:"Tjetër",customConditionQuestion:"Shkruaj kushtin",customConditionPlaceholder:"p.sh. kur porosit 2 pizza",productQuestion:"Cili produkt?",productPlaceholder:"p.sh. Pizza Margherita",priceRegular:"Çmimi normal",priceGo:"Çmimi GO",pricePlaceholder:"0,00",saving:"Kursen",photoQuestion:"Foto e ofertës",photoHint:"Shto një foto që klienti ta shohë ofertën menjëherë.",photoOptional:"Opsionale",photoAdd:"Shto një foto",photoSource:"Nga telefoni ose kamera",photoChange:"Ndrysho",photoRemove:"Hiq",photoUploading:"Po ngarkohet...",photoError:"Fotoja nuk u ngarkua. Provo prapë.",partyQuestion:"Për sa persona vlen?",partyHint:"Zgjidh për çfarë madhësie të grupit vlen oferta.",partyAll:"Të gjithë",categoryQuestion:"Kur të shfaqet oferta?",categoryHint:"Zgjidh kur kjo ofertë i përshtatet kërkimit të klientit.",ifFood:"Nëse kërkohet ushqim",ifDrinks:"Nëse kërkohet kafe / pije",scheduleQuestion:"Kur vlen oferta?",scheduleHint:"Zgjidh kur klientët mund ta përdorin ofertën.",always:"Gjithmonë",specificHours:"Orar specifik",daysQuestion:"Ditët",hoursQuestion:"Orari",hoursFrom:"Nga",hoursTo:"Deri",limitsTitle:"Kufijtë",slotGroups:"Grupe për 30 min",slotGuests:"Mysafirë për 30 min",dailyGroups:"Grupe në ditë",totalRedemptions:"Sa herë gjithsej",noLimit:"0 = pa kufi",paused:"Pauzuar",archived:"Arkivuar",archive:"Arkivo",noBookings:"Ende asnjë klient sot.",noHistory:"Ende asnjë histori.",loading:"Po ngarkohet...",guestName:"Mnyra Guest",around:"Rreth",finalize:"Finalizo",needsActivation:"Klienti duhet ta aktivizojë ofertën.",search:"Kërko",searching:"Po kërkoj...",codePlaceholder:"Kodi i klientit",codeNotFound:"Ky kod nuk u gjet.",partyAtTable:"Sa persona janë",commission:"Provizioni",keepsRunning:"Rezervimet ekzistuese mbeten. Vetëm të rejat ndalen.",onlyBusiness:"Ky funksion eshte vetem per profile biznesi.",loadingBusiness:"Biznesi po ngarkohet..."});function o(e,t=""){return typeof e=="function"?e(t):String(t??"")}function L(e,t="",a="w-4 h-4"){return typeof e=="function"?e(t,a):""}function _t(e=""){const t=Date.parse(String(e||""));if(!Number.isFinite(t))return"";const a=new Date(t);return`${String(a.getHours()).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}`}function Ea({enabled:e=!1,unseenCount:t=0,activeOffers:a=0,todayBookings:n=0,iconFn:r=null,texts:i={}}={}){if(!e)return"";const d={...s,...i||{}},c=Math.max(0,Math.trunc(Number(t)||0)),b=a>0||n>0,x=b?`${a} oferta aktive · ${n} rezervime sot`:d.cardIdle;return`
...
`;function Ka(e={},t={}){const a=t.escapeHtml,n=t.icon,r=e.imageUrl?`<img class="go-hl__media" src="${o(a,e.imageUrl)}" alt="" loading="lazy" decoding="async" onerror="this.style.display='none'" />`:"",i=e.action?`<span class="go-hl__action">${o(a,e.action)}</span>`:`
  ...
  `}function Ta({stats:e={},deps:t={}}={}){return`
    <div class="go-hl" data-go-highlights>
      ${[{key:"scan",action:s.scanOffer,icon:"camera",tone:"text-indigo-600",attr:"data-go-scan"},{key:"seen",label:s.seenToday,value:Number(e.impressions)||0,icon:"eye",tone:"text-indigo-600"},{key:"accepted",label:s.acceptedToday,value:Number(e.accepted)||0,icon:"check-check",tone:"text-emerald-600"}].map(n=>Ka(n,t)).join("")}
    ...
    <div class="go-tabs" role="tablist" data-go-tabs>
      ${[["active",s.tabs.active,"zap"],["offers",s.tabs.offers,"tag"],["archive",s.tabs.archive,"archive"],["options",s.tabs.options,"settings"]].map(([i,d,c])=>`
        <button type="button" role="tab" aria-selected="${e===i?"true":"false"}" data-go-business-tab="${i}"
          class="go-tab">${L(n,c,"w-4 h-4")}<span class="go-tab-label">${o(a,d)}</span></button>
      `).join("")}
    </div>
  `}function _e(e={},t={},{found:a=!1}={}){const n=t.escapeHtml,r=e.benefitLabel||e.snapshot?.benefitLabel||"",i=!e.businessSeenAt,d=e.partySizeVerified||e.partySizeRequested||1,c=_t(e.acceptedAt),b=c?`${s.around} ${c}`:s.guestName;return`
    <div class="p-4 rounded-[1.6rem] border ${a?"go-booking--found bg-white":i?"bg-indigo-50/50 border-indigo-100":"bg-slate-50 border-slate-100"}"
  ...
  `}function Ga({code:e="",status:t="",busy:a=!1,deps:n={}}={}){const r=n.escapeHtml,i=n.icon;return`
  ...
  `}function Ia(e={},t={}){const a=t.escapeHtml,n=e.status==="paused"?s.paused:e.status==="archived"?s.archived:"";return`
    <div class="p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100" data-go-offer="${o(a,e.id)}">
      ...
      <div style="pointer-events:none;" aria-hidden="true">
        ${bt({businessName:"",imageUrl:e.imageUrl||"",variant:je,benefitLabel:e.benefitLabel||"",benefitView:ct(e.benefit||{}),meta:[{icon:"users",label:pt(e)},{icon:"clock",label:ut(e)}]})}
      </div>
  ...
  `}function La({offer:e={},businessName:t="",previewImageUrl:a="",deps:n={}}={}){const r=n.escapeHtml;return`
    <div data-go-offer-preview>
      ...
      -->
      <div style="pointer-events:none;" aria-hidden="true">
        ${bt({businessName:t,imageUrl:a||e.imageUrl||"",benefitLabel:e.benefitLabel||"",benefitView:ct(e.benefit||{}),meta:[{icon:"users",label:pt(e)},{icon:"clock",label:ut(e)}]})}
      </div>
    </div>
  `}function G(e,t="",a=""){return`<label class="text-[10px] font-black uppercase tracking-widest text-slate-400"${a?` for="${o(e,a)}"`:""}>${o(e,t)}</label>`}function ue(e,{active:t=!1,attr:a="",value:n="",escapeHtml:r=null}={}){return`
...
`;function xe({attr:e="",unit:t="€",value:a="",placeholder:n="",mode:r="decimal",inputClass:i="",escapeHtml:d=null}={}){return`
  ...
  `}const qe=Object.freeze([10,15,20,25]);function Ha({benefit:e={},percentCustom:t=!1,errorFor:a=()=>"",inputClass:n="",inputBase:r="",escapeHtml:i=null}={}){const d=g=>G(i,g),c=g=>{const w=a(g);return w?`<p class="mt-2 text-[11px] font-bold text-rose-500" data-go-error="${o(i,g)}">${o(i,w)}</p>`:""};if(!ma.includes(e.kind))return`
      <p class="go-offer-saving font-bold text-slate-400">${o(i,s.benefitLegacy)}</p>
      ${c("benefit")}
    `;const b=Number(e.percent)||0,x=t||b>0&&!qe.includes(b),p=()=>{const g=me(e.savingCents);if(!g)return"";const w=Math.round(Number(e.savingPercent)||0);return`
    ...
    <div class="mt-3">
      ${d(s.priceRegular)}
      ${xe({attr:"data-go-benefit-regular",value:He(e.regularPriceCents),placeholder:s.pricePlaceholder,inputClass:r,escapeHtml:i})}
      ${c("regularPrice")}
    </div>
    <div class="mt-3">
      ${d(s.priceGo)}
      ${xe({attr:"data-go-benefit-go",value:He(e.goPriceCents),placeholder:s.pricePlaceholder,inputClass:r,escapeHtml:i})}
      ${c("goPrice")}
    </div>
    ${p()}
  `;if(e.kind===Q)return`
      ...
      <div class="mt-2 flex flex-wrap gap-2">
        ${qe.map(g=>se(`${g}%`,{active:!x&&b===g,attr:"data-go-discount",value:String(g),escapeHtml:i})).join("")}
    ...
    `}return e.kind===ne?`
      ...
      ${c("benefitItem")}
      ${m()}
    `:""}function Za({imageUrl:e="",photo:t={},escapeHtml:a=null,icon:n=null}={}){const r=String(t.status||""),i=r==="uploading",d=String(t.previewUrl||e||""),c=r==="error"?String(t.error||s.photoError):"",b=d?`
    ...
    <div data-go-section="photo">
      ...
      ${c?`<p class="mt-2 text-[11px] font-bold text-rose-500">${o(a,c)}</p>`:""}
    </div>
  `}function Va(e=""){const t=String(e||"all").trim().toLowerCase();return t==="food"?["food"]:t==="coffee"||t==="drinks"||t==="dessert"?["drinks"]:["food","drinks"]}function In(e=[]){const t=Array.isArray(e)?e:[],a=t.includes("food"),n=t.includes("drinks");return a&&n?"all":a?"food":n?"drinks":""}function Ln({editor:e=null,businessName:t="",deps:a={}}={}){if(!e)return"";const n=a.escapeHtml,r=a.icon,i=e.draft||{},d=Array.isArray(e.errors)?e.errors:[],c=v=>d.find(R=>R.field===v)?.message||"",b=Array.isArray(i.partyRanges)?i.partyRanges:[],x=i.schedule?.mode==="windows"?"windows":"always",p=Array.isArray(i.schedule?.days)&&i.schedule.days.length?i.schedule.days:I.slice(),m=re.every(v=>b.includes(v.key)),g=Array.isArray(e.intents)?e.intents:Va(i.category),w=i.benefit||{},A=e.mode==="edit",O="w-full go-offer-input bg-slate-50 border border-slate-100 rounded-2xl px-4 text-sm font-bold text-slate-900 outline-none focus:border-indigo-400",M=`mt-2 ${O}`,_='<div class="h-px bg-slate-100"></div>',B=v=>`<p class="mt-1 text-[11px] font-semibold text-slate-400">${o(n,v)}</p>`,U=Da(i).ok&&g.length>0;return`
        ...
        <div class="flex-1 overflow-y-auto no-scrollbar modal-scroll px-6 py-5 space-y-5" data-go-editor-scroll>
          ...
          <div class="go-offer-section" data-go-section="benefit">
            ...
            <div class="mt-5" data-go-benefit-form>
              ${Ha({benefit:w,percentCustom:e.percentCustom===!0,errorFor:c,inputClass:M,inputBase:O,escapeHtml:n})}
            </div>
          </div>
          ...
          <div data-go-section="category">
            ...
            <div class="mt-3 space-y-2">
              ${[{key:"food",label:s.ifFood},{key:"drinks",label:s.ifDrinks}].map(v=>{const R=g.includes(v.key),T=at.find(J=>J.key===v.key)?.hint||"";return`
              ...
              <div class="mt-4">
                ...
                <div class="mt-2 grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input id="goOfferFrom" type="time" data-go-offer-from value="${o(n,e.windowFrom||"14:00")}" class="${M}" />
                  </div>
                  <div>
                    ${G(n,s.hoursTo,"goOfferTo")}
                    <input id="goOfferTo" type="time" data-go-offer-to value="${o(n,e.windowTo||"18:00")}" class="${M}" />
                  </div>
                </div>
              </div>
            `:""}
          ...
          ${La({offer:i,businessName:t,previewImageUrl:e.photo?.previewUrl||"",deps:a})}
        </div>
  ...
  `}function Un({restaurantName:e="",tab:t="active",stats:a={},search:n={},bookings:r=[],offers:i=[],settings:d={},paused:c=!1,loading:b=!1,error:x="",deps:p={}}={}){const m=p.escapeHtml,g=p.icon,w=r.filter(_=>["accepted","activated"].includes(_.status)),A=r.filter(_=>!["accepted","activated"].includes(_.status)),O=i.filter(_=>_.status!=="archived");let M="";if(t==="offers")M=he({eyebrow:s.brand,title:s.tabs.offers,sub:`${O.length} ${O.length===1?"oferte":"oferta"}`,action:`
      ...
      `,body:O.length?`<div class="space-y-3">${O.map(_=>Ia(_,p)).join("")}</div>`:`<div class="text-center py-10 text-[10px] font-bold uppercase tracking-widest text-slate-300">${o(m,s.emptyTitle)}</div>`,deps:p});else if(t==="archive")M=he({eyebrow:s.brand,title:s.tabs.archive,sub:`${A.length}`,body:A.length?`<div class="space-y-3">${A.map(_=>_e(_,p)).join("")}</div>`:`<div class="text-center py-10 text-[10px] font-bold uppercase tracking-widest text-slate-300">${o(m,s.noHistory)}</div>`,deps:p});else if(t==="options"){const _=_t(d?.pausedUntil);M=he({eyebrow:s.brand,title:s.tabs.options,body:`
      ...
      `,deps:p})}else M=he({eyebrow:s.brand,title:s.tabs.active,sub:`${w.length}`,body:`
  ...
  `}function Hn({deps:e={},resolving:t=!1}={}){const a=e.icon,n=e.escapeHtml;return t?`
...
`;function qa(e=typeof document>"u"?null:document){if(!(!e||e.getElementById(Qe)))try{const t=e.createElement("style");t.id=Qe,t.textContent=Wa,e.head?.appendChild(t)}catch{}}function $(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function D(e,t,a=""){if(typeof e!="function")return"";try{return e(t,a)||""}catch{return""}}const Qa=Object.freeze(["hotel","motel","hostel","resort","accommodation","travel"]);function Ya({businessType:e="",isShopCatalog:t=!1}={}){if(t)return"shop";const a=String(e||"").trim().toLowerCase();return Qa.includes(a)?"hotel":"restaurant"}function Ja(e=new Date().getHours()){const t=Number.isFinite(Number(e))?(Math.trunc(Number(e))%24+24)%24:12;return t>=5&&t<=10?{dayPart:"mengjes",text:"Ju urojmë një mëngjes të mbarë!"}:t>=11&&t<=17?{dayPart:"dite",text:"Ju urojmë një ditë të mbarë!"}:t>=18&&t<=21?{dayPart:"mbremje",text:"Ju urojmë një mbrëmje të mbarë!"}:{dayPart:"nate",text:"Ju urojmë një natë të mbarë!"}}function Xa({name:e="",logoUrl:t="",hour:a=new Date().getHours(),iconFn:n}={}){const r=Ja(a),i=$(e||"Business");return`
    <div class="mnyra-dash__greet">
      <p class="mnyra-dash__greet-title">
        ...
        <span class="mnyra-dash__greet-logo">
          ${t?`<img src="${$(t)}" alt="${i}" title="${i}" loading="lazy" decoding="async" onerror="this.style.display='none'" />`:`<span class="mnyra-dash__greet-logo-fallback" title="${i}">${D(n,"store","w-4 h-4")}</span>`}
        </span>
      </p>
  ...
  `}function tn({iconFn:e,showEditor:t=!0}={}){return t?`
  ...
  `:""}const Ye=Object.freeze({restaurant:{accent:"Ndrysho",rest:"menunë",sub:"Shto produkte, kategori dhe çmime.",cta:"Menu"},shop:{accent:"Ndrysho",rest:"dyqanin",sub:"Shto produkte, kategori dhe stok.",cta:"Dyqani"},hotel:{accent:"Ndrysho",rest:"hotelin",sub:"Detajet, dhomat dhe çmimet e tua.",cta:"Hoteli"}});function nn(e="restaurant"){const t=String(e||"").trim().toLowerCase();return Ye[t]||Ye.restaurant}function rn({iconFn:e,kind:t="restaurant",showEditor:a=!0}={}){if(!a)return"";const n=nn(t);return`
  ...
  `}const sn="/waiter?from=panel";function on({iconFn:e,showEditor:t=!0}={}){return t?`
  ...
  `:""}function dn({cards:e=[],iconFn:t}={}){const a=(Array.isArray(e)?e:[]).filter(r=>r&&r.key);if(!a.length)return"";const n=a.map((r,i)=>{const d=$(r.label||"");if(r.pending)return'<div class="mnyra-dash__hl-card mnyra-dash__hl-card--pending" aria-hidden="true"></div>';const c=i<2?'loading="eager" fetchpriority="high"':'loading="lazy" fetchpriority="low"';let b="";r.imageUrl?b=`<img class="mnyra-dash__hl-media" src="${$(r.imageUrl)}" alt="" ${c} decoding="async" onerror="this.style.display='none'" />`:r.videoUrl&&(b=`<video class="mnyra-dash__hl-media" src="${$(r.videoUrl)}#t=0.1" preload="metadata" muted playsinline disablepictureinpicture tabindex="-1" aria-hidden="true"></video>`);const x=`
    ...
    `}).join("");return`
    <div class="mnyra-dash__hl" data-dashboard-metrics="${$(ln(a))}">
      ${n}
      <span class="mnyra-dash__hl-tail" aria-hidden="true"></span>
    </div>
  `}function ln(e=[]){return(Array.isArray(e)?e:[]).filter(t=>t&&t.key).map(t=>[t.key,t.label||"",t.value||"",t.emptyText||"",t.imageUrl||"",t.videoUrl||"",t.iconName||"",t.panelTab||"",t.composer||"",t.pending?"p":"",t.loading?"l":"",t.locked?"x":"",t.withEye?"e":""].join("~")).join("|")}const xt=Object.freeze([Object.freeze({id:"funksionet",label:"Funksionet",iconName:"layout-grid"}),Object.freeze({id:"analitika",label:"Analitika",iconName:"bar-chart-3"}),Object.freeze({id:"opsionet",label:"Opsionet",iconName:"settings"})]);function pe(e=""){const t=String(e||"").trim().toLowerCase();return xt.some(a=>a.id===t)?t:"funksionet"}function cn({activeTab:e="funksionet",iconFn:t}={}){const a=pe(e);return`<div class="mnyra-dash__tabs" role="tablist" data-dashboard-panel-tabs>${xt.map(r=>{const i=r.id===a;return`
      <button
        type="button"
        role="tab"
      ...
      >${D(t,r.iconName,"w-4 h-4")}<span class="mnyra-dash__tab-label">${$(r.label)}</span></button>
    `}).join("")}</div>`}function vt(e=""){return`
    <div class="mnyra-dash__bento" data-dashboard-bento>
      ${e}
    </div>
  `}function hn({posts:e=[],iconFn:t}={}){const a=Array.isArray(e)?e:[];let n="";return a.length?(n=a.map(r=>{const i=[r.dateLabel,`${ee(r.likesCount||0)} Likes`,`${ee(r.commentsCount||0)} Kommentare`];return Number(r.impressions||0)>0&&i.push(`${ee(r.impressions)} shtrirje (7 dite)`),`
        <div class="mnyra-dash__post">
          <div class="mnyra-dash__post-thumb">
            ${r.thumbUrl?`<img src="${$(r.thumbUrl)}" alt="" loading="lazy" decoding="async" onerror="this.style.display='none'" />`:D(t,r.mediaType==="video"?"play":"image","w-5 h-5")}
          </div>
  ...
  `}function mn(){return'<div class="mnyra-dash__skeleton" style="min-height:44px; border-radius:14px; margin: 4px 0 16px;"></div>'}function fn(){const e=Array.from({length:4},()=>'<div class="mnyra-dash__hl-card mnyra-dash__hl-card--pending" aria-hidden="true"></div>').join(""),t=Array.from({length:4},(a,n)=>`<div class="mnyra-dash__skeleton" style="min-height:132px; border-radius:var(--dash-card-radius); margin-top:${n===0?32:22}px;"></div>`).join("");return`
    ${mn()}
  ...
  `}const yn="menyra_social_dashboard_cache_v1::",Je="menyra_social_composer_products_v1::",Xe=2500,et=1200,_n=6,xn=3,vn=Object.freeze({menuImageUrl:"/apps/menyra-social/assets/panel/menu-scan.jpg",qrImageUrl:"/apps/menyra-social/assets/panel/qr-stand.jpg"}),wn=Object.freeze({menuOpens:"Menü-Aufrufe",qrScans:"QR-Scans"});function E(e){const t=Number(e);return Number.isFinite(t)?t:0}function kn(e={}){const t=String(e.createdAtClient||"").trim();if(t){const n=new Date(t);if(!Number.isNaN(n.getTime()))return n}const a=e.createdAt;if(a&&typeof a.toDate=="function")try{const n=a.toDate();if(n instanceof Date&&!Number.isNaN(n.getTime()))return n}catch{}return null}function $n(e="",t={}){const a=Array.isArray(t.media)&&t.media.length?t.media[0]:{},n=String(a.type||t.mediaType||"image").trim().toLowerCase()==="video"?"video":"image",r=String(a.thumbUrl||(n==="image"?a.url:"")||t.thumbUrl||"").trim(),i=n==="video"?String(a.url||t.mediaUrl||"").trim():"",d=kn(t);return{id:String(e||"").trim(),caption:String(t.caption||"").trim(),mediaType:n,thumbUrl:r,videoUrl:i,likesCount:E(t.likesCount),commentsCount:E(t.commentsCount),impressions:0,dateLabel:d?d.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit"}):"",createdAtMs:d?d.getTime():0}}function Sn({days:e=[],todayKey:t="",rawPosts:a=[]}={}){const n=Array.isArray(e)?e:[],r=Ke(n),i=n.find(p=>String(p?.date||p?.id||"").trim()===String(t||"").trim()),d=Ke(i?[i]:[]),c=r.merged?.posts&&typeof r.merged.posts=="object"?r.merged.posts:{},b=(Array.isArray(a)?a:[]).map(p=>$n(p?.id,p?.data||{})).filter(p=>p.id).map(p=>({...p,impressions:E(c[p.id]?.impressions)})),x=b.slice().sort((p,m)=>m.createdAtMs-p.createdAtMs).slice(0,xn);return{day:String(t||"").trim(),week:r.summary,today:d.summary,posts:x,latestPost:zn(b)}}function zn(e=[]){const t=(Array.isArray(e)?e:[]).filter(a=>a&&a.id);return t.length?t.slice().sort((a,n)=>E(n.createdAtMs)-E(a.createdAtMs)||E(n.impressions)-E(a.impressions)||E(n.likesCount)-E(a.likesCount))[0]:null}function An({profile:e={},restaurant:t={}}={}){return It({profile:e,restaurant:t,feature:"qr"})}function Pn(e={}){const t=e&&typeof e=="object"?e:{};return String(t.titleImageUrl||t.coverImageUrl||t.coverUrl||t.heroUrl||t.bannerUrl||"").trim()}function Dn({model:e=null,coverUrl:t="",subscribed:a=!1,assets:n={}}={}){const r=e?.today||{},i=!e,d=e?.latestPost||null,c=[];if(i)c.push({key:"latestPost",label:"Postimi fundit",pending:!0});else if(!d)c.push({key:"latestPost",label:"Postimi fundit",emptyText:"S'ka postim",iconName:"image",composer:"post"});else{const b=String(d.thumbUrl||"").trim();c.push({key:"latestPost",label:"Postimi fundit",value:ee(E(d.impressions)),withEye:!0,imageUrl:b,videoUrl:b?"":String(d.videoUrl||"").trim(),iconName:"image",panelTab:"analitika"})}return c.push({key:"profileViews",label:"Vizitor n'profil",value:ee(E(r.profileViews)),withEye:!0,loading:i,imageUrl:String(t||"").trim(),iconName:"user",panelTab:"analitika"}),c.push({key:"menuOpens",label:"Vizitor n'meny",value:ee(E(r.menuOpens)),withEye:!0,loading:i&&a,locked:!a,imageUrl:String(n.menuImageUrl||"").trim(),iconName:"book-open",panelTab:"analitika"}),c.push({key:"qrScans",label:"Skanime n'tavolina",value:ee(E(r.qrScans)),withEye:!0,loading:i&&a,locked:!a,imageUrl:String(n.qrImageUrl||"").trim(),iconName:"layout-grid",panelTab:"analitika"}),c}function Zn({state:e,renderFn:t,documentObj:a,firestoreApi:n={},profileApi:r={},composerApi:i={},viewApi:d={},iconFn:c,storageObj:b}={}){const x=a||(typeof document>"u"?null:document),p=x?.defaultView||(typeof window>"u"?null:window),m=typeof t=="function"?t:()=>{},g=b||(typeof localStorage>"u"?null:localStorage),w=typeof r.getBusinessProfileTypeFn=="function"?r.getBusinessProfileTypeFn:(()=>""),A=typeof r.isShopCatalogProfileFn=="function"?r.isShopCatalogProfileFn:(()=>!1),O=typeof r.getRestaurantMetaByIdFn=="function"?r.getRestaurantMetaByIdFn:(()=>null),M=typeof r.resolveRestaurantLogoFn=="function"?r.resolveRestaurantLogoFn:(()=>""),_=typeof r.resolveOwnAvatarUrlFn=="function"?r.resolveOwnAvatarUrlFn:(()=>""),B=typeof d.renderAnalyticsViewFn=="function"?d.renderAnalyticsViewFn:(()=>""),U=typeof d.renderSettingsViewFn=="function"?d.renderSettingsViewFn:(()=>""),v=typeof d.warmAnalyticsFn=="function"?d.warmAnalyticsFn:(()=>{});let R=!1,T=0,J=!1,N=null,H=null,Z="",V=!1,Fe=()=>null;const wt=300;function ge(){const l=e?.userProfile||{};return Ya({businessType:w(l),isShopCatalog:A(l)})}function kt(l=""){const h=O(l)||{};return Jt(h).map(u=>({id:u.id,name:u.title,price:u.price??"",category:u.beds||u.tag||"",type:"room",imageUrl:u.imageUrl||""}))}function $t(l=""){if(!g)return null;try{const h=g.getItem(`${Je}${l}`);if(!h)return null;const u=JSON.parse(h),f=Array.isArray(u?.items)?u.items:null;return f&&f.length?f:null}catch{return null}}function St(l="",h=[]){if(g)try{g.setItem(`${Je}${l}`,JSON.stringify({savedAt:Date.now(),items:h}))}catch{}}async function zt(l=""){const{db:h,collectionFn:u,queryFn:f,limitFn:k,getDocsFn:z}=n;if(!h||typeof u!="function"||typeof z!="function")throw new Error("Produktet nuk u ngarkuan.");const W=u(h,"restaurants",l,"menuItems"),j=typeof f=="function"&&typeof k=="function"?f(W,k(wt)):W,q=await z(j),P=[];return q.forEach(X=>{const le=Fe(X?.id,X?.data?.()||{});le&&P.push(le)}),P.sort((X,le)=>X.name.localeCompare(le.name,"sq")),P}async function At(l="",h){const u=String(l||"").trim();if(!u)throw new Error("Produktet nuk u ngarkuan.");if(ge()==="hotel")return kt(u);const f=zt(u).then(z=>(St(u,z),z)),k=$t(u);return k?(typeof h=="function"?f.then(z=>h(z)).catch(()=>{}):f.catch(()=>{}),k):f}function Ce(){return N?Promise.resolve(N):(H||(H=Tt(()=>import("./business-composer-controller-okdh5aGB.js"),__vite__mapDeps([0,1,2,3,4,5,6])).then(l=>(Fe=typeof l?.normalizeComposerProductCore=="function"?l.normalizeComposerProductCore:(()=>null),N=l.createBusinessComposerController({documentObj:x,windowObj:x?.defaultView||null,api:{getRestaurantIdFn:()=>oe(),getBusinessMetaFn:()=>{const h=oe();if(!h)return{name:"",logoUrl:"",city:""};const u=Be(h),f=O(h)||{};return{name:u.name,logoUrl:u.logoUrl,city:String(f.city||"").trim()}},loadProductsFn:(h,u)=>At(h,u),getBusinessKindFn:()=>ge(),uploadImageFn:i.uploadImageFn,uploadVideoFn:i.uploadVideoFn,captureVideoPosterFn:i.captureVideoPosterFn,createPostFn:i.createPostFn,createStoryFn:i.createStoryFn,formatPriceFn:i.formatPriceFn,getOptimizedImageUrlFn:i.getOptimizedImageUrlFn,escapeHtmlFn:i.escapeHtmlFn,iconFn:typeof c=="function"?c:void 0,afterPublishFn:async h=>{try{await de({force:!0})}catch{}typeof i.afterPublishFn=="function"&&await i.afterPublishFn(h)}}}),N)).catch(l=>{throw H=null,console.error("[mnyra][dashboard] composer load failed",l),l})),H)}function Oe(){const l=p?.navigator?.connection;return!l||typeof l!="object"?!1:l.saveData===!0?!0:/(^|-)2g$/.test(String(l.effectiveType||"").trim().toLowerCase())}function Pt(){if(V||N||!p||Oe())return;V=!0;const l=()=>{if(Ce().catch(()=>{}),typeof i.prewarmFn=="function")try{i.prewarmFn()}catch{}};if(typeof p.requestIdleCallback=="function"){p.requestIdleCallback(l,{timeout:Xe});return}p.setTimeout?.(l,et)}function Dt(){if(R||!p||Oe())return;R=!0;const l=()=>{try{v()}catch{}};if(typeof p.requestIdleCallback=="function"){p.requestIdleCallback(l,{timeout:Xe});return}p.setTimeout?.(l,et)}function jt(l="post"){const h=String(l||"").trim().toLowerCase(),u=h==="story"||h==="profile"?h:"post";if(typeof i.prewarmFn=="function")try{i.prewarmFn()}catch{}if(N){N.open(u);return}Z=u,Ce().then(f=>{const k=Z||u;Z="",f?.open?.(k)}).catch(()=>{Z=""})}function be(){return(!e.dashboardView||typeof e.dashboardView!="object")&&(e.dashboardView={status:"idle",error:"",model:null,loadedSignature:"",restaurantId:"",paywall:""}),e.dashboardView}function Me(l=""){const h=be(),u=String(l||"").trim();return String(h.restaurantId||"")===u||(h.restaurantId=u,h.model=null,h.status="idle",h.error="",h.loadedSignature="",h.paywall="",T+=1),h}function oe(){const l=e?.userProfile||{};return String(l.restaurantId||l.staffRestaurantId||"").trim()}let Re="";function Ft(){const l=String(e?.user?.uid||"").trim();!l||Re===l||typeof r.ensureBusinessProfileFn=="function"&&(Re=l,Promise.resolve().then(()=>r.ensureBusinessProfileFn()).catch(h=>{console.warn("[mnyra][panel] business profile could not be resolved",h)}).finally(()=>{String(e?.user?.uid||"").trim()===l&&m()}))}function Ct(){const l=String(e?.user?.uid||"").trim();if(!l)return!1;const h=String(e?.__authBootstrapInFlightUid||"").trim();return!!e?.__authProfileLoadPromise||h===l}function Ee(l=""){return`${yn}${l}`}function Ot(l="",h=""){if(!g||!l)return null;try{const u=g.getItem(Ee(l));if(!u)return null;const f=JSON.parse(u);return!f||typeof f!="object"||String(f.day||"").trim()!==String(h||"").trim()||!f.model||typeof f.model!="object"?null:f.model}catch{return null}}function Mt(l="",h=null){if(!(!g||!l||!h))try{g.setItem(Ee(l),JSON.stringify({day:h.day,model:h}))}catch{}}async function Rt(l=""){const{db:h,collectionFn:u,queryFn:f,orderByFn:k,limitFn:z,getDocsFn:W}=n;if(!h||typeof u!="function"||typeof f!="function"||typeof k!="function"||typeof z!="function"||typeof W!="function")return[];const j=u(h,"restaurants",l,"socialPosts");return(await W(f(j,k("createdAt","desc"),z(_n)))).docs.map(P=>({id:P.id,data:P.data()||{}})).filter(P=>{const X=String(P.data.status||"active").trim().toLowerCase();return X!=="deleted"&&X!=="hidden"})}async function de({force:l=!1}={}){const h=oe(),u=Me(h);if(!h)return;const f=Nt({rangeKey:"7d"});if(!f)return;const k=`${h}::${f.toDay}`;if(!l&&u.loadedSignature===k&&u.status==="ready")return;if(!u.model){const j=Ot(h,f.toDay);j&&(u.model=j,u.status="ready",m())}T+=1;const z=T;u.model||(u.status="loading",u.error="",m());try{const j={db:n.db,collectionFn:n.collectionFn,queryFn:n.queryFn,whereFn:n.whereFn,documentIdFn:n.documentIdFn,getDocsFn:n.getDocsFn,restaurantId:h},[q,P]=await Promise.allSettled([Gt({...j,fromDay:f.fromDay,toDay:f.toDay}),Rt(h)]);if(z!==T)return;if(q.status==="rejected")throw q.reason;P.status==="rejected"&&console.error("[mnyra][dashboard] recent posts load failed",P.reason),u.model=Sn({days:q.value,todayKey:f.toDay,rawPosts:P.status==="fulfilled"?P.value:[]}),u.status="ready",u.error="",u.loadedSignature=k,Mt(h,u.model)}catch(j){if(z!==T)return;console.error("[mnyra][dashboard] load failed",j),u.model||(u.status="error",u.error="Ju lutem kontrollo lidhjen dhe provo perseri.")}m()}function Et(){J||!x||(J=!0,x.addEventListener("click",l=>{try{if(String(e?.activeTab||"").trim().toLowerCase()!=="dashboard")return;if(l.target?.closest?.("[data-dashboard-retry]")){de({force:!0});return}if(l.target?.closest?.("[data-dashboard-paywall-close]")){l.preventDefault(),be().paywall="",m();return}const h=l.target?.closest?.("[data-dashboard-metric-locked]");if(h){l.preventDefault(),be().paywall=String(h.getAttribute("data-dashboard-metric-locked")||"").trim(),m();return}const u=l.target?.closest?.("[data-dashboard-composer]");if(u){l.preventDefault(),jt(u.getAttribute("data-dashboard-composer"));return}const f=l.target?.closest?.("[data-dashboard-panel-tab]");if(f){l.preventDefault();const k=pe(f.getAttribute("data-dashboard-panel-tab"));if(k===pe(e?.dashboardPanelTab))return;e.dashboardPanelTab=k,m()}}catch{}}))}function Be(l=""){const h=e?.userProfile||{},u=l?O(l)||{}:{},f=String(u.name||u.restaurantName||h.name||"").trim()||"Business";let k="";try{k=String(_()||"").trim()}catch{}if(!k)try{k=String(M(u)||"").trim()}catch{}return{name:f,logoUrl:k,kind:ge(),coverUrl:Pn(u),subscribed:An({profile:h,restaurant:u})}}function Bt(l=""){try{if(!Lt()||!l)return"";Ut({restaurantId:l,onBadgeFn:()=>m()});const h=Ht();return Ea({enabled:!0,unseenCount:h.unseen,activeOffers:h.activeOffers||0,todayBookings:h.today,iconFn:c})}catch{return""}}function Kt(){qa(x),Et();const l=oe(),h=Me(l);let u="";if(!l)Ft(),u=Ct()?fn():bn();else{Pt(),Dt();const f=Be(l),k=pe(e?.dashboardPanelTab);h.status==="idle"&&(h.status="loading",queueMicrotask(()=>{de({force:!1})}));let z="";h.model?z=hn({posts:h.model.posts,iconFn:c}):h.status==="error"?z=gn({message:h.error}):z=un();const W=`
        ${Bt(l)}
        ${en({iconFn:c})}
    ...
    `}return Object.freeze({renderDashboardView:Kt,loadDashboard:de})}export{yt as A,bt as B,Gn as C,Jt as D,Mn as E,Rn as F,re as G,Vt as M,Zn as a,fe as b,Wt as c,Va as d,Un as e,ke as f,Kn as g,I as h,In as i,Ln as j,La as k,Oa as l,Nn as m,Yt as n,gt as o,_a as p,Bn as q,Hn as r,Te as s,Tn as t,En as u,Da as v,ce as w,at as x,je as y,De as z};
