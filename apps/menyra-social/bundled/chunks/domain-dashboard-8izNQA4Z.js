const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/business-composer-controller-yvG6FGBe.js","chunks/domain-feed-social-eager-QMXAIe5K.js","chunks/domain-auth-Aq-4Vdvh.js","chunks/domain-public-profile-mLQti0eH.js","chunks/domain-media-eager-DAUyCk2O.js","chunks/domain-menu-eager-Cg7tiv-m.js","chunks/profile-post-card-markup-utils-HwqIiXgP.js"])))=>i.map(i=>d[i]);
import{_ as Ce}from"./domain-auth-Aq-4Vdvh.js";import{f as C,r as Be,l as $e,s as Q}from"./domain-analytics-CuBqYnIy.js";import{b as Re}from"./domain-business-accounts-D8NpUhi6.js";const je=20,Ee=8;function z(e=""){return e==null?"":String(e).trim()}function M(e){if(e==null||e==="")return null;const a=Number(String(e).replace(",","."));return Number.isFinite(a)&&a>0?a:null}function Ke(e=Date.now(),a=Math.random()){const t=Math.max(0,Number(e)||0).toString(36),o=Math.floor(Math.max(0,Math.min(.999999,Number(a)||0))*36**6).toString(36).padStart(6,"0");return`room_${t}_${o}`}function Te(e={}){const a=e&&typeof e=="object"?e:{},t=[...Array.isArray(a.images)?a.images:[],z(a.imageUrl??a.image??a.photoUrl)],o=[];return t.forEach(n=>{const l=z(n);l&&!o.includes(l)&&o.push(l)}),o.slice(0,Ee)}function Ae(e={},{index:a=0}={}){const t=e&&typeof e=="object"?e:{},o=M(t.persons??t.guests??t.capacity),n=M(t.size??t.sizeSqm??t.area),l=Te(t);return{id:z(t.id)||Ke(Date.now()+a),title:z(t.title??t.name),description:z(t.description??t.text).slice(0,400),imageUrl:l[0]||"",images:l,price:M(t.price??t.pricePerNight),currency:z(t.currency??t.currencyCode).toUpperCase()||"EUR",persons:o==null?null:Math.min(20,Math.round(o)),beds:z(t.beds??t.bedsLabel).slice(0,60),size:n==null?null:Math.min(500,Math.round(n)),tag:z(t.tag??t.badge).slice(0,40),active:t.active!==!1}}function Ue(e=[]){return(Array.isArray(e)?e:[]).slice(0,je).map((a,t)=>Ae(a,{index:t}))}function Ie(e={}){return Ue((e&&typeof e=="object"?e:{}).hotelRooms).filter(t=>t.title)}function xa(e={}){const a=[];return Number.isFinite(e?.persons)&&e.persons>0&&a.push({icon:"users",label:`${e.persons} persona`}),z(e?.beds)&&a.push({icon:"bed",label:z(e.beds)}),Number.isFinite(e?.size)&&e.size>0&&a.push({icon:"size",label:`${e.size} m²`}),a}function Sa(e={}){const a=Number(e?.price);if(!Number.isFinite(a)||a<=0)return"";const t=z(e?.currency).toUpperCase()||"EUR",o=Number.isInteger(a)?String(a):a.toFixed(2);return t==="EUR"?`€${o}`:`${o} ${t}`}const X="mnyraDashboardStyles",Ne=`
.mnyra-dash {
...
`;function Me(e=typeof document>"u"?null:document){if(!(!e||e.getElementById(X)))try{const a=e.createElement("style");a.id=X,a.textContent=Ne,e.head?.appendChild(a)}catch{}}function c(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function v(e,a,t=""){if(typeof e!="function")return"";try{return e(a,t)||""}catch{return""}}const Le=Object.freeze(["hotel","motel","hostel","resort","accommodation","travel"]);function Oe({businessType:e="",isShopCatalog:a=!1}={}){if(a)return"shop";const t=String(e||"").trim().toLowerCase();return Le.includes(t)?"hotel":"restaurant"}function He({kind:e="restaurant",isOwner:a=!1}={}){const t=[];return e==="hotel"?t.push({nav:"menu",iconName:"bed-double",label:"Hotel & Dhoma",sub:"Detaje, dhoma, oferta"}):e==="shop"?t.push({nav:"menu",iconName:"shopping-bag",label:"Ndrysho dyqanin",sub:"Produkte & Stok"}):t.push({nav:"menu",iconName:"utensils",label:"Ndrysho menune",sub:"Produkte & Kategorien"}),t.push({nav:"menu",iconName:"megaphone",label:"Oferta & Reklama",sub:"Im Editor verwalten"}),a&&t.push({nav:"businessAccounts",iconName:"users-round",label:"Team & Staff",sub:"Zugänge verwalten"}),t.push({nav:"settings",iconName:"settings",label:"Cilesimet",sub:"Profili & Kontakti"}),t}function Ze(e=new Date().getHours()){const a=Number.isFinite(Number(e))?(Math.trunc(Number(e))%24+24)%24:12;return a>=5&&a<=10?{dayPart:"mengjes",text:"Ju urojmë një mëngjes të mbarë!"}:a>=11&&a<=17?{dayPart:"dite",text:"Ju urojmë një ditë të mbarë!"}:a>=18&&a<=21?{dayPart:"mbremje",text:"Ju urojmë një mbrëmje të mbarë!"}:{dayPart:"nate",text:"Ju urojmë një natë të mbarë!"}}function Ve({name:e="",logoUrl:a="",hour:t=new Date().getHours(),iconFn:o}={}){const n=Ze(t),l=c(e||"Business");return`
  ...
  `}function aa({posts:e=[],iconFn:a}={}){const t=Array.isArray(e)?e:[];let o="";return t.length?(o=t.map(n=>{const l=[n.dateLabel,`${C(n.likesCount||0)} Likes`,`${C(n.commentsCount||0)} Kommentare`];return Number(n.impressions||0)>0&&l.push(`${C(n.impressions)} shtrirje (7 dite)`),`
  ...
  `}function ra(){return'<div class="mnyra-dash__skeleton" style="min-height:44px; border-radius:14px; margin: 4px 0 16px;"></div>'}function sa(){const e=Array.from({length:4},()=>'<div class="mnyra-dash__hl-card mnyra-dash__hl-card--pending" aria-hidden="true"></div>').join(""),a=Array.from({length:3},(o,n)=>'<div class="mnyra-dash__skeleton" style="min-height:132px; border-radius:var(--dash-card-radius); margin-top:22px;"></div>').join(""),t=Array.from({length:4},()=>'<div class="mnyra-dash__skeleton" style="min-height:92px; border-radius:var(--dash-bento-cell-radius);"></div>').join("");return`
    ${ra()}
  ...
  `}const da="menyra_social_dashboard_cache_v1::",ae="menyra_social_composer_products_v1::",te=2500,ne=1200,la=6,ca=3,ha=Object.freeze({menuImageUrl:"/apps/menyra-social/assets/panel/menu-scan.jpg",qrImageUrl:"/apps/menyra-social/assets/panel/qr-stand.jpg"}),ua=Object.freeze({menuOpens:"Menü-Aufrufe",qrScans:"QR-Scans"});function _(e){const a=Number(e);return Number.isFinite(a)?a:0}function ma(e={}){const a=String(e.createdAtClient||"").trim();if(a){const o=new Date(a);if(!Number.isNaN(o.getTime()))return o}const t=e.createdAt;if(t&&typeof t.toDate=="function")try{const o=t.toDate();if(o instanceof Date&&!Number.isNaN(o.getTime()))return o}catch{}return null}function pa(e="",a={}){const t=Array.isArray(a.media)&&a.media.length?a.media[0]:{},o=String(t.type||a.mediaType||"image").trim().toLowerCase()==="video"?"video":"image",n=String(t.thumbUrl||(o==="image"?t.url:"")||a.thumbUrl||"").trim(),l=o==="video"?String(t.url||a.mediaUrl||"").trim():"",m=ma(a);return{id:String(e||"").trim(),caption:String(a.caption||"").trim(),mediaType:o,thumbUrl:n,videoUrl:l,likesCount:_(a.likesCount),commentsCount:_(a.commentsCount),impressions:0,dateLabel:m?m.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit"}):"",createdAtMs:m?m.getTime():0}}function ga({days:e=[],todayKey:a="",rawPosts:t=[]}={}){const o=Array.isArray(e)?e:[],n=Q(o),l=o.find(h=>String(h?.date||h?.id||"").trim()===String(a||"").trim()),m=Q(l?[l]:[]),p=n.merged?.posts&&typeof n.merged.posts=="object"?n.merged.posts:{},k=(Array.isArray(t)?t:[]).map(h=>pa(h?.id,h?.data||{})).filter(h=>h.id).map(h=>({...h,impressions:_(p[h.id]?.impressions)})),D=k.slice().sort((h,b)=>b.createdAtMs-h.createdAtMs).slice(0,ca);return{day:String(a||"").trim(),week:n.summary,today:m.summary,posts:D,latestPost:ba(k)}}function ba(e=[]){const a=(Array.isArray(e)?e:[]).filter(t=>t&&t.id);return a.length?a.slice().sort((t,o)=>_(o.createdAtMs)-_(t.createdAtMs)||_(o.impressions)-_(t.impressions)||_(o.likesCount)-_(t.likesCount))[0]:null}function fa({profile:e={},restaurant:a={}}={}){return Re({profile:e,restaurant:a,feature:"qr"})}function ya(e={}){const a=e&&typeof e=="object"?e:{};return String(a.titleImageUrl||a.coverImageUrl||a.coverUrl||a.heroUrl||a.bannerUrl||"").trim()}function _a({model:e=null,coverUrl:a="",subscribed:t=!1,assets:o={}}={}){const n=e?.today||{},l=!e,m=e?.latestPost||null,p=[];if(l)p.push({key:"latestPost",label:"Postimi fundit",pending:!0});else if(!m)p.push({key:"latestPost",label:"Postimi fundit",emptyText:"S'ka postim",iconName:"image",composer:"post"});else{const k=String(m.thumbUrl||"").trim();p.push({key:"latestPost",label:"Postimi fundit",value:C(_(m.impressions)),withEye:!0,imageUrl:k,videoUrl:k?"":String(m.videoUrl||"").trim(),iconName:"image",panelTab:"analitika"})}return p.push({key:"profileViews",label:"Vizitor n'profil",value:C(_(n.profileViews)),withEye:!0,loading:l,imageUrl:String(a||"").trim(),iconName:"user",panelTab:"analitika"}),p.push({key:"menuOpens",label:"Vizitor n'meny",value:C(_(n.menuOpens)),withEye:!0,loading:l&&t,locked:!t,imageUrl:String(o.menuImageUrl||"").trim(),iconName:"book-open",panelTab:"analitika"}),p.push({key:"qrScans",label:"Skanime n'tavolina",value:C(_(n.qrScans)),withEye:!0,loading:l&&t,locked:!t,imageUrl:String(o.qrImageUrl||"").trim(),iconName:"layout-grid",panelTab:"analitika"}),p}function za({state:e,renderFn:a,documentObj:t,firestoreApi:o={},profileApi:n={},composerApi:l={},viewApi:m={},iconFn:p,storageObj:k}={}){const D=t||(typeof document>"u"?null:document),h=D?.defaultView||(typeof window>"u"?null:window),b=typeof a=="function"?a:()=>{},y=k||(typeof localStorage>"u"?null:localStorage),A=typeof n.getBusinessProfileTypeFn=="function"?n.getBusinessProfileTypeFn:(()=>""),ie=typeof n.isShopCatalogProfileFn=="function"?n.isShopCatalogProfileFn:(()=>!1),oe=typeof n.isBusinessOwnerProfileFn=="function"?n.isBusinessOwnerProfileFn:(()=>!1),U=typeof n.getRestaurantMetaByIdFn=="function"?n.getRestaurantMetaByIdFn:(()=>null),de=typeof n.resolveRestaurantLogoFn=="function"?n.resolveRestaurantLogoFn:(()=>""),le=typeof n.resolveOwnAvatarUrlFn=="function"?n.resolveOwnAvatarUrlFn:(()=>""),ce=typeof m.renderAnalyticsViewFn=="function"?m.renderAnalyticsViewFn:(()=>""),he=typeof m.renderSettingsViewFn=="function"?m.renderSettingsViewFn:(()=>""),ue=typeof m.warmAnalyticsFn=="function"?m.warmAnalyticsFn:(()=>{});let L=!1,B=0,O=!1,F=null,$=null,R="",H=!1,Z=()=>null;const me=300;function I(){const r=e?.userProfile||{};return Oe({businessType:A(r),isShopCatalog:ie(r)})}function pe(r=""){const s=U(r)||{};return Ie(s).map(i=>({id:i.id,name:i.title,price:i.price??"",category:i.beds||i.tag||"",type:"room",imageUrl:i.imageUrl||""}))}function ge(r=""){if(!y)return null;try{const s=y.getItem(`${ae}${r}`);if(!s)return null;const i=JSON.parse(s),d=Array.isArray(i?.items)?i.items:null;return d&&d.length?d:null}catch{return null}}function be(r="",s=[]){if(y)try{y.setItem(`${ae}${r}`,JSON.stringify({savedAt:Date.now(),items:s}))}catch{}}async function fe(r=""){const{db:s,collectionFn:i,queryFn:d,limitFn:u,getDocsFn:g}=o;if(!s||typeof i!="function"||typeof g!="function")throw new Error("Produktet nuk u ngarkuan.");const x=i(s,"restaurants",r,"menuItems"),w=typeof d=="function"&&typeof u=="function"?d(x,u(me)):x,S=await g(w),f=[];return S.forEach(P=>{const K=Z(P?.id,P?.data?.()||{});K&&f.push(K)}),f.sort((P,K)=>P.name.localeCompare(K.name,"sq")),f}async function ye(r="",s){const i=String(r||"").trim();if(!i)throw new Error("Produktet nuk u ngarkuan.");if(I()==="hotel")return pe(i);const d=fe(i).then(g=>(be(i,g),g)),u=ge(i);return u?(typeof s=="function"?d.then(g=>s(g)).catch(()=>{}):d.catch(()=>{}),u):d}function V(){return F?Promise.resolve(F):($||($=Ce(()=>import("./business-composer-controller-yvG6FGBe.js"),__vite__mapDeps([0,1,2,3,4,5,6])).then(r=>(Z=typeof r?.normalizeComposerProductCore=="function"?r.normalizeComposerProductCore:(()=>null),F=r.createBusinessComposerController({documentObj:D,windowObj:D?.defaultView||null,api:{getRestaurantIdFn:()=>j(),getBusinessMetaFn:()=>{const s=j();if(!s)return{name:"",logoUrl:"",city:""};const i=Y(s),d=U(s)||{};return{name:i.name,logoUrl:i.logoUrl,city:String(d.city||"").trim()}},loadProductsFn:(s,i)=>ye(s,i),getBusinessKindFn:()=>I(),uploadImageFn:l.uploadImageFn,uploadVideoFn:l.uploadVideoFn,captureVideoPosterFn:l.captureVideoPosterFn,createPostFn:l.createPostFn,createStoryFn:l.createStoryFn,formatPriceFn:l.formatPriceFn,getOptimizedImageUrlFn:l.getOptimizedImageUrlFn,escapeHtmlFn:l.escapeHtmlFn,iconFn:typeof p=="function"?p:void 0,afterPublishFn:async s=>{try{await E({force:!0})}catch{}typeof l.afterPublishFn=="function"&&await l.afterPublishFn(s)}}}),F)).catch(r=>{throw $=null,console.error("[mnyra][dashboard] composer load failed",r),r})),$)}function q(){const r=h?.navigator?.connection;return!r||typeof r!="object"?!1:r.saveData===!0?!0:/(^|-)2g$/.test(String(r.effectiveType||"").trim().toLowerCase())}function _e(){if(H||F||!h||q())return;H=!0;const r=()=>{if(V().catch(()=>{}),typeof l.prewarmFn=="function")try{l.prewarmFn()}catch{}};if(typeof h.requestIdleCallback=="function"){h.requestIdleCallback(r,{timeout:te});return}h.setTimeout?.(r,ne)}function ve(){if(L||!h||q())return;L=!0;const r=()=>{try{ue()}catch{}};if(typeof h.requestIdleCallback=="function"){h.requestIdleCallback(r,{timeout:te});return}h.setTimeout?.(r,ne)}function we(r="post"){const s=String(r||"").trim().toLowerCase(),i=s==="story"||s==="profile"?s:"post";if(typeof l.prewarmFn=="function")try{l.prewarmFn()}catch{}if(F){F.open(i);return}R=i,V().then(d=>{const u=R||i;R="",d?.open?.(u)}).catch(()=>{R=""})}function N(){return(!e.dashboardView||typeof e.dashboardView!="object")&&(e.dashboardView={status:"idle",error:"",model:null,loadedSignature:"",restaurantId:"",paywall:""}),e.dashboardView}function G(r=""){const s=N(),i=String(r||"").trim();return String(s.restaurantId||"")===i||(s.restaurantId=i,s.model=null,s.status="idle",s.error="",s.loadedSignature="",s.paywall="",B+=1),s}function j(){const r=e?.userProfile||{};return String(r.restaurantId||r.staffRestaurantId||"").trim()}let W="";function ke(){const r=String(e?.user?.uid||"").trim();!r||W===r||typeof n.ensureBusinessProfileFn=="function"&&(W=r,Promise.resolve().then(()=>n.ensureBusinessProfileFn()).catch(s=>{console.warn("[mnyra][panel] business profile could not be resolved",s)}).finally(()=>{String(e?.user?.uid||"").trim()===r&&b()}))}function xe(){const r=String(e?.user?.uid||"").trim();if(!r)return!1;const s=String(e?.__authBootstrapInFlightUid||"").trim();return!!e?.__authProfileLoadPromise||s===r}function J(r=""){return`${da}${r}`}function Se(r="",s=""){if(!y||!r)return null;try{const i=y.getItem(J(r));if(!i)return null;const d=JSON.parse(i);return!d||typeof d!="object"||String(d.day||"").trim()!==String(s||"").trim()||!d.model||typeof d.model!="object"?null:d.model}catch{return null}}function ze(r="",s=null){if(!(!y||!r||!s))try{y.setItem(J(r),JSON.stringify({day:s.day,model:s}))}catch{}}async function De(r=""){const{db:s,collectionFn:i,queryFn:d,orderByFn:u,limitFn:g,getDocsFn:x}=o;if(!s||typeof i!="function"||typeof d!="function"||typeof u!="function"||typeof g!="function"||typeof x!="function")return[];const w=i(s,"restaurants",r,"socialPosts");return(await x(d(w,u("createdAt","desc"),g(la)))).docs.map(f=>({id:f.id,data:f.data()||{}})).filter(f=>{const P=String(f.data.status||"active").trim().toLowerCase();return P!=="deleted"&&P!=="hidden"})}async function E({force:r=!1}={}){const s=j(),i=G(s);if(!s)return;const d=Be({rangeKey:"7d"});if(!d)return;const u=`${s}::${d.toDay}`;if(!r&&i.loadedSignature===u&&i.status==="ready")return;if(!i.model){const w=Se(s,d.toDay);w&&(i.model=w,i.status="ready",b())}B+=1;const g=B;i.model||(i.status="loading",i.error="",b());try{const w={db:o.db,collectionFn:o.collectionFn,queryFn:o.queryFn,whereFn:o.whereFn,documentIdFn:o.documentIdFn,getDocsFn:o.getDocsFn,restaurantId:s},[S,f]=await Promise.allSettled([$e({...w,fromDay:d.fromDay,toDay:d.toDay}),De(s)]);if(g!==B)return;if(S.status==="rejected")throw S.reason;f.status==="rejected"&&console.error("[mnyra][dashboard] recent posts load failed",f.reason),i.model=ga({days:S.value,todayKey:d.toDay,rawPosts:f.status==="fulfilled"?f.value:[]}),i.status="ready",i.error="",i.loadedSignature=u,ze(s,i.model)}catch(w){if(g!==B)return;console.error("[mnyra][dashboard] load failed",w),i.model||(i.status="error",i.error="Ju lutem kontrollo lidhjen dhe provo perseri.")}b()}function Pe(){O||!D||(O=!0,D.addEventListener("click",r=>{try{if(String(e?.activeTab||"").trim().toLowerCase()!=="dashboard")return;if(r.target?.closest?.("[data-dashboard-retry]")){E({force:!0});return}if(r.target?.closest?.("[data-dashboard-paywall-close]")){r.preventDefault(),N().paywall="",b();return}const s=r.target?.closest?.("[data-dashboard-metric-locked]");if(s){r.preventDefault(),N().paywall=String(s.getAttribute("data-dashboard-metric-locked")||"").trim(),b();return}const i=r.target?.closest?.("[data-dashboard-composer]");if(i){r.preventDefault(),we(i.getAttribute("data-dashboard-composer"));return}const d=r.target?.closest?.("[data-dashboard-panel-tab]");if(d){r.preventDefault();const u=T(d.getAttribute("data-dashboard-panel-tab"));if(u===T(e?.dashboardPanelTab))return;e.dashboardPanelTab=u,b()}}catch{}}))}function Y(r=""){const s=e?.userProfile||{},i=r?U(r)||{}:{},d=String(i.name||i.restaurantName||s.name||"").trim()||"Business";let u="";try{u=String(le()||"").trim()}catch{}if(!u)try{u=String(de(i)||"").trim()}catch{}return{name:d,logoUrl:u,kind:I(),coverUrl:ya(i),subscribed:fa({profile:s,restaurant:i})}}function Fe(){Me(D),Pe();const r=j(),s=G(r);let i="";if(!r)ke(),i=xe()?sa():oa();else{_e(),ve();const d=Y(r),u=He({kind:d.kind,isOwner:oe(e?.userProfile)}),g=T(e?.dashboardPanelTab);s.status==="idle"&&(s.status="loading",queueMicrotask(()=>{E({force:!1})}));let x="";s.model?x=aa({posts:s.model.posts,iconFn:p}):s.status==="error"?x=ia({message:s.error}):x=ta();const w=`
    ...
    `}return Object.freeze({renderDashboardView:Fe,loadDashboard:E})}export{Ee as M,za as a,Ie as b,Ke as c,xa as d,Sa as f,Ue as n};
