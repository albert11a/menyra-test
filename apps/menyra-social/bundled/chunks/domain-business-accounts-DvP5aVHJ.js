const ge="crm-admin-business-account-write-facade.v1",ve=Object.freeze(["saveBusinessAccountFromView","toggleBusinessAccountActive"]);function Y(e,a){return function(...d){if(typeof a!="function")throw new Error(`CRM admin business account write facade handler missing: ${e}`);return a(...d)}}function xe({saveBusinessAccount:e,updateBusinessAccount:a,saveBusinessAccountFromView:i,toggleBusinessAccountActive:d}={}){const o=Y("saveBusinessAccountFromView",typeof e=="function"?e:i),A=Y("toggleBusinessAccountActive",typeof a=="function"?a:d);return Object.freeze({version:ge,operations:ve,saveCrmBusinessAccount:o,updateCrmBusinessAccount:A,saveBusinessAccount:o,updateBusinessAccount:A,saveBusinessAccountFromView:o,toggleBusinessAccountActive:A})}function f(e=""){return String(e||"").trim()}function se(e={},a=""){const i=e&&typeof e=="object"?e:{},d=i.permissions&&typeof i.permissions=="object"?i.permissions:{},o=f(i.firstName),A=f(i.lastName),x=f(i.name||`${o} ${A}`.trim()||i.displayName),$=f(i.status||(i.active===!1?"disabled":"active")).toLowerCase(),b=i.active===!1?!1:$!=="disabled",g=f(i.role||i.staffRole).toLowerCase();return{uid:f(a||i.uid||i.userId),userId:f(i.userId||i.uid||a),restaurantId:f(i.restaurantId),firstName:o,lastName:A,name:x,email:f(i.email),role:g==="manager"?"manager":"waiter",businessAccess:i.businessAccess===!0||d.businessAccess===!0,waiterAccess:i.waiterAccess===!0||d.waiterAccess===!0,active:b,status:b?"active":"disabled",createdAt:i.createdAt||null,updatedAt:i.updatedAt||null}}async function we({db:e,collectionFn:a,getDocsFn:i,restaurantId:d="",normalizeBusinessAccountEntryFn:o=se}={}){const A=f(d),x=[];if(e||x.push("db"),typeof a!="function"&&x.push("collection"),typeof i!="function"&&x.push("getDocs"),A||x.push("restaurantId"),x.length)throw new Error(`loadCrmBusinessAccountsCore missing read deps: ${x.join(", ")}`);const $=await i(a(e,"restaurants",A,"staff")),b=[];return $?.forEach&&$.forEach(g=>{const w=o(g.data?.()||{},g.id);w.uid&&b.push(w)}),b.sort((g,w)=>{const j=`${f(g.firstName)} ${f(g.lastName)}`.trim().toLowerCase(),I=`${f(w.firstName)} ${f(w.lastName)}`.trim().toLowerCase();return j.localeCompare(I)}),{rows:b,items:b,hasMore:!1,knownCount:b.length,countExact:!0,restaurantId:A}}function r(e=""){return String(e||"").trim()}function R(e=""){return r(e).toLowerCase()==="manager"?"manager":"waiter"}function ke({businessAccess:e=!1,waiterAccess:a=!1}={}){return e&&a?"Beides":e?"Business":a?"Waiter":"Pa qasje"}function F(){return{firstName:"",lastName:"",email:"",password:"",role:"waiter",businessAccess:!1,waiterAccess:!0,active:!0}}function ee(e={},a=""){return se(e,a)}function he(e={}){return e.active?'<span class="px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-[9px] font-black uppercase tracking-widest">Aktiv</span>':'<span class="px-3 py-1 rounded-full bg-slate-100 text-slate-500 text-[9px] font-black uppercase tracking-widest">Deaktiviert</span>'}function Ne({state:e,icon:a,escapeHtml:i,db:d,auth:o,collection:A,getDocs:x,getDoc:$,doc:b,setDoc:g,serverTimestamp:w,createAuthUser:j,signOut:I,saveUserProfileToStorage:D,render:W,getRestaurantMetaById:T,isBusinessOwnerProfile:K,isPlaceholderUrl:ye,getOptimizedImageUrl:Be,PLACEHOLDER_IMAGE:$e=""}={}){const N=typeof a=="function"?a:(()=>""),u=typeof i=="function"?i:((n="")=>String(n||"")),p=typeof W=="function"?W:(()=>{}),te=typeof T=="function"?T:(()=>null),ne=typeof j=="function"?j:(async()=>null),ie=typeof I=="function"?I:(async()=>{}),ce=typeof D=="function"?D:(()=>{}),re=typeof K=="function"?K:(()=>!1);function k(){(!e.businessAccounts||typeof e.businessAccounts!="object")&&(e.businessAccounts={items:[],view:"list",editorUid:"",loading:!1,saving:!1,deleting:!1,loaded:!1,error:"",status:"",form:F()})}function z(){return re(e?.userProfile)}function L(){return z()?r(e?.userProfile?.restaurantId):""}function O(n=""){k(),e.businessAccounts={...e.businessAccounts,view:"list",editorUid:"",saving:!1,deleting:!1,error:"",status:r(n),form:F()}}function V(n="create",t=null){k();const s=t?ee(t,t.uid||t.userId||""):null;e.businessAccounts={...e.businessAccounts,view:"form",editorUid:s?.uid||"",deleting:!1,error:"",status:"",form:s?{firstName:s.firstName,lastName:s.lastName,email:s.email,password:"",role:s.role,businessAccess:s.businessAccess,waiterAccess:s.waiterAccess,active:s.active}:F()},p()}function q(n=""){O(n),p()}function P(n=document){k();const t=n||document,s=m=>{const l=t?.getElementById(m);return l&&"value"in l?String(l.value||""):""},c=m=>!!t?.getElementById(m)?.checked;e.businessAccounts.form={...e.businessAccounts.form,firstName:s("businessAccountFirstName").trim(),lastName:s("businessAccountLastName").trim(),email:s("businessAccountEmail").trim().toLowerCase(),password:s("businessAccountPassword"),role:R(s("businessAccountRole")),businessAccess:c("businessAccountBusinessAccess"),waiterAccess:c("businessAccountWaiterAccess"),active:c("businessAccountActive")}}async function _({force:n=!1}={}){k();const t=L();if(!t)return e.businessAccounts.error="Zona e stafit nuk eshte e disponueshme.",p(),[];if(e.businessAccounts.loading)return e.businessAccounts.items||[];if(e.businessAccounts.loaded&&!n)return e.businessAccounts.items||[];e.businessAccounts.loading=!0,e.businessAccounts.error="",p();try{const s=await we({db:d,collectionFn:A,getDocsFn:x,restaurantId:t,normalizeBusinessAccountEntryFn:ee}),c=Array.isArray(s.items)?s.items:[];return e.businessAccounts.items=c,e.businessAccounts.loaded=!0,e.businessAccounts.loading=!1,e.businessAccounts.error="",p(),c}catch(s){return console.error(s),e.businessAccounts.loading=!1,e.businessAccounts.error=s?.message||"Stafi nuk mund te ngarkohej.",p(),[]}}async function ae(){k();const n=L();if(!n||!e?.user?.uid)return;P();const t=e.businessAccounts.form||{},s=!!r(e.businessAccounts.editorUid),c=r(t.firstName),m=r(t.lastName),l=r(t.email).toLowerCase(),y=String(t.password||""),S=R(t.role),h=t.businessAccess===!0,B=t.waiterAccess===!0,E=t.active!==!1,M=r(`${c} ${m}`.trim()),Z=te(n)||{},me=r(Z.name||Z.restaurantName||e.userProfile?.name||"Business");if(!c||!m||!l||!s&&!y){e.businessAccounts.error=s?"Emri, mbiemri dhe email jane te detyrueshme.":"Emri, mbiemri, email dhe fjalekalimi jane te detyrueshme.",p();return}if(!l.includes("@")){e.businessAccounts.error="Ju lutem shkruani nje email te vlefshem.",p();return}if(!h&&!B){e.businessAccounts.error="Te pakten nje qasje duhet te jete aktive.",p();return}e.businessAccounts.saving=!0,e.businessAccounts.deleting=!1,e.businessAccounts.error="",e.businessAccounts.status=s?"Llogaria po ruhet...":"Llogaria po krijohet...",p();const C=o?.currentUser||null;try{let v=r(e.businessAccounts.editorUid);if(!v){const Ae=await ne(l,y);v=r(Ae?.uid)}if(!v)throw new Error("Llogaria nuk mund te krijohej.");const U=w(),J={businessAccess:h,waiterAccess:B},Q={uid:v,userId:v,restaurantId:n,restaurantName:me,firstName:c,lastName:m,name:M,email:l,role:S,permissions:J,businessAccess:h,waiterAccess:B,active:E,status:E?"active":"disabled",createdByUid:r(e.user.uid),createdByName:r(e.userProfile?.name||e.user.displayName||""),updatedAt:U},X={uid:v,displayName:M,name:M,firstName:c,lastName:m,email:l,role:"staff",roles:["staff"],status:E?"active":"disabled",staffRole:S,permissions:J,businessAccess:h,waiterAccess:B,staffActive:E,staffStatus:E?"active":"disabled",staffRestaurantId:n,waiterRestaurantId:n,restaurantId:h?n:"",businessOwnerUid:r(e.user.uid),updatedAt:U};s||(Q.createdAt=U,X.createdAt=U),await g(b(d,"restaurants",n,"staff",v),Q,{merge:!0}),await g(b(d,"users",v),X,{merge:!0}),C&&o?.currentUser&&r(o.currentUser.uid)!==r(C.uid)&&await ie(o).catch(()=>{}),C&&(!o?.currentUser||r(o.currentUser.uid)!==r(C.uid))&&ce(),O(s?"Llogaria u ruajt.":"Llogaria u krijua."),await _({force:!0})}catch(v){console.error(v),e.businessAccounts.saving=!1,e.businessAccounts.deleting=!1,e.businessAccounts.error=v?.message||"Llogaria nuk mund te ruhej.",e.businessAccounts.status="",p()}}async function ue(){k();const n=r(e.businessAccounts.editorUid),t=L();if(!(!n||!t)){P(),e.businessAccounts.form.active=!e.businessAccounts.form.active,e.businessAccounts.deleting=!0,e.businessAccounts.saving=!1,e.businessAccounts.error="",e.businessAccounts.status=e.businessAccounts.form.active?"Llogaria po aktivizohet...":"Llogaria po deaktivizohet...",p();try{const s=e.businessAccounts.form.active!==!1,c={businessAccess:e.businessAccounts.form.businessAccess===!0,waiterAccess:e.businessAccounts.form.waiterAccess===!0};await g(b(d,"restaurants",t,"staff",n),{active:s,status:s?"active":"disabled",businessAccess:c.businessAccess,waiterAccess:c.waiterAccess,permissions:c,updatedAt:w()},{merge:!0}),await g(b(d,"users",n),{businessAccess:c.businessAccess,waiterAccess:c.waiterAccess,permissions:c,staffActive:s,staffStatus:s?"active":"disabled",status:s?"active":"disabled",restaurantId:c.businessAccess?t:"",updatedAt:w()},{merge:!0}),e.businessAccounts.deleting=!1,e.businessAccounts.status=s?"Llogaria u aktivizua.":"Llogaria u deaktivizua.",await _({force:!0})}catch(s){console.error(s),e.businessAccounts.deleting=!1,e.businessAccounts.error=s?.message||"Statusi nuk mund te perditesohej.",e.businessAccounts.status="",p()}}}const oe=xe({saveBusinessAccountFromView:ae,toggleBusinessAccountActive:ue}),{saveCrmBusinessAccount:H,updateCrmBusinessAccount:G}=oe;function le(){return`
    ...
    `}function de(){const n=e.businessAccounts.form||F(),t=!!r(e.businessAccounts.editorUid),s=e.businessAccounts.saving?t?"Duke ruajtur...":"Duke krijuar...":t?"Ruaj llogarine":"Krijo llogari",c=n.active!==!1;return`
    ...
    `}function fe(){const n=Array.isArray(e.businessAccounts.items)?e.businessAccounts.items:[],t=e.businessAccounts.loading?'<div class="text-center text-[10px] font-bold uppercase tracking-widest text-slate-400 py-16">Accounts laden...</div>':n.length?n.map(s=>{const c=ke(s);return`
