import{_ as ur}from"./domain-auth-s7TCC84S.js";import{w as pr}from"./domain-menu-eager-DoUNtcee.js";import{a as Qt}from"./domain-media-eager-B90n_Ot7.js";import{am as Ye,an as fr,t as mr,ao as gr,k as br,ap as We}from"./domain-feed-social-eager-BK0Unws6.js";import{n as ra,g as Jt,h as hr,i as vr}from"./domain-app-events-C-h6Kqxb.js";import{K as xr,L as wr,M as yr,N as $r,O as kr,P as Sr,Q as Ir,J as Cr,R as Pr,A as Ar,g as Tr,B as jr,S as Lr,T as _r,b as Fr,d as Mr}from"./vendor-firebase-D7Ks7H8l.js";import{a as Rr,r as Er,b as ia,w as zr,B as oa}from"./business-type-hint-utils-CdPWo8OB.js";import"./domain-public-profile-BW4dw-Ab.js";const on=Object.freeze([Object.freeze({key:"city",label:"Qyteti",labelDe:"Stadt"}),Object.freeze({key:"beach",label:"Plazha",labelDe:"Straende"}),Object.freeze({key:"sights",label:"Vende per te pare",labelDe:"Sehenswuerdigkeiten"}),Object.freeze({key:"activities",label:"Aktivitete",labelDe:"Aktivitaeten"}),Object.freeze({key:"nature",label:"Natyre",labelDe:"Natur"}),Object.freeze({key:"food",label:"Restorante & Kafene",labelDe:"Restaurants & Cafes"}),Object.freeze({key:"nearby",label:"Vende te rendesishme",labelDe:"Wichtige Orte"})]),Nr=Object.freeze(on.map(l=>l.key)),Dr=Object.freeze([Object.freeze({key:"all",labelDe:"Ganzjaehrig"}),Object.freeze({key:"summer",labelDe:"Saisonal Sommer"}),Object.freeze({key:"winter",labelDe:"Saisonal Winter"})]),Ur=Object.freeze(Dr.map(l=>l.key)),Br=12;function ve(l=""){return l==null?"":String(l).trim()}function Xt(l){const r=Number(l);return Number.isFinite(r)?r:null}function Or(l=""){const r=ve(l).toLowerCase();return Nr.includes(r)?r:{qyteti:"city",stadt:"city",plazha:"beach",plazhi:"beach",strand:"beach",straende:"beach",sehenswuerdigkeiten:"sights",sehenswurdigkeiten:"sights",aktivitete:"activities",aktivitaeten:"activities",natyre:"nature",natur:"nature",restorante:"food",restaurants:"food",cafes:"food",kafene:"food",umgebung:"nearby",rrethina:"nearby"}[r]||"nearby"}function Hr(l=""){const r=ve(l).toLowerCase();return Ur.includes(r)?r:"all"}function Vr(l=Date.now(),r=Math.random()){const u=Math.max(0,Number(l)||0).toString(36),a=Math.floor(Math.max(0,Math.min(.999999,Number(r)||0))*36**6).toString(36).padStart(6,"0");return`place_${u}_${a}`}function Kr(l){return Array.isArray(l)?l.map(r=>ve(r)).filter(Boolean).slice(0,Br):[]}function qr(l={},{index:r=0}={}){const u=l&&typeof l=="object"?l:{},a=Xt(u.lat??u.latitude??u.coords?.lat),g=Xt(u.lng??u.lon??u.longitude??u.coords?.lng),f=Xt(u.priority);return{id:ve(u.id)||Vr(Date.now()+r),name:ve(u.name),category:Or(u.category),description:ve(u.description??u.text).slice(0,600),address:ve(u.address??u.plusCode).slice(0,240),lat:a,lng:g,coverImageUrl:ve(u.coverImageUrl??u.imageUrl??u.coverUrl),gallery:Kr(u.gallery),priority:f==null?0:Math.max(0,Math.min(100,Math.round(f))),pinned:u.pinned===!0,season:Hr(u.season??u.seasonal),active:u.active!==!1}}const Gr=6371e3,Yr=80,Wr=600,Qr=1600;function vt(l=0){return(Number(l)||0)*(Math.PI/180)}function ze(l){return l==null||l===""?NaN:Number(l)}function $t(l={}){return Number.isFinite(ze(l?.lat))&&Number.isFinite(ze(l?.lng))}function Jr(l,r,u,a){const g=ze(l),f=ze(r),R=ze(u),U=ze(a);if(![g,f,R,U].every(Number.isFinite))return null;const Y=vt(R-g),L=vt(U-f),A=Math.sin(Y/2)**2+Math.cos(vt(g))*Math.cos(vt(R))*Math.sin(L/2)**2;return Math.round(2*Gr*Math.asin(Math.min(1,Math.sqrt(A))))}function Xr(l){const r=Number(l);return!Number.isFinite(r)||r<0?"":r<1e3?`${Math.max(10,Math.round(r/10)*10)} m`:r<1e4?`${(r/1e3).toFixed(1).replace(/\.0$/,"")} km`:`${Math.round(r/1e3)} km`}function Zr(l){const r=Number(l);return!Number.isFinite(r)||r<0?null:r<=Qr?{mode:"walk",minutes:Math.max(1,Math.round(r/Yr))}:{mode:"drive",minutes:Math.max(1,Math.round(r/Wr))}}function la(l,r={}){const u=Zr(l);if(!u)return"";const a=String(r.walk||"min in Gehweite"),g=String(r.drive||"min mit dem Auto");return`${u.minutes} ${u.mode==="walk"?a:g}`}const ba=200;function he(l=""){return l==null?"":String(l).trim()}function ca(l){return Array.isArray(l)?Array.from(new Set(l.map(r=>he(r)).filter(Boolean))).slice(0,ba):[]}function ha(l={}){const r=l&&typeof l=="object"?l:{},u=r.placePatches&&typeof r.placePatches=="object"?r.placePatches:{},a={};return Object.entries(u).slice(0,ba).forEach(([g,f])=>{const R=he(g);if(!R||!f||typeof f!="object")return;const U={};he(f.name)&&(U.name=he(f.name)),he(f.description)&&(U.description=he(f.description).slice(0,600)),he(f.coverImageUrl)&&(U.coverImageUrl=he(f.coverImageUrl)),Object.keys(U).length&&(a[R]=U)}),{hidden:ca(r.hidden),pinned:ca(r.pinned),placePatches:a}}function en({places:l=[],overrides:r={},hotelCoords:u=null,includeHidden:a=!1}={}){const g=ha(r),f=new Set(g.hidden),R=new Map(g.pinned.map((L,A)=>[L,A])),U=$t(u)?u:null;return(Array.isArray(l)?l:[]).map((L,A)=>qr(L,{index:A})).filter(L=>L.name&&L.active).map(L=>{const A=g.placePatches[L.id]||{},Q=U&&$t(L)?Jr(U.lat,U.lng,L.lat,L.lng):null;return{...L,...A,hidden:f.has(L.id),pinned:R.has(L.id)||L.pinned,pinnedRank:R.has(L.id)?R.get(L.id):null,distanceMeters:Q}}).filter(L=>a||!L.hidden).sort((L,A)=>{const Q=L.pinnedRank!=null,xe=A.pinnedRank!=null;if(Q!==xe)return Q?-1:1;if(Q&&xe&&L.pinnedRank!==A.pinnedRank)return L.pinnedRank-A.pinnedRank;if(L.pinned!==A.pinned)return L.pinned?-1:1;if(L.priority!==A.priority)return A.priority-L.priority;const Ce=Number.isFinite(L.distanceMeters)?L.distanceMeters:1/0,Pe=Number.isFinite(A.distanceMeters)?A.distanceMeters:1/0;return Ce!==Pe?Ce-Pe:String(L.name).localeCompare(String(A.name))})}function ei(l=[]){const r=Array.isArray(l)?l:[];return on.map(u=>({...u,places:r.filter(a=>a.category===u.key)})).filter(u=>u.places.length)}const tn="mnyraHotelDestinationSections",da="mnyraHotelDetailStyles",ti="/apps/menyra-social/styles/hotel-detail.css?v=2026-07-10-hotel-detail-v1",ua=Object.freeze({walk:"min në këmbë",drive:"min me makinë"}),De=Object.freeze({rooms:"Qëndrimi yt",city:"Përreth teje",beach:"Deti afër",sights:"Vlen të shihet",activities:"Përjeto zonën",nature:"Natyrë e gjallë",food:"Shijo lokal",nearby:"Afër teje",amenities:"Pa pagesë shtesë",map:"Zbulo zonën",rating:"Nga vizitorët"}),nn=Object.freeze({city:"Qyteti",beach:"Plazha",sights:"Vende për të parë",activities:"Aktivitete",nature:"Natyra",food:"Restorante & Kafene",nearby:"Vende të rëndësishme"}),an=Object.freeze({bed:'<path d="M2 20v-8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v8M4 10V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4M12 4v6M2 18h20"/>',building:'<path d="M10 12h4M10 8h4M14 21v-3a2 2 0 0 0-4 0v3M6 10H4a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16"/>',waves:'<path d="M2 5q2.5 2 5 0t5 0 5 0 5 0M2 12q2.5 2 5 0t5 0 5 0 5 0M2 19q2.5 2 5 0t5 0 5 0 5 0"/>',compass:'<circle cx="12" cy="12" r="10"/><path d="m16.24 7.76-2.12 6.36-6.36 2.12 2.12-6.36z"/>',sparkles:'<path d="m12 3-1.2 3.1L8 7.5l2.8 1.4L12 12l1.2-3.1L16 7.5l-2.8-1.4zM5 14l-.8 2.2L2 17l2.2.8L5 20l.8-2.2L8 17l-2.2-.8zM18 13l-1 2.7-3 1.3 3 1.3 1 2.7 1-2.7 3-1.3-3-1.3z"/>',tree:'<path d="m17 14 3 3h-5l3 3H6l3-3H4l3-3H3l5-5H5l7-7 7 7h-3l5 5zM12 20v2"/>',coffee:'<path d="M10 2v2M14 2v2M6 2v2M18 8h1a3 3 0 0 1 0 6h-1M4 8h14v9a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3z"/>',pin:'<path d="M20 10c0 5-8 12-8 12S4 15 4 10a8 8 0 1 1 16 0"/><circle cx="12" cy="10" r="3"/>',nav:'<path d="m3 11 19-9-9 19-2-8z"/>',clock:'<circle cx="12" cy="12" r="10"/><path d="M12 6v6h4"/>',star:'<path d="m12 2 3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z"/>',expand:'<path d="M8 3H3v5M16 3h5v5M8 21H3v-5M16 21h5v-5M3 3l6 6M21 3l-6 6M3 21l6-6M21 21l-6-6"/>',check:'<path d="m20 6-11 11-5-5"/>',wifi:'<path d="M5 12.55a11 11 0 0 1 14 0M1.42 9a16 16 0 0 1 21.16 0M8.53 16.11a6 6 0 0 1 6.95 0M12 20h.01"/>',car:'<path d="m5 17-2-1v-4l2-5h14l2 5v4l-2 1M5 17v2M19 17v2M3 13h18M7 13h.01M17 13h.01"/>',snow:'<path d="M12 2v20M4.93 4.93l14.14 14.14M2 12h20M4.93 19.07 19.07 4.93M8 5l4 2 4-2M8 19l4-2 4 2"/>',shield:'<path d="M20 13c0 5-3.5 7.5-8 9-4.5-1.5-8-4-8-9V5l8-3 8 3z"/><path d="m9 12 2 2 4-4"/>',umbrella:'<path d="M2 12h20M12 12v8a2 2 0 0 0 4 0M2 12a10 10 0 0 1 20 0M12 2v1"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M16 3.2a4 4 0 0 1 0 7.6M22 21v-2a4 4 0 0 0-3-3.9"/><circle cx="9" cy="7" r="4"/>',size:'<path d="M15 3h6v6M21 3l-7 7M3 21l7-7M9 21H3v-6"/>'}),ni=Object.freeze({city:"building",beach:"waves",sights:"compass",activities:"sparkles",nature:"tree",food:"coffee",nearby:"pin"}),ai=Object.freeze([{keywords:["wifi","wi-fi","internet"],icon:"wifi"},{keywords:["parkim","parking","garazh"],icon:"car"},{keywords:["mengjes","mëngjes","breakfast","fruehstueck"],icon:"coffee"},{keywords:["klime","klimë","kondicioner","ac"],icon:"snow"},{keywords:["plazh","det","beach","pishine","pishinë","pool"],icon:"waves"},{keywords:["shezlong","ombrelle","umbrella"],icon:"umbrella"},{keywords:["recepsion","reception","siguri","security","24"],icon:"shield"},{keywords:["pastrim","cleaning","spa"],icon:"sparkles"},{keywords:["famil","person"],icon:"users"}]);function V(l=""){return l==null?"":String(l).trim()}function N(l=""){return V(l).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ie(l="pin",r=""){const u=an[l]||an.pin;return`<svg class="mhd-icon ${r}" viewBox="0 0 24 24" aria-hidden="true">${u}</svg>`}function pa(l=typeof document>"u"?null:document){if(!l||l.getElementById(da))return;const r=l.createElement("link");r.id=da,r.rel="stylesheet",r.href=ti,l.head.appendChild(r)}function Ue({iconName:l="pin",eyebrow:r="",title:u=""}={}){return`
  ...
  `}function si(l=""){const r=V(l);if(!r)return null;const u=r.match(/(\d+(?:[.,]\d+)?)\s*(km|kilometer|m|meter)?/i);if(!u)return null;const a=Number(String(u[1]||"").replace(",","."));if(!Number.isFinite(a)||a<0)return null;const g=String(u[2]||"m").trim().toLowerCase();return Math.round(g.startsWith("k")?a*1e3:a)}function ri(l={}){const r=l.manualDistance&&typeof l.manualDistance=="object"?l.manualDistance:null;if(r){const g=V(r.label);if(!g)return"";const f=si(g),R=r.direct!==!0&&Number.isFinite(f)?la(f,ua):"";return`
      <div class="mhd-distance">
        <span>${ie("nav","mhd-icon--sm")}${N(g)}</span>
        ${R?`<span>${ie("clock","mhd-icon--sm")}${N(R)}</span>`:""}
      </div>
    `}const u=Xr(l.distanceMeters);if(!u)return"";const a=la(l.distanceMeters,ua);return`
    <div class="mhd-distance">
      <span>${ie("nav","mhd-icon--sm")}${N(u)}</span>
      ${a?`<span>${ie("clock","mhd-icon--sm")}${N(a)}</span>`:""}
    </div>
  `}function ii(l={},{nearestPlaceId:r="",imageUrlFn:u=null}={}){const a=on.find(U=>U.key===l.category)?.label||"",g=l.id&&l.id===r?"Më afër hotelit":a,f=V(l.coverImageUrl),R=f&&typeof u=="function"&&V(u(f))||f;return`
    <article class="mhd-card">
      <div class="mhd-photo">${R?`<img src="${N(R)}" alt="${N(l.name)}" loading="lazy" decoding="async" />`:""}</div>
      <div class="mhd-card-body">
        ${g?`<span class="mhd-pill ${l.id===r?"mhd-pill--accent":""}">${N(g)}</span>`:""}
        <h3>${N(l.name)}</h3>
        ${ri(l)}
        ${l.description?`<p class="mhd-copy">${N(l.description)}</p>`:""}
      </div>
    </article>
  `}function fa({template:l=null,overrides:r={},hotelCoords:u=null,imageUrlFn:a=null,manualBeachDistance:g=null}={}){if(!l||!Array.isArray(l.places)||!l.places.length)return"";const f=en({places:l.places,overrides:r,hotelCoords:$t(u)?u:null});if(!f.length)return"";const R=f.filter(A=>Number.isFinite(A.distanceMeters)).sort((A,Q)=>A.distanceMeters-Q.distanceMeters)[0]||null,U=ei(f),Y=g&&typeof g=="object"?g:null,L=Y?Y.direct===!0?"Në plazh":V(Y.label):"";if(L){const A=U.find(Q=>Q.key==="beach");A?.places?.length&&(A.places[0]={...A.places[0],manualDistance:{label:L,direct:Y.direct===!0}})}return U.map(A=>`
    <section class="mhd-section">
      ${Ue({iconName:ni[A.key]||"pin",eyebrow:De[A.key]||"",title:nn[A.key]||A.label})}
      <div class="mhd-rail">
        ${A.places.map(Q=>ii(Q,{nearestPlaceId:R?.id||"",imageUrlFn:a})).join("")}
      </div>
    </section>
  ...
  `}function li(l={},r="€"){const u=V(l.priceLabel||l.priceText);if(u)return u;const a=Number(l.price??l.startingPrice??l.pricePerNight);if(!Number.isFinite(a)||a<=0)return"";const g=V(l.currency||l.currencyCode)||r;return g==="€"||g.toUpperCase()==="EUR"?`€${a}`:`${a} ${g}`}function ci(l=[]){const r=(Array.isArray(l)?l:[]).filter(u=>V(u?.label));return r.length?`
    <div class="mhd-distance">
      ${r.map(u=>`<span>${ie(u.icon||"check","mhd-icon--sm")}${N(u.label)}</span>`).join("")}
    </div>
  `:""}function di({rooms:l=[],offers:r=[],imageUrlFn:u=null}={}){const a=(Array.isArray(l)&&l.length?l:Array.isArray(r)?r:[]).filter(g=>g&&g.active!==!1&&V(g.title));return a.length?`
    <section class="mhd-section">
      ${Ue({iconName:"bed",eyebrow:De.rooms,title:"Dhoma"})}
      <div class="mhd-rail">
        ${a.map(g=>{const f=V(g.imageUrl),R=f&&typeof u=="function"&&V(u(f))||f,U=li(g);return`
            <article class="mhd-card">
              <div class="mhd-photo">${R?`<img src="${N(R)}" alt="${N(g.title)}" loading="lazy" decoding="async" />`:""}</div>
              <div class="mhd-card-body">
                ${V(g.tag||g.badge)?`<span class="mhd-pill mhd-pill--accent">${N(g.tag||g.badge)}</span>`:""}
  ...
  `:""}function ui({city:l="",address:r="",imageUrl:u="",imageUrlFn:a=null}={}){const g=V(l);if(!g)return"";const f=V(u),R=f&&typeof a=="function"&&V(a(f))||f;return`
    <section class="mhd-section">
      ${Ue({iconName:"building",eyebrow:De.city,title:nn.city})}
      <div class="mhd-rail">
        <article class="mhd-card">
          <div class="mhd-photo">${R?`<img src="${N(R)}" alt="${N(g)}" loading="lazy" decoding="async" />`:""}</div>
          <div class="mhd-card-body">
            <span class="mhd-pill">${N(nn.city)}</span>
            <h3>${N(g)}</h3>
  ...
  `}function pi(l=""){const r=V(l).toLowerCase();for(const u of ai)if(u.keywords.some(a=>r.includes(a)))return u.icon;return"check"}function fi({amenities:l=[]}={}){const r=(Array.isArray(l)?l:[]).map(u=>V(u)).filter(Boolean);return r.length?`
    <section class="mhd-section">
      ${Ue({iconName:"check",eyebrow:De.amenities,title:"Përfshihet"})}
      <div class="mhd-amenities">
        ${r.slice(0,12).map(u=>`
          <article class="mhd-amenity">
            <span class="mhd-amenity-icon">${ie(pi(u))}</span>
            <h3>${N(u)}</h3>
          </article>
        `).join("")}
      </div>
    </section>
  `:""}const sn="mnyraHotelDetailMap";function mi({address:l="",city:r="",destinationName:u="",mapsUrl:a="",hotelCoords:g=null,hotelName:f=""}={}){const R=[V(l),V(r)].filter(Boolean).join(", ")||V(u);if(!R&&!a)return"";const U=$t(g),Y=U?`id="${sn}" data-map-lat="${N(String(g.lat))}" data-map-lng="${N(String(g.lng))}" data-map-name="${N(V(f))}"`:"";return`
    <section class="mhd-section">
  ...
  `}function gi({rating:l="",reviewCount:r="",summary:u=""}={}){const a=Number(V(l).replace(",","."));if(!Number.isFinite(a)||a<=0)return"";const g=Math.max(1,Math.min(5,Math.round(a))),f=Array.from({length:g}).map(()=>`<svg class="mhd-icon mhd-star" viewBox="0 0 24 24" aria-hidden="true">${an.star}</svg>`).join(""),R=V(r);return`
    <section class="mhd-section">
  ...
  `}function bi({rooms:l=[],offers:r=[],amenities:u=[],address:a="",city:g="",cityImageUrl:f="",destinationId:R="",destinationName:U="",destinationSectionsHtml:Y="",mapsUrl:L="",hotelCoords:A=null,hotelName:Q="",rating:xe="",reviewCount:Ce="",ratingSummary:Pe="",imageUrlFn:Qe=null}={}){const we=!!V(R),It=Y||(we?wt():"");return`
    <div class="mhd">
      ${di({rooms:l,offers:r,imageUrlFn:Qe})}
      <div id="${tn}" data-destination-id="${N(R)}" style="display:contents">
        ${It}
      </div>
      ${we?"":ui({city:g,address:a,imageUrl:f,imageUrlFn:Qe})}
      ${fi({amenities:u})}
      ${mi({address:a,city:g,destinationName:U,mapsUrl:L,hotelCoords:A,hotelName:Q})}
      ${gi({rating:xe,reviewCount:Ce,summary:Pe})}
    </div>
  ...
  `}function hi(l={},{imagePreview:r=""}={}){const u=ee(l.id),a=Ie(r)||Ie(l.imageUrl);return`
  ...
  `}function vi({restaurantId:l="",record:r={},editorState:u={}}={}){const a=Ie(l);if(!a)return"";const g=Ie(u.restaurantId)===a,f=g&&Array.isArray(u.rooms)?ra(u.rooms):ra(r?.hotelRooms),R=g&&u.imagePreviews&&typeof u.imagePreviews=="object"?u.imagePreviews:{},U=g&&u.saving===!0,Y=g?Ie(u.status):"";return`
    <div data-hotel-rooms-editor="${ee(a)}" class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
      ...
      ${f.length?`<div class="space-y-4">${f.map(L=>hi(L,{imagePreview:Ie(R[L.id])})).join("")}</div>`:'<p class="text-sm font-bold text-slate-400">Ende pa dhoma. Shto dhomën e parë me +.</p>'}
  ...
  `}const xi=Object.freeze({apiKey:"AIzaSyAq5kzdGITDekgajC0uUBny63JjS1DIPEU",authDomain:"menyra-c0e68.firebaseapp.com",projectId:"menyra-c0e68",storageBucket:"menyra-c0e68.firebasestorage.app",messagingSenderId:"528471049588",appId:"1:528471049588:web:c507d87c0832562a855821",measurementId:"G-YLFKC8726B"});function wi(){try{const l=String(globalThis?.location?.hostname||"").trim().toLowerCase();if(!["localhost","127.0.0.1","::1"].includes(l))return null;const r=globalThis?.__MENYRA_FIREBASE_EMULATORS__,u=r&&typeof r=="object"?r:{},a=new URLSearchParams(globalThis?.location?.search||"").get("firebase-emulator")==="1";if(u.enabled!==!0&&!a)return null;const g=String(u.projectId||"mnyra-local").trim();return/^(mnyra-local|demo-|test-|local-)/.test(g)?Object.freeze({projectId:g,host:String(u.host||"127.0.0.1").trim()||"127.0.0.1",firestorePort:Math.max(1,Number(u.firestorePort||8080)||8080),authPort:Math.max(1,Number(u.authPort||9099)||9099),functionsPort:Math.max(1,Number(u.functionsPort||5001)||5001)}):null}catch{return null}}const ue=wi(),Zt=Object.freeze(ue?{apiKey:"mnyra-local-api-key",authDomain:`${ue.projectId}.firebaseapp.com`,projectId:ue.projectId,storageBucket:`${ue.projectId}.appspot.com`,messagingSenderId:"000000000000",appId:"1:000000000000:web:mnyra-local"}:xi),ma=new WeakSet,ga=new WeakSet;function yi({firestore:l=null,authInstance:r=null}={}){return ue?(l&&!ma.has(l)&&(Lr(l,ue.host,ue.firestorePort),ma.add(l)),r&&!ga.has(r)&&(_r(r,`http://${ue.host}:${ue.authPort}`,{disableWarnings:!0}),ga.add(r)),!0):!1}function $i(){try{const l=Tr();if(l?.options?.projectId===Zt.projectId&&l?.options?.appId===Zt.appId)return l}catch{}return jr(Zt)}const kt=$i();function ki(){try{return globalThis?.__MENYRA_SOCIAL_PUBLIC_WEBSITE_STARTUP__===!0}catch{return!1}}let St;try{const l=ki();St=xr(kt,{experimentalAutoDetectLongPolling:!0,localCache:l?wr():yr({tabManager:$r()})});try{globalThis.__MENYRA_FIRESTORE_LOCAL_CACHE_KIND__=l?"memory-public-website":"persistent-multitab"}catch{}}catch{St=kr(kt)}let rn;try{rn=Sr(kt,{persistence:[Ir,Cr,Pr]})}catch{rn=Ar(kt)}yi({firestore:St,authInstance:rn});const Si="destinationsPublic",va="menyra_social_destination_public_cache_v1::",Ii=360*60*1e3,yt=new Map,xt=new Map;function Ne(l=""){return l==null?"":String(l).trim()}function xa(l="",r={}){const u=r&&typeof r=="object"?r:{},a=Array.isArray(u.places)?u.places:[];return a.length?{id:Ne(l),name:Ne(u.name),slug:Ne(u.slug),description:Ne(u.description),version:Math.max(0,Number(u.version)||0),places:a}:null}function Ci(l=""){try{const r=localStorage.getItem(`${va}${l}`);if(!r)return null;const u=JSON.parse(r);return!u||typeof u!="object"||Date.now()-Number(u.storedAt||0)>Ii?null:xa(l,u.data)}catch{return null}}function Pi(l="",r=null){try{localStorage.setItem(`${va}${l}`,JSON.stringify({storedAt:Date.now(),data:r}))}catch{}}function wa(l=""){const r=Ne(l);if(!r)return null;if(yt.has(r))return yt.get(r);const u=Ci(r);return u&&yt.set(r,u),u}async function Ai(l=""){const r=Ne(l);if(!r)return null;const u=wa(r);if(u)return u;if(xt.has(r))return xt.get(r);const a=(async()=>{try{const g=await Fr(Mr(St,Si,r)),f=g.exists()?xa(r,g.data()||{}):null;return yt.set(r,f),f&&Pi(r,g.data()||{}),f}catch{return null}finally{xt.delete(r)}})();return xt.set(r,a),a}function zi(l={}){const r=l.state,u=l.resolvePostCountsFn,a=l.escapeHtmlFn,g=l.getOptimizedImageUrlFn,f=l.iconFn,R=l.isLocalBusinessProfileFn,U=typeof l.isCeoUserFn=="function"?l.isCeoUserFn:(()=>!1),Y=l.normalizeHandleFn,L=l.logoFitClassFn,A=l.formatCountFn,Q=l.renderProfileShopCartViewFn,xe=l.renderProfileShopFavoritesViewFn,Ce=typeof l.ensurePostsDataForProfileFn=="function"?l.ensurePostsDataForProfileFn:(()=>{}),Pe=l.ensureMenuDataForProfileFn,Qe=typeof l.ensureEditorMenuDataForProfileFn=="function"?l.ensureEditorMenuDataForProfileFn:(()=>{}),we=l.ensureFocusDataForProfileFn,It=typeof l.ensureAdsDataForProfileFn=="function"?l.ensureAdsDataForProfileFn:(()=>{}),ln=l.ensureTableQrStateForProfileFn,ae=l.isShopCatalogProfileFn,ya=l.getBusinessCatalogLabelFn,Ae=l.normalizeMenuTypeFn,$a=l.primeMenuItemCountsFn,ka=typeof l.hydrateMenuCardViewerLikesFn=="function"?l.hydrateMenuCardViewerLikesFn:(()=>Promise.resolve()),Sa=l.renderShopProductListFn,Ia=l.getMenuLayoutThemeFn,Ca=l.menuLayoutColors,oe=l.resolveMenuItemHeroFn,J=l.isPlaceholderUrlFn,q=l.placeholderImage,Pa=l.getFirebaseStorageUrlFn,Aa=l.isDirectImageUrlFn,cn=l.formatPriceFn,Ta=typeof l.resolveCurrencyCodeForMenuItemFn=="function"?l.resolveCurrencyCodeForMenuItemFn:(()=>""),dn=l.getMenuItemImagesFn,Z=l.getMenuItemObjectPositionFn,Je=l.getMenuItemSocialIdFn,un=l.menuItemMetaKeyFn,pn=l.ensureMenuItemMetaFn,fn=l.resolveMenuItemCountsFn,Xe=l.getFocusStateForRestaurantFn,ja=typeof l.getAdsStateForRestaurantFn=="function"?l.getAdsStateForRestaurantFn:(()=>({items:[],enabled:!0,loading:!1,same:!1})),Ze=l.getTableQrStateForRestaurantFn,Te=l.getFocusItemObjectPositionFn,Ct=l.getFocusCardClassFn,La=l.getFocusIndexFn,ye=l.isRestaurantCafeProfileFn,Pt=typeof l.getBusinessProfileTypeFn=="function"?l.getBusinessProfileTypeFn:(()=>""),le=l.getRestaurantMetaByIdFn,_a=l.buildUrlFn,Fa=l.normalizeSearchKeyFn,Ma=l.normalizeFollowHandleFn,pe={key:"",inFlightKey:""},mn=new Set,et=()=>{try{if(globalThis?.__MENYRA_DEBUG_MENU_STATE__===!0||globalThis?.__MENYRA_DEBUG_PROFILE_RENDER__===!0)return!0;const e=new URLSearchParams(globalThis?.location?.search||"");return e.get("debug-menu-state")==="1"||e.get("debug-profile-render")==="1"}catch{return!1}},Ra=({profile:e=null,routePayload:t=null,surface:n=null,decision:s=null}={})=>{if(!et())return;const o=n&&typeof n=="object"?n:{},i=o.menu&&typeof o.menu=="object"?o.menu:{},c=e&&typeof e=="object"?e:{},d=t&&typeof t=="object"?t:{},p=d?.businessSnapshot?.identity||d?.identity||{},b=String(o.authoritativeRestaurantId||o.restaurantId||i.restaurantId||"").trim(),m=String(c.publicSlug||c.landingSlug||c.handle||p.publicSlug||p.landingSlug||p.handle||"").trim(),h=`${b||"pending"}::${m||"no-slug"}`;if(mn.has(h))return;mn.add(h);const x=Array.isArray(i.items)?i.items:[],w=new Set(x.map($=>String($?.category||"").trim()).filter(Boolean)).size,C=String(i.rawTruthState||i.truthState||"").trim();console.debug("[mnyra][public-menu.first-render]",{businessId:b,slug:m,itemsLength:x.length,categoriesLength:w,menuStatus:String(i.status||"loading"),truthState:C,isLoading:s?.isLoading===!0,isHydrating:i.hydrating===!0||C.toLowerCase()==="hydrating",confirmedEmpty:i.confirmedEmpty===!0,canRenderItems:i.canRenderItems===!0,shouldRenderNoProducts:s?.shouldRenderNoProducts===!0,source:String(i.source||"")})},Ea=()=>{try{return String(globalThis?.__MNYRA_BUILD_TOKEN__||globalThis?.__MENYRA_SOCIAL_APP_VERSION__||"").trim()}catch{return""}},At=(e="")=>a(String(e||"")),je=(e="")=>a(String(e??"")),se=({renderer:e="profile-menu-focus-render-controller",skeleton:t="",source:n=""}={})=>{if(!et())return"";const s=[e?`data-debug-renderer="${At(e)}"`:"",t?`data-debug-skeleton="${At(t)}"`:"",n?`data-debug-source="${At(n)}"`:""].filter(Boolean);return s.length?` ${s.join(" ")}`:""},za=(e={},t=[])=>{const n=gr(e,t);return` ${[`data-menu-state="${je(n.menuState)}"`,`data-menu-item-count="${je(n.menuItemCount)}"`,`data-focus-state="${je(n.focusState)}"`,`data-focus-business-id="${je(n.focusBusinessId)}"`,`data-focus-item-count="${je(n.focusItemCount)}"`,`data-focus-source="${je(n.focusSource)}"`,`data-focus-stale="${n.focusStale?"true":"false"}"`].join(" ")}`},gn=({component:e="profile-menu-focus-render-controller",functionName:t="",profile:n=null,routePayload:s=null,surface:o=null,decision:i=null,items:c=null,rawItems:d=null,filteredItems:p=null,renderDecision:b="",source:m=""}={})=>{const h=o&&typeof o=="object"?o:{},x=h.menu&&typeof h.menu=="object"?h.menu:{},w=h.focus&&typeof h.focus=="object"?h.focus:{},C=n&&typeof n=="object"?n:r?.profileView?.profile&&typeof r.profileView.profile=="object"?r.profileView.profile:{},$=s&&typeof s=="object"?s:r?.profileView?.routePayload&&typeof r.profileView.routePayload=="object"?r.profileView.routePayload:{},P=$?.businessSnapshot&&typeof $.businessSnapshot=="object"?$.businessSnapshot:{},T=P?.identity&&typeof P.identity=="object"?P.identity:$?.identity&&typeof $.identity=="object"?$.identity:{},k=r?.__webDirectEntry&&typeof r.__webDirectEntry=="object"?r.__webDirectEntry:{},S=String(C.publicSlug||C.landingSlug||C.handle||T.publicSlug||T.landingSlug||T.handle||k.publicSlug||"").trim(),_=String(C.restaurantId||$.restaurantId||k.restaurantId||"").trim(),F=String(C.canonicalRestaurantId||$.canonicalRestaurantId||h.authoritativeRestaurantId||k.canonicalRestaurantId||P.restaurantId||"").trim();let E="";C.canonicalRestaurantId?E="profile.canonicalRestaurantId":$.canonicalRestaurantId?E="routePayload.canonicalRestaurantId":h.authoritativeRestaurantId?E="surface.authoritativeRestaurantId":k.canonicalRestaurantId?E="webDirectEntry.canonicalRestaurantId":P.restaurantId?E="routeSnapshot.restaurantId":C.restaurantId?E="profile.restaurantId":$.restaurantId?E="routePayload.restaurantId":k.restaurantId&&(E="webDirectEntry.restaurantId");const I=String(F||h.restaurantId||x.restaurantId||_||"").trim(),z=Array.isArray(d)?d:Array.isArray(x.items)?x.items:[],B=Array.isArray(c)?c:z,O=Array.isArray(p)?p:B,y=new Set(O.map($e=>String($e?.category||"").trim()).filter(Boolean)).size,M=String(x.status||(i?.isLoading?"loading":"")||"").trim(),D=String(x.rawTruthState||x.truthState||"").trim(),H=x.confirmedEmpty===!0||i?.confirmedEmpty===!0,K=i?.hasError===!0||M==="error"||!!String(x.error||"").trim(),te=!(O.length>0||i?.hasItems===!0)&&!H&&!K,ne=F||_||I||"";return{component:e,functionName:t,slug:S,businessId:I,requestedRestaurantId:_,canonicalRestaurantId:F,restaurantIdSource:E,menuReadPath:ne?`restaurants/${ne}/public/menu`:"",activeTab:String(r?.activeTab||"").trim(),profileTopTab:String(r?.profileTopTab||"").trim(),profileContentTab:String(r?.profileContentTab||"").trim(),itemsLength:B.length,rawItemsLength:z.length,filteredItemsLength:O.length,categoriesLength:y,focusItemsLength:Array.isArray(w.items)?w.items.length:0,loading:x.loading===!0||i?.isLoading===!0||M==="loading",pending:te,hydrating:x.hydrating===!0||D.toLowerCase()==="hydrating",status:M,truthState:D,confirmedEmpty:H,canRenderItems:x.canRenderItems===!0,renderDecision:b||(i?.shouldRenderNoProducts?"no-products":i?.isLoading?"loading":""),source:m||String(x.source||""),buildToken:Ea()}},tt=(e={})=>{et()&&console.warn("[mnyra:no-products-render]",{...gn(e),stack:new Error().stack})},nt=(e="",t={})=>{et()&&console.info("[mnyra:skeleton-render]",{skeletonName:e,...gn({...t,renderDecision:t.renderDecision||"skeleton"}),reason:String(t.reason||"").trim()})},v=(e,t=e,n={})=>mr(e,{fallback:t,params:n}),Na=(e="")=>{const t=String(e||"").trim();if(!t)return v("nav.menu","Menue");const n=t.toLowerCase();return n==="menue"||n==="menu"||n==="menü"?v("nav.menu",t):n==="shop"?"Shop":t},bn=(e="")=>{const t=String(e||"").trim();if(!t)return"";const n=t.toLowerCase();return["speisen","food","getraenke","getränke","drink","drinks","beverage","beverages"].includes(n)?v("menu.products","Produkte"):t},Da=(e="food",t=!1)=>t?v("menu.products","Produkte"):String(e||"").trim().toLowerCase()==="drink"?v("menu.drinks","Getraenke"):v("menu.food","Speisen"),hn=(e={},t=!1)=>{const n=Ae(e?.type||"food");return t?v("menu.product","Produkt"):n==="drink"?v("menu.drinkItem","Getraenk"):v("menu.foodItem","Speise")},Tt=(e="",t="#111827")=>{const n=String(e||"").trim();return/^#[0-9a-fA-F]{6}$/.test(n)?n:t};function Ua(e=null,t=null){return Ye(r,{profile:e,routePayload:t,webDirectEntry:r?.__webDirectEntry}).restaurantId}function vn(e=null,t=""){if(!e||typeof e!="object")return e;const n=String(t||"").trim();if(!n)return e;const s=String(e.canonicalRestaurantId||"").trim();return String(e.restaurantId||"").trim()===n&&s?e:{...e,restaurantId:n,...s?{canonicalRestaurantId:s}:{}}}function Ba(e=""){const t=String(e||"").trim();return t?Ye(r,{profile:r?.profileView?.profile||r?.userProfile,routePayload:r?.profileView?.routePayload,webDirectEntry:r?.__webDirectEntry,restaurantId:t}).focus.canRenderFocus:!1}function Be(e={}){const t=String(Ta(e)||"").trim();return t?cn(e?.price,t):cn(e?.price)}function Oa(e=[],t="",n=""){const s=String(t||"").trim(),o=String(n||"").trim();if(!s||!o)return"";const i=Array.isArray(e)?e:[];if(!i.length)return`${s}|${o}|empty`;const c=[];return i.forEach(d=>{const p=String(Je(d)||d?.id||"").trim();p&&c.push(p)}),c.length?(c.sort(),`${s}|${o}|${c.join(",")}`):`${s}|${o}|empty`}function Ha(e=[],t=""){const n=String(r.user?.uid||"").trim(),s=Oa(e,t,n);s&&pe.inFlightKey!==s&&pe.key!==s&&(pe.key=s,pe.inFlightKey=s,ka(e,t).catch(o=>{console.error(o),pe.key===s&&(pe.key="")}).finally(()=>{pe.inFlightKey===s&&(pe.inFlightKey="")}))}function Va(e={}){const t=String(e?.uid||"").trim();if(t&&r.followingTargetIds.includes(t))return!0;const n=String(e?.restaurantId||"").trim();if(n&&r.followingTargetIds.includes(n))return!0;const s=Ma(e?.handle||"");return!!(s&&r.followingHandles.includes(s))}function xn(e={}){if(e?.specialEnabled===!0)return!0;if(e?.specialEnabled===!1)return!1;const t=String(e?.restaurantId||"").trim();if(!t)return!1;const n=typeof le=="function"&&le(t)||null;return n?.specialEnabled===!0?!0:(n?.specialEnabled===!1,!1)}function Ka(e={}){return be(e)==="testfirst_special"?!0:String(e?.category||"").trim().toLowerCase()==="special"}function wn(e,t,n=!0,{includeImageKey:s=!0}={}){const o=u(e),i=e.id?String(e.id):"",c=i?`data-open-post="${a(i)}"`:"",d=i?`data-post-like-count="${a(i)}"`:"",p=i?`data-post-comment-count="${a(i)}"`:"",b=s&&i?`data-img-key="profile-post:${a(i)}"`:"",m=e.type==="wide"||e.type==="hero",h=t&&m?"col-span-2":"",x=t&&m?"aspect-[1.8/1]":"aspect-[4/5]",w=m?800:400,C=m?400:500,$=String(e.posterUrl||e.thumbUrl||e.poster||"").trim(),P=e.isVideo===!0,T=P&&$?$:e.url,k=g(T,m?"large":"medium",{stableKey:i?`profile-post:${i}`:"",variantGroup:"post-detail"}),S=String(e.url||"").trim(),_=S&&!S.includes("#")?`${S}#t=0.001`:S,F=P&&!$&&S?`<video src="${a(_)}" preload="metadata" muted playsinline webkit-playsinline width="${w}" height="${C}" ${b} class="w-full h-full object-cover pointer-events-none"></video>`:`<img src="${a(k)}" loading="lazy" decoding="async" width="${w}" height="${C}" ${b} class="w-full h-full object-cover" />`;return`
  ...
  `}function jt(e,t,n=!0,{includeImageKeys:s=!0}={}){const o=t==="grid";if(!e.length)return`
    ...
    `;const i=e.map(d=>wn(d,o,n,{includeImageKey:s})),c=e.reduce((d,p)=>{const b=p?.type==="wide"||p?.type==="hero";return d+(b?2:1)},0);return o&&c%2===1&&i.unshift(`
    ...
    <div class="rounded-[1.7rem] border border-slate-100 bg-slate-50 p-4 space-y-3">
      ...
      <div class="grid grid-cols-[1fr_92px] gap-2">
        ...
        <select id="${a(e)}Unit" class="w-full px-3 py-3 bg-white rounded-2xl text-sm font-black border border-slate-100 outline-none focus:ring-2 focus:ring-indigo-100">
          ${es.map(d=>`<option value="${a(d.value)}" ${c.unit===d.value?"selected":""}>${a(d.label)}</option>`).join("")}
        </select>
      </div>
  ...
  `}function os(e=[],t=""){const n=String(t||"").trim(),s=new Set(e.map(me));return`
  ...
  `}function ls(e={},t=[]){const n=new Set(t.map(me).filter(Boolean)),s=[],o=(i="")=>{const c=String(i||"").trim();if(!c)return;const d=me(c);n.has(d)||s.some(p=>me(p)===d)||s.push(c)};return[e.features,e.hotelFeatures,e.amenities,e.facilities,e.hotelAmenities].forEach(i=>st(i).forEach(o)),s}function cs({existingImages:e=[],newPreviews:t=[],imageUrlDraft:n=""}={}){const s=[...t.map((c,d)=>({src:c,kind:"new",idx:d})),...e.map((c,d)=>({src:c,kind:"existing",idx:d}))].filter(c=>c.src),o=s[0]?.src||n||"",i=o?g(o,"large"):q;return`
    <div class="space-y-4">
  ...
  `}function ds({destinationId:e="",overrides:t={},hotelCoords:n=null,manualBeachDistance:s=null}={}){const o=String(e||"").trim();if(!o||typeof document>"u")return;const i=p=>fa({template:p,overrides:t,hotelCoords:n,imageUrlFn:b=>g(b,"medium"),manualBeachDistance:s});let c=0;const d=()=>{const p=document.getElementById(tn);if(!p){c++<20&&requestAnimationFrame(d);return}String(p.dataset.destinationId||"")===o&&p.dataset.destinationFilled!==o&&Ai(o).then(b=>{const m=document.getElementById(tn);!m||String(m.dataset.destinationId||"")!==o||(m.dataset.destinationFilled=o,m.innerHTML=b?i(b):"",b&&Cn(en({places:b.places,overrides:t,hotelCoords:n})))}).catch(()=>{})};typeof requestAnimationFrame=="function"?requestAnimationFrame(d):queueMicrotask(d)}function Cn(e=[]){if(typeof document>"u")return;const t=document.getElementById(sn);t&&(typeof t.__mhdSetPlaces=="function"?t.__mhdSetPlaces(e):t.__mhdPlaces=Array.isArray(e)?e:[])}function us(e=[]){if(typeof document>"u")return;let t=0;const n=()=>{const s=document.getElementById(sn);if(!s){t++<20&&requestAnimationFrame(n);return}if(Array.isArray(e)&&e.length&&Cn(e),s.dataset.mhdMapObserved==="1")return;s.dataset.mhdMapObserved="1";const o=()=>{ur(()=>import("./hotel-detail-map-runtime-DB741SQ-.js"),[]).then(i=>i.ensureHotelDetailMap({container:s})).catch(()=>{})};if(typeof IntersectionObserver=="function"){const i=new IntersectionObserver(c=>{c.some(d=>d.isIntersecting)&&(i.disconnect(),o())},{rootMargin:"240px"});i.observe(s)}else o()};typeof requestAnimationFrame=="function"?requestAnimationFrame(n):queueMicrotask(n)}function Pn(e={}){return kn(e).filter(t=>t.active!==!1&&String(t.title||"").trim())}function ps(e={}){const t=e.beachfront===!0||e.onBeach===!0||e.amStrand===!0,n=X(e,["distanceBeach","distanceToBeach","beachDistance","beachDistanceLabel","strandEntfernung"]);return!t&&!n?null:{label:n,direct:t}}function An(e={}){return!!(Jt(e).length||Pn(e).length||Sn(e).length||String(e.destinationId||"").trim()||X(e,["rating","reviewRating","stars","hotelStars"]))}const Tn="mnyraHotelDetailsPendingRoot";let rt="";function fs(e={},t=""){if(typeof document>"u"||typeof setTimeout!="function")return;const n=String(t||"").trim();if(!n||rt===n)return;rt=n;let s=0;const o=()=>{const i=document.getElementById(Tn);if(!i||String(i.dataset.hotelDetailsPending||"")!==n){rt="";return}if(!(!!(typeof le=="function"?le(n):null)||An(_e(e)))&&s++<24){setTimeout(o,250);return}rt="",i.removeAttribute("data-hotel-details-pending"),i.classList.add("animate-in","fade-in","duration-300"),i.innerHTML=_n(e)};setTimeout(o,250)}const He="data-business-catalog-type-pending";let Ve="";function jn(e={}){return String(e?.canonicalRestaurantId||e?.restaurantId||e?.publicSlug||e?.handle||$n()||"").trim().toLowerCase().replace(/[^a-z0-9_-]/g,"")}function ms(e={}){const t=r?.profileView?.profile;if(t&&typeof t=="object"&&Le(t))return t;const n=r?.userProfile;return n&&typeof n=="object"&&Le(n)?n:e&&typeof e=="object"?e:{}}function gs(){document.querySelectorAll('[data-profile-tab="menu"]').forEach(e=>{e.setAttribute("data-profile-tab-surface","hotel-details"),e.textContent="Details"})}function Ln(e="",t={}){if(typeof document>"u"||typeof setTimeout!="function")return;const n=String(e||"").trim();if(!n||Ve===n)return;Ve=n;let s=0;const o=()=>{const i=document.querySelector(`[${He}="${n}"]`);if(!i){Ve="";return}const c=ms(t),d=at(c),p=Oe(c);if(!d&&!p){if(s++<40){setTimeout(o,300);return}Ve="",i.removeAttribute(He);return}Ve="",i.removeAttribute(He),p&&(_t(c,d||"hotel"),i.classList.add("animate-in","fade-in","duration-300"),i.innerHTML=Mt(c),gs())};setTimeout(o,300)}function Mt(e={}){const t=_e(e),n=String(e?.canonicalRestaurantId||e?.restaurantId||t.canonicalRestaurantId||t.restaurantId||"").trim(),s=n&&typeof le=="function"?le(n):null;return n&&!s&&!An(t)?(pa(),fs(e,n),`
  ...
  `}function _n(e={}){const t=_e(e),n=Wa(t),s=X(t,["address","primaryAddress","location","formattedAddress","street"]),o=X(t,["city","locationCity","primaryCity","region","country"]),i=X(t,["rating","reviewRating","stars","hotelStars"]),c=X(t,["reviewCount","reviewsCount","ratingsCount","commentsCount"]),d=X(t,["reviewSummary","ratingSummary","commentsSummary"]),p=Sn(t),b=Pn(t),m=Jt(t).map(S=>({...S,priceLabel:vr(S),metaParts:hr(S)})),h=String(t.destinationId||"").trim(),x=String(t.destinationName||"").trim(),w=ha(t.destinationOverrides||{}),C=X(t,["name","restaurantName","businessName"])||"Hotel",$=n?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${n.lat},${n.lng}`)}`:s||o?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${s} ${o}`.trim())}`:"";pa();const P=ps(t),T=h?wa(h):null,k=T?fa({template:T,overrides:w,hotelCoords:n,imageUrlFn:S=>g(S,"medium"),manualBeachDistance:P}):"";return h&&!T&&ds({destinationId:h,overrides:w,hotelCoords:n,manualBeachDistance:P}),n&&us(T?en({places:T.places,overrides:w,hotelCoords:n}):[]),bi({rooms:m,offers:b,amenities:p,address:s,city:o,cityImageUrl:X(t,["titleImageUrl","coverImageUrl","heroUrl"]),destinationId:h,destinationName:x,destinationSectionsHtml:k,mapsUrl:$,hotelCoords:n,hotelName:C,rating:i,reviewCount:c,ratingSummary:d,imageUrlFn:S=>g(S,"medium")})}function bs(e={}){const t=_e(e),n=String(e?.restaurantId||t.restaurantId||t.id||"").trim(),s=t?.name||t?.restaurantName||e?.name||"Hotel",o=Xa(n),i=String(o.status||"").trim(),c=o.saving===!0,d=Array.isArray(o.existingImages)?o.existingImages.map(z=>String(z||"").trim()).filter(Boolean):Qa(t),p=Array.isArray(o.imagePreviews)?o.imagePreviews.map(z=>String(z||"").trim()).filter(Boolean):[],b=String(o.imageUrlDraft||"").trim(),[m,h,x]=Za(t),w=ls(t,[m,h,x]),C=X(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),$=X(t,["distanceBeach","distanceToBeach","beachDistance","beachDistanceLabel","strandEntfernung","lakeDistance","distanceToLake"]),P=X(t,["hotelStartingPrice","startingPrice","priceFrom","fromPrice","bestPrice","roomStartingPrice"]),T=t.directCenter===!0||t.inCenter===!0||t.cityCenterDirect===!0,k=t.beachfront===!0||t.onBeach===!0||t.amStrand===!0,S=o.detailsOpen===!0||c,_=p[0]||d[0]||"",F=_?g(_,"thumb"):q,E=[C,$,P?`${P} €`:""].filter(Boolean).join(" · ")||"Plotëso detajet",I=i.includes("fehl")||i.includes("Bitte")||i.includes("Nuk");return`
      ...
      ${n?`
        ...
        <div data-hotel-card-editor="${a(n)}" data-hotel-card-details-panel class="${S?"":"hidden "}bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
            ...
            <div>
              ...
              ${cs({existingImages:d,newPreviews:p,imageUrlDraft:b})}
            </div>

            <div class="grid grid-cols-1 gap-4">
              ${In({idPrefix:"hotelCardDistanceCenter",iconName:"navigation",label:"Qendra",value:C,directLabel:ts,direct:T})}
              ${In({idPrefix:"hotelCardDistanceBeach",iconName:"waves",label:"Plazhi",value:$,directLabel:ns,direct:k})}
              <div>
            ...
            <div class="grid grid-cols-1 gap-4">
              ${Ft({id:"hotelCardFeatureOneText",iconName:"utensils",label:"Ushqimi",value:m,options:as})}
              ${Ft({id:"hotelCardFeatureTwoText",iconName:"waves",label:"Shezlongë",value:h,options:ss})}
              ${Ft({id:"hotelCardFeatureThreeText",iconName:"square-parking",label:"Parking",value:x,options:rs})}
              <div>
...
`))}</textarea>
        ...
        ${vi({restaurantId:n,record:t,editorState:r.hotelRoomsEditor&&typeof r.hotelRoomsEditor=="object"?r.hotelRoomsEditor:{}})}
        ${Kt(n,{variant:"travel-offers",suppressLoading:!0})}
      `:`
      ...
      <div data-landing-panel="0" class="absolute inset-0 z-50 flex flex-col items-start justify-center transition-transform ${n===0?"translate-y-0":"-translate-y-full pointer-events-none"}" style="background: #F8F9FA; color: #111827; padding-top: var(--landing-top-gap); opacity: ${n===0?"1":"0"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        ...
        <div class="flex flex-col items-start relative z-10 w-full" style="padding-left: 2.5rem; padding-right: 2.5rem;">
          <div class="relative w-full flex justify-start items-center mb-5" style="height: 40px;">
            ${t.map((O,y)=>{const M=y===s,D=y===(s-1+t.length)%t.length;return`
  ...
  `}function Et(e=r.profileView?.profile||r.userProfile,{landingPreview:t=!1,selectedTabOverride:n="",compact:s=!1}={}){const o=Le(e),i=String(n||it(e)).trim().toLowerCase()||"posts",c=Oe(e),d=ae(e),p=c?"Details":d?"Shop":v("nav.menu","Menue"),b=o?[{id:"posts",label:v("profile.posts","Beitraege")},{id:"menu",label:p,surface:c?"hotel-details":"menu"}]:[{id:"posts",label:v("profile.posts","Beitraege")},{id:"media",label:v("profile.media","Medien")},{id:"checkins",label:v("profile.checkins","Check-ins")}];return`
  ...
  `}function zt(e=r.profileView?.profile||r.userProfile,{disabled:t=!1}={}){const n=it(e);return n==="checkins"||n==="menu"?"":`
  ...
  `}function G(e=""){return String(e||"").trim()}const Mn="mnyra_business_title_image_cache_v1",Rn=80;function En(){if(!r)return{};const e=r.businessTitleImageCache&&typeof r.businessTitleImageCache=="object"?r.businessTitleImageCache:null;if(e?.loaded===!0&&e.items&&typeof e.items=="object")return e.items;let t={};try{const s=(typeof window<"u"?window.localStorage:null)?.getItem?.(Mn)||"",o=s?JSON.parse(s):{};o&&typeof o=="object"&&Object.entries(o).forEach(([i,c])=>{const d=G(i),p=G(c);d&&p&&!J(p)&&(t[d]=p)})}catch{}return r.businessTitleImageCache={loaded:!0,items:t},t}function ws(e={}){try{const t=typeof window<"u"?window.localStorage:null;if(!t)return;t.setItem(Mn,JSON.stringify(e))}catch{}}function ys(e={},t="business"){const n=[e?.restaurantId,e?.canonicalRestaurantId,e?.uid,e?.handle,e?.publicSlug,e?.landingSlug,e?.name,t].map(s=>G(s)).filter(Boolean);return[...new Set(n)]}function $s(e=[],t=""){const n=G(t);if(!n||J(n))return;const s=En();let o=!1;e.forEach(c=>{const d=G(c);!d||s[d]===n||(s[d]=n,o=!0)});const i=Object.entries(s);if(i.length>Rn){const c=i.slice(i.length-Rn);Object.keys(s).forEach(d=>delete s[d]),c.forEach(([d,p])=>{s[d]=p}),o=!0}o&&ws(s)}function ks(e=[]){const t=En();for(const n of e){const s=G(n),o=s?G(t[s]):"";if(o&&!J(o))return o}return""}function Ss(e={},t="business"){return String(e?.restaurantId||e?.canonicalRestaurantId||e?.uid||e?.handle||e?.name||t).trim()||t}function Is(e={}){return String(e?.canonicalRestaurantId||e?.restaurantId||e?.id||e?.landingRestaurantId||e?.documentId||"").trim()}function Cs(e={}){const n=(Array.isArray(e?.coverImages)?e.coverImages:Array.isArray(e?.titleImages)?e.titleImages:[]).map(s=>String(s||"").trim()).find(Boolean)||"";return String(e?.titleImageUrl||e?.coverImageUrl||e?.coverUrl||e?.heroUrl||n||"").trim()}function Ps(e={},t={}){const n=Cs(e),s=Array.isArray(t.cacheKeys)?t.cacheKeys:[],o=G(t.stableKey||s[0]||"");if(!n){if(t.allowCacheFallback===!0){const c=ks(s);if(c)return c;const d=o?g("","medium",{stableKey:o}):"";return d&&!J(d)?d:""}return""}const i=g(n,"medium",o?{stableKey:o}:void 0);return i&&!J(i)?($s(s,i),i):""}function zn(e="",t=""){const n=G(e);if(!n)return"";if(/^https?:\/\//i.test(n))return n;const s=n.replace(/^@+/,"").replace(/^instagram\.com\//i,"").replace(/^www\.instagram\.com\//i,"").replace(/^tiktok\.com\/@?/i,"").replace(/^www\.tiktok\.com\/@?/i,"").replace(/^\/+/,"").trim();return s?t==="tiktok"?`https://www.tiktok.com/@${encodeURIComponent(s)}`:t==="instagram"?`https://www.instagram.com/${encodeURIComponent(s)}`:"":""}function As(e=""){const t=G(e);if(!t)return"";const n=t.replace(/[^\d+]/g,"");return n?`tel:${n}`:""}function Ts(e={}){const t=Number(e?.gpsLat??e?.lat),n=Number(e?.gpsLng??e?.lng);if(Number.isFinite(t)&&Number.isFinite(n))return`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${t},${n}`)}`;const s=[e?.address,e?.locationPlace||e?.place,e?.location,e?.city,e?.country].map(o=>G(o)).filter(Boolean).join(", ");return s?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(s)}`:""}function ot({href:e="",label:t="",iconName:n="",body:s="",buttonAttrs:o=""}={}){const i=G(e),c=String(o||"").trim();if(!i&&!c)return"";const d=s||f(n,"w-4 h-4"),p="w-9 h-9 rounded-full bg-white text-slate-900 shadow-lg border border-white/80 flex items-center justify-center active:scale-95 transition-transform";return c?`
  ...
  `}function Nn(e={},t={}){const n=t.mode==="self"?"self":"public",s=t.disabledBlockClass||"",o=Ss(e,n),i=n==="self"?"avatar:self":`avatar:public:${o}`,c=t.avatarUrl||g(e.avatar||"","avatar",{stableKey:i}),d=t.avatarFit||L(!!e.restaurantId),p=String(r?.profileCardInfoOpen||"")===o,b=Number(r?.profileCardInfoHeights?.[o]||0),m=p&&Number.isFinite(b)&&b>0?`height:${Math.ceil(b)}px;`:"",h=t.avatarImgKeyAttr||(n==="self"?'data-img-key="avatar:self"':`data-img-key="avatar:public:${a(o)}"`),x=t.renderAvatarImage===!0?!!String(c||"").trim()&&!J(c):t.renderAvatarImage!==!1&&!!String(c||"").trim()&&!J(c)&&!!String(e?.avatar||"").trim(),w=!!t.identityPending,C=t.followersLabel??A(e.followers),$=G(e?.name)||"User",P=G(t.typeLabel||e?.customerType||e?.type||"Business"),T=G(e?.location||"-"),k=n==="public"?`${T} / ${P}`:T,S=t.bioHtml||a(e?.bio||"").replace(/\n/g,"<br>")||a(v("profile.noBio","Noch keine Bio.")),_=`business-cover:${o}`,F=ys(e,o),E=Ps(e,{cacheKeys:F,stableKey:_,allowCacheFallback:t.allowTitleImageCacheFallback===!0}),I=Ts(e),z=Is(e),B=ot(z?{buttonAttrs:`data-marketplace-open-map="${a(z)}"`,label:v("profile.openMap","Karte oeffnen"),iconName:"map"}:{href:I,label:v("profile.openMap","Karte oeffnen"),iconName:"map"}),O=zn(e?.instagramUrl||e?.instagram||e?.insta||"","instagram"),y=zn(e?.tiktokUrl||e?.tiktok||e?.tikTok||"","tiktok"),M=G(e?.phone||e?.telephone||e?.contactPhone||""),D=As(M),H=G(e?.address||e?.locationLabel||[e?.place||e?.locationPlace,e?.location||e?.city].map(te=>G(te)).filter(Boolean).join(", ")),K=[lt({href:O,iconName:"instagram",eyebrow:"Instagram",value:e?.instagram||e?.instagramUrl||e?.insta||""}),lt({href:y,iconName:"music-2",eyebrow:"TikTok",value:e?.tiktok||e?.tiktokUrl||e?.tikTok||""})].filter(Boolean).join(""),W=n==="self"?`
    ...
    `;if(p){const te=[lt({href:D,iconName:"phone",eyebrow:v("profile.call","Anrufen"),value:M}),lt({href:I,iconName:"map-pin",eyebrow:v("profile.address","Adresse"),value:H||T}),K].filter(Boolean).join("");return`
      <div data-landing-tutorial-target="identity" data-business-profile-card="${a(o)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${s}" style="${m}min-height: var(--business-profile-card-min-height, 440px);display:grid;grid-template-columns:minmax(0,1fr);width:100%;max-width:100%;min-width:0;box-sizing:border-box;">
        ${js({profileName:$,safeBio:S,metaLine:k,identityPending:w,followersLabel:C})}
  ...
  `}function ct(e={},t=[],{topTabOverride:n="",tutorialMode:s=!1,contentTabOverride:o="",landingHideContent:i=!1,collapseIdentity:c=!1,contentReveal:d=!1,landingMode:p=!1}={}){const b=Va(e),m=!!e.privateAccount&&e.uid&&String(e.uid)!==String(r.user?.uid||"")&&!b,h=!!e.pendingFollowRequest&&!b,x=e.restaurantId?"Business":v("nav.user","User"),w=String(e.handle||Y(e.name||"user")).replace(/^@/,""),$=a(e.bio||"").replace(/\n/g,"<br>")||a(v("profile.noBio","Noch keine Bio.")),P=Le(e),T=String(n||Rt(e)).trim().toLowerCase()||"profile",k=String(o||it(e)).trim().toLowerCase()||"posts",S=k==="menu",_=k==="checkins",F=t,I={...r?.profileView&&typeof r.profileView=="object"?r.profileView:{},profile:e,posts:Array.isArray(F)?F:[]},z=br(r,{profileView:I,profileTopTab:T,profileContentTab:k}),B=String(z?.header?.status||"").trim().toLowerCase()||"loading",O=String(z?.posts?.status||"").trim().toLowerCase()||"loading",y=e.uid||e.restaurantId||w||"public",M=`avatar:public:${y}`,D=String(e?.avatar||"").trim(),H=g(D,"avatar",{stableKey:M}),K=L(!!e.restaurantId),W=p?"":`data-img-key="avatar:public:${a(y)}"`,te=!D&&!!String(H||"").trim()&&!J(H),ne=!!D||te&&We(B),$e=Re=>{if(Re==null)return!1;const Se=Number(Re);return Number.isFinite(Se)&&Se>=0},Wt=ne||$e(e?.followers)||$e(e?.following),ce=We(B)&&!Wt,ke=!!String(H||"").trim()&&!J(H)&&ne,ft=ce?"...":A(e.followers),mt=ce?"...":A(e.following),gt=P?"pt-2":"pt-10",bt=b?v("profile.following","Following"):h?v("profile.requested","Requested"):m?v("profile.request","Request"):v("profile.follow","Follow"),qe=b?"bg-slate-100 text-slate-600 shadow-none border border-slate-200":h?"bg-amber-50 text-amber-700 shadow-none border border-amber-200":"bg-gradient-to-r from-slate-900 to-slate-800 text-white border border-transparent",Ge=s?"select-none":"app-main-content-safe",de=s?"pointer-events-none":"",re=!c,aa=!i,ht=d?p?"transition-opacity duration-200":"animate-in fade-in duration-300":"",sa=k==="posts"&&F.length>0,cr=k!=="posts"||sa||O==="empty"||O==="error",dr=k==="posts"&&!sa&&O==="error";return!s&&(k==="posts"||k==="media")&&e?.restaurantId&&We(O)&&Ce(e),`
    <div class="${Ge}" ${s?'data-landing-tutorial-surface="true"':""}>
      ...
      `:`
        ${Et(e,{landingPreview:s,selectedTabOverride:k,compact:c})}
        ${aa?zt(e,{disabled:s}):""}

        ${aa?S?(()=>{const Re=Oe(e),Se=!Re&&P&&!s&&!p&&!at(e)?jn(e):"";return Se&&Ln(Se,e),`
          <div class="${de} ${ht}"${Se?` ${He}="${a(Se)}"`:""}>
            ${Re?Mt(e):pt(e,{mode:p?"landing":"profile",allowAutoEnsure:!p})}
          </div>
        `})():_?`
          <div class="${de} ${ht}">
            ${Lt()}
  ...
  `}function Ls(){const e=r.profileView;if(!e||!e.profile)return"";const t=e.profile,n=e.posts||t.posts||[],s=Rt(t);return s==="landing"?xs(t):ct(t,n,{topTabOverride:s,tutorialMode:!1})}function Dn(e,{filter:t="all",query:n=""}={}){const s=Array.isArray(e)?e:[],o=Fa(n||"");return s.filter(i=>t==="all"||Ae(i.type)===t?o?`${i.name||""} ${i.category||""} ${i.description||""}`.toLowerCase().includes(o):!0:!1)}function Un(e,t=0){const n=Number(e);return Number.isFinite(n)?Math.max(0,Math.floor(n)):Math.max(0,Number(t)||0)}function dt(e=[]){return(Array.isArray(e)?e.slice():[]).map((n,s)=>({item:n,idx:s,order:Un(n?.orderIndex,s)})).sort((n,s)=>n.order-s.order||n.idx-s.idx).map((n,s)=>({...n.item,orderIndex:Un(n.item?.orderIndex,s)}))}function Nt(e={}){const t=String(e?.menuVisibility||"").trim().toLowerCase();return e?.menuHidden===!0||t==="hidden"}function Ke(e={}){const t=String(e?.menuSection||e?.displaySection||e?.menuPlacement||"").trim().toLowerCase();return t==="drink"?"drink":t==="food"?"food":Ae(e?.type||"food")==="drink"?"drink":"food"}function _s(e={}){return String(e?.category||v("menu.other","Sonstiges")).trim()||v("menu.other","Sonstiges")}function Fs(e=""){const t=String(e||"").trim().toLowerCase();return t?(typeof t.normalize=="function"?t.normalize("NFD").replace(/[\u0300-\u036f]/g,""):t).replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""):""}const Ms=4,Rs={thumb:160,small:480,medium:768,large:1280};function Bn({mode:e="profile",priorityIndex:t=-1,slideIndex:n=0}={}){return(e==="profile"||e==="landing")&&Number.isFinite(t)&&t>=0&&t<Ms&&n===0}function Es({mode:e="profile",priorityIndex:t=-1,slideIndex:n=0}={}){const s=Bn({mode:e,priorityIndex:t,slideIndex:n}),o=e==="profile"?' data-image-reveal="menu"':"";return s?`loading="eager" fetchpriority="high"${o}`:`loading="lazy" fetchpriority="low"${o}`}function zs({variant:e="grid"}={}){return e==="thumb"?"(max-width: 640px) 64px, 64px":e==="hero"?"(max-width: 640px) 94vw, (max-width: 1200px) 74vw, 920px":"(max-width: 640px) 48vw, (max-width: 1200px) 28vw, 360px"}function ge(e,{mode:t="profile",priorityIndex:n=-1,slideIndex:s=0,stableKey:o="",preferredSize:i="small",candidateSizes:c=["small","medium","large"],variant:d="grid"}={}){const p=String(e||"").trim(),b=t==="profile"&&o?{stableKey:o}:null,m=Bn({mode:t,priorityIndex:n,slideIndex:s}),h=t==="profile"&&!m&&d!=="thumb",x=g(p,i,b),w=J(x)?q:x,C=Pa(p),$=Aa(p)&&p!==w?p:C,P=[],T=new Set;c.forEach(y=>{const M=Rs[y]||0;if(!M)return;const D=g(p,y,b);if(!D||J(D))return;const H=`${D}|${M}`;T.has(H)||(T.add(H),P.push(`${D} ${M}w`))});const k=P.length>1?P.join(", "):"",S=k?zs({variant:d}):"",_=h?"":k,F=h?"":S,E=_?` srcset="${a(_)}"`:"",I=F?` sizes="${a(F)}"`:"",z=Es({mode:t,priorityIndex:n,slideIndex:s}),B=`${z}${E}${I}`,O=h?[`data-menu-lazy-src="${a(w)}"`,`data-menu-lazy-fallback="${a($||q)}"`,k?`data-menu-lazy-srcset="${a(k)}"`:"",S?`data-menu-lazy-sizes="${a(S)}"`:""].filter(Boolean).join(" "):"";return{safeImg:h?q:w,fallbackImg:h?q:$,imageAttrs:B,lazyAttrs:O?` ${O}`:"",srcsetValue:k,sizesValue:S,loadingAttrs:z}}function Fe(e=[],t,n=null){const s=n instanceof Set?n:new Set;return e.map((o,i)=>{const c=_s(o),d=Fs(c),p=!!d&&!s.has(d);return p&&s.add(d),`<div${p?` data-menu-category-anchor="${a(d)}"`:""} class="h-full">${t(o,i)}</div>`}).join("")}function Dt(e={}){return String(e?.specialSize||e?.specialCardSize||"").trim().toLowerCase()==="food"?"food":"default"}function Ns(e=""){const t=String(e||"").trim();return t?/^(https?:\/\/|mailto:|tel:)/i.test(t)?t:`https://${t.replace(/^\/+/,"")}`:""}function On(e={}){const t=String(e?.specialActionType||e?.actionType||"").trim().toLowerCase(),n=Ns(e?.specialActionUrl||e?.linkUrl||e?.actionUrl||""),s=String(e?.specialActionProductId||e?.targetProductId||"").trim();return t==="link"&&n?{type:"link",url:n,productId:""}:t==="product"&&s?{type:"product",url:"",productId:s}:{type:"self",url:"",productId:""}}function Hn(){const e=ae(r.userProfile),t=String(r.menu.filter||"all").trim().toLowerCase()||"all",n=e&&t==="drink"?"all":t;return`
  ...
  `}function Ds(){const e=Ia().id;return`
  ...
  `}function ut(e,{poster:t="",objectPosition:n="50% 50%",badge:s=!0}={}){if(!Qt(e))return"";const o=String(e.videoUrl||"").trim();if(!o)return"";const i=t?` poster="${a(t)}"`:"";return`<video data-autoplay-video src="${a(o)}"${i} class="absolute inset-0 w-full h-full object-cover pointer-events-none z-[1]" style="object-position:${n};" muted loop playsinline autoplay preload="metadata"></video>`+(s?'<div class="absolute top-3 left-3 w-7 h-7 rounded-full bg-black/35 backdrop-blur-md text-white flex items-center justify-center pointer-events-none z-10"><svg viewBox="0 0 24 24" class="w-3.5 h-3.5 fill-white block"><path d="M8 5v14l11-7z"></path></svg></div>':"")}function Ut(e,{mode:t="profile",priorityIndex:n=-1}={}){const s=oe(e),o=t==="profile"?Me(e,{index:0}):"",{safeImg:i,fallbackImg:c,imageAttrs:d,lazyAttrs:p}=ge(s,{mode:t,priorityIndex:n,stableKey:o,preferredSize:"thumb",candidateSizes:["thumb","small"],variant:"thumb"}),b=Be(e),m=r.activeTab==="menu"?r.userProfile:r.profileView?.profile||r.userProfile,h=ae(m),x=hn(e,h),w=h?bn(e.category):e.category||"",C=e.description||"";return t==="admin"?`
  ...
  `}function Ot(e={}){if(!e?.restaurantId||ae(e))return!1;const t=String(Pt(e)||"").trim().toLowerCase();return t?t==="restaurant"||t==="cafe"||t==="fastfood":ye(e)}function Vn(e){const t=e?.restaurantId||r.menu.restaurantId||r.profileView?.profile?.restaurantId||r.userProfile.restaurantId||"",n=Je(e),s=un(t,n),o=s?pn(s):{likes:[],comments:[],counts:{likes:0,comments:0}},i=String(r.user?.uid||"").trim(),c=String(r.user?.handle||"").trim().toLowerCase(),d=!!o.likes?.some(p=>{const b=String(p?.uid||"").trim();if(i&&b&&b===i)return!0;const m=String(p?.handle||"").trim().toLowerCase();return!!c&&!!m&&m===c});return{itemId:n,meta:o,counts:fn(o),isLiked:d}}function Me(e,{index:t=0}={}){const n=String(e?.restaurantId||r.menu.restaurantId||r.profileView?.profile?.restaurantId||r.userProfile.restaurantId||"").trim(),s=String(e?.id||Je(e)||"").trim();if(!n||!s)return"";const o=Number(t),i=Number.isFinite(o)?Math.max(0,Math.floor(o)):0;return`menu-detail:${n}:${s}:${i}`}function Us(e){const t=typeof dn=="function"?dn(e):[],n=Array.isArray(t)?t.filter(Boolean):[];if(n.length)return n;const s=oe(e);return s?[s]:[]}function be(e){return pr(e?.cardStyle||"",Ae(e?.type||"food"))}function Ht(e,{menuItemId:t=""}={}){if(!e)return null;const n=String(t||e.menuItemId||e.itemId||e.productId||"").trim(),s=Qt(e),o=String(e.videoUrl||"").trim(),i=String(e.posterUrl||"").trim(),c=oe(e)||e.imageUrl||(s?i:"")||"";return{id:e.id||"",title:e.name||e.title||"Sot ne Fokus",text:e.description||e.text||"",imageUrl:c,objectPosition:e.objectPosition||Z(e),menuItemId:n,mediaType:s?"video":"image",videoUrl:s?o:"",posterUrl:s?i||c:""}}function j(e=""){return`<div aria-hidden="true" class="${e} bg-slate-100 animate-pulse"></div>`}function Bs(e={}){return nt("focus-carousel-skeleton",{...e,functionName:"renderFocusCarouselSkeleton",source:e?.source||"public-focus"}),`
  ...
  `}function qs(e,t="profile"){if(t!=="profile")return"";const n=On(e);return n.type==="link"&&n.url?`data-menu-special-link="${a(n.url)}" role="button" tabindex="0"`:n.type==="product"&&n.productId?`data-menu-open="${a(n.productId)}" role="button"`:`data-menu-open="${a(e.id)}" role="button"`}function Vt(e,{mode:t="profile",size:n="default",priorityIndex:s=-1}={}){const o=oe(e),i=t==="profile"?Me(e,{index:0}):"",c=n==="food",{safeImg:d,fallbackImg:p,imageAttrs:b,lazyAttrs:m}=ge(o,{mode:t,priorityIndex:s,stableKey:i,preferredSize:c?"medium":"small",candidateSizes:c?["small","medium","large"]:["small","medium"],variant:c?"hero":"grid"}),h=qs(e,t),x=String(e.category||"Special").trim()||"Special",w=a(String(e.name||"Special")).replace(/\n/g,"<br>");return n==="food"?`
  ...
  `}function Qn(e,{mode:t="profile",priorityIndex:n=-1}={}){const s=Be(e),o=t==="profile"?`data-menu-open="${a(e.id)}" role="button"`:"",i=Us(e),d=(i.length?i:[oe(e)||""]).filter(Boolean),p=d.length?d.slice(0,12):[""],b=p.length>1,{itemId:m,counts:h,isLiked:x}=Vn(e),w=A(Math.max(0,Number(h.likes)||0)),C=A(Math.max(0,Number(h.comments)||0));return`
  ...
  `}function Gs(e,t,{mode:n="profile",publicMenuSurfaceState:s=null,focusFallbackHtml:o=""}={}){const i=dt(Array.isArray(t)?t:[]),c=String(e?.restaurantId||"").trim(),d=n==="admin"||Ba(c),p=s?.focus?.canRenderFocus?{items:Array.isArray(s.focus.items)?s.focus.items:[],enabled:!0}:c&&d?Xe(c):{items:[],enabled:!1},b=p.enabled?(Array.isArray(p.items)?p.items:[]).map(y=>Ht({...y,objectPosition:Te(y)})):[],m=i.filter(y=>be(y)==="testfirst_focus"&&!Nt(y)).map(y=>Ht(y,{menuItemId:y.id||""})).filter(Boolean),h=new Set,x=[...b,...m].filter(y=>{const M=String(y.menuItemId||y.id||`${y.title}|${y.text}|${y.imageUrl}`);return!M||h.has(M)?!1:(h.add(M),!0)}),w=i.filter(y=>!Nt(y)),C=w.filter(y=>be(y)!=="testfirst_focus"),$=C.length?C:w,P=C.length?x:[],T=$.filter(y=>Ke(y)==="drink"),k=$.filter(y=>Ke(y)!=="drink"),S=(y=[])=>{const M=[],D=[];return y.forEach(H=>{const K=be(H);K==="testfirst_food"||K==="testfirst_special"&&Dt(H)==="food"?D.push(H):M.push(H)}),{gridItems:M,foodItems:D}},_=(y,M=-1)=>be(y)==="testfirst_special"?Vt(y,{mode:n,priorityIndex:M}):Wn(y,{mode:n,priorityIndex:M});let F=0;const E=()=>{const y=F;return F+=1,y},I=new Set,z=(y,M)=>!M.gridItems.length&&!M.foodItems.length?"":`
      <section class="menu-type-block relative" data-menu-type-block="${a(y)}">
        ...
        ${M.foodItems.length?`
          <div class="menu-category-section pb-6 pt-4" data-menu-type="${a(y)}">
            <div class="app-content-inline">
              ${Fe(M.foodItems,D=>{const H=be(D),K=E();return H==="testfirst_special"?Vt(D,{mode:n,size:"food",priorityIndex:K}):Qn(D,{mode:n,priorityIndex:K})},I)}
            </div>
          </div>
        `:""}
      </section>
  ...
  `}function Jn(e,{mode:t="profile",useTestfirstCardUi:n=!1,seenCategories:s=null,priorityOffset:o=0}={}){return e.length?n?`
    ...
    `:`
    <div class="grid grid-cols-2 auto-rows-fr gap-4">
      ${Fe(e,(i,c)=>Bt(i,{mode:t,variant:"drink",priorityIndex:o+c}),s)}
    </div>
  `:""}function Xn(e,{mode:t="profile",useTestfirstCardUi:n=!1,seenCategories:s=null,priorityOffset:o=0}={}){return e.length?n?`
      <div>
        ${Fe(e,(i,c)=>be(i)==="testfirst_special"&&Dt(i)==="food"?Vt(i,{mode:t,size:"food",priorityIndex:o+c}):Qn(i,{mode:t,priorityIndex:o+c}),s)}
      </div>
    `:`
    <div class="space-y-4">
      ${Fe(e,(i,c)=>Bt(i,{mode:t,variant:"food",priorityIndex:o+c}),s)}
    </div>
  `:""}function Zn(e,{mode:t="profile"}={}){if(t==="admin"){const n=String(r?.menu?.filter||"all").trim().toLowerCase(),s=ae(r.userProfile),o=v("menu.products","Produkte"),i=e.filter(m=>Ae(m?.type)==="drink"),c=e.filter(m=>Ae(m?.type)!=="drink"),d=(m,h,{addType:x=""}={})=>`
    ...
    <div class="space-y-4">
      ${e.map((n,s)=>Ut(n,{mode:t,priorityIndex:s})).join("")}
    </div>
  ...
  `}function ea(e={}){if(!e?.restaurantId)return!1;const t=String(Pt(e)||"").trim().toLowerCase();return["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"].includes(t)||t==="ecommerce"||ae(e)?!1:ye(e)||["restaurant","cafe","coffee","fastfood","food"].includes(t)||!t}function Ys(e={}){if(e.active===!1)return{label:"Inaktiv",className:"text-slate-400"};const t=String(e.status||e.approvalStatus||"pending").trim().toLowerCase();return t==="approved"?{label:"Freigegeben",className:"text-emerald-600"}:t==="rejected"?{label:"Abgelehnt",className:"text-rose-600"}:{label:"Wartet auf Heart",className:"text-amber-600"}}function Ws(e,t){if(!t||!ea(e))return"";const{items:n,loading:s}=ja(t,{includeInactive:!0}),o=A(n.length);return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(i=>{const c=g(i.imageUrl||"","thumb"),d=J(c)?q:c,p=Ys(i),b=i.category||"RESTAURANT",m=i.priceSegment||"€€ - €€€";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function qt(e){if(Array.isArray(e))return e.map(n=>String(n||"").trim()).filter(Boolean);const t=String(e||"").trim();return t?t.split(/[\n,;|]/).map(n=>n.trim()).filter(Boolean):[]}function Qs(e={}){const t=String(e?.restaurantId||"").trim(),n=t?le(t):null;return{...n&&typeof n=="object"?n:{},...e&&typeof e=="object"?e:{},...t?{restaurantId:t}:{}}}function Gt(e={}){return e.shoppingLandingCard&&typeof e.shoppingLandingCard=="object"?e.shoppingLandingCard:{}}function Js(e={}){const t=Gt(e);return[...qt(t.productIds),...qt(e.shoppingLandingCardProductIds),...qt(e.shoppingLandingProductIds)].filter(Boolean)}function Yt(e={}){return!e||typeof e!="object"?{}:Object.entries(e).reduce((t,[n,s])=>{const o=String(n||"").trim(),i=String(s||"").trim();return o&&i&&(t[o]=i),t},{})}function Xs(e={}){const t=Gt(e);return{...Yt(e.shoppingLandingProductImageOverrides),...Yt(t.productImageOverrides)}}function Zs(e=""){const t=String(e||"").trim(),n=r.shoppingLandingCardEditor&&typeof r.shoppingLandingCardEditor=="object"?r.shoppingLandingCardEditor:{},s=String(n.restaurantId||"").trim();return s&&s!==t?{}:n}function er(e){return e?typeof e=="string"?e.trim():typeof e!="object"?String(e||"").trim():String(e.url||e.src||e.cdnUrl||e.imageUrl||e.image||e.photoUrl||e.thumbnail||"").trim():""}function tr(e={}){const n=[oe(e),...Array.isArray(e.imageUrls)?e.imageUrls:[],...Array.isArray(e.images)?e.images:[],e.imageUrl,e.image,e.photoUrl,e.coverUrl,e.img,e.thumbnail].map(er).filter(Boolean);return n.filter((s,o)=>n.indexOf(s)===o)}function nr(e={},t={},n={}){const s=String(e?.id||e?.productId||e?.menuItemId||"").trim();if(!s)return null;const o=tr(e).map(m=>({rawUrl:m,imageUrl:g(m,"thumb")})).filter(m=>m.rawUrl&&!J(m.imageUrl)),i=o[0]?.rawUrl||"",c=String(t?.[s]||"").trim(),d=String(n?.[s]||"").trim(),p=d||c||i,b=p?g(p,"thumb"):"";return{id:s,name:String(e.name||e.title||"Produkt").trim(),price:Be(e),imageUrl:b&&!J(b)?b:"",defaultImageRaw:i,cardImageUrl:c,previewImageUrl:d,imageCandidates:o,objectPosition:Z(e)}}function ar(e={},t="",n=[]){if(!t||!ae(e))return"";const s=Qs(e),o=Gt(s),i=Zs(t),c=i.saving===!0,d=String(i.status||"").trim(),p=/fehl|error|nicht|nuk|kein/i.test(d),b=String(o.imageUrl||s.shoppingLandingCardImageUrl||s.shoppingLandingImageUrl||"").trim(),m=String(s.logoUrl||s.logo||s.logoURL||s.avatar||e.avatar||"").trim(),h=String(i.imageUrlDraft??b).trim(),x=String(i.imagePreview||h||m||"").trim(),w=x?g(x,"large"):q,C=String(i.titleDraft??(o.title||s.shoppingLandingCardTitle||e.name||"")).trim(),$=i.active!==void 0?i.active!==!1:o.active!==!1&&s.shoppingLandingCardEnabled!==!1,P=Js(s),T=Array.isArray(i.productIds)?i.productIds.map(I=>String(I||"").trim()).filter(Boolean):null,k=new Set(T||P),S={...Xs(s),...Yt(i.productImageOverrides)},_=i.productImagePreviews&&typeof i.productImagePreviews=="object"?i.productImagePreviews:{},F=(Array.isArray(n)?n:[]).filter(I=>I&&String(I.id||"").trim()&&I.hidden!==!0&&I.available!==!1).map(I=>nr(I,S,_)).filter(Boolean),E=k.size?`${A(k.size)} ausgewaehlt`:"Keine Auswahl = alle Produkte";return`
        ...
        <div class="rounded-[1.8rem] border border-slate-100 bg-slate-50 p-4">
          ...
          ${F.length?`
            <div class="grid grid-cols-1 gap-2">
              ${F.map(I=>{const z=k.has(I.id),B=I.imageUrl||q,O=String(I.defaultImageRaw||I.imageCandidates[0]?.rawUrl||"").trim(),y=String(I.cardImageUrl||"").trim(),M=String(I.previewImageUrl||"").trim(),D=!!(M||y&&y!==O),H=M||(y&&!I.imageCandidates.some(K=>K.rawUrl===y)?y:"");return`
                          ...
                          ${H?`
                            <label class="shrink-0 w-16">
                              ...
                              <span class="block h-16 rounded-2xl overflow-hidden border border-slate-900 bg-slate-100">
                                <img src="${a(g(H,"thumb"))}" class="w-full h-full object-cover" loading="lazy" decoding="async" />
                              </span>
  ...
  `}function sr(e){if(!Ot(e)||!xn(e))return"";const n=dt((r.menu.items||[]).filter(s=>be(s)==="testfirst_special"));return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(s=>{const o=g(oe(s),"thumb"),i=J(o)?q:o,c=On(s),d=c.type==="link"?"Link":c.type==="product"?"Produkt-Modal":"Diese Karte",p=Dt(s)==="food"?"Food-Size":"Normal",b=Da(Ke(s));return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function rr(e,t=220){const n=encodeURIComponent(e||"");return`https://api.qrserver.com/v1/create-qr-code/?size=${t}x${t}&data=${n}`}function na({label:e,url:t,caption:n}){if(!t)return"";const s=rr(t,240);return`
  ...
  `}function or(){const e=r.userProfile,t=e.restaurantId||"",n=String(r.user?.uid||"").trim(),s=String(r.__authBootstrapInFlightUid||"").trim(),o=!t&&!!n&&(!!r.__authProfileLoadPromise||s===n),i=Oe(e),c=ye(e),d=r.profileView?.profile?.restaurantId?r.profileView.profile:null,p=U()&&!!d?.restaurantId&&ye(d),b=ae(e),m=Na(ya(e)),h=t?le(t):null,x=h?.name||h?.restaurantName||e.name||"Business",w=t&&r.menu.restaurantId===t,C=String(r.menu.source||"").trim().toLowerCase(),$=!!w&&C==="collection",P=!!w&&C==="collection"&&r.menu.loading,T=!!t&&(P||!$),k=b?"all":r.menu.filter,S=$?Dn(r.menu.items,{filter:k,query:r.menu.query}):[],F=xn(e)?S:S.filter(z=>!Ka(z)),E=dt(F),I=A(E.length);if(t&&i){Ya(e);const z=String(r.focus?.truthSource||"").trim().toLowerCase();return!r.focus.loading&&(r.focus.restaurantId!==t||z!=="public-menu")&&we(e),bs(e)}return t&&c&&!$&&!P&&Qe(e),t&&c&&!r.focus.loading&&r.focus.restaurantId!==t&&we(e),t&&ea(e)&&It(e),c?`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      <div class="flex items-end justify-between mb-6">
        <div>
      ...
      ${t?`
        ...
        ${ir({profile:e,restaurantId:t,catalogLabel:m})}
      `:""}
  ...
  `:p?pt(d):`
    ...
    `;const d=vn(e,c),p=ae(d),b=ye(d)&&!p;b&&(i=Ye(r,{profile:d,routePayload:s,webDirectEntry:o,restaurantId:c}));const m=String(o?.canonicalRestaurantId||o?.restaurantId||"").trim(),h=new Set(i.targetIds),x=i.menu.status==="ready",w=i.focus.canRenderFocus,C=x&&b,$=i.focus.matches===!0&&i.focus.loading===!0,T=String(r?.profileView?.menuAccessSource||o?.menuAccessSource||s?.menuAccessSource||"").trim().toLowerCase()==="qr",k=o?.active===!0&&o?.webPriority===!0&&o?.menuFirst===!0&&String(r?.activeTab||"").trim().toLowerCase()==="profile"&&String(r?.profileTopTab||"").trim().toLowerCase()==="menu"&&(m===c||h.has(c)),S=k&&!T,_=["ready","empty","error"].includes(i.menu.status),F=k&&_,E=k&&(!C||i.menu.status!=="ready"),I=!C||i.focus.settled===!0||i.focus.confirmedEmpty===!0||i.menu.status!=="ready";n&&!F&&!_&&Pe(d),n&&!E&&!I&&!$&&x&&(!S||_)&&we(d);const B=i.menu.canRenderItems?dt(Dn(i.menu.items,{filter:"all",query:""})).filter(re=>!Nt(re)):[],O=i.menu.error||"",y=fr(i.menu,B),{hasItems:M,hasError:D,isLoading:H,shouldRenderNoProducts:K}=y;Ra({profile:d,routePayload:s,surface:i,decision:y});const W={profile:d,routePayload:s,surface:i,decision:y,rawItems:i.menu.items,items:B,filteredItems:B,source:"public-menu"},te=za(i,B),ne=B.filter(re=>Ke(re)==="drink"),$e=B.filter(re=>Ke(re)!=="drink"),Wt=0,ce=ne.length,ke=Ot(e),ft=ke||p,mt=new Set;M&&c&&($a(B,c),Ha(B,c));const gt=c&&w?(Array.isArray(i.focus.items)?i.focus.items:[]).map(re=>Ht({...re,objectPosition:Te(re)})).filter(Boolean):[],bt=i.focus.status==="empty"||i.focus.status==="error",qe=b&&!w&&!bt&&i.menu.status!=="empty"&&i.menu.status!=="error",Ge=gt.length?Yn(d,gt,{mode:t}):qe?Os({...W,reason:"focus-truth-pending"}):"",de=ft?Ge:ta(d,{restaurantId:c,suppressLoading:!0,allowAutoEnsure:x&&(!S||_),requirePublicMenuTruth:!0})||(qe?Bs({...W,reason:"focus-truth-pending"}):"");return ke?`
      <div class="app-main-content-safe"${te}>
        ${H?`
          ${Ge}
          ${Kn({...W,reason:"menu-loading"})}
        `:`
          ${M?Gs(d,B,{mode:t,publicMenuSurfaceState:i,focusFallbackHtml:Ge}):D?`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${a(v("menu.loadError","Menu konnte nicht geladen werden"))}</div>`:K?(tt({...W,functionName:"renderProfileMenuView",renderDecision:"testfirst-no-products"}),`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300"${se({source:"public-menu:no-products"})}>${a(v("menu.noProducts","Keine Produkte"))}</div>`):Kn({...W,reason:"menu-not-confirmed-empty"})}
          ...
          `:`
            ${ne.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="drink">
                ...
                <div data-menu-type="drink">
                  ${Jn(ne,{mode:t,useTestfirstCardUi:ke,seenCategories:mt,priorityOffset:Wt})}
                </div>
              </section>
            `:""}
            ${$e.length?`
  ...
  `}function lr(){const e=r.userProfile,t=R(e),n=t?r.businessPosts:r.userPosts,s=String(r.user?.uid||e?.uid||"").trim(),o=String(e?.restaurantId||"").trim(),i=String(r.__userPostsLoadingUid||"").trim(),c=String(r.__businessPostsLoadingRestaurantId||"").trim(),d=String(r.__authBootstrapInFlightUid||"").trim(),p=!!s&&i===s,b=!!o&&c===o,m=!!s&&d===s,h=t?b||m&&!n.length:p||m&&!n.length,x=String(e.handle||Y(e.name||"user")).replace(/^@/,""),C=a(e.bio||"").replace(/\n/g,"<br>")||a(v("profile.noBio","Noch keine Bio.")),$=it(e),P=$==="menu",T=$==="checkins",k=n,S=g(e.avatar,"avatar"),_=L(t),F=Rt(e);return`
    <div class="app-main-content-safe">
      ...
      ${P?(()=>{const I=Oe(e),z=!I&&t&&!at(e)?jn(e):"";return z&&Ln(z,e),`
        <div${z?` ${He}="${a(z)}"`:""}>
          ${I?Mt(e):pt(e)}
        </div>
      `})():T?`
  ...
  `}return{renderProfilePostCardFancy:wn,renderProfilePostsFancy:jt,renderProfileCheckins:Lt,renderProfileTabs:Et,renderProfileViewControls:zt,renderPublicProfileView:Ls,renderMenuFilterRow:Hn,renderMenuLayoutSection:Ds,renderMenuItemCard:Ut,renderMenuItemCardStacked:Bt,renderMenuDrinkGrid:Jn,renderMenuFoodList:Xn,renderMenuList:Zn,renderFocusAdminSection:Kt,renderFocusCarousel:ta,renderMenuQrCard:na,renderMenuAdminView:or,renderProfileMenuView:pt,renderProfileView:lr}}export{zi as createProfileMenuFocusRenderController};
