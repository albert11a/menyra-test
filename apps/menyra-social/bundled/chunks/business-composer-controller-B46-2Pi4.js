...
`;function gt(p){if(!(!p||p.getElementById(xe)))try{const l=p.createElement("style");l.id=xe,l.textContent=yt,p.head?.appendChild(l)}catch{}}function vt(p){if(!p?.body)return null;let l=p.getElementById("overlayRoot");return l||(l=p.createElement("div"),l.id="overlayRoot",l.style.position="relative",l.style.zIndex="200",l.style.isolation="isolate",p.body.appendChild(l)),l}function Lt(p="",l={}){const a=l&&typeof l=="object"?l:{},s=String(p||"").trim();if(!s)return null;const u=a.imageUrl||a.image||(Array.isArray(a.images)?a.images[0]:"")||"",U=String(a.type||a.menuType||"").trim().toLowerCase(),X=["drink","drinks","beverage","getraenke","getränke"].includes(U)?"drink":"food";return{id:s,name:String(a.name||a.title||"").trim()||s,price:a.price??"",category:String(a.category||"").trim(),type:X,imageUrl:typeof u=="string"?u.trim():""}}function _t(p=[]){const l=new Set,a=[];return(Array.isArray(p)?p:[]).forEach(s=>{const u=String(s?.id||"").trim();!u||l.has(u)||(l.add(u),a.push(s))}),a}function Pe(p=[]){return(Array.isArray(p)?p:[]).map(l=>`${l?.id||""}|${l?.name||""}|${l?.price??""}|${l?.imageUrl||""}`).join("~")}function xt(p=[],l=""){const a=Array.isArray(p)?p:[],s=String(l||"").trim().toLowerCase();return s?a.filter(u=>`${u?.name||""} ${u?.category||""}`.toLowerCase().includes(s)):a}function Ce(p=""){const l=String(p||"").trim().toLowerCase();return l==="story"?"story":l==="profile"?"profile":"post"}function Ee({caption:p="",hasImage:l=!1,submitting:a=!1}={}){return a||!l?!1:String(p||"").trim().length>0}function Tt({documentObj:p=null,windowObj:l=null,api:a={}}={}){const s=p||(typeof document>"u"?null:document),u=l||s?.defaultView||(typeof window>"u"?null:window),U=typeof a.getRestaurantIdFn=="function"?a.getRestaurantIdFn:(()=>""),X=typeof a.getBusinessMetaFn=="function"?a.getBusinessMetaFn:(()=>({name:"",logoUrl:""})),ee=typeof a.loadProductsFn=="function"?a.loadProductsFn:null,Le=typeof a.getBusinessKindFn=="function"?a.getBusinessKindFn:(()=>""),F=typeof a.uploadImageFn=="function"?a.uploadImageFn:null,te=typeof a.uploadVideoFn=="function"?a.uploadVideoFn:null,O=typeof a.captureVideoPosterFn=="function"?a.captureVideoPosterFn:null,re=typeof a.createPostFn=="function"?a.createPostFn:null,ie=typeof a.createStoryFn=="function"?a.createStoryFn:null,Te=typeof a.afterPublishFn=="function"?a.afterPublishFn:(()=>{}),Ie=typeof a.formatPriceFn=="function"?a.formatPriceFn:(e=>String(e??"")),ne=typeof a.getOptimizedImageUrlFn=="function"?a.getOptimizedImageUrlFn:(e=>String(e||"").trim()),N=typeof a.escapeHtmlFn=="function"?a.escapeHtmlFn:(e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")),A=typeof a.iconFn=="function"?a.iconFn:(()=>""),S=(e="")=>N(String(e??"")),L={post:{caption:"",file:null,previewUrl:"",thumbUrl:"",posterFile:null,mediaType:"",product:null},story:{caption:"",file:null,previewUrl:"",thumbUrl:"",posterFile:null,mediaType:"",product:null},profile:{caption:"",file:null,previewUrl:"",thumbUrl:"",posterFile:null,mediaType:"",product:null}},b={status:"idle",items:[],restaurantId:"",fresh:!1};let m=null,r=null,f="post",C=!1,h=!1,v=null,ae=!1,oe=!1,R=0;function g(){return L[f]||L.post}function B(){let e="";try{e=String(Le()||"")}catch{e=""}return ht(e)}function ce(e=""){const t=String(e||"").trim();if(t.startsWith("blob:"))try{u?.URL?.revokeObjectURL?.(t)}catch{}}function W(e){e&&(ce(e.previewUrl),e.thumbUrl&&e.thumbUrl!==e.previewUrl&&ce(e.thumbUrl))}function $e(){const e=B();return`
