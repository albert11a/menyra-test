const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/hotel-stay-detail-modal-3tE8S1ny.js","chunks/domain-app-events-hrSGrzeg.js","chunks/domain-auth-Aq-4Vdvh.js","chunks/domain-feed-social-eager-CSzqAfRb.js","chunks/domain-public-profile-mLQti0eH.js","chunks/domain-media-eager-B3Bb4ghO.js","chunks/domain-menu-eager-BUdqOprI.js","chunks/domain-dashboard-XgTL-wxD.js","chunks/domain-analytics-jv5B-kA2.js"])))=>i.map(i=>d[i]);
import{_ as ia}from"./domain-auth-Aq-4Vdvh.js";import{w as yr}from"./domain-menu-eager-BUdqOprI.js";import{r as $r}from"./profile-post-card-markup-utils-HwqIiXgP.js";import{a as Zt}from"./domain-media-eager-B3Bb4ghO.js";import{az as Qe,aA as kr,t as Sr,aB as Ir,k as Cr,aC as Je}from"./domain-feed-social-eager-CSzqAfRb.js";import{r as Pr,g as jr,H as ya,n as $a,h as Ar}from"./domain-app-events-hrSGrzeg.js";import{n as oa,M as la,b as en,d as Tr,f as Lr}from"./domain-dashboard-XgTL-wxD.js";import{K as Mr,L as _r,M as Fr,N as Er,O as Rr,P as zr,Q as Nr,J as Dr,R as Or,A as Ur,g as Hr,B as Br,S as Vr,T as Kr,b as qr,d as Gr}from"./vendor-firebase-D7Ks7H8l.js";import{a as Yr,r as Wr,b as ca,c as Qr,p as Jr,w as Xr,B as da}from"./business-type-hint-utils-DMmUx9Wd.js";import"./domain-public-profile-mLQti0eH.js";import"./domain-analytics-jv5B-kA2.js";const dn=Object.freeze([Object.freeze({key:"city",label:"Qyteti",labelDe:"Qyteti"}),Object.freeze({key:"beach",label:"Plazha",labelDe:"Straende"}),Object.freeze({key:"sights",label:"Vende per te pare",labelDe:"Sehenswuerdigkeiten"}),Object.freeze({key:"activities",label:"Aktivitete",labelDe:"Aktivitaeten"}),Object.freeze({key:"nature",label:"Natyre",labelDe:"Natur"}),Object.freeze({key:"food",label:"Restorante & Kafene",labelDe:"Restaurants & Cafes"}),Object.freeze({key:"nearby",label:"Vende te rendesishme",labelDe:"Wichtige Orte"})]),Zr=Object.freeze(dn.map(o=>o.key)),ei=Object.freeze([Object.freeze({key:"all",labelDe:"Ganzjaehrig"}),Object.freeze({key:"summer",labelDe:"Saisonal Sommer"}),Object.freeze({key:"winter",labelDe:"Saisonal Winter"})]),ti=Object.freeze(ei.map(o=>o.key)),ni=12;function ye(o=""){return o==null?"":String(o).trim()}function tn(o){const r=Number(o);return Number.isFinite(r)?r:null}function ai(o=""){const r=ye(o).toLowerCase();return Zr.includes(r)?r:{qyteti:"city",stadt:"city",plazha:"beach",plazhi:"beach",strand:"beach",straende:"beach",sehenswuerdigkeiten:"sights",sehenswurdigkeiten:"sights",aktivitete:"activities",aktivitaeten:"activities",natyre:"nature",natur:"nature",restorante:"food",restaurants:"food",cafes:"food",kafene:"food",umgebung:"nearby",rrethina:"nearby"}[r]||"nearby"}function si(o=""){const r=ye(o).toLowerCase();return ti.includes(r)?r:"all"}function ri(o=Date.now(),r=Math.random()){const u=Math.max(0,Number(o)||0).toString(36),a=Math.floor(Math.max(0,Math.min(.999999,Number(r)||0))*36**6).toString(36).padStart(6,"0");return`place_${u}_${a}`}function ii(o){return Array.isArray(o)?o.map(r=>ye(r)).filter(Boolean).slice(0,ni):[]}function oi(o={},{index:r=0}={}){const u=o&&typeof o=="object"?o:{},a=tn(u.lat??u.latitude??u.coords?.lat),b=tn(u.lng??u.lon??u.longitude??u.coords?.lng),f=tn(u.priority);return{id:ye(u.id)||ri(Date.now()+r),name:ye(u.name),category:ai(u.category),description:ye(u.description??u.text).slice(0,600),address:ye(u.address??u.plusCode).slice(0,240),lat:a,lng:b,coverImageUrl:ye(u.coverImageUrl??u.imageUrl??u.coverUrl),gallery:ii(u.gallery),priority:f==null?0:Math.max(0,Math.min(100,Math.round(f))),pinned:u.pinned===!0,season:si(u.season??u.seasonal),active:u.active!==!1}}const li=6371e3,ci=80,di=600,ui=1600;function wt(o=0){return(Number(o)||0)*(Math.PI/180)}function Ne(o){return o==null||o===""?NaN:Number(o)}function St(o={}){return Number.isFinite(Ne(o?.lat))&&Number.isFinite(Ne(o?.lng))}function pi(o,r,u,a){const b=Ne(o),f=Ne(r),E=Ne(u),_=Ne(a);if(![b,f,E,_].every(Number.isFinite))return null;const U=wt(E-b),P=wt(_-f),S=Math.sin(U/2)**2+Math.cos(wt(b))*Math.cos(wt(E))*Math.sin(P/2)**2;return Math.round(2*li*Math.asin(Math.min(1,Math.sqrt(S))))}function ua(o){const r=Number(o);return!Number.isFinite(r)||r<0?"":r<1e3?`${Math.max(10,Math.round(r/10)*10)} m`:r<1e4?`${(r/1e3).toFixed(1).replace(/\.0$/,"")} km`:`${Math.round(r/1e3)} km`}function fi(o){const r=Number(o);return!Number.isFinite(r)||r<0?null:r<=ui?{mode:"walk",minutes:Math.max(1,Math.round(r/ci))}:{mode:"drive",minutes:Math.max(1,Math.round(r/di))}}function pa(o,r={}){const u=fi(o);if(!u)return"";const a=String(r.walk||"min in Gehweite"),b=String(r.drive||"min me makine");return`${u.minutes} ${u.mode==="walk"?a:b}`}const ka=200;function we(o=""){return o==null?"":String(o).trim()}function fa(o){return Array.isArray(o)?Array.from(new Set(o.map(r=>we(r)).filter(Boolean))).slice(0,ka):[]}function Sa(o={}){const r=o&&typeof o=="object"?o:{},u=r.placePatches&&typeof r.placePatches=="object"?r.placePatches:{},a={};return Object.entries(u).slice(0,ka).forEach(([b,f])=>{const E=we(b);if(!E||!f||typeof f!="object")return;const _={};we(f.name)&&(_.name=we(f.name)),we(f.description)&&(_.description=we(f.description).slice(0,600)),we(f.coverImageUrl)&&(_.coverImageUrl=we(f.coverImageUrl)),Object.keys(_).length&&(a[E]=_)}),{hidden:fa(r.hidden),pinned:fa(r.pinned),placePatches:a}}function an({places:o=[],overrides:r={},hotelCoords:u=null,includeHidden:a=!1}={}){const b=Sa(r),f=new Set(b.hidden),E=new Map(b.pinned.map((P,S)=>[P,S])),_=St(u)?u:null;return(Array.isArray(o)?o:[]).map((P,S)=>oi(P,{index:S})).filter(P=>P.name&&P.active).map(P=>{const S=b.placePatches[P.id]||{},B=_&&St(P)?pi(_.lat,_.lng,P.lat,P.lng):null;return{...P,...S,hidden:f.has(P.id),pinned:E.has(P.id)||P.pinned,pinnedRank:E.has(P.id)?E.get(P.id):null,distanceMeters:B}}).filter(P=>a||!P.hidden).sort((P,S)=>{const B=P.pinnedRank!=null,Q=S.pinnedRank!=null;if(B!==Q)return B?-1:1;if(B&&Q&&P.pinnedRank!==S.pinnedRank)return P.pinnedRank-S.pinnedRank;if(P.pinned!==S.pinned)return P.pinned?-1:1;if(P.priority!==S.priority)return S.priority-P.priority;const le=Number.isFinite(P.distanceMeters)?P.distanceMeters:1/0,ce=Number.isFinite(S.distanceMeters)?S.distanceMeters:1/0;return le!==ce?le-ce:String(P.name).localeCompare(String(S.name))})}function mi(o=[]){const r=Array.isArray(o)?o:[];return dn.map(u=>({...u,places:r.filter(a=>a.category===u.key)})).filter(u=>u.places.length)}const sn="mnyraHotelDestinationSections",ma="mnyraHotelDetailStyles",gi="/apps/menyra-social/styles/hotel-detail.css?v=2026-07-11-hotel-detail-v10",ga=Object.freeze({walk:"min në këmbë",drive:"min me makinë"}),je=Object.freeze({rooms:"Qëndrimi yt",offers:"Oferta për ty",city:"Përreth teje",beach:"Deti afër",sights:"Vlen të shihet",activities:"Përjeto zonën",nature:"Natyrë e gjallë",food:"Shijo lokal",nearby:"Afër teje",amenities:"Pa pagesë shtesë",map:"Zbulo zonën",rating:"Nga vizitorët"}),rn=Object.freeze({city:"Qyteti",beach:"Plazha",sights:"Vende për të parë",activities:"Aktivitete",nature:"Natyra",food:"Restorante & Kafene",nearby:"Vende të rëndësishme"}),on=Object.freeze({bed:'<path d="M2 20v-8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v8M4 10V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4M12 4v6M2 18h20"/>',building:'<path d="M10 12h4M10 8h4M14 21v-3a2 2 0 0 0-4 0v3M6 10H4a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16"/>',waves:'<path d="M2 5q2.5 2 5 0t5 0 5 0 5 0M2 12q2.5 2 5 0t5 0 5 0 5 0M2 19q2.5 2 5 0t5 0 5 0 5 0"/>',compass:'<circle cx="12" cy="12" r="10"/><path d="m16.24 7.76-2.12 6.36-6.36 2.12 2.12-6.36z"/>',sparkles:'<path d="m12 3-1.2 3.1L8 7.5l2.8 1.4L12 12l1.2-3.1L16 7.5l-2.8-1.4zM5 14l-.8 2.2L2 17l2.2.8L5 20l.8-2.2L8 17l-2.2-.8zM18 13l-1 2.7-3 1.3 3 1.3 1 2.7 1-2.7 3-1.3-3-1.3z"/>',tree:'<path d="m17 14 3 3h-5l3 3H6l3-3H4l3-3H3l5-5H5l7-7 7 7h-3l5 5zM12 20v2"/>',coffee:'<path d="M10 2v2M14 2v2M6 2v2M18 8h1a3 3 0 0 1 0 6h-1M4 8h14v9a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3z"/>',pin:'<path d="M20 10c0 5-8 12-8 12S4 15 4 10a8 8 0 1 1 16 0"/><circle cx="12" cy="10" r="3"/>',nav:'<path d="m3 11 19-9-9 19-2-8z"/>',clock:'<circle cx="12" cy="12" r="10"/><path d="M12 6v6h4"/>',star:'<path d="m12 2 3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z"/>',expand:'<path d="M8 3H3v5M16 3h5v5M8 21H3v-5M16 21h5v-5M3 3l6 6M21 3l-6 6M3 21l6-6M21 21l-6-6"/>',arrowRight:'<path d="M5 12h14M13 6l6 6-6 6"/>',check:'<path d="m20 6-11 11-5-5"/>',wifi:'<path d="M5 12.55a11 11 0 0 1 14 0M1.42 9a16 16 0 0 1 21.16 0M8.53 16.11a6 6 0 0 1 6.95 0M12 20h.01"/>',car:'<path d="m5 17-2-1v-4l2-5h14l2 5v4l-2 1M5 17v2M19 17v2M3 13h18M7 13h.01M17 13h.01"/>',snow:'<path d="M12 2v20M4.93 4.93l14.14 14.14M2 12h20M4.93 19.07 19.07 4.93M8 5l4 2 4-2M8 19l4-2 4 2"/>',shield:'<path d="M20 13c0 5-3.5 7.5-8 9-4.5-1.5-8-4-8-9V5l8-3 8 3z"/><path d="m9 12 2 2 4-4"/>',umbrella:'<path d="M2 12h20M12 12v8a2 2 0 0 0 4 0M2 12a10 10 0 0 1 20 0M12 2v1"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M16 3.2a4 4 0 0 1 0 7.6M22 21v-2a4 4 0 0 0-3-3.9"/><circle cx="9" cy="7" r="4"/>',size:'<path d="M15 3h6v6M21 3l-7 7M3 21l7-7M9 21H3v-6"/>'}),bi=Object.freeze({city:"building",beach:"waves",sights:"compass",activities:"sparkles",nature:"tree",food:"coffee",nearby:"pin"}),hi=Object.freeze([{keywords:["wifi","wi-fi","internet"],icon:"wifi"},{keywords:["parkim","parking","garazh"],icon:"car"},{keywords:["mengjes","mëngjes","breakfast","fruehstueck"],icon:"coffee"},{keywords:["klime","klimë","kondicioner","ac"],icon:"snow"},{keywords:["plazh","det","beach","pishine","pishinë","pool"],icon:"waves"},{keywords:["shezlong","ombrelle","umbrella"],icon:"umbrella"},{keywords:["recepsion","reception","siguri","security","24"],icon:"shield"},{keywords:["pastrim","cleaning","spa"],icon:"sparkles"},{keywords:["famil","person"],icon:"users"}]);function V(o=""){return o==null?"":String(o).trim()}function N(o=""){return V(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function re(o="pin",r=""){const u=on[o]||on.pin;return`<svg class="mhd-icon ${r}" viewBox="0 0 24 24" aria-hidden="true">${u}</svg>`}function ba(o=typeof document>"u"?null:document){if(!o||o.getElementById(ma))return;const r=o.createElement("link");r.id=ma,r.rel="stylesheet",r.href=gi,o.head.appendChild(r)}function Oe({iconName:o="pin",eyebrow:r="",title:u=""}={}){return`
  ...
  `}function vi(o=""){const r=V(o);if(!r)return null;const u=r.match(/(\d+(?:[.,]\d+)?)\s*(km|kilometer|m|meter)?/i);if(!u)return null;const a=Number(String(u[1]||"").replace(",","."));if(!Number.isFinite(a)||a<0)return null;const b=String(u[2]||"m").trim().toLowerCase();return Math.round(b.startsWith("k")?a*1e3:a)}function xi(o={}){const r=o.manualDistance&&typeof o.manualDistance=="object"?o.manualDistance:null;if(r){const b=V(r.label),f=V(r.timeLabel),E=b||ua(o.distanceMeters),_=vi(b),U=Number.isFinite(_)?_:o.distanceMeters,P=f||(r.direct!==!0&&Number.isFinite(U)?pa(U,ga):"");return!E&&!P?"":`
  ...
  `}function wi(o={},{nearestPlaceId:r="",imageUrlFn:u=null}={}){const a=dn.find(_=>_.key===o.category)?.label||"",b=o.id&&o.id===r?"Më afër hotelit":a,f=V(o.coverImageUrl),E=f&&typeof u=="function"&&V(u(f))||f;return`
  ...
  `}function $i(o={},r="€"){const u=V(o.priceLabel||o.priceText);if(u)return u;const a=Number(o.price??o.startingPrice??o.pricePerNight);if(!Number.isFinite(a)||a<=0)return"";const b=V(o.currency||o.currencyCode)||r;return b==="€"||b.toUpperCase()==="EUR"?`€${a}`:`${a} ${b}`}function ki(o=[]){const r=(Array.isArray(o)?o:[]).filter(u=>V(u?.label));return r.length?`
    <div class="mhd-distance">
      ${r.map(u=>`<span>${re(u.icon||"check","mhd-icon--sm")}${N(u.label)}</span>`).join("")}
    </div>
  `:""}function va(o=[]){return(Array.isArray(o)?o:[]).filter(r=>r&&r.active!==!1&&V(r.title))}function Si({rooms:o=[],offers:r=[],staySection:u="",imageUrlFn:a=null}={}){const b=va(o),f=va(r),_=Pr({preferred:u,roomsCount:b.length,offersCount:f.length})===ya,U=_?f:b.length?b:f,P=_||!b.length?"offer":"room";return U.length?`
    <section class="mhd-section">
      ${Oe({iconName:_?"sparkles":"bed",eyebrow:_?je.offers:je.rooms,title:_?"Oferta":"Dhoma"})}
      <div class="mhd-rail">
        ${U.map(S=>{const B=jr(S),Q=B[0]||"",le=Q&&typeof a=="function"&&V(a(Q))||Q,ce=$i(S),Ue=V(S.priceSuffix)||"/ natë";return`
            <article class="mhd-card">
              <div class="mhd-photo">
  ...
  `:""}function Ii({city:o="",address:r="",imageUrl:u="",imageUrlFn:a=null}={}){const b=V(o);if(!b)return"";const f=V(u),E=f&&typeof a=="function"&&V(a(f))||f;return`
    <section class="mhd-section">
  ...
  `}function Ci(o=""){const r=V(o).toLowerCase();for(const u of hi)if(u.keywords.some(a=>r.includes(a)))return u.icon;return"check"}function Pi({amenities:o=[]}={}){const r=(Array.isArray(o)?o:[]).map(u=>V(u)).filter(Boolean);return r.length?`
    <section class="mhd-section">
      ${Oe({iconName:"check",eyebrow:je.amenities,title:"Përfshihet"})}
      <div class="mhd-amenities">
        ${r.slice(0,12).map(u=>`
          <article class="mhd-amenity">
            <span class="mhd-amenity-icon">${re(Ci(u))}</span>
            <h3>${N(u)}</h3>
          </article>
        `).join("")}
      </div>
    </section>
  `:""}const ln="mnyraHotelDetailMap";function ji({address:o="",city:r="",destinationName:u="",mapsUrl:a="",hotelCoords:b=null,hotelName:f=""}={}){const E=[V(o),V(r)].filter(Boolean).join(", ")||V(u);if(!E&&!a)return"";const _=St(b),U=_?`id="${ln}" data-map-lat="${N(String(b.lat))}" data-map-lng="${N(String(b.lng))}" data-map-name="${N(V(f))}"`:"";return`
    <section class="mhd-section">
  ...
  `}function Ti({rooms:o=[],offers:r=[],staySection:u="",amenities:a=[],address:b="",city:f="",cityImageUrl:E="",destinationId:_="",destinationName:U="",destinationSectionsHtml:P="",mapsUrl:S="",hotelCoords:B=null,hotelName:Q="",rating:le="",reviewCount:ce="",ratingSummary:Ue="",imageUrlFn:$e=null}={}){const Xe=!!V(_),Ze=P||(Xe?$t():"");return`
    <div class="mhd">
      ${Si({rooms:o,offers:r,staySection:u,imageUrlFn:$e})}
      ${Pi({amenities:a})}
      <div id="${sn}" data-destination-id="${N(_)}" style="display:contents">
        ${Ze}
      </div>
      ${Xe?"":Ii({city:f,address:b,imageUrl:E,imageUrlFn:$e})}
      ${ji({address:b,city:f,destinationName:U,mapsUrl:S,hotelCoords:B,hotelName:Q})}
  ...
  `}function Li(o={},{imagePreviews:r=[]}={}){const u=ee(o.id),a=Array.isArray(o.images)?o.images.map(Pe).filter(Boolean):[],b=(Array.isArray(r)?r:[]).map(Pe),f=a.length+b.length,E=(_,U,P)=>`
...
`))}" />
  ...
  `}function Mi(o={},{imagePreviews:r=[]}={}){const u=ee(o.id);return`
  ...
  `}function Fi({restaurantId:o="",record:r={},editorState:u={},hasOffers:a=!1}={}){const b=Pe(o);if(!b)return"";const f=Pe(u.restaurantId)===b,E=f&&Array.isArray(u.rooms)?oa(u.rooms):oa(r?.hotelRooms),_=f&&u.imagePreviews&&typeof u.imagePreviews=="object"?u.imagePreviews:{},U=f&&u.saving===!0,P=f?Pe(u.status):"",S=f&&Pe(u.staySection)?u.staySection:r?.hotelStaySection;return`
    <div data-hotel-rooms-editor="${ee(b)}" class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
      ...
      ${E.length?`<div class="space-y-4">${E.map(B=>Mi(B,{imagePreviews:_[B.id]})).join("")}</div>`:'<p class="text-sm font-bold text-slate-400">Ende pa dhoma. Shto dhomën e parë me +.</p>'}
      ...
      ${n?`
        ...
        <div data-hotel-card-editor="${a(n)}" data-hotel-card-details-panel class="${j?"":"hidden "}bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
            ...
            <div class="grid grid-cols-1 gap-4">
              ...
              ${Cn({idPrefix:"hotelCardDistanceBeach",iconName:"waves",label:"Plazhi",value:k,directLabel:ds,direct:T,withTime:!0,timeMinutes:A})}
              <div>
...
`))}</textarea>
        ...
        ${Fi({restaurantId:n,record:t,editorState:r.hotelRoomsEditor&&typeof r.hotelRoomsEditor=="object"?r.hotelRoomsEditor:{},hasOffers:He(n,{includeInactive:!0}).items.length>0||Rt(t).length>0})}
  ...
  `}function Dn(e={},t={}){const n=t.mode==="self"?"self":"public",s=t.disabledBlockClass||"",l=Fs(e,n),i=n==="self"?"avatar:self":`avatar:public:${l}`,c=t.avatarUrl||b(e.avatar||"","avatar",{stableKey:i}),d=t.avatarFit||P(!!e.restaurantId),p=String(r?.profileCardInfoOpen||"")===l,g=Number(r?.profileCardInfoHeights?.[l]||0),m=p&&Number.isFinite(g)&&g>0?`height:${Math.ceil(g)}px;`:"",h=t.avatarImgKeyAttr||(n==="self"?'data-img-key="avatar:self"':`data-img-key="avatar:public:${a(l)}"`),v=t.renderAvatarImage===!0?!!String(c||"").trim()&&!X(c):t.renderAvatarImage!==!1&&!!String(c||"").trim()&&!X(c)&&!!String(e?.avatar||"").trim(),w=!!t.identityPending,C=t.followersLabel??S(e.followers),k=W(e?.name)||"User",A=W(t.typeLabel||e?.customerType||e?.type||"Business"),L=W(e?.location||"-"),y=n==="public"?`${L} / ${A}`:L,T=t.bioHtml||a(e?.bio||"").replace(/\n/g,"<br>")||a(x("profile.noBio","Nuk ka bio.")),j=`business-cover:${l}`,F=Ls(e,l),z=zs(e,{cacheKeys:F,stableKey:j,allowCacheFallback:t.allowTitleImageCacheFallback===!0}),I=Ds(e),D=Es(e),O=ct(D?{buttonAttrs:`data-marketplace-open-map="${a(D)}"`,label:x("profile.openMap","Karte oeffnen"),iconName:"map"}:{href:I,label:x("profile.openMap","Karte oeffnen"),iconName:"map"}),K=Nn(e?.instagramUrl||e?.instagram||e?.insta||"","instagram"),$=Nn(e?.tiktokUrl||e?.tiktok||e?.tikTok||"","tiktok"),R=W(e?.phone||e?.telephone||e?.contactPhone||""),H=Ns(R),q=W(e?.address||e?.locationLabel||[e?.place||e?.locationPlace,e?.location||e?.city].map(ne=>W(ne)).filter(Boolean).join(", ")),G=[dt({href:K,iconName:"instagram",eyebrow:"Instagram",value:e?.instagram||e?.instagramUrl||e?.insta||""}),dt({href:$,iconName:"music-2",eyebrow:"TikTok",value:e?.tiktok||e?.tiktokUrl||e?.tikTok||""})].filter(Boolean).join(""),J=n==="self"?`
    ...
    `;if(p){const ne=[dt({href:H,iconName:"phone",eyebrow:x("profile.call","Anrufen"),value:R}),dt({href:I,iconName:"map-pin",eyebrow:x("profile.address","Adresse"),value:q||L}),G].filter(Boolean).join("");return`
      <div data-landing-tutorial-target="identity" data-business-profile-card="${a(l)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${s}" style="${m}min-height: var(--business-profile-card-min-height, 440px);display:grid;grid-template-columns:minmax(0,1fr);width:100%;max-width:100%;min-width:0;box-sizing:border-box;">
        ${Os({profileName:k,safeBio:T,metaLine:y,identityPending:w,followersLabel:C})}
  ...
  `}function Ws(){const e=Ma().id;return`
    <div class="mb-5 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      <div class="flex flex-wrap gap-3">
        ${_a.map(t=>{const n=t.id===e,s=t.id==="white"?"text-slate-700":"text-white";return`
  ...
  `}function Jn(e,{mode:t="profile",priorityIndex:n=-1}={}){const s=Be(e),l=t==="profile"?`data-menu-open="${a(e.id)}" role="button"`:"",i=Qs(e),d=(i.length?i:[de(e)||""]).filter(Boolean),p=d.length?d.slice(0,12):[""],g=p.length>1,{itemId:m,counts:h,isLiked:v}=Kn(e),w=S(Math.max(0,Number(h.likes)||0)),C=S(Math.max(0,Number(h.comments)||0));return`
  ...
  `}function ta(e={}){if(!e?.restaurantId)return!1;const t=String(jt(e)||"").trim().toLowerCase();return["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"].includes(t)||t==="ecommerce"||se(e)?!1:ke(e)||["restaurant","cafe","coffee","fastfood","food"].includes(t)||!t}function sr(e={}){if(e.active===!1)return{label:"Inaktiv",className:"text-slate-400"};const t=String(e.status||e.approvalStatus||"pending").trim().toLowerCase();return t==="approved"?{label:"Miratuar",className:"text-emerald-600"}:t==="rejected"?{label:"Refuzuar",className:"text-rose-600"}:{label:"Ne pritje te Heart",className:"text-amber-600"}}function rr(e,t){if(!t||!ta(e))return"";const{items:n,loading:s}=za(t,{includeInactive:!0}),l=S(n.length);return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(i=>{const c=b(i.imageUrl||"","thumb"),d=X(c)?Y:c,p=sr(i),g=i.category||"RESTAURANT",m=i.priceSegment||"€€ - €€€";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function Wt(e){if(Array.isArray(e))return e.map(n=>String(n||"").trim()).filter(Boolean);const t=String(e||"").trim();return t?t.split(/[\n,;|]/).map(n=>n.trim()).filter(Boolean):[]}function ir(e={}){const t=String(e?.restaurantId||"").trim(),n=t?ue(t):null;return{...n&&typeof n=="object"?n:{},...e&&typeof e=="object"?e:{},...t?{restaurantId:t}:{}}}function Qt(e={}){return e.shoppingLandingCard&&typeof e.shoppingLandingCard=="object"?e.shoppingLandingCard:{}}function or(e={}){const t=Qt(e);return[...Wt(t.productIds),...Wt(e.shoppingLandingCardProductIds),...Wt(e.shoppingLandingProductIds)].filter(Boolean)}function Jt(e={}){return!e||typeof e!="object"?{}:Object.entries(e).reduce((t,[n,s])=>{const l=String(n||"").trim(),i=String(s||"").trim();return l&&i&&(t[l]=i),t},{})}function lr(e={}){const t=Qt(e);return{...Jt(e.shoppingLandingProductImageOverrides),...Jt(t.productImageOverrides)}}function cr(e=""){const t=String(e||"").trim(),n=r.shoppingLandingCardEditor&&typeof r.shoppingLandingCardEditor=="object"?r.shoppingLandingCardEditor:{},s=String(n.restaurantId||"").trim();return s&&s!==t?{}:n}function dr(e){return e?typeof e=="string"?e.trim():typeof e!="object"?String(e||"").trim():String(e.url||e.src||e.cdnUrl||e.imageUrl||e.image||e.photoUrl||e.thumbnail||"").trim():""}function ur(e={}){const n=[de(e),...Array.isArray(e.imageUrls)?e.imageUrls:[],...Array.isArray(e.images)?e.images:[],e.imageUrl,e.image,e.photoUrl,e.coverUrl,e.img,e.thumbnail].map(dr).filter(Boolean);return n.filter((s,l)=>n.indexOf(s)===l)}function pr(e={},t={},n={}){const s=String(e?.id||e?.productId||e?.menuItemId||"").trim();if(!s)return null;const l=ur(e).map(m=>({rawUrl:m,imageUrl:b(m,"thumb")})).filter(m=>m.rawUrl&&!X(m.imageUrl)),i=l[0]?.rawUrl||"",c=String(t?.[s]||"").trim(),d=String(n?.[s]||"").trim(),p=d||c||i,g=p?b(p,"thumb"):"";return{id:s,name:String(e.name||e.title||"Produkt").trim(),price:Be(e),imageUrl:g&&!X(g)?g:"",defaultImageRaw:i,cardImageUrl:c,previewImageUrl:d,imageCandidates:l,objectPosition:te(e)}}function fr(e={},t="",n=[]){if(!t||!se(e))return"";const s=ir(e),l=Qt(s),i=cr(t),c=i.saving===!0,d=String(i.status||"").trim(),p=/fehl|error|nicht|nuk|kein/i.test(d),g=String(l.imageUrl||s.shoppingLandingCardImageUrl||s.shoppingLandingImageUrl||"").trim(),m=String(s.logoUrl||s.logo||s.logoURL||s.avatar||e.avatar||"").trim(),h=String(i.imageUrlDraft??g).trim(),v=String(i.imagePreview||h||m||"").trim(),w=v?b(v,"large"):Y,C=String(i.titleDraft??(l.title||s.shoppingLandingCardTitle||e.name||"")).trim(),k=i.active!==void 0?i.active!==!1:l.active!==!1&&s.shoppingLandingCardEnabled!==!1,A=or(s),L=Array.isArray(i.productIds)?i.productIds.map(I=>String(I||"").trim()).filter(Boolean):null,y=new Set(L||A),T={...lr(s),...Jt(i.productImageOverrides)},j=i.productImagePreviews&&typeof i.productImagePreviews=="object"?i.productImagePreviews:{},F=(Array.isArray(n)?n:[]).filter(I=>I&&String(I.id||"").trim()&&I.hidden!==!0&&I.available!==!1).map(I=>pr(I,T,j)).filter(Boolean),z=y.size?`${S(y.size)} ausgewaehlt`:"Pa zgjedhje = te gjitha produktet";return`
  ...
  `}function mr(e){if(!Kt(e)||!yn(e))return"";const n=pt((r.menu.items||[]).filter(s=>xe(s)==="testfirst_special"));return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(s=>{const l=b(de(s),"thumb"),i=X(l)?Y:l,c=Bn(s),d=c.type==="link"?"Link":c.type==="product"?"Produkt-Modal":"Kjo karte",p=Ht(s)==="food"?"Food-Size":"Normal",g=qa(Ge(s));return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function na(e,{restaurantId:t="",suppressLoading:n=!1,allowAutoEnsure:s=!0,requirePublicMenuTruth:l=!0}={}){const i=String(t||e?.canonicalRestaurantId||e?.restaurantId||"").trim();if(!i||!ke(e))return"";const c=Qe(r,{profile:e,routePayload:r?.profileView?.routePayload,webDirectEntry:r?.__webDirectEntry,restaurantId:i});if(l&&c.menu.status!=="ready")return"";const d=!l||c.focus.canRenderFocus;if(s&&!r.focus.loading&&!d&&$e(wn(e,i)),l&&!d)return"";const{items:p,loading:g}=d?{items:Array.isArray(c.focus.items)?c.focus.items:[],loading:c.focus.loading}:He(i);if(!(d?!0:He(i).enabled)||!p.length&&!g||n&&g&&!p.length)return"";if(g&&!p.length)return`
    ...
    `;const h=Na(p),v=p[h]||p[0],{safeImg:w,fallbackImg:C,imageAttrs:k,lazyAttrs:A}=ve(v.imageUrl||"",{mode:"profile",priorityIndex:0,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:v?.id?`focus-carousel:${i}:${String(v.id)}`:""}),L=v.text||"";return`
  ...
  `}function hr(){const e=r.userProfile,t=e.restaurantId||"",n=String(r.user?.uid||"").trim(),s=String(r.__authBootstrapInFlightUid||"").trim(),l=!t&&!!n&&(!!r.__authProfileLoadPromise||s===n),i=Ve(e),c=ke(e),d=r.profileView?.profile?.restaurantId?r.profileView.profile:null,p=_()&&!!d?.restaurantId&&ke(d),g=se(e),m=Ka(ja(e)),h=t?ue(t):null,v=h?.name||h?.restaurantName||e.name||"Business",w=t&&r.menu.restaurantId===t,C=String(r.menu.source||"").trim().toLowerCase(),k=!!w&&C==="collection",A=!!w&&C==="collection"&&r.menu.loading,L=!!t&&(A||!k),y=g?"all":r.menu.filter,T=k?On(r.menu.items,{filter:y,query:r.menu.query}):[],F=yn(e)?T:T.filter(D=>!Xa(D)),z=pt(F),I=S(z.length);if(t&&i){ns(e);const D=String(r.focus?.truthSource||"").trim().toLowerCase();return!r.focus.loading&&(r.focus.restaurantId!==t||D!=="public-menu")&&$e(e),Cs(e)}return t&&c&&!k&&!A&&Ue(e),t&&c&&!r.focus.loading&&r.focus.restaurantId!==t&&$e(e),t&&ta(e)&&Xe(e),c?`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      <div class="flex items-end justify-between mb-6">
        <div>
  ...
  `:p?mt(d):`
    ...
    `;const d=wn(e,c),p=se(d),g=ke(d)&&!p;g&&(i=Qe(r,{profile:d,routePayload:s,webDirectEntry:l,restaurantId:c}));const m=String(l?.canonicalRestaurantId||l?.restaurantId||"").trim(),h=new Set(i.targetIds),v=i.menu.status==="ready",w=i.focus.canRenderFocus,C=v&&g,k=i.focus.matches===!0&&i.focus.loading===!0,L=String(r?.profileView?.menuAccessSource||l?.menuAccessSource||s?.menuAccessSource||"").trim().toLowerCase()==="qr",y=l?.active===!0&&l?.webPriority===!0&&l?.menuFirst===!0&&String(r?.activeTab||"").trim().toLowerCase()==="profile"&&String(r?.profileTopTab||"").trim().toLowerCase()==="menu"&&(m===c||h.has(c)),T=y&&!L,j=["ready","empty","error"].includes(i.menu.status),F=y&&j,z=y&&(!C||i.menu.status!=="ready"),I=!C||i.focus.settled===!0||i.focus.confirmedEmpty===!0||i.menu.status!=="ready";n&&!F&&!j&&ce(d),n&&!z&&!I&&!k&&v&&(!T||j)&&$e(d);const O=i.menu.canRenderItems?pt(On(i.menu.items,{filter:"all",query:""})).filter(oe=>!Ut(oe)):[],K=i.menu.error||"",$=kr(i.menu,O),{hasItems:R,hasError:H,isLoading:q,shouldRenderNoProducts:G}=$;Ha({profile:d,routePayload:s,surface:i,decision:$});const J={profile:d,routePayload:s,surface:i,decision:$,rawItems:i.menu.items,items:O,filteredItems:O,source:"public-menu"},ne=Va(i,O),ae=O.filter(oe=>Ge(oe)==="drink"),Se=O.filter(oe=>Ge(oe)!=="drink"),Xt=0,pe=ae.length,Ie=Kt(e),gt=Ie||p,bt=new Set;R&&c&&(Aa(O,c),Qa(O,c));const ht=c&&w?(Array.isArray(i.focus.items)?i.focus.items:[]).map(oe=>qt({...oe,objectPosition:Te(oe)})).filter(Boolean):[],vt=i.focus.status==="empty"||i.focus.status==="error",Ye=g&&!w&&!vt&&i.menu.status!=="empty"&&i.menu.status!=="error",We=ht.length?Wn(d,ht,{mode:t}):Ye?Xs({...J,reason:"focus-truth-pending"}):"",fe=gt?We:na(d,{restaurantId:c,suppressLoading:!0,allowAutoEnsure:v&&(!T||j),requirePublicMenuTruth:!0})||(Ye?Js({...J,reason:"focus-truth-pending"}):"");return Ie?`
      <div class="app-main-content-safe"${ne}>
        ${q?`
          ${We}
          ${qn({...J,reason:"menu-loading"})}
        `:`
          ${R?ar(d,O,{mode:t,publicMenuSurfaceState:i,focusFallbackHtml:We}):H?`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${a(x("menu.loadError","Menuja nuk mund te ngarkohej"))}</div>`:G?(at({...J,functionName:"renderProfileMenuView",renderDecision:"testfirst-no-products"}),`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300"${ie({source:"public-menu:no-products"})}>${a(x("menu.noProducts","Nuk ka produkte"))}</div>`):qn({...J,reason:"menu-not-confirmed-empty"})}
  ...
  `}return{renderProfilePostCardFancy:$n,renderProfilePostsFancy:Lt,renderProfileCheckins:Mt,renderProfileTabs:Dt,renderProfileViewControls:Ot,renderPublicProfileView:Us,renderMenuFilterRow:Vn,renderMenuLayoutSection:Ws,renderMenuItemCard:Bt,renderMenuItemCardStacked:Vt,renderMenuDrinkGrid:Xn,renderMenuFoodList:Zn,renderMenuList:ea,renderFocusAdminSection:Yt,renderFocusCarousel:na,renderMenuQrCard:aa,renderMenuAdminView:hr,renderProfileMenuView:mt,renderProfileView:vr}}export{no as createProfileMenuFocusRenderController};
