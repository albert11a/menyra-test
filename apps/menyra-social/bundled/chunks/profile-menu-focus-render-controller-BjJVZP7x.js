import{e as de,f as vs,t as ws,g as ys,h as Te,a as $s}from"../entry/social-app.js";import"./startup-route-runtime-context-6Co7bthZ.js";import"./vendor-firebase-V03pMX6J.js";function Cs(b={}){const d=b.state,Vt=b.resolvePostCountsFn,s=b.escapeHtmlFn,B=b.getOptimizedImageUrlFn,f=b.iconFn,Kt=b.isLocalBusinessProfileFn,qt=typeof b.isCeoUserFn=="function"?b.isCeoUserFn:(()=>!1),Je=b.normalizeHandleFn,Le=b.logoFitClassFn,E=b.formatCountFn,Xe=b.renderProfileShopCartViewFn,et=b.renderProfileShopFavoritesViewFn,Gt=typeof b.ensurePostsDataForProfileFn=="function"?b.ensurePostsDataForProfileFn:(()=>{}),Qt=b.ensureMenuDataForProfileFn,Wt=typeof b.ensureEditorMenuDataForProfileFn=="function"?b.ensureEditorMenuDataForProfileFn:(()=>{}),ue=b.ensureFocusDataForProfileFn,Yt=typeof b.ensureAdsDataForProfileFn=="function"?b.ensureAdsDataForProfileFn:(()=>{}),tt=b.ensureTableQrStateForProfileFn,ee=b.isShopCatalogProfileFn,at=b.getBusinessCatalogLabelFn,ae=b.normalizeMenuTypeFn,Zt=b.primeMenuItemCountsFn,Jt=typeof b.hydrateMenuCardViewerLikesFn=="function"?b.hydrateMenuCardViewerLikesFn:(()=>Promise.resolve()),Xt=b.renderShopProductListFn,ea=b.getMenuLayoutThemeFn,ta=b.menuLayoutColors,G=b.resolveMenuItemHeroFn,O=b.isPlaceholderUrlFn,U=b.placeholderImage,aa=b.getFirebaseStorageUrlFn,sa=b.isDirectImageUrlFn,st=b.formatPriceFn,na=typeof b.resolveCurrencyCodeForMenuItemFn=="function"?b.resolveCurrencyCodeForMenuItemFn:(()=>""),nt=b.getMenuItemImagesFn,V=b.getMenuItemObjectPositionFn,pe=b.getMenuItemSocialIdFn,rt=b.menuItemMetaKeyFn,it=b.ensureMenuItemMetaFn,ot=b.resolveMenuItemCountsFn,fe=b.getFocusStateForRestaurantFn,ra=typeof b.getAdsStateForRestaurantFn=="function"?b.getAdsStateForRestaurantFn:(()=>({items:[],enabled:!0,loading:!1,same:!1})),ge=b.getTableQrStateForRestaurantFn,ie=b.getFocusItemObjectPositionFn,lt=b.getFocusCardClassFn,ia=b.getFocusIndexFn,se=b.isRestaurantCafeProfileFn,me=typeof b.getBusinessProfileTypeFn=="function"?b.getBusinessProfileTypeFn:(()=>""),be=b.getRestaurantMetaByIdFn,oa=b.buildUrlFn,la=b.normalizeSearchKeyFn,ca=b.normalizeFollowHandleFn,ct=new Map,xe=(e="",t={},a=null)=>{if(typeof a!="function")return;const n=[String(e||"").trim().toLowerCase(),String(t?.canonicalRestaurantId||t?.restaurantId||t?.uid||t?.handle||"").trim()].filter(Boolean).join(":");if(!n)return;const r=Date.now(),i=Number(ct.get(n)||0)||0;if(r-i<500)return;ct.set(n,r);const o=()=>{try{a(t)}catch{}};typeof queueMicrotask=="function"?queueMicrotask(o):setTimeout(o,0)},Q={key:"",inFlightKey:""},u=(e,t=e,a={})=>ws(e,{fallback:t,params:a}),dt=(e="")=>{const t=String(e||"").trim();if(!t)return u("nav.menu","Menue");const a=t.toLowerCase();return a==="menue"||a==="menu"||a==="menü"?u("nav.menu",t):a==="shop"?"Shop":t},da=(e="food")=>String(e||"").trim().toLowerCase()==="drink"?u("menu.drinks","Getraenke"):u("menu.food","Speisen"),ut=(e={},t=!1)=>{const a=ae(e?.type||"food");return t?a==="drink"?u("menu.variant","Variante"):u("menu.product","Produkt"):a==="drink"?u("menu.drinkItem","Getraenk"):u("menu.foodItem","Speise")},_e=(e="",t="#111827")=>{const a=String(e||"").trim();return/^#[0-9a-fA-F]{6}$/.test(a)?a:t};function ua(e=null,t=null){return de(d,{profile:e,routePayload:t,webDirectEntry:d?.__webDirectEntry}).restaurantId}function pt(e=null,t=""){if(!e||typeof e!="object")return e;const a=String(t||"").trim();if(!a)return e;const n=String(e.canonicalRestaurantId||"").trim();return String(e.restaurantId||"").trim()===a&&n?e:{...e,restaurantId:a,...n?{canonicalRestaurantId:n}:{}}}function pa(e=""){const t=String(e||"").trim();return t?de(d,{profile:d?.profileView?.profile||d?.userProfile,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:t}).focus.canRenderFocus:!1}function he(e={}){const t=String(na(e)||"").trim();return t?st(e?.price,t):st(e?.price)}function fa(e=[],t="",a=""){const n=String(t||"").trim(),r=String(a||"").trim();if(!n||!r)return"";const i=Array.isArray(e)?e:[];if(!i.length)return`${n}|${r}|empty`;const o=[];return i.forEach(l=>{const c=String(pe(l)||l?.id||"").trim();c&&o.push(c)}),o.length?(o.sort(),`${n}|${r}|${o.join(",")}`):`${n}|${r}|empty`}function ga(e=[],t=""){const a=String(d.user?.uid||"").trim(),n=fa(e,t,a);n&&Q.inFlightKey!==n&&Q.key!==n&&(Q.key=n,Q.inFlightKey=n,Jt(e,t).catch(r=>{console.error(r),Q.key===n&&(Q.key="")}).finally(()=>{Q.inFlightKey===n&&(Q.inFlightKey="")}))}function ma(e={}){const t=String(e?.uid||"").trim();if(t&&d.followingTargetIds.includes(t))return!0;const a=String(e?.restaurantId||"").trim();if(a&&d.followingTargetIds.includes(a))return!0;const n=ca(e?.handle||"");return!!(n&&d.followingHandles.includes(n))}function ft(e={}){if(e?.specialEnabled===!0)return!0;if(e?.specialEnabled===!1)return!1;const t=String(e?.restaurantId||"").trim();if(!t)return!1;const a=typeof be=="function"&&be(t)||null;return a?.specialEnabled===!0?!0:(a?.specialEnabled===!1,!1)}function ba(e={}){return Z(e)==="testfirst_special"?!0:String(e?.category||"").trim().toLowerCase()==="special"}function gt(e,t,a=!0,{includeImageKey:n=!0}={}){const r=Vt(e),i=e.id?String(e.id):"",o=i?`data-open-post="${s(i)}"`:"",l=i?`data-post-like-count="${s(i)}"`:"",c=i?`data-post-comment-count="${s(i)}"`:"",p=n&&i?`data-img-key="profile-post:${s(i)}"`:"",g=e.type==="wide"||e.type==="hero",m=t&&g?"col-span-2":"",v=t&&g?"aspect-[1.8/1]":"aspect-[4/5]",h=B(e.url,g?"large":"medium",{stableKey:i?`profile-post:${i}`:"",variantGroup:"post-detail"}),$=g?800:400,I=g?400:500;return`
  ...
  `}function ze(e,t,a=!0,{includeImageKeys:n=!0}={}){const r=t==="grid";if(!e.length)return`
    ...
    `;const i=e.map(l=>gt(l,r,a,{includeImageKey:n})),o=e.reduce((l,c)=>{const p=c?.type==="wide"||c?.type==="hero";return l+(p?2:1)},0);return r&&o%2===1&&i.unshift(`
  ...
  `:`
    ...
    `}function ve(e={}){return String(e?.canonicalRestaurantId||e?.restaurantId||"").trim()?!0:String(e?.role||"").trim().toLowerCase()==="business"}function we(e={}){const t=String(me(e)||"").trim().toLowerCase();return t==="hotel"||t==="motel"}function Ee(e={}){const t=String(e?.canonicalRestaurantId||e?.restaurantId||"").trim(),a=t?be(t):null;return{...a&&typeof a=="object"?a:{},...e&&typeof e=="object"?e:{}}}function xa(e={},t=""){const a=e&&typeof e=="object"?e:{},n=String(a.id||a._id||a.offerId||a.menuItemId||t||"offer").trim();return{...a,id:n,menuItemId:String(a.menuItemId||a.targetMenuItemId||a.itemId||a.targetItemId||"").trim(),title:a.title||a.name||"Oferta",text:a.text||a.desc||a.description||"",imageUrl:a.imageUrl||a.image||a.photoUrl||"",active:a.active!==!1}}function ha(e={}){const t=[...Array.isArray(e.publicOffers)?e.publicOffers:[],...Array.isArray(e.travelOffers)?e.travelOffers:[],...Array.isArray(e.offerItems)?e.offerItems:[]],a=new Set;return t.map((n,r)=>xa(n,`offer_${r}`)).filter(n=>{const r=String(n.id||`${n.title}|${n.text}|${n.imageUrl}`).trim();return!r||a.has(r)?!1:(a.add(r),!0)})}function va(e={}){const t=Ee(e),a=String(e?.restaurantId||e?.canonicalRestaurantId||t.restaurantId||t.canonicalRestaurantId||t.id||"").trim();if(!a)return!1;const n=d.focus&&typeof d.focus=="object"?d.focus:{},r=String(n.restaurantId||"").trim()===a,i=String(n.truthSource||"").trim().toLowerCase();if(r&&i==="public-menu"||(r&&Array.isArray(n.items)?n.items:[]).length)return!1;const l=ha(t);return l.length>0||Array.isArray(t.publicOffers)||Array.isArray(t.travelOffers)||Array.isArray(t.offerItems)||Number.isFinite(Number(t.publicOffersCount))||Number.isFinite(Number(t.travelOffersCount))||typeof t.hasTravelOffers=="boolean"||String(t.offersTruthState||"").trim()?(d.focus={...n,restaurantId:a,items:l,enabled:n.enabled!==!1,loading:!1,error:"",index:0,truthSource:"restaurant-cache",truthState:l.length?"seeded":"knownEmpty"},!0):!1}function wa(e={}){const t=[e?.verifiedMapLocation,e?.mapLocation,e?.geo,e?.coordinates,e?.coords,e?.locationCoords,e];for(const a of t){if(!a||typeof a!="object")continue;const n=Number(a.lat??a.latitude),r=Number(a.lng??a.lon??a.longitude);if(Number.isFinite(n)&&Number.isFinite(r))return{lat:n,lng:r}}return null}function H(e={},t=[]){for(const a of t){const n=String(e?.[a]||"").trim();if(n)return n}return""}function ye(e){if(Array.isArray(e))return e.map(a=>String(a||"").trim()).filter(Boolean);const t=String(e||"").trim();return t?t.split(/[\n,;|]/).map(a=>a.trim()).filter(Boolean):[]}function ya(e={}){const t=[...ye(e.coverImages),...ye(e.hotelCoverImages),...ye(e.titleImages),e.titleImageUrl,e.coverImageUrl,e.coverUrl,e.heroUrl,e.imageUrl].map(n=>String(n||"").trim()).filter(Boolean),a=[];return t.forEach(n=>{a.includes(n)||a.push(n)}),a.slice(0,8)}function $a(e={}){return!e||typeof e!="object"?!1:Array.isArray(e.existingImages)||Array.isArray(e.imagePreviews)||Array.isArray(e.imageFiles)||!!String(e.imageUrlDraft||"").trim()||e.saving===!0||e.detailsOpen===!0||!!String(e.status||"").trim()}function ka(e=""){const t=String(e||"").trim(),a=d.hotelCardEditor&&typeof d.hotelCardEditor=="object"?d.hotelCardEditor:{},n=String(a.restaurantId||"").trim();return n?n===t?a:{}:$a(a)?{}:a}function Ia(e={}){const t=Array.isArray(e.features)?e.features.map(n=>String(n||"").trim()).filter(Boolean):[],a=e.restaurantFeatures&&typeof e.restaurantFeatures=="object"?e.restaurantFeatures:{};return[H(e,["hotelFeatureOneText","gardenTerraceText"])||String(a.gardenTerrace||"").trim()||t[0]||"",H(e,["hotelFeatureTwoText","accessibilityText"])||String(a.accessibility||"").trim()||t[1]||"",H(e,["hotelFeatureThreeText","veganOptionsText"])||String(a.veganOptions||"").trim()||t[2]||""]}function Sa(e={}){const t=[],a=(n="")=>{const r=String(n||"").trim();r&&!t.includes(r)&&t.push(r)};return[e.amenities,e.features,e.included,e.facilities,e.hotelAmenities].forEach(n=>{Array.isArray(n)&&n.forEach(r=>{typeof r=="string"?a(r):r&&typeof r=="object"&&a(r.label||r.name||r.title)})}),(e.beachfront||e.onBeach||e.amStrand)&&a("Në plazh"),(e.restaurant||e.hasRestaurant)&&a("Restaurant"),(e.breakfast||e.breakfastIncluded)&&a("Mëngjes"),(e.pool||e.hasPool)&&a("Pool"),(e.wifi||e.freeWifi||e.hasWifi)&&a("WLAN"),(e.parking||e.freeParking||e.hasParking)&&a("Parking"),(e.spa||e.wellness)&&a("Wellness"),t.slice(0,8)}const Ca=[{value:"m",label:"m"},{value:"km",label:"km"}],Pa="Në qendër",mt="Në plazh",Fa=["Mëngjes","Gjysmë pension","Pension i plotë","All inclusive","Restorant","Pa ushqim"],ja=["Shezlongë falas","Shezlongë me pagesë","Plazh privat","Pa shezlongë"],Aa=["Parking falas","Parking privat","Parking me pagesë","Pa parking"];function W(e=""){return String(e||"").trim().toLowerCase().replace(/[ëèéê]/g,"e").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}function Ta(e="",{direct:t=!1}={}){const a=String(e||"").trim(),n=W(a),r=t||n==="ne_qender"||n==="ne_plazh"||n==="direkt_ne_qender"||n==="direkt_ne_plazh"||n.includes("direkt")&&(n.includes("strand")||n.includes("zentrum")||n.includes("center"))||n.includes("am_strand")||n.includes("im_zentrum"),i=a.match(/(\d+(?:[.,]\d+)?)\s*(km|kilometer|m|meter)?/i),o=i?i[1].replace(",","."):"",c=(i?String(i[2]||"").trim().toLowerCase():"").startsWith("k")?"km":"m";return{amount:o,unit:c,isDirect:r}}function bt({idPrefix:e="",iconName:t="navigation",label:a="",value:n="",directLabel:r="",direct:i=!1}={}){const o=Ta(n,{direct:i});return`
    <div class="rounded-[1.7rem] border border-slate-100 bg-slate-50 p-4 space-y-3">
      ...
      <div class="grid grid-cols-[1fr_92px] gap-2">
        ...
        <select id="${s(e)}Unit" class="w-full px-3 py-3 bg-white rounded-2xl text-sm font-black border border-slate-100 outline-none focus:ring-2 focus:ring-indigo-100">
          ${Ca.map(l=>`<option value="${s(l.value)}" ${o.unit===l.value?"selected":""}>${s(l.label)}</option>`).join("")}
        </select>
      </div>
  ...
  `}function La(e=[],t=""){const a=String(t||"").trim(),n=new Set(e.map(W));return`
  ...
  `}function _a(e={},t=[]){const a=new Set(t.map(W).filter(Boolean)),n=[],r=(i="")=>{const o=String(i||"").trim();if(!o)return;const l=W(o);a.has(l)||n.some(c=>W(c)===l)||n.push(o)};return[e.features,e.hotelFeatures,e.amenities,e.facilities,e.hotelAmenities].forEach(i=>ye(i).forEach(r)),n}function za({existingImages:e=[],newPreviews:t=[],imageUrlDraft:a=""}={}){const n=[...t.map((o,l)=>({src:o,kind:"new",idx:l})),...e.map((o,l)=>({src:o,kind:"existing",idx:l}))].filter(o=>o.src),r=n[0]?.src||a||"",i=r?B(r,"large"):U;return`
    <div class="space-y-4">
  ...
  `}function xt(e={}){const t=Ee(e),a=wa(t),n=H(t,["address","primaryAddress","location","formattedAddress","street"]),r=H(t,["city","locationCity","primaryCity","region","country"]),i=H(t,["beachDistance","distanceToBeach","beachDistanceLabel","strandEntfernung"]),o=H(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),l=H(t,["rating","reviewRating","stars","hotelStars"]),c=H(t,["reviewCount","reviewsCount","ratingsCount","commentsCount"]),p=Sa(t),g=a?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${a.lat},${a.lng}`)}`:n||r?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${n} ${r}`.trim())}`:"";return`
    <div class="app-content-inline flex flex-col gap-4 app-main-content-safe animate-in fade-in duration-300">
      ...
      <div class="grid grid-cols-1 gap-4">
        ${$e({iconName:"map-pin",label:"Adresa",value:[n,r].filter(Boolean).join(", ")||"Shto lokacionin",helper:a?`${a.lat.toFixed(5)}, ${a.lng.toFixed(5)}`:""})}
        ${$e({iconName:"navigation",label:"Qendra",value:o||"Shto detajet"})}
        ${$e({iconName:"waves",label:"Plazhi",value:i||(t.beachfront||t.onBeach?mt:"Shto detajet")})}
        ${$e({iconName:"star",label:"Vlerësime",value:l?`${l}${c?` / ${c} vlerësime`:""}`:"Pa vlerësime",helper:H(t,["reviewSummary","ratingSummary","commentsSummary"])})}
      </div>
  ...
  `}function Ma(e={}){const t=Ee(e),a=String(e?.restaurantId||t.restaurantId||t.id||"").trim(),n=t?.name||t?.restaurantName||e?.name||"Hotel",r=ka(a),i=String(r.status||"").trim(),o=r.saving===!0,l=Array.isArray(r.existingImages)?r.existingImages.map(z=>String(z||"").trim()).filter(Boolean):ya(t),c=Array.isArray(r.imagePreviews)?r.imagePreviews.map(z=>String(z||"").trim()).filter(Boolean):[],p=String(r.imageUrlDraft||"").trim(),[g,m,v]=Ia(t),h=_a(t,[g,m,v]),$=H(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),I=H(t,["distanceBeach","distanceToBeach","beachDistance","beachDistanceLabel","strandEntfernung","lakeDistance","distanceToLake"]),y=H(t,["hotelStartingPrice","startingPrice","priceFrom","fromPrice","bestPrice","roomStartingPrice"]),P=t.directCenter===!0||t.inCenter===!0||t.cityCenterDirect===!0,w=t.beachfront===!0||t.onBeach===!0||t.amStrand===!0,k=r.detailsOpen===!0||o,S=c[0]||l[0]||"",C=S?B(S,"thumb"):U,T=[$,I,y?`${y} €`:""].filter(Boolean).join(" · ")||"Plotëso detajet",L=i.includes("fehl")||i.includes("Bitte")||i.includes("Nuk");return`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      ...
      ${a?`
        ...
        <div data-hotel-card-editor="${s(a)}" data-hotel-card-details-panel class="${k?"":"hidden "}bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
            ...
            <div class="grid grid-cols-1 gap-4">
              ${bt({idPrefix:"hotelCardDistanceCenter",iconName:"navigation",label:"Qendra",value:$,directLabel:Pa,direct:P})}
              ${bt({idPrefix:"hotelCardDistanceBeach",iconName:"waves",label:"Plazhi",value:I,directLabel:mt,direct:w})}
              <div>
            ...
            <div class="grid grid-cols-1 gap-4">
              ${Be({id:"hotelCardFeatureOneText",iconName:"utensils",label:"Ushqimi",value:g,options:Fa})}
              ${Be({id:"hotelCardFeatureTwoText",iconName:"waves",label:"Shezlongë",value:m,options:ja})}
              ${Be({id:"hotelCardFeatureThreeText",iconName:"square-parking",label:"Parking",value:v,options:Aa})}
              <div>
...
`))}</textarea>
    ...
    <section data-landing-swipe-root="true" class="relative w-full overflow-hidden font-sans" style="height: calc((var(--viewport-height, 1vh) * 100) - var(--smart-header-total-height, 4.5rem)); min-height: calc((var(--viewport-height, 1vh) * 100) - var(--smart-header-total-height, 4.5rem)); overscroll-behavior: none; -webkit-overflow-scrolling: auto; touch-action: none; user-select: none; background: #F8F9FA; --landing-panel-duration: 460ms; --landing-greeting-duration: 720ms; --landing-top-gap: 14px; --landing-swipe-bottom: 0.45rem;">
      ...
      <div data-landing-panel="0" class="absolute inset-0 z-50 flex flex-col items-start justify-center transition-transform ${a===0?"translate-y-0":"-translate-y-full pointer-events-none"}" style="background: #F8F9FA; color: #111827; padding-top: var(--landing-top-gap); opacity: ${a===0?"1":"0"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        ...
        <div class="flex flex-col items-start relative z-10 w-full" style="padding-left: 2.5rem; padding-right: 2.5rem;">
          <div class="relative w-full flex justify-start items-center mb-5" style="height: 40px;">
            ${t.map((A,x)=>{const F=x===n,j=x===(n-1+t.length)%t.length;return`
                <h1 data-landing-greeting-item="${x}" class="absolute left-0 font-medium text-indigo-600 origin-left" style="font-family: 'Playfair Display', Georgia, 'Times New Roman', serif; font-size: 1.875rem; line-height: 2.25rem; transition: all var(--landing-greeting-duration) cubic-bezier(0.23,1,0.32,1); ${F?"opacity: 1; transform: translateY(0) scale(1);":j?"opacity: 0; transform: translateY(-1.5rem) scale(0.95); pointer-events: none;":!F&&!j?"opacity: 0; transform: translateY(1.5rem) scale(0.95); pointer-events: none;":"opacity: 0;"}">
                  ${s(A)}
                </h1>
              `}).join("")}
          </div>
      ...
      <div data-landing-panel="1" class="absolute inset-0 transition-transform ${a<1?"translate-y-full":a===1?"translate-y-0":"-translate-y-full"}" style="background: #F8F9FA; opacity: ${a===1?"1":"0"}; pointer-events: ${a===1?"auto":"none"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        <div data-landing-panel-scroll="1" class="h-full overflow-y-auto overscroll-contain" style="-webkit-overflow-scrolling: touch; touch-action: pan-y; overscroll-behavior-y: none; padding-top: var(--landing-top-gap); padding-bottom: 0;">
          ${Se(e,L,{topTabOverride:"profile",tutorialMode:!0,contentTabOverride:"posts",landingHideContent:!0,collapseIdentity:!1,landingMode:!0})}
        </div>
        ${R}
      </div>
      ...
      <div data-landing-panel="2" class="absolute inset-0 transition-transform ${a<2?"translate-y-full":a===2?"translate-y-0":"-translate-y-full"}" style="background: #F8F9FA; opacity: ${a===2?"1":"0"}; pointer-events: ${a===2?"auto":"none"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        <div data-landing-panel-scroll="2" class="h-full overflow-y-auto overscroll-contain" style="-webkit-overflow-scrolling: touch; touch-action: pan-y; overscroll-behavior-y: none; padding-top: var(--landing-top-gap); padding-bottom: 0;">
          ${C?Se(e,L,{topTabOverride:"profile",tutorialMode:!0,contentTabOverride:"posts",landingHideContent:!1,collapseIdentity:!0,contentReveal:!0,landingMode:!0}):""}
        </div>
        ${R}
      </div>
      ...
      <div data-landing-panel="3" class="absolute inset-0 transition-transform ${a<3?"translate-y-full":"translate-y-0"}" style="background: #F8F9FA; opacity: ${a===3?"1":"0"}; pointer-events: ${a===3?"auto":"none"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        <div data-landing-panel-scroll="3" class="h-full overflow-y-auto overscroll-contain" style="-webkit-overflow-scrolling: touch; touch-action: pan-y; overscroll-behavior-y: none; padding-top: var(--landing-top-gap); padding-bottom: 0;">
          ${T?Se(e,L,{topTabOverride:"profile",tutorialMode:!0,contentTabOverride:"menu",landingHideContent:!1,collapseIdentity:!0,contentReveal:!0,landingMode:!0}):""}
        </div>
      </div>
    </section>
  `}function Ne(e=d.profileView?.profile||d.userProfile,{landingPreview:t=!1,selectedTabOverride:a="",compact:n=!1}={}){const r=ve(e),i=String(a||ke(e)).trim().toLowerCase()||"posts",o=we(e),l=r?[{id:"posts",label:u("profile.posts","Beitraege")},{id:"menu",label:o?"Details":u("nav.menu","Menue"),surface:o?"hotel-details":"menu"}]:[{id:"posts",label:u("profile.posts","Beitraege")},{id:"media",label:u("profile.media","Medien")},{id:"checkins",label:u("profile.checkins","Check-ins")}];return`
  ...
  `}function Ue(e=d.profileView?.profile||d.userProfile,{disabled:t=!1}={}){const a=ke(e);return a==="checkins"||a==="menu"?"":`
  ...
  `}function _(e=""){return String(e||"").trim()}const vt="mnyra_business_title_image_cache_v1",wt=80;function yt(){if(!d)return{};const e=d.businessTitleImageCache&&typeof d.businessTitleImageCache=="object"?d.businessTitleImageCache:null;if(e?.loaded===!0&&e.items&&typeof e.items=="object")return e.items;let t={};try{const n=(typeof window<"u"?window.localStorage:null)?.getItem?.(vt)||"",r=n?JSON.parse(n):{};r&&typeof r=="object"&&Object.entries(r).forEach(([i,o])=>{const l=_(i),c=_(o);l&&c&&!O(c)&&(t[l]=c)})}catch{}return d.businessTitleImageCache={loaded:!0,items:t},t}function Na(e={}){try{const t=typeof window<"u"?window.localStorage:null;if(!t)return;t.setItem(vt,JSON.stringify(e))}catch{}}function Ua(e={},t="business"){const a=[e?.canonicalRestaurantId,e?.restaurantId,e?.uid,e?.handle,e?.publicSlug,e?.landingSlug,e?.name,t].map(n=>_(n)).filter(Boolean);return[...new Set(a)]}function Ha(e=[],t=""){const a=_(t);if(!a||O(a))return;const n=yt();let r=!1;e.forEach(o=>{const l=_(o);!l||n[l]===a||(n[l]=a,r=!0)});const i=Object.entries(n);if(i.length>wt){const o=i.slice(i.length-wt);Object.keys(n).forEach(l=>delete n[l]),o.forEach(([l,c])=>{n[l]=c}),r=!0}r&&Na(n)}function Da(e=[]){const t=yt();for(const a of e){const n=_(a),r=n?_(t[n]):"";if(r&&!O(r))return r}return""}function Oa(e={},t="business"){return String(e?.canonicalRestaurantId||e?.restaurantId||e?.uid||e?.handle||e?.name||t).trim()||t}function Va(e={}){const a=(Array.isArray(e?.coverImages)?e.coverImages:Array.isArray(e?.titleImages)?e.titleImages:[]).map(n=>String(n||"").trim()).find(Boolean)||"";return String(e?.titleImageUrl||e?.coverImageUrl||e?.coverUrl||e?.heroUrl||a||"").trim()}function Ka(e={},t={}){const a=Va(e),n=Array.isArray(t.cacheKeys)?t.cacheKeys:[],r=_(t.stableKey||n[0]||"");if(!a){if(t.allowCacheFallback===!0){const o=Da(n);if(o)return o;const l=r?B("","medium",{stableKey:r}):"";return l&&!O(l)?l:""}return""}const i=B(a,"medium",r?{stableKey:r}:void 0);return i&&!O(i)?(Ha(n,i),i):""}function $t(e="",t=""){const a=_(e);if(!a)return"";if(/^https?:\/\//i.test(a))return a;const n=a.replace(/^@+/,"").replace(/^instagram\.com\//i,"").replace(/^www\.instagram\.com\//i,"").replace(/^tiktok\.com\/@?/i,"").replace(/^www\.tiktok\.com\/@?/i,"").replace(/^\/+/,"").trim();return n?t==="tiktok"?`https://www.tiktok.com/@${encodeURIComponent(n)}`:t==="instagram"?`https://www.instagram.com/${encodeURIComponent(n)}`:"":""}function qa(e=""){const t=_(e);if(!t)return"";const a=t.replace(/[^\d+]/g,"");return a?`tel:${a}`:""}function Ga(e={}){const t=Number(e?.gpsLat??e?.lat),a=Number(e?.gpsLng??e?.lng);if(Number.isFinite(t)&&Number.isFinite(a))return`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${t},${a}`)}`;const n=[e?.address,e?.locationPlace||e?.place,e?.location,e?.city,e?.country].map(r=>_(r)).filter(Boolean).join(", ");return n?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(n)}`:""}function He({href:e="",label:t="",iconName:a="",body:n=""}={}){const r=_(e);return r?`
  ...
  `:""}function Ie({href:e="",buttonAttrs:t="",iconName:a="",eyebrow:n="",value:r=""}={}){const i=_(r);if(!i)return"";const o=`
  ...
  `}function kt(e={},t={}){const a=t.mode==="self"?"self":"public",n=t.disabledBlockClass||"",r=Oa(e,a),i=_(t.avatarUrl||""),o=_(e?.avatar||""),l=o?B(o,"avatar"):"",c=i||l,p=t.avatarFit||Le(!!e.restaurantId),g=String(d?.profileCardInfoOpen||"")===r,m=Number(d?.profileCardInfoHeights?.[r]||0),v=g&&Number.isFinite(m)&&m>0?`height:${Math.ceil(m)}px;`:"",h=t.avatarImgKeyAttr||(a==="self"?'data-img-key="avatar:self"':`data-img-key="avatar:public:${s(r)}"`),$=!!_(c)&&!O(c),I=typeof t.renderAvatarImage=="boolean"?t.renderAvatarImage&&$:$,y=!!t.identityPending,P=t.followersLabel??E(e.followers),w=_(e?.name)||"User",k=_(t.typeLabel||e?.customerType||e?.type||"Business"),S=_(e?.location||"-"),C=a==="public"?`${S} / ${k}`:S,T=t.bioHtml||s(e?.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),L=`business-cover:${r}`,z=Ua(e,r),R=Ka(e,{cacheKeys:z,stableKey:L,allowCacheFallback:t.allowTitleImageCacheFallback===!0}),A=Ga(e),x=$t(e?.instagramUrl||e?.instagram||e?.insta||"","instagram"),F=$t(e?.tiktokUrl||e?.tiktok||e?.tikTok||"","tiktok"),j=_(e?.phone||e?.telephone||e?.contactPhone||""),M=qa(j),N=_(e?.address||e?.locationLabel||[e?.place||e?.locationPlace,e?.location||e?.city].map(q=>_(q)).filter(Boolean).join(", ")),J=[Ie({href:x,iconName:"instagram",eyebrow:"Instagram",value:e?.instagram||e?.instagramUrl||e?.insta||""}),Ie({href:F,iconName:"music-2",eyebrow:"TikTok",value:e?.tiktok||e?.tiktokUrl||e?.tikTok||""})].filter(Boolean).join(""),X=a==="self"?`
    ...
    `;if(g){const q=[Ie({href:M,iconName:"phone",eyebrow:u("profile.call","Anrufen"),value:j}),Ie({href:A,iconName:"map-pin",eyebrow:u("profile.address","Adresse"),value:N||S}),J].filter(Boolean).join("");return`
      <div data-landing-tutorial-target="identity" data-business-profile-card="${s(r)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${n}" style="${v}min-height: var(--business-profile-card-min-height, 440px);display:grid;grid-template-columns:minmax(0,1fr);width:100%;max-width:100%;min-width:0;box-sizing:border-box;">
        ${Qa({profileName:w,safeBio:T,metaLine:C,identityPending:y,followersLabel:P})}
    ...
    <div data-landing-tutorial-target="identity" data-business-profile-card="${s(r)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${n}" style="min-height: var(--business-profile-card-min-height, 440px);">
      <div class="h-40 w-full bg-slate-900 relative overflow-hidden flex items-center justify-center select-none">
        ...
        <div class="absolute top-4 right-4 flex items-center gap-2 z-30">
          ${He({href:A,label:u("profile.openMap","Karte oeffnen"),iconName:"map"})}
          ${He({href:F,label:"TikTok",iconName:"music-2"})}
          ${He({href:x,label:"Instagram",iconName:"instagram"})}
        </div>
      </div>
      <div class="px-8 pb-8 relative z-20" style="margin-top:-3rem;">
        <div class="flex items-end justify-between w-full">
  ...
  `}function Se(e={},t=[],{topTabOverride:a="",tutorialMode:n=!1,contentTabOverride:r="",landingHideContent:i=!1,collapseIdentity:o=!1,contentReveal:l=!1,landingMode:c=!1}={}){const p=ma(e),g=!!e.privateAccount&&e.uid&&String(e.uid)!==String(d.user?.uid||"")&&!p,m=!!e.pendingFollowRequest&&!p,v=e.restaurantId?"Business":u("nav.user","User"),h=String(e.handle||Je(e.name||"user")).replace(/^@/,""),I=s(e.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),y=ve(e),P=String(a||Re(e)).trim().toLowerCase()||"profile",w=String(r||ke(e)).trim().toLowerCase()||"posts",k=w==="menu",S=w==="checkins",C=t,L={...d?.profileView&&typeof d.profileView=="object"?d.profileView:{},profile:e,posts:Array.isArray(C)?C:[]},z=ys(d,{profileView:L,profileTopTab:P,profileContentTab:w}),R=String(z?.header?.status||"").trim().toLowerCase()||"loading",A=String(z?.posts?.status||"").trim().toLowerCase()||"loading",x=String(e?.avatar||"").trim(),F=x?B(x,"avatar"):"",j=Le(!!e.restaurantId),M=e.canonicalRestaurantId||e.restaurantId||e.uid||h||"public",N=c?"":`data-img-key="avatar:public:${s(M)}"`,J=!!x,X=Ze=>{if(Ze==null)return!1;const Ot=Number(Ze);return Number.isFinite(Ot)&&Ot>=0},q=X(e?.followers),Fe=X(e?.following),Ye=J||q||Fe,D=Te(R)&&!Ye,le=!!String(F||"").trim()&&J,ce=D||!q?"...":E(e.followers),je=D||!Fe?"...":E(e.following),K=y?"pt-2":"pt-10",Nt=p?u("profile.following","Following"):m?u("profile.requested","Requested"):g?u("profile.request","Request"):u("profile.follow","Follow"),Ut=p?"bg-slate-100 text-slate-600 shadow-none border border-slate-200":m?"bg-amber-50 text-amber-700 shadow-none border border-amber-200":"bg-gradient-to-r from-slate-900 to-slate-800 text-white border border-transparent",ms=n?"select-none":"app-main-content-safe",te=n?"pointer-events-none":"",bs=!o,Ht=!i,Ae=l?c?"transition-opacity duration-200":"animate-in fade-in duration-300":"",Dt=w==="posts"&&C.length>0,xs=w!=="posts"||Dt||A==="empty"||A==="error",hs=w==="posts"&&!Dt&&A==="error";return!n&&(w==="posts"||w==="media")&&e?.restaurantId&&Te(A)&&xe("posts",e,Gt),`
    <div class="${ms}" ${n?'data-landing-tutorial-surface="true"':""}>
      ${P==="profile"||P==="menu"?`
      ${bs?`
        <div class="app-content-inline pb-2 ${K}">
          ${y?kt(e,{mode:"public",disabledBlockClass:te,avatarUrl:F,avatarFit:j,avatarImgKeyAttr:N,renderAvatarImage:le,identityPending:D,followersLabel:ce,followLabel:Nt,followTone:Ut,isFollowing:p,hasPendingFollowRequest:m,isLocked:g,bioHtml:I,typeLabel:v,allowTitleImageCacheFallback:Te(R)||Te(A)}):`
          <div data-landing-tutorial-target="identity" class="bg-white rounded-[2.5rem] p-8 relative overflow-hidden z-10 border border-slate-100 ${te}">
            <div class="relative z-10">
              <div class="flex justify-between items-start mb-8">
                <div class="relative">
                  <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500">
                    ${le?`<img src="${s(F)}" decoding="async" width="100" height="100" ${N} class="w-full h-full rounded-[1.8rem] ${j} border-2 border-white" />`:`<div class="w-full h-full rounded-[1.8rem] border-2 border-white bg-slate-100 flex items-center justify-center ${D?"animate-pulse":""}">${f(e.restaurantId?"store":"user","w-8 h-8 text-slate-300")}</div>`}
                  </div>
                  ${e.isPremium?`
                    <div class="absolute -bottom-1 -right-1 bg-white rounded-full p-1.5 shadow-lg text-blue-500 border-2 border-slate-50">
                      ${f("badge-check","w-4 h-4 fill-blue-500 text-white")}
                ...
                <div class="flex items-center gap-6 pt-3 pr-2">
                   ...
                   <div class="flex flex-col items-center">
                      <span class="font-black text-2xl ${D?"text-slate-300":"text-slate-900"} leading-none mb-1">${s(je)}</span>
              ...
              <div class="flex gap-4">
                <button data-landing-tutorial-target="follow" data-public-profile-follow="${s(e.handle)}" data-target-type="${s(e.restaurantId?"restaurant":e.uid?"user":"")}" data-target-id="${s(e.restaurantId||e.uid||"")}" data-target-name="${s(e.name||"")}" data-target-avatar="${s(e.avatar||"")}" ${m?"disabled":""} class="flex-1 h-[56px] rounded-[1.2rem] font-bold text-xs uppercase tracking-widest shadow-[0_10px_20px_-5px_rgba(15,23,42,0.25)] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden ${Ut} ${m?"opacity-90 cursor-default":""}">
                  <span class="relative z-10 flex items-center gap-2">
                    ${p?f("check","w-4 h-4"):""}
                    ${Nt}
                  </span>
      ...
      `:`
        ...
        ${Ht?k?`
          <div class="${te} ${Ae}">
            ${we(e)?xt(e):Pe(e,{mode:c?"landing":"profile",allowAutoEnsure:!c})}
          </div>
        `:S?`
          <div class="${te} ${Ae}">
            ${Me()}
        ...
        `:`
          ${xs?`
            ...
            `:`
              <div class="${d.profileViewMode==="grid"?"grid grid-cols-2 gap-4 app-content-inline grid-flow-dense":"flex flex-col gap-8 app-content-inline"} ${te} ${Ae}">
  ...
  `}function Wa(){const e=d.profileView;if(!e||!e.profile)return"";const t=e.profile,a=e.posts||t.posts||[],n=Re(t);return n==="landing"?Ra(t):Se(t,a,{topTabOverride:n,tutorialMode:!1})}function It(e,{filter:t="all",query:a=""}={}){const n=Array.isArray(e)?e:[],r=la(a||"");return n.filter(i=>t==="all"||ae(i.type)===t?r?`${i.name||""} ${i.category||""} ${i.description||""}`.toLowerCase().includes(r):!0:!1)}function St(e,t=0){const a=Number(e);return Number.isFinite(a)?Math.max(0,Math.floor(a)):Math.max(0,Number(t)||0)}function Ce(e=[]){return(Array.isArray(e)?e.slice():[]).map((a,n)=>({item:a,idx:n,order:St(a?.orderIndex,n)})).sort((a,n)=>a.order-n.order||a.idx-n.idx).map((a,n)=>({...a.item,orderIndex:St(a.item?.orderIndex,n)}))}function De(e={}){const t=String(e?.menuVisibility||"").trim().toLowerCase();return e?.menuHidden===!0||t==="hidden"}function oe(e={}){const t=String(e?.menuSection||e?.displaySection||e?.menuPlacement||"").trim().toLowerCase();return t==="drink"?"drink":t==="food"?"food":ae(e?.type||"food")==="drink"?"drink":"food"}function Ya(e={}){return String(e?.category||u("menu.other","Sonstiges")).trim()||u("menu.other","Sonstiges")}function Za(e=""){const t=String(e||"").trim().toLowerCase();return t?(typeof t.normalize=="function"?t.normalize("NFD").replace(/[\u0300-\u036f]/g,""):t).replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""):""}const Ja=4,Xa={thumb:160,small:480,medium:768,large:1280};function Ct({mode:e="profile",priorityIndex:t=-1,slideIndex:a=0}={}){return(e==="profile"||e==="landing")&&Number.isFinite(t)&&t>=0&&t<Ja&&a===0}function es({mode:e="profile",priorityIndex:t=-1,slideIndex:a=0}={}){const n=Ct({mode:e,priorityIndex:t,slideIndex:a}),r=e==="profile"?' data-image-reveal="menu"':"";return n?`loading="eager" fetchpriority="high"${r}`:`loading="lazy" fetchpriority="low"${r}`}function ts({variant:e="grid"}={}){return e==="thumb"?"(max-width: 640px) 64px, 64px":e==="hero"?"(max-width: 640px) 94vw, (max-width: 1200px) 74vw, 920px":"(max-width: 640px) 48vw, (max-width: 1200px) 28vw, 360px"}function Y(e,{mode:t="profile",priorityIndex:a=-1,slideIndex:n=0,stableKey:r="",preferredSize:i="small",candidateSizes:o=["small","medium","large"],variant:l="grid"}={}){const c=String(e||"").trim(),p=t==="profile"&&r?{stableKey:r}:null,g=Ct({mode:t,priorityIndex:a,slideIndex:n}),m=t==="profile"&&!g&&l!=="thumb",v=B(c,i,p),h=O(v)?U:v,$=aa(c),I=sa(c)&&c!==h?c:$,y=[],P=new Set;o.forEach(x=>{const F=Xa[x]||0;if(!F)return;const j=B(c,x,p);if(!j||O(j))return;const M=`${j}|${F}`;P.has(M)||(P.add(M),y.push(`${j} ${F}w`))});const w=y.length>1?y.join(", "):"",k=w?ts({variant:l}):"",S=m?"":w,C=m?"":k,T=S?` srcset="${s(S)}"`:"",L=C?` sizes="${s(C)}"`:"",z=es({mode:t,priorityIndex:a,slideIndex:n}),R=`${z}${T}${L}`,A=m?[`data-menu-lazy-src="${s(h)}"`,`data-menu-lazy-fallback="${s(I||U)}"`,w?`data-menu-lazy-srcset="${s(w)}"`:"",k?`data-menu-lazy-sizes="${s(k)}"`:""].filter(Boolean).join(" "):"";return{safeImg:m?U:h,fallbackImg:m?U:I,imageAttrs:R,lazyAttrs:A?` ${A}`:"",srcsetValue:w,sizesValue:k,loadingAttrs:z}}function ne(e=[],t,a=null){const n=a instanceof Set?a:new Set;return e.map((r,i)=>{const o=Ya(r),l=Za(o),c=!!l&&!n.has(l);return c&&n.add(l),`<div${c?` data-menu-category-anchor="${s(l)}"`:""} class="h-full">${t(r,i)}</div>`}).join("")}function Oe(e={}){return String(e?.specialSize||e?.specialCardSize||"").trim().toLowerCase()==="food"?"food":"default"}function as(e=""){const t=String(e||"").trim();return t?/^(https?:\/\/|mailto:|tel:)/i.test(t)?t:`https://${t.replace(/^\/+/,"")}`:""}function Pt(e={}){const t=String(e?.specialActionType||e?.actionType||"").trim().toLowerCase(),a=as(e?.specialActionUrl||e?.linkUrl||e?.actionUrl||""),n=String(e?.specialActionProductId||e?.targetProductId||"").trim();return t==="link"&&a?{type:"link",url:a,productId:""}:t==="product"&&n?{type:"product",url:"",productId:n}:{type:"self",url:"",productId:""}}function Ft(){const e=d.menu.filter||"all";return`
  ...
  `}function ss(){const e=ea().id;return`
    <div class="mb-5 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      <div class="flex flex-wrap gap-3">
        ${ta.map(t=>{const a=t.id===e,n=t.id==="white"?"text-slate-700":"text-white";return`
  ...
  `}function qe(e={}){if(!e?.restaurantId||ee(e))return!1;const t=String(me(e)||"").trim().toLowerCase();return t==="restaurant"||t==="cafe"||t==="fastfood"}function ns(e={},{items:t=[],menuSurfaceState:a=null,mode:n="profile"}={}){if(qe(e))return!0;const r=String(n||"profile").trim().toLowerCase();if(r!=="profile"&&r!=="landing"||!e?.restaurantId||ee(e))return!1;const i=String(me(e)||"").trim().toLowerCase();if(i==="hotel"||i==="motel"||i==="ecommerce")return!1;const o=a?.menu&&typeof a.menu=="object"?a.menu:{},l=Array.isArray(o.items)?o.items:[];return String(o.source||"").trim().toLowerCase()==="public"&&o.status==="ready"&&(Array.isArray(t)&&t.length>0||l.length>0)&&!i}function jt(e){const t=e?.restaurantId||d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"",a=pe(e),n=rt(t,a),r=n?it(n):{likes:[],comments:[],counts:{likes:0,comments:0}},i=String(d.user?.uid||"").trim(),o=String(d.user?.handle||"").trim().toLowerCase(),l=!!r.likes?.some(c=>{const p=String(c?.uid||"").trim();if(i&&p&&p===i)return!0;const g=String(c?.handle||"").trim().toLowerCase();return!!o&&!!g&&g===o});return{itemId:a,meta:r,counts:ot(r),isLiked:l}}function re(e,{index:t=0}={}){const a=String(e?.restaurantId||d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"").trim(),n=String(e?.id||pe(e)||"").trim();if(!a||!n)return"";const r=Number(t),i=Number.isFinite(r)?Math.max(0,Math.floor(r)):0;return`menu-detail:${a}:${n}:${i}`}function rs(e){const t=typeof nt=="function"?nt(e):[],a=Array.isArray(t)?t.filter(Boolean):[];if(a.length)return a;const n=G(e);return n?[n]:[]}function Z(e){return $s(e?.cardStyle||"",ae(e?.type||"food"))}function Ge(e,{menuItemId:t=""}={}){if(!e)return null;const a=String(t||e.menuItemId||e.itemId||e.productId||"").trim();return{id:e.id||"",title:e.name||e.title||"Sot ne Fokus",text:e.description||e.text||"",imageUrl:G(e)||e.imageUrl||"",objectPosition:e.objectPosition||V(e),menuItemId:a}}function At(e,t=[],{mode:a="profile",force:n=!1}={}){const r=e?.restaurantId||"";return!r||!n&&!qe(e)||!t.length?"":`
    <div class="pt-2 pb-4">
  ...
  `}function Tt(e,{mode:t="profile",priorityIndex:a=-1}={}){const n=G(e),r=t==="profile"?re(e,{index:0}):"",{safeImg:i,fallbackImg:o,imageAttrs:l,lazyAttrs:c}=Y(n,{mode:t,priorityIndex:a,stableKey:r,preferredSize:"small",candidateSizes:["small","medium"],variant:"grid"}),p=he(e),g=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",{itemId:m,counts:v,isLiked:h}=jt(e);return`
  ...
  `}function is(e,t="profile"){if(t!=="profile")return"";const a=Pt(e);return a.type==="link"&&a.url?`data-menu-special-link="${s(a.url)}" role="button" tabindex="0"`:a.type==="product"&&a.productId?`data-menu-open="${s(a.productId)}" role="button"`:`data-menu-open="${s(e.id)}" role="button"`}function Qe(e,{mode:t="profile",size:a="default",priorityIndex:n=-1}={}){const r=G(e),i=t==="profile"?re(e,{index:0}):"",o=a==="food",{safeImg:l,fallbackImg:c,imageAttrs:p,lazyAttrs:g}=Y(r,{mode:t,priorityIndex:n,stableKey:i,preferredSize:o?"medium":"small",candidateSizes:o?["small","medium","large"]:["small","medium"],variant:o?"hero":"grid"}),m=is(e,t),v=String(e.category||"Special").trim()||"Special",h=s(String(e.name||"Special")).replace(/\n/g,"<br>");return a==="food"?`
  ...
  `}function Lt(e,{mode:t="profile",priorityIndex:a=-1}={}){const n=he(e),r=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",i=rs(e),l=(i.length?i:[G(e)||""]).filter(Boolean),c=l.length?l.slice(0,12):[""],p=c.length>1,{itemId:g,counts:m,isLiked:v}=jt(e),h=E(Math.max(0,Number(m.likes)||0)),$=E(Math.max(0,Number(m.comments)||0));return`
    <div ${r} class="bg-white p-3.5 rounded-[2.2rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-5 group relative ${t==="profile"?"cursor-pointer":""}" style="padding:14px;border-radius:2.2rem;margin-bottom:20px;box-sizing:border-box;">
      <div class="w-full aspect-[16/9] rounded-[1.8rem] overflow-hidden bg-slate-100 mb-4 relative" style="aspect-ratio:16 / 9;border-radius:1.8rem;margin-bottom:16px;">
        ${p?`
          ...
          >
            ${c.map((I,y)=>{const P=t==="profile"?re(e,{index:y}):"",w=Y(I||"",{mode:t,priorityIndex:a,slideIndex:y,stableKey:P,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"}),k=y>0,S=k?U:w.safeImg,C=k?U:w.fallbackImg,T=k?w.loadingAttrs:w.imageAttrs,L=k?"":w.lazyAttrs||"",z=k?` data-menu-card-deferred-src="${s(w.safeImg)}"
        ...
        `:`
          ${c.map((I,y)=>{const P=t==="profile"?re(e,{index:y}):"",{safeImg:w,fallbackImg:k,imageAttrs:S,lazyAttrs:C}=Y(I||"",{mode:t,priorityIndex:a,slideIndex:y,stableKey:P,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"});return`
  ...
  `}function os(e,t,{mode:a="profile",publicMenuSurfaceState:n=null,forceModernCards:r=!1}={}){const i=Ce(Array.isArray(t)?t:[]),o=String(e?.restaurantId||"").trim(),l=a==="admin"||pa(o),c=n?.focus?.canRenderFocus?{items:Array.isArray(n.focus.items)?n.focus.items:[],enabled:!0}:o&&l?fe(o):{items:[],enabled:!1},p=c.enabled?(Array.isArray(c.items)?c.items:[]).map(x=>Ge({...x,objectPosition:ie(x)})):[],g=i.filter(x=>Z(x)==="testfirst_focus"&&!De(x)).map(x=>Ge(x,{menuItemId:x.id||""})).filter(Boolean),m=new Set,v=[...p,...g].filter(x=>{const F=String(x.menuItemId||x.id||`${x.title}|${x.text}|${x.imageUrl}`);return!F||m.has(F)?!1:(m.add(F),!0)}),h=i.filter(x=>!De(x)),$=h.filter(x=>Z(x)!=="testfirst_focus"),I=$.length?$:h,y=$.length?v:[],P=I.filter(x=>oe(x)==="drink"),w=I.filter(x=>oe(x)!=="drink"),k=(x=[])=>{const F=[],j=[];return x.forEach(M=>{const N=Z(M);N==="testfirst_food"||N==="testfirst_special"&&Oe(M)==="food"?j.push(M):F.push(M)}),{gridItems:F,foodItems:j}},S=(x,F=-1)=>Z(x)==="testfirst_special"?Qe(x,{mode:a,priorityIndex:F}):Tt(x,{mode:a,priorityIndex:F});let C=0;const T=()=>{const x=C;return C+=1,x},L=new Set,z=(x,F)=>!F.gridItems.length&&!F.foodItems.length?"":`
        ...
        ${F.foodItems.length?`
          <div class="menu-category-section pb-6 pt-4" data-menu-type="${s(x)}">
            <div class="app-content-inline">
              ${ne(F.foodItems,j=>{const M=Z(j),N=T();return M==="testfirst_special"?Qe(j,{mode:a,size:"food",priorityIndex:N}):Lt(j,{mode:a,priorityIndex:N})},L)}
            </div>
          </div>
        `:""}
      </section>
  ...
  `:""}function zt(e,{mode:t="profile",useTestfirstCardUi:a=!1,seenCategories:n=null,priorityOffset:r=0}={}){return e.length?a?`
      <div>
        ${ne(e,(i,o)=>Z(i)==="testfirst_special"&&Oe(i)==="food"?Qe(i,{mode:t,size:"food",priorityIndex:r+o}):Lt(i,{mode:t,priorityIndex:r+o}),n)}
      </div>
    `:`
    <div class="space-y-4">
      ${ne(e,(i,o)=>Ke(i,{mode:t,variant:"food",priorityIndex:r+o}),n)}
    </div>
  `:""}function Mt(e,{mode:t="profile"}={}){if(t==="admin"){const a=String(d?.menu?.filter||"all").trim().toLowerCase(),n=e.filter(c=>ae(c?.type)==="drink"),r=e.filter(c=>ae(c?.type)!=="drink"),i=(c,p,{addType:g=""}={})=>`
      <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
        <div class="flex items-center justify-between mb-4">
          <div>
  ...
  `:`
    ...
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(h=>{const $=B(h.imageUrl||"","thumb"),I=O($)?U:$,y=h.active!==!1?"Aktiv":"Inaktiv",P=h.active!==!1?"text-emerald-600":"text-slate-400";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function Et(e={}){if(!e?.restaurantId)return!1;const t=String(me(e)||"").trim().toLowerCase();return["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"].includes(t)?!1:ee(e)||se(e)||["restaurant","cafe","coffee","fastfood","food","ecommerce"].includes(t)||!t}function ls(e={}){if(e.active===!1)return{label:"Inaktiv",className:"text-slate-400"};const t=String(e.status||e.approvalStatus||"pending").trim().toLowerCase();return t==="approved"?{label:"Freigegeben",className:"text-emerald-600"}:t==="rejected"?{label:"Abgelehnt",className:"text-rose-600"}:{label:"Wartet auf Heart",className:"text-amber-600"}}function cs(e,t){if(!t||!Et(e))return"";const{items:a,loading:n}=ra(t,{includeInactive:!0}),r=E(a.length);return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(i=>{const o=B(i.imageUrl||"","thumb"),l=O(o)?U:o,c=ls(i),p=i.category||"RESTAURANT",g=i.priceSegment||"€€ - €€€";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function ds(e){if(!qe(e)||!ft(e))return"";const a=Ce((d.menu.items||[]).filter(n=>Z(n)==="testfirst_special"));return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(n=>{const r=B(G(n),"thumb"),i=O(r)?U:r,o=Pt(n),l=o.type==="link"?"Link":o.type==="product"?"Produkt-Modal":"Diese Karte",c=Oe(n)==="food"?"Food-Size":"Normal",p=da(oe(n));return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function Bt(e,{restaurantId:t="",suppressLoading:a=!1,allowAutoEnsure:n=!0,requirePublicMenuTruth:r=!0}={}){const i=String(t||e?.canonicalRestaurantId||e?.restaurantId||"").trim();if(!i||!se(e))return"";const o=de(d,{profile:e,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:i});if(r&&o.menu.status!=="ready")return"";const l=!r||o.focus.canRenderFocus;if(n&&!d.focus.loading&&!l&&xe("focus",pt(e,i),ue),r&&!l)return"";const{items:c,loading:p}=l?{items:Array.isArray(o.focus.items)?o.focus.items:[],loading:o.focus.loading}:fe(i);if(!(l?!0:fe(i).enabled)||!c.length&&!p||a&&p&&!c.length)return"";if(p&&!c.length)return`
    ...
    `;const m=ia(c),v=c[m]||c[0],{safeImg:h,fallbackImg:$,imageAttrs:I,lazyAttrs:y}=Y(v.imageUrl||"",{mode:"profile",priorityIndex:0,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:v?.id?`focus-carousel:${i}:${String(v.id)}`:""}),P=v.text||"";return`
  ...
  `}function us(e,t=220){const a=encodeURIComponent(e||"");return`https://api.qrserver.com/v1/create-qr-code/?size=${t}x${t}&data=${a}`}function Rt({label:e,url:t,caption:a}){if(!t)return"";const n=us(t,240);return`
  ...
  `}function ps({profile:e,restaurantId:t,catalogLabel:a}){if(!t||!se(e))return"";if(typeof tt=="function"){const i=ge?ge(t):null;(!i||i.sameRestaurant!==!0||!i.loading&&!i.loaded&&!i.error)&&tt(e)}const n=typeof ge=="function"?ge(t):{enabled:!0,count:0,tables:[],loading:!1,saving:!1,error:""},r=(n.tables||[]).map(i=>{const o=oa("apps/menyra-social/index.html",{r:t,tab:"menu",source:"qr",table:i});return Rt({label:`Tisch ${i}`,url:o,caption:`${a} fuer Tisch ${i}`})}).join("");return`
  ...
  `}function fs(){const e=d.userProfile,t=e.restaurantId||"",a=String(d.user?.uid||"").trim(),n=String(d.__authBootstrapInFlightUid||"").trim(),r=!t&&!!a&&(!!d.__authProfileLoadPromise||n===a),i=we(e),o=se(e),l=d.profileView?.profile?.restaurantId?d.profileView.profile:null,c=qt()&&!!l?.restaurantId&&se(l),p=dt(at(e)),g=t?be(t):null,m=g?.name||g?.restaurantName||e.name||"Business",v=t&&d.menu.restaurantId===t,h=String(d.menu.source||"").trim().toLowerCase(),$=!!v&&h==="collection",I=!!v&&h==="collection"&&d.menu.loading,y=!!t&&(I||!$),P=$?It(d.menu.items,{filter:d.menu.filter,query:d.menu.query}):[],k=ft(e)?P:P.filter(T=>!ba(T)),S=Ce(k),C=E(S.length);if(t&&i){va(e);const T=String(d.focus?.truthSource||"").trim().toLowerCase();return!d.focus.loading&&(d.focus.restaurantId!==t||T!=="public-menu")&&ue(e),Ma(e)}return t&&o&&!$&&!I&&Wt(e),t&&o&&!d.focus.loading&&d.focus.restaurantId!==t&&ue(e),t&&Et(e)&&Yt(e),o?`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      <div class="flex items-end justify-between mb-6">
        <div>
      ...
      ${t?`
        ...
        ${y?`<div class="text-center py-12 text-[10px] font-bold uppercase tracking-widest text-slate-400">${s(u("menu.loading",`${p} wird geladen...`,{label:p}))}</div>`:Mt(S,{mode:"admin"})}
        ${d.menu.error?`<div class="text-center text-[10px] font-bold uppercase tracking-widest text-rose-500 mt-4">${s(d.menu.error)}</div>`:""}
        ${ps({profile:e,restaurantId:t,catalogLabel:p})}
      `:""}
  ...
  `:c?Pe(l):`
    ...
    `;const l=pt(e,o),c=se(l);c&&(i=de(d,{profile:l,routePayload:n,webDirectEntry:r,restaurantId:o,coordinateFocusWithMenu:!0}));const p=String(r?.canonicalRestaurantId||r?.restaurantId||"").trim(),g=new Set(i.targetIds),m=vs(i.focus.truthState||""),v=i.menu.status==="ready",h=i.focus.canRenderFocus,$=v&&c,I=i.focus.matches===!0&&i.focus.loading===!0,y=t==="landing",w=String(d?.profileView?.menuAccessSource||r?.menuAccessSource||n?.menuAccessSource||"").trim().toLowerCase()==="qr",k=r?.active===!0&&r?.webPriority===!0&&r?.menuFirst===!0&&String(d?.activeTab||"").trim().toLowerCase()==="profile"&&String(d?.profileTopTab||"").trim().toLowerCase()==="menu"&&(p===o||g.has(o)),S=k&&!w,C=["ready","empty","error"].includes(i.menu.status),T=k&&C,L=k&&(!$||i.menu.status!=="ready"),z=!$||i.focus.settled===!0||m==="knownEmpty"||i.menu.status!=="ready";a&&!T&&!C&&xe("menu",l,Qt),a&&!L&&!z&&!I&&(!S||C)&&xe("focus",l,ue);const A=i.menu.canRenderItems?Ce(It(i.menu.items,{filter:"all",query:""})).filter(K=>!De(K)):[],x=A.length>0,F=ee(l),j=dt(at(l)),M=i.menu.error||"",N=!!String(M||"").trim(),J=i.menu.status==="loading"||i.menu.waitingForFocus===!0,X=A.filter(K=>oe(K)==="drink"),q=A.filter(K=>oe(K)!=="drink"),Fe=0,Ye=X.length,D=ns(l,{items:A,menuSurfaceState:i,mode:t}),le=new Set;x&&o&&(Zt(A,o),ga(A,o));const ce=o&&h?(Array.isArray(i.focus.items)?i.focus.items:[]).map(K=>Ge({...K,objectPosition:ie(K)})).filter(Boolean):[],je=ce.length?At(l,ce,{mode:t,force:D}):"";return y&&J?'<div class="app-content-inline app-main-content-safe" style="min-height: 34vh;"></div>':D?`
      <div class="app-main-content-safe">
        ...
        `:`
          ${x?os(l,A,{mode:t,publicMenuSurfaceState:i,forceModernCards:D}):N?`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${s(u("menu.loadError","Menu konnte nicht geladen werden"))}</div>`:je||`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300">${s(u("menu.noProducts","Keine Produkte"))}</div>`}
    ...
    <div class="app-content-inline app-main-content-safe space-y-5">
      ${Bt(l,{restaurantId:o,suppressLoading:!0,allowAutoEnsure:v&&(!S||C),requirePublicMenuTruth:!0})}
      ${J?`
            ...
            ${X.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="drink">
                ...
                <div data-menu-type="drink">
                  ${_t(X,{mode:t,useTestfirstCardUi:D,seenCategories:le,priorityOffset:Fe})}
                </div>
              </section>
            `:""}
            ${q.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="food">
                ...
                <div data-menu-type="food">
                  ${zt(q,{mode:t,useTestfirstCardUi:D,seenCategories:le,priorityOffset:Ye})}
                </div>
              </section>
            `:""}
          `}
  ...
  `}function gs(){const e=d.userProfile,t=Kt(e),a=t?d.businessPosts:d.userPosts,n=String(d.user?.uid||e?.uid||"").trim(),r=String(e?.restaurantId||"").trim(),i=String(d.__userPostsLoadingUid||"").trim(),o=String(d.__businessPostsLoadingRestaurantId||"").trim(),l=String(d.__authBootstrapInFlightUid||"").trim(),c=!!n&&i===n,p=!!r&&o===r,g=!!n&&l===n,m=t?p||g&&!a.length:c||g&&!a.length,v=String(e.handle||Je(e.name||"user")).replace(/^@/,""),$=s(e.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),I=ke(e),y=I==="menu",P=I==="checkins",w=a,k=B(e.avatar,"avatar"),S=Le(t),C=Re(e);return`
    <div class="app-main-content-safe">
      ...
      `}
      `:`
        ${C==="cart"?Xe(e):C==="favorites"?et(e):""}
      `}
    </div>
  `}return{renderProfilePostCardFancy:gt,renderProfilePostsFancy:ze,renderProfileCheckins:Me,renderProfileTabs:Ne,renderProfileViewControls:Ue,renderPublicProfileView:Wa,renderMenuFilterRow:Ft,renderMenuLayoutSection:ss,renderMenuItemCard:Ve,renderMenuItemCardStacked:Ke,renderMenuDrinkGrid:_t,renderMenuFoodList:zt,renderMenuList:Mt,renderFocusAdminSection:We,renderFocusCarousel:Bt,renderMenuQrCard:Rt,renderMenuAdminView:fs,renderProfileMenuView:Pe,renderProfileView:gs}}export{Cs as createProfileMenuFocusRenderController};
