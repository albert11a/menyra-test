import{t as $}from"./domain-feed-social-eager-CvM2km4n.js";import"./domain-auth-DQDx_hFk.js";import"./domain-public-profile-mLQti0eH.js";import"./domain-media-eager-B90n_Ot7.js";import"./domain-menu-eager-Cy2AQlNM.js";function W({state:a,getOptimizedImageUrl:p,escapeHtml:u,icon:x,formatRelative:v,toDateSafe:b}={}){if(!a?.chatModal?.open||!a?.chatModal?.profile)return"";const h=typeof p=="function"?p:(l=>l||""),n=typeof u=="function"?u:(l=>String(l??"")),m=typeof x=="function"?x:(()=>""),t=(l,y=l,e={})=>$(l,{fallback:y,params:e}),w=typeof v=="function"?v:(l=>String(l??"")),i=typeof b=="function"?b:(l=>l),o=a.chatModal.profile,f=h(o.avatar,"avatar"),g=Array.isArray(a.chatModal.messages)?a.chatModal.messages:[];return`
            ...
            `).join(""):`
              <div class="h-full flex items-center justify-center text-center py-16">
                <div>
                  ...
                  <p class="text-[10px] font-black uppercase tracking-widest text-slate-400">${n(t("chat.empty","Noch keine Nachrichten"))}</p>
                </div>
              </div>
            `}
          </div>
  ...
  `}function E({state:a,isFollowingProfile:p,getOptimizedImageUrl:u,formatCount:x,escapeHtml:v,icon:b}={}){if(!a?.profileModal?.open||!a?.profileModal?.profile)return"";const h=typeof p=="function"?p:(()=>!1),n=typeof u=="function"?u:(d=>d||""),m=typeof x=="function"?x:(d=>String(d??"0")),t=typeof v=="function"?v:(d=>String(d??"")),w=typeof b=="function"?b:(()=>""),i=(d,c=d,s={})=>$(d,{fallback:c,params:s}),o=a.profileModal.profile,f=h(o),g=!!o.pendingFollowRequest&&!f,l=!!o.privateAccount&&o.uid&&String(o.uid)!==String(a.user?.uid||"")&&!f,y=o.restaurantId?i("profile.business","Business"):i("profile.user","User"),e=n(o.avatar,"avatar");return`
      ...
      <div class="modal-frame">
        <div class="bg-white rounded-t-[3rem] shadow-2xl border border-slate-100  flex flex-col modal-sheet-85 overflow-hidden modal-sheet">
          ...
          <div class="px-7 pb-7 space-y-3 overflow-y-auto no-scrollbar modal-scroll flex-1">
            ...
            `}).join(""):`
              <div class="text-center text-[10px] font-bold uppercase text-slate-400">${t(i("likes.empty","Noch keine Likes"))}</div>
            `}
          </div>
        </div>
      </div>
  ...
  `}export{W as renderChatModalCore,J as renderLikesModalCore,Q as renderPostModalCore,E as renderProfileModalCore};
