function Ho(s={}){const g=String(s?.id||"").trim();if(!g)return"";const C=String(s?.ownerType||(s?.restaurantId||s?.rid?"restaurant":"")||(s?.uid||s?.userId?"user":"")||"").trim(),A=String(s?.ownerId||s?.restaurantId||s?.rid||s?.uid||s?.userId||"").trim();return C&&A?`${C}:${A}:${g}`:`post:${g}`}function Ar(s=null){return s?(s.postEntityMap instanceof Map||(s.postEntityMap=new Map),s.postEntityMap):new Map}function on(s=null){const g=Ar(s);return g.clear(),g}function Wo(s=null,g=[]){const C=Ar(s),A=new Set;return(Array.isArray(g)?g:[]).map(N=>{const z=Ho(N);if(!z||A.has(z))return null;A.add(z);const F=C.get(z);if(!F){const V={...N||{}};return C.set(z,V),V}return Object.assign(F,N||{}),F}).filter(Boolean)}function nn({state:s=null,toDateSafeFn:g=f=>f,getStoriesRowSignatureFn:C=()=>"",setStoriesRowSignatureFn:A=()=>{},FAST_MODE:N=!1,buildStoriesFromFeedFn:z=()=>[],updateStoryLogoNodesFn:F=()=>{},updateStoryMetaNodesFn:V=()=>{},updateFeedLogoNodesFn:Z=()=>{},updatePostCountNodesFn:le=()=>{},ensureFeedRestaurantMetaListenersFn:et=()=>{},preloadFeedHeroImagesFn:tt=()=>{},buildStoriesRowSignatureFn:Ft=()=>"",documentObj:rt=null,windowObj:ot=null,isLocalBusinessProfileFn:ze=()=>!1,iconFn:B=()=>"",escapeHtmlFn:p=f=>String(f||""),buildUrlFn:ee=()=>"",buildStoryViewerUrlFn:Ie=(f="")=>ee("apps/menyra-social/index.html",{r:f,tab:"profile"}),resolveRestaurantLogoFn:de=()=>"",resolveStoryRenderIdentityFn:Pe=null,getOptimizedImageUrlFn:h=()=>"",getVerifiedMapLocationFn:_=()=>null,setVerifiedMapLocationFn:E=null,buildUploadStateForIntentFn:j=(f="",y={})=>y,setStateFn:U=()=>{},openGuestAuthPromptFn:W=()=>!1,openOwnBusinessProfileFn:k=null,openProfileViewFromBusinessFn:te=()=>{},openPostModalFn:ke=async()=>{},togglePostLikeFn:Ee=async()=>{},setTimeoutFn:q=(f,y)=>setTimeout(f,y)}={}){if(!s)return{renderHomeView:()=>"",renderFeedView:()=>"",renderStoryItem:()=>"",renderStoriesRow:()=>"",renderFeedItem:()=>"",renderFeedList:()=>"",patchFeedList:()=>!1,patchStoriesRow:()=>!1,updateFeedDom:()=>!1,bindFeedDelegation:()=>{}};const f=rt||(typeof document<"u"?document:null),y=ot||(typeof window<"u"?window:null),K=typeof HTMLVideoElement=="function"?HTMLVideoElement:null,Re="mnyra_story_viewer_hint_v1:",nt=()=>!!String(s.userProfile?.uid||"").trim(),it=()=>!!String(s.userProfile?.restaurantId||"").trim(),Ge=()=>!!ze(s.userProfile)||it()&&(!!s.user||nt()),at=(e="")=>{const t=String(e||"").trim();return t?t.toLowerCase()==="business"?"":t:""},Bt=(e={})=>String(e?.truthSource||e?.storyTruthSource||e?.storyTruth||"").trim().toLowerCase()==="feed-fallback"?"feed-fallback":"canonical",Ut=15,jr=6,$r=15,Or=35,Nr=Object.freeze(["city","locationCity","primaryCity","place","locationPlace","primaryPlace","postalCity","address","primaryAddress","formattedAddress","fullAddress","addressText","streetAddress","street","locationLabel","displayLocation","locality","town","municipality","village","neighborhood","neighbourhood","area","district","county","region","state","province"]),zr=Object.freeze(["location","primaryLocation","businessLocation","venueLocation","addressInfo","geo","coords","coordinates","geoPoint"]),Pr="flex:0 0 29%;width:29%;max-width:120px;",Rr="height:13rem;",Gr="border-radius:1rem;",Q=new WeakMap;let Fe=null,Dt=!1;const Be=({withMarginLeft:e=!1}={})=>`${Pr}${e?"margin-left:1.25rem;":""}`,Fr=()=>"margin-left:calc(var(--app-content-inline,1.5rem) * -1);margin-right:calc(var(--app-content-inline,1.5rem) * -1);scroll-padding-left:1.25rem;overscroll-behavior-x:contain;touch-action:pan-x;-webkit-overflow-scrolling:touch;",st=(e="")=>`${Rr}${Gr}position:relative;overflow:hidden;${e}`,L=(e=0)=>{const t=Number(e);return Number.isFinite(t)?t:0},Br=(e={})=>De(e?.createdAt||e?.updatedAt||e?.timestamp||e?.ts||e?.publishedAt||null),Ur=(e="")=>{const t=String(e||"").trim().toLowerCase();return t?!!(/\.m3u8($|\?)/.test(t)||/\.mpd($|\?)/.test(t)||/\.mp4($|\?)/.test(t)||/\.webm($|\?)/.test(t)||/\.mov($|\?)/.test(t)||/\.m4v($|\?)/.test(t)||/\.ogv($|\?)/.test(t)):!1},ct=(e={})=>{const t=String(e?.mediaType||e?.type||"").trim().toLowerCase(),r=String(e?.imageUrl||e?.thumbUrl||"").trim(),o=String(e?.videoUrl||e?.playbackUrl||"").trim(),n=String(e?.mediaUrl||e?.url||"").trim(),i=String(e?.embedUrl||"").trim(),a=String(e?.img||e?.image||e?.thumbnail||e?.thumbnailUrl||e?.previewImage||e?.previewUrl||e?.coverImage||e?.poster||e?.posterUrl||"").trim(),l=Ur(n),d=o||(t==="video"||l?n:""),u=r||(t==="image"?n:"");return d?{kind:"video",src:d,poster:u||a,signature:`video:${d}|${u||a||""}`}:u?{kind:"image",src:u,poster:u,signature:`image:${u}`}:a?{kind:"image",src:a,poster:a,signature:`fallback:${a}`}:i?{kind:"embed",src:i,poster:"",signature:`embed:${i}`}:{kind:"none",src:"",poster:"",signature:"none"}},Vt=(e={})=>{const t=Bt(e),r=ct(e);return[String(e?.restaurantId||e?.id||"").trim(),t,e?.isLive?"1":"0",r.signature].join("|")},qt=(e={})=>[String(e?.id||"").trim(),String(e?.business||"").trim(),String(e?.location||"").trim(),String(e?.content||e?.caption||"").trim(),String(e?.image||e?.url||"").trim(),e?.isLive?"1":"0"].join("|"),Dr=(e=[])=>(Array.isArray(e)?e:[]).slice(0,10).map(t=>[String(t?.id||"").trim(),String(t?.image||t?.url||"").trim()].join("|")).join(","),Ue=typeof Pe=="function"?(e={})=>Pe(e):(e={})=>{const t=String(e?.restaurantId||"").trim(),r=Bt(e),o=r==="feed-fallback";if(!t)return{storyRestaurantId:"",hasCanonicalRestaurant:!1,storyLabel:"",logoSource:"",borderClass:e?.isLive?"border-red-500 animate-pulse":o?"border-amber-300 border-dashed":"border-slate-200",truthSource:r};const n=s.restaurants.find(x=>String(x?.id||"").trim()===t)||null,i=String(s.userProfile?.restaurantId||"").trim(),a=i&&i===t,l=!!n?.id,d=String(n?.logoUrl||n?.logo||n?.logoURL||"").trim(),u=at(n?.name||n?.restaurantName||n?.displayName||n?.businessName||""),m=at(e?.name||e?.businessName||e?.restaurantName||""),b=a?at(s.userProfile?.name||""):"",v=a?String(s.userProfile?.avatar||"").trim():"",w=l?u||m||b||"":b||m||u||"",S=l?d||String(e?.img||e?.logo||e?.logoUrl||"").trim():v||String(e?.img||e?.logo||e?.logoUrl||"").trim();return{storyRestaurantId:t,hasCanonicalRestaurant:l,storyLabel:w,logoSource:S,borderClass:e?.isLive?"border-red-500 animate-pulse":o?"border-amber-300 border-dashed":"border-slate-200",truthSource:r}},Kt=(e={})=>!!Ue(e).storyRestaurantId,Yt=(e="")=>{const t=String(e||"").trim();return t&&(Array.isArray(s?.feedPosts)?s.feedPosts:[]).find(o=>String(o?.id||"").trim()===t)||null},De=(e=null)=>{const t=g(e),r=Number(t?.getTime?.()||0);return Number.isFinite(r)?r:0},lt=()=>{const e=new Map;return(Array.isArray(s?.restaurants)?s.restaurants:[]).forEach(r=>{const o=String(r?.id||r?.restaurantId||"").trim();!o||e.has(o)||e.set(o,r)}),e},Ht=(e={})=>String(e?.restaurantId||(String(e?.ownerType||"").trim().toLowerCase()==="restaurant"?e?.ownerId:"")||e?.rid||"").trim(),dt=(e=[],t="")=>{if(typeof t=="string"||typeof t=="number"){const r=String(t||"").trim();r&&e.push(r)}},ut=(e=[],t={})=>{!t||typeof t!="object"||(Nr.forEach(r=>dt(e,t[r])),(typeof t.location=="string"||typeof t.location=="number")&&dt(e,t.location))},Ve=(e="")=>P(e).replace(/-/g," ").replace(/\s+/g," ").trim(),Wt=()=>pt.map(e=>[e?.id,e?.label,e?.city,...Array.isArray(e?.aliases)?e.aliases:[]].map(Ve).filter(Boolean)).filter(e=>e.length),Vr=(e="")=>{const t=Ve(e);if(!t)return[];const r=new Set([t]);return Wt().forEach(o=>{o.includes(t)&&o.forEach(n=>r.add(n))}),Array.from(r)},Qt=(e=[],t=[])=>{const r=(Array.isArray(e)?e:[]).map(Ve).filter(Boolean);if(!r.length||!t.length)return!1;const o=r.join(" ");return t.some(n=>{const i=n.split(" ").filter(Boolean);return r.some(a=>a===n||a.includes(n))||i.length>0&&i.every(a=>o.includes(a))})},qr=(e=[])=>{const t=(Array.isArray(e)?e:[]).map(Ve).filter(Boolean);if(!t.length)return!1;const r=t.join(" ");return Wt().some(o=>o.some(n=>{const i=n.split(" ").filter(Boolean);return t.some(a=>a===n||a.includes(n))||i.length>0&&i.every(a=>r.includes(a))}))},Kr=(e={})=>{const t=ie(e);if(!t)return"";const r=pt.map(o=>{const n=G(o);return{label:String(o?.label||"").trim(),distanceKm:n?_e(t,n):Number.POSITIVE_INFINITY}}).filter(o=>o.label&&Number.isFinite(o.distanceKm)).sort((o,n)=>o.distanceKm-n.distanceKm)[0];return r&&r.distanceKm<=Or?r.label:""},Yr=(...e)=>{const t=[];return e.forEach(r=>{!r||typeof r!="object"||(ut(t,r),zr.forEach(o=>ut(t,r[o])),Array.isArray(r.locations)&&r.locations.forEach(o=>ut(t,o)))}),t},Hr=(...e)=>{const t=[];return e.forEach(r=>dt(t,Kr(r))),t},qe=({entry:e={},restaurant:t=null,viewerCity:r=""}={})=>{const o=Vr(r);if(!o.length)return!0;const n=Yr(t,e);return Qt(n,o)?!0:qr(n)?!1:Qt(Hr(t,e),o)},Xt=({feedPosts:e=[],stories:t=[]}={})=>{const r=Array.isArray(e)?e:[],o=Array.isArray(t)?t:[],n=X(we()),i=Lt(n),a=Le(n),l=G(n),d=lt(),u=!!a,m=!!i,b=(S={},{type:x="post",fallbackIndex:I=0}={})=>{const T=Ht(S),O=T&&d.get(T)||null,H=Le({...O&&typeof O=="object"?O:{},...S&&typeof S=="object"?S:{}});if(u&&(!H||H!==a)||m&&!qe({entry:S,restaurant:O,viewerCity:i}))return null;const ae=ie(O)||ie(S),be=l&&ae?_e(l,ae):Number.POSITIVE_INFINITY;return{entry:S,fallbackIndex:I,distanceKm:be,createdAtMs:x==="post"?De(S?.createdAt||S?.updatedAt):0}},v=r.map((S,x)=>b(S,{type:"post",fallbackIndex:x})).filter(Boolean).sort((S,x)=>{const I=Number.isFinite(S.distanceKm),T=Number.isFinite(x.distanceKm);return I&&T&&Math.abs(S.distanceKm-x.distanceKm)>.001?S.distanceKm-x.distanceKm:I!==T?I?-1:1:S.createdAtMs!==x.createdAtMs?x.createdAtMs-S.createdAtMs:S.fallbackIndex-x.fallbackIndex}).map(S=>S.entry),w=o.map((S,x)=>b(S,{type:"story",fallbackIndex:x})).filter(Boolean).sort((S,x)=>{const I=Number.isFinite(S.distanceKm),T=Number.isFinite(x.distanceKm);return I&&T&&Math.abs(S.distanceKm-x.distanceKm)>.001?S.distanceKm-x.distanceKm:I!==T?I?-1:1:S.fallbackIndex-x.fallbackIndex}).map(S=>S.entry);return{feedPosts:v,stories:w}},ft=(e=Number.POSITIVE_INFINITY,t=Number.POSITIVE_INFINITY)=>{const r=Number.isFinite(e),o=Number.isFinite(t);return r&&o&&Math.abs(e-t)>.001?e-t:r!==o?r?-1:1:0},gt=(e={},t={})=>{if(e.likes!==t.likes)return t.likes-e.likes;if(e.visitors!==t.visitors)return t.visitors-e.visitors;if(e.comments!==t.comments)return t.comments-e.comments;if(e.createdAtMs!==t.createdAtMs)return t.createdAtMs-e.createdAtMs;const r=ft(e.distanceKm,t.distanceKm);return r!==0?r:e.fallbackIndex-t.fallbackIndex},Wr=(e=null)=>{const t=new Set;return(e instanceof Set?Array.from(e):Array.isArray(e)?e:[]).forEach(o=>{const n=String(o||"").trim();n&&t.add(n)}),t},Jt=(...e)=>{const t=new Set;return e.forEach(r=>{(Array.isArray(r)?r:[]).forEach(o=>{const n=Ue(o),i=String(o?.restaurantId||o?.storyId||n.storyRestaurantId||"").trim();i&&t.add(i)})}),t},Zt=(e=[],t=[],r=null)=>{const o=Array.isArray(e)?e:[],n=Array.isArray(t)?t:[],i=o.length?o:n,a=X(we()),l=Lt(a),d=G(a),u=Le(a),m=lt(),b=Wr(r),v=new Map,w=(c=null)=>{if(!c||!c.spotId)return;const $=v.get(c.spotId);if(!$){v.set(c.spotId,c);return}gt(c,$)<0&&v.set(c.spotId,c)},S=(c={},$=0)=>{const M=Ht(c),D=String(c?.id||"").trim(),se=M||(D?`post:${D}`:`idx:${$}`),R=M&&m.get(M)||null,Xe=Le({...R&&typeof R=="object"?R:{},...c&&typeof c=="object"?c:{}});if(u&&(!Xe||Xe!==u)||l&&!qe({entry:c,restaurant:R,viewerCity:l}))return null;const Je=ie(R)||ie(c),jt=d&&Je?_e(d,Je):Number.POSITIVE_INFINITY,$t=Math.max(0,L(c?.likes),L(c?.likesCount)),Ot=Math.max(0,L(c?.comments),L(c?.commentsCount)),Nt=Math.max(0,L(c?.visitors),L(c?.visitorCount),L(c?.visitorsCount),L(c?.views),L(c?.viewCount),L(c?.viewsCount),L(c?.reach),L(c?.reachCount),L(c?.impressions),L(c?.impressionsCount)),zt=Math.max(0,L(c?.rating),L(c?.score),L(c?.stars),L(R?.rating),L(R?.score),L(R?.stars)),Pt=De(c?.createdAt||c?.updatedAt),Rt=String(c?.business||c?.restaurantName||R?.name||R?.restaurantName||"Best Spot").trim()||"Best Spot",Ze=String(R?.bestSpotLogoUrl||R?.spotLogoUrl||R?.bestSpotLogo||R?.spotLogo||R?.logoUrl||R?.logo||R?.logoURL||c?.bestSpotLogoUrl||c?.spotLogoUrl||c?.logo||c?.image||c?.url||"").trim(),Ko=M?de(M,Ze,"avatar",!1):Ze,Yo=M?ee("apps/menyra-social/index.html",{r:M,tab:"profile",source:"best-spot"}):ee("apps/menyra-social/index.html",{tab:"feed",post:D,source:"best-spot"});return{spotId:se,postId:D,restaurantId:M,displayName:Rt,avatarUrl:Ko,profileUrl:Yo,likes:$t,comments:Ot,visitors:Nt,rating:zt,distanceKm:jt,createdAtMs:Pt,fallbackIndex:$}},x=(c={},$=0)=>{const M=String(c?.id||c?.restaurantId||"").trim();if(!M)return null;const D=String(c?.status||"").trim().toLowerCase();if(D==="archived"||D==="deleted"||D==="blocked"||D==="disabled")return null;const se=Le(c);if(u&&(!se||se!==u)||l&&!qe({entry:c,restaurant:c,viewerCity:l}))return null;const R=ie(c),Xe=d&&R?_e(d,R):Number.POSITIVE_INFINITY,Je=Math.max(0,L(c?.likes),L(c?.likesCount),L(c?.likeCount),L(c?.socialLikes),L(c?.socialLikesCount),L(c?.followersCount),L(c?.followers)),jt=Math.max(0,L(c?.comments),L(c?.commentsCount),L(c?.reviewCount),L(c?.reviews),L(c?.reviewsCount),L(c?.ratingsCount)),$t=Math.max(0,L(c?.visitors),L(c?.visitorCount),L(c?.visitorsCount),L(c?.views),L(c?.viewCount),L(c?.viewsCount),L(c?.reach),L(c?.reachCount),L(c?.impressions),L(c?.impressionsCount),L(c?.ordersCount),L(c?.orders)),Ot=Math.max(0,L(c?.rating),L(c?.score),L(c?.stars)),Nt=De(c?.createdAt||c?.updatedAt||c?.truthUpdatedAt),zt=String(c?.name||c?.restaurantName||c?.displayName||c?.businessName||"Best Spot").trim()||"Best Spot",Pt=String(c?.bestSpotLogoUrl||c?.spotLogoUrl||c?.bestSpotLogo||c?.spotLogo||c?.logoUrl||c?.logo||c?.logoURL||c?.image||c?.coverImage||"").trim(),Rt=de(M,Pt,"avatar",!1),Ze=ee("apps/menyra-social/index.html",{r:M,tab:"profile",source:"best-spot"});return{spotId:M,postId:"",restaurantId:M,displayName:zt,avatarUrl:Rt,profileUrl:Ze,likes:Je,comments:jt,visitors:$t,rating:Ot,distanceKm:Xe,createdAtMs:Nt,fallbackIndex:$}};if(i.forEach((c,$)=>{w(S(c,$))}),!i.length||v.size<Ut){let c=i.length+1e3;Array.from(m.values()).forEach($=>{const M=x($,c);c+=1,M&&(v.has(M.spotId)||w(M))})}const I=Array.from(v.values()).filter(c=>{if(!b.size)return!0;const $=String(c?.restaurantId||"").trim();return!$||!b.has($)});if(!I.length)return[];const O=I.some(c=>Number.isFinite(c?.distanceKm))?I.filter(c=>Number.isFinite(c?.distanceKm)):I;if(!O.length)return[];const H=[...O].sort(gt).slice(0,jr),ae=new Set(H.map(c=>c.spotId)),be=O.filter(c=>!ae.has(c.spotId)).sort((c,$)=>{const M=ft(c.distanceKm,$.distanceKm);return M!==0?M:gt(c,$)});return[...H,...be].slice(0,Ut).map((c,$)=>({ratingDisplay:(()=>{const M=L(c?.rating);if(M>0)return Math.max(1,Math.min(5,M)).toFixed(1);const D=Math.max(1,L(c?.likes)*1.2+L(c?.visitors)*.05+L(c?.comments)*.6);return(4.2+Math.min(.75,Math.log10(1+D)/4.5)).toFixed(1)})(),...c,rank:$+1,renderSignature:[c.spotId,c.postId,c.displayName,c.avatarUrl,String($+1),String(c.rating||0),String(c.likes||0),String(c.visitors||0),Number(c.distanceKm).toFixed(3),String(c.createdAtMs||0)].join("|")}))},er=(e={},t={})=>{const r=ft(e.distanceKm,t.distanceKm);if(r!==0)return r;const o=!!e.isLive,n=!!t.isLive;return o!==n?o?-1:1:e.createdAtMs!==t.createdAtMs?t.createdAtMs-e.createdAtMs:e.fallbackIndex-t.fallbackIndex},tr=(e=[],t=[])=>{const r=Array.isArray(e)?e:[],o=Array.isArray(t)?t:[],n=r.length?r:o;if(!n.length)return[];const i=X(we()),a=Lt(i),l=G(i),d=lt(),u=new Map;n.forEach((w,S)=>{const x=Ue(w),I=x.storyRestaurantId;if(!I)return;const T=d.get(I)||null;if(a&&!qe({entry:w,restaurant:T,viewerCity:a}))return;const O=ie(T)||ie(w),H=l&&O?_e(l,O):Number.POSITIVE_INFINITY,ae=Br(w),be=ct(w),c=String(x.storyLabel||"").trim()||"Story",$=Ie(I),M=de(I,String(x.logoSource||"").trim(),"thumb",!1),D={...w,storyId:I,restaurantId:I,storyLabel:c,storyUrl:$,profileImageUrl:M,preview:be,distanceKm:H,createdAtMs:ae,isLive:!!w?.isLive,fallbackIndex:S},se=u.get(I);if(!se){u.set(I,D);return}er(D,se)<0&&u.set(I,D)});const m=Array.from(u.values());return(m.some(w=>Number.isFinite(w?.distanceKm))?m.filter(w=>Number.isFinite(w?.distanceKm)):m).sort(er).slice(0,$r)},rr=({spots:e=[],stories:t=[]}={})=>{const r=Array.isArray(e)?e:[],o=Array.isArray(t)?t:[];if(!r.length&&!o.length)return[];if(!o.length)return r.map(l=>({type:"spot",spot:l}));if(!r.length)return o.map(l=>({type:"story",story:l}));const n=[];let i=0,a=0;for(;i<r.length||a<o.length;)i<r.length&&(n.push({type:"spot",spot:r[i]}),i+=1),a<o.length&&(n.push({type:"story",story:o[a]}),a+=1);return n},Qr=({spots:e=[],stories:t=[]}={})=>rr({spots:e,stories:t}).map(r=>{if(r.type==="spot"){const o=r?.spot||{};return["spot",String(o?.spotId||"").trim(),String(o?.postId||"").trim(),String(o?.displayName||"").trim(),String(o?.avatarUrl||"").trim(),String(o?.rank||"").trim()].join(":")}return`story:${Vt(r?.story||{})}`}).join(","),or=async(e="")=>{const t=String(e||"");if(!t)return!1;try{if(y?.navigator?.clipboard?.writeText)return await y.navigator.clipboard.writeText(t),!0}catch{}if(!f?.body)return!1;const r=f.createElement("textarea");r.value=t,r.setAttribute("readonly","readonly"),r.style.position="fixed",r.style.opacity="0",r.style.pointerEvents="none",f.body.appendChild(r),r.select();let o=!1;try{o=!!f.execCommand?.("copy")}catch{}return r.remove(),o},mt=(e,t="Link kopiert")=>{if(!(e instanceof HTMLElement))return;const r=e.querySelector("[data-feed-share-label]");if(!r)return;const o=e.dataset.shareDefaultLabel||r.textContent||"Share";e.dataset.shareDefaultLabel=o,r.textContent=t,e.classList.add("text-white"),e.classList.remove("text-white/70"),e._shareFeedbackTimer&&clearTimeout(e._shareFeedbackTimer),e._shareFeedbackTimer=q(()=>{r.textContent=o,e.classList.add("text-white/70"),e.classList.remove("text-white"),e._shareFeedbackTimer=null},1800)},Xr=(e={})=>{const t={post:e?.id||""},r=String(e?.restaurantId||(String(e?.ownerType||"").trim()==="restaurant"?e?.ownerId:"")||"").trim();return r?(t.r=r,t.tab="profile"):t.tab="feed",ee("apps/menyra-social/index.html",t)},Jr=(e="")=>{const t=String(e||"").trim();if(!t)return null;const r=s.restaurants.find(l=>String(l?.id||"").trim()===t)||null,o=String(s.userProfile?.restaurantId||"").trim(),n=o&&o===t,i=String(r?.name||r?.restaurantName||r?.displayName||r?.businessName||(n?s.userProfile?.name:"")||"").trim(),a=String(r?.logoUrl||r?.logo||r?.logoURL||(n?s.userProfile?.avatar:"")||"").trim();return{id:t,restaurantName:i,name:i,logoUrl:a,logo:a}},Zr=(e="",t="")=>{const r=String(e||"").trim();if(!r||!y||!f)return;const o=Jr(r);if(o&&y.sessionStorage)try{y.sessionStorage.setItem(`${Re}${r}`,JSON.stringify({restaurantId:r,meta:o,savedAt:Date.now()}))}catch{}const n=String(t||Ie(r)||"").trim();if(!n||!f.head||Array.from(f.head.querySelectorAll("link[data-story-prefetch]")).find(l=>String(l?.getAttribute?.("href")||"").trim()===n))return;const a=f.createElement("link");a.rel="prefetch",a.href=n,a.as="document",a.crossOrigin="anonymous",a.dataset.storyPrefetch="1",f.head.appendChild(a)},eo=()=>{q(()=>{const e=f?.getElementById("postCommentInput");if(e instanceof HTMLElement){try{e.focus({preventScroll:!1})}catch{try{e.focus()}catch{}}try{e.scrollIntoView({block:"nearest",behavior:"smooth"})}catch{}if(typeof e.setSelectionRange=="function"){const t=String(e.value||"").length;try{e.setSelectionRange(t,t)}catch{}}}},90)},ye="mnyra_social_feed_viewer_location_v1",to=14,nr=3,ro=72,oo=620,no=4200,io=12e4,ao=new Set(["xk","al","rs"]),so=new Set(["city","town","village","hamlet","municipality"]),co=new Map([["xk","Kosove"],["kosove","Kosove"],["kosova","Kosove"],["kosovo","Kosove"],["al","Shqiperi"],["shqiperi","Shqiperi"],["shqiperia","Shqiperi"],["albania","Shqiperi"],["rs","Serbi"],["serbi","Serbi"],["serbia","Serbi"],["srbija","Serbi"]]),lo=new Map([["xk","xk"],["kosove","xk"],["kosova","xk"],["kosovo","xk"],["al","al"],["shqiperi","al"],["shqiperia","al"],["albania","al"],["rs","rs"],["serbi","rs"],["serbia","rs"],["srbija","rs"]]),uo=["rruga","street","bulevard","boulevard","lagj","district","neighborhood","quarter","park","mall","plaza"],pt=Object.freeze([{id:"prishtina",label:"Prishtina",lat:42.6629,lng:21.1655,aliases:["prishtine","prishtin","pristina"]},{id:"prizren",label:"Prizren",lat:42.2139,lng:20.7397,aliases:["prizr","prizreni"]},{id:"peja",label:"Peja",lat:42.6591,lng:20.2883,aliases:["peje","pec"]},{id:"gjakova",label:"Gjakova",lat:42.3803,lng:20.4308,aliases:["gjakove","djakova"]},{id:"ferizaj",label:"Ferizaj",lat:42.3706,lng:21.1553,aliases:["feri","ferizaji","uroshevac"]},{id:"gjilan",label:"Gjilan",lat:42.4635,lng:21.4699,aliases:["gjilani"]},{id:"mitrovica",label:"Mitrovica",lat:42.8914,lng:20.866,aliases:["mitrovice","mitro"]},{id:"vushtrria",label:"Vushtrria",lat:42.8231,lng:20.9675,aliases:["vushtrri"]},{id:"podujeva",label:"Podujeva",lat:42.9106,lng:21.193,aliases:["podujeve","podu"]},{id:"tirana",label:"Tirana",lat:41.3275,lng:19.8187,aliases:["tirane"],country:"Shqiperi"},{id:"kukes",label:"Kukes",lat:42.0769,lng:20.4219,aliases:["kukes albania"],country:"Shqiperi"},{id:"smederevo",label:"Smederevo",lat:44.6644,lng:20.9276,aliases:["smederevo serbia"],country:"Serbi"}]),ht=Object.freeze({xk:Object.freeze({minLat:41.85,maxLat:43.35,minLng:20,maxLng:21.85}),al:Object.freeze({minLat:39.55,maxLat:42.75,minLng:19,maxLng:21.1}),rs:Object.freeze({minLat:42.2,maxLat:46.3,minLng:18.7,maxLng:23.1})}),fo=Object.freeze({xk:Object.freeze(["prishtina","prishtine","prizren","peja","peje","gjakova","gjakove","ferizaj","gjilan","mitrovica","mitrovice","vushtrria","vushtrri","podujeva","podujeve"]),al:Object.freeze(["tirana","tirane","kukes","durres","vlore","shkoder","elbasan","fier","korce","sarande"]),rs:Object.freeze(["smederevo","beograd","belgrade","novi sad","nis","kragujevac","subotica","pancevo"])});let Ce=null,Y=!1,ue="idle",Ke="",Ae=null,oe=null,fe="",Te=null,bt=0,ge=!1,Me=null,Ye=!1,ir="",ve=!1,re=null,yt=null,ar=!1,vt=null;const ne=new Map,He=new Map,P=(e="")=>String(e||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9\s-]/g," ").replace(/\s+/g," ").trim(),St=(e="")=>{const t=P(e);return t==="current location"||t==="vendndodhja aktuale"||t==="trenutna lokacija"||t==="standort"||t==="aktueller standort"},Lt=(e=null)=>{const t=String(e?.city||"").trim();if(t&&!St(t))return t;const r=String(e?.label||"").trim();return r&&!St(r)?r:""},Se=(e="")=>{const t=P(e);return t&&lo.get(t)||""},me=(e="")=>{const t=P(e);return t&&co.get(t)||""},sr=(e=null)=>{const t=G(e);if(!t)return"";const r=Number(t.lat),o=Number(t.lng),n=(i=null)=>!!i&&r>=Number(i.minLat)&&r<=Number(i.maxLat)&&o>=Number(i.minLng)&&o<=Number(i.maxLng);return n(ht.xk)?"xk":n(ht.al)?"al":n(ht.rs)?"rs":""},go=()=>{if(vt instanceof Map)return vt;const e=new Map,t=(r="",o="")=>{const n=P(r),i=Se(o);!n||!i||e.set(n,i)};return Object.entries(fo).forEach(([r,o])=>{(Array.isArray(o)?o:[]).forEach(n=>t(n,r))}),xt().forEach(r=>{const o=Se(r?.countryCode||r?.country);o&&(t(r?.label,o),t(r?.city,o),(Array.isArray(r?.searchTerms)?r.searchTerms:[]).forEach(n=>t(n,o)))}),vt=e,e},mo=(...e)=>{const t=go();for(const r of e){const o=Se(r);if(o)return o;const n=P(r);if(!n)continue;const i=t.get(n);if(i)return i;const a=n.split(" ").filter(Boolean);for(const l of a){const d=t.get(l);if(d)return d}}return""},Le=(e=null)=>!e||typeof e!="object"?"":Se(e?.countryCode||e?.country_code||e?.country||e?.geo?.countryCode||e?.geo?.country_code||e?.geo?.country||e?.coords?.countryCode||e?.coords?.country||e?.location?.countryCode||e?.location?.country||"")||mo(e?.country,e?.geo?.country,e?.coords?.country,e?.location?.country,e?.city,e?.geo?.city,e?.coords?.city,e?.location?.city,e?.label,e?.address,e?.location)||sr(e),ie=(e=null)=>!e||typeof e!="object"?null:G(e)||G({lat:e?.latitude,lng:e?.longitude})||G({lat:e?.gpsLat,lng:e?.gpsLng})||G({lat:e?.geo?.lat,lng:e?.geo?.lng})||G({lat:e?.geo?.latitude,lng:e?.geo?.longitude})||G({lat:e?.coords?.lat,lng:e?.coords?.lng})||G({lat:e?.coords?.latitude,lng:e?.coords?.longitude})||G({lat:e?.location?.lat,lng:e?.location?.lng}),_e=(e=null,t=null)=>{const r=G(e),o=G(t);if(!r||!o)return Number.POSITIVE_INFINITY;const n=6371,i=S=>S*Math.PI/180,a=i(Number(o.lat)-Number(r.lat)),l=i(Number(o.lng)-Number(r.lng)),d=i(Number(r.lat)),u=i(Number(o.lat)),m=Math.sin(a/2),b=Math.sin(l/2),v=m*m+Math.cos(d)*Math.cos(u)*b*b,w=2*Math.atan2(Math.sqrt(v),Math.sqrt(1-v));return n*w},G=(e=null)=>{const t=Number(e?.lat??e?.latitude??e?.y),r=Number(e?.lng??e?.lon??e?.longitude??e?.x);return!Number.isFinite(t)||!Number.isFinite(r)?null:{lat:t,lng:r}},X=(e=null)=>{const t=G(e);if(!t)return null;const r=String(e?.label||e?.city||"").trim(),n=String(e?.city||"").trim()||(St(r)?"":r),i=String(e?.source||"").trim().toLowerCase(),a=Le({...e&&typeof e=="object"?e:{},lat:t.lat,lng:t.lng,label:r,city:n}),l=me(e?.country||e?.countryCode||e?.country_code||a)||me(a)||"";return{lat:t.lat,lng:t.lng,label:r,city:n,country:l,countryCode:a,source:i||"manual",savedAt:Number(e?.savedAt||Date.now())||Date.now()}},po=()=>{if(!y?.localStorage)return null;try{const e=y.localStorage.getItem(ye);if(!e)return null;const t=X(JSON.parse(e));if(t)return t;try{y.localStorage.removeItem(ye)}catch{}return null}catch{try{y.localStorage.removeItem(ye)}catch{}return null}},ho=()=>{if(!y?.localStorage)return null;try{return y.localStorage.getItem(ye)!==null}catch{return null}},cr=(e=null)=>{if(y?.localStorage){if(!e){try{y.localStorage.removeItem(ye)}catch{}return}try{y.localStorage.setItem(ye,JSON.stringify(e))}catch{}}},we=()=>{const e=X(Ce),t=po();if(t){if(Ce=t,typeof E=="function")try{E({lat:t.lat,lng:t.lng,label:t.label,city:t.city,source:t.source,savedAt:t.savedAt})}catch{}return t}const r=ho();if(e&&r!==!1)return e;if(r===!1&&(Ce=null),typeof _!="function")return null;let o=null;try{o=_()}catch{}const n=X({...o&&typeof o=="object"?o:{},source:"gps-map"});return n?(Ce=n,cr(n),n):null},bo=(e=null)=>{const t=X(e);if(!t)return!1;if(Ce=t,cr(t),typeof E=="function")try{E({lat:t.lat,lng:t.lng,label:t.label,city:t.city,source:t.source,savedAt:t.savedAt})}catch{}return!0},lr=()=>{if(Ae){try{clearTimeout(Ae)}catch{}Ae=null}},dr=()=>{if(lr(),oe)try{oe.abort()}catch{}Te=null,oe=null,fe=""},ur=(e="",t=[])=>{const r=P(e);if(!r)return;const o=Array.isArray(t)?t:[];for(ne.set(r,o);ne.size>ro;){const n=ne.keys().next().value;if(!n)break;ne.delete(n)}He.size>oo&&He.clear(),o.forEach(n=>{He.set(String(n?.id||"").trim().toLowerCase(),n)})},wt=()=>{if(Me){try{clearTimeout(Me)}catch{}Me=null}},We=(e=!1)=>{const t=!!e,r=f?.documentElement||null,o=f?.body||null;r?.classList?.toggle?.("feed-location-gate-resolving",t),o?.classList?.toggle?.("feed-location-gate-resolving",t);try{const n=y?.__MENYRA_SOCIAL_SET_UI_CHROME_MODE__;t&&typeof n=="function"&&n("app");const i=y?.__MENYRA_SOCIAL_FORCE_UI_CHROME__;typeof i=="function"&&i()}catch{}},je=()=>{if(re){if(typeof y?.cancelAnimationFrame=="function")try{y.cancelAnimationFrame(re)}catch{}else try{clearTimeout(re)}catch{}re=null}},yo=()=>{if(!y||!f)return null;const e=f.querySelector("main.app-main-scroll");if(!(e instanceof HTMLElement))return null;const t=y.getComputedStyle?.(e),r=String(t?.overflowY||t?.overflow||"").trim().toLowerCase(),o=r==="auto"||r==="scroll"||r==="overlay",n=Number(e.scrollHeight||0)-Number(e.clientHeight||0)>1;return!o||!n?null:e},vo=({behavior:e="smooth"}={})=>{if(!y||!f)return!1;const t=f.getElementById("feedLocationGate");if(!(t instanceof HTMLElement))return!1;const r=t.querySelector(".feed-bento-pin-outline");if(!(r instanceof HTMLElement))return!1;const o=yo(),n=o instanceof HTMLElement,i=Math.max(0,Math.round(parseFloat(y.getComputedStyle?.(r)?.top||"0")||0)),a=n?Math.round(Number(o.getBoundingClientRect().top||0)):0,l=n?Math.max(0,Number(o.scrollTop||0)):Math.max(0,Number(y.scrollY||y.pageYOffset||f?.documentElement?.scrollTop||0)),d=Math.round(Number(r.getBoundingClientRect().top||0)),u=Math.max(0,l+(d-(a+i)));if(Math.abs(u-l)<2)return!0;if(n){try{o.scrollTo({top:u,behavior:e})}catch{o.scrollTop=u}return!0}try{y.scrollTo({top:u,behavior:e})}catch{y.scrollTo(0,u)}return!0},fr=()=>{if(!ve)return;ve=!1,je();let e=0;const t=4,r=4,o=()=>{if(e+=1,vo({behavior:e===1?"smooth":"auto"}),e>=t){je();return}re=q(o,e===1?420:130)};if(typeof y?.requestAnimationFrame=="function"){let n=0;const i=()=>{re=y.requestAnimationFrame(()=>{if(n+=1,n<r){i();return}re=null,o()})};i();return}re=q(()=>{re=null,o()},80)},gr=()=>{if(je(),typeof yt=="function")try{yt()}catch{}yt=null},So=(e=null)=>{gr()},mr=(e={})=>{const t=me(e?.countryCode||e?.country_code||"");if(t)return t;const r=me(e?.country||"");return r||(String(e?.source||"").trim().toLowerCase()==="local"?"Kosove":String(e?.country||"").trim())},pr=({id:e="",label:t="",lat:r=null,lng:o=null,aliases:n=[],source:i="local",country:a="",metaLabel:l="",importance:d=0}={})=>{const u=G({lat:r,lng:o}),m=String(t||"").trim();if(!u||!m)return null;const b=String(i||"local").trim().toLowerCase(),v=Se(a),w=me(a)||me(v)||(b==="local"?"Kosove":""),S=Array.from(new Set([m,w,v,...Array.isArray(n)?n:[]].map(x=>P(x)).filter(Boolean)));return Object.freeze({id:String(e||m).trim().toLowerCase(),label:m,city:m,lat:u.lat,lng:u.lng,source:b,country:w,countryCode:v,metaLabel:String(l||"").trim(),importance:Number(d)||0,searchTerms:S})},xt=()=>pt.map(e=>pr(e)).filter(Boolean),hr=(e="")=>{const t=String(e||"").trim().toLowerCase();if(!t)return null;const r=xt().find(o=>o.id===t)||null;return r||He.get(t)||null},Lo=(e="")=>{const t=P(e);if(!t||/[0-9]/.test(t))return!1;const r=t.split(" ").filter(Boolean);return!r.length||r.length>3?!1:!r.some(o=>uo.some(n=>o.startsWith(n)))},wo=(e={},t="")=>{if(!e||!t)return-1;const r=Array.isArray(e.searchTerms)?e.searchTerms:[];let o=-1;return r.forEach(n=>{if(!n)return;if(n===t){o=Math.max(o,420);return}if(n.startsWith(t)){o=Math.max(o,260-Math.max(0,n.length-t.length));return}const i=n.indexOf(t);i>=0&&(o=Math.max(o,170-i))}),o<0?-1:(String(e?.source||"").toLowerCase()==="remote"&&(o+=12+Math.round(Math.max(0,Number(e.importance||0)*10))),o)},xo=(...e)=>{const t=new Map;return e.forEach(r=>{(Array.isArray(r)?r:[]).forEach(o=>{if(!o||typeof o!="object")return;const n=`${P(o.label)}|${P(mr(o))}`;if(!n.trim())return;if(!t.has(n)){t.set(n,o);return}const i=t.get(n);String(i?.source||"").trim().toLowerCase()!=="local"&&t.set(n,o)})}),Array.from(t.values())},Io=(e=[])=>Array.isArray(e)?e.map((t,r)=>{const o=t?.properties&&typeof t.properties=="object"?t.properties:{},n=G({lat:t?.geometry?.coordinates?.[1],lng:t?.geometry?.coordinates?.[0]}),i=String(o.name||o.city||o.locality||"").trim();if(!n||!i||!Lo(i))return null;const a=Se(o.countrycode||o.country_code||o.country||"");if(!a||!ao.has(a))return null;const l=P(o.osm_value||o.type||"");if(!so.has(l))return null;const d=me(a)||"",m=[String(o.state||o.county||"").trim(),d].filter(Boolean).join(" · ");return pr({id:`remote-${String(o.osm_id||`${i}-${a}-${r}`).trim().toLowerCase()}`,label:i,lat:n.lat,lng:n.lng,aliases:[o.city,o.state,o.county,d].filter(Boolean),source:"remote",country:a,metaLabel:m,importance:Number(o.importance||t?.importance||0)})}).filter(Boolean):[],ko=async(e="")=>{const t=String(e||"").trim(),r=P(t);if(r.length<nr)return[];if(ne.has(r))return ne.get(r)||[];if(Te&&fe===r)return Te;if(Date.now()<bt)return[];const o=typeof y?.fetch=="function"?y.fetch.bind(y):null;if(!o)return[];if(oe&&fe&&fe!==r)try{oe.abort()}catch{}const n=typeof AbortController=="function"?new AbortController:null;let i=null;oe=n,fe=r,n&&(i=q(()=>{try{n.abort()}catch{}},no));const a=new URL("https://photon.komoot.io/api/");a.searchParams.set("limit",String(to)),a.searchParams.set("lang","en"),a.searchParams.set("osm_tag","place"),a.searchParams.set("q",t);const l=(async()=>{try{const d=await o(a.toString(),{method:"GET",signal:n?.signal,headers:{"Accept-Language":"sq,sr,de,en"}});if(!d?.ok)throw new Error(`photon_${Number(d?.status||0)}`);const u=await d.json(),m=Array.isArray(u?.features)?u.features:[],b=Io(m);return ur(r,b),bt=0,b}catch(d){return String(d?.name||"")!=="AbortError"&&(bt=Date.now()+io,ur(r,[])),[]}finally{if(i)try{clearTimeout(i)}catch{}oe===n&&fe===r&&(oe=null,fe="",Te=null)}})();return Te=l,l},It=(e="",t=6)=>{const r=P(e);if(r.length<2)return[];const o=xt(),n=ne.get(r)||[];return xo(o,n).map(a=>{const l=wo(a,r);return l<0?null:{...a,score:l}}).filter(Boolean).sort((a,l)=>Number(l.score||0)-Number(a.score||0)||String(a.label||"").localeCompare(String(l.label||""),"de")).slice(0,Math.max(1,Number(t)||6))},Eo=(e=[])=>{const t=Array.isArray(e)?e:[];return t.length?t.map(r=>`
  ...
  `,$o=(e=$e())=>{const t=e?.socialBlock||{};return`
    ...
    `};function Oo({mode:e=vr(),bentoContentHtml:t="",showSearchControls:r=!0,showTopSection:o=!0}={}){const n=$e(),i=we(),a=String(i?.label||i?.city||"").trim(),l=String(e||"feed-gate").trim().toLowerCase()||"feed-gate",d=r!==!1,u=o!==!1,m=String(t||wr(n)).trim();return`
    ...
    `:""}function zo(){return`
      <div class="flex-none w-[29%] sm:w-[120px] snap-start ml-5" style="${Be({withMarginLeft:!0})}">
    ...
    `}function Po(e={},t=0){const r=String(e?.spotId||e?.postId||"").trim(),o=p(r),n=o?`data-best-spot-avatar="${o}"`:"",i=o?`data-img-key="best-spot-avatar:${o}"`:"",a=o?`data-best-spot-name="${o}"`:"",l=String(e?.profileUrl||ee("apps/menyra-social/index.html",{tab:"feed",source:"best-spot"})).trim(),d=String(e?.restaurantId||"").trim(),u=String(e?.avatarUrl||"").trim(),m=String(e?.displayName||"Best Spot").trim()||"Best Spot",b=t<4,v=String(e?.ratingDisplay||"4.8").trim()||"4.8",w=b?'loading="eager" fetchpriority="high"':'loading="lazy" fetchpriority="low"',S='<svg viewBox="0 0 24 24" width="8" height="8" aria-hidden="true" focusable="false" style="display:block;color:#fbbf24;fill:currentColor;stroke:currentColor;stroke-width:1.5;"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>',x=u?`<img src="${p(h(u,"small"))}" ${w} decoding="async" width="120" height="208" ${n} ${i} class="absolute inset-0 w-full h-full object-cover" />`:`<div class="absolute inset-0 flex items-center justify-center text-white/85" style="background:linear-gradient(145deg,#1f2937 0%,#0f172a 60%,#020617 100%);">${B("map-pin","w-6 h-6")}</div>`,I=d?`<button type="button" data-profile-business="${p(m)}" data-profile-id="${p(d)}" data-best-spot-item="${o}" class="flex-none w-[29%] sm:w-[120px] snap-start cursor-pointer text-left" style="${Be()}">`:`<a href="${p(l)}" data-best-spot-item="${o}" class="flex-none w-[29%] sm:w-[120px] snap-start cursor-pointer" style="${Be()}">`,T=d?"</button>":"</a>";return`
      ${I}
      ...
      ${T}
    `}function Ro(e={},t=0,r=""){const o=ct(e),n=t<5;if(o.kind==="video"&&o.src){const i=n?'preload="auto" fetchpriority="high"':'preload="metadata" fetchpriority="low"',a=o.poster?`poster="${p(h(o.poster,"small"))}"`:"",l=r?`data-story-preview-id="${p(r)}"`:"";return`
        ...
        <div class="relative h-52 rounded-2xl overflow-hidden shadow-md" style="${st()}">
          ...
          <div class="absolute top-2 right-2" style="position:absolute;top:0.5rem;right:0.5rem;z-index:12;">
            <div class="w-7 h-7 rounded-full p-[2px] bg-gradient-to-tr from-amber-500 to-fuchsia-600 shadow-sm" ${w} style="padding:2px;background:linear-gradient(135deg,#f59e0b 0%,#db2777 100%);">
              <img src="${p(u)}" ${O} decoding="async" width="28" height="28" ${b} ${v} class="w-full h-full rounded-full border-[1.5px] border-black/60 object-cover bg-white" style="border:1.5px solid rgba(0,0,0,0.6);" />
            </div>
          </div>
          <div class="absolute bottom-2 left-2 right-2" style="position:absolute;left:0.5rem;right:0.5rem;bottom:0.5rem;z-index:12;">
    ...
    `}function Qe(e,t){const r=e.id?String(e.id):"",o=r?`data-post-like-count="${p(r)}"`:"",n=r?`data-post-comment-count="${p(r)}"`:"",i=r?`data-feed-id="${p(r)}"`:'data-feed-id=""',a=r?`data-feed-logo="${p(r)}"`:"",l=r?`data-img-key="feed-logo:${p(r)}"`:"",d=r?`data-img-key="feed-hero:${p(r)}"`:"",u=`data-feed-render-sig="${p(qt(e))}"`,m=t<2,b=m?'loading="eager" fetchpriority="high"':'loading="lazy" fetchpriority="low"',v=m?'loading="eager"':'loading="lazy" fetchpriority="low"',w=s.restaurants.find(be=>be.id===(e.restaurantId||e.ownerId))||{},S=w.logoUrl||w.logo||e.logo||"",x=de(e.restaurantId||e.ownerId,S,"avatar"),I=h(e.image,"medium",{stableKey:r?`feed-hero:${r}`:""}),T=p(`${h(e.image,"small")} 480w, ${I} 768w, ${h(e.image,"large")} 1280w`),O="(max-width: 640px) 100vw, 600px",H=e.poster?h(e.poster,"medium",{stableKey:r?`feed-hero-poster:${r}`:""}):I,ae=e.isVideo&&e.videoUrl?`<video src="${p(e.videoUrl)}" poster="${p(H)}" autoplay muted loop playsinline preload="none" ${d} class="w-full h-full block object-cover group-hover:scale-105 transition-transform duration-1000"></video>`:`<img src="${p(I)}" srcset="${T}" sizes="${O}" ${b} ${d} decoding="async" class="w-full h-full block object-cover group-hover:scale-105 transition-transform duration-1000" />`;return`
