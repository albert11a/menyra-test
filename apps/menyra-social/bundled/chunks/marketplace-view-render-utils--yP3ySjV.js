const I=Object.freeze({restaurants:Object.freeze({key:"restaurants",title:"Restaurants",emptyTitle:"Noch keine Restaurants",emptyBody:"Keine passenden Profile gefunden.",icon:"utensils",typeKeys:Object.freeze(["restaurant","cafe","coffee","fastfood","food"])}),travel:Object.freeze({key:"travel",title:"Travel",emptyTitle:"Noch keine Travel-Profile",emptyBody:"Keine passenden Profile gefunden.",icon:"plane",typeKeys:Object.freeze(["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"])}),shopping:Object.freeze({key:"shopping",title:"Shopping",emptyTitle:"Noch keine Shopping-Profile",emptyBody:"Keine passenden Profile gefunden.",icon:"shopping-bag",typeKeys:Object.freeze(["ecommerce"])})}),G=new Map;Object.values(I).forEach(e=>{e.typeKeys.forEach(t=>{G.set(t,e.key)})});const Y=8,A=24,re="#ff4f3f",ce="mnyra_social_feed_viewer_location_v1",T="#00cce5",X=35,ue=Object.freeze([Object.freeze({label:"Prishtina",lat:42.6629,lng:21.1655}),Object.freeze({label:"Prizren",lat:42.2139,lng:20.7397}),Object.freeze({label:"Peja",lat:42.6591,lng:20.2883}),Object.freeze({label:"Gjakova",lat:42.3803,lng:20.4308}),Object.freeze({label:"Ferizaj",lat:42.3706,lng:21.1553}),Object.freeze({label:"Gjilan",lat:42.4635,lng:21.4699}),Object.freeze({label:"Mitrovica",lat:42.8914,lng:20.866}),Object.freeze({label:"Vushtrria",lat:42.8231,lng:20.9675}),Object.freeze({label:"Podujeva",lat:42.9106,lng:21.193}),Object.freeze({label:"Tirana",lat:41.3275,lng:19.8187}),Object.freeze({label:"Kukes",lat:42.0769,lng:20.4219}),Object.freeze({label:"Smederevo",lat:44.6644,lng:20.9276})]),pe=Object.freeze([Object.freeze(["tirana","tirane"]),Object.freeze(["durres","durresi"]),Object.freeze(["vlora","vlore"]),Object.freeze(["shkoder","shkodra"]),Object.freeze(["shengjin","shëngjin","shen gjin","shengjini"]),Object.freeze(["ksamil","ksamili"]),Object.freeze(["dhermi","dhërmi","dhermiu"]),Object.freeze(["velipoje","velipojë","velipoja"]),Object.freeze(["theth","thethi"]),Object.freeze(["valbone","valbonë","valbona"]),Object.freeze(["elbasan","elbasani"]),Object.freeze(["fier","fieri"]),Object.freeze(["korce","korca"]),Object.freeze(["sarande","saranda"]),Object.freeze(["berat","berati"]),Object.freeze(["gjirokaster","gjirokastra"]),Object.freeze(["kukes","kukesi"]),Object.freeze(["lezhe","lezha"]),Object.freeze(["pogradec","pogradeci"]),Object.freeze(["kruje","kruja"]),Object.freeze(["fushe kruje","fushë krujë","fushe-kruje","fush kruje"]),Object.freeze(["lushnje","lushnja"]),Object.freeze(["himare","himarë","himara"]),Object.freeze(["kavaje","kavajë","kavaja"]),Object.freeze(["kamze","kamëz","kamza"]),Object.freeze(["vore","vorë","vora"]),Object.freeze(["divjake","divjakë","divjaka"]),Object.freeze(["permet","përmet","permeti"]),Object.freeze(["tepelene","tepelenë","tepelena"]),Object.freeze(["delvine","delvinë","delvina"]),Object.freeze(["peshkopi","peshkopia","diber","dibër"]),Object.freeze(["burrel","burreli","mat"]),Object.freeze(["puke","pukë","puka"]),Object.freeze(["bajram curri","bajramcurri","tropoje","tropojë"]),Object.freeze(["krume","krumë","has"]),Object.freeze(["lac","laç","kurbin"]),Object.freeze(["orikum","orikumi"]),Object.freeze(["golem","golemi"]),Object.freeze(["jale","jalë","jali"]),Object.freeze(["qepare","qeparo","qeparoi"]),Object.freeze(["borsh","borshi"]),Object.freeze(["lukove","lukovë","lukova"]),Object.freeze(["palase","palasë","palasa"]),Object.freeze(["drimadhe","drymades","drimadhes"]),Object.freeze(["spille","spilleja"]),Object.freeze(["gjiri i lalzit","lalzi","lalez","lalëz"])]),fe=Object.freeze([Object.freeze(["prishtina","prishtine","prishtin","pristina"]),Object.freeze(["ferizaj","ferizaji","uroshevac"]),Object.freeze(["peja","peje","pec"]),Object.freeze(["prizren","prizreni"]),Object.freeze(["gjakova","gjakove","djakova"]),Object.freeze(["gjilan","gjilani"]),Object.freeze(["mitrovica","mitrovice"]),Object.freeze(["vushtrria","vushtrri"]),Object.freeze(["podujeva","podujeve","podujevo","besiana"]),Object.freeze(["fushe kosove","fushe kosova","fush kosove","fush kosova"]),Object.freeze(["lipjan"]),Object.freeze(["suhareka","suhareke","theranda"]),Object.freeze(["rahovec","rahoveci"]),Object.freeze(["drenas","gllogoc"]),Object.freeze(["skenderaj","skenderaji"]),Object.freeze(["malisheva","malisheve"]),Object.freeze(["kamenica","kamenice","kamenica kosove"]),Object.freeze(["decan","decani"]),Object.freeze(["istog","istogu"]),Object.freeze(["klina","kline"]),Object.freeze(["vite","vitia"]),Object.freeze(["hani i elezit","hani elezit"])]),Z=Object.freeze(["city","locationCity","primaryCity","postalCity","address","primaryAddress","formattedAddress","fullAddress","addressText","streetAddress","street","locationLabel","displayLocation","locality","town","municipality","village","neighborhood","area","district","county","region","state","province","country","countryCode"]),V=Object.freeze([...Z,"label","name","title"]),be=Object.freeze(["location","primaryLocation","businessLocation","venueLocation","addressInfo","place","geo","coords","coordinates","geoPoint"]);function q(e,t=()=>""){return typeof e=="function"?e:t}function o(e=""){return String(e||"").trim()}function x(e=""){const t=o(e).toLowerCase();return t?t.replace(/[ëèéê]/g,"e").replace(/[çćč]/g,"c").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/&/g,"and").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,""):""}function J(e=""){const t=x(e);if(!t)return[];const a=new Set([t]);return pe.forEach(n=>{const s=n.map(x).filter(Boolean);s.includes(t)&&s.forEach(i=>a.add(i))}),Array.from(a)}function ge(e=""){const t=x(e);if(!t)return[];const a=new Set(J(e));return fe.forEach(n=>{const s=n.map(x).filter(Boolean);s.includes(t)&&s.forEach(i=>a.add(i))}),Array.from(a)}function Q(e=""){const t=x(e);return t==="restaurant"?"restaurants":["hotel","hotels","motel","motels"].includes(t)?"travel":["shop","ecommerce","e_commerce","shopping"].includes(t)?"shopping":I[t]?t:"restaurants"}function W(e=""){const t=x(e);return t?t==="e_commerce"||t==="online_shop"||t==="onlineshop"||t==="shop"||t==="store"?"ecommerce":t==="coffee"||t==="coffe"||t==="coffee_shop"||t==="coffeeshop"||t==="kaffee"||t==="caffe"?"cafe":t==="fast_food"||t==="snack"||t==="imbiss"?"fastfood":t==="hotels"?"hotel":t==="motels"?"motel":t:""}function de(e={}){return[e.type,e.customerType,e.restaurantType,e.businessProfileType,e.profileType,e.catalogMode,e.category,e.kind,e.vertical,e.leadType]}function N(e={},{normalizeRestaurantType:t,normalizeLeadTypeKey:a}={}){const n=typeof t=="function"?t:(r=>r),s=typeof a=="function"?a:(r=>r),i=de(e);for(const r of i){const c=W(n(r)||s(r)||r);if(c)return c}const l=[e.name,e.restaurantName,e.businessName,e.description,e.bio].map(r=>o(r).toLowerCase()).join(" ");return/\bhotel(s)?\b/.test(l)?"hotel":/\bmotel(s)?\b/.test(l)?"motel":/\bcoffee\b|\bcoffe\b|\bcafe\b|\bcaffe\b/.test(l)?"cafe":/\bfast\s*food\b|\bfastfood\b/.test(l)?"fastfood":/\be-?commerce\b|\bonline\s*shop\b/.test(l)?"ecommerce":/\brestaurant\b|\brestoran\b|\bpizza\b|\bpizzeria\b/.test(l)?"restaurant":""}function me(e={},t={}){const a=N(e,t);return G.get(a)||""}function j(e={}){return o(e.canonicalRestaurantId||e.restaurantId||e.id||e.landingRestaurantId||"")}function k(e={}){return o(e.name||e.restaurantName||e.businessName||e.displayName||"Business")}function _(e={}){const t=o(e.city||e.locationCity||e.primaryCity),a=o(e.address||e.location||e.primaryAddress);return t&&a&&t!==a?`${t} - ${a}`:t||a||R(e)||o(e.country||e.region||"")||"Standort folgt"}function F(e={}){const t=Number(String(e?.lat??e?.latitude??"").replace(",",".")),a=Number(String(e?.lng??e?.lon??e?.longitude??"").replace(",","."));return!Number.isFinite(t)||!Number.isFinite(a)||Math.abs(t)>90||Math.abs(a)>180||Math.abs(t)<1e-6&&Math.abs(a)<1e-6?null:{lat:t,lng:a}}function ee(e={},t={}){const a=Number(e.lat),n=Number(e.lng),s=Number(t.lat),i=Number(t.lng);if(![a,n,s,i].every(Number.isFinite))return Number.POSITIVE_INFINITY;const l=h=>h*Math.PI/180,r=6371,c=l(s-a),p=l(i-n),b=Math.sin(c/2),f=Math.sin(p/2),u=b*b+Math.cos(l(a))*Math.cos(l(s))*f*f;return 2*r*Math.atan2(Math.sqrt(u),Math.sqrt(Math.max(0,1-u)))}function R(e={}){const t=L(e);if(!t)return"";const a=ue.map(n=>({label:n.label,distanceKm:ee(t,n)})).filter(n=>Number.isFinite(n.distanceKm)).sort((n,s)=>n.distanceKm-s.distanceKm)[0];return a&&a.distanceKm<=X?a.label:"Auf Karte markiert"}function he(e={}){const t=[e.id,e.restaurantId,e.canonicalRestaurantId,e.publicSlug,e.landingSlug,e.handle,e.type,e.customerType,e.restaurantType,e.businessProfileType,e.profileType,e.catalogMode,e.category,e.kind,e.vertical,e.leadType,e.city,e.locationCity,e.primaryCity,e.address,e.location,e.primaryAddress,R(e),e.country,e.region,e.district,e.name,e.restaurantName,e.businessName,e.displayName,e.description,e.bio,e.about];return Array.isArray(e.locations)&&e.locations.forEach(a=>{!a||typeof a!="object"||t.push(a.city,a.address,a.country,a.region,a.name)}),t}function ve(e={},t=""){const a=J(t);if(!a.length)return!0;const n=he(e).map(x).filter(Boolean).join("_");return a.some(s=>{const i=s.split("_").filter(Boolean);return n.includes(s)?!0:i.length>0&&i.every(l=>n.includes(l))})}function C(e=[],t=""){if(typeof t=="string"||typeof t=="number"){const a=o(t);a&&e.push(a)}}function P(e=[],t={},a=Z){!t||typeof t!="object"||a.forEach(n=>C(e,t[n]))}function xe(e={}){const t=[];return P(t,e),C(t,e.location),C(t,R(e)),be.forEach(a=>{P(t,e[a],V)}),Array.isArray(e.locations)&&e.locations.forEach(a=>{!a||typeof a!="object"||(P(t,a,V),C(t,R(a)))}),t}function ye(e={},t=""){const a=ge(t);if(!a.length)return!1;const n=xe(e).map(x).filter(Boolean).join("_");return n?a.some(s=>{const i=s.split("_").filter(Boolean);return n.includes(s)||i.length>0&&i.every(l=>n.includes(l))}):!1}function we(e={},t=null){if(!t)return!0;const a=o(t.city||t.label||"");if(a&&ye(e,a))return!0;const n=F(t),s=L(e);return n&&s?ee(n,s)<=X:!a&&!n}function L(e={}){const t=[{lat:e.lat,lng:e.lng},{lat:e.latitude,lng:e.longitude},{lat:e.latitude,lng:e.lon},{lat:e._lat,lng:e._long},{lat:e._latitude,lng:e._longitude},{lat:e.gpsLat,lng:e.gpsLng},{lat:e.mapLat,lng:e.mapLng},{lat:e.geo?.lat,lng:e.geo?.lng},{lat:e.geo?.latitude,lng:e.geo?.longitude},{lat:e.geo?.latitude,lng:e.geo?.lon},{lat:e.coords?.lat,lng:e.coords?.lng},{lat:e.coords?.latitude,lng:e.coords?.longitude},{lat:e.coordinates?.lat,lng:e.coordinates?.lng},{lat:e.coordinates?.latitude,lng:e.coordinates?.longitude},{lat:e.coordinates?._lat,lng:e.coordinates?._long},{lat:e.coordinates?._latitude,lng:e.coordinates?._longitude},{lat:e.geoPoint?.lat,lng:e.geoPoint?.lng},{lat:e.geoPoint?.latitude,lng:e.geoPoint?.longitude},{lat:e.geoPoint?._lat,lng:e.geoPoint?._long},{lat:e.geoPoint?._latitude,lng:e.geoPoint?._longitude},{lat:e.geopoint?.lat,lng:e.geopoint?.lng},{lat:e.geopoint?.latitude,lng:e.geopoint?.longitude},{lat:e.geopoint?._lat,lng:e.geopoint?._long},{lat:e.geopoint?._latitude,lng:e.geopoint?._longitude},{lat:e.location?.lat,lng:e.location?.lng},{lat:e.location?.latitude,lng:e.location?.longitude},{lat:e.primaryLocation?.lat,lng:e.primaryLocation?.lng},{lat:e.primaryLocation?.latitude,lng:e.primaryLocation?.longitude},{lat:e.businessLocation?.lat,lng:e.businessLocation?.lng},{lat:e.businessLocation?.latitude,lng:e.businessLocation?.longitude}];for(const a of t){const n=F(a);if(n)return n}if(Array.isArray(e.locations))for(const a of e.locations){const n=L(a||{});if(n)return n}return null}function te(e={}){const t=e.openingHours||e.openHours||e.hours||e.businessHours||e.workingHours||"";if(typeof t=="string"&&o(t))return o(t);if(t&&typeof t=="object"){const a=Object.values(t).map(o).filter(Boolean);if(a.length)return a[0]}return"Oeffnungszeiten folgen"}function ke(e={}){return o(e.phone||e.telephone||e.contactPhone||e.ownerPhone||"")}function je(e={}){return o(e.description||e.bio||e.about||e.shortDescription||"")}function B(e={}){const t=Number(e.rating??e.avgRating??e.score??e.publicRating??0);return!Number.isFinite(t)||t<=0?"":Math.min(5,Math.max(1,t)).toFixed(1)}function E(e={},{getOptimizedImageUrl:t,resolveRestaurantLogo:a,placeholderImage:n=""}={}){const s=j(e),i=o(e.logoUrl||e.logo||e.logoURL||e.heroUrl||e.coverUrl||e.imageUrl||e.img||""),r=(s&&typeof a=="function"?o(a(s,i,"medium")):i)||i||n;return(typeof t=="function"?o(t(r,"medium")):r)||n||""}function ae(e={},{getOptimizedImageUrl:t,placeholderImage:a=""}={}){const s=o(e.titleImageUrl||e.coverImageUrl||e.coverImage||e.coverUrl||e.heroImageUrl||e.heroUrl||e.imageUrl||e.bestSpotLogoUrl||e.spotLogoUrl||e.logoUrl||e.logo||"")||a;return(typeof t=="function"?o(t(s,"large")):s)||a||""}function S(e){if(Array.isArray(e))return e.map(o).filter(Boolean);const t=o(e);return t?t.split(/[\n,;|]/).map(o).filter(Boolean):[]}function ze(e={},t={}){const a=[...S(e.coverImages),...S(e.hotelCoverImages),...S(e.titleImages),e.titleImageUrl,e.coverImageUrl,e.coverImage,e.coverUrl,e.heroImageUrl,e.heroUrl,e.imageUrl].map(o).filter(Boolean),n=[];a.forEach(l=>{n.includes(l)||n.push(l)});const s=ae(e,t);s&&!n.includes(s)&&n.push(s);const i=n.map(l=>typeof t.getOptimizedImageUrl=="function"?o(t.getOptimizedImageUrl(l,"large")):l).filter(Boolean);return i.length?i.slice(0,5):[t.placeholderImage||""].filter(Boolean)}function $e(e={}){return o(e.cuisine||e.kitchen||e.foodType||e.categoryLabel||e.__marketplaceTypeLabel||e.type||e.customerType||"")}function Te(e={}){return o(e.priceRange||e.priceLevel||e.priceLabel||e.budget||"")}function H(e,t=""){return typeof e=="string"?o(e):e===!0?o(t):""}function ne(e={}){const t=e.restaurantFeatures&&typeof e.restaurantFeatures=="object"?e.restaurantFeatures:{},a=[H(e.gardenTerraceText||e.gardenTerrace||e.gardenOrTerrace||t.gardenTerrace,"Gastgarten"),H(e.accessibilityText||e.barrierFreeText||e.accessibleText||e.barrierefrei||e.accessible||t.accessibility,"Barrierefrei"),H(e.veganOptionsText||e.veganOptions||e.veganText||e.vegan||t.veganOptions,"Vegane Optionen")].filter(Boolean);if(a.length)return a.slice(0,3);const n=Array.isArray(e.features)?e.features.map(o).filter(Boolean):[];if(n.length)return n.slice(0,3);const s=o(e.features||e.amenities||"");return s?s.split(/[,;|]/).map(o).filter(Boolean).slice(0,3):[]}function Oe(e={}){return o(e.hotelCategory||e.categoryLabel||e.__marketplaceTypeLabel||e.travelCategory||e.typeLabel||e.type||e.customerType||"Hotel")}function _e(e={}){return o(e.distanceCenter||e.distanceToCenter||e.centerDistance||e.cityCenterDistance||e.centerDistanceLabel||e.zentrumEntfernung||e.distanceCentre||"")}function Le(e={}){return o(e.distanceBeach||e.distanceToBeach||e.beachDistance||e.beachDistanceLabel||e.strandEntfernung||e.lakeDistance||e.distanceToLake||"")}function Ce(e={}){return o(e.hotelStartingPrice||e.startingPrice||e.priceFrom||e.fromPrice||e.bestPrice||e.roomStartingPrice||"").replace(/^\s*ab\s+/i,"").replace(/\s*(eur|€)\s*$/i,"").trim()}function Se(e={}){const t=[e.hotelFeatureOneText,e.hotelFeatureTwoText,e.hotelFeatureThreeText].map(o).filter(Boolean);if(t.length)return t.slice(0,3);const a=ne(e);return a.length?a.slice(0,3):S(e.hotelAmenities||e.amenities||e.facilities).slice(0,3)}function se(e="",t="",a={}){const n=a.icon,s=a.escapeHtml,i=o(t),r=`xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"${i?` class="${s(i)}"`:""} aria-hidden="true" focusable="false"`;return e==="share-2"?`<svg ${r}><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><path d="m8.59 13.51 6.83 3.98"></path><path d="m15.41 6.51-6.82 3.98"></path></svg>`:e==="phone"?`<svg ${r}><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>`:e==="book-open"?`<svg ${r}><path d="M12 7v14"></path><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"></path></svg>`:e==="navigation"?`<svg ${r}><polygon points="3 11 22 2 13 21 11 13 3 11"></polygon></svg>`:e==="waves"?`<svg ${r}><path d="M2 6c.6.5 1.2 1 2.5 1C7 7 7 5 9.5 5c2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"></path><path d="M2 12c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"></path><path d="M2 18c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"></path></svg>`:typeof n=="function"?n(e,t):""}function Ie(e={}){const t=Number(e.rating??e.avgRating??e.publicRating??0),a=Number(e.score??e.publicScore??0),n=Number(e.followersCount??e.followerCount??0),s=Number(e.postsCount??e.postCount??0),i=Number(e.updatedAt?.seconds||e.createdAt?.seconds||0);return(Number.isFinite(t)?t*1e3:0)+(Number.isFinite(a)?a:0)+(Number.isFinite(n)?Math.min(n,500):0)+(Number.isFinite(s)?Math.min(s,200):0)+(Number.isFinite(i)?Math.min(i/1e5,100):0)}function Ae(e={},t={}){const a=new Map,n=(s={})=>{if(!s||typeof s!="object")return;const i=j(s);if(!i)return;const l=a.get(i)||{};a.set(i,{...l,...s,id:i})};return(Array.isArray(e.bootstrapRestaurantPreview)?e.bootstrapRestaurantPreview:[]).forEach(n),(Array.isArray(e.restaurants)?e.restaurants:[]).forEach(n),Array.from(a.values()).map(s=>({...s,__marketplaceSection:me(s,t),__marketplaceScore:Ie(s)})).filter(s=>s.__marketplaceSection).sort((s,i)=>i.__marketplaceScore-s.__marketplaceScore||k(s).localeCompare(k(i)))}function U(e={},t="",a={}){const n=Q(t);return Ae(e,a).filter(s=>s.__marketplaceSection===n)}function O(e="",t="",{escapeHtml:a,isPlaceholderUrl:n,extraClass:s=""}={}){const i=o(e),l=!i||typeof n=="function"&&n(i);return`
    <img
      src="${a(i)}"
      alt="${a(t)}"
      loading="lazy"
    ...
    />
  `}function ie(e={},t={}){const a=t.escapeHtml,n=t.icon,s=k(e),i=j(e),l=E(e,t),r=B(e),c=_(e);return`
  ...
  `}function Re(e={},t={}){const a=t.escapeHtml,n=t.icon,s=k(e),i=j(e),l=E(e,t),r=B(e),c=_(e),p=te(e),b=je(e),f=o(e.__marketplaceTypeLabel||e.type||e.customerType||"");return`
  ...
  `}function Ne(e={},t={}){const a=t.escapeHtml,n=t.icon,s=(m,w)=>se(m,w,t),i=k(e),l=j(e),r=ae(e,t),c=E(e,t),p=B(e),b=Number(e.reviewsCount??e.reviewCount??e.ratingsCount??0),f=p||"0.0",u=Number.isFinite(b)&&b>0?b:0,h=$e(e),$=Te(e)||"€€ - €€€",g=_(e),z=ke(e),v=te(e),y=ne(e),d=e.isLiked===!0||e.liked===!0||e.favorite===!0||e.favorited===!0;return`
    <article class="w-full bg-white rounded-[28px] overflow-hidden shadow-lg shadow-slate-200/80 border border-slate-100/60 relative flex flex-col" style="border-radius:28px;border-color:rgba(241,245,249,0.6);box-shadow:0 10px 15px -3px rgba(226,232,240,0.8),0 4px 6px -4px rgba(226,232,240,0.8);">
      <div class="h-44 relative overflow-hidden group">
        ${O(r,i,{...t,extraClass:"transition-transform duration-700 group-hover:scale-105"})}
  ...
  `}function K(e={},t={}){const a=o(e.__marketplaceType||e.type||e.customerType||""),n=W(a);return{...e,__marketplaceTypeLabel:{restaurant:"Restaurant",cafe:"Cafe",coffee:"Cafe",fastfood:"Fastfood",hotel:"Hotel",motel:"Motel",ecommerce:"E-Commerce"}[n]||t.title,__marketplaceType:n}}function M(e={},t={}){const a=t.escapeHtml,n=t.icon;return`
  ...
  `}function Be(){const e=globalThis?.localStorage||null;if(!e)return null;try{const t=e.getItem(ce);if(!t)return null;const a=JSON.parse(t),n=F(a);return n?{lat:n.lat,lng:n.lng,label:o(a?.label||a?.city||""),city:o(a?.city||a?.label||""),source:o(a?.source||"")}:null}catch{return null}}function Ee({deps:e}={}){const t=e.icon;return`
    <div id="restaurantsSearchTop" data-restaurant-search-top style="background:${re};">
      <div class="loc-top">
        <div class="loc-title">
  ...
  `}function Me({items:e=[],bestItems:t=[],section:a={},deps:n={}}={}){return e.length?`
  ...
  `:M(a,n)}function Pe({state:e,dataLoaded:t,section:a,deps:n}={}){const s=U(e,a.key,n).map(u=>K({...u,__marketplaceType:N(u,n)},a)),i=Be(),l=!!i,r=l?s.filter(u=>we(u,i)):s,c=l?r:r.slice(0,A),p=c.slice(0,Y),f=t?.restaurants===!0||s.length?Me({items:c,bestItems:p,section:a,deps:n}):D(a,n);return l?`
  ...
  `}function He(e={}){const t=e?.travelView&&typeof e.travelView=="object"?e.travelView:{},a=o(t.query||""),n=o(t.activeTab||"").toLowerCase(),s=["offers","hotels","map"].includes(n)?n:a?"hotels":"offers";return{query:a,activeTab:a?s:"offers",notice:o(t.notice||"")}}function Fe({travel:e,deps:t}={}){const a=t.escapeHtml,n=t.icon;return`
    <div id="travelSearchTop" data-travel-search-top style="background:${T}; padding:4.6rem 1.5rem 6.35rem;">
      <div class="bg-white border border-white/60 shadow-sm" style="border-radius:2rem; padding:1.4rem;">
        <div class="flex items-center gap-3 mb-4">
          <div class="w-12 h-12 rounded-2xl flex items-center justify-center text-white" style="background:${T};">
            ${n("plane","w-5 h-5")}
          </div>
          <div class="min-w-0">
            <p class="text-[10px] font-black uppercase tracking-widest" style="color:${T};">Travel</p>
        ...
        <div class="relative">
          <input
            ...
            aria-expanded="false"
          />
          <button type="button" data-travel-submit="true" class="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full flex items-center justify-center text-white active:scale-95 transition-all" style="background:${T};">
            ${n("search","w-4 h-4")}
          </button>
        </div>
  ...
  `}function Ue({activeTab:e,hasDestination:t,hotelCount:a,deps:n}={}){const s=n.escapeHtml;return`
  ...
  `}function le(e={},t={}){const a=t.escapeHtml,n=t.icon,s=(m,w)=>se(m,w,t),i=k(e),l=j(e),r=ze(e,t),c=r[0]||t.placeholderImage||"",p=E(e,t),b=B(e)||"0.0",f=Number(e.reviewsCount??e.reviewCount??e.ratingsCount??0),u=Number.isFinite(f)&&f>0?f:0,h=Oe(e),$=_(e),g=_e(e),z=Le(e),v=Se(e),y=Ce(e),d=e.isLiked===!0||e.liked===!0||e.favorite===!0||e.favorited===!0;return`
    <article
        ...
        ${r.length>1?`
          ...
          <div class="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-1 z-10">
            ${r.map((m,w)=>`
              <button
                type="button"
                data-travel-hotel-dot="${w}"
                data-travel-hotel-image-src="${a(m)}"
                class="${w===0?"w-4 bg-white shadow-sm":"w-1.5 bg-white/50"} h-1.5 rounded-full transition-all duration-300"
                aria-label="Hotelbild ${w+1}"
              ></button>
            `).join("")}
          </div>
        `:`
      ...
      <div class="px-5 pb-5 pt-12 relative flex-1 flex flex-col gap-3.5" style="padding-top:3rem;gap:0.875rem;">
        ...
        <div class="flex flex-col gap-2.5 text-slate-600">
          ...
          <div class="flex items-center gap-3">
            ...
            <span class="text-[11px] text-slate-600">${a(z||"Strand / See folgt")}</span>
          </div>
        </div>
  ...
  `}function Ke(e=[],t={}){const a=e.slice(0,4);return a.length?`
    <div class="space-y-4">
      ${a.map(n=>le(n,t)).join("")}
    </div>
  `:M({emptyTitle:"Noch keine Angebote",emptyBody:"Keine passenden Hotel-Angebote gefunden.",icon:"plane"},t)}function oe(e=[],t={}){return e.length?`
    <div class="space-y-4">
      ${e.map(a=>le(a,t)).join("")}
    </div>
  `:M({emptyTitle:"Keine Hotels gefunden",emptyBody:"Keine passenden Hotels fuer dieses Reiseziel gefunden.",icon:"plane"},t)}function De(e={},t=0,a={}){const n=a.escapeHtml,s=L(e),i=k(e),l=j(e),r=_(e),c=18+t*23%58,p=22+t*17%46;return`
    <button
      type="button"
      ...
      style="left:${c}%; top:${p}%; transform:translate(-50%,-50%); color:${T};"
      title="${n(`${i} - ${r}`)}"
    >
  ...
  `}function Ve(e=[],t={}){if(typeof t.renderMapView=="function")return t.renderMapView();const a=e.filter(n=>L(n)).slice(0,8);return e.length?`
    <div class="space-y-4">
  ...
  `:oe(e,t)}function qe({state:e,dataLoaded:t,section:a,deps:n}={}){const s=U(e,a.key,n).map(u=>K({...u,__marketplaceType:N(u,n)},a)),i=He(e),l=!!i.query,r=l?s.filter(u=>ve(u,i.query)):s.slice(0,A),c=r.slice(0,A),p=l?i.activeTab:"offers",b=t?.restaurants===!0,f=p==="map"?Ve(c,n):p==="hotels"?oe(c,n):Ke(c,n);return`
    <section id="travelView" class="animate-in slide-in-from-right-10 duration-500" style="background:#f8fafc; min-height:100%;">
      ...
      <div id="travelBenko" data-travel-benko style="margin-top:-1.75rem; border-top-left-radius:2.5rem; border-top-right-radius:2.5rem; background:#f8fafc; padding:2rem 1.5rem 6.5rem;">
        ${Ue({activeTab:p,hasDestination:l,hotelCount:r.length,deps:n})}
        <div class="mt-5">
          ${b||s.length?f:D(a,n)}
        </div>
      </div>
    </section>
  `}function Ge({state:e={},dataLoaded:t=null,sectionKey:a="restaurants",escapeHtmlFn:n,iconFn:s,getOptimizedImageUrlFn:i,isPlaceholderUrlFn:l,placeholderImage:r="",normalizeRestaurantTypeFn:c,normalizeLeadTypeKeyFn:p,resolveRestaurantLogoFn:b,renderMapViewFn:f}={}){const u=I[Q(a)]||I.restaurants,h=q(n,(d="")=>String(d||"")),$=q(s,()=>""),g={escapeHtml:h,icon:$,getOptimizedImageUrl:i,isPlaceholderUrl:l,placeholderImage:r,resolveRestaurantLogo:b,renderMapView:f,normalizeRestaurantType:c,normalizeLeadTypeKey:p},z=t?.restaurants===!0;if(u.key==="travel")return qe({state:e,dataLoaded:t,section:u,deps:g});if(u.key==="restaurants")return Pe({state:e,dataLoaded:t,section:u,deps:g});const v=U(e,u.key,g).slice(0,A).map(d=>K({...d,__marketplaceType:N(d,g)},u)),y=v.slice(0,Y);return`
    <section class="p-6 pb-24 animate-in slide-in-from-right-10 duration-500">
      ${v.length?`
        <div style="margin-bottom:2rem;">
          <div class="flex gap-3 overflow-x-auto hide-scrollbar snap-x" style="-webkit-overflow-scrolling:touch; scrollbar-width:none;">
  ...
  `}export{U as filterMarketplaceBusinessesCore,Ge as renderMarketplaceViewCore,me as resolveMarketplaceSectionForBusinessCore};
