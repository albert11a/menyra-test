import{t as y}from"../entry/social-app.js";import"./startup-route-runtime-context-6Co7bthZ.js";import"./vendor-firebase-D0kNzhPF.js";function K({state:o,getOptimizedImageUrl:p,escapeHtml:x,icon:u,formatRelative:v,toDateSafe:b}={}){if(!o?.chatModal?.open||!o?.chatModal?.profile)return"";const h=typeof p=="function"?p:(l=>l||""),d=typeof x=="function"?x:(l=>String(l??"")),m=typeof u=="function"?u:(()=>""),t=(l,$=l,e={})=>y(l,{fallback:$,params:e}),w=typeof v=="function"?v:(l=>String(l??"")),a=typeof b=="function"?b:(l=>l),s=o.chatModal.profile,f=h(s.avatar,"avatar"),g=Array.isArray(o.chatModal.messages)?o.chatModal.messages:[];return`
  ...
  `}function R({state:o,isFollowingProfile:p,getOptimizedImageUrl:x,formatCount:u,escapeHtml:v,icon:b}={}){if(!o?.profileModal?.open||!o?.profileModal?.profile)return"";const h=typeof p=="function"?p:(()=>!1),d=typeof x=="function"?x:(i=>i||""),m=typeof u=="function"?u:(i=>String(i??"0")),t=typeof v=="function"?v:(i=>String(i??"")),w=typeof b=="function"?b:(()=>""),a=(i,c=i,n={})=>y(i,{fallback:c,params:n}),s=o.profileModal.profile,f=h(s),g=!!s.pendingFollowRequest&&!f,l=!!s.privateAccount&&s.uid&&String(s.uid)!==String(o.user?.uid||"")&&!f,$=s.restaurantId?a("profile.business","Business"):a("profile.user","User"),e=d(s.avatar,"avatar");return`
  ...
  `}export{K as renderChatModalCore,D as renderLikesModalCore,G as renderPostModalCore,R as renderProfileModalCore};
