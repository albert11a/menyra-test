const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/business-composer-controller-BU2-Y-Vg.js","chunks/domain-feed-social-eager-CewaEtic.js","chunks/domain-auth-CdW0dNSS.js","chunks/domain-public-profile-mLQti0eH.js","chunks/domain-media-eager-DAUyCk2O.js","chunks/domain-menu-eager-BtWbRFcw.js","chunks/profile-post-card-markup-utils-HwqIiXgP.js"])))=>i.map(i=>d[i]);
import{_ as Fe}from"./domain-auth-CdW0dNSS.js";import{f as B,r as Be,l as Ce,s as X}from"./domain-analytics-YvFkDAlU.js";import{b as Re}from"./domain-business-accounts-D8NpUhi6.js";const $e=20,Ae=8;function x(e=""){return e==null?"":String(e).trim()}function L(e){if(e==null||e==="")return null;const a=Number(String(e).replace(",","."));return Number.isFinite(a)&&a>0?a:null}function Ke(e=Date.now(),a=Math.random()){const t=Math.max(0,Number(e)||0).toString(36),o=Math.floor(Math.max(0,Math.min(.999999,Number(a)||0))*36**6).toString(36).padStart(6,"0");return`room_${t}_${o}`}function je(e={}){const a=e&&typeof e=="object"?e:{},t=[...Array.isArray(a.images)?a.images:[],x(a.imageUrl??a.image??a.photoUrl)],o=[];return t.forEach(r=>{const d=x(r);d&&!o.includes(d)&&o.push(d)}),o.slice(0,Ae)}function Ee(e={},{index:a=0}={}){const t=e&&typeof e=="object"?e:{},o=L(t.persons??t.guests??t.capacity),r=L(t.size??t.sizeSqm??t.area),d=je(t);return{id:x(t.id)||Ke(Date.now()+a),title:x(t.title??t.name),description:x(t.description??t.text).slice(0,400),imageUrl:d[0]||"",images:d,price:L(t.price??t.pricePerNight),currency:x(t.currency??t.currencyCode).toUpperCase()||"EUR",persons:o==null?null:Math.min(20,Math.round(o)),beds:x(t.beds??t.bedsLabel).slice(0,60),size:r==null?null:Math.min(500,Math.round(r)),tag:x(t.tag??t.badge).slice(0,40),active:t.active!==!1}}function Te(e=[]){return(Array.isArray(e)?e:[]).slice(0,$e).map((a,t)=>Ee(a,{index:t}))}function Ue(e={}){return Te((e&&typeof e=="object"?e:{}).hotelRooms).filter(t=>t.title)}function xa(e={}){const a=[];return Number.isFinite(e?.persons)&&e.persons>0&&a.push({icon:"users",label:`${e.persons} persona`}),x(e?.beds)&&a.push({icon:"bed",label:x(e.beds)}),Number.isFinite(e?.size)&&e.size>0&&a.push({icon:"size",label:`${e.size} m²`}),a}function Sa(e={}){const a=Number(e?.price);if(!Number.isFinite(a)||a<=0)return"";const t=x(e?.currency).toUpperCase()||"EUR",o=Number.isInteger(a)?String(a):a.toFixed(2);return t==="EUR"?`€${o}`:`${o} ${t}`}const Q="mnyraDashboardStyles",Me=`
.mnyra-dash {
...
`;function Ie(e=typeof document>"u"?null:document){if(!(!e||e.getElementById(Q)))try{const a=e.createElement("style");a.id=Q,a.textContent=Me,e.head?.appendChild(a)}catch{}}function h(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function f(e,a,t=""){if(typeof e!="function")return"";try{return e(a,t)||""}catch{return""}}const Le=Object.freeze(["hotel","motel","hostel","resort","accommodation","travel"]);function Ne({businessType:e="",isShopCatalog:a=!1}={}){if(a)return"shop";const t=String(e||"").trim().toLowerCase();return Le.includes(t)?"hotel":"restaurant"}function Oe(e=new Date().getHours()){const a=Number.isFinite(Number(e))?(Math.trunc(Number(e))%24+24)%24:12;return a>=5&&a<=10?{dayPart:"mengjes",text:"Ju urojmë një mëngjes të mbarë!"}:a>=11&&a<=17?{dayPart:"dite",text:"Ju urojmë një ditë të mbarë!"}:a>=18&&a<=21?{dayPart:"mbremje",text:"Ju urojmë një mbrëmje të mbarë!"}:{dayPart:"nate",text:"Ju urojmë një natë të mbarë!"}}function He({name:e="",logoUrl:a="",hour:t=new Date().getHours(),iconFn:o}={}){const r=Oe(t),d=h(e||"Business");return`
  ...
  `}function aa({posts:e=[],iconFn:a}={}){const t=Array.isArray(e)?e:[];let o="";return t.length?(o=t.map(r=>{const d=[r.dateLabel,`${B(r.likesCount||0)} Likes`,`${B(r.commentsCount||0)} Kommentare`];return Number(r.impressions||0)>0&&d.push(`${B(r.impressions)} shtrirje (7 dite)`),`
  ...
  `}const da="menyra_social_dashboard_cache_v1::",ae="menyra_social_composer_products_v1::",te=2500,ne=1200,la=6,ca=3,ha=Object.freeze({menuImageUrl:"/apps/menyra-social/assets/panel/menu-scan.jpg",qrImageUrl:"/apps/menyra-social/assets/panel/qr-stand.jpg"}),ua=Object.freeze({menuOpens:"Menü-Aufrufe",qrScans:"QR-Scans"});function v(e){const a=Number(e);return Number.isFinite(a)?a:0}function ma(e={}){const a=String(e.createdAtClient||"").trim();if(a){const o=new Date(a);if(!Number.isNaN(o.getTime()))return o}const t=e.createdAt;if(t&&typeof t.toDate=="function")try{const o=t.toDate();if(o instanceof Date&&!Number.isNaN(o.getTime()))return o}catch{}return null}function pa(e="",a={}){const t=Array.isArray(a.media)&&a.media.length?a.media[0]:{},o=String(t.type||a.mediaType||"image").trim().toLowerCase()==="video"?"video":"image",r=String(t.thumbUrl||(o==="image"?t.url:"")||a.thumbUrl||"").trim(),d=o==="video"?String(t.url||a.mediaUrl||"").trim():"",p=ma(a);return{id:String(e||"").trim(),caption:String(a.caption||"").trim(),mediaType:o,thumbUrl:r,videoUrl:d,likesCount:v(a.likesCount),commentsCount:v(a.commentsCount),impressions:0,dateLabel:p?p.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit"}):"",createdAtMs:p?p.getTime():0}}function ba({days:e=[],todayKey:a="",rawPosts:t=[]}={}){const o=Array.isArray(e)?e:[],r=X(o),d=o.find(u=>String(u?.date||u?.id||"").trim()===String(a||"").trim()),p=X(d?[d]:[]),m=r.merged?.posts&&typeof r.merged.posts=="object"?r.merged.posts:{},k=(Array.isArray(t)?t:[]).map(u=>pa(u?.id,u?.data||{})).filter(u=>u.id).map(u=>({...u,impressions:v(m[u.id]?.impressions)})),S=k.slice().sort((u,y)=>y.createdAtMs-u.createdAtMs).slice(0,ca);return{day:String(a||"").trim(),week:r.summary,today:p.summary,posts:S,latestPost:ga(k)}}function ga(e=[]){const a=(Array.isArray(e)?e:[]).filter(t=>t&&t.id);return a.length?a.slice().sort((t,o)=>v(o.createdAtMs)-v(t.createdAtMs)||v(o.impressions)-v(t.impressions)||v(o.likesCount)-v(t.likesCount))[0]:null}function fa({profile:e={},restaurant:a={}}={}){return Re({profile:e,restaurant:a,feature:"qr"})}function ya(e={}){const a=e&&typeof e=="object"?e:{};return String(a.titleImageUrl||a.coverImageUrl||a.coverUrl||a.heroUrl||a.bannerUrl||"").trim()}function _a({model:e=null,coverUrl:a="",subscribed:t=!1,assets:o={}}={}){const r=e?.today||{},d=!e,p=e?.latestPost||null,m=[];if(d)m.push({key:"latestPost",label:"Postimi fundit",pending:!0});else if(!p)m.push({key:"latestPost",label:"Postimi fundit",emptyText:"S'ka postim",iconName:"image",composer:"post"});else{const k=String(p.thumbUrl||"").trim();m.push({key:"latestPost",label:"Postimi fundit",value:B(v(p.impressions)),withEye:!0,imageUrl:k,videoUrl:k?"":String(p.videoUrl||"").trim(),iconName:"image",panelTab:"analitika"})}return m.push({key:"profileViews",label:"Vizitor n'profil",value:B(v(r.profileViews)),withEye:!0,loading:d,imageUrl:String(a||"").trim(),iconName:"user",panelTab:"analitika"}),m.push({key:"menuOpens",label:"Vizitor n'meny",value:B(v(r.menuOpens)),withEye:!0,loading:d&&t,locked:!t,imageUrl:String(o.menuImageUrl||"").trim(),iconName:"book-open",panelTab:"analitika"}),m.push({key:"qrScans",label:"Skanime n'tavolina",value:B(v(r.qrScans)),withEye:!0,loading:d&&t,locked:!t,imageUrl:String(o.qrImageUrl||"").trim(),iconName:"layout-grid",panelTab:"analitika"}),m}function za({state:e,renderFn:a,documentObj:t,firestoreApi:o={},profileApi:r={},composerApi:d={},viewApi:p={},iconFn:m,storageObj:k}={}){const S=t||(typeof document>"u"?null:document),u=S?.defaultView||(typeof window>"u"?null:window),y=typeof a=="function"?a:()=>{},w=k||(typeof localStorage>"u"?null:localStorage),T=typeof r.getBusinessProfileTypeFn=="function"?r.getBusinessProfileTypeFn:(()=>""),ie=typeof r.isShopCatalogProfileFn=="function"?r.isShopCatalogProfileFn:(()=>!1),U=typeof r.getRestaurantMetaByIdFn=="function"?r.getRestaurantMetaByIdFn:(()=>null),oe=typeof r.resolveRestaurantLogoFn=="function"?r.resolveRestaurantLogoFn:(()=>""),de=typeof r.resolveOwnAvatarUrlFn=="function"?r.resolveOwnAvatarUrlFn:(()=>""),le=typeof p.renderAnalyticsViewFn=="function"?p.renderAnalyticsViewFn:(()=>""),ce=typeof p.renderSettingsViewFn=="function"?p.renderSettingsViewFn:(()=>""),he=typeof p.warmAnalyticsFn=="function"?p.warmAnalyticsFn:(()=>{});let N=!1,C=0,O=!1,P=null,R=null,$="",H=!1,V=()=>null;const ue=300;function M(){const n=e?.userProfile||{};return Ne({businessType:T(n),isShopCatalog:ie(n)})}function me(n=""){const s=U(n)||{};return Ue(s).map(i=>({id:i.id,name:i.title,price:i.price??"",category:i.beds||i.tag||"",type:"room",imageUrl:i.imageUrl||""}))}function pe(n=""){if(!w)return null;try{const s=w.getItem(`${ae}${n}`);if(!s)return null;const i=JSON.parse(s),l=Array.isArray(i?.items)?i.items:null;return l&&l.length?l:null}catch{return null}}function be(n="",s=[]){if(w)try{w.setItem(`${ae}${n}`,JSON.stringify({savedAt:Date.now(),items:s}))}catch{}}async function ge(n=""){const{db:s,collectionFn:i,queryFn:l,limitFn:c,getDocsFn:b}=o;if(!s||typeof i!="function"||typeof b!="function")throw new Error("Produktet nuk u ngarkuan.");const z=i(s,"restaurants",n,"menuItems"),_=typeof l=="function"&&typeof c=="function"?l(z,c(ue)):z,D=await b(_),g=[];return D.forEach(F=>{const j=V(F?.id,F?.data?.()||{});j&&g.push(j)}),g.sort((F,j)=>F.name.localeCompare(j.name,"sq")),g}async function fe(n="",s){const i=String(n||"").trim();if(!i)throw new Error("Produktet nuk u ngarkuan.");if(M()==="hotel")return me(i);const l=ge(i).then(b=>(be(i,b),b)),c=pe(i);return c?(typeof s=="function"?l.then(b=>s(b)).catch(()=>{}):l.catch(()=>{}),c):l}function Z(){return P?Promise.resolve(P):(R||(R=Fe(()=>import("./business-composer-controller-BU2-Y-Vg.js"),__vite__mapDeps([0,1,2,3,4,5,6])).then(n=>(V=typeof n?.normalizeComposerProductCore=="function"?n.normalizeComposerProductCore:(()=>null),P=n.createBusinessComposerController({documentObj:S,windowObj:S?.defaultView||null,api:{getRestaurantIdFn:()=>A(),getBusinessMetaFn:()=>{const s=A();if(!s)return{name:"",logoUrl:"",city:""};const i=Y(s),l=U(s)||{};return{name:i.name,logoUrl:i.logoUrl,city:String(l.city||"").trim()}},loadProductsFn:(s,i)=>fe(s,i),getBusinessKindFn:()=>M(),uploadImageFn:d.uploadImageFn,uploadVideoFn:d.uploadVideoFn,captureVideoPosterFn:d.captureVideoPosterFn,createPostFn:d.createPostFn,createStoryFn:d.createStoryFn,formatPriceFn:d.formatPriceFn,getOptimizedImageUrlFn:d.getOptimizedImageUrlFn,escapeHtmlFn:d.escapeHtmlFn,iconFn:typeof m=="function"?m:void 0,afterPublishFn:async s=>{try{await K({force:!0})}catch{}typeof d.afterPublishFn=="function"&&await d.afterPublishFn(s)}}}),P)).catch(n=>{throw R=null,console.error("[mnyra][dashboard] composer load failed",n),n})),R)}function W(){const n=u?.navigator?.connection;return!n||typeof n!="object"?!1:n.saveData===!0?!0:/(^|-)2g$/.test(String(n.effectiveType||"").trim().toLowerCase())}function ye(){if(H||P||!u||W())return;H=!0;const n=()=>{if(Z().catch(()=>{}),typeof d.prewarmFn=="function")try{d.prewarmFn()}catch{}};if(typeof u.requestIdleCallback=="function"){u.requestIdleCallback(n,{timeout:te});return}u.setTimeout?.(n,ne)}function _e(){if(N||!u||W())return;N=!0;const n=()=>{try{he()}catch{}};if(typeof u.requestIdleCallback=="function"){u.requestIdleCallback(n,{timeout:te});return}u.setTimeout?.(n,ne)}function we(n="post"){const s=String(n||"").trim().toLowerCase(),i=s==="story"||s==="profile"?s:"post";if(typeof d.prewarmFn=="function")try{d.prewarmFn()}catch{}if(P){P.open(i);return}$=i,Z().then(l=>{const c=$||i;$="",l?.open?.(c)}).catch(()=>{$=""})}function I(){return(!e.dashboardView||typeof e.dashboardView!="object")&&(e.dashboardView={status:"idle",error:"",model:null,loadedSignature:"",restaurantId:"",paywall:""}),e.dashboardView}function G(n=""){const s=I(),i=String(n||"").trim();return String(s.restaurantId||"")===i||(s.restaurantId=i,s.model=null,s.status="idle",s.error="",s.loadedSignature="",s.paywall="",C+=1),s}function A(){const n=e?.userProfile||{};return String(n.restaurantId||n.staffRestaurantId||"").trim()}let q="";function ve(){const n=String(e?.user?.uid||"").trim();!n||q===n||typeof r.ensureBusinessProfileFn=="function"&&(q=n,Promise.resolve().then(()=>r.ensureBusinessProfileFn()).catch(s=>{console.warn("[mnyra][panel] business profile could not be resolved",s)}).finally(()=>{String(e?.user?.uid||"").trim()===n&&y()}))}function ke(){const n=String(e?.user?.uid||"").trim();if(!n)return!1;const s=String(e?.__authBootstrapInFlightUid||"").trim();return!!e?.__authProfileLoadPromise||s===n}function J(n=""){return`${da}${n}`}function xe(n="",s=""){if(!w||!n)return null;try{const i=w.getItem(J(n));if(!i)return null;const l=JSON.parse(i);return!l||typeof l!="object"||String(l.day||"").trim()!==String(s||"").trim()||!l.model||typeof l.model!="object"?null:l.model}catch{return null}}function Se(n="",s=null){if(!(!w||!n||!s))try{w.setItem(J(n),JSON.stringify({day:s.day,model:s}))}catch{}}async function ze(n=""){const{db:s,collectionFn:i,queryFn:l,orderByFn:c,limitFn:b,getDocsFn:z}=o;if(!s||typeof i!="function"||typeof l!="function"||typeof c!="function"||typeof b!="function"||typeof z!="function")return[];const _=i(s,"restaurants",n,"socialPosts");return(await z(l(_,c("createdAt","desc"),b(la)))).docs.map(g=>({id:g.id,data:g.data()||{}})).filter(g=>{const F=String(g.data.status||"active").trim().toLowerCase();return F!=="deleted"&&F!=="hidden"})}async function K({force:n=!1}={}){const s=A(),i=G(s);if(!s)return;const l=Be({rangeKey:"7d"});if(!l)return;const c=`${s}::${l.toDay}`;if(!n&&i.loadedSignature===c&&i.status==="ready")return;if(!i.model){const _=xe(s,l.toDay);_&&(i.model=_,i.status="ready",y())}C+=1;const b=C;i.model||(i.status="loading",i.error="",y());try{const _={db:o.db,collectionFn:o.collectionFn,queryFn:o.queryFn,whereFn:o.whereFn,documentIdFn:o.documentIdFn,getDocsFn:o.getDocsFn,restaurantId:s},[D,g]=await Promise.allSettled([Ce({..._,fromDay:l.fromDay,toDay:l.toDay}),ze(s)]);if(b!==C)return;if(D.status==="rejected")throw D.reason;g.status==="rejected"&&console.error("[mnyra][dashboard] recent posts load failed",g.reason),i.model=ba({days:D.value,todayKey:l.toDay,rawPosts:g.status==="fulfilled"?g.value:[]}),i.status="ready",i.error="",i.loadedSignature=c,Se(s,i.model)}catch(_){if(b!==C)return;console.error("[mnyra][dashboard] load failed",_),i.model||(i.status="error",i.error="Ju lutem kontrollo lidhjen dhe provo perseri.")}y()}function De(){O||!S||(O=!0,S.addEventListener("click",n=>{try{if(String(e?.activeTab||"").trim().toLowerCase()!=="dashboard")return;if(n.target?.closest?.("[data-dashboard-retry]")){K({force:!0});return}if(n.target?.closest?.("[data-dashboard-paywall-close]")){n.preventDefault(),I().paywall="",y();return}const s=n.target?.closest?.("[data-dashboard-metric-locked]");if(s){n.preventDefault(),I().paywall=String(s.getAttribute("data-dashboard-metric-locked")||"").trim(),y();return}const i=n.target?.closest?.("[data-dashboard-composer]");if(i){n.preventDefault(),we(i.getAttribute("data-dashboard-composer"));return}const l=n.target?.closest?.("[data-dashboard-panel-tab]");if(l){n.preventDefault();const c=E(l.getAttribute("data-dashboard-panel-tab"));if(c===E(e?.dashboardPanelTab))return;e.dashboardPanelTab=c,y()}}catch{}}))}function Y(n=""){const s=e?.userProfile||{},i=n?U(n)||{}:{},l=String(i.name||i.restaurantName||s.name||"").trim()||"Business";let c="";try{c=String(de()||"").trim()}catch{}if(!c)try{c=String(oe(i)||"").trim()}catch{}return{name:l,logoUrl:c,kind:M(),coverUrl:ya(i),subscribed:fa({profile:s,restaurant:i})}}function Pe(){Ie(S),De();const n=A(),s=G(n);let i="";if(!n)ve(),i=ke()?sa():oa();else{ye(),_e();const l=Y(n),c=E(e?.dashboardPanelTab);s.status==="idle"&&(s.status="loading",queueMicrotask(()=>{K({force:!1})}));let b="";s.model?b=aa({posts:s.model.posts,iconFn:m}):s.status==="error"?b=ia({message:s.error}):b=ta();const z=`
        ${Ve({iconFn:m})}
        ${Ye({iconFn:m,showEditor:!!n})}
        ${Ze({iconFn:m,showEditor:!!n})}
        ${We({iconFn:m,showEditor:!!n})}
        ${qe({iconFn:m,kind:l.kind,showEditor:!!n})}
      `;let _;c==="analitika"?_=`
        ...
        ${se(`
          ...
          ${_}
        `)}
        ${g?na({title:ua[g]||"Me pagesë"}):""}
      `}return`
      <section class="mnyra-dash" data-dashboard-root>
        ${i}
      </section>
    `}return Object.freeze({renderDashboardView:Pe,loadDashboard:K})}export{Ae as M,za as a,Ue as b,Ke as c,xa as d,Sa as f,Te as n};
