...
`,g=Object.freeze({brand:"Mnyra GO",partyQuestion:"Sa veta jeni?",partyOne:"person",partyMany:"veta",step:"Hapi",stepBack:"Kthehu një hap prapa",next:"Vazhdo",categoryQuestion:"Çka dëshironi?",whenQuestion:"Kur?",whenLaterLabel:"Zgjidh ditën dhe orën",placeQuestion:"Ku?",placeLabel:"Qyteti",placeEmpty:"Shto qytetin tënd",cityPlaceholder:"Shkruaj qytetin",locationChange:"Ndrysho",locationSave:"Ruaj",submit:"Shiko ofertat",searching:"Po kërkojmë...",resultsHeadline:"lokale kanë oferta për ju",offering:"po ju ofron",forGroup:"për grupin tuaj",accept:"Prano ofertën",confirming:"Po konfirmohet...",sponsored:"Sponsored",onlyGo:"Vetëm me Mnyra GO",tableIncluded:"Tavolinë",emptyTitle:"Nuk gjetëm ofertë GO që përputhet tani.",emptySubtitle:"Provo me një orë tjetër ose me një grup tjetër.",doneTitle:"U krye",reservationConfirmed:"Tavolina është konfirmuar",claimConfirmed:"Oferta është e juaja",menu:"Shiko menunë",directions:"Udhëzime",code:"Kodi",cancel:"Anulo",cancelConfirm:"Dëshiron ta anulosh?",cancelYes:"Po, anuloje",cancelNo:"Jo",saveToAccount:"Ruaje në llogarinë tënde",signIn:"Hyr",errorTitle:"Mnyra GO është përkohësisht i padisponueshëm.",errorRetry:"Provo prapë",alternatives:"alternativa për ju",peopleSuffix:"persona",now:"Tani",back:"Ndrysho kërkimin"}),w="/apps/menyra-social/assets/go/",k=Object.freeze([Object.freeze({file:"story-1-uritur.webp",alt:"Vajzë ulur në tavolinë, e uritur",side:"right",headline:Object.freeze(["A je ",Object.freeze({accent:"unt?"})]),text:Object.freeze(["Hape Mnyra GO edhe thuaj veç ",Object.freeze({accent:"sa veta jeni"})," edhe çka po ju hahet."])}),Object.freeze({file:"story-2-kerkim.webp",alt:"Vajzë që shikon telefonin, tuj kërku lokal",side:"left",headline:Object.freeze(["Ku me ",Object.freeze({accent:"shku?"})]),text:Object.freeze(["Po kërkon restorant a kafe, po s’po din ku? ",Object.freeze({accent:"Mos kërko"})," — lokalet t’gjejnë ty."])}),Object.freeze({file:"story-3-oferta.webp",alt:"Vajzë e gëzueme me telefon në dorë",side:"right",headline:Object.freeze(["Ofertat ",Object.freeze({accent:"t’vijn."})]),text:Object.freeze(["Lokalet përreth teje t’çojnë zbritje a diçka falas, ",Object.freeze({accent:"veç për grupin tënd"}),"."])}),Object.freeze({file:"story-4-tavolina.webp",alt:"Dy shoqe në tavolinë të lokalit",side:"right",headline:null,text:Object.freeze(["Zgjedh njënën, shko edhe ",Object.freeze({accent:"knaqu."})," Kaq âsht Mnyra GO."])})]);function _(a=[],e="mnyra-go-page__story-accent"){return(Array.isArray(a)?a:[a]).map(t=>{if(typeof t=="string")return n(t);const r=typeof t?.accent=="string"?t.accent:"";return r?`<span class="${e}">${n(r)}</span>`:""}).join("")}function ne(a=[]){return(Array.isArray(a)?a:[a]).map(e=>typeof e=="string"?e:String(e?.accent||"")).join("")}const D=Object.freeze({now:"zap",in30:"timer",in60:"clock",later:"calendar-clock"}),p=Object.freeze(["party","category","when","place"]),$=Object.freeze({party:"users",category:"utensils",when:"clock",place:"map-pin"});function n(a=""){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function f(a=""){const e=String(a||"").trim();return p.includes(e)?e:p[0]}function te(a=""){const e=p.indexOf(f(a));return p[Math.min(p.length-1,e+1)]}function re(a=""){const e=p.indexOf(f(a));return p[Math.max(0,e-1)]}function u(a){const e=Math.trunc(Number(a));return Number.isFinite(e)?Math.min(m,Math.max(l,e)):B}function S(a,e=g){return u(a)===1?e.partyOne||g.partyOne:e.partyMany||g.partyMany}function z(a,e=g){return`${u(a)} ${S(a,e)}`}function E(a){const e=u(a),t=m-l;return Math.round((e-l)/t*100)}function M(a,{active:e=!1,attr:t="",value:r="",iconName:i="",wide:s=!1}={}){return`
  ...
  `}function P(a={},e=g){const t=String(a.category||"all");return`
    <div class="mnyra-go-page__chips" role="group" aria-label="${n(e.categoryQuestion)}">
      ${b.map((r,i)=>M(r.label,{active:t===r.key,attr:"data-go-category",value:r.key,iconName:r.icon,wide:i===0})).join("")}
    </div>
  `}function R(a={},e=g){const t=String(a.when||"now");return`
    <div class="mnyra-go-page__chips" role="group" aria-label="${n(e.whenQuestion)}">
      ${v.map(r=>M(r.label,{active:t===r.key,attr:"data-go-when",value:r.key,iconName:D[r.key]||"clock"})).join("")}
    </div>
    ${t==="later"?`
      ...
      />
    `:""}
  `}function L(a={},e=g){const t=String(a.city||"").trim();return a.editCity?`
  ...
  `}function K(a={},e=g){const t=f(a.step),r=p.indexOf(t),i=p.length,s=Math.round((r+1)/i*100);let d="",c="",h="";return t==="party"?(c=e.partyQuestion,d=T(a,e),h=`<button type="button" class="mnyra-go-page__cta" data-go-step-next>${n(e.next)}${o("chevron-right")}</button>`):t==="category"?(c=e.categoryQuestion,d=P(a,e)):t==="when"?(c=e.whenQuestion,d=R(a,e),String(a.when||"now")==="later"&&(h=`<button type="button" class="mnyra-go-page__cta" data-go-step-next>${n(e.next)}${o("chevron-right")}</button>`)):(c=e.placeQuestion,d=L(a,e),h=`<button type="button" class="mnyra-go-page__cta" data-go-submit>${o("search")}${n(e.submit)}</button>`),`
    <section class="mnyra-go-page__ask" data-go-step="${n(t)}">
      <header class="mnyra-go-page__ask-head">
        ${r>0?`<button type="button" class="mnyra-go-page__ask-back" data-go-step-back aria-label="${n(e.stepBack)}" title="${n(e.stepBack)}">${o("arrow-left")}</button>`:""}
        <div class="mnyra-go-page__ask-meta">
          <p class="mnyra-go-page__ask-count">${n(e.step)} ${r+1}/${i}</p>
      ...
      <h2 class="mnyra-go-page__q">${o($[t]||"users")}${n(c)}</h2>
      ${d}
      ${h}
    </section>
  `}function O(a={},{texts:e=g,busyOfferId:t="",nowMs:r=Date.now()}={}){const i=t&&t===a.offerId,s=Number.isFinite(Number(a.distanceKm))&&a.distanceKm!==null?`${Number(a.distanceKm).toFixed(1)} km`:"",d=a.isNow?e.now:j(a.expectedArrivalAt,{nowMs:r});return`
    <article class="mnyra-go-page__card" data-go-result="${n(a.offerId)}">
      <div class="mnyra-go-page__card-head">
        ${a.logoUrl?`<img class="mnyra-go-page__card-logo" src="${n(a.logoUrl)}" alt="" width="40" height="40" loading="lazy" decoding="async" />`:`<div class="mnyra-go-page__card-logo mnyra-go-page__card-logo--empty">${o("store")}</div>`}
      ...
      <div class="mnyra-go-page__card-meta">
        <span>${o("users")}${n(`${a.partySize} ${e.peopleSuffix}`)}</span>
        ${d?`<span>${o("clock")}${n(d)}</span>`:""}
        ${s?`<span>${o("map-pin")}${n(s)}</span>`:""}
        ${a.bookingType==="reservation"?`<span>${o("armchair")}${n(e.tableIncluded)}</span>`:""}
      </div>

      <p class="mnyra-go-page__card-only">${o("ticket-percent")}${n(e.onlyGo)}</p>
      ...
      <button
        ...
        ${i?"disabled":""}
      >${i?"":o("check-check")}${n(i?e.confirming:e.accept)}</button>
    </article>
  `}function I(a={},e=g){const t=Array.isArray(a.results)?a.results:[],r=Number(a.nowMs)||Date.now();return t.length?`
    <h2 class="mnyra-go-page__lead">${t.length} ${n(e.resultsHeadline)}</h2>
    ${a.notice?`<p class="mnyra-go-page__note">${n(a.notice)}</p>`:""}
    ${t.map(i=>O(i,{texts:e,busyOfferId:a.busyOfferId,nowMs:r})).join("")}
  ...
  `:`
    ...
    `}function C(a={},e=g){const t=a.booking||{},r=t.type==="reservation",i=Number(a.nowMs)||Date.now(),s=j(t.expectedArrivalAt,{nowMs:i}),d=String(a.statusLabel||"").trim()||(r?e.reservationConfirmed:e.claimConfirmed);return a.confirmCancel?`
    ...
    `:`
    <p class="mnyra-go-page__done">${n(e.doneTitle)} ${o("party-popper")}</p>
    <p class="mnyra-go-page__done-name">${n(t.businessName||"")}</p>
    <p class="mnyra-go-page__card-for">${n(t.benefitLabel||"")}</p>

    <div class="mnyra-go-page__card-meta">
      <span>${o("users")}${n(`${t.partySize||1} ${e.peopleSuffix}`)}</span>
      ${s?`<span>${o("clock")}${n(s)}</span>`:""}
      ${t.city?`<span>${o("map-pin")}${n(t.city)}</span>`:""}
    </div>

    <p class="mnyra-go-page__ok">${o("circle-check-big")}${n(d)}</p>
  ...
  `}function H(a={},e=g){const t=String(a.error||"").trim()||e.errorTitle;return`
    ...
    `:`
      <button type="button" class="mnyra-go-page__cta" data-go-retry>
        ${o("rotate-ccw")}${n(e.errorRetry)}
      </button>
    `}
  `}function N(a=[]){const e=Array.isArray(a)?a:[];let t=0;const r=()=>{const i=t++;return`data-go-reveal="${i}"${e.includes(i)?' data-go-reveal-in="1"':""}`};return`
    <div class="mnyra-go-page__story" data-go-story>
      ${k.map((i,s)=>{const d=s===0;return`
        <article class="mnyra-go-page__story-slide" data-go-story-slide="${s}">
          ...
          >
            <img
              ...
              fetchpriority="${d?"high":"low"}"
              decoding="async"
              onerror="this.remove()"
            />
            ${i.headline?`<figcaption class="mnyra-go-page__story-headline">${_(i.headline,"mnyra-go-page__story-headline-accent")}</figcaption>`:""}
          </figure>
          <p class="mnyra-go-page__story-text" ${r()}>${_(i.text)}</p>
        </article>
      `}).join("")}
    </div>
  `}function V(a={}){return N(a.storyShown)}function ie(a={}){const e={...g,...a.texts||{}},t=String(a.view||"search"),r=t==="search";let i="";return t==="loading"?i=`<div class="mnyra-go-page__empty">${n(e.searching)}</div>`:t==="results"?i=I(a,e):t==="booking"?i=C(a,e):t==="error"?i=H(a,e):i=V(a),`
    <div class="mnyra-go-page" data-go-page data-go-view="${n(t)}">
      ${r?`<div class="mnyra-go-page__top">${K(a.form||{},e)}</div>`:""}
      <div class="mnyra-go-page__bento" data-go-bento>${i}</div>
    </div>
  `}const oe=g,se=k,ge=w;export{ae as GO_PAGE_CSS,ge as GO_PAGE_STORY_BASE,se as GO_PAGE_STORY_SLIDES,ee as GO_PAGE_STYLE_ELEMENT_ID,oe as GO_PAGE_TEXTS,p as GO_STEPS,u as clampGoPartySize,E as goPartyFillPercent,z as goPartyLabel,S as goPartyWord,ne as goStoryPlainText,te as nextGoStep,re as previousGoStep,ie as renderGoPageCore,f as resolveGoStep};
