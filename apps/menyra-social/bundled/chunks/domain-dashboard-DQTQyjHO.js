const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/business-composer-controller-Pde06W8L.js","chunks/domain-feed-social-eager-Dk0ZJfex.js","chunks/domain-auth-Aq-4Vdvh.js","chunks/domain-public-profile-mLQti0eH.js","chunks/domain-media-eager-DAUyCk2O.js","chunks/domain-menu-eager-BUjsiYeF.js","chunks/profile-post-card-markup-utils-HwqIiXgP.js"])))=>i.map(i=>d[i]);
import{_ as Pe}from"./domain-auth-Aq-4Vdvh.js";import{f as C,r as Fe,l as Ce,s as Y}from"./domain-analytics-CuBqYnIy.js";import{b as Be}from"./domain-business-accounts-D8NpUhi6.js";const $e=20,Re=8;function z(e=""){return e==null?"":String(e).trim()}function M(e){if(e==null||e==="")return null;const a=Number(String(e).replace(",","."));return Number.isFinite(a)&&a>0?a:null}function je(e=Date.now(),a=Math.random()){const t=Math.max(0,Number(e)||0).toString(36),o=Math.floor(Math.max(0,Math.min(.999999,Number(a)||0))*36**6).toString(36).padStart(6,"0");return`room_${t}_${o}`}function Ee(e={}){const a=e&&typeof e=="object"?e:{},t=[...Array.isArray(a.images)?a.images:[],z(a.imageUrl??a.image??a.photoUrl)],o=[];return t.forEach(n=>{const l=z(n);l&&!o.includes(l)&&o.push(l)}),o.slice(0,Re)}function Ke(e={},{index:a=0}={}){const t=e&&typeof e=="object"?e:{},o=M(t.persons??t.guests??t.capacity),n=M(t.size??t.sizeSqm??t.area),l=Ee(t);return{id:z(t.id)||je(Date.now()+a),title:z(t.title??t.name),description:z(t.description??t.text).slice(0,400),imageUrl:l[0]||"",images:l,price:M(t.price??t.pricePerNight),currency:z(t.currency??t.currencyCode).toUpperCase()||"EUR",persons:o==null?null:Math.min(20,Math.round(o)),beds:z(t.beds??t.bedsLabel).slice(0,60),size:n==null?null:Math.min(500,Math.round(n)),tag:z(t.tag??t.badge).slice(0,40),active:t.active!==!1}}function Te(e=[]){return(Array.isArray(e)?e:[]).slice(0,$e).map((a,t)=>Ke(a,{index:t}))}function Ue(e={}){return Te((e&&typeof e=="object"?e:{}).hotelRooms).filter(t=>t.title)}function va(e={}){const a=[];return Number.isFinite(e?.persons)&&e.persons>0&&a.push({icon:"users",label:`${e.persons} persona`}),z(e?.beds)&&a.push({icon:"bed",label:z(e.beds)}),Number.isFinite(e?.size)&&e.size>0&&a.push({icon:"size",label:`${e.size} m²`}),a}function wa(e={}){const a=Number(e?.price);if(!Number.isFinite(a)||a<=0)return"";const t=z(e?.currency).toUpperCase()||"EUR",o=Number.isInteger(a)?String(a):a.toFixed(2);return t==="EUR"?`€${o}`:`${o} ${t}`}const Q="mnyraDashboardStyles",Ae=`
.mnyra-dash {
...
`;function Ie(e=typeof document>"u"?null:document){if(!(!e||e.getElementById(Q)))try{const a=e.createElement("style");a.id=Q,a.textContent=Ae,e.head?.appendChild(a)}catch{}}function c(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function v(e,a,t=""){if(typeof e!="function")return"";try{return e(a,t)||""}catch{return""}}const Ne=Object.freeze(["hotel","motel","hostel","resort","accommodation","travel"]);function Me({businessType:e="",isShopCatalog:a=!1}={}){if(a)return"shop";const t=String(e||"").trim().toLowerCase();return Ne.includes(t)?"hotel":"restaurant"}function Le({kind:e="restaurant",isOwner:a=!1}={}){const t=[];return e==="hotel"?t.push({nav:"menu",iconName:"bed-double",label:"Hotel & Dhoma",sub:"Detaje, dhoma, oferta"}):e==="shop"?t.push({nav:"menu",iconName:"shopping-bag",label:"Ndrysho dyqanin",sub:"Produkte & Stok"}):t.push({nav:"menu",iconName:"utensils",label:"Ndrysho menune",sub:"Produkte & Kategorien"}),t.push({nav:"menu",iconName:"megaphone",label:"Oferta & Reklama",sub:"Im Editor verwalten"}),a&&t.push({nav:"businessAccounts",iconName:"users-round",label:"Team & Staff",sub:"Zugänge verwalten"}),t.push({nav:"settings",iconName:"settings",label:"Cilesimet",sub:"Profili & Kontakti"}),t}function Oe(e=new Date().getHours()){const a=Number.isFinite(Number(e))?(Math.trunc(Number(e))%24+24)%24:12;return a>=5&&a<=10?{dayPart:"mengjes",text:"Ju urojmë një mëngjes të mbarë!"}:a>=11&&a<=17?{dayPart:"dite",text:"Ju urojmë një ditë të mbarë!"}:a>=18&&a<=21?{dayPart:"mbremje",text:"Ju urojmë një mbrëmje të mbarë!"}:{dayPart:"nate",text:"Ju urojmë një natë të mbarë!"}}function He({name:e="",logoUrl:a="",hour:t=new Date().getHours(),iconFn:o}={}){const n=Oe(t),l=c(e||"Business");return`
  ...
  `}function Ve({iconFn:e,showEditor:a=!0}={}){return a?`
  ...
  `:""}const X=Object.freeze({restaurant:{accent:"Ndrysho",rest:"menunë",sub:"Shto produkte, kategori dhe çmime.",cta:"Menu"},shop:{accent:"Ndrysho",rest:"dyqanin",sub:"Shto produkte, kategori dhe stok.",cta:"Dyqani"},hotel:{accent:"Ndrysho",rest:"hotelin",sub:"Detajet, dhomat dhe çmimet e tua.",cta:"Hoteli"}});function qe(e="restaurant"){const a=String(e||"").trim().toLowerCase();return X[a]||X.restaurant}function Ge({iconFn:e,kind:a="restaurant",showEditor:t=!0}={}){if(!t)return"";const o=qe(a);return`
  ...
  `}function We({actions:e=[],iconFn:a}={}){return`<div class="mnyra-dash__actions">${(Array.isArray(e)?e:[]).map(o=>`
    ...
    `).join("")}</div>`}function Je({cards:e=[],iconFn:a}={}){const t=(Array.isArray(e)?e:[]).filter(n=>n&&n.key);if(!t.length)return"";const o=t.map((n,l)=>{const m=c(n.label||"");if(n.pending)return'<div class="mnyra-dash__hl-card mnyra-dash__hl-card--pending" aria-hidden="true"></div>';const p=l<2?'loading="eager" fetchpriority="high"':'loading="lazy" fetchpriority="low"';let k="";n.imageUrl?k=`<img class="mnyra-dash__hl-media" src="${c(n.imageUrl)}" alt="" ${p} decoding="async" onerror="this.style.display='none'" />`:n.videoUrl&&(k=`<video class="mnyra-dash__hl-media" src="${c(n.videoUrl)}#t=0.1" preload="metadata" muted playsinline disablepictureinpicture tabindex="-1" aria-hidden="true"></video>`);const D=`
      <span class="mnyra-dash__hl-plate">${v(a,n.iconName||"image","w-6 h-6")}</span>
      ${k}
    `,h=n.withEye?`<span class="mnyra-dash__hl-eye">${v(a,"eye","w-4 h-4")}</span>`:"";let f;n.locked?f=`<span class="mnyra-dash__hl-lock">${v(a,"lock","w-3 h-3")}Me pagesë</span>`:n.loading?f='<span class="mnyra-dash__hl-value mnyra-dash__hl-value--pending" aria-hidden="true"></span>':n.emptyText?f=`<span class="mnyra-dash__hl-empty">${c(n.emptyText)}</span>`:f=`<span class="mnyra-dash__hl-value">${h}${c(n.value||"0")}</span>`;let y;n.locked?y=`class="mnyra-dash__hl-card mnyra-dash__hl-card--locked" data-dashboard-metric-locked="${c(n.key)}"`:n.composer?y=`class="mnyra-dash__hl-card" data-dashboard-composer="${c(n.composer)}"`:y=`class="mnyra-dash__hl-card"${n.panelTab?` data-dashboard-panel-tab="${c(n.panelTab)}"`:""}`;const U=n.locked?`${m} – me pagesë`:`${m} ${n.emptyText||n.value||""}`.trim();return`
  ...
  `}function Ye(e=[]){return(Array.isArray(e)?e:[]).filter(a=>a&&a.key).map(a=>[a.key,a.label||"",a.value||"",a.emptyText||"",a.imageUrl||"",a.videoUrl||"",a.iconName||"",a.panelTab||"",a.composer||"",a.pending?"p":"",a.loading?"l":"",a.locked?"x":"",a.withEye?"e":""].join("~")).join("|")}const re=Object.freeze([Object.freeze({id:"funksionet",label:"Funksionet",iconName:"layout-grid"}),Object.freeze({id:"analitika",label:"Analitika",iconName:"bar-chart-3"}),Object.freeze({id:"opsionet",label:"Opsionet",iconName:"settings"})]);function T(e=""){const a=String(e||"").trim().toLowerCase();return re.some(t=>t.id===a)?a:"funksionet"}function Qe({activeTab:e="funksionet",iconFn:a}={}){const t=T(e);return`<div class="mnyra-dash__tabs" role="tablist" data-dashboard-panel-tabs>${re.map(n=>{const l=n.id===t;return`
    ...
    `}).join("")}</div>`}function Xe(e=""){return`
    <div class="mnyra-dash__bento" data-dashboard-bento>
      ${e}
    </div>
  `}function ea({posts:e=[],iconFn:a}={}){const t=Array.isArray(e)?e:[];let o="";return t.length?(o=t.map(n=>{const l=[n.dateLabel,`${C(n.likesCount||0)} Likes`,`${C(n.commentsCount||0)} Kommentare`];return Number(n.impressions||0)>0&&l.push(`${C(n.impressions)} shtrirje (7 dite)`),`
  ...
  `}function ta(){return'<div class="mnyra-dash__skeleton" style="min-height:44px; border-radius:14px; margin: 4px 0 16px;"></div>'}function na({message:e=""}={}){return`
  ...
  `}const sa="menyra_social_dashboard_cache_v1::",ae="menyra_social_composer_products_v1::",te=2500,ne=1200,ia=6,oa=3,da=Object.freeze({menuImageUrl:"/apps/menyra-social/assets/panel/menu-scan.jpg",qrImageUrl:"/apps/menyra-social/assets/panel/qr-stand.jpg"}),la=Object.freeze({menuOpens:"Menü-Aufrufe",qrScans:"QR-Scans"});function _(e){const a=Number(e);return Number.isFinite(a)?a:0}function ca(e={}){const a=String(e.createdAtClient||"").trim();if(a){const o=new Date(a);if(!Number.isNaN(o.getTime()))return o}const t=e.createdAt;if(t&&typeof t.toDate=="function")try{const o=t.toDate();if(o instanceof Date&&!Number.isNaN(o.getTime()))return o}catch{}return null}function ha(e="",a={}){const t=Array.isArray(a.media)&&a.media.length?a.media[0]:{},o=String(t.type||a.mediaType||"image").trim().toLowerCase()==="video"?"video":"image",n=String(t.thumbUrl||(o==="image"?t.url:"")||a.thumbUrl||"").trim(),l=o==="video"?String(t.url||a.mediaUrl||"").trim():"",m=ca(a);return{id:String(e||"").trim(),caption:String(a.caption||"").trim(),mediaType:o,thumbUrl:n,videoUrl:l,likesCount:_(a.likesCount),commentsCount:_(a.commentsCount),impressions:0,dateLabel:m?m.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit"}):"",createdAtMs:m?m.getTime():0}}function ua({days:e=[],todayKey:a="",rawPosts:t=[]}={}){const o=Array.isArray(e)?e:[],n=Y(o),l=o.find(h=>String(h?.date||h?.id||"").trim()===String(a||"").trim()),m=Y(l?[l]:[]),p=n.merged?.posts&&typeof n.merged.posts=="object"?n.merged.posts:{},k=(Array.isArray(t)?t:[]).map(h=>ha(h?.id,h?.data||{})).filter(h=>h.id).map(h=>({...h,impressions:_(p[h.id]?.impressions)})),D=k.slice().sort((h,f)=>f.createdAtMs-h.createdAtMs).slice(0,oa);return{day:String(a||"").trim(),week:n.summary,today:m.summary,posts:D,latestPost:ma(k)}}function ma(e=[]){const a=(Array.isArray(e)?e:[]).filter(t=>t&&t.id);return a.length?a.slice().sort((t,o)=>_(o.createdAtMs)-_(t.createdAtMs)||_(o.impressions)-_(t.impressions)||_(o.likesCount)-_(t.likesCount))[0]:null}function pa({profile:e={},restaurant:a={}}={}){return Be({profile:e,restaurant:a,feature:"qr"})}function ba(e={}){const a=e&&typeof e=="object"?e:{};return String(a.titleImageUrl||a.coverImageUrl||a.coverUrl||a.heroUrl||a.bannerUrl||"").trim()}function ga({model:e=null,coverUrl:a="",subscribed:t=!1,assets:o={}}={}){const n=e?.today||{},l=!e,m=e?.latestPost||null,p=[];if(l)p.push({key:"latestPost",label:"Postimi fundit",pending:!0});else if(!m)p.push({key:"latestPost",label:"Postimi fundit",emptyText:"S'ka postim",iconName:"image",composer:"post"});else{const k=String(m.thumbUrl||"").trim();p.push({key:"latestPost",label:"Postimi fundit",value:C(_(m.impressions)),withEye:!0,imageUrl:k,videoUrl:k?"":String(m.videoUrl||"").trim(),iconName:"image",panelTab:"analitika"})}return p.push({key:"profileViews",label:"Vizitor n'profil",value:C(_(n.profileViews)),withEye:!0,loading:l,imageUrl:String(a||"").trim(),iconName:"user",panelTab:"analitika"}),p.push({key:"menuOpens",label:"Vizitor n'meny",value:C(_(n.menuOpens)),withEye:!0,loading:l&&t,locked:!t,imageUrl:String(o.menuImageUrl||"").trim(),iconName:"book-open",panelTab:"analitika"}),p.push({key:"qrScans",label:"Skanime n'tavolina",value:C(_(n.qrScans)),withEye:!0,loading:l&&t,locked:!t,imageUrl:String(o.qrImageUrl||"").trim(),iconName:"layout-grid",panelTab:"analitika"}),p}function ka({state:e,renderFn:a,documentObj:t,firestoreApi:o={},profileApi:n={},composerApi:l={},viewApi:m={},iconFn:p,storageObj:k}={}){const D=t||(typeof document>"u"?null:document),h=D?.defaultView||(typeof window>"u"?null:window),f=typeof a=="function"?a:()=>{},y=k||(typeof localStorage>"u"?null:localStorage),U=typeof n.getBusinessProfileTypeFn=="function"?n.getBusinessProfileTypeFn:(()=>""),se=typeof n.isShopCatalogProfileFn=="function"?n.isShopCatalogProfileFn:(()=>!1),ie=typeof n.isBusinessOwnerProfileFn=="function"?n.isBusinessOwnerProfileFn:(()=>!1),A=typeof n.getRestaurantMetaByIdFn=="function"?n.getRestaurantMetaByIdFn:(()=>null),oe=typeof n.resolveRestaurantLogoFn=="function"?n.resolveRestaurantLogoFn:(()=>""),de=typeof n.resolveOwnAvatarUrlFn=="function"?n.resolveOwnAvatarUrlFn:(()=>""),le=typeof m.renderAnalyticsViewFn=="function"?m.renderAnalyticsViewFn:(()=>""),ce=typeof m.renderSettingsViewFn=="function"?m.renderSettingsViewFn:(()=>""),he=typeof m.warmAnalyticsFn=="function"?m.warmAnalyticsFn:(()=>{});let L=!1,B=0,O=!1,F=null,$=null,R="",H=!1,Z=()=>null;const ue=300;function I(){const r=e?.userProfile||{};return Me({businessType:U(r),isShopCatalog:se(r)})}function me(r=""){const s=A(r)||{};return Ue(s).map(i=>({id:i.id,name:i.title,price:i.price??"",category:i.beds||i.tag||"",type:"room",imageUrl:i.imageUrl||""}))}function pe(r=""){if(!y)return null;try{const s=y.getItem(`${ae}${r}`);if(!s)return null;const i=JSON.parse(s),d=Array.isArray(i?.items)?i.items:null;return d&&d.length?d:null}catch{return null}}function be(r="",s=[]){if(y)try{y.setItem(`${ae}${r}`,JSON.stringify({savedAt:Date.now(),items:s}))}catch{}}async function ge(r=""){const{db:s,collectionFn:i,queryFn:d,limitFn:u,getDocsFn:b}=o;if(!s||typeof i!="function"||typeof b!="function")throw new Error("Produktet nuk u ngarkuan.");const x=i(s,"restaurants",r,"menuItems"),w=typeof d=="function"&&typeof u=="function"?d(x,u(ue)):x,S=await b(w),g=[];return S.forEach(P=>{const K=Z(P?.id,P?.data?.()||{});K&&g.push(K)}),g.sort((P,K)=>P.name.localeCompare(K.name,"sq")),g}async function fe(r="",s){const i=String(r||"").trim();if(!i)throw new Error("Produktet nuk u ngarkuan.");if(I()==="hotel")return me(i);const d=ge(i).then(b=>(be(i,b),b)),u=pe(i);return u?(typeof s=="function"?d.then(b=>s(b)).catch(()=>{}):d.catch(()=>{}),u):d}function V(){return F?Promise.resolve(F):($||($=Pe(()=>import("./business-composer-controller-Pde06W8L.js"),__vite__mapDeps([0,1,2,3,4,5,6])).then(r=>(Z=typeof r?.normalizeComposerProductCore=="function"?r.normalizeComposerProductCore:(()=>null),F=r.createBusinessComposerController({documentObj:D,windowObj:D?.defaultView||null,api:{getRestaurantIdFn:()=>j(),getBusinessMetaFn:()=>{const s=j();if(!s)return{name:"",logoUrl:"",city:""};const i=J(s),d=A(s)||{};return{name:i.name,logoUrl:i.logoUrl,city:String(d.city||"").trim()}},loadProductsFn:(s,i)=>fe(s,i),getBusinessKindFn:()=>I(),uploadImageFn:l.uploadImageFn,uploadVideoFn:l.uploadVideoFn,captureVideoPosterFn:l.captureVideoPosterFn,createPostFn:l.createPostFn,createStoryFn:l.createStoryFn,formatPriceFn:l.formatPriceFn,getOptimizedImageUrlFn:l.getOptimizedImageUrlFn,escapeHtmlFn:l.escapeHtmlFn,iconFn:typeof p=="function"?p:void 0,afterPublishFn:async s=>{try{await E({force:!0})}catch{}typeof l.afterPublishFn=="function"&&await l.afterPublishFn(s)}}}),F)).catch(r=>{throw $=null,console.error("[mnyra][dashboard] composer load failed",r),r})),$)}function q(){const r=h?.navigator?.connection;return!r||typeof r!="object"?!1:r.saveData===!0?!0:/(^|-)2g$/.test(String(r.effectiveType||"").trim().toLowerCase())}function ye(){if(H||F||!h||q())return;H=!0;const r=()=>{if(V().catch(()=>{}),typeof l.prewarmFn=="function")try{l.prewarmFn()}catch{}};if(typeof h.requestIdleCallback=="function"){h.requestIdleCallback(r,{timeout:te});return}h.setTimeout?.(r,ne)}function _e(){if(L||!h||q())return;L=!0;const r=()=>{try{he()}catch{}};if(typeof h.requestIdleCallback=="function"){h.requestIdleCallback(r,{timeout:te});return}h.setTimeout?.(r,ne)}function ve(r="post"){const s=String(r||"").trim().toLowerCase(),i=s==="story"||s==="profile"?s:"post";if(typeof l.prewarmFn=="function")try{l.prewarmFn()}catch{}if(F){F.open(i);return}R=i,V().then(d=>{const u=R||i;R="",d?.open?.(u)}).catch(()=>{R=""})}function N(){return(!e.dashboardView||typeof e.dashboardView!="object")&&(e.dashboardView={status:"idle",error:"",model:null,loadedSignature:"",restaurantId:"",paywall:""}),e.dashboardView}function G(r=""){const s=N(),i=String(r||"").trim();return String(s.restaurantId||"")===i||(s.restaurantId=i,s.model=null,s.status="idle",s.error="",s.loadedSignature="",s.paywall="",B+=1),s}function j(){const r=e?.userProfile||{};return String(r.restaurantId||r.staffRestaurantId||"").trim()}function we(){const r=String(e?.user?.uid||"").trim();if(!r)return!1;const s=String(e?.__authBootstrapInFlightUid||"").trim();return!!e?.__authProfileLoadPromise||s===r}function W(r=""){return`${sa}${r}`}function ke(r="",s=""){if(!y||!r)return null;try{const i=y.getItem(W(r));if(!i)return null;const d=JSON.parse(i);return!d||typeof d!="object"||String(d.day||"").trim()!==String(s||"").trim()||!d.model||typeof d.model!="object"?null:d.model}catch{return null}}function xe(r="",s=null){if(!(!y||!r||!s))try{y.setItem(W(r),JSON.stringify({day:s.day,model:s}))}catch{}}async function Se(r=""){const{db:s,collectionFn:i,queryFn:d,orderByFn:u,limitFn:b,getDocsFn:x}=o;if(!s||typeof i!="function"||typeof d!="function"||typeof u!="function"||typeof b!="function"||typeof x!="function")return[];const w=i(s,"restaurants",r,"socialPosts");return(await x(d(w,u("createdAt","desc"),b(ia)))).docs.map(g=>({id:g.id,data:g.data()||{}})).filter(g=>{const P=String(g.data.status||"active").trim().toLowerCase();return P!=="deleted"&&P!=="hidden"})}async function E({force:r=!1}={}){const s=j(),i=G(s);if(!s)return;const d=Fe({rangeKey:"7d"});if(!d)return;const u=`${s}::${d.toDay}`;if(!r&&i.loadedSignature===u&&i.status==="ready")return;if(!i.model){const w=ke(s,d.toDay);w&&(i.model=w,i.status="ready",f())}B+=1;const b=B;i.model||(i.status="loading",i.error="",f());try{const w={db:o.db,collectionFn:o.collectionFn,queryFn:o.queryFn,whereFn:o.whereFn,documentIdFn:o.documentIdFn,getDocsFn:o.getDocsFn,restaurantId:s},[S,g]=await Promise.allSettled([Ce({...w,fromDay:d.fromDay,toDay:d.toDay}),Se(s)]);if(b!==B)return;if(S.status==="rejected")throw S.reason;g.status==="rejected"&&console.error("[mnyra][dashboard] recent posts load failed",g.reason),i.model=ua({days:S.value,todayKey:d.toDay,rawPosts:g.status==="fulfilled"?g.value:[]}),i.status="ready",i.error="",i.loadedSignature=u,xe(s,i.model)}catch(w){if(b!==B)return;console.error("[mnyra][dashboard] load failed",w),i.model||(i.status="error",i.error="Ju lutem kontrollo lidhjen dhe provo perseri.")}f()}function ze(){O||!D||(O=!0,D.addEventListener("click",r=>{try{if(String(e?.activeTab||"").trim().toLowerCase()!=="dashboard")return;if(r.target?.closest?.("[data-dashboard-retry]")){E({force:!0});return}if(r.target?.closest?.("[data-dashboard-paywall-close]")){r.preventDefault(),N().paywall="",f();return}const s=r.target?.closest?.("[data-dashboard-metric-locked]");if(s){r.preventDefault(),N().paywall=String(s.getAttribute("data-dashboard-metric-locked")||"").trim(),f();return}const i=r.target?.closest?.("[data-dashboard-composer]");if(i){r.preventDefault(),ve(i.getAttribute("data-dashboard-composer"));return}const d=r.target?.closest?.("[data-dashboard-panel-tab]");if(d){r.preventDefault();const u=T(d.getAttribute("data-dashboard-panel-tab"));if(u===T(e?.dashboardPanelTab))return;e.dashboardPanelTab=u,f()}}catch{}}))}function J(r=""){const s=e?.userProfile||{},i=r?A(r)||{}:{},d=String(i.name||i.restaurantName||s.name||"").trim()||"Business";let u="";try{u=String(de()||"").trim()}catch{}if(!u)try{u=String(oe(i)||"").trim()}catch{}return{name:d,logoUrl:u,kind:I(),coverUrl:ba(i),subscribed:pa({profile:s,restaurant:i})}}function De(){Ie(D),ze();const r=j(),s=G(r);let i="";if(!r)i=we()?`${ta()}${ee()}`:ra();else{ye(),_e();const d=J(r),u=Le({kind:d.kind,isOwner:ie(e?.userProfile)}),b=T(e?.dashboardPanelTab);s.status==="idle"&&(s.status="loading",queueMicrotask(()=>{E({force:!1})}));let x="";s.model?x=ea({posts:s.model.posts,iconFn:p}):s.status==="error"?x=na({message:s.error}):x=ee();const w=`
        ${Ze({iconFn:p})}
        ${Ve({iconFn:p,showEditor:!!r})}
        ${Ge({iconFn:p,kind:d.kind,showEditor:!!r})}
        ${We({actions:u,iconFn:p})}
        ${x}
      `;let S;b==="analitika"?S=`<div class="mnyra-dash__embed">${le()}</div>`:b==="opsionet"?S=`<div class="mnyra-dash__embed">${ce()}</div>`:S=w;const g=ga({model:s.model,coverUrl:d.coverUrl,subscribed:d.subscribed,assets:da}),P=String(s.paywall||"").trim();i=`
        ${He({name:d.name,logoUrl:d.logoUrl,iconFn:p})}
        ${Je({cards:g,iconFn:p})}
        ${Xe(`
          ${Qe({activeTab:b,iconFn:p})}
          ${S}
        `)}
        ${P?aa({title:la[P]||"Me pagesë"}):""}
      `}return`
      <section class="mnyra-dash" data-dashboard-root>
        ${i}
      </section>
    `}return Object.freeze({renderDashboardView:De,loadDashboard:E})}export{Re as M,ka as a,Ue as b,je as c,va as d,wa as f,Te as n};
