...
`,g=Object.freeze({brand:"Mnyra GO",partyQuestion:"Sa veta jeni?",partyOne:"person",partyMany:"veta",step:"Hapi",stepBack:"Kthehu një hap prapa",next:"Vazhdo",categoryQuestion:"Çka dëshironi?",whenQuestion:"Kur?",whenLaterLabel:"Zgjidh ditën dhe orën",placeQuestion:"Ku?",placeLabel:"Qyteti",placeEmpty:"Shto qytetin tënd",cityPlaceholder:"Shkruaj qytetin",locationChange:"Ndrysho",locationSave:"Ruaj",submit:"Shiko ofertat",searching:"Po kërkojmë...",resultsHeadline:"lokale kanë oferta për ju",offering:"po ju ofron",forGroup:"për grupin tuaj",accept:"Prano ofertën",confirming:"Po konfirmohet...",sponsored:"Sponsored",onlyGo:"Vetëm me Mnyra GO",tableIncluded:"Tavolinë",emptyTitle:"Nuk gjetëm ofertë GO që përputhet tani.",emptySubtitle:"Provo me një orë tjetër ose me një grup tjetër.",doneTitle:"U krye",reservationConfirmed:"Tavolina është konfirmuar",claimConfirmed:"Oferta është e juaja",menu:"Shiko menunë",directions:"Udhëzime",code:"Kodi",cancel:"Anulo",cancelConfirm:"Dëshiron ta anulosh?",cancelYes:"Po, anuloje",cancelNo:"Jo",saveToAccount:"Ruaje në llogarinë tënde",signIn:"Hyr",errorTitle:"Mnyra GO është përkohësisht i padisponueshëm.",errorRetry:"Provo prapë",alternatives:"alternativa për ju",peopleSuffix:"persona",now:"Tani",back:"Ndrysho kërkimin"}),w="/apps/menyra-social/assets/go/",k=Object.freeze([Object.freeze({file:"story-1-uritur.webp",alt:"Vajzë ulur në tavolinë, e uritur",side:"right",focus:"left",headline:Object.freeze(["A je ",Object.freeze({accent:"unt?"})]),text:Object.freeze(["Hape Mnyra GO edhe thuaj veç ",Object.freeze({accent:"sa veta jeni"})," edhe çka po ju hahet."])}),Object.freeze({file:"story-2-kerkim.webp",alt:"Vajzë që shikon telefonin, tuj kërku lokal",side:"left",focus:"right",headline:Object.freeze(["Ku me ",Object.freeze({accent:"shku?"})]),text:Object.freeze(["Po kërkon restorant a kafe, po s’po din ku? ",Object.freeze({accent:"Mos kërko"})," — lokalet t’gjejnë ty."])}),Object.freeze({file:"story-3-oferta.webp",alt:"Vajzë e gëzueme me telefon në dorë",side:"right",focus:"left",headline:Object.freeze(["Ofertat ",Object.freeze({accent:"t’vijn."})]),text:Object.freeze(["Lokalet përreth teje t’çojnë zbritje a diçka falas, ",Object.freeze({accent:"veç për grupin tënd"}),"."])}),Object.freeze({file:"story-4-tavolina.webp",alt:"Dy shoqe në tavolinë të lokalit",side:"right",focus:"center",headline:null,text:Object.freeze(["Zgjedh njënën, shko edhe ",Object.freeze({accent:"knaqu."})," Kaq âsht Mnyra GO."])})]);function b(a=[],e="mnyra-go-page__story-accent"){return(Array.isArray(a)?a:[a]).map(t=>{if(typeof t=="string")return n(t);const r=typeof t?.accent=="string"?t.accent:"";return r?`<span class="${e}">${n(r)}</span>`:""}).join("")}function ne(a=[]){return(Array.isArray(a)?a:[a]).map(e=>typeof e=="string"?e:String(e?.accent||"")).join("")}const E=Object.freeze({now:"zap",in30:"timer",in60:"clock",later:"calendar-clock"}),p=Object.freeze(["party","category","when","place"]),$=Object.freeze({party:"users",category:"utensils",when:"clock",place:"map-pin"});function n(a=""){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function f(a=""){const e=String(a||"").trim();return p.includes(e)?e:p[0]}function te(a=""){const e=p.indexOf(f(a));return p[Math.min(p.length-1,e+1)]}function re(a=""){const e=p.indexOf(f(a));return p[Math.max(0,e-1)]}function u(a){const e=Math.trunc(Number(a));return Number.isFinite(e)?Math.min(m,Math.max(l,e)):O}function S(a,e=g){return u(a)===1?e.partyOne||g.partyOne:e.partyMany||g.partyMany}function z(a,e=g){return`${u(a)} ${S(a,e)}`}function D(a){const e=u(a),t=m-l;return Math.round((e-l)/t*100)}function M(a,{active:e=!1,attr:t="",value:r="",iconName:i="",wide:s=!1}={}){return`
  ...
  `}function j(a,{nowMs:e=Date.now()}={}){const t=Date.parse(String(a||""));if(!Number.isFinite(t))return"";if(Math.abs(t-e)<900*1e3)return g.now;const r=new Date(t);return`Rreth ${String(r.getHours()).padStart(2,"0")}:${String(r.getMinutes()).padStart(2,"0")}`}function F(a="",e={},t=g){if(a==="party")return z(e.partySize,t);if(a==="category"){const r=_.find(i=>i.key===String(e.category||"all"));return r?r.label:""}if(a==="when"){const r=v.find(i=>i.key===String(e.when||"now"));return r?r.label:""}return a==="place"?String(e.city||"").trim()||t.placeEmpty:""}function G(a="",e={},t=g){const r=p.indexOf(a),i=p.slice(0,Math.max(0,r));return i.length?`
    <div class="mnyra-go-page__ask-done">
      ${i.map(s=>`
        <button type="button" class="mnyra-go-page__ask-tag" data-go-goto="${n(s)}">
          ${o($[s]||"check-check")}<span>${n(F(s,e,t))}</span>
        </button>
      `).join("")}
    </div>
  ...
  `}function P(a={},e=g){const t=String(a.when||"now");return`
    <div class="mnyra-go-page__chips" role="group" aria-label="${n(e.whenQuestion)}">
      ${v.map(r=>M(r.label,{active:t===r.key,attr:"data-go-when",value:r.key,iconName:E[r.key]||"clock"})).join("")}
    </div>
    ${t==="later"?`
  ...
  `}function B(a={},{texts:e=g,busyOfferId:t="",nowMs:r=Date.now()}={}){const i=t&&t===a.offerId,s=Number.isFinite(Number(a.distanceKm))&&a.distanceKm!==null?`${Number(a.distanceKm).toFixed(1)} km`:"",d=a.isNow?e.now:j(a.expectedArrivalAt,{nowMs:r});return`
  ...
  `}function I(a={},e=g){const t=Array.isArray(a.results)?a.results:[],r=Number(a.nowMs)||Date.now();return t.length?`
    ...
    ${t.map(i=>B(i,{texts:e,busyOfferId:a.busyOfferId,nowMs:r})).join("")}
  ...
  `}function H(a={},e=g){const t=String(a.error||"").trim()||e.errorTitle;return`
    ...
    ${Array.isArray(a.alternatives)&&a.alternatives.length?`
      ...
      ${a.alternatives.map(r=>B(r,{texts:e,nowMs:a.nowMs})).join("")}
    `:`
  ...
  `}function Z(a={}){return N(a.storyShown)}function ie(a={}){const e={...g,...a.texts||{}},t=String(a.view||"search"),r=t==="search";let i="";return t==="loading"?i=`<div class="mnyra-go-page__empty">${n(e.searching)}</div>`:t==="results"?i=I(a,e):t==="booking"?i=C(a,e):t==="error"?i=H(a,e):i=Z(a),`
