...
`;function M(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function He({businessName:e="",logoUrl:t="",imageUrl:a="",variant:n="",benefitLabel:r="",benefitView:o=null,sponsored:h=!1,meta:l=[],ctaLabel:g="",ctaIcon:_="check-check",ctaDisabled:b=!1,cardAttrs:m="",ctaAttrs:p="",texts:x=Se}={}){const k={...Se,...x||{}},S=(Array.isArray(l)?l:[]).filter(I=>I&&I.label),N=String(g||k.accept),$=o&&typeof o=="object"?o:{},T=String($.headline||r||""),C=String($.priceGo||""),w=String($.priceRegular||""),D=String(a||"").trim(),B=Mt({imageUrl:D,variant:n}),A=B===ce,v=D?`<img class="mnyra-go-page__card-photo" src="${M(D)}" alt="" loading="lazy" decoding="async" />`:"",Z=`
...
`;function jt(e=typeof document>"u"?null:document){if(!(!e||e.getElementById($e)))try{const t=e.createElement("style");t.id=$e,t.textContent=We,e.head?.appendChild(t)}catch{}}const i=Object.freeze({brand:"Mnyra GO",mark:"⚡",brandMnyra:"MNYRA",brandGo:"GO",createOfferAction:"Krijo ofertë",groupNext:"Menaxhimi",groupBack:"Puna e ditës",soonStats:"Këtu do të shohësh se si ecën GO për ty me kalimin e kohës.",soonPayments:"Këtu do të shohësh faturat dhe pagesat e tua për MNYRA GO.",soonHint:"Së shpejti",emptyTitle:"Merr klientë kur ata janë gati të dalin.",emptyAction:"Aktivizo ofertën e parë",cardIdle:"Krijo oferta për klientët që kërkojnë tani.",cardManage:"Menaxho GO",tabs:{pending:"Në pritje",active:"Aktivizo",finalized:"Finalizuar",stats:"Statistikat",payments:"Pagesat",offers:"Ofertat",options:"Opsionet"},statNew:"Të reja",statActive:"Aktive",statToday:"Sot",guests:"Mysafirë",goOn:"GO Aktiv",pause:"Pauzo GO",resume:"Aktivizo GO",pausedUntil:"Pauzuar deri",createOffer:"Ofertë e re GO",editorHint:"Krijoje ofertën një herë. Mnyra ua shfaq automatikisht klientëve që përputhen.",today:"Sot",current:"Aktuale",kpiViewsTitle:"Shikime të ofertave",kpiViewsNote:"Sa persona i kanë parë ofertat e tua.",kpiChosenTitle:"Oferta të zgjedhura",kpiChosenNote:"Sa herë klientët kanë zgjedhur ofertën tënde.",kpiVisitsTitle:"Vizita të realizuara",kpiVisitsNote:"Oferta të përdorura dhe verifikuara në lokal.",kpiGuestsTitle:"Klientë të sjellë",kpiGuestsNote:"Sa persona kanë ardhur përmes MNYRA GO.",kpiDueTitle:"Për pagesë",kpiDueNote:"Shuma aktuale për MNYRA GO.",kpiDueClear:"Asgjë për pagesë.",kpiPending:"Po ngarkohet",editOffer:"Ndrysho ofertën",preview:"Kështu e sheh klienti",activate:"Aktivizo",save:"Ruaj ofertën",saving:"Po ruhet...",close:"Mbyll",edit:"Edit",offering:"po ju ofron",forGroup:"për grupin tuaj",accept:"Prano ofertën",finalizeTitle:"Finalizo ofertën",benefitQuestion:"Çka po ofron?",benefitHint:"Zgjidh çfarë dëshiron t'i ofrosh klientit.",benefitPercent:"Zbritje %",benefitBundle:"Paketë GO",benefitFree:"Falas",benefitSpecial:"Çmim special",benefitLegacy:"Zgjidh llojin e ofertës.",discountQuestion:"Sa zbritje po ofron?",discountOther:"Tjetër",discountPlaceholder:"Shkruaj zbritjen",scopeQuestion:"Ku vlen zbritja?",scopeAll:"Krejt fatura",scopeFood:"Ushqim",scopeDrinks:"Pije",bundleQuestion:"Çka përfshin paketa?",bundlePlaceholder:"p.sh. 2 Burger + 2 Pije",freeQuestion:"Çka merr falas?",freePlaceholder:"p.sh. 1 Pije",conditionQuestion:"Kur e merr falas?",conditionFood:"Me ushqim",conditionDrink:"Me pije",conditionAny:"Me çdo porosi",conditionCustom:"Tjetër",customConditionQuestion:"Shkruaj kushtin",customConditionPlaceholder:"p.sh. kur porosit 2 pizza",productQuestion:"Cili produkt?",productPlaceholder:"p.sh. Pizza Margherita",priceRegular:"Çmimi normal",priceGo:"Çmimi GO",pricePlaceholder:"0,00",saving:"Kursen",photoQuestion:"Foto e ofertës",photoHint:"Shto një foto që klienti ta shohë ofertën menjëherë.",photoOptional:"Opsionale",photoAdd:"Shto një foto",photoSource:"Nga telefoni ose kamera",photoChange:"Ndrysho",photoRemove:"Hiq",photoUploading:"Po ngarkohet...",photoError:"Fotoja nuk u ngarkua. Provo prapë.",partyQuestion:"Për sa persona vlen?",partyHint:"Zgjidh për çfarë madhësie të grupit vlen oferta.",partyAll:"Të gjithë",categoryQuestion:"Kur të shfaqet oferta?",categoryHint:"Zgjidh kur kjo ofertë i përshtatet kërkimit të klientit.",ifFood:"Nëse kërkohet ushqim",ifDrinks:"Nëse kërkohet kafe / pije",scheduleQuestion:"Kur vlen oferta?",scheduleHint:"Zgjidh kur klientët mund ta përdorin ofertën.",always:"Gjithmonë",specificHours:"Orar specifik",daysQuestion:"Ditët",hoursQuestion:"Orari",hoursFrom:"Nga",hoursTo:"Deri",limitsTitle:"Kufijtë",slotGroups:"Grupe për 30 min",slotGuests:"Mysafirë për 30 min",dailyGroups:"Grupe në ditë",totalRedemptions:"Sa herë gjithsej",noLimit:"0 = pa kufi",paused:"Pauzuar",archived:"Arkivuar",archive:"Arkivo",noBookings:"Ende asnjë klient sot.",noHistory:"Ende asnjë histori.",loading:"Po ngarkohet...",guestName:"Mnyra Guest",around:"Rreth",finalize:"Finalizo",needsActivation:"Klienti duhet ta aktivizojë ofertën.",search:"Kërko",codePlaceholder:"Kodi i klientit",codeNotFound:"Kodi nuk u gjet.",codeRetry:"Provo përsëri.",activateTitle:"Aktivizo ofertën",activateHint:"Shkruaj kodin ose skano QR-në.",scanQr:"Skano QR-në",cameraClose:"Mbyll kamerën",cameraDenied:"Lejo kamerën për të skanuar QR-në.",cameraFailed:"Kamera nuk mund të hapej. Përdor kodin.",finalizeFailed:"Finalizimi dështoi. Provo përsëri.",partyAtTable:"Sa persona?",partyLess:"Një person më pak",partyMore:"Një person më shumë",dealCode:"Oferta",personOne:"person",personMany:"persona",commission:"Provizioni",keepsRunning:"Rezervimet ekzistuese mbeten. Vetëm të rejat ndalen.",onlyBusiness:"Ky funksion eshte vetem per profile biznesi.",loadingBusiness:"Biznesi po ngarkohet..."});function Ve({className:e="",label:t="",attrs:a="",deps:n={}}={}){const r=n.escapeHtml;return`
  ...
  `}function s(e,t=""){return typeof e=="function"?e(t):String(t??"")}function P(e,t="",a="w-4 h-4"){return typeof e=="function"?e(t,a):""}function he(e=""){const t=Date.parse(String(e||""));if(!Number.isFinite(t))return"";const a=new Date(t);return`${String(a.getHours()).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}`}function Ct({enabled:e=!1,unseenCount:t=0,activeOffers:a=0,todayBookings:n=0,iconFn:r=null,texts:o={}}={}){if(!e)return"";const h={...i,...o||{}},l=Math.max(0,Math.trunc(Number(t)||0)),g=a>0||n>0,_=g?`${a} oferta aktive · ${n} rezervime sot`:h.cardIdle;return`
...
`;function Gt(e={},t={}){const a=t.escapeHtml,n=t.icon;return`
        ...
        <div class="go-tabs__track">
          ${te.map((_,b)=>`
            <div class="mnyra-work__pills go-tabs__pane" role="tablist" data-go-tab-pane="${b}"${b===h?"":' aria-hidden="true" inert'}>
              ${_.tabs.map(m=>{const p=m==="pending",x=p?`<span class="go-tabs__count" aria-hidden="true">${s(r,String(g))}</span>`:P(o,Ot[m],"w-4 h-4"),k=p?`${g} ${i.tabs[m]}`:i.tabs[m];return`
  ...
  `}function ue(e={}){return e.partySizeVerified||e.partySizeRequested||e.partySize||1}function Lt(e=""){const t=String(e||"").trim().length;return t<=8?"xl":t<=18?"lg":t<=36?"md":"sm"}function It(e={},t={}){const a=t.escapeHtml,n=t.icon,r=e.benefitLabel||e.snapshot?.benefitLabel||"",o=!e.businessSeenAt,h=ue(e),l=he(e.acceptedAt),g=l?`${i.around} ${l}`:i.guestName;return`
    <div class="p-4 rounded-[1.6rem] border ${o?"bg-indigo-50/50 border-indigo-100":"bg-slate-50 border-slate-100"}"
      ...
      <div class="flex items-start justify-between gap-3">
        <p class="text-sm font-black text-slate-900 truncate min-w-0">${s(a,g)}</p>
  ...
  `}function Ut({code:e="",status:t="",busy:a=!1,cameraOpen:n=!1,cameraError:r="",booking:o=null,bookingEntering:h=!1,deps:l={}}={}){const g=l.escapeHtml,_=l.icon,b=o&&typeof o=="object"?o:null,m=!!b&&!h,p=String(t||"").trim()||String(r||"").trim();return`
    <div class="go-activate" data-go-activate data-go-camera="${n?"1":"0"}"
      ...
      <div class="go-activate__face" data-go-activate-face>
        <p class="go-activate__title">${s(g,i.activateTitle)}</p>
        <p class="go-activate__hint">${s(g,i.activateHint)}</p>
        <div class="go-activate__row go-code-box">
          <input type="text" data-go-code-input value="${s(g,e)}"
            placeholder="${s(g,i.codePlaceholder)}"
          ...
          <button type="button" data-go-camera-open class="go-activate__qr"
            aria-label="${s(g,i.scanQr)}" title="${s(g,i.scanQr)}">
        ...
        -->
        <p class="go-activate__status" role="status" data-go-code-status>${s(g,b?"":p)}</p>
      </div>
      <!--
      ...
      <div class="go-activate__cam" data-go-activate-cam>
        ...
        <button type="button" data-go-camera-close class="go-activate__cam-close"
          aria-label="${s(g,i.cameraClose)}" title="${s(g,i.cameraClose)}">
          ${P(_,"x","w-4 h-4")}
        </button>
      </div>
      ${b?Wt({booking:b,code:e,busy:a,note:p,deps:l}):""}
    </div>
  `}function Wt({booking:e={},code:t="",busy:a=!1,note:n="",deps:r={}}={}){const o=r.escapeHtml,h=ue(e),l=e.benefitLabel||e.snapshot?.benefitLabel||"",g=de(e.status),_=String(t||"").trim().toUpperCase();return`
  ...
  `}function Ke({title:e="",note:t="",iconName:a="",deps:n={}}={}){const r=n.escapeHtml,o=n.icon;return ae({eyebrow:i.brand,title:e,sub:i.soonHint,body:`
    ...
    <div class="p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100" data-go-offer="${s(a,e.id)}">
      ...
      <div style="pointer-events:none;" aria-hidden="true">
        ${He({businessName:"",imageUrl:e.imageUrl||"",variant:ce,benefitLabel:e.benefitLabel||"",benefitView:Te(e.benefit||{}),meta:[{icon:"users",label:Ze(e)},{icon:"clock",label:Ge(e)}]})}
      </div>
  ...
  `}function qt({offer:e={},businessName:t="",previewImageUrl:a="",deps:n={}}={}){const r=n.escapeHtml;return`
    <div data-go-offer-preview>
      ...
      -->
      <div style="pointer-events:none;" aria-hidden="true">
        ${He({businessName:t,imageUrl:a||e.imageUrl||"",benefitLabel:e.benefitLabel||"",benefitView:Te(e.benefit||{}),meta:[{icon:"users",label:Ze(e)},{icon:"clock",label:Ge(e)}]})}
      </div>
    </div>
...
`;function oe({attr:e="",unit:t="€",value:a="",placeholder:n="",mode:r="decimal",inputClass:o="",escapeHtml:h=null}={}){return`
  ...
  `}const De=Object.freeze([10,15,20,25]);function Yt({benefit:e={},percentCustom:t=!1,errorFor:a=()=>"",inputClass:n="",inputBase:r="",escapeHtml:o=null}={}){const h=p=>O(o,p),l=p=>{const x=a(p);return x?`<p class="mt-2 text-[11px] font-bold text-rose-500" data-go-error="${s(o,p)}">${s(o,x)}</p>`:""};if(!vt.includes(e.kind))return`
      <p class="go-offer-saving font-bold text-slate-400">${s(o,i.benefitLegacy)}</p>
      ${l("benefit")}
    `;const g=Number(e.percent)||0,_=t||g>0&&!De.includes(g),b=()=>{const p=yt(e.savingCents);if(!p)return"";const x=Math.round(Number(e.savingPercent)||0);return`
      <p class="mt-3 go-offer-saving font-black text-emerald-600" data-go-benefit-saving>
        ${s(o,i.saving)} ${s(o,p)}${x>0?` &middot; -${x}%`:""}
      </p>
    `},m=()=>`
    <div class="mt-3">
      ${h(i.priceRegular)}
  ...
  `;if(e.kind===Fe)return`
      ...
      <div class="mt-2 flex flex-wrap gap-2">
        ${De.map(p=>q(`${p}%`,{active:!_&&g===p,attr:"data-go-discount",value:String(p),escapeHtml:o})).join("")}
        ${q(i.discountOther,{active:_,attr:"data-go-discount",value:"other",escapeHtml:o})}
      </div>
      ${_?`
        <div class="mt-3">
          ${oe({attr:"data-go-benefit-percent",unit:"%",mode:"numeric",value:g>0?String(g):"",placeholder:i.discountPlaceholder,inputClass:r,escapeHtml:o})}
        </div>
      `:""}
      ${l("benefitPercent")}
      ...
      <div class="mt-4">
        ${h(i.scopeQuestion)}
        <div class="mt-2 flex flex-wrap gap-2">
          ${[["all",i.scopeAll],["food",i.scopeFood],["drinks",i.scopeDrinks]].map(([p,x])=>q(x,{active:(e.scope||"all")===p,attr:"data-go-discount-scope",value:p,escapeHtml:o})).join("")}
        </div>
        ${l("benefitScope")}
      </div>
    `;if(e.kind===Me)return`
      ...
      ${l("benefitItem")}
      ${m()}
    `;if(e.kind===je){const p=String(e.conditionType||"");return`
      ${h(i.freeQuestion)}
      <input type="text" data-go-benefit-item autocomplete="off"
      ...
      <div class="mt-4">
        ...
        <div class="mt-2 grid grid-cols-2 gap-2">
          ${[["food",i.conditionFood],["drink",i.conditionDrink],["any_order",i.conditionAny],["custom",i.conditionCustom]].map(([x,k])=>q(k,{active:p===x,attr:"data-go-benefit-condition",value:x,escapeHtml:o})).join("")}
        </div>
        ${p==="custom"?`
          <div class="mt-3">
    ...
    `}return e.kind===Ce?`
      ...
      ${l("benefitItem")}
      ${m()}
    `:""}function Jt({imageUrl:e="",photo:t={},escapeHtml:a=null,icon:n=null}={}){const r=String(t.status||""),o=r==="uploading",h=String(t.previewUrl||e||""),l=r==="error"?String(t.error||i.photoError):"",g=h?`
  ...
  `}function Xt(e=""){const t=String(e||"all").trim().toLowerCase();return t==="food"?["food"]:t==="coffee"||t==="drinks"||t==="dessert"?["drinks"]:["food","drinks"]}function Na(e=[]){const t=Array.isArray(e)?e:[],a=t.includes("food"),n=t.includes("drinks");return a&&n?"all":a?"food":n?"drinks":""}function La({editor:e=null,businessName:t="",deps:a={}}={}){if(!e)return"";const n=a.escapeHtml,r=a.icon,o=e.draft||{},h=Array.isArray(e.errors)?e.errors:[],l=w=>h.find(D=>D.field===w)?.message||"",g=Array.isArray(o.partyRanges)?o.partyRanges:[],_=o.schedule?.mode==="windows"?"windows":"always",b=Array.isArray(o.schedule?.days)&&o.schedule.days.length?o.schedule.days:ve.slice(),m=ye.every(w=>g.includes(w.key)),p=Array.isArray(e.intents)?e.intents:Xt(o.category),x=o.benefit||{},k=e.mode==="edit",S="w-full go-offer-input bg-slate-50 border border-slate-100 rounded-2xl px-4 text-sm font-bold text-slate-900 outline-none focus:border-indigo-400",N=`mt-2 ${S}`,$='<div class="h-px bg-slate-100"></div>',T=w=>`<p class="mt-1 text-[11px] font-semibold text-slate-400">${s(n,w)}</p>`,C=_t(o).ok&&p.length>0;return`
      ...
      <div class="modal-frame">
        ...
        <div class="flex-1 overflow-y-auto no-scrollbar modal-scroll px-6 py-5 space-y-5" data-go-editor-scroll>
          ...
          <div data-go-section="partyRanges">
            ...
            <div class="mt-2 flex flex-wrap gap-2">
              ${ye.map(w=>ee(w.label,{active:g.includes(w.key),attr:"data-go-offer-party",value:w.key,escapeHtml:n})).join("")}
            </div>
          ...
          <div data-go-section="category">
            ...
            <div class="mt-3 space-y-2">
              ${[{key:"food",label:i.ifFood},{key:"drinks",label:i.ifDrinks}].map(w=>{const D=p.includes(w.key),B=wt.find(A=>A.key===w.key)?.hint||"";return`
          ...
          <div data-go-section="schedule">
            ...
            ${_==="windows"?`
              ...
              <div class="mt-4">
                ${O(n,i.daysQuestion)}
                <div class="mt-2 flex flex-wrap gap-2">
                  ${ve.map(w=>q(kt(w),{active:b.includes(w),attr:"data-go-offer-day",value:w,escapeHtml:n})).join("")}
                </div>
              </div>
              <div class="mt-4">
                ${O(n,i.hoursQuestion)}
  ...
  `}function Ia({restaurantName:e="",tab:t="active",group:a=0,overview:n={},search:r={},camera:o={},bookingEntering:h=!1,bookings:l=[],dayKey:g="",offers:_=[],settings:b={},paused:m=!1,loading:p=!1,error:x="",deps:k={}}={}){const S=k.escapeHtml,N=k.icon,$=v=>["accepted","activated"].includes(de(v.status)),T=l.filter($),C=String(g||"").trim(),w=T.filter(v=>de(v.status)==="accepted"&&(!C||v.dayKey===C)),D=l.filter(v=>!$(v)),B=_.filter(v=>v.status!=="archived");let A="";if(t==="offers")A=ae({eyebrow:i.brand,title:i.tabs.offers,sub:`${B.length} ${B.length===1?"oferte":"oferta"}`,action:`
      ...
      `,body:B.length?`<div class="space-y-3">${B.map(v=>Vt(v,k)).join("")}</div>`:`<div class="text-center py-10 text-[10px] font-bold uppercase tracking-widest text-slate-300">${s(S,i.emptyTitle)}</div>`,deps:k});else if(t==="finalized")A=ae({eyebrow:i.brand,title:i.tabs.finalized,sub:`${D.length}`,body:D.length?`<div class="space-y-3">${D.map(v=>It(v,k)).join("")}</div>`:`<div class="text-center py-10 text-[10px] font-bold uppercase tracking-widest text-slate-300">${s(S,i.noHistory)}</div>`,deps:k});else if(t==="pending")A=p?`<p class="go-pending__note go-pending__note--loading" role="status">${s(S,i.loading)}</p>`:w.length?`<div class="go-pending">${w.map(v=>Ht(v,k)).join("")}</div>`:`<p class="go-pending__note">${s(S,i.noBookings)}</p>`;else if(t==="stats")A=Ke({title:i.tabs.stats,note:i.soonStats,iconName:"bar-chart-3",deps:k});else if(t==="payments")A=Ke({title:i.tabs.payments,note:i.soonPayments,iconName:"wallet",deps:k});else if(t==="options"){const v=he(b?.pausedUntil);A=ae({eyebrow:i.brand,title:i.tabs.options,body:`
        <div class="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
          <div>
            <p class="text-xs font-black text-slate-800">${s(S,i.goOn)}</p>
            <p class="text-[10px] font-bold text-slate-400">${s(S,m?`${i.pausedUntil} ${v}`:"ON")}</p>
          </div>
        ...
        <div class="mt-4 flex flex-wrap gap-2">
          ${m?`<button type="button" data-go-pause="0" class="go-pause px-4 rounded-2xl bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest">${s(S,i.resume)}</button>`:[{value:"30",label:"30 min"},{value:"60",label:"1 orë"},{value:"tomorrow",label:"Deri nesër"},{value:"-1",label:"Pa afat"}].map(Z=>`
              <button type="button" data-go-pause="${Z.value}"
                class="go-pause px-4 rounded-2xl bg-slate-50 border border-slate-100 text-[10px] font-black uppercase tracking-widest text-slate-600">${s(S,Z.label)}</button>
            `).join("")}
        </div>
...
`;function ta(e=typeof document>"u"?null:document){if(jt(e),!(!e||e.getElementById(Pe)))try{const t=e.createElement("style");t.id=Pe,t.textContent=ea,e.head?.appendChild(t)}catch{}}function y(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function R(e,t,a=""){if(typeof e!="function")return"";try{return e(t,a)||""}catch{return""}}const aa=Object.freeze(["hotel","motel","hostel","resort","accommodation","travel"]);function na({businessType:e="",isShopCatalog:t=!1}={}){if(t)return"shop";const a=String(e||"").trim().toLowerCase();return aa.includes(a)?"hotel":"restaurant"}function ia(e=new Date().getHours()){const t=Number.isFinite(Number(e))?(Math.trunc(Number(e))%24+24)%24:12;return t>=5&&t<=10?{dayPart:"mengjes",text:"Ju urojmë një mëngjes të mbarë!"}:t>=11&&t<=17?{dayPart:"dite",text:"Ju urojmë një ditë të mbarë!"}:t>=18&&t<=21?{dayPart:"mbremje",text:"Ju urojmë një mbrëmje të mbarë!"}:{dayPart:"nate",text:"Ju urojmë një natë të mbarë!"}}function ra({name:e="",logoUrl:t="",hour:a=new Date().getHours(),iconFn:n}={}){const r=ia(a),o=y(e||"Business");return`
    <div class="mnyra-work__head mnyra-dash__greet">
      <p class="mnyra-dash__greet-title">
        ...
        <span class="mnyra-dash__greet-logo">
          ${t?`<img src="${y(t)}" alt="${o}" title="${o}" loading="lazy" decoding="async" onerror="this.style.display='none'" />`:`<span class="mnyra-dash__greet-logo-fallback" title="${o}">${R(n,"store","w-4 h-4")}</span>`}
        </span>
      </p>
  ...
  `:""}function ga({cards:e=[],iconFn:t}={}){const a=(Array.isArray(e)?e:[]).filter(r=>r&&r.key);if(!a.length)return"";const n=a.map((r,o)=>{const h=y(r.label||"");if(r.pending)return'<div class="mnyra-dash__hl-card mnyra-dash__hl-card--pending" aria-hidden="true"></div>';const l=o<2?'loading="eager" fetchpriority="high"':'loading="lazy" fetchpriority="low"';let g="";r.imageUrl?g=`<img class="mnyra-dash__hl-media" src="${y(r.imageUrl)}" alt="" ${l} decoding="async" onerror="this.style.display='none'" />`:r.videoUrl&&(g=`<video class="mnyra-dash__hl-media" src="${y(r.videoUrl)}#t=0.1" preload="metadata" muted playsinline disablepictureinpicture tabindex="-1" aria-hidden="true"></video>`);const _=`
    ...
    `}).join("");return`
    <div class="mnyra-work__cards" data-dashboard-metrics="${y(pa(a))}">
      ${n}
  ...
  `}function pa(e=[]){return(Array.isArray(e)?e:[]).filter(t=>t&&t.key).map(t=>[t.key,t.label||"",t.value||"",t.emptyText||"",t.imageUrl||"",t.videoUrl||"",t.iconName||"",t.panelTab||"",t.composer||"",t.pending?"p":"",t.loading?"l":"",t.locked?"x":"",t.withEye?"e":""].join("~")).join("|")}const qe=Object.freeze([Object.freeze({id:"funksionet",label:"Funksionet",iconName:"layout-grid"}),Object.freeze({id:"analitika",label:"Analitika",iconName:"bar-chart-3"}),Object.freeze({id:"opsionet",label:"Opsionet",iconName:"settings"})]);function ne(e=""){const t=String(e||"").trim().toLowerCase();return qe.some(a=>a.id===t)?t:"funksionet"}function ma({activeTab:e="funksionet",iconFn:t}={}){const a=ne(e);return`<div class="mnyra-work__pills mnyra-dash__tabs" role="tablist" data-dashboard-panel-tabs>${qe.map(r=>{const o=r.id===a;return`
      <button
        type="button"
        role="tab"
        data-dashboard-panel-tab="${y(r.id)}"
        aria-selected="${o?"true":"false"}"
        aria-label="${y(r.label)}"
        title="${y(r.label)}"
        class="mnyra-work__pill"
      >${R(t,r.iconName,"w-4 h-4")}<span class="mnyra-work__pill-label">${y(r.label)}</span></button>
  ...
  `}function fa({posts:e=[],iconFn:t}={}){const a=Array.isArray(e)?e:[];let n="";return a.length?(n=a.map(r=>{const o=[r.dateLabel,`${V(r.likesCount||0)} Likes`,`${V(r.commentsCount||0)} Kommentare`];return Number(r.impressions||0)>0&&o.push(`${V(r.impressions)} shtrirje (7 dite)`),`
        <div class="mnyra-dash__post">
          <div class="mnyra-dash__post-thumb">
            ${r.thumbUrl?`<img src="${y(r.thumbUrl)}" alt="" loading="lazy" decoding="async" onerror="this.style.display='none'" />`:R(t,r.mediaType==="video"?"play":"image","w-5 h-5")}
          </div>
          <div class="mnyra-dash__post-main">
            <p class="mnyra-dash__post-caption">${y(r.caption||"Pa tekst")}</p>
            <p class="mnyra-dash__post-meta">${y(o.filter(Boolean).join(" · "))}</p>
          </div>
        </div>
  ...
  `}function va({message:e=""}={}){return`
    <div class="mnyra-dash__section">
      <div class="mnyra-dash__state">
        ...
        <p class="mnyra-dash__state-body">${y(e||"Ju lutem kontrollo lidhjen dhe provo perseri.")}</p>
  ...
  `}const xa="menyra_social_dashboard_cache_v1::",Ee="menyra_social_composer_products_v1::",Re=2500,Be=1200,za=6,Sa=3,$a=Object.freeze({menuImageUrl:"/apps/menyra-social/assets/panel/menu-scan.jpg",qrImageUrl:"/apps/menyra-social/assets/panel/qr-stand.jpg"}),Ka=Object.freeze({menuOpens:"Menü-Aufrufe",qrScans:"QR-Scans"});function j(e){const t=Number(e);return Number.isFinite(t)?t:0}function Da(e={}){const t=String(e.createdAtClient||"").trim();if(t){const n=new Date(t);if(!Number.isNaN(n.getTime()))return n}const a=e.createdAt;if(a&&typeof a.toDate=="function")try{const n=a.toDate();if(n instanceof Date&&!Number.isNaN(n.getTime()))return n}catch{}return null}function Pa(e="",t={}){const a=Array.isArray(t.media)&&t.media.length?t.media[0]:{},n=String(a.type||t.mediaType||"image").trim().toLowerCase()==="video"?"video":"image",r=String(a.thumbUrl||(n==="image"?a.url:"")||t.thumbUrl||"").trim(),o=n==="video"?String(a.url||t.mediaUrl||"").trim():"",h=Da(t);return{id:String(e||"").trim(),caption:String(t.caption||"").trim(),mediaType:n,thumbUrl:r,videoUrl:o,likesCount:j(t.likesCount),commentsCount:j(t.commentsCount),impressions:0,dateLabel:h?h.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit"}):"",createdAtMs:h?h.getTime():0}}function Aa({days:e=[],todayKey:t="",rawPosts:a=[]}={}){const n=Array.isArray(e)?e:[],r=ke(n),o=n.find(b=>String(b?.date||b?.id||"").trim()===String(t||"").trim()),h=ke(o?[o]:[]),l=r.merged?.posts&&typeof r.merged.posts=="object"?r.merged.posts:{},g=(Array.isArray(a)?a:[]).map(b=>Pa(b?.id,b?.data||{})).filter(b=>b.id).map(b=>({...b,impressions:j(l[b.id]?.impressions)})),_=g.slice().sort((b,m)=>m.createdAtMs-b.createdAtMs).slice(0,Sa);return{day:String(t||"").trim(),week:r.summary,today:h.summary,posts:_,latestPost:Ea(g)}}function Ea(e=[]){const t=(Array.isArray(e)?e:[]).filter(a=>a&&a.id);return t.length?t.slice().sort((a,n)=>j(n.createdAtMs)-j(a.createdAtMs)||j(n.impressions)-j(a.impressions)||j(n.likesCount)-j(a.likesCount))[0]:null}function Ra({profile:e={},restaurant:t={}}={}){return bt({profile:e,restaurant:t,feature:"qr"})}function Ba(e={}){const t=e&&typeof e=="object"?e:{};return String(t.titleImageUrl||t.coverImageUrl||t.coverUrl||t.heroUrl||t.bannerUrl||"").trim()}function Fa({model:e=null,coverUrl:t="",subscribed:a=!1,assets:n={}}={}){const r=e?.today||{},o=!e,h=e?.latestPost||null,l=[];if(o)l.push({key:"latestPost",label:"Postimi fundit",pending:!0});else if(!h)l.push({key:"latestPost",label:"Postimi fundit",emptyText:"S'ka postim",iconName:"image",composer:"post"});else{const g=String(h.thumbUrl||"").trim();l.push({key:"latestPost",label:"Postimi fundit",value:V(j(h.impressions)),withEye:!0,imageUrl:g,videoUrl:g?"":String(h.videoUrl||"").trim(),iconName:"image",panelTab:"analitika"})}return l.push({key:"profileViews",label:"Vizitor n'profil",value:V(j(r.profileViews)),withEye:!0,loading:o,imageUrl:String(t||"").trim(),iconName:"user",panelTab:"analitika"}),l.push({key:"menuOpens",label:"Vizitor n'meny",value:V(j(r.menuOpens)),withEye:!0,loading:o&&a,locked:!a,imageUrl:String(n.menuImageUrl||"").trim(),iconName:"book-open",panelTab:"analitika"}),l.push({key:"qrScans",label:"Skanime n'tavolina",value:V(j(r.qrScans)),withEye:!0,loading:o&&a,locked:!a,imageUrl:String(n.qrImageUrl||"").trim(),iconName:"layout-grid",panelTab:"analitika"}),l}function Wa({state:e,renderFn:t,documentObj:a,firestoreApi:n={},profileApi:r={},composerApi:o={},viewApi:h={},iconFn:l,storageObj:g}={}){const _=a||(typeof document>"u"?null:document),b=_?.defaultView||(typeof window>"u"?null:window),m=typeof t=="function"?t:()=>{},p=g||(typeof localStorage>"u"?null:localStorage),x=typeof r.getBusinessProfileTypeFn=="function"?r.getBusinessProfileTypeFn:(()=>""),k=typeof r.isShopCatalogProfileFn=="function"?r.isShopCatalogProfileFn:(()=>!1),S=typeof r.getRestaurantMetaByIdFn=="function"?r.getRestaurantMetaByIdFn:(()=>null),N=typeof r.resolveRestaurantLogoFn=="function"?r.resolveRestaurantLogoFn:(()=>""),$=typeof r.resolveOwnAvatarUrlFn=="function"?r.resolveOwnAvatarUrlFn:(()=>""),T=typeof h.renderAnalyticsViewFn=="function"?h.renderAnalyticsViewFn:(()=>""),C=typeof h.renderSettingsViewFn=="function"?h.renderSettingsViewFn:(()=>""),w=typeof h.warmAnalyticsFn=="function"?h.warmAnalyticsFn:(()=>{});let D=!1,B=0,A=!1,v=null,Z=null,L="",I=!1,ge=()=>null;const Ye=300;function ie(){const d=e?.userProfile||{};return na({businessType:x(d),isShopCatalog:k(d)})}function Je(d=""){const c=S(d)||{};return Rt(c).map(u=>({id:u.id,name:u.title,price:u.price??"",category:u.beds||u.tag||"",type:"room",imageUrl:u.imageUrl||""}))}function Xe(d=""){if(!p)return null;try{const c=p.getItem(`${Ee}${d}`);if(!c)return null;const u=JSON.parse(c),f=Array.isArray(u?.items)?u.items:null;return f&&f.length?f:null}catch{return null}}function et(d="",c=[]){if(p)try{p.setItem(`${Ee}${d}`,JSON.stringify({savedAt:Date.now(),items:c}))}catch{}}async function tt(d=""){const{db:c,collectionFn:u,queryFn:f,limitFn:z,getDocsFn:K}=n;if(!c||typeof u!="function"||typeof K!="function")throw new Error("Produktet nuk u ngarkuan.");const H=u(c,"restaurants",d,"menuItems"),F=typeof f=="function"&&typeof z=="function"?f(H,z(Ye)):H,U=await K(F),E=[];return U.forEach(W=>{const J=ge(W?.id,W?.data?.()||{});J&&E.push(J)}),E.sort((W,J)=>W.name.localeCompare(J.name,"sq")),E}async function at(d="",c){const u=String(d||"").trim();if(!u)throw new Error("Produktet nuk u ngarkuan.");if(ie()==="hotel")return Je(u);const f=tt(u).then(K=>(et(u,K),K)),z=Xe(u);return z?(typeof c=="function"?f.then(K=>c(K)).catch(()=>{}):f.catch(()=>{}),z):f}function pe(){return v?Promise.resolve(v):(Z||(Z=pt(()=>import("./business-composer-controller-BieqEyIr.js"),__vite__mapDeps([0,1,2,3,4,5,6])).then(d=>(ge=typeof d?.normalizeComposerProductCore=="function"?d.normalizeComposerProductCore:(()=>null),v=d.createBusinessComposerController({documentObj:_,windowObj:_?.defaultView||null,api:{getRestaurantIdFn:()=>Q(),getBusinessMetaFn:()=>{const c=Q();if(!c)return{name:"",logoUrl:"",city:""};const u=we(c),f=S(c)||{};return{name:u.name,logoUrl:u.logoUrl,city:String(f.city||"").trim()}},loadProductsFn:(c,u)=>at(c,u),getBusinessKindFn:()=>ie(),uploadImageFn:o.uploadImageFn,uploadVideoFn:o.uploadVideoFn,captureVideoPosterFn:o.captureVideoPosterFn,createPostFn:o.createPostFn,createStoryFn:o.createStoryFn,formatPriceFn:o.formatPriceFn,getOptimizedImageUrlFn:o.getOptimizedImageUrlFn,escapeHtmlFn:o.escapeHtmlFn,iconFn:typeof l=="function"?l:void 0,afterPublishFn:async c=>{try{await Y({force:!0})}catch{}typeof o.afterPublishFn=="function"&&await o.afterPublishFn(c)}}}),v)).catch(d=>{throw Z=null,console.error("[mnyra][dashboard] composer load failed",d),d})),Z)}function me(){const d=b?.navigator?.connection;return!d||typeof d!="object"?!1:d.saveData===!0?!0:/(^|-)2g$/.test(String(d.effectiveType||"").trim().toLowerCase())}function nt(){if(I||v||!b||me())return;I=!0;const d=()=>{if(pe().catch(()=>{}),typeof o.prewarmFn=="function")try{o.prewarmFn()}catch{}};if(typeof b.requestIdleCallback=="function"){b.requestIdleCallback(d,{timeout:Re});return}b.setTimeout?.(d,Be)}function it(){if(D||!b||me())return;D=!0;const d=()=>{try{w()}catch{}};if(typeof b.requestIdleCallback=="function"){b.requestIdleCallback(d,{timeout:Re});return}b.setTimeout?.(d,Be)}function rt(d="post"){const c=String(d||"").trim().toLowerCase(),u=c==="story"||c==="profile"?c:"post";if(typeof o.prewarmFn=="function")try{o.prewarmFn()}catch{}if(v){v.open(u);return}L=u,pe().then(f=>{const z=L||u;L="",f?.open?.(z)}).catch(()=>{L=""})}function re(){return(!e.dashboardView||typeof e.dashboardView!="object")&&(e.dashboardView={status:"idle",error:"",model:null,loadedSignature:"",restaurantId:"",paywall:""}),e.dashboardView}function fe(d=""){const c=re(),u=String(d||"").trim();return String(c.restaurantId||"")===u||(c.restaurantId=u,c.model=null,c.status="idle",c.error="",c.loadedSignature="",c.paywall="",B+=1),c}function Q(){const d=e?.userProfile||{};return String(d.restaurantId||d.staffRestaurantId||"").trim()}let be="";function st(){const d=String(e?.user?.uid||"").trim();!d||be===d||typeof r.ensureBusinessProfileFn=="function"&&(be=d,Promise.resolve().then(()=>r.ensureBusinessProfileFn()).catch(c=>{console.warn("[mnyra][panel] business profile could not be resolved",c)}).finally(()=>{String(e?.user?.uid||"").trim()===d&&m()}))}function ot(){const d=String(e?.user?.uid||"").trim();if(!d)return!1;const c=String(e?.__authBootstrapInFlightUid||"").trim();return!!e?.__authProfileLoadPromise||c===d}function _e(d=""){return`${xa}${d}`}function dt(d="",c=""){if(!p||!d)return null;try{const u=p.getItem(_e(d));if(!u)return null;const f=JSON.parse(u);return!f||typeof f!="object"||String(f.day||"").trim()!==String(c||"").trim()||!f.model||typeof f.model!="object"?null:f.model}catch{return null}}function lt(d="",c=null){if(!(!p||!d||!c))try{p.setItem(_e(d),JSON.stringify({day:c.day,model:c}))}catch{}}async function ct(d=""){const{db:c,collectionFn:u,queryFn:f,orderByFn:z,limitFn:K,getDocsFn:H}=n;if(!c||typeof u!="function"||typeof f!="function"||typeof z!="function"||typeof K!="function"||typeof H!="function")return[];const F=u(c,"restaurants",d,"socialPosts");return(await H(f(F,z("createdAt","desc"),K(za)))).docs.map(E=>({id:E.id,data:E.data()||{}})).filter(E=>{const W=String(E.data.status||"active").trim().toLowerCase();return W!=="deleted"&&W!=="hidden"})}async function Y({force:d=!1}={}){const c=Q(),u=fe(c);if(!c)return;const f=mt({rangeKey:"7d"});if(!f)return;const z=`${c}::${f.toDay}`;if(!d&&u.loadedSignature===z&&u.status==="ready")return;if(!u.model){const F=dt(c,f.toDay);F&&(u.model=F,u.status="ready",m())}B+=1;const K=B;u.model||(u.status="loading",u.error="",m());try{const F={db:n.db,collectionFn:n.collectionFn,queryFn:n.queryFn,whereFn:n.whereFn,documentIdFn:n.documentIdFn,getDocsFn:n.getDocsFn,restaurantId:c},[U,E]=await Promise.allSettled([ft({...F,fromDay:f.fromDay,toDay:f.toDay}),ct(c)]);if(K!==B)return;if(U.status==="rejected")throw U.reason;E.status==="rejected"&&console.error("[mnyra][dashboard] recent posts load failed",E.reason),u.model=Aa({days:U.value,todayKey:f.toDay,rawPosts:E.status==="fulfilled"?E.value:[]}),u.status="ready",u.error="",u.loadedSignature=z,lt(c,u.model)}catch(F){if(K!==B)return;console.error("[mnyra][dashboard] load failed",F),u.model||(u.status="error",u.error="Ju lutem kontrollo lidhjen dhe provo perseri.")}m()}function ht(){A||!_||(A=!0,_.addEventListener("click",d=>{try{if(String(e?.activeTab||"").trim().toLowerCase()!=="dashboard")return;if(d.target?.closest?.("[data-dashboard-retry]")){Y({force:!0});return}if(d.target?.closest?.("[data-dashboard-paywall-close]")){d.preventDefault(),re().paywall="",m();return}const c=d.target?.closest?.("[data-dashboard-metric-locked]");if(c){d.preventDefault(),re().paywall=String(c.getAttribute("data-dashboard-metric-locked")||"").trim(),m();return}const u=d.target?.closest?.("[data-dashboard-composer]");if(u){d.preventDefault(),rt(u.getAttribute("data-dashboard-composer"));return}const f=d.target?.closest?.("[data-dashboard-panel-tab]");if(f){d.preventDefault();const z=ne(f.getAttribute("data-dashboard-panel-tab"));if(z===ne(e?.dashboardPanelTab))return;e.dashboardPanelTab=z,m()}}catch{}}))}function we(d=""){const c=e?.userProfile||{},u=d?S(d)||{}:{},f=String(u.name||u.restaurantName||c.name||"").trim()||"Business";let z="";try{z=String($()||"").trim()}catch{}if(!z)try{z=String(N(u)||"").trim()}catch{}return{name:f,logoUrl:z,kind:ie(),coverUrl:Ba(u),subscribed:Ra({profile:c,restaurant:u})}}function ut(d=""){try{if(!xt()||!d)return"";zt({restaurantId:d,onBadgeFn:()=>m()});const c=St();return Ct({enabled:!0,unseenCount:c.unseen,activeOffers:c.activeOffers||0,todayBookings:c.today,iconFn:l})}catch{return""}}function gt(){ta(_),ht();const d=Q(),c=fe(d);let u="";if(!d)st(),u=ot()?ka():ya();else{nt(),it();const f=we(d),z=ne(e?.dashboardPanelTab);c.status==="idle"&&(c.status="loading",queueMicrotask(()=>{Y({force:!1})}));let K="";c.model?K=fa({posts:c.model.posts,iconFn:l}):c.status==="error"?K=va({message:c.error}):K=ba();const H=`
    ...
    `}return Object.freeze({renderDashboardView:gt,loadDashboard:Y})}export{Ua as B,te as G,Kt as M,Wa as a,Ia as b,Dt as c,Oa as d,Na as e,La as f,Xt as g,qt as h,Ie as i,X as j,ce as k,le as l,He as m,Et as n,Rt as o,Ga as p,Ta as q,Ha as r};
