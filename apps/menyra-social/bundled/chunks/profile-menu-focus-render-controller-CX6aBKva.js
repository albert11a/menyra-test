import{e as pe,f as Cs,t as Ps,g as Fs,h as Ae,a as js}from"../entry/social-app.js";import"./startup-route-runtime-context-6Co7bthZ.js";import"./vendor-firebase-V03pMX6J.js";function zs(x={}){const d=x.state,Dt=x.resolvePostCountsFn,s=x.escapeHtmlFn,U=x.getOptimizedImageUrlFn,g=x.iconFn,Vt=x.isLocalBusinessProfileFn,Kt=typeof x.isCeoUserFn=="function"?x.isCeoUserFn:(()=>!1),et=x.normalizeHandleFn,Te=x.logoFitClassFn,M=x.formatCountFn,tt=x.renderProfileShopCartViewFn,at=x.renderProfileShopFavoritesViewFn,qt=typeof x.ensurePostsDataForProfileFn=="function"?x.ensurePostsDataForProfileFn:(()=>{}),Gt=x.ensureMenuDataForProfileFn,Qt=typeof x.ensureEditorMenuDataForProfileFn=="function"?x.ensureEditorMenuDataForProfileFn:(()=>{}),fe=x.ensureFocusDataForProfileFn,Wt=typeof x.ensureAdsDataForProfileFn=="function"?x.ensureAdsDataForProfileFn:(()=>{}),st=x.ensureTableQrStateForProfileFn,X=x.isShopCatalogProfileFn,nt=x.getBusinessCatalogLabelFn,ae=x.normalizeMenuTypeFn,Yt=x.primeMenuItemCountsFn,Zt=typeof x.hydrateMenuCardViewerLikesFn=="function"?x.hydrateMenuCardViewerLikesFn:(()=>Promise.resolve()),Jt=x.renderShopProductListFn,Xt=x.getMenuLayoutThemeFn,ea=x.menuLayoutColors,q=x.resolveMenuItemHeroFn,D=x.isPlaceholderUrlFn,B=x.placeholderImage,ta=x.getFirebaseStorageUrlFn,aa=x.isDirectImageUrlFn,rt=x.formatPriceFn,sa=typeof x.resolveCurrencyCodeForMenuItemFn=="function"?x.resolveCurrencyCodeForMenuItemFn:(()=>""),it=x.getMenuItemImagesFn,V=x.getMenuItemObjectPositionFn,ge=x.getMenuItemSocialIdFn,ot=x.menuItemMetaKeyFn,lt=x.ensureMenuItemMetaFn,ct=x.resolveMenuItemCountsFn,me=x.getFocusStateForRestaurantFn,na=typeof x.getAdsStateForRestaurantFn=="function"?x.getAdsStateForRestaurantFn:(()=>({items:[],enabled:!0,loading:!1,same:!1})),be=x.getTableQrStateForRestaurantFn,oe=x.getFocusItemObjectPositionFn,dt=x.getFocusCardClassFn,ra=x.getFocusIndexFn,se=x.isRestaurantCafeProfileFn,ze=typeof x.getBusinessProfileTypeFn=="function"?x.getBusinessProfileTypeFn:(()=>""),le=x.getRestaurantMetaByIdFn,ia=x.buildUrlFn,oa=x.normalizeSearchKeyFn,la=x.normalizeFollowHandleFn,W={key:"",inFlightKey:""},u=(e,t=e,a={})=>Ps(e,{fallback:t,params:a}),ut=(e="")=>{const t=String(e||"").trim();if(!t)return u("nav.menu","Menue");const a=t.toLowerCase();return a==="menue"||a==="menu"||a==="menü"?u("nav.menu",t):a==="shop"?"Shop":t},ca=(e="food")=>String(e||"").trim().toLowerCase()==="drink"?u("menu.drinks","Getraenke"):u("menu.food","Speisen"),pt=(e={},t=!1)=>{const a=ae(e?.type||"food");return t?a==="drink"?u("menu.variant","Variante"):u("menu.product","Produkt"):a==="drink"?u("menu.drinkItem","Getraenk"):u("menu.foodItem","Speise")},_e=(e="",t="#111827")=>{const a=String(e||"").trim();return/^#[0-9a-fA-F]{6}$/.test(a)?a:t};function da(e=null,t=null){return pe(d,{profile:e,routePayload:t,webDirectEntry:d?.__webDirectEntry}).restaurantId}function ft(e=null,t=""){if(!e||typeof e!="object")return e;const a=String(t||"").trim();if(!a)return e;const n=String(e.canonicalRestaurantId||"").trim();return String(e.restaurantId||"").trim()===a&&n?e:{...e,restaurantId:a,...n?{canonicalRestaurantId:n}:{}}}function ua(e=""){const t=String(e||"").trim();return t?pe(d,{profile:d?.profileView?.profile||d?.userProfile,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:t}).focus.canRenderFocus:!1}function ce(e={}){const t=String(sa(e)||"").trim();return t?rt(e?.price,t):rt(e?.price)}function pa(e=[],t="",a=""){const n=String(t||"").trim(),r=String(a||"").trim();if(!n||!r)return"";const i=Array.isArray(e)?e:[];if(!i.length)return`${n}|${r}|empty`;const o=[];return i.forEach(l=>{const c=String(ge(l)||l?.id||"").trim();c&&o.push(c)}),o.length?(o.sort(),`${n}|${r}|${o.join(",")}`):`${n}|${r}|empty`}function fa(e=[],t=""){const a=String(d.user?.uid||"").trim(),n=pa(e,t,a);n&&W.inFlightKey!==n&&W.key!==n&&(W.key=n,W.inFlightKey=n,Zt(e,t).catch(r=>{console.error(r),W.key===n&&(W.key="")}).finally(()=>{W.inFlightKey===n&&(W.inFlightKey="")}))}function ga(e={}){const t=String(e?.uid||"").trim();if(t&&d.followingTargetIds.includes(t))return!0;const a=String(e?.restaurantId||"").trim();if(a&&d.followingTargetIds.includes(a))return!0;const n=la(e?.handle||"");return!!(n&&d.followingHandles.includes(n))}function gt(e={}){if(e?.specialEnabled===!0)return!0;if(e?.specialEnabled===!1)return!1;const t=String(e?.restaurantId||"").trim();if(!t)return!1;const a=typeof le=="function"&&le(t)||null;return a?.specialEnabled===!0?!0:(a?.specialEnabled===!1,!1)}function ma(e={}){return J(e)==="testfirst_special"?!0:String(e?.category||"").trim().toLowerCase()==="special"}function mt(e,t,a=!0,{includeImageKey:n=!0}={}){const r=Dt(e),i=e.id?String(e.id):"",o=i?`data-open-post="${s(i)}"`:"",l=i?`data-post-like-count="${s(i)}"`:"",c=i?`data-post-comment-count="${s(i)}"`:"",p=n&&i?`data-img-key="profile-post:${s(i)}"`:"",f=e.type==="wide"||e.type==="hero",b=t&&f?"col-span-2":"",h=t&&f?"aspect-[1.8/1]":"aspect-[4/5]",v=U(e.url,f?"large":"medium",{stableKey:i?`profile-post:${i}`:"",variantGroup:"post-detail"}),S=f?800:400,C=f?400:500;return`
    <div ${o} role="button" tabindex="0" class="${b} relative ${h} rounded-[2rem] overflow-hidden bg-white shadow-[0_30px_60px_-12px_rgba(50,50,93,0.15),0_18px_36px_-18px_rgba(0,0,0,0.15)] cursor-pointer transition-transform">
      <div class="absolute inset-0 rounded-[2rem] overflow-hidden active:scale-[0.98] transition-transform">
        <img src="${s(v)}" loading="lazy" decoding="async" width="${S}" height="${C}" ${p} class="w-full h-full object-cover" />
  ...
  `}function Ue(e,t,a=!0,{includeImageKeys:n=!0}={}){const r=t==="grid";if(!e.length)return`
    ...
    `;const i=e.map(l=>mt(l,r,a,{includeImageKey:n})),o=e.reduce((l,c)=>{const p=c?.type==="wide"||c?.type==="hero";return l+(p?2:1)},0);return r&&o%2===1&&i.unshift(`
      <div data-profile-grid-placeholder="true" class="col-start-2 aspect-[4/5] rounded-[2rem] invisible pointer-events-none"></div>
    `),i.join("")}function Me(){const e=d.profileCheckins||[];return e.length?`
  ...
  `}function Aa(e=[],t=""){const a=String(t||"").trim(),n=new Set(e.map(Y));return`
    <option value="">Zgjidh</option>
    ${e.map(r=>`<option value="${s(r)}" ${Y(r)===Y(a)?"selected":""}>${s(r)}</option>`).join("")}
    ${a&&!n.has(Y(a))?`<option value="${s(a)}" selected>Aktuale: ${s(a)}</option>`:""}
  ...
  `}function Ta(e={},t=[]){const a=new Set(t.map(Y).filter(Boolean)),n=[],r=(i="")=>{const o=String(i||"").trim();if(!o)return;const l=Y(o);a.has(l)||n.some(c=>Y(c)===l)||n.push(o)};return[e.features,e.hotelFeatures,e.amenities,e.facilities,e.hotelAmenities].forEach(i=>ve(i).forEach(r)),n}function za({existingImages:e=[],newPreviews:t=[],imageUrlDraft:a=""}={}){const n=[...t.map((o,l)=>({src:o,kind:"new",idx:l})),...e.map((o,l)=>({src:o,kind:"existing",idx:l}))].filter(o=>o.src),r=n[0]?.src||a||"",i=r?U(r,"large"):B;return`
    <div class="space-y-4">
  ...
  `}function ht(e={}){const t=Ee(e),a=va(t),n=H(t,["address","primaryAddress","location","formattedAddress","street"]),r=H(t,["city","locationCity","primaryCity","region","country"]),i=H(t,["beachDistance","distanceToBeach","beachDistanceLabel","strandEntfernung"]),o=H(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),l=H(t,["rating","reviewRating","stars","hotelStars"]),c=H(t,["reviewCount","reviewsCount","ratingsCount","commentsCount"]),p=Ia(t),f=a?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${a.lat},${a.lng}`)}`:n||r?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${n} ${r}`.trim())}`:"";return`
    <div class="app-content-inline flex flex-col gap-4 app-main-content-safe animate-in fade-in duration-300">
      ...
      <div class="grid grid-cols-1 gap-4">
        ...
        ${we({iconName:"waves",label:"Plazhi",value:i||(t.beachfront||t.onBeach?bt:"Shto detajet")})}
        ${we({iconName:"star",label:"Vlerësime",value:l?`${l}${c?` / ${c} vlerësime`:""}`:"Pa vlerësime",helper:H(t,["reviewSummary","ratingSummary","commentsSummary"])})}
      </div>
  ...
  `}function _a(e={}){const t=Ee(e),a=String(e?.restaurantId||t.restaurantId||t.id||"").trim(),n=t?.name||t?.restaurantName||e?.name||"Hotel",r=$a(a),i=String(r.status||"").trim(),o=r.saving===!0,l=Array.isArray(r.existingImages)?r.existingImages.map(_=>String(_||"").trim()).filter(Boolean):wa(t),c=Array.isArray(r.imagePreviews)?r.imagePreviews.map(_=>String(_||"").trim()).filter(Boolean):[],p=String(r.imageUrlDraft||"").trim(),[f,b,h]=ka(t),v=Ta(t,[f,b,h]),S=H(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),C=H(t,["distanceBeach","distanceToBeach","beachDistance","beachDistanceLabel","strandEntfernung","lakeDistance","distanceToLake"]),k=H(t,["hotelStartingPrice","startingPrice","priceFrom","fromPrice","bestPrice","roomStartingPrice"]),F=t.directCenter===!0||t.inCenter===!0||t.cityCenterDirect===!0,y=t.beachfront===!0||t.onBeach===!0||t.amStrand===!0,I=r.detailsOpen===!0||o,j=c[0]||l[0]||"",P=j?U(j,"thumb"):B,T=[S,C,k?`${k} €`:""].filter(Boolean).join(" · ")||"Plotëso detajet",w=i.includes("fehl")||i.includes("Bitte")||i.includes("Nuk");return`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      ...
      ${a?`
        <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
          ...
          ${i&&!I?`<div class="text-center text-[10px] font-black uppercase tracking-widest mt-4 ${w?"text-rose-500":"text-slate-500"}">${s(i)}</div>`:""}
        </div>
        ...
        <div data-hotel-card-editor="${s(a)}" data-hotel-card-details-panel class="${I?"":"hidden "}bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
            ...
            <div class="grid grid-cols-1 gap-4">
              ${xt({idPrefix:"hotelCardDistanceCenter",iconName:"navigation",label:"Qendra",value:S,directLabel:Ca,direct:F})}
              ${xt({idPrefix:"hotelCardDistanceBeach",iconName:"waves",label:"Plazhi",value:C,directLabel:bt,direct:y})}
              <div>
            ...
            <div class="grid grid-cols-1 gap-4">
              ...
              ${Be({id:"hotelCardFeatureTwoText",iconName:"waves",label:"Shezlongë",value:b,options:Fa})}
...
`))}</textarea>
            ...
            ${i?`<div class="text-center text-[10px] font-black uppercase tracking-widest ${w?"text-rose-500":"text-slate-500"}">${s(i)}</div>`:""}
    ...
    <section data-landing-swipe-root="true" class="relative w-full overflow-hidden font-sans" style="height: calc((var(--viewport-height, 1vh) * 100) - var(--smart-header-total-height, 4.5rem)); min-height: calc((var(--viewport-height, 1vh) * 100) - var(--smart-header-total-height, 4.5rem)); overscroll-behavior: none; -webkit-overflow-scrolling: auto; touch-action: none; user-select: none; background: #F8F9FA; --landing-panel-duration: 460ms; --landing-greeting-duration: 720ms; --landing-top-gap: 14px; --landing-swipe-bottom: 0.45rem;">
      ...
      <div data-landing-panel="0" class="absolute inset-0 z-50 flex flex-col items-start justify-center transition-transform ${a===0?"translate-y-0":"-translate-y-full pointer-events-none"}" style="background: #F8F9FA; color: #111827; padding-top: var(--landing-top-gap); opacity: ${a===0?"1":"0"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        ...
        <div class="flex flex-col items-start relative z-10 w-full" style="padding-left: 2.5rem; padding-right: 2.5rem;">
          <div class="relative w-full flex justify-start items-center mb-5" style="height: 40px;">
            ${t.map((m,$)=>{const L=$===n,A=$===(n-1+t.length)%t.length;return`
                <h1 data-landing-greeting-item="${$}" class="absolute left-0 font-medium text-indigo-600 origin-left" style="font-family: 'Playfair Display', Georgia, 'Times New Roman', serif; font-size: 1.875rem; line-height: 2.25rem; transition: all var(--landing-greeting-duration) cubic-bezier(0.23,1,0.32,1); ${L?"opacity: 1; transform: translateY(0) scale(1);":A?"opacity: 0; transform: translateY(-1.5rem) scale(0.95); pointer-events: none;":!L&&!A?"opacity: 0; transform: translateY(1.5rem) scale(0.95); pointer-events: none;":"opacity: 0;"}">
                  ${s(m)}
                </h1>
              `}).join("")}
          </div>
          <div class="flex items-center gap-3 mb-6">
            <div class="rounded-full shadow-sm border border-slate-200 flex items-center justify-center overflow-hidden shrink-0" style="width:48px;height:48px;min-width:48px;min-height:48px;max-width:48px;max-height:48px;flex:0 0 48px;background:#f8fafc;">
              <img src="${s(y)}" alt="${s(`${i} Logo`)}" class="block rounded-full" style="width:100%;height:100%;min-width:100%;min-height:100%;object-fit:cover;object-position:center;max-width:none;max-height:none;" />
            </div>
            <h2 class="font-black text-left flex flex-wrap items-baseline" style="font-size:56px;line-height:48px;letter-spacing:-0.05em;column-gap:0.16em;row-gap:0;">
              <span style="color:${s(c)};">${s(S)}</span>${C?`<span style="color:${s(p)};">${s(C)}</span>`:""}
            </h2>
          </div>
      ...
      <div data-landing-panel="3" class="absolute inset-0 transition-transform ${a<3?"translate-y-full":"translate-y-0"}" style="background: #F8F9FA; opacity: ${a===3?"1":"0"}; pointer-events: ${a===3?"auto":"none"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        <div data-landing-panel-scroll="3" class="h-full overflow-y-auto overscroll-contain" style="-webkit-overflow-scrolling: touch; touch-action: pan-y; overscroll-behavior-y: none; padding-top: var(--landing-top-gap); padding-bottom: 0;">
          ${T?Ie(e,w,{topTabOverride:"profile",tutorialMode:!0,contentTabOverride:"menu",landingHideContent:!1,collapseIdentity:!0,contentReveal:!0,landingMode:!0}):""}
        </div>
      </div>
    </section>
  ...
  `}function He(e=d.profileView?.profile||d.userProfile,{disabled:t=!1}={}){const a=ye(e);return a==="checkins"||a==="menu"?"":`
  ...
  `}function E(e=""){return String(e||"").trim()}const wt="mnyra_business_title_image_cache_v1",yt=80;function $t(){if(!d)return{};const e=d.businessTitleImageCache&&typeof d.businessTitleImageCache=="object"?d.businessTitleImageCache:null;if(e?.loaded===!0&&e.items&&typeof e.items=="object")return e.items;let t={};try{const n=(typeof window<"u"?window.localStorage:null)?.getItem?.(wt)||"",r=n?JSON.parse(n):{};r&&typeof r=="object"&&Object.entries(r).forEach(([i,o])=>{const l=E(i),c=E(o);l&&c&&!D(c)&&(t[l]=c)})}catch{}return d.businessTitleImageCache={loaded:!0,items:t},t}function Ba(e={}){try{const t=typeof window<"u"?window.localStorage:null;if(!t)return;t.setItem(wt,JSON.stringify(e))}catch{}}function Ra(e={},t="business"){const a=[e?.restaurantId,e?.canonicalRestaurantId,e?.uid,e?.handle,e?.publicSlug,e?.landingSlug,e?.name,t].map(n=>E(n)).filter(Boolean);return[...new Set(a)]}function Na(e=[],t=""){const a=E(t);if(!a||D(a))return;const n=$t();let r=!1;e.forEach(o=>{const l=E(o);!l||n[l]===a||(n[l]=a,r=!0)});const i=Object.entries(n);if(i.length>yt){const o=i.slice(i.length-yt);Object.keys(n).forEach(l=>delete n[l]),o.forEach(([l,c])=>{n[l]=c}),r=!0}r&&Ba(n)}function Ha(e=[]){const t=$t();for(const a of e){const n=E(a),r=n?E(t[n]):"";if(r&&!D(r))return r}return""}function Oa(e={},t="business"){return String(e?.restaurantId||e?.canonicalRestaurantId||e?.uid||e?.handle||e?.name||t).trim()||t}function Da(e={}){return String(e?.canonicalRestaurantId||e?.restaurantId||e?.id||e?.landingRestaurantId||e?.documentId||"").trim()}function Va(e={}){const a=(Array.isArray(e?.coverImages)?e.coverImages:Array.isArray(e?.titleImages)?e.titleImages:[]).map(n=>String(n||"").trim()).find(Boolean)||"";return String(e?.titleImageUrl||e?.coverImageUrl||e?.coverUrl||e?.heroUrl||a||"").trim()}function Ka(e={},t={}){const a=Va(e),n=Array.isArray(t.cacheKeys)?t.cacheKeys:[],r=E(t.stableKey||n[0]||"");if(!a){if(t.allowCacheFallback===!0){const o=Ha(n);if(o)return o;const l=r?U("","medium",{stableKey:r}):"";return l&&!D(l)?l:""}return""}const i=U(a,"medium",r?{stableKey:r}:void 0);return i&&!D(i)?(Na(n,i),i):""}function kt(e="",t=""){const a=E(e);if(!a)return"";if(/^https?:\/\//i.test(a))return a;const n=a.replace(/^@+/,"").replace(/^instagram\.com\//i,"").replace(/^www\.instagram\.com\//i,"").replace(/^tiktok\.com\/@?/i,"").replace(/^www\.tiktok\.com\/@?/i,"").replace(/^\/+/,"").trim();return n?t==="tiktok"?`https://www.tiktok.com/@${encodeURIComponent(n)}`:t==="instagram"?`https://www.instagram.com/${encodeURIComponent(n)}`:"":""}function qa(e=""){const t=E(e);if(!t)return"";const a=t.replace(/[^\d+]/g,"");return a?`tel:${a}`:""}function Ga(e={}){const t=Number(e?.gpsLat??e?.lat),a=Number(e?.gpsLng??e?.lng);if(Number.isFinite(t)&&Number.isFinite(a))return`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${t},${a}`)}`;const n=[e?.address,e?.locationPlace||e?.place,e?.location,e?.city,e?.country].map(r=>E(r)).filter(Boolean).join(", ");return n?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(n)}`:""}function $e({href:e="",label:t="",iconName:a="",body:n="",buttonAttrs:r=""}={}){const i=E(e),o=String(r||"").trim();if(!i&&!o)return"";const l=n||g(a,"w-4 h-4"),c="w-9 h-9 rounded-full bg-white text-slate-900 shadow-lg border border-white/80 flex items-center justify-center active:scale-95 transition-transform";return o?`
  ...
  `}function ke({href:e="",buttonAttrs:t="",iconName:a="",eyebrow:n="",value:r=""}={}){const i=E(r);if(!i)return"";const o=`
  ...
  `}function It(e={},t={}){const a=t.mode==="self"?"self":"public",n=t.disabledBlockClass||"",r=t.avatarUrl||U(e.avatar||"","avatar"),i=t.avatarFit||Te(!!e.restaurantId),o=Oa(e,a),l=String(d?.profileCardInfoOpen||"")===o,c=Number(d?.profileCardInfoHeights?.[o]||0),p=l&&Number.isFinite(c)&&c>0?`height:${Math.ceil(c)}px;`:"",f=t.avatarImgKeyAttr||(a==="self"?'data-img-key="avatar:self"':`data-img-key="avatar:public:${s(o)}"`),b=t.renderAvatarImage!==!1&&!!String(r||"").trim()&&!!String(e?.avatar||"").trim(),h=!!t.identityPending,v=t.followersLabel??M(e.followers),S=E(e?.name)||"User",C=E(t.typeLabel||e?.customerType||e?.type||"Business"),k=E(e?.location||"-"),F=a==="public"?`${k} / ${C}`:k,y=t.bioHtml||s(e?.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),I=`business-cover:${o}`,j=Ra(e,o),P=Ka(e,{cacheKeys:j,stableKey:I,allowCacheFallback:t.allowTitleImageCacheFallback===!0}),T=Ga(e),w=Da(e),_=$e(w?{buttonAttrs:`data-marketplace-open-map="${s(w)}"`,label:u("profile.openMap","Karte oeffnen"),iconName:"map"}:{href:T,label:u("profile.openMap","Karte oeffnen"),iconName:"map"}),R=kt(e?.instagramUrl||e?.instagram||e?.insta||"","instagram"),m=kt(e?.tiktokUrl||e?.tiktok||e?.tikTok||"","tiktok"),$=E(e?.phone||e?.telephone||e?.contactPhone||""),L=qa($),A=E(e?.address||e?.locationLabel||[e?.place||e?.locationPlace,e?.location||e?.city].map(O=>E(O)).filter(Boolean).join(", ")),z=[ke({href:R,iconName:"instagram",eyebrow:"Instagram",value:e?.instagram||e?.instagramUrl||e?.insta||""}),ke({href:m,iconName:"music-2",eyebrow:"TikTok",value:e?.tiktok||e?.tiktokUrl||e?.tikTok||""})].filter(Boolean).join(""),N=a==="self"?`
    ...
    `;if(l){const O=[ke({href:L,iconName:"phone",eyebrow:u("profile.call","Anrufen"),value:$}),ke({href:T,iconName:"map-pin",eyebrow:u("profile.address","Adresse"),value:A||k}),z].filter(Boolean).join("");return`
      <div data-landing-tutorial-target="identity" data-business-profile-card="${s(o)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${n}" style="${p}min-height: var(--business-profile-card-min-height, 440px);display:grid;grid-template-columns:minmax(0,1fr);width:100%;max-width:100%;min-width:0;box-sizing:border-box;">
        ${Qa({profileName:S,safeBio:y,metaLine:F,identityPending:h,followersLabel:v})}
    ...
    <div data-landing-tutorial-target="identity" data-business-profile-card="${s(o)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${n}" style="min-height: var(--business-profile-card-min-height, 440px);">
      <div class="h-40 w-full bg-slate-900 relative overflow-hidden flex items-center justify-center select-none">
        ...
        <div class="absolute top-4 right-4 flex items-center gap-2 z-30">
          ${_}
          ${$e({href:m,label:"TikTok",iconName:"music-2"})}
          ${$e({href:R,label:"Instagram",iconName:"instagram"})}
        </div>
      </div>
      <div class="px-8 pb-8 relative z-20" style="margin-top:-3rem;">
        <div class="flex items-end justify-between w-full">
          <div ${a==="self"?'id="profileAvatarTrigger"':""} class="relative ${a==="self"?"cursor-pointer group":""}">
            <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500 shadow-lg">
              ${b?`<img src="${s(r)}" decoding="async" width="100" height="100" ${f} class="w-full h-full rounded-[1.8rem] ${i} border-2 border-white bg-white" />`:`<div class="w-full h-full rounded-[1.8rem] border-2 border-white bg-slate-100 flex items-center justify-center ${h?"animate-pulse":""}">${g("store","w-8 h-8 text-slate-300")}</div>`}
            </div>
            ${e.isPremium?`
  ...
  `}function Ie(e={},t=[],{topTabOverride:a="",tutorialMode:n=!1,contentTabOverride:r="",landingHideContent:i=!1,collapseIdentity:o=!1,contentReveal:l=!1,landingMode:c=!1}={}){const p=ga(e),f=!!e.privateAccount&&e.uid&&String(e.uid)!==String(d.user?.uid||"")&&!p,b=!!e.pendingFollowRequest&&!p,h=e.restaurantId?"Business":u("nav.user","User"),v=String(e.handle||et(e.name||"user")).replace(/^@/,""),C=s(e.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),k=xe(e),F=String(a||Re(e)).trim().toLowerCase()||"profile",y=String(r||ye(e)).trim().toLowerCase()||"posts",I=y==="menu",j=y==="checkins",P=t,w={...d?.profileView&&typeof d.profileView=="object"?d.profileView:{},profile:e,posts:Array.isArray(P)?P:[]},_=Fs(d,{profileView:w,profileTopTab:F,profileContentTab:y}),R=String(_?.header?.status||"").trim().toLowerCase()||"loading",m=String(_?.posts?.status||"").trim().toLowerCase()||"loading",$=String(e?.avatar||"").trim(),L=$?U($,"avatar"):"",A=Te(!!e.restaurantId),z=e.uid||e.restaurantId||v||"public",N=c?"":`data-img-key="avatar:public:${s(z)}"`,O=!!$,G=Xe=>{if(Xe==null)return!1;const Ot=Number(Xe);return Number.isFinite(Ot)&&Ot>=0},ee=O||G(e?.followers)||G(e?.following),Q=Ae(R)&&!ee,Pe=!!String(L||"").trim()&&O,ie=Q?"...":M(e.followers),Fe=Q?"...":M(e.following),je=k?"pt-2":"pt-10",ue=p?u("profile.following","Following"):b?u("profile.requested","Requested"):f?u("profile.request","Request"):u("profile.follow","Follow"),K=p?"bg-slate-100 text-slate-600 shadow-none border border-slate-200":b?"bg-amber-50 text-amber-700 shadow-none border border-amber-200":"bg-gradient-to-r from-slate-900 to-slate-800 text-white border border-transparent",$s=n?"select-none":"app-main-content-safe",te=n?"pointer-events-none":"",ks=!o,Nt=!i,Le=l?c?"transition-opacity duration-200":"animate-in fade-in duration-300":"",Ht=y==="posts"&&P.length>0,Is=y!=="posts"||Ht||m==="empty"||m==="error",Ss=y==="posts"&&!Ht&&m==="error";return!n&&(y==="posts"||y==="media")&&e?.restaurantId&&Ae(m)&&qt(e),`
    <div class="${$s}" ${n?'data-landing-tutorial-surface="true"':""}>
      ${F==="profile"||F==="menu"?`
      ${ks?`
        <div class="app-content-inline pb-2 ${je}">
          ${k?It(e,{mode:"public",disabledBlockClass:te,avatarUrl:L,avatarFit:A,avatarImgKeyAttr:N,renderAvatarImage:Pe,identityPending:Q,followersLabel:ie,followLabel:ue,followTone:K,isFollowing:p,hasPendingFollowRequest:b,isLocked:f,bioHtml:C,typeLabel:h,allowTitleImageCacheFallback:Ae(R)||Ae(m)}):`
          <div data-landing-tutorial-target="identity" class="bg-white rounded-[2.5rem] p-8 relative overflow-hidden z-10 border border-slate-100 ${te}">
            <div class="relative z-10">
              <div class="flex justify-between items-start mb-8">
                <div class="relative">
                  <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500">
                    ${Pe?`<img src="${s(L)}" decoding="async" width="100" height="100" ${N} class="w-full h-full rounded-[1.8rem] ${A} border-2 border-white" />`:`<div class="w-full h-full rounded-[1.8rem] border-2 border-white bg-slate-100 flex items-center justify-center ${Q?"animate-pulse":""}">${g(e.restaurantId?"store":"user","w-8 h-8 text-slate-300")}</div>`}
                  </div>
                  ${e.isPremium?`
                    <div class="absolute -bottom-1 -right-1 bg-white rounded-full p-1.5 shadow-lg text-blue-500 border-2 border-slate-50">
                      ${g("badge-check","w-4 h-4 fill-blue-500 text-white")}
              ...
              <div class="mb-8">
                ...
                ${k?"":`<p class="text-[11px] font-bold text-slate-400 uppercase tracking-[0.3em] mb-2">@${s(v)}</p>`}
              ...
              <div class="flex gap-4">
                <button data-landing-tutorial-target="follow" data-public-profile-follow="${s(e.handle)}" data-target-type="${s(e.restaurantId?"restaurant":e.uid?"user":"")}" data-target-id="${s(e.restaurantId||e.uid||"")}" data-target-name="${s(e.name||"")}" data-target-avatar="${s(e.avatar||"")}" ${b?"disabled":""} class="flex-1 h-[56px] rounded-[1.2rem] font-bold text-xs uppercase tracking-widest shadow-[0_10px_20px_-5px_rgba(15,23,42,0.25)] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden ${K} ${b?"opacity-90 cursor-default":""}">
                  <span class="relative z-10 flex items-center gap-2">
                    ${p?g("check","w-4 h-4"):""}
                    ${ue}
                  </span>
      ...
      `:`
        ...
        ${Nt?I?`
          <div class="${te} ${Le}">
            ${he(e)?ht(e):Ce(e,{mode:c?"landing":"profile",allowAutoEnsure:!c})}
          </div>
        `:j?`
          <div class="${te} ${Le}">
            ${Me()}
        ...
        `:`
          ${Is?`
            ...
            `:`
              <div class="${d.profileViewMode==="grid"?"grid grid-cols-2 gap-4 app-content-inline grid-flow-dense":"flex flex-col gap-8 app-content-inline"} ${te} ${Le}">
  ...
  `}function Wa(){const e=d.profileView;if(!e||!e.profile)return"";const t=e.profile,a=e.posts||t.posts||[],n=Re(t);return n==="landing"?Ea(t):Ie(t,a,{topTabOverride:n,tutorialMode:!1})}function St(e,{filter:t="all",query:a=""}={}){const n=Array.isArray(e)?e:[],r=oa(a||"");return n.filter(i=>t==="all"||ae(i.type)===t?r?`${i.name||""} ${i.category||""} ${i.description||""}`.toLowerCase().includes(r):!0:!1)}function Ct(e,t=0){const a=Number(e);return Number.isFinite(a)?Math.max(0,Math.floor(a)):Math.max(0,Number(t)||0)}function Se(e=[]){return(Array.isArray(e)?e.slice():[]).map((a,n)=>({item:a,idx:n,order:Ct(a?.orderIndex,n)})).sort((a,n)=>a.order-n.order||a.idx-n.idx).map((a,n)=>({...a.item,orderIndex:Ct(a.item?.orderIndex,n)}))}function Oe(e={}){const t=String(e?.menuVisibility||"").trim().toLowerCase();return e?.menuHidden===!0||t==="hidden"}function de(e={}){const t=String(e?.menuSection||e?.displaySection||e?.menuPlacement||"").trim().toLowerCase();return t==="drink"?"drink":t==="food"?"food":ae(e?.type||"food")==="drink"?"drink":"food"}function Ya(e={}){return String(e?.category||u("menu.other","Sonstiges")).trim()||u("menu.other","Sonstiges")}function Za(e=""){const t=String(e||"").trim().toLowerCase();return t?(typeof t.normalize=="function"?t.normalize("NFD").replace(/[\u0300-\u036f]/g,""):t).replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""):""}const Ja=4,Xa={thumb:160,small:480,medium:768,large:1280};function Pt({mode:e="profile",priorityIndex:t=-1,slideIndex:a=0}={}){return(e==="profile"||e==="landing")&&Number.isFinite(t)&&t>=0&&t<Ja&&a===0}function es({mode:e="profile",priorityIndex:t=-1,slideIndex:a=0}={}){const n=Pt({mode:e,priorityIndex:t,slideIndex:a}),r=e==="profile"?' data-image-reveal="menu"':"";return n?`loading="eager" fetchpriority="high"${r}`:`loading="lazy" fetchpriority="low"${r}`}function ts({variant:e="grid"}={}){return e==="thumb"?"(max-width: 640px) 64px, 64px":e==="hero"?"(max-width: 640px) 94vw, (max-width: 1200px) 74vw, 920px":"(max-width: 640px) 48vw, (max-width: 1200px) 28vw, 360px"}function Z(e,{mode:t="profile",priorityIndex:a=-1,slideIndex:n=0,stableKey:r="",preferredSize:i="small",candidateSizes:o=["small","medium","large"],variant:l="grid"}={}){const c=String(e||"").trim(),p=t==="profile"&&r?{stableKey:r}:null,f=Pt({mode:t,priorityIndex:a,slideIndex:n}),b=t==="profile"&&!f&&l!=="thumb",h=U(c,i,p),v=D(h)?B:h,S=ta(c),C=aa(c)&&c!==v?c:S,k=[],F=new Set;o.forEach($=>{const L=Xa[$]||0;if(!L)return;const A=U(c,$,p);if(!A||D(A))return;const z=`${A}|${L}`;F.has(z)||(F.add(z),k.push(`${A} ${L}w`))});const y=k.length>1?k.join(", "):"",I=y?ts({variant:l}):"",j=b?"":y,P=b?"":I,T=j?` srcset="${s(j)}"`:"",w=P?` sizes="${s(P)}"`:"",_=es({mode:t,priorityIndex:a,slideIndex:n}),R=`${_}${T}${w}`,m=b?[`data-menu-lazy-src="${s(v)}"`,`data-menu-lazy-fallback="${s(C||B)}"`,y?`data-menu-lazy-srcset="${s(y)}"`:"",I?`data-menu-lazy-sizes="${s(I)}"`:""].filter(Boolean).join(" "):"";return{safeImg:b?B:v,fallbackImg:b?B:C,imageAttrs:R,lazyAttrs:m?` ${m}`:"",srcsetValue:y,sizesValue:I,loadingAttrs:_}}function ne(e=[],t,a=null){const n=a instanceof Set?a:new Set;return e.map((r,i)=>{const o=Ya(r),l=Za(o),c=!!l&&!n.has(l);return c&&n.add(l),`<div${c?` data-menu-category-anchor="${s(l)}"`:""} class="h-full">${t(r,i)}</div>`}).join("")}function De(e={}){return String(e?.specialSize||e?.specialCardSize||"").trim().toLowerCase()==="food"?"food":"default"}function as(e=""){const t=String(e||"").trim();return t?/^(https?:\/\/|mailto:|tel:)/i.test(t)?t:`https://${t.replace(/^\/+/,"")}`:""}function Ft(e={}){const t=String(e?.specialActionType||e?.actionType||"").trim().toLowerCase(),a=as(e?.specialActionUrl||e?.linkUrl||e?.actionUrl||""),n=String(e?.specialActionProductId||e?.targetProductId||"").trim();return t==="link"&&a?{type:"link",url:a,productId:""}:t==="product"&&n?{type:"product",url:"",productId:n}:{type:"self",url:"",productId:""}}function jt(){const e=d.menu.filter||"all";return`
  ...
  `}function Ve(e,{mode:t="profile",priorityIndex:a=-1}={}){const n=q(e),r=t==="profile"?re(e,{index:0}):"",{safeImg:i,fallbackImg:o,imageAttrs:l,lazyAttrs:c}=Z(n,{mode:t,priorityIndex:a,stableKey:r,preferredSize:"thumb",candidateSizes:["thumb","small"],variant:"thumb"}),p=ce(e),f=d.activeTab==="menu"?d.userProfile:d.profileView?.profile||d.userProfile,b=X(f),h=pt(e,b),v=e.category||"",S=e.description||"";return t==="admin"?`
  ...
  `}function Ke(e,{mode:t="profile",variant:a="food",priorityIndex:n=-1}={}){const r=q(e),i=t==="profile"?re(e,{index:0}):"",o=a==="drink",{safeImg:l,fallbackImg:c,imageAttrs:p,lazyAttrs:f}=Z(r,{mode:t,priorityIndex:n,stableKey:i,preferredSize:o?"small":"medium",candidateSizes:o?["small","medium"]:["small","medium","large"],variant:o?"grid":"hero"}),b=ce(e),h=d.activeTab==="menu"?d.userProfile:d.profileView?.profile||d.userProfile,v=X(h),S=pt(e,v),C=e.category||"",k=e.description||"",F=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",y=d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"",I=ge(e),j=ot(y,I),P=j?lt(j):{likes:[],comments:[],counts:{likes:0,comments:0}},T=ct(P),w=`
    <div class="mt-2 flex items-center gap-3 text-[10px] font-bold text-slate-400">
      <span class="inline-flex items-center gap-1">
        ${g("heart","w-3 h-3 text-rose-400")} <span data-menu-like-count="${s(I)}">${s(M(T.likes))}</span>
      </span>
      <span class="inline-flex items-center gap-1">
        ${g("message-circle","w-3 h-3 text-indigo-400")} <span data-menu-comment-count="${s(I)}">${s(M(T.comments))}</span>
      </span>
    </div>
  `;return`
    <div ${F} class="w-full ${o?"h-full p-3 rounded-[1.6rem] flex flex-col":"p-4 rounded-[2rem]"} bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all ${t==="profile"?"cursor-pointer":""}">
      <div class="w-full ${o?"h-28 rounded-[1.4rem]":"h-44 rounded-[1.8rem]"} overflow-hidden bg-slate-100">
        <img src="${s(l)}" data-fallback-src="${s(c)}"${f} class="w-full h-full object-cover" style="object-position:${V(e)};" ${p} decoding="async" />
      </div>
      ${o?`
  ...
  `}function qe(e={}){if(!e?.restaurantId||X(e))return!1;const t=String(ze(e)||"").trim().toLowerCase();return t==="restaurant"||t==="cafe"||t==="fastfood"}function Lt(e){const t=e?.restaurantId||d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"",a=ge(e),n=ot(t,a),r=n?lt(n):{likes:[],comments:[],counts:{likes:0,comments:0}},i=String(d.user?.uid||"").trim(),o=String(d.user?.handle||"").trim().toLowerCase(),l=!!r.likes?.some(c=>{const p=String(c?.uid||"").trim();if(i&&p&&p===i)return!0;const f=String(c?.handle||"").trim().toLowerCase();return!!o&&!!f&&f===o});return{itemId:a,meta:r,counts:ct(r),isLiked:l}}function re(e,{index:t=0}={}){const a=String(e?.restaurantId||d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"").trim(),n=String(e?.id||ge(e)||"").trim();if(!a||!n)return"";const r=Number(t),i=Number.isFinite(r)?Math.max(0,Math.floor(r)):0;return`menu-detail:${a}:${n}:${i}`}function ns(e){const t=typeof it=="function"?it(e):[],a=Array.isArray(t)?t.filter(Boolean):[];if(a.length)return a;const n=q(e);return n?[n]:[]}function J(e){return js(e?.cardStyle||"",ae(e?.type||"food"))}function Ge(e,{menuItemId:t=""}={}){if(!e)return null;const a=String(t||e.menuItemId||e.itemId||e.productId||"").trim();return{id:e.id||"",title:e.name||e.title||"Sot ne Fokus",text:e.description||e.text||"",imageUrl:q(e)||e.imageUrl||"",objectPosition:e.objectPosition||V(e),menuItemId:a}}function At(e,t=[],{mode:a="profile"}={}){const n=e?.restaurantId||"";return!n||!qe(e)||!t.length?"":`
    <div class="pt-2 pb-4">
      <div class="flex gap-4 overflow-x-auto hide-scrollbar snap-x horizontal-safe-scroll pb-4">
        ${t.map((r,i)=>{const o=r.imageUrl||"",l=String(r.menuItemId||r.id||"").trim(),{safeImg:c,fallbackImg:p,imageAttrs:f,lazyAttrs:b}=Z(o,{mode:a,priorityIndex:i,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:l?`menu-focus:${n}:${l}`:""}),h=String(r.menuItemId||"").trim(),v=a==="profile"&&h?`data-menu-open="${s(h)}" role="button"`:"";return`
  ...
  `}function Tt(e,{mode:t="profile",priorityIndex:a=-1}={}){const n=q(e),r=t==="profile"?re(e,{index:0}):"",{safeImg:i,fallbackImg:o,imageAttrs:l,lazyAttrs:c}=Z(n,{mode:t,priorityIndex:a,stableKey:r,preferredSize:"small",candidateSizes:["small","medium"],variant:"grid"}),p=ce(e),f=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",{itemId:b,counts:h,isLiked:v}=Lt(e);return`
  ...
  `}function rs(e,t="profile"){if(t!=="profile")return"";const a=Ft(e);return a.type==="link"&&a.url?`data-menu-special-link="${s(a.url)}" role="button" tabindex="0"`:a.type==="product"&&a.productId?`data-menu-open="${s(a.productId)}" role="button"`:`data-menu-open="${s(e.id)}" role="button"`}function Qe(e,{mode:t="profile",size:a="default",priorityIndex:n=-1}={}){const r=q(e),i=t==="profile"?re(e,{index:0}):"",o=a==="food",{safeImg:l,fallbackImg:c,imageAttrs:p,lazyAttrs:f}=Z(r,{mode:t,priorityIndex:n,stableKey:i,preferredSize:o?"medium":"small",candidateSizes:o?["small","medium","large"]:["small","medium"],variant:o?"hero":"grid"}),b=rs(e,t),h=String(e.category||"Special").trim()||"Special",v=s(String(e.name||"Special")).replace(/\n/g,"<br>");return a==="food"?`
      <div ${b} class="rounded-[2.2rem] shadow-[0_8px_30px_rgb(0,0,0,0.06)] relative overflow-hidden mb-5 group aspect-[16/9] ${t==="profile"?"cursor-pointer":""}" style="border-radius:2.2rem;aspect-ratio:16 / 9;margin-bottom:20px;">
        <img src="${s(l)}" data-fallback-src="${s(c)}"${f} class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 select-none pointer-events-none" draggable="false" style="width:100%;height:100%;object-fit:cover;object-position:${V(e)};" ${p} decoding="async" />
  ...
  `}function zt(e,{mode:t="profile",priorityIndex:a=-1}={}){const n=ce(e),r=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",i=ns(e),l=(i.length?i:[q(e)||""]).filter(Boolean),c=l.length?l.slice(0,12):[""],p=c.length>1,{itemId:f,counts:b,isLiked:h}=Lt(e),v=M(Math.max(0,Number(b.likes)||0)),S=M(Math.max(0,Number(b.comments)||0));return`
    <div ${r} class="bg-white p-3.5 rounded-[2.2rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-5 group relative ${t==="profile"?"cursor-pointer":""}" style="padding:14px;border-radius:2.2rem;margin-bottom:20px;box-sizing:border-box;">
      <div class="w-full aspect-[16/9] rounded-[1.8rem] overflow-hidden bg-slate-100 mb-4 relative" style="aspect-ratio:16 / 9;border-radius:1.8rem;margin-bottom:16px;">
        ${p?`
          ...
          >
            ${c.map((C,k)=>{const F=t==="profile"?re(e,{index:k}):"",y=Z(C||"",{mode:t,priorityIndex:a,slideIndex:k,stableKey:F,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"}),I=k>0,j=I?B:y.safeImg,P=I?B:y.fallbackImg,T=I?y.loadingAttrs:y.imageAttrs,w=I?"":y.lazyAttrs||"",_=I?` data-menu-card-deferred-src="${s(y.safeImg)}"
                ...
                <div class="min-w-full h-full snap-center relative" data-menu-card-gallery-slide="${k}" style="min-width:100%;width:100%;height:100%;scroll-snap-align:center;">
                  <img src="${s(j)}" data-fallback-src="${s(P)}"${w}${_} class="w-full h-full object-cover select-none pointer-events-none" draggable="false" style="object-position:${V(e)};" ${T} decoding="async" />
                </div>
              `}).join("")}
          </div>
        `:`
          ${c.map((C,k)=>{const F=t==="profile"?re(e,{index:k}):"",{safeImg:y,fallbackImg:I,imageAttrs:j,lazyAttrs:P}=Z(C||"",{mode:t,priorityIndex:a,slideIndex:k,stableKey:F,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"});return`
              <div class="w-full h-full">
                <img src="${s(y)}" data-fallback-src="${s(I)}"${P} class="w-full h-full object-cover select-none pointer-events-none" draggable="false" style="object-position:${V(e)};" ${j} decoding="async" />
              </div>
            `}).join("")}
        `}
        <button
        ...
        <div class="flex items-center justify-between border-t border-slate-50 pt-4 pb-1" style="padding-top:16px;padding-bottom:4px;">
          <div class="flex items-center gap-2">
            <div class="hidden">
              ...
              <span data-menu-comment-count="${s(f)}">${s(S)}</span>
            </div>
          </div>
  ...
  `}function is(e,t,{mode:a="profile",publicMenuSurfaceState:n=null}={}){const r=Se(Array.isArray(t)?t:[]),i=String(e?.restaurantId||"").trim(),o=a==="admin"||ua(i),l=n?.focus?.canRenderFocus?{items:Array.isArray(n.focus.items)?n.focus.items:[],enabled:!0}:i&&o?me(i):{items:[],enabled:!1},c=l.enabled?(Array.isArray(l.items)?l.items:[]).map(m=>Ge({...m,objectPosition:oe(m)})):[],p=r.filter(m=>J(m)==="testfirst_focus"&&!Oe(m)).map(m=>Ge(m,{menuItemId:m.id||""})).filter(Boolean),f=new Set,b=[...c,...p].filter(m=>{const $=String(m.menuItemId||m.id||`${m.title}|${m.text}|${m.imageUrl}`);return!$||f.has($)?!1:(f.add($),!0)}),h=r.filter(m=>!Oe(m)),v=h.filter(m=>J(m)!=="testfirst_focus"),S=v.length?v:h,C=v.length?b:[],k=S.filter(m=>de(m)==="drink"),F=S.filter(m=>de(m)!=="drink"),y=(m=[])=>{const $=[],L=[];return m.forEach(A=>{const z=J(A);z==="testfirst_food"||z==="testfirst_special"&&De(A)==="food"?L.push(A):$.push(A)}),{gridItems:$,foodItems:L}},I=(m,$=-1)=>J(m)==="testfirst_special"?Qe(m,{mode:a,priorityIndex:$}):Tt(m,{mode:a,priorityIndex:$});let j=0;const P=()=>{const m=j;return j+=1,m},T=new Set,w=(m,$)=>!$.gridItems.length&&!$.foodItems.length?"":`
        ...
        ${$.foodItems.length?`
          <div class="menu-category-section pb-6 pt-4" data-menu-type="${s(m)}">
            <div class="app-content-inline">
              ${ne($.foodItems,L=>{const A=J(L),z=P();return A==="testfirst_special"?Qe(L,{mode:a,size:"food",priorityIndex:z}):zt(L,{mode:a,priorityIndex:z})},T)}
            </div>
          </div>
        `:""}
      </section>
  ...
  `}function _t(e,{mode:t="profile",useTestfirstCardUi:a=!1,seenCategories:n=null,priorityOffset:r=0}={}){return e.length?a?`
      <div class="grid grid-cols-2 auto-rows-fr gap-3">
        ${ne(e,(i,o)=>Tt(i,{mode:t,priorityIndex:r+o}),n)}
      </div>
    `:`
    <div class="grid grid-cols-2 auto-rows-fr gap-4">
      ${ne(e,(i,o)=>Ke(i,{mode:t,variant:"drink",priorityIndex:r+o}),n)}
    </div>
  `:""}function Ut(e,{mode:t="profile",useTestfirstCardUi:a=!1,seenCategories:n=null,priorityOffset:r=0}={}){return e.length?a?`
      <div>
        ${ne(e,(i,o)=>J(i)==="testfirst_special"&&De(i)==="food"?Qe(i,{mode:t,size:"food",priorityIndex:r+o}):zt(i,{mode:t,priorityIndex:r+o}),n)}
      </div>
    `:`
    <div class="space-y-4">
      ${ne(e,(i,o)=>Ke(i,{mode:t,variant:"food",priorityIndex:r+o}),n)}
    </div>
  `:""}function Mt(e,{mode:t="profile"}={}){if(t==="admin"){const a=String(d?.menu?.filter||"all").trim().toLowerCase(),n=e.filter(c=>ae(c?.type)==="drink"),r=e.filter(c=>ae(c?.type)!=="drink"),i=(c,p,{addType:f=""}={})=>`
      <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
        <div class="flex items-center justify-between mb-4">
          <div>
  ...
  `:`
    ...
    `}function We(e,{variant:t="focus",suppressLoading:a=!1}={}){if(!e)return"";const{items:n,enabled:r,loading:i}=me(e,{includeInactive:!0}),o=M(n.length),l=String(t||"").trim().toLowerCase()==="travel-offers",c=l?"Ofertat":"Sot ne Fokus",p=l?"Oferta":"Highlights",f=l?"Im Travel und Profil sichtbar":"Im Profil sichtbar",b=l?"Ofertat werden geladen...":u("focus.loading","Fokus wird geladen..."),h=l?"Noch keine Oferta-Eintraege":"Noch keine Fokus-Eintraege";return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(v=>{const S=U(v.imageUrl||"","thumb"),C=D(S)?B:S,k=v.active!==!1?"Aktiv":"Inaktiv",F=v.active!==!1?"text-emerald-600":"text-slate-400";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
                  <img src="${s(C)}" class="w-full h-full object-cover" style="object-position:${oe(v)};" loading="lazy" decoding="async" />
                </div>
                <div class="flex-1 min-w-0">
  ...
  `}function Et(e={}){if(!e?.restaurantId)return!1;const t=String(ze(e)||"").trim().toLowerCase();return["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"].includes(t)?!1:X(e)||se(e)||["restaurant","cafe","coffee","fastfood","food","ecommerce"].includes(t)||!t}function os(e={}){if(e.active===!1)return{label:"Inaktiv",className:"text-slate-400"};const t=String(e.status||e.approvalStatus||"pending").trim().toLowerCase();return t==="approved"?{label:"Freigegeben",className:"text-emerald-600"}:t==="rejected"?{label:"Abgelehnt",className:"text-rose-600"}:{label:"Wartet auf Heart",className:"text-amber-600"}}function ls(e,t){if(!t||!Et(e))return"";const{items:a,loading:n}=na(t,{includeInactive:!0}),r=M(a.length);return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(i=>{const o=U(i.imageUrl||"","thumb"),l=D(o)?B:o,c=os(i),p=i.category||"RESTAURANT",f=i.priceSegment||"€€ - €€€";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function Ye(e){if(Array.isArray(e))return e.map(a=>String(a||"").trim()).filter(Boolean);const t=String(e||"").trim();return t?t.split(/[\n,;|]/).map(a=>a.trim()).filter(Boolean):[]}function cs(e={}){const t=String(e?.restaurantId||"").trim(),a=t?le(t):null;return{...a&&typeof a=="object"?a:{},...e&&typeof e=="object"?e:{},...t?{restaurantId:t}:{}}}function Ze(e={}){return e.shoppingLandingCard&&typeof e.shoppingLandingCard=="object"?e.shoppingLandingCard:{}}function ds(e={}){const t=Ze(e);return[...Ye(t.productIds),...Ye(e.shoppingLandingCardProductIds),...Ye(e.shoppingLandingProductIds)].filter(Boolean)}function Je(e={}){return!e||typeof e!="object"?{}:Object.entries(e).reduce((t,[a,n])=>{const r=String(a||"").trim(),i=String(n||"").trim();return r&&i&&(t[r]=i),t},{})}function us(e={}){const t=Ze(e);return{...Je(e.shoppingLandingProductImageOverrides),...Je(t.productImageOverrides)}}function ps(e=""){const t=String(e||"").trim(),a=d.shoppingLandingCardEditor&&typeof d.shoppingLandingCardEditor=="object"?d.shoppingLandingCardEditor:{},n=String(a.restaurantId||"").trim();return n&&n!==t?{}:a}function fs(e){return e?typeof e=="string"?e.trim():typeof e!="object"?String(e||"").trim():String(e.url||e.src||e.cdnUrl||e.imageUrl||e.image||e.photoUrl||e.thumbnail||"").trim():""}function gs(e={}){const a=[q(e),...Array.isArray(e.imageUrls)?e.imageUrls:[],...Array.isArray(e.images)?e.images:[],e.imageUrl,e.image,e.photoUrl,e.coverUrl,e.img,e.thumbnail].map(fs).filter(Boolean);return a.filter((n,r)=>a.indexOf(n)===r)}function ms(e={},t={},a={}){const n=String(e?.id||e?.productId||e?.menuItemId||"").trim();if(!n)return null;const r=gs(e).map(f=>({rawUrl:f,imageUrl:U(f,"thumb")})).filter(f=>f.rawUrl&&!D(f.imageUrl)),i=r[0]?.rawUrl||"",o=String(t?.[n]||"").trim(),l=String(a?.[n]||"").trim(),c=l||o||i,p=c?U(c,"thumb"):"";return{id:n,name:String(e.name||e.title||"Produkt").trim(),price:ce(e),imageUrl:p&&!D(p)?p:"",defaultImageRaw:i,cardImageUrl:o,previewImageUrl:l,imageCandidates:r,objectPosition:V(e)}}function bs(e={},t="",a=[]){if(!t||!X(e))return"";const n=cs(e),r=Ze(n),i=ps(t),o=i.saving===!0,l=String(i.status||"").trim(),c=/fehl|error|nicht|nuk|kein/i.test(l),p=String(r.imageUrl||n.shoppingLandingCardImageUrl||n.shoppingLandingImageUrl||"").trim(),f=String(n.logoUrl||n.logo||n.logoURL||n.avatar||e.avatar||"").trim(),b=String(i.imageUrlDraft??p).trim(),h=String(i.imagePreview||b||f||"").trim(),v=h?U(h,"large"):B,S=String(i.titleDraft??(r.title||n.shoppingLandingCardTitle||e.name||"")).trim(),C=i.active!==void 0?i.active!==!1:r.active!==!1&&n.shoppingLandingCardEnabled!==!1,k=ds(n),F=Array.isArray(i.productIds)?i.productIds.map(w=>String(w||"").trim()).filter(Boolean):null,y=new Set(F||k),I={...us(n),...Je(i.productImageOverrides)},j=i.productImagePreviews&&typeof i.productImagePreviews=="object"?i.productImagePreviews:{},P=(Array.isArray(a)?a:[]).filter(w=>w&&String(w.id||"").trim()&&w.hidden!==!0&&w.available!==!1).map(w=>ms(w,I,j)).filter(Boolean),T=y.size?`${M(y.size)} ausgewaehlt`:"Keine Auswahl = alle Produkte";return`
    <div data-shopping-landing-card-editor="${s(t)}" class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
          ...
          <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">${s(T)}</p>
        </div>
      ...
      <div class="relative h-44 rounded-2xl overflow-hidden bg-slate-100 border border-slate-100 mb-4">
        <img src="${s(v||B)}" class="w-full h-full object-cover" loading="lazy" decoding="async" />
        ...
        <div class="rounded-[1.8rem] border border-slate-100 bg-slate-50 p-4">
          ...
          ${P.length?`
            <div class="grid grid-cols-1 gap-2">
              ${P.map(w=>{const _=y.has(w.id),R=w.imageUrl||B,m=String(w.defaultImageRaw||w.imageCandidates[0]?.rawUrl||"").trim(),$=String(w.cardImageUrl||"").trim(),L=String(w.previewImageUrl||"").trim(),A=!!(L||$&&$!==m),z=L||($&&!w.imageCandidates.some(N=>N.rawUrl===$)?$:"");return`
                    ...
                    ${_?`
                      <div class="mt-3 pt-3 border-t border-slate-100">
                        ...
                        <div class="flex gap-2 overflow-x-auto hide-scrollbar pb-1">
                          ${w.imageCandidates.map((N,O)=>{const G=O===0,ee=L?!1:G?!A:$===N.rawUrl;return`
                              <label class="shrink-0 w-16">
                                <input type="radio" name="shoppingLandingProductImage_${s(w.id)}" data-shopping-landing-product-image-choice="${s(w.id)}" value="${G?"":s(N.rawUrl)}" class="hidden" ${ee?"checked":""} />
                          ...
                          ${z?`
                            <label class="shrink-0 w-16">
                              <input type="radio" name="shoppingLandingProductImage_${s(w.id)}" data-shopping-landing-product-image-choice="${s(w.id)}" value="${s(z)}" class="hidden" checked />
                              <span class="block h-16 rounded-2xl overflow-hidden border border-slate-900 bg-slate-100">
                                <img src="${s(U(z,"thumb"))}" class="w-full h-full object-cover" loading="lazy" decoding="async" />
                              </span>
  ...
  `}function xs(e){if(!qe(e)||!gt(e))return"";const a=Se((d.menu.items||[]).filter(n=>J(n)==="testfirst_special"));return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(n=>{const r=U(q(n),"thumb"),i=D(r)?B:r,o=Ft(n),l=o.type==="link"?"Link":o.type==="product"?"Produkt-Modal":"Diese Karte",c=De(n)==="food"?"Food-Size":"Normal",p=ca(de(n));return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function Bt(e,{restaurantId:t="",suppressLoading:a=!1,allowAutoEnsure:n=!0,requirePublicMenuTruth:r=!0}={}){const i=String(t||e?.canonicalRestaurantId||e?.restaurantId||"").trim();if(!i||!se(e))return"";const o=pe(d,{profile:e,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:i});if(r&&o.menu.status!=="ready")return"";const l=!r||o.focus.canRenderFocus;if(n&&!d.focus.loading&&!l&&fe(ft(e,i)),r&&!l)return"";const{items:c,loading:p}=l?{items:Array.isArray(o.focus.items)?o.focus.items:[],loading:o.focus.loading}:me(i);if(!(l?!0:me(i).enabled)||!c.length&&!p||a&&p&&!c.length)return"";if(p&&!c.length)return`
    ...
    `;const b=ra(c),h=c[b]||c[0],{safeImg:v,fallbackImg:S,imageAttrs:C,lazyAttrs:k}=Z(h.imageUrl||"",{mode:"profile",priorityIndex:0,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:h?.id?`focus-carousel:${i}:${String(h.id)}`:""}),F=h.text||"";return`
    <div id="focusCarousel" class="${dt()} rounded-[2.5rem] p-6 border shadow-sm">
      ...
      <div class="relative rounded-[2rem] overflow-hidden border border-slate-100 bg-slate-50">
        <img data-focus-image src="${s(v)}" data-fallback-src="${s(S)}"${k} class="w-full h-56 object-cover" style="object-position:${oe(h)};" ${C} decoding="async" />
      </div>
      <div class="mt-4">
  ...
  `}function vs({profile:e,restaurantId:t,catalogLabel:a}){if(!t||!se(e))return"";if(typeof st=="function"){const i=be?be(t):null;(!i||i.sameRestaurant!==!0||!i.loading&&!i.loaded&&!i.error)&&st(e)}const n=typeof be=="function"?be(t):{enabled:!0,count:0,tables:[],loading:!1,saving:!1,error:""},r=(n.tables||[]).map(i=>{const o=ia("apps/menyra-social/index.html",{r:t,tab:"menu",source:"qr",table:i});return Rt({label:`Tisch ${i}`,url:o,caption:`${a} fuer Tisch ${i}`})}).join("");return`
  ...
  `}function ws(){const e=d.userProfile,t=e.restaurantId||"",a=String(d.user?.uid||"").trim(),n=String(d.__authBootstrapInFlightUid||"").trim(),r=!t&&!!a&&(!!d.__authProfileLoadPromise||n===a),i=he(e),o=se(e),l=d.profileView?.profile?.restaurantId?d.profileView.profile:null,c=Kt()&&!!l?.restaurantId&&se(l),p=ut(nt(e)),f=t?le(t):null,b=f?.name||f?.restaurantName||e.name||"Business",h=t&&d.menu.restaurantId===t,v=String(d.menu.source||"").trim().toLowerCase(),S=!!h&&v==="collection",C=!!h&&v==="collection"&&d.menu.loading,k=!!t&&(C||!S),F=S?St(d.menu.items,{filter:d.menu.filter,query:d.menu.query}):[],I=gt(e)?F:F.filter(T=>!ma(T)),j=Se(I),P=M(j.length);if(t&&i){ha(e);const T=String(d.focus?.truthSource||"").trim().toLowerCase();return!d.focus.loading&&(d.focus.restaurantId!==t||T!=="public-menu")&&fe(e),_a(e)}return t&&o&&!S&&!C&&Qt(e),t&&o&&!d.focus.loading&&d.focus.restaurantId!==t&&fe(e),t&&Et(e)&&Wt(e),o?`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      <div class="flex items-end justify-between mb-6">
        <div>
      ...
      ${t?`
        ...
        ${k?`<div class="text-center py-12 text-[10px] font-bold uppercase tracking-widest text-slate-400">${s(u("menu.loading",`${p} wird geladen...`,{label:p}))}</div>`:Mt(j,{mode:"admin"})}
  ...
  `:c?Ce(l):`
    ...
    `;const l=ft(e,o),c=se(l);c&&(i=pe(d,{profile:l,routePayload:n,webDirectEntry:r,restaurantId:o,coordinateFocusWithMenu:!0}));const p=String(r?.canonicalRestaurantId||r?.restaurantId||"").trim(),f=new Set(i.targetIds),b=Cs(i.focus.truthState||""),h=i.menu.status==="ready",v=i.focus.canRenderFocus,S=h&&c,C=i.focus.matches===!0&&i.focus.loading===!0,k=t==="landing",y=String(d?.profileView?.menuAccessSource||r?.menuAccessSource||n?.menuAccessSource||"").trim().toLowerCase()==="qr",I=r?.active===!0&&r?.webPriority===!0&&r?.menuFirst===!0&&String(d?.activeTab||"").trim().toLowerCase()==="profile"&&String(d?.profileTopTab||"").trim().toLowerCase()==="menu"&&(p===o||f.has(o)),j=I&&!y,P=["ready","empty","error"].includes(i.menu.status),T=I&&P,w=I&&(!S||i.menu.status!=="ready"),_=!S||i.focus.settled===!0||b==="knownEmpty"||i.menu.status!=="ready";a&&!T&&!P&&Gt(l),a&&!w&&!_&&!C&&h&&(!j||P)&&fe(l);const m=i.menu.canRenderItems?Se(St(i.menu.items,{filter:"all",query:""})).filter(K=>!Oe(K)):[],$=m.length>0,L=X(e),A=ut(nt(e)),z=i.menu.error||"",N=!!String(z||"").trim(),O=i.menu.status==="loading"||i.menu.waitingForFocus===!0,G=m.filter(K=>de(K)==="drink"),ee=m.filter(K=>de(K)!=="drink"),Q=0,Pe=G.length,ie=qe(e),Fe=new Set;$&&o&&(Yt(m,o),fa(m,o));const je=o&&v?(Array.isArray(i.focus.items)?i.focus.items:[]).map(K=>Ge({...K,objectPosition:oe(K)})).filter(Boolean):[],ue=je.length?At(l,je,{mode:t}):"";return k&&O?'<div class="app-content-inline app-main-content-safe" style="min-height: 34vh;"></div>':ie?`
      <div class="app-main-content-safe">
        ...
        `:`
          ${$?is(l,m,{mode:t,publicMenuSurfaceState:i}):N?`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${s(u("menu.loadError","Menu konnte nicht geladen werden"))}</div>`:ue||`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300">${s(u("menu.noProducts","Keine Produkte"))}</div>`}
            ...
            ${G.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="drink">
                ...
                <div data-menu-type="drink">
                  ${_t(G,{mode:t,useTestfirstCardUi:ie,seenCategories:Fe,priorityOffset:Q})}
                </div>
              </section>
            `:""}
            ${ee.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="food">
                ...
                <div data-menu-type="food">
                  ${Ut(ee,{mode:t,useTestfirstCardUi:ie,seenCategories:Fe,priorityOffset:Pe})}
                </div>
              </section>
            `:""}
          `}
          ...
          <div class="relative z-10">
            <div class="flex justify-between items-start mb-8">
              <div id="profileAvatarTrigger" class="relative cursor-pointer group">
                <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500">
                  <img src="${s(I)}" decoding="async" width="100" height="100" data-img-key="avatar:self" class="w-full h-full rounded-[1.8rem] ${j} border-2 border-white" />
                </div>
                ${e.isPremium?`
                  <div class="absolute -bottom-1 -right-1 bg-white rounded-full p-1.5 shadow-lg text-blue-500 border-2 border-slate-50">
                    ${g("badge-check","w-4 h-4 fill-blue-500 text-white")}
  ...
  `}return{renderProfilePostCardFancy:mt,renderProfilePostsFancy:Ue,renderProfileCheckins:Me,renderProfileTabs:Ne,renderProfileViewControls:He,renderPublicProfileView:Wa,renderMenuFilterRow:jt,renderMenuLayoutSection:ss,renderMenuItemCard:Ve,renderMenuItemCardStacked:Ke,renderMenuDrinkGrid:_t,renderMenuFoodList:Ut,renderMenuList:Mt,renderFocusAdminSection:We,renderFocusCarousel:Bt,renderMenuQrCard:Rt,renderMenuAdminView:ws,renderProfileMenuView:Ce,renderProfileView:ys}}export{zs as createProfileMenuFocusRenderController};
