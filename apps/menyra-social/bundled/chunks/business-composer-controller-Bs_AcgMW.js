      ...
      <div class="mnyra-bc__sheet">
        ...
        <div class="mnyra-bc__body" data-bc-body>
          <div class="mnyra-bc__compose" data-bc-compose>
            <textarea class="mnyra-bc__text" data-bc-text maxlength="${F}" rows="5" enterkeyhint="done"></textarea>
            <div class="mnyra-bc__compose-bar">
              ...
              <span class="mnyra-bc__count" data-bc-count>0/${F}</span>
            </div>
          </div>
