const T=Object.freeze({restaurants:Object.freeze({key:"restaurants",title:"Restaurants",emptyTitle:"Noch keine Restaurants",emptyBody:"Keine passenden Profile gefunden.",icon:"utensils",typeKeys:Object.freeze(["restaurant","cafe","coffee","fastfood","food"])}),travel:Object.freeze({key:"travel",title:"Travel",emptyTitle:"Noch keine Travel-Profile",emptyBody:"Keine passenden Profile gefunden.",icon:"plane",typeKeys:Object.freeze(["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"])}),shopping:Object.freeze({key:"shopping",title:"Shopping",emptyTitle:"Noch keine Shopping-Profile",emptyBody:"Keine passenden Profile gefunden.",icon:"shopping-bag",typeKeys:Object.freeze(["ecommerce"])})}),F=new Map;Object.values(T).forEach(e=>{e.typeKeys.forEach(t=>{F.set(t,e.key)})});const K=8,O=24,X="#ff4f3f",Q="mnyra_social_feed_viewer_location_v1",x="#00cce5",W=35,Z=Object.freeze([Object.freeze({label:"Prishtina",lat:42.6629,lng:21.1655}),Object.freeze({label:"Prizren",lat:42.2139,lng:20.7397}),Object.freeze({label:"Peja",lat:42.6591,lng:20.2883}),Object.freeze({label:"Gjakova",lat:42.3803,lng:20.4308}),Object.freeze({label:"Ferizaj",lat:42.3706,lng:21.1553}),Object.freeze({label:"Gjilan",lat:42.4635,lng:21.4699}),Object.freeze({label:"Mitrovica",lat:42.8914,lng:20.866}),Object.freeze({label:"Vushtrria",lat:42.8231,lng:20.9675}),Object.freeze({label:"Podujeva",lat:42.9106,lng:21.193}),Object.freeze({label:"Tirana",lat:41.3275,lng:19.8187}),Object.freeze({label:"Kukes",lat:42.0769,lng:20.4219}),Object.freeze({label:"Smederevo",lat:44.6644,lng:20.9276})]),ee=Object.freeze([Object.freeze(["tirana","tirane"]),Object.freeze(["durres","durresi"]),Object.freeze(["vlora","vlore"]),Object.freeze(["shkoder","shkodra"]),Object.freeze(["shengjin","shëngjin","shen gjin","shengjini"]),Object.freeze(["ksamil","ksamili"]),Object.freeze(["dhermi","dhërmi","dhermiu"]),Object.freeze(["velipoje","velipojë","velipoja"]),Object.freeze(["theth","thethi"]),Object.freeze(["valbone","valbonë","valbona"]),Object.freeze(["elbasan","elbasani"]),Object.freeze(["fier","fieri"]),Object.freeze(["korce","korca"]),Object.freeze(["sarande","saranda"]),Object.freeze(["berat","berati"]),Object.freeze(["gjirokaster","gjirokastra"]),Object.freeze(["kukes","kukesi"]),Object.freeze(["lezhe","lezha"]),Object.freeze(["pogradec","pogradeci"]),Object.freeze(["kruje","kruja"]),Object.freeze(["fushe kruje","fushë krujë","fushe-kruje","fush kruje"]),Object.freeze(["lushnje","lushnja"]),Object.freeze(["himare","himarë","himara"]),Object.freeze(["kavaje","kavajë","kavaja"]),Object.freeze(["kamze","kamëz","kamza"]),Object.freeze(["vore","vorë","vora"]),Object.freeze(["divjake","divjakë","divjaka"]),Object.freeze(["permet","përmet","permeti"]),Object.freeze(["tepelene","tepelenë","tepelena"]),Object.freeze(["delvine","delvinë","delvina"]),Object.freeze(["peshkopi","peshkopia","diber","dibër"]),Object.freeze(["burrel","burreli","mat"]),Object.freeze(["puke","pukë","puka"]),Object.freeze(["bajram curri","bajramcurri","tropoje","tropojë"]),Object.freeze(["krume","krumë","has"]),Object.freeze(["lac","laç","kurbin"]),Object.freeze(["orikum","orikumi"]),Object.freeze(["golem","golemi"]),Object.freeze(["jale","jalë","jali"]),Object.freeze(["qepare","qeparo","qeparoi"]),Object.freeze(["borsh","borshi"]),Object.freeze(["lukove","lukovë","lukova"]),Object.freeze(["palase","palasë","palasa"]),Object.freeze(["drimadhe","drymades","drimadhes"]),Object.freeze(["spille","spilleja"]),Object.freeze(["gjiri i lalzit","lalzi","lalez","lalëz"])]);function E(e,t=()=>""){return typeof e=="function"?e:t}function o(e=""){return String(e||"").trim()}function w(e=""){const t=o(e).toLowerCase();return t?t.replace(/[ëèéê]/g,"e").replace(/[çćč]/g,"c").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/&/g,"and").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,""):""}function te(e=""){const t=w(e);if(!t)return[];const a=new Set([t]);return ee.forEach(n=>{const s=n.map(w).filter(Boolean);s.includes(t)&&s.forEach(i=>a.add(i))}),Array.from(a)}function P(e=""){const t=w(e);return t==="restaurant"?"restaurants":["hotel","hotels","motel","motels"].includes(t)?"travel":["shop","ecommerce","e_commerce","shopping"].includes(t)?"shopping":T[t]?t:"restaurants"}function U(e=""){const t=w(e);return t?t==="e_commerce"||t==="online_shop"||t==="onlineshop"||t==="shop"||t==="store"?"ecommerce":t==="coffee"||t==="coffe"||t==="kaffee"?"cafe":t==="fast_food"||t==="snack"||t==="imbiss"?"fastfood":t==="hotels"?"hotel":t==="motels"?"motel":t:""}function ae(e={}){return[e.type,e.customerType,e.restaurantType,e.businessProfileType,e.profileType,e.catalogMode,e.category,e.kind,e.vertical,e.leadType]}function _(e={},{normalizeRestaurantType:t,normalizeLeadTypeKey:a}={}){const n=typeof t=="function"?t:(l=>l),s=typeof a=="function"?a:(l=>l),i=ae(e);for(const l of i){const c=U(n(l)||s(l)||l);if(c)return c}const r=[e.name,e.restaurantName,e.businessName,e.description,e.bio].map(l=>o(l).toLowerCase()).join(" ");return/\bhotel(s)?\b/.test(r)?"hotel":/\bmotel(s)?\b/.test(r)?"motel":/\bcoffee\b|\bcoffe\b|\bcafe\b|\bcaffe\b/.test(r)?"cafe":/\bfast\s*food\b|\bfastfood\b/.test(r)?"fastfood":/\be-?commerce\b|\bonline\s*shop\b/.test(r)?"ecommerce":/\brestaurant\b|\brestoran\b|\bpizza\b|\bpizzeria\b/.test(r)?"restaurant":""}function ne(e={},t={}){const a=_(e,t);return F.get(a)||""}function h(e={}){return o(e.canonicalRestaurantId||e.restaurantId||e.id||e.landingRestaurantId||"")}function g(e={}){return o(e.name||e.restaurantName||e.businessName||e.displayName||"Business")}function j(e={}){const t=o(e.city||e.locationCity||e.primaryCity),a=o(e.address||e.location||e.primaryAddress);return t&&a&&t!==a?`${t} - ${a}`:t||a||V(e)||o(e.country||e.region||"")||"Standort folgt"}function se(e={},t={}){const a=Number(e.lat),n=Number(e.lng),s=Number(t.lat),i=Number(t.lng);if(![a,n,s,i].every(Number.isFinite))return Number.POSITIVE_INFINITY;const r=v=>v*Math.PI/180,l=6371,c=r(s-a),p=r(i-n),f=Math.sin(c/2),b=Math.sin(p/2),u=f*f+Math.cos(r(a))*Math.cos(r(s))*b*b;return 2*l*Math.atan2(Math.sqrt(u),Math.sqrt(Math.max(0,1-u)))}function V(e={}){const t=S(e);if(!t)return"";const a=Z.map(n=>({label:n.label,distanceKm:se(t,n)})).filter(n=>Number.isFinite(n.distanceKm)).sort((n,s)=>n.distanceKm-s.distanceKm)[0];return a&&a.distanceKm<=W?a.label:"Auf Karte markiert"}function ie(e={}){const t=[e.id,e.restaurantId,e.canonicalRestaurantId,e.publicSlug,e.landingSlug,e.handle,e.type,e.customerType,e.restaurantType,e.businessProfileType,e.profileType,e.catalogMode,e.category,e.kind,e.vertical,e.leadType,e.city,e.locationCity,e.primaryCity,e.address,e.location,e.primaryAddress,V(e),e.country,e.region,e.district,e.name,e.restaurantName,e.businessName,e.displayName,e.description,e.bio,e.about];return Array.isArray(e.locations)&&e.locations.forEach(a=>{!a||typeof a!="object"||t.push(a.city,a.address,a.country,a.region,a.name)}),t}function re(e={},t=""){const a=te(t);if(!a.length)return!0;const n=ie(e).map(w).filter(Boolean).join("_");return a.some(s=>{const i=s.split("_").filter(Boolean);return n.includes(s)?!0:i.length>0&&i.every(r=>n.includes(r))})}function S(e={}){const t=[[e.lat,e.lng],[e.latitude,e.longitude],[e.gpsLat,e.gpsLng],[e.geo?.lat,e.geo?.lng],[e.geo?.latitude,e.geo?.longitude],[e.coords?.lat,e.coords?.lng],[e.coords?.latitude,e.coords?.longitude],[e.location?.lat,e.location?.lng]];for(const[a,n]of t){const s=Number(String(a??"").replace(",",".")),i=Number(String(n??"").replace(",","."));if(Number.isFinite(s)&&Number.isFinite(i)&&Math.abs(s)<=90&&Math.abs(i)<=180){if(Math.abs(s)<1e-6&&Math.abs(i)<1e-6)continue;return{lat:s,lng:i}}}if(Array.isArray(e.locations))for(const a of e.locations){const n=S(a||{});if(n)return n}return null}function q(e={}){const t=e.openingHours||e.openHours||e.hours||e.businessHours||e.workingHours||"";if(typeof t=="string"&&o(t))return o(t);if(t&&typeof t=="object"){const a=Object.values(t).map(o).filter(Boolean);if(a.length)return a[0]}return"Oeffnungszeiten folgen"}function le(e={}){return o(e.phone||e.telephone||e.contactPhone||e.ownerPhone||"")}function oe(e={}){return o(e.description||e.bio||e.about||e.shortDescription||"")}function L(e={}){const t=Number(e.rating??e.avgRating??e.score??e.publicRating??0);return!Number.isFinite(t)||t<=0?"":Math.min(5,Math.max(1,t)).toFixed(1)}function N(e={},{getOptimizedImageUrl:t,resolveRestaurantLogo:a,placeholderImage:n=""}={}){const s=h(e),i=o(e.logoUrl||e.logo||e.logoURL||e.heroUrl||e.coverUrl||e.imageUrl||e.img||""),l=(s&&typeof a=="function"?o(a(s,i,"medium")):i)||i||n;return(typeof t=="function"?o(t(l,"medium")):l)||n||""}function ce(e={},{getOptimizedImageUrl:t,placeholderImage:a=""}={}){const s=o(e.titleImageUrl||e.coverImageUrl||e.coverImage||e.coverUrl||e.heroImageUrl||e.heroUrl||e.imageUrl||e.bestSpotLogoUrl||e.spotLogoUrl||e.logoUrl||e.logo||"")||a;return(typeof t=="function"?o(t(s,"large")):s)||a||""}function ue(e={}){return o(e.cuisine||e.kitchen||e.foodType||e.categoryLabel||e.__marketplaceTypeLabel||e.type||e.customerType||"")}function pe(e={}){return o(e.priceRange||e.priceLevel||e.priceLabel||e.budget||"")}function A(e,t=""){return typeof e=="string"?o(e):e===!0?o(t):""}function fe(e={}){const t=e.restaurantFeatures&&typeof e.restaurantFeatures=="object"?e.restaurantFeatures:{},a=[A(e.gardenTerraceText||e.gardenTerrace||e.gardenOrTerrace||t.gardenTerrace,"Gastgarten"),A(e.accessibilityText||e.barrierFreeText||e.accessibleText||e.barrierefrei||e.accessible||t.accessibility,"Barrierefrei"),A(e.veganOptionsText||e.veganOptions||e.veganText||e.vegan||t.veganOptions,"Vegane Optionen")].filter(Boolean);if(a.length)return a.slice(0,3);const n=Array.isArray(e.features)?e.features.map(o).filter(Boolean):[];if(n.length)return n.slice(0,3);const s=o(e.features||e.amenities||"");return s?s.split(/[,;|]/).map(o).filter(Boolean).slice(0,3):[]}function be(e="",t="",a={}){const n=a.icon,s=a.escapeHtml,i=o(t),l=`xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"${i?` class="${s(i)}"`:""} aria-hidden="true" focusable="false"`;return e==="share-2"?`<svg ${l}><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><path d="m8.59 13.51 6.83 3.98"></path><path d="m15.41 6.51-6.82 3.98"></path></svg>`:e==="phone"?`<svg ${l}><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>`:e==="book-open"?`<svg ${l}><path d="M12 7v14"></path><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"></path></svg>`:typeof n=="function"?n(e,t):""}function de(e={}){const t=Number(e.rating??e.avgRating??e.publicRating??0),a=Number(e.score??e.publicScore??0),n=Number(e.followersCount??e.followerCount??0),s=Number(e.postsCount??e.postCount??0),i=Number(e.updatedAt?.seconds||e.createdAt?.seconds||0);return(Number.isFinite(t)?t*1e3:0)+(Number.isFinite(a)?a:0)+(Number.isFinite(n)?Math.min(n,500):0)+(Number.isFinite(s)?Math.min(s,200):0)+(Number.isFinite(i)?Math.min(i/1e5,100):0)}function me(e={},t={}){const a=new Map,n=(s={})=>{if(!s||typeof s!="object")return;const i=h(s);if(!i)return;const r=a.get(i)||{};a.set(i,{...r,...s,id:i})};return(Array.isArray(e.bootstrapRestaurantPreview)?e.bootstrapRestaurantPreview:[]).forEach(n),(Array.isArray(e.restaurants)?e.restaurants:[]).forEach(n),Array.from(a.values()).map(s=>({...s,__marketplaceSection:ne(s,t),__marketplaceScore:de(s)})).filter(s=>s.__marketplaceSection).sort((s,i)=>i.__marketplaceScore-s.__marketplaceScore||g(s).localeCompare(g(i)))}function M(e={},t="",a={}){const n=P(t);return me(e,a).filter(s=>s.__marketplaceSection===n)}function k(e="",t="",{escapeHtml:a,isPlaceholderUrl:n,extraClass:s=""}={}){const i=o(e),r=!i||typeof n=="function"&&n(i);return`
    ...
    />
  `}function D(e={},t={}){const a=t.escapeHtml,n=t.icon,s=g(e),i=h(e),r=N(e,t),l=L(e),c=j(e);return`
  ...
  `}function G(e={},t={}){const a=t.escapeHtml,n=t.icon,s=g(e),i=h(e),r=N(e,t),l=L(e),c=j(e),p=q(e),f=oe(e),b=o(e.__marketplaceTypeLabel||e.type||e.customerType||"");return`
  ...
  `}function ge(e={},t={}){const a=t.escapeHtml,n=t.icon,s=(I,J)=>be(I,J,t),i=g(e),r=h(e),l=ce(e,t),c=N(e,t),p=L(e),f=Number(e.reviewsCount??e.reviewCount??e.ratingsCount??0),b=p||"0.0",u=Number.isFinite(f)&&f>0?f:0,v=ue(e),R=pe(e)||"€€ - €€€",d=j(e),$=le(e),y=q(e),z=fe(e),m=e.isLiked===!0||e.liked===!0||e.favorite===!0||e.favorited===!0;return`
  ...
  `}function B(e={},t={}){const a=o(e.__marketplaceType||e.type||e.customerType||""),n=U(a);return{...e,__marketplaceTypeLabel:{restaurant:"Restaurant",cafe:"Cafe",coffee:"Cafe",fastfood:"Fastfood",hotel:"Hotel",motel:"Motel",ecommerce:"E-Commerce"}[n]||t.title,__marketplaceType:n}}function C(e={},t={}){const a=t.escapeHtml,n=t.icon;return`
  ...
  `}function H(e={},t={}){t.escapeHtml;const a=t.icon;return`
  ...
  `}function he(){const e=globalThis?.localStorage||null;if(!e)return null;try{const t=e.getItem(Q);if(!t)return null;const a=JSON.parse(t),n=Number(a?.lat??a?.latitude),s=Number(a?.lng??a?.lon??a?.longitude);return!Number.isFinite(n)||!Number.isFinite(s)?null:{lat:n,lng:s,label:o(a?.label||a?.city||""),city:o(a?.city||a?.label||""),source:o(a?.source||"")}}catch{return null}}function ve({deps:e}={}){const t=e.icon;return`
    <div id="restaurantsSearchTop" data-restaurant-search-top style="background:${X};">
      <div class="loc-top">
        <div class="loc-title">
  ...
  `}function xe({items:e=[],bestItems:t=[],section:a={},deps:n={}}={}){return e.length?`
  ...
  `:C(a,n)}function ye({state:e,dataLoaded:t,section:a,deps:n}={}){const s=M(e,a.key,n).map(b=>B({...b,__marketplaceType:_(b,n)},a)),r=!!he(),l=s.slice(0,O),c=l.slice(0,K),f=t?.restaurants===!0||s.length?xe({items:l,bestItems:c,section:a,deps:n}):H(a,n);return r?`
  ...
  `}function we(e={}){const t=e?.travelView&&typeof e.travelView=="object"?e.travelView:{},a=o(t.query||""),n=o(t.activeTab||"").toLowerCase(),s=["offers","hotels","map"].includes(n)?n:a?"hotels":"offers";return{query:a,activeTab:a?s:"offers",notice:o(t.notice||"")}}function ke({travel:e,deps:t}={}){const a=t.escapeHtml,n=t.icon;return`
  ...
  `}function je({activeTab:e,hasDestination:t,hotelCount:a,deps:n}={}){const s=n.escapeHtml;return`
  ...
  `}function $e(e={},t={}){const a=t.escapeHtml,n=t.icon,s=g(e),i=h(e),r=N(e,t),l=j(e),c=L(e);return`
  ...
  `}function ze(e=[],t={}){const a=e.slice(0,4);return a.length?`
    <div class="space-y-4">
      ${a.map(n=>$e(n,t)).join("")}
    </div>
  `:C({emptyTitle:"Noch keine Angebote",emptyBody:"Keine passenden Hotel-Angebote gefunden.",icon:"plane"},t)}function Y(e=[],t={}){return e.length?`
    <div class="space-y-4">
      ${e.map(a=>G(a,t)).join("")}
    </div>
  `:C({emptyTitle:"Keine Hotels gefunden",emptyBody:"Keine passenden Hotels fuer dieses Reiseziel gefunden.",icon:"plane"},t)}function Te(e={},t=0,a={}){const n=a.escapeHtml,s=S(e),i=g(e),r=h(e),l=j(e),c=18+t*23%58,p=22+t*17%46;return`
    <button
      type="button"
  ...
  `}function Oe(e=[],t={}){if(typeof t.renderMapView=="function")return t.renderMapView();const a=e.filter(n=>S(n)).slice(0,8);return e.length?`
    <div class="space-y-4">
  ...
  `:Y(e,t)}function _e({state:e,dataLoaded:t,section:a,deps:n}={}){const s=M(e,a.key,n).map(u=>B({...u,__marketplaceType:_(u,n)},a)),i=we(e),r=!!i.query,l=r?s.filter(u=>re(u,i.query)):s.slice(0,O),c=l.slice(0,O),p=r?i.activeTab:"offers",f=t?.restaurants===!0,b=p==="map"?Oe(c,n):p==="hotels"?Y(c,n):ze(c,n);return`
    <section id="travelView" class="animate-in slide-in-from-right-10 duration-500" style="background:#f8fafc; min-height:100%;">
      ...
      <div id="travelBenko" data-travel-benko style="margin-top:-1.75rem; border-top-left-radius:2.5rem; border-top-right-radius:2.5rem; background:#f8fafc; padding:2rem 1.5rem 6.5rem;">
        ${je({activeTab:p,hasDestination:r,hotelCount:l.length,deps:n})}
        <div class="mt-5">
          ${f||s.length?b:H(a,n)}
        </div>
      </div>
    </section>
  `}function Se({state:e={},dataLoaded:t=null,sectionKey:a="restaurants",escapeHtmlFn:n,iconFn:s,getOptimizedImageUrlFn:i,isPlaceholderUrlFn:r,placeholderImage:l="",normalizeRestaurantTypeFn:c,normalizeLeadTypeKeyFn:p,resolveRestaurantLogoFn:f,renderMapViewFn:b}={}){const u=T[P(a)]||T.restaurants,v=E(n,(m="")=>String(m||"")),R=E(s,()=>""),d={escapeHtml:v,icon:R,getOptimizedImageUrl:i,isPlaceholderUrl:r,placeholderImage:l,resolveRestaurantLogo:f,renderMapView:b,normalizeRestaurantType:c,normalizeLeadTypeKey:p},$=t?.restaurants===!0;if(u.key==="travel")return _e({state:e,dataLoaded:t,section:u,deps:d});if(u.key==="restaurants")return ye({state:e,dataLoaded:t,section:u,deps:d});const y=M(e,u.key,d).slice(0,O).map(m=>B({...m,__marketplaceType:_(m,d)},u)),z=y.slice(0,K);return`
    <section class="p-6 pb-24 animate-in slide-in-from-right-10 duration-500">
      ${y.length?`
        <div style="margin-bottom:2rem;">
          <div class="flex gap-3 overflow-x-auto hide-scrollbar snap-x" style="-webkit-overflow-scrolling:touch; scrollbar-width:none;">
  ...
  `}export{M as filterMarketplaceBusinessesCore,Se as renderMarketplaceViewCore,ne as resolveMarketplaceSectionForBusinessCore};
