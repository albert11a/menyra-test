import{e as de,f as gs,t as ms,g as bs,h as Ae,a as xs}from"../entry/social-app.js";import"./startup-route-runtime-context-6Co7bthZ.js";import"./vendor-firebase-V03pMX6J.js";function ys(m={}){const c=m.state,Ut=m.resolvePostCountsFn,s=m.escapeHtmlFn,B=m.getOptimizedImageUrlFn,f=m.iconFn,Ht=m.isLocalBusinessProfileFn,Dt=typeof m.isCeoUserFn=="function"?m.isCeoUserFn:(()=>!1),Ze=m.normalizeHandleFn,Te=m.logoFitClassFn,E=m.formatCountFn,Je=m.renderProfileShopCartViewFn,Xe=m.renderProfileShopFavoritesViewFn,Ot=typeof m.ensurePostsDataForProfileFn=="function"?m.ensurePostsDataForProfileFn:(()=>{}),Vt=m.ensureMenuDataForProfileFn,Kt=typeof m.ensureEditorMenuDataForProfileFn=="function"?m.ensureEditorMenuDataForProfileFn:(()=>{}),ue=m.ensureFocusDataForProfileFn,qt=typeof m.ensureAdsDataForProfileFn=="function"?m.ensureAdsDataForProfileFn:(()=>{}),et=m.ensureTableQrStateForProfileFn,te=m.isShopCatalogProfileFn,tt=m.getBusinessCatalogLabelFn,ae=m.normalizeMenuTypeFn,Gt=m.primeMenuItemCountsFn,Qt=typeof m.hydrateMenuCardViewerLikesFn=="function"?m.hydrateMenuCardViewerLikesFn:(()=>Promise.resolve()),Wt=m.renderShopProductListFn,Yt=m.getMenuLayoutThemeFn,Zt=m.menuLayoutColors,K=m.resolveMenuItemHeroFn,H=m.isPlaceholderUrlFn,N=m.placeholderImage,Jt=m.getFirebaseStorageUrlFn,Xt=m.isDirectImageUrlFn,at=m.formatPriceFn,ea=typeof m.resolveCurrencyCodeForMenuItemFn=="function"?m.resolveCurrencyCodeForMenuItemFn:(()=>""),st=m.getMenuItemImagesFn,O=m.getMenuItemObjectPositionFn,pe=m.getMenuItemSocialIdFn,nt=m.menuItemMetaKeyFn,rt=m.ensureMenuItemMetaFn,it=m.resolveMenuItemCountsFn,fe=m.getFocusStateForRestaurantFn,ta=typeof m.getAdsStateForRestaurantFn=="function"?m.getAdsStateForRestaurantFn:(()=>({items:[],enabled:!0,loading:!1,same:!1})),ge=m.getTableQrStateForRestaurantFn,oe=m.getFocusItemObjectPositionFn,ot=m.getFocusCardClassFn,aa=m.getFocusIndexFn,se=m.isRestaurantCafeProfileFn,Le=typeof m.getBusinessProfileTypeFn=="function"?m.getBusinessProfileTypeFn:(()=>""),me=m.getRestaurantMetaByIdFn,sa=m.buildUrlFn,na=m.normalizeSearchKeyFn,ra=m.normalizeFollowHandleFn,q={key:"",inFlightKey:""},u=(e,t=e,a={})=>ms(e,{fallback:t,params:a}),lt=(e="")=>{const t=String(e||"").trim();if(!t)return u("nav.menu","Menue");const a=t.toLowerCase();return a==="menue"||a==="menu"||a==="menü"?u("nav.menu",t):a==="shop"?"Shop":t},ia=(e="food")=>String(e||"").trim().toLowerCase()==="drink"?u("menu.drinks","Getraenke"):u("menu.food","Speisen"),ct=(e={},t=!1)=>{const a=ae(e?.type||"food");return t?a==="drink"?u("menu.variant","Variante"):u("menu.product","Produkt"):a==="drink"?u("menu.drinkItem","Getraenk"):u("menu.foodItem","Speise")},_e=(e="",t="#111827")=>{const a=String(e||"").trim();return/^#[0-9a-fA-F]{6}$/.test(a)?a:t};function oa(e=null,t=null){return de(c,{profile:e,routePayload:t,webDirectEntry:c?.__webDirectEntry}).restaurantId}function dt(e=null,t=""){if(!e||typeof e!="object")return e;const a=String(t||"").trim();if(!a)return e;const n=String(e.canonicalRestaurantId||"").trim();return String(e.restaurantId||"").trim()===a&&n?e:{...e,restaurantId:a,...n?{canonicalRestaurantId:n}:{}}}function la(e=""){const t=String(e||"").trim();return t?de(c,{profile:c?.profileView?.profile||c?.userProfile,routePayload:c?.profileView?.routePayload,webDirectEntry:c?.__webDirectEntry,restaurantId:t}).focus.canRenderFocus:!1}function be(e={}){const t=String(ea(e)||"").trim();return t?at(e?.price,t):at(e?.price)}function ca(e=[],t="",a=""){const n=String(t||"").trim(),r=String(a||"").trim();if(!n||!r)return"";const i=Array.isArray(e)?e:[];if(!i.length)return`${n}|${r}|empty`;const o=[];return i.forEach(l=>{const d=String(pe(l)||l?.id||"").trim();d&&o.push(d)}),o.length?(o.sort(),`${n}|${r}|${o.join(",")}`):`${n}|${r}|empty`}function da(e=[],t=""){const a=String(c.user?.uid||"").trim(),n=ca(e,t,a);n&&q.inFlightKey!==n&&q.key!==n&&(q.key=n,q.inFlightKey=n,Qt(e,t).catch(r=>{console.error(r),q.key===n&&(q.key="")}).finally(()=>{q.inFlightKey===n&&(q.inFlightKey="")}))}function ua(e={}){const t=String(e?.uid||"").trim();if(t&&c.followingTargetIds.includes(t))return!0;const a=String(e?.restaurantId||"").trim();if(a&&c.followingTargetIds.includes(a))return!0;const n=ra(e?.handle||"");return!!(n&&c.followingHandles.includes(n))}function ut(e={}){if(e?.specialEnabled===!0)return!0;if(e?.specialEnabled===!1)return!1;const t=String(e?.restaurantId||"").trim();if(!t)return!1;const a=typeof me=="function"&&me(t)||null;return a?.specialEnabled===!0?!0:(a?.specialEnabled===!1,!1)}function pa(e={}){return W(e)==="testfirst_special"?!0:String(e?.category||"").trim().toLowerCase()==="special"}function pt(e,t,a=!0,{includeImageKey:n=!0}={}){const r=Ut(e),i=e.id?String(e.id):"",o=i?`data-open-post="${s(i)}"`:"",l=i?`data-post-like-count="${s(i)}"`:"",d=i?`data-post-comment-count="${s(i)}"`:"",p=n&&i?`data-img-key="profile-post:${s(i)}"`:"",g=e.type==="wide"||e.type==="hero",b=t&&g?"col-span-2":"",v=t&&g?"aspect-[1.8/1]":"aspect-[4/5]",h=B(e.url,g?"large":"medium",{stableKey:i?`profile-post:${i}`:"",variantGroup:"post-detail"}),S=g?800:400,I=g?400:500;return`
  ...
  `}function mt(e={}){const t=Ee(e),a=ba(t),n=U(t,["address","primaryAddress","location","formattedAddress","street"]),r=U(t,["city","locationCity","primaryCity","region","country"]),i=U(t,["beachDistance","distanceToBeach","beachDistanceLabel","strandEntfernung"]),o=U(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),l=U(t,["rating","reviewRating","stars","hotelStars"]),d=U(t,["reviewCount","reviewsCount","ratingsCount","commentsCount"]),p=ya(t),g=a?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${a.lat},${a.lng}`)}`:n||r?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${n} ${r}`.trim())}`:"";return`
    <div class="app-content-inline flex flex-col gap-4 app-main-content-safe animate-in fade-in duration-300">
      ...
      <div class="grid grid-cols-1 gap-4">
        ...
        ${we({iconName:"star",label:"Vlerësime",value:l?`${l}${d?` / ${d} vlerësime`:""}`:"Pa vlerësime",helper:U(t,["reviewSummary","ratingSummary","commentsSummary"])})}
      </div>
    ...
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      ...
      ${a?`
        <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
          ...
          <button type="button" data-hotel-card-details-open aria-expanded="${$?"true":"false"}" class="w-full flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100 text-left active:scale-[0.99] transition-transform">
            <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
              <img src="${s(F||N)}" class="w-full h-full object-cover" loading="lazy" decoding="async" />
            </div>
        ...
        <div data-hotel-card-editor="${s(a)}" data-hotel-card-details-panel class="${$?"":"hidden "}bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
            ...
            <div class="grid grid-cols-1 gap-4">
              ${gt({idPrefix:"hotelCardDistanceCenter",iconName:"navigation",label:"Qendra",value:S,directLabel:ka,direct:P})}
...
`))}</textarea>
    ...
    <section data-landing-swipe-root="true" class="relative w-full overflow-hidden font-sans" style="height: calc((var(--viewport-height, 1vh) * 100) - var(--smart-header-total-height, 4.5rem)); min-height: calc((var(--viewport-height, 1vh) * 100) - var(--smart-header-total-height, 4.5rem)); overscroll-behavior: none; -webkit-overflow-scrolling: auto; touch-action: none; user-select: none; background: #F8F9FA; --landing-panel-duration: 460ms; --landing-greeting-duration: 720ms; --landing-top-gap: 14px; --landing-swipe-bottom: 0.45rem;">
      ...
      <div data-landing-panel="0" class="absolute inset-0 z-50 flex flex-col items-start justify-center transition-transform ${a===0?"translate-y-0":"-translate-y-full pointer-events-none"}" style="background: #F8F9FA; color: #111827; padding-top: var(--landing-top-gap); opacity: ${a===0?"1":"0"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        ...
        <div class="flex flex-col items-start relative z-10 w-full" style="padding-left: 2.5rem; padding-right: 2.5rem;">
          <div class="relative w-full flex justify-start items-center mb-5" style="height: 40px;">
            ${t.map((x,k)=>{const j=k===n,A=k===(n-1+t.length)%t.length;return`
                <h1 data-landing-greeting-item="${k}" class="absolute left-0 font-medium text-indigo-600 origin-left" style="font-family: 'Playfair Display', Georgia, 'Times New Roman', serif; font-size: 1.875rem; line-height: 2.25rem; transition: all var(--landing-greeting-duration) cubic-bezier(0.23,1,0.32,1); ${j?"opacity: 1; transform: translateY(0) scale(1);":A?"opacity: 0; transform: translateY(-1.5rem) scale(0.95); pointer-events: none;":!j&&!A?"opacity: 0; transform: translateY(1.5rem) scale(0.95); pointer-events: none;":"opacity: 0;"}">
                  ${s(x)}
                </h1>
              `}).join("")}
          </div>
          <div class="flex items-center gap-3 mb-6">
            ...
            <h2 class="font-black text-left flex flex-wrap items-baseline" style="font-size:56px;line-height:48px;letter-spacing:-0.05em;column-gap:0.16em;row-gap:0;">
              <span style="color:${s(d)};">${s(S)}</span>${I?`<span style="color:${s(p)};">${s(I)}</span>`:""}
            </h2>
          </div>
      ...
      <div data-landing-panel="2" class="absolute inset-0 transition-transform ${a<2?"translate-y-full":a===2?"translate-y-0":"-translate-y-full"}" style="background: #F8F9FA; opacity: ${a===2?"1":"0"}; pointer-events: ${a===2?"auto":"none"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        <div data-landing-panel-scroll="2" class="h-full overflow-y-auto overscroll-contain" style="-webkit-overflow-scrolling: touch; touch-action: pan-y; overscroll-behavior-y: none; padding-top: var(--landing-top-gap); padding-bottom: 0;">
          ${F?ke(e,L,{topTabOverride:"profile",tutorialMode:!0,contentTabOverride:"posts",landingHideContent:!1,collapseIdentity:!0,contentReveal:!0,landingMode:!0}):""}
        </div>
        ${R}
      </div>
      ...
      <div data-landing-panel="3" class="absolute inset-0 transition-transform ${a<3?"translate-y-full":"translate-y-0"}" style="background: #F8F9FA; opacity: ${a===3?"1":"0"}; pointer-events: ${a===3?"auto":"none"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        <div data-landing-panel-scroll="3" class="h-full overflow-y-auto overscroll-contain" style="-webkit-overflow-scrolling: touch; touch-action: pan-y; overscroll-behavior-y: none; padding-top: var(--landing-top-gap); padding-bottom: 0;">
          ${T?ke(e,L,{topTabOverride:"profile",tutorialMode:!0,contentTabOverride:"menu",landingHideContent:!1,collapseIdentity:!0,contentReveal:!0,landingMode:!0}):""}
        </div>
      </div>
    </section>
  ...
  `}function Ue(e=c.profileView?.profile||c.userProfile,{disabled:t=!1}={}){const a=ye(e);return a==="checkins"||a==="menu"?"":`
  ...
  `}function yt(e={},t={}){const a=t.mode==="self"?"self":"public",n=t.disabledBlockClass||"",r=Na(e,a),i=_(t.avatarUrl||""),o=_(e?.avatar||""),l=o?B(o,"avatar"):"",d=i||l,p=t.avatarFit||Te(!!e.restaurantId),g=String(c?.profileCardInfoOpen||"")===r,b=Number(c?.profileCardInfoHeights?.[r]||0),v=g&&Number.isFinite(b)&&b>0?`height:${Math.ceil(b)}px;`:"",h=t.avatarImgKeyAttr||(a==="self"?'data-img-key="avatar:self"':`data-img-key="avatar:public:${s(r)}"`),S=!!_(d)&&!H(d),I=typeof t.renderAvatarImage=="boolean"?t.renderAvatarImage&&S:S,y=!!t.identityPending,P=t.followersLabel??E(e.followers),w=_(e?.name)||"User",$=_(t.typeLabel||e?.customerType||e?.type||"Business"),C=_(e?.location||"-"),F=a==="public"?`${C} / ${$}`:C,T=t.bioHtml||s(e?.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),L=`business-cover:${r}`,z=Ea(e,r),R=Ha(e,{cacheKeys:z,stableKey:L,allowCacheFallback:t.allowTitleImageCacheFallback===!0}),x=Oa(e),k=wt(e?.instagramUrl||e?.instagram||e?.insta||"","instagram"),j=wt(e?.tiktokUrl||e?.tiktok||e?.tikTok||"","tiktok"),A=_(e?.phone||e?.telephone||e?.contactPhone||""),M=Da(A),Y=_(e?.address||e?.locationLabel||[e?.place||e?.locationPlace,e?.location||e?.city].map(X=>_(X)).filter(Boolean).join(", ")),Z=[$e({href:k,iconName:"instagram",eyebrow:"Instagram",value:e?.instagram||e?.instagramUrl||e?.insta||""}),$e({href:j,iconName:"music-2",eyebrow:"TikTok",value:e?.tiktok||e?.tiktokUrl||e?.tikTok||""})].filter(Boolean).join(""),J=a==="self"?`
    ...
    `;if(g){const X=[$e({href:M,iconName:"phone",eyebrow:u("profile.call","Anrufen"),value:A}),$e({href:x,iconName:"map-pin",eyebrow:u("profile.address","Adresse"),value:Y||C}),Z].filter(Boolean).join("");return`
      <div data-landing-tutorial-target="identity" data-business-profile-card="${s(r)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${n}" style="${v}min-height: var(--business-profile-card-min-height, 440px);display:grid;grid-template-columns:minmax(0,1fr);width:100%;max-width:100%;min-width:0;box-sizing:border-box;">
        ${Va({profileName:w,safeBio:T,metaLine:F,identityPending:y,followersLabel:P})}
        <div class="p-8 min-w-0 max-w-full overflow-hidden flex flex-col justify-between" style="grid-area:1/1;min-height:100%;width:100%;max-width:100%;box-sizing:border-box;">
          ...
          <div class="mt-8 flex flex-col gap-4 min-w-0 max-w-full overflow-hidden">
            ${X||`<div class="py-10 text-center text-[10px] font-bold uppercase tracking-widest text-slate-300">${s(u("profile.noContactInfo","Noch keine Kontaktdaten"))}</div>`}
          </div>
    ...
    <div data-landing-tutorial-target="identity" data-business-profile-card="${s(r)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${n}" style="min-height: var(--business-profile-card-min-height, 440px);">
      <div class="h-40 w-full bg-slate-900 relative overflow-hidden flex items-center justify-center select-none">
        ...
        <div class="absolute top-4 right-4 flex items-center gap-2 z-30">
          ${He({href:x,label:u("profile.openMap","Karte oeffnen"),iconName:"map"})}
          ${He({href:j,label:"TikTok",iconName:"music-2"})}
          ${He({href:k,label:"Instagram",iconName:"instagram"})}
        </div>
      </div>
      <div class="px-8 pb-8 relative z-20" style="margin-top:-3rem;">
        <div class="flex items-end justify-between w-full">
          <div ${a==="self"?'id="profileAvatarTrigger"':""} class="relative ${a==="self"?"cursor-pointer group":""}">
            <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500 shadow-lg">
              ${I?`<img src="${s(d)}" decoding="async" width="100" height="100" ${h} class="w-full h-full rounded-[1.8rem] ${p} border-2 border-white bg-white" />`:`<div class="w-full h-full rounded-[1.8rem] border-2 border-white bg-slate-100 flex items-center justify-center ${y?"animate-pulse":""}">${f("store","w-8 h-8 text-slate-300")}</div>`}
            </div>
            ${e.isPremium?`
          ...
          <div class="flex items-center gap-6 pb-1 pr-2">
            <div data-landing-tutorial-target="fans" class="flex flex-col items-center min-w-0">
              <span class="font-black text-2xl ${y?"text-slate-300":"text-slate-900"} leading-none mb-1">${s(String(P))}</span>
              <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest opacity-80">${s(u("profile.fans","Fans"))}</span>
            </div>
            <div class="w-px h-8 bg-slate-100"></div>
  ...
  `}function ke(e={},t=[],{topTabOverride:a="",tutorialMode:n=!1,contentTabOverride:r="",landingHideContent:i=!1,collapseIdentity:o=!1,contentReveal:l=!1,landingMode:d=!1}={}){const p=ua(e),g=!!e.privateAccount&&e.uid&&String(e.uid)!==String(c.user?.uid||"")&&!p,b=!!e.pendingFollowRequest&&!p,v=e.restaurantId?"Business":u("nav.user","User"),h=String(e.handle||Ze(e.name||"user")).replace(/^@/,""),I=s(e.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),y=xe(e),P=String(a||Re(e)).trim().toLowerCase()||"profile",w=String(r||ye(e)).trim().toLowerCase()||"posts",$=w==="menu",C=w==="checkins",F=t,L={...c?.profileView&&typeof c.profileView=="object"?c.profileView:{},profile:e,posts:Array.isArray(F)?F:[]},z=bs(c,{profileView:L,profileTopTab:P,profileContentTab:w}),R=String(z?.header?.status||"").trim().toLowerCase()||"loading",x=String(z?.posts?.status||"").trim().toLowerCase()||"loading",k=String(e?.avatar||"").trim(),j=k?B(k,"avatar"):"",A=Te(!!e.restaurantId),M=e.canonicalRestaurantId||e.restaurantId||e.uid||h||"public",Y=d?"":`data-img-key="avatar:public:${s(M)}"`,Z=!!k,J=Ye=>{if(Ye==null)return!1;const Nt=Number(Ye);return Number.isFinite(Nt)&&Nt>=0},X=Z||J(e?.followers)||J(e?.following),V=Ae(R)&&!X,Ce=!!String(j||"").trim()&&Z,ie=V?"...":E(e.followers),Fe=V?"...":E(e.following),Pe=y?"pt-2":"pt-10",ce=p?u("profile.following","Following"):b?u("profile.requested","Requested"):g?u("profile.request","Request"):u("profile.follow","Follow"),D=p?"bg-slate-100 text-slate-600 shadow-none border border-slate-200":b?"bg-amber-50 text-amber-700 shadow-none border border-amber-200":"bg-gradient-to-r from-slate-900 to-slate-800 text-white border border-transparent",ds=n?"select-none":"app-main-content-safe",ee=n?"pointer-events-none":"",us=!o,Bt=!i,je=l?d?"transition-opacity duration-200":"animate-in fade-in duration-300":"",Rt=w==="posts"&&F.length>0,ps=w!=="posts"||Rt||x==="empty"||x==="error",fs=w==="posts"&&!Rt&&x==="error";return!n&&(w==="posts"||w==="media")&&e?.restaurantId&&Ae(x)&&Ot(e),`
    <div class="${ds}" ${n?'data-landing-tutorial-surface="true"':""}>
      ${P==="profile"||P==="menu"?`
      ${us?`
        <div class="app-content-inline pb-2 ${Pe}">
          ${y?yt(e,{mode:"public",disabledBlockClass:ee,avatarUrl:j,avatarFit:A,avatarImgKeyAttr:Y,renderAvatarImage:Ce,identityPending:V,followersLabel:ie,followLabel:ce,followTone:D,isFollowing:p,hasPendingFollowRequest:b,isLocked:g,bioHtml:I,typeLabel:v,allowTitleImageCacheFallback:Ae(R)||Ae(x)}):`
          <div data-landing-tutorial-target="identity" class="bg-white rounded-[2.5rem] p-8 relative overflow-hidden z-10 border border-slate-100 ${ee}">
            <div class="relative z-10">
              <div class="flex justify-between items-start mb-8">
                <div class="relative">
                  <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500">
                    ${Ce?`<img src="${s(j)}" decoding="async" width="100" height="100" ${Y} class="w-full h-full rounded-[1.8rem] ${A} border-2 border-white" />`:`<div class="w-full h-full rounded-[1.8rem] border-2 border-white bg-slate-100 flex items-center justify-center ${V?"animate-pulse":""}">${f(e.restaurantId?"store":"user","w-8 h-8 text-slate-300")}</div>`}
                  </div>
                  ${e.isPremium?`
                    <div class="absolute -bottom-1 -right-1 bg-white rounded-full p-1.5 shadow-lg text-blue-500 border-2 border-slate-50">
                      ${f("badge-check","w-4 h-4 fill-blue-500 text-white")}
                ...
                <div class="flex items-center gap-6 pt-3 pr-2">
                   <div data-landing-tutorial-target="fans" class="flex flex-col items-center">
                      <span class="font-black text-2xl ${V?"text-slate-300":"text-slate-900"} leading-none mb-1">${s(ie)}</span>
                      <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest opacity-80">${s(u("profile.fans","Fans"))}</span>
                   </div>
                   <div class="w-px h-8 bg-slate-100"></div>
      ...
      `:`
        ...
        ${Bt?$?`
          <div class="${ee} ${je}">
            ${he(e)?mt(e):Se(e,{mode:d?"landing":"profile",allowAutoEnsure:!d})}
          </div>
        `:C?`
          <div class="${ee} ${je}">
            ${Me()}
        ...
        `:`
          ${ps?`
            ${fs?`
              <div class="app-content-inline ${ee}">
            ...
            `:`
              <div class="${c.profileViewMode==="grid"?"grid grid-cols-2 gap-4 app-content-inline grid-flow-dense":"flex flex-col gap-8 app-content-inline"} ${ee} ${je}">
                ${ze(F,c.profileViewMode,!1,{includeImageKeys:!d})}
              </div>
            `}
          `:`
            <div class="app-content-inline ${ee}">
  ...
  `}function Ka(){const e=c.profileView;if(!e||!e.profile)return"";const t=e.profile,a=e.posts||t.posts||[],n=Re(t);return n==="landing"?za(t):ke(t,a,{topTabOverride:n,tutorialMode:!1})}function $t(e,{filter:t="all",query:a=""}={}){const n=Array.isArray(e)?e:[],r=na(a||"");return n.filter(i=>t==="all"||ae(i.type)===t?r?`${i.name||""} ${i.category||""} ${i.description||""}`.toLowerCase().includes(r):!0:!1)}function kt(e,t=0){const a=Number(e);return Number.isFinite(a)?Math.max(0,Math.floor(a)):Math.max(0,Number(t)||0)}function Ie(e=[]){return(Array.isArray(e)?e.slice():[]).map((a,n)=>({item:a,idx:n,order:kt(a?.orderIndex,n)})).sort((a,n)=>a.order-n.order||a.idx-n.idx).map((a,n)=>({...a.item,orderIndex:kt(a.item?.orderIndex,n)}))}function De(e={}){const t=String(e?.menuVisibility||"").trim().toLowerCase();return e?.menuHidden===!0||t==="hidden"}function le(e={}){const t=String(e?.menuSection||e?.displaySection||e?.menuPlacement||"").trim().toLowerCase();return t==="drink"?"drink":t==="food"?"food":ae(e?.type||"food")==="drink"?"drink":"food"}function qa(e={}){return String(e?.category||u("menu.other","Sonstiges")).trim()||u("menu.other","Sonstiges")}function Ga(e=""){const t=String(e||"").trim().toLowerCase();return t?(typeof t.normalize=="function"?t.normalize("NFD").replace(/[\u0300-\u036f]/g,""):t).replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""):""}const Qa=4,Wa={thumb:160,small:480,medium:768,large:1280};function It({mode:e="profile",priorityIndex:t=-1,slideIndex:a=0}={}){return(e==="profile"||e==="landing")&&Number.isFinite(t)&&t>=0&&t<Qa&&a===0}function Ya({mode:e="profile",priorityIndex:t=-1,slideIndex:a=0}={}){const n=It({mode:e,priorityIndex:t,slideIndex:a}),r=e==="profile"?' data-image-reveal="menu"':"";return n?`loading="eager" fetchpriority="high"${r}`:`loading="lazy" fetchpriority="low"${r}`}function Za({variant:e="grid"}={}){return e==="thumb"?"(max-width: 640px) 64px, 64px":e==="hero"?"(max-width: 640px) 94vw, (max-width: 1200px) 74vw, 920px":"(max-width: 640px) 48vw, (max-width: 1200px) 28vw, 360px"}function Q(e,{mode:t="profile",priorityIndex:a=-1,slideIndex:n=0,stableKey:r="",preferredSize:i="small",candidateSizes:o=["small","medium","large"],variant:l="grid"}={}){const d=String(e||"").trim(),p=t==="profile"&&r?{stableKey:r}:null,g=It({mode:t,priorityIndex:a,slideIndex:n}),b=t==="profile"&&!g&&l!=="thumb",v=B(d,i,p),h=H(v)?N:v,S=Jt(d),I=Xt(d)&&d!==h?d:S,y=[],P=new Set;o.forEach(k=>{const j=Wa[k]||0;if(!j)return;const A=B(d,k,p);if(!A||H(A))return;const M=`${A}|${j}`;P.has(M)||(P.add(M),y.push(`${A} ${j}w`))});const w=y.length>1?y.join(", "):"",$=w?Za({variant:l}):"",C=b?"":w,F=b?"":$,T=C?` srcset="${s(C)}"`:"",L=F?` sizes="${s(F)}"`:"",z=Ya({mode:t,priorityIndex:a,slideIndex:n}),R=`${z}${T}${L}`,x=b?[`data-menu-lazy-src="${s(h)}"`,`data-menu-lazy-fallback="${s(I||N)}"`,w?`data-menu-lazy-srcset="${s(w)}"`:"",$?`data-menu-lazy-sizes="${s($)}"`:""].filter(Boolean).join(" "):"";return{safeImg:b?N:h,fallbackImg:b?N:I,imageAttrs:R,lazyAttrs:x?` ${x}`:"",srcsetValue:w,sizesValue:$,loadingAttrs:z}}function ne(e=[],t,a=null){const n=a instanceof Set?a:new Set;return e.map((r,i)=>{const o=qa(r),l=Ga(o),d=!!l&&!n.has(l);return d&&n.add(l),`<div${d?` data-menu-category-anchor="${s(l)}"`:""} class="h-full">${t(r,i)}</div>`}).join("")}function Oe(e={}){return String(e?.specialSize||e?.specialCardSize||"").trim().toLowerCase()==="food"?"food":"default"}function Ja(e=""){const t=String(e||"").trim();return t?/^(https?:\/\/|mailto:|tel:)/i.test(t)?t:`https://${t.replace(/^\/+/,"")}`:""}function St(e={}){const t=String(e?.specialActionType||e?.actionType||"").trim().toLowerCase(),a=Ja(e?.specialActionUrl||e?.linkUrl||e?.actionUrl||""),n=String(e?.specialActionProductId||e?.targetProductId||"").trim();return t==="link"&&a?{type:"link",url:a,productId:""}:t==="product"&&n?{type:"product",url:"",productId:n}:{type:"self",url:"",productId:""}}function Ct(){const e=c.menu.filter||"all";return`
    <div class="flex gap-2 mb-5">
      ${(te(c.userProfile)?[{id:"all",label:u("menu.all","Alle")},{id:"food",label:u("menu.products","Produkte")},{id:"drink",label:u("menu.variants","Varianten")}]:[{id:"all",label:u("menu.all","Alle")},{id:"food",label:u("menu.food","Speisen")},{id:"drink",label:u("menu.drinks","Getraenke")}]).map(n=>`
  ...
  `}function Ke(e,{mode:t="profile",variant:a="food",priorityIndex:n=-1}={}){const r=K(e),i=t==="profile"?re(e,{index:0}):"",o=a==="drink",{safeImg:l,fallbackImg:d,imageAttrs:p,lazyAttrs:g}=Q(r,{mode:t,priorityIndex:n,stableKey:i,preferredSize:o?"small":"medium",candidateSizes:o?["small","medium"]:["small","medium","large"],variant:o?"grid":"hero"}),b=be(e),v=c.activeTab==="menu"?c.userProfile:c.profileView?.profile||c.userProfile,h=te(v),S=ct(e,h),I=e.category||"",y=e.description||"",P=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",w=c.menu.restaurantId||c.profileView?.profile?.restaurantId||c.userProfile.restaurantId||"",$=pe(e),C=nt(w,$),F=C?rt(C):{likes:[],comments:[],counts:{likes:0,comments:0}},T=it(F),L=`
    <div class="mt-2 flex items-center gap-3 text-[10px] font-bold text-slate-400">
      <span class="inline-flex items-center gap-1">
        ${f("heart","w-3 h-3 text-rose-400")} <span data-menu-like-count="${s($)}">${s(E(T.likes))}</span>
      </span>
      <span class="inline-flex items-center gap-1">
        ${f("message-circle","w-3 h-3 text-indigo-400")} <span data-menu-comment-count="${s($)}">${s(E(T.comments))}</span>
      </span>
    </div>
  `;return`
  ...
  `}function qe(e={}){if(!e?.restaurantId||te(e))return!1;const t=String(Le(e)||"").trim().toLowerCase();return t==="restaurant"||t==="cafe"||t==="fastfood"}function Ft(e){const t=e?.restaurantId||c.menu.restaurantId||c.profileView?.profile?.restaurantId||c.userProfile.restaurantId||"",a=pe(e),n=nt(t,a),r=n?rt(n):{likes:[],comments:[],counts:{likes:0,comments:0}},i=String(c.user?.uid||"").trim(),o=String(c.user?.handle||"").trim().toLowerCase(),l=!!r.likes?.some(d=>{const p=String(d?.uid||"").trim();if(i&&p&&p===i)return!0;const g=String(d?.handle||"").trim().toLowerCase();return!!o&&!!g&&g===o});return{itemId:a,meta:r,counts:it(r),isLiked:l}}function re(e,{index:t=0}={}){const a=String(e?.restaurantId||c.menu.restaurantId||c.profileView?.profile?.restaurantId||c.userProfile.restaurantId||"").trim(),n=String(e?.id||pe(e)||"").trim();if(!a||!n)return"";const r=Number(t),i=Number.isFinite(r)?Math.max(0,Math.floor(r)):0;return`menu-detail:${a}:${n}:${i}`}function es(e){const t=typeof st=="function"?st(e):[],a=Array.isArray(t)?t.filter(Boolean):[];if(a.length)return a;const n=K(e);return n?[n]:[]}function W(e){return xs(e?.cardStyle||"",ae(e?.type||"food"))}function Ge(e,{menuItemId:t=""}={}){if(!e)return null;const a=String(t||e.menuItemId||e.itemId||e.productId||"").trim();return{id:e.id||"",title:e.name||e.title||"Sot ne Fokus",text:e.description||e.text||"",imageUrl:K(e)||e.imageUrl||"",objectPosition:e.objectPosition||O(e),menuItemId:a}}function Pt(e,t=[],{mode:a="profile"}={}){const n=e?.restaurantId||"";return!n||!qe(e)||!t.length?"":`
    <div class="pt-2 pb-4">
      <div class="flex gap-4 overflow-x-auto hide-scrollbar snap-x horizontal-safe-scroll pb-4">
        ${t.map((r,i)=>{const o=r.imageUrl||"",l=String(r.menuItemId||r.id||"").trim(),{safeImg:d,fallbackImg:p,imageAttrs:g,lazyAttrs:b}=Q(o,{mode:a,priorityIndex:i,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:l?`menu-focus:${n}:${l}`:""}),v=String(r.menuItemId||"").trim(),h=a==="profile"&&v?`data-menu-open="${s(v)}" role="button"`:"";return`
            <div ${h} class="min-w-[85%] sm:min-w-[300px] snap-center bg-white rounded-[2rem] p-2.5 border border-slate-100 flex flex-col group relative mb-2 ${h?"cursor-pointer":""}" style="box-shadow:0 4px 14px rgba(0,0,0,0.03);">
              <div class="w-full aspect-[16/9] rounded-[1.5rem] overflow-hidden bg-slate-100 relative" style="aspect-ratio:16 / 9;">
                <img src="${s(d)}" data-fallback-src="${s(p)}"${b} class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 select-none pointer-events-none" draggable="false" style="width:100%;height:100%;object-fit:cover;object-position:${r.objectPosition||"50% 50%"};" ${g} decoding="async" />
  ...
  `}function jt(e,{mode:t="profile",priorityIndex:a=-1}={}){const n=K(e),r=t==="profile"?re(e,{index:0}):"",{safeImg:i,fallbackImg:o,imageAttrs:l,lazyAttrs:d}=Q(n,{mode:t,priorityIndex:a,stableKey:r,preferredSize:"small",candidateSizes:["small","medium"],variant:"grid"}),p=be(e),g=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",{itemId:b,counts:v,isLiked:h}=Ft(e);return`
  ...
  `}function At(e,{mode:t="profile",priorityIndex:a=-1}={}){const n=be(e),r=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",i=es(e),l=(i.length?i:[K(e)||""]).filter(Boolean),d=l.length?l.slice(0,12):[""],p=d.length>1,{itemId:g,counts:b,isLiked:v}=Ft(e),h=E(Math.max(0,Number(b.likes)||0)),S=E(Math.max(0,Number(b.comments)||0));return`
    <div ${r} class="bg-white p-3.5 rounded-[2.2rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-5 group relative ${t==="profile"?"cursor-pointer":""}" style="padding:14px;border-radius:2.2rem;margin-bottom:20px;box-sizing:border-box;">
      <div class="w-full aspect-[16/9] rounded-[1.8rem] overflow-hidden bg-slate-100 mb-4 relative" style="aspect-ratio:16 / 9;border-radius:1.8rem;margin-bottom:16px;">
        ${p?`
          ...
          >
            ${d.map((I,y)=>{const P=t==="profile"?re(e,{index:y}):"",w=Q(I||"",{mode:t,priorityIndex:a,slideIndex:y,stableKey:P,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"}),$=y>0,C=$?N:w.safeImg,F=$?N:w.fallbackImg,T=$?w.loadingAttrs:w.imageAttrs,L=$?"":w.lazyAttrs||"",z=$?` data-menu-card-deferred-src="${s(w.safeImg)}"
                ...
                <div class="min-w-full h-full snap-center relative" data-menu-card-gallery-slide="${y}" style="min-width:100%;width:100%;height:100%;scroll-snap-align:center;">
                  <img src="${s(C)}" data-fallback-src="${s(F)}"${L}${z} class="w-full h-full object-cover select-none pointer-events-none" draggable="false" style="object-position:${O(e)};" ${T} decoding="async" />
                </div>
              `}).join("")}
          </div>
        `:`
          ${d.map((I,y)=>{const P=t==="profile"?re(e,{index:y}):"",{safeImg:w,fallbackImg:$,imageAttrs:C,lazyAttrs:F}=Q(I||"",{mode:t,priorityIndex:a,slideIndex:y,stableKey:P,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"});return`
              <div class="w-full h-full">
                <img src="${s(w)}" data-fallback-src="${s($)}"${F} class="w-full h-full object-cover select-none pointer-events-none" draggable="false" style="object-position:${O(e)};" ${C} decoding="async" />
              </div>
            `}).join("")}
        `}
        <button
  ...
  `}function as(e,t,{mode:a="profile",publicMenuSurfaceState:n=null}={}){const r=Ie(Array.isArray(t)?t:[]),i=String(e?.restaurantId||"").trim(),o=a==="admin"||la(i),l=n?.focus?.canRenderFocus?{items:Array.isArray(n.focus.items)?n.focus.items:[],enabled:!0}:i&&o?fe(i):{items:[],enabled:!1},d=l.enabled?(Array.isArray(l.items)?l.items:[]).map(x=>Ge({...x,objectPosition:oe(x)})):[],p=r.filter(x=>W(x)==="testfirst_focus"&&!De(x)).map(x=>Ge(x,{menuItemId:x.id||""})).filter(Boolean),g=new Set,b=[...d,...p].filter(x=>{const k=String(x.menuItemId||x.id||`${x.title}|${x.text}|${x.imageUrl}`);return!k||g.has(k)?!1:(g.add(k),!0)}),v=r.filter(x=>!De(x)),h=v.filter(x=>W(x)!=="testfirst_focus"),S=h.length?h:v,I=h.length?b:[],y=S.filter(x=>le(x)==="drink"),P=S.filter(x=>le(x)!=="drink"),w=(x=[])=>{const k=[],j=[];return x.forEach(A=>{const M=W(A);M==="testfirst_food"||M==="testfirst_special"&&Oe(A)==="food"?j.push(A):k.push(A)}),{gridItems:k,foodItems:j}},$=(x,k=-1)=>W(x)==="testfirst_special"?Qe(x,{mode:a,priorityIndex:k}):jt(x,{mode:a,priorityIndex:k});let C=0;const F=()=>{const x=C;return C+=1,x},T=new Set,L=(x,k)=>!k.gridItems.length&&!k.foodItems.length?"":`
        ...
        ${k.foodItems.length?`
          <div class="menu-category-section pb-6 pt-4" data-menu-type="${s(x)}">
            <div class="app-content-inline">
              ${ne(k.foodItems,j=>{const A=W(j),M=F();return A==="testfirst_special"?Qe(j,{mode:a,size:"food",priorityIndex:M}):At(j,{mode:a,priorityIndex:M})},T)}
            </div>
          </div>
        `:""}
      </section>
  ...
  `}function Tt(e,{mode:t="profile",useTestfirstCardUi:a=!1,seenCategories:n=null,priorityOffset:r=0}={}){return e.length?a?`
    ...
    <div class="grid grid-cols-2 auto-rows-fr gap-4">
      ${ne(e,(i,o)=>Ke(i,{mode:t,variant:"drink",priorityIndex:r+o}),n)}
    </div>
  `:""}function Lt(e,{mode:t="profile",useTestfirstCardUi:a=!1,seenCategories:n=null,priorityOffset:r=0}={}){return e.length?a?`
      <div>
        ${ne(e,(i,o)=>W(i)==="testfirst_special"&&Oe(i)==="food"?Qe(i,{mode:t,size:"food",priorityIndex:r+o}):At(i,{mode:t,priorityIndex:r+o}),n)}
      </div>
    `:`
    <div class="space-y-4">
      ${ne(e,(i,o)=>Ke(i,{mode:t,variant:"food",priorityIndex:r+o}),n)}
    </div>
  `:""}function _t(e,{mode:t="profile"}={}){if(t==="admin"){const a=String(c?.menu?.filter||"all").trim().toLowerCase(),n=e.filter(d=>ae(d?.type)==="drink"),r=e.filter(d=>ae(d?.type)!=="drink"),i=(d,p,{addType:g=""}={})=>`
      <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
        <div class="flex items-center justify-between mb-4">
          <div>
  ...
  `:`
    ...
    `}function We(e,{variant:t="focus",suppressLoading:a=!1}={}){if(!e)return"";const{items:n,enabled:r,loading:i}=fe(e,{includeInactive:!0}),o=E(n.length),l=String(t||"").trim().toLowerCase()==="travel-offers",d=l?"Ofertat":"Sot ne Fokus",p=l?"Oferta":"Highlights",g=l?"Im Travel und Profil sichtbar":"Im Profil sichtbar",b=l?"Ofertat werden geladen...":u("focus.loading","Fokus wird geladen..."),v=l?"Noch keine Oferta-Eintraege":"Noch keine Fokus-Eintraege";return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(h=>{const S=B(h.imageUrl||"","thumb"),I=H(S)?N:S,y=h.active!==!1?"Aktiv":"Inaktiv",P=h.active!==!1?"text-emerald-600":"text-slate-400";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function zt(e={}){if(!e?.restaurantId)return!1;const t=String(Le(e)||"").trim().toLowerCase();return["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"].includes(t)?!1:te(e)||se(e)||["restaurant","cafe","coffee","fastfood","food","ecommerce"].includes(t)||!t}function ss(e={}){if(e.active===!1)return{label:"Inaktiv",className:"text-slate-400"};const t=String(e.status||e.approvalStatus||"pending").trim().toLowerCase();return t==="approved"?{label:"Freigegeben",className:"text-emerald-600"}:t==="rejected"?{label:"Abgelehnt",className:"text-rose-600"}:{label:"Wartet auf Heart",className:"text-amber-600"}}function ns(e,t){if(!t||!zt(e))return"";const{items:a,loading:n}=ta(t,{includeInactive:!0}),r=E(a.length);return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(i=>{const o=B(i.imageUrl||"","thumb"),l=H(o)?N:o,d=ss(i),p=i.category||"RESTAURANT",g=i.priceSegment||"€€ - €€€";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function rs(e){if(!qe(e)||!ut(e))return"";const a=Ie((c.menu.items||[]).filter(n=>W(n)==="testfirst_special"));return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(n=>{const r=B(K(n),"thumb"),i=H(r)?N:r,o=St(n),l=o.type==="link"?"Link":o.type==="product"?"Produkt-Modal":"Diese Karte",d=Oe(n)==="food"?"Food-Size":"Normal",p=ia(le(n));return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function Mt(e,{restaurantId:t="",suppressLoading:a=!1,allowAutoEnsure:n=!0,requirePublicMenuTruth:r=!0}={}){const i=String(t||e?.canonicalRestaurantId||e?.restaurantId||"").trim();if(!i||!se(e))return"";const o=de(c,{profile:e,routePayload:c?.profileView?.routePayload,webDirectEntry:c?.__webDirectEntry,restaurantId:i});if(r&&o.menu.status!=="ready")return"";const l=!r||o.focus.canRenderFocus;if(n&&!c.focus.loading&&!l&&ue(dt(e,i)),r&&!l)return"";const{items:d,loading:p}=l?{items:Array.isArray(o.focus.items)?o.focus.items:[],loading:o.focus.loading}:fe(i);if(!(l?!0:fe(i).enabled)||!d.length&&!p||a&&p&&!d.length)return"";if(p&&!d.length)return`
    ...
    `;const b=aa(d),v=d[b]||d[0],{safeImg:h,fallbackImg:S,imageAttrs:I,lazyAttrs:y}=Q(v.imageUrl||"",{mode:"profile",priorityIndex:0,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:v?.id?`focus-carousel:${i}:${String(v.id)}`:""}),P=v.text||"";return`
    <div id="focusCarousel" class="${ot()} rounded-[2.5rem] p-6 border shadow-sm">
      ...
      <div class="relative rounded-[2rem] overflow-hidden border border-slate-100 bg-slate-50">
        <img data-focus-image src="${s(h)}" data-fallback-src="${s(S)}"${y} class="w-full h-56 object-cover" style="object-position:${oe(v)};" ${I} decoding="async" />
      </div>
      <div class="mt-4">
      ...
      ${d.length>1?`
        <div class="flex items-center justify-center gap-2 mt-4">
          ${d.map(($,C)=>`
            <button type="button" data-focus-dot="${C}" class="w-2.5 h-2.5 rounded-full ${C===b?"bg-slate-900":"bg-slate-200"}"></button>
          `).join("")}
        </div>
      `:""}
    </div>
  ...
  `}function os({profile:e,restaurantId:t,catalogLabel:a}){if(!t||!se(e))return"";if(typeof et=="function"){const i=ge?ge(t):null;(!i||i.sameRestaurant!==!0||!i.loading&&!i.loaded&&!i.error)&&et(e)}const n=typeof ge=="function"?ge(t):{enabled:!0,count:0,tables:[],loading:!1,saving:!1,error:""},r=(n.tables||[]).map(i=>{const o=sa("apps/menyra-social/index.html",{r:t,tab:"menu",source:"qr",table:i});return Et({label:`Tisch ${i}`,url:o,caption:`${a} fuer Tisch ${i}`})}).join("");return`
  ...
  `}function ls(){const e=c.userProfile,t=e.restaurantId||"",a=String(c.user?.uid||"").trim(),n=String(c.__authBootstrapInFlightUid||"").trim(),r=!t&&!!a&&(!!c.__authProfileLoadPromise||n===a),i=he(e),o=se(e),l=c.profileView?.profile?.restaurantId?c.profileView.profile:null,d=Dt()&&!!l?.restaurantId&&se(l),p=lt(tt(e)),g=t?me(t):null,b=g?.name||g?.restaurantName||e.name||"Business",v=t&&c.menu.restaurantId===t,h=String(c.menu.source||"").trim().toLowerCase(),S=!!v&&h==="collection",I=!!v&&h==="collection"&&c.menu.loading,y=!!t&&(I||!S),P=S?$t(c.menu.items,{filter:c.menu.filter,query:c.menu.query}):[],$=ut(e)?P:P.filter(T=>!pa(T)),C=Ie($),F=E(C.length);if(t&&i){ma(e);const T=String(c.focus?.truthSource||"").trim().toLowerCase();return!c.focus.loading&&(c.focus.restaurantId!==t||T!=="public-menu")&&ue(e),Ta(e)}return t&&o&&!S&&!I&&Kt(e),t&&o&&!c.focus.loading&&c.focus.restaurantId!==t&&ue(e),t&&zt(e)&&qt(e),o?`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      <div class="flex items-end justify-between mb-6">
        <div>
      ...
      ${t?`
        ...
        ${y?`<div class="text-center py-12 text-[10px] font-bold uppercase tracking-widest text-slate-400">${s(u("menu.loading",`${p} wird geladen...`,{label:p}))}</div>`:_t(C,{mode:"admin"})}
  ...
  `:d?Se(l):`
    ...
    `;const l=dt(e,o),d=se(l);d&&(i=de(c,{profile:l,routePayload:n,webDirectEntry:r,restaurantId:o,coordinateFocusWithMenu:!0}));const p=String(r?.canonicalRestaurantId||r?.restaurantId||"").trim(),g=new Set(i.targetIds),b=gs(i.focus.truthState||""),v=i.menu.status==="ready",h=i.focus.canRenderFocus,S=v&&d,I=i.focus.matches===!0&&i.focus.loading===!0,y=t==="landing",w=String(c?.profileView?.menuAccessSource||r?.menuAccessSource||n?.menuAccessSource||"").trim().toLowerCase()==="qr",$=r?.active===!0&&r?.webPriority===!0&&r?.menuFirst===!0&&String(c?.activeTab||"").trim().toLowerCase()==="profile"&&String(c?.profileTopTab||"").trim().toLowerCase()==="menu"&&(p===o||g.has(o)),C=$&&!w,F=["ready","empty","error"].includes(i.menu.status),T=$&&F,L=$&&(!S||i.menu.status!=="ready"),z=!S||i.focus.settled===!0||b==="knownEmpty"||i.menu.status!=="ready";a&&!T&&!F&&Vt(l),a&&!L&&!z&&!I&&v&&(!C||F)&&ue(l);const x=i.menu.canRenderItems?Ie($t(i.menu.items,{filter:"all",query:""})).filter(D=>!De(D)):[],k=x.length>0,j=te(e),A=lt(tt(e)),M=i.menu.error||"",Y=!!String(M||"").trim(),Z=i.menu.status==="loading"||i.menu.waitingForFocus===!0,J=x.filter(D=>le(D)==="drink"),X=x.filter(D=>le(D)!=="drink"),V=0,Ce=J.length,ie=qe(e),Fe=new Set;k&&o&&(Gt(x,o),da(x,o));const Pe=o&&h?(Array.isArray(i.focus.items)?i.focus.items:[]).map(D=>Ge({...D,objectPosition:oe(D)})).filter(Boolean):[],ce=Pe.length?Pt(l,Pe,{mode:t}):"";return y&&Z?'<div class="app-content-inline app-main-content-safe" style="min-height: 34vh;"></div>':ie?`
      <div class="app-main-content-safe">
        ...
        `:`
          ${k?as(l,x,{mode:t,publicMenuSurfaceState:i}):Y?`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${s(u("menu.loadError","Menu konnte nicht geladen werden"))}</div>`:ce||`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300">${s(u("menu.noProducts","Keine Produkte"))}</div>`}
    ...
    <div class="app-content-inline app-main-content-safe space-y-5">
      ${Mt(l,{restaurantId:o,suppressLoading:!0,allowAutoEnsure:v&&(!C||F),requirePublicMenuTruth:!0})}
      ${Z?`
            ...
            ${J.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="drink">
                ...
                <div data-menu-type="drink">
                  ${Tt(J,{mode:t,useTestfirstCardUi:ie,seenCategories:Fe,priorityOffset:V})}
                </div>
              </section>
            `:""}
            ${X.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="food">
                ...
                <div data-menu-type="food">
                  ${Lt(X,{mode:t,useTestfirstCardUi:ie,seenCategories:Fe,priorityOffset:Ce})}
                </div>
              </section>
            `:""}
          `}
  ...
  `}return{renderProfilePostCardFancy:pt,renderProfilePostsFancy:ze,renderProfileCheckins:Me,renderProfileTabs:Ne,renderProfileViewControls:Ue,renderPublicProfileView:Ka,renderMenuFilterRow:Ct,renderMenuLayoutSection:Xa,renderMenuItemCard:Ve,renderMenuItemCardStacked:Ke,renderMenuDrinkGrid:Tt,renderMenuFoodList:Lt,renderMenuList:_t,renderFocusAdminSection:We,renderFocusCarousel:Mt,renderMenuQrCard:Et,renderMenuAdminView:ls,renderProfileMenuView:Se,renderProfileView:cs}}export{ys as createProfileMenuFocusRenderController};
