import{_ as dt}from"./domain-auth-GDqJX7rW.js";const pt=()=>"";function Oe(e,t=pt){return typeof e=="function"?e:t}function gt(e=""){const t=String(e||"").trim().toLowerCase();return t==="restaurant"?"restaurants":t==="hotel"||t==="hotels"||t==="motel"||t==="motels"?"travel":t==="shop"||t==="ecommerce"||t==="e-commerce"?"shopping":t}function Ja({state:e=null,dataLoaded:t=null,renderFn:a=()=>{},helperApi:n={},profileApi:s={}}={}){const i=Oe(a,()=>{});let r=null,l=null;function f(){return r?Promise.resolve(r):l||(l=dt(()=>Promise.resolve().then(()=>Ta),void 0).then(g=>(r=g,i(),g)).catch(g=>{throw l=null,g}),l)}function b(){f().catch(()=>null)}function x(){return`
