import{e as de,f as ms,t as bs,g as xs,h as Te,a as hs}from"../entry/social-app.js";import"./startup-route-runtime-context-6Co7bthZ.js";import"./vendor-firebase-V03pMX6J.js";function $s(b={}){const d=b.state,Ut=b.resolvePostCountsFn,s=b.escapeHtmlFn,B=b.getOptimizedImageUrlFn,f=b.iconFn,Ht=b.isLocalBusinessProfileFn,Dt=typeof b.isCeoUserFn=="function"?b.isCeoUserFn:(()=>!1),Ze=b.normalizeHandleFn,Le=b.logoFitClassFn,E=b.formatCountFn,Je=b.renderProfileShopCartViewFn,Xe=b.renderProfileShopFavoritesViewFn,Ot=typeof b.ensurePostsDataForProfileFn=="function"?b.ensurePostsDataForProfileFn:(()=>{}),Vt=b.ensureMenuDataForProfileFn,Kt=typeof b.ensureEditorMenuDataForProfileFn=="function"?b.ensureEditorMenuDataForProfileFn:(()=>{}),ue=b.ensureFocusDataForProfileFn,qt=typeof b.ensureAdsDataForProfileFn=="function"?b.ensureAdsDataForProfileFn:(()=>{}),et=b.ensureTableQrStateForProfileFn,te=b.isShopCatalogProfileFn,tt=b.getBusinessCatalogLabelFn,se=b.normalizeMenuTypeFn,Gt=b.primeMenuItemCountsFn,Qt=typeof b.hydrateMenuCardViewerLikesFn=="function"?b.hydrateMenuCardViewerLikesFn:(()=>Promise.resolve()),Wt=b.renderShopProductListFn,Yt=b.getMenuLayoutThemeFn,Zt=b.menuLayoutColors,q=b.resolveMenuItemHeroFn,D=b.isPlaceholderUrlFn,U=b.placeholderImage,Jt=b.getFirebaseStorageUrlFn,Xt=b.isDirectImageUrlFn,at=b.formatPriceFn,ea=typeof b.resolveCurrencyCodeForMenuItemFn=="function"?b.resolveCurrencyCodeForMenuItemFn:(()=>""),st=b.getMenuItemImagesFn,V=b.getMenuItemObjectPositionFn,pe=b.getMenuItemSocialIdFn,nt=b.menuItemMetaKeyFn,rt=b.ensureMenuItemMetaFn,it=b.resolveMenuItemCountsFn,fe=b.getFocusStateForRestaurantFn,ta=typeof b.getAdsStateForRestaurantFn=="function"?b.getAdsStateForRestaurantFn:(()=>({items:[],enabled:!0,loading:!1,same:!1})),ge=b.getTableQrStateForRestaurantFn,oe=b.getFocusItemObjectPositionFn,ot=b.getFocusCardClassFn,aa=b.getFocusIndexFn,ne=b.isRestaurantCafeProfileFn,me=typeof b.getBusinessProfileTypeFn=="function"?b.getBusinessProfileTypeFn:(()=>""),be=b.getRestaurantMetaByIdFn,sa=b.buildUrlFn,na=b.normalizeSearchKeyFn,ra=b.normalizeFollowHandleFn,G={key:"",inFlightKey:""},u=(e,t=e,a={})=>bs(e,{fallback:t,params:a}),lt=(e="")=>{const t=String(e||"").trim();if(!t)return u("nav.menu","Menue");const a=t.toLowerCase();return a==="menue"||a==="menu"||a==="menü"?u("nav.menu",t):a==="shop"?"Shop":t},ia=(e="food")=>String(e||"").trim().toLowerCase()==="drink"?u("menu.drinks","Getraenke"):u("menu.food","Speisen"),ct=(e={},t=!1)=>{const a=se(e?.type||"food");return t?a==="drink"?u("menu.variant","Variante"):u("menu.product","Produkt"):a==="drink"?u("menu.drinkItem","Getraenk"):u("menu.foodItem","Speise")},_e=(e="",t="#111827")=>{const a=String(e||"").trim();return/^#[0-9a-fA-F]{6}$/.test(a)?a:t};function oa(e=null,t=null){return de(d,{profile:e,routePayload:t,webDirectEntry:d?.__webDirectEntry}).restaurantId}function dt(e=null,t=""){if(!e||typeof e!="object")return e;const a=String(t||"").trim();if(!a)return e;const n=String(e.canonicalRestaurantId||"").trim();return String(e.restaurantId||"").trim()===a&&n?e:{...e,restaurantId:a,...n?{canonicalRestaurantId:n}:{}}}function la(e=""){const t=String(e||"").trim();return t?de(d,{profile:d?.profileView?.profile||d?.userProfile,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:t}).focus.canRenderFocus:!1}function xe(e={}){const t=String(ea(e)||"").trim();return t?at(e?.price,t):at(e?.price)}function ca(e=[],t="",a=""){const n=String(t||"").trim(),r=String(a||"").trim();if(!n||!r)return"";const i=Array.isArray(e)?e:[];if(!i.length)return`${n}|${r}|empty`;const o=[];return i.forEach(l=>{const c=String(pe(l)||l?.id||"").trim();c&&o.push(c)}),o.length?(o.sort(),`${n}|${r}|${o.join(",")}`):`${n}|${r}|empty`}function da(e=[],t=""){const a=String(d.user?.uid||"").trim(),n=ca(e,t,a);n&&G.inFlightKey!==n&&G.key!==n&&(G.key=n,G.inFlightKey=n,Qt(e,t).catch(r=>{console.error(r),G.key===n&&(G.key="")}).finally(()=>{G.inFlightKey===n&&(G.inFlightKey="")}))}function ua(e={}){const t=String(e?.uid||"").trim();if(t&&d.followingTargetIds.includes(t))return!0;const a=String(e?.restaurantId||"").trim();if(a&&d.followingTargetIds.includes(a))return!0;const n=ra(e?.handle||"");return!!(n&&d.followingHandles.includes(n))}function ut(e={}){if(e?.specialEnabled===!0)return!0;if(e?.specialEnabled===!1)return!1;const t=String(e?.restaurantId||"").trim();if(!t)return!1;const a=typeof be=="function"&&be(t)||null;return a?.specialEnabled===!0?!0:(a?.specialEnabled===!1,!1)}function pa(e={}){return Y(e)==="testfirst_special"?!0:String(e?.category||"").trim().toLowerCase()==="special"}function pt(e,t,a=!0,{includeImageKey:n=!0}={}){const r=Ut(e),i=e.id?String(e.id):"",o=i?`data-open-post="${s(i)}"`:"",l=i?`data-post-like-count="${s(i)}"`:"",c=i?`data-post-comment-count="${s(i)}"`:"",p=n&&i?`data-img-key="profile-post:${s(i)}"`:"",g=e.type==="wide"||e.type==="hero",m=t&&g?"col-span-2":"",v=t&&g?"aspect-[1.8/1]":"aspect-[4/5]",h=B(e.url,g?"large":"medium",{stableKey:i?`profile-post:${i}`:"",variantGroup:"post-detail"}),$=g?800:400,I=g?400:500;return`
  ...
  `}function Fa(e=[],t=""){const a=String(t||"").trim(),n=new Set(e.map(Q));return`
  ...
  `}function mt(e={}){const t=Ee(e),a=ba(t),n=H(t,["address","primaryAddress","location","formattedAddress","street"]),r=H(t,["city","locationCity","primaryCity","region","country"]),i=H(t,["beachDistance","distanceToBeach","beachDistanceLabel","strandEntfernung"]),o=H(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),l=H(t,["rating","reviewRating","stars","hotelStars"]),c=H(t,["reviewCount","reviewsCount","ratingsCount","commentsCount"]),p=ya(t),g=a?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${a.lat},${a.lng}`)}`:n||r?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${n} ${r}`.trim())}`:"";return`
    <div class="app-content-inline flex flex-col gap-4 app-main-content-safe animate-in fade-in duration-300">
    ...
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      ...
      ${a?`
        ...
        <div data-hotel-card-editor="${s(a)}" data-hotel-card-details-panel class="${k?"":"hidden "}bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
            ...
            <div class="grid grid-cols-1 gap-4">
              ${gt({idPrefix:"hotelCardDistanceCenter",iconName:"navigation",label:"Qendra",value:$,directLabel:ka,direct:P})}
            ...
            <div class="grid grid-cols-1 gap-4">
              ...
              ${Be({id:"hotelCardFeatureTwoText",iconName:"waves",label:"Shezlongë",value:m,options:Sa})}
...
`))}</textarea>
  ...
  `}function Ue(e=d.profileView?.profile||d.userProfile,{disabled:t=!1}={}){const a=$e(e);return a==="checkins"||a==="menu"?"":`
  ...
  `}function yt(e={},t={}){const a=t.mode==="self"?"self":"public",n=t.disabledBlockClass||"",r=Na(e,a),i=_(t.avatarUrl||""),o=_(e?.avatar||""),l=o?B(o,"avatar"):"",c=i||l,p=t.avatarFit||Le(!!e.restaurantId),g=String(d?.profileCardInfoOpen||"")===r,m=Number(d?.profileCardInfoHeights?.[r]||0),v=g&&Number.isFinite(m)&&m>0?`height:${Math.ceil(m)}px;`:"",h=t.avatarImgKeyAttr||(a==="self"?'data-img-key="avatar:self"':`data-img-key="avatar:public:${s(r)}"`),$=!!_(c)&&!D(c),I=typeof t.renderAvatarImage=="boolean"?t.renderAvatarImage&&$:$,y=!!t.identityPending,P=t.followersLabel??E(e.followers),w=_(e?.name)||"User",k=_(t.typeLabel||e?.customerType||e?.type||"Business"),S=_(e?.location||"-"),C=a==="public"?`${S} / ${k}`:S,T=t.bioHtml||s(e?.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),L=`business-cover:${r}`,z=Ea(e,r),R=Ha(e,{cacheKeys:z,stableKey:L,allowCacheFallback:t.allowTitleImageCacheFallback===!0}),A=Oa(e),x=wt(e?.instagramUrl||e?.instagram||e?.insta||"","instagram"),F=wt(e?.tiktokUrl||e?.tiktok||e?.tikTok||"","tiktok"),j=_(e?.phone||e?.telephone||e?.contactPhone||""),M=Da(j),N=_(e?.address||e?.locationLabel||[e?.place||e?.locationPlace,e?.location||e?.city].map(X=>_(X)).filter(Boolean).join(", ")),Z=[ke({href:x,iconName:"instagram",eyebrow:"Instagram",value:e?.instagram||e?.instagramUrl||e?.insta||""}),ke({href:F,iconName:"music-2",eyebrow:"TikTok",value:e?.tiktok||e?.tiktokUrl||e?.tikTok||""})].filter(Boolean).join(""),J=a==="self"?`
    ...
    `;if(g){const X=[ke({href:M,iconName:"phone",eyebrow:u("profile.call","Anrufen"),value:j}),ke({href:A,iconName:"map-pin",eyebrow:u("profile.address","Adresse"),value:N||S}),Z].filter(Boolean).join("");return`
      <div data-landing-tutorial-target="identity" data-business-profile-card="${s(r)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${n}" style="${v}min-height: var(--business-profile-card-min-height, 440px);display:grid;grid-template-columns:minmax(0,1fr);width:100%;max-width:100%;min-width:0;box-sizing:border-box;">
        ${Va({profileName:w,safeBio:T,metaLine:C,identityPending:y,followersLabel:P})}
  ...
  `}function Ie(e={},t=[],{topTabOverride:a="",tutorialMode:n=!1,contentTabOverride:r="",landingHideContent:i=!1,collapseIdentity:o=!1,contentReveal:l=!1,landingMode:c=!1}={}){const p=ua(e),g=!!e.privateAccount&&e.uid&&String(e.uid)!==String(d.user?.uid||"")&&!p,m=!!e.pendingFollowRequest&&!p,v=e.restaurantId?"Business":u("nav.user","User"),h=String(e.handle||Ze(e.name||"user")).replace(/^@/,""),I=s(e.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),y=he(e),P=String(a||Re(e)).trim().toLowerCase()||"profile",w=String(r||$e(e)).trim().toLowerCase()||"posts",k=w==="menu",S=w==="checkins",C=t,L={...d?.profileView&&typeof d.profileView=="object"?d.profileView:{},profile:e,posts:Array.isArray(C)?C:[]},z=xs(d,{profileView:L,profileTopTab:P,profileContentTab:w}),R=String(z?.header?.status||"").trim().toLowerCase()||"loading",A=String(z?.posts?.status||"").trim().toLowerCase()||"loading",x=String(e?.avatar||"").trim(),F=x?B(x,"avatar"):"",j=Le(!!e.restaurantId),M=e.canonicalRestaurantId||e.restaurantId||e.uid||h||"public",N=c?"":`data-img-key="avatar:public:${s(M)}"`,Z=!!x,J=Ye=>{if(Ye==null)return!1;const Nt=Number(Ye);return Number.isFinite(Nt)&&Nt>=0},X=Z||J(e?.followers)||J(e?.following),K=Te(R)&&!X,Pe=!!String(F||"").trim()&&Z,ee=K?"...":E(e.followers),Fe=K?"...":E(e.following),je=y?"pt-2":"pt-10",ce=p?u("profile.following","Following"):m?u("profile.requested","Requested"):g?u("profile.request","Request"):u("profile.follow","Follow"),O=p?"bg-slate-100 text-slate-600 shadow-none border border-slate-200":m?"bg-amber-50 text-amber-700 shadow-none border border-amber-200":"bg-gradient-to-r from-slate-900 to-slate-800 text-white border border-transparent",us=n?"select-none":"app-main-content-safe",ae=n?"pointer-events-none":"",ps=!o,Bt=!i,Ae=l?c?"transition-opacity duration-200":"animate-in fade-in duration-300":"",Rt=w==="posts"&&C.length>0,fs=w!=="posts"||Rt||A==="empty"||A==="error",gs=w==="posts"&&!Rt&&A==="error";return!n&&(w==="posts"||w==="media")&&e?.restaurantId&&Te(A)&&Ot(e),`
    <div class="${us}" ${n?'data-landing-tutorial-surface="true"':""}>
      ${P==="profile"||P==="menu"?`
      ${ps?`
        <div class="app-content-inline pb-2 ${je}">
          ${y?yt(e,{mode:"public",disabledBlockClass:ae,avatarUrl:F,avatarFit:j,avatarImgKeyAttr:N,renderAvatarImage:Pe,identityPending:K,followersLabel:ee,followLabel:ce,followTone:O,isFollowing:p,hasPendingFollowRequest:m,isLocked:g,bioHtml:I,typeLabel:v,allowTitleImageCacheFallback:Te(R)||Te(A)}):`
              ...
              <div class="flex justify-between items-start mb-8">
                <div class="relative">
                  <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500">
                    ${Pe?`<img src="${s(F)}" decoding="async" width="100" height="100" ${N} class="w-full h-full rounded-[1.8rem] ${j} border-2 border-white" />`:`<div class="w-full h-full rounded-[1.8rem] border-2 border-white bg-slate-100 flex items-center justify-center ${K?"animate-pulse":""}">${f(e.restaurantId?"store":"user","w-8 h-8 text-slate-300")}</div>`}
                  </div>
                  ${e.isPremium?`
                    <div class="absolute -bottom-1 -right-1 bg-white rounded-full p-1.5 shadow-lg text-blue-500 border-2 border-slate-50">
                      ${f("badge-check","w-4 h-4 fill-blue-500 text-white")}
                ...
                <div class="flex items-center gap-6 pt-3 pr-2">
                   <div data-landing-tutorial-target="fans" class="flex flex-col items-center">
                      <span class="font-black text-2xl ${K?"text-slate-300":"text-slate-900"} leading-none mb-1">${s(ee)}</span>
                      <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest opacity-80">${s(u("profile.fans","Fans"))}</span>
                   </div>
                   <div class="w-px h-8 bg-slate-100"></div>
                   <div class="flex flex-col items-center">
                      <span class="font-black text-2xl ${K?"text-slate-300":"text-slate-900"} leading-none mb-1">${s(Fe)}</span>
      ...
      `:`
        ...
        `:`
          ${fs?`
            ...
            `:`
              <div class="${d.profileViewMode==="grid"?"grid grid-cols-2 gap-4 app-content-inline grid-flow-dense":"flex flex-col gap-8 app-content-inline"} ${ae} ${Ae}">
  ...
  `}function Ka(){const e=d.profileView;if(!e||!e.profile)return"";const t=e.profile,a=e.posts||t.posts||[],n=Re(t);return n==="landing"?za(t):Ie(t,a,{topTabOverride:n,tutorialMode:!1})}function $t(e,{filter:t="all",query:a=""}={}){const n=Array.isArray(e)?e:[],r=na(a||"");return n.filter(i=>t==="all"||se(i.type)===t?r?`${i.name||""} ${i.category||""} ${i.description||""}`.toLowerCase().includes(r):!0:!1)}function kt(e,t=0){const a=Number(e);return Number.isFinite(a)?Math.max(0,Math.floor(a)):Math.max(0,Number(t)||0)}function Se(e=[]){return(Array.isArray(e)?e.slice():[]).map((a,n)=>({item:a,idx:n,order:kt(a?.orderIndex,n)})).sort((a,n)=>a.order-n.order||a.idx-n.idx).map((a,n)=>({...a.item,orderIndex:kt(a.item?.orderIndex,n)}))}function De(e={}){const t=String(e?.menuVisibility||"").trim().toLowerCase();return e?.menuHidden===!0||t==="hidden"}function le(e={}){const t=String(e?.menuSection||e?.displaySection||e?.menuPlacement||"").trim().toLowerCase();return t==="drink"?"drink":t==="food"?"food":se(e?.type||"food")==="drink"?"drink":"food"}function qa(e={}){return String(e?.category||u("menu.other","Sonstiges")).trim()||u("menu.other","Sonstiges")}function Ga(e=""){const t=String(e||"").trim().toLowerCase();return t?(typeof t.normalize=="function"?t.normalize("NFD").replace(/[\u0300-\u036f]/g,""):t).replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""):""}const Qa=4,Wa={thumb:160,small:480,medium:768,large:1280};function It({mode:e="profile",priorityIndex:t=-1,slideIndex:a=0}={}){return(e==="profile"||e==="landing")&&Number.isFinite(t)&&t>=0&&t<Qa&&a===0}function Ya({mode:e="profile",priorityIndex:t=-1,slideIndex:a=0}={}){const n=It({mode:e,priorityIndex:t,slideIndex:a}),r=e==="profile"?' data-image-reveal="menu"':"";return n?`loading="eager" fetchpriority="high"${r}`:`loading="lazy" fetchpriority="low"${r}`}function Za({variant:e="grid"}={}){return e==="thumb"?"(max-width: 640px) 64px, 64px":e==="hero"?"(max-width: 640px) 94vw, (max-width: 1200px) 74vw, 920px":"(max-width: 640px) 48vw, (max-width: 1200px) 28vw, 360px"}function W(e,{mode:t="profile",priorityIndex:a=-1,slideIndex:n=0,stableKey:r="",preferredSize:i="small",candidateSizes:o=["small","medium","large"],variant:l="grid"}={}){const c=String(e||"").trim(),p=t==="profile"&&r?{stableKey:r}:null,g=It({mode:t,priorityIndex:a,slideIndex:n}),m=t==="profile"&&!g&&l!=="thumb",v=B(c,i,p),h=D(v)?U:v,$=Jt(c),I=Xt(c)&&c!==h?c:$,y=[],P=new Set;o.forEach(x=>{const F=Wa[x]||0;if(!F)return;const j=B(c,x,p);if(!j||D(j))return;const M=`${j}|${F}`;P.has(M)||(P.add(M),y.push(`${j} ${F}w`))});const w=y.length>1?y.join(", "):"",k=w?Za({variant:l}):"",S=m?"":w,C=m?"":k,T=S?` srcset="${s(S)}"`:"",L=C?` sizes="${s(C)}"`:"",z=Ya({mode:t,priorityIndex:a,slideIndex:n}),R=`${z}${T}${L}`,A=m?[`data-menu-lazy-src="${s(h)}"`,`data-menu-lazy-fallback="${s(I||U)}"`,w?`data-menu-lazy-srcset="${s(w)}"`:"",k?`data-menu-lazy-sizes="${s(k)}"`:""].filter(Boolean).join(" "):"";return{safeImg:m?U:h,fallbackImg:m?U:I,imageAttrs:R,lazyAttrs:A?` ${A}`:"",srcsetValue:w,sizesValue:k,loadingAttrs:z}}function re(e=[],t,a=null){const n=a instanceof Set?a:new Set;return e.map((r,i)=>{const o=qa(r),l=Ga(o),c=!!l&&!n.has(l);return c&&n.add(l),`<div${c?` data-menu-category-anchor="${s(l)}"`:""} class="h-full">${t(r,i)}</div>`}).join("")}function Oe(e={}){return String(e?.specialSize||e?.specialCardSize||"").trim().toLowerCase()==="food"?"food":"default"}function Ja(e=""){const t=String(e||"").trim();return t?/^(https?:\/\/|mailto:|tel:)/i.test(t)?t:`https://${t.replace(/^\/+/,"")}`:""}function St(e={}){const t=String(e?.specialActionType||e?.actionType||"").trim().toLowerCase(),a=Ja(e?.specialActionUrl||e?.linkUrl||e?.actionUrl||""),n=String(e?.specialActionProductId||e?.targetProductId||"").trim();return t==="link"&&a?{type:"link",url:a,productId:""}:t==="product"&&n?{type:"product",url:"",productId:n}:{type:"self",url:"",productId:""}}function Ct(){const e=d.menu.filter||"all";return`
    <div class="flex gap-2 mb-5">
      ${(te(d.userProfile)?[{id:"all",label:u("menu.all","Alle")},{id:"food",label:u("menu.products","Produkte")},{id:"drink",label:u("menu.variants","Varianten")}]:[{id:"all",label:u("menu.all","Alle")},{id:"food",label:u("menu.food","Speisen")},{id:"drink",label:u("menu.drinks","Getraenke")}]).map(n=>`
  ...
  `}function Ke(e,{mode:t="profile",variant:a="food",priorityIndex:n=-1}={}){const r=q(e),i=t==="profile"?ie(e,{index:0}):"",o=a==="drink",{safeImg:l,fallbackImg:c,imageAttrs:p,lazyAttrs:g}=W(r,{mode:t,priorityIndex:n,stableKey:i,preferredSize:o?"small":"medium",candidateSizes:o?["small","medium"]:["small","medium","large"],variant:o?"grid":"hero"}),m=xe(e),v=d.activeTab==="menu"?d.userProfile:d.profileView?.profile||d.userProfile,h=te(v),$=ct(e,h),I=e.category||"",y=e.description||"",P=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",w=d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"",k=pe(e),S=nt(w,k),C=S?rt(S):{likes:[],comments:[],counts:{likes:0,comments:0}},T=it(C),L=`
  ...
  `}function qe(e={}){if(!e?.restaurantId||te(e))return!1;const t=String(me(e)||"").trim().toLowerCase();return t==="restaurant"||t==="cafe"||t==="fastfood"}function es(e={},{items:t=[],menuSurfaceState:a=null,mode:n="profile"}={}){if(qe(e))return!0;const r=String(n||"profile").trim().toLowerCase();if(r!=="profile"&&r!=="landing"||!e?.restaurantId||te(e))return!1;const i=String(me(e)||"").trim().toLowerCase();if(i==="hotel"||i==="motel"||i==="ecommerce")return!1;const o=a?.menu&&typeof a.menu=="object"?a.menu:{},l=Array.isArray(o.items)?o.items:[];return String(o.source||"").trim().toLowerCase()==="public"&&o.status==="ready"&&(Array.isArray(t)&&t.length>0||l.length>0)&&!i}function Pt(e){const t=e?.restaurantId||d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"",a=pe(e),n=nt(t,a),r=n?rt(n):{likes:[],comments:[],counts:{likes:0,comments:0}},i=String(d.user?.uid||"").trim(),o=String(d.user?.handle||"").trim().toLowerCase(),l=!!r.likes?.some(c=>{const p=String(c?.uid||"").trim();if(i&&p&&p===i)return!0;const g=String(c?.handle||"").trim().toLowerCase();return!!o&&!!g&&g===o});return{itemId:a,meta:r,counts:it(r),isLiked:l}}function ie(e,{index:t=0}={}){const a=String(e?.restaurantId||d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"").trim(),n=String(e?.id||pe(e)||"").trim();if(!a||!n)return"";const r=Number(t),i=Number.isFinite(r)?Math.max(0,Math.floor(r)):0;return`menu-detail:${a}:${n}:${i}`}function ts(e){const t=typeof st=="function"?st(e):[],a=Array.isArray(t)?t.filter(Boolean):[];if(a.length)return a;const n=q(e);return n?[n]:[]}function Y(e){return hs(e?.cardStyle||"",se(e?.type||"food"))}function Ge(e,{menuItemId:t=""}={}){if(!e)return null;const a=String(t||e.menuItemId||e.itemId||e.productId||"").trim();return{id:e.id||"",title:e.name||e.title||"Sot ne Fokus",text:e.description||e.text||"",imageUrl:q(e)||e.imageUrl||"",objectPosition:e.objectPosition||V(e),menuItemId:a}}function Ft(e,t=[],{mode:a="profile",force:n=!1}={}){const r=e?.restaurantId||"";return!r||!n&&!qe(e)||!t.length?"":`
    <div class="pt-2 pb-4">
      <div class="flex gap-4 overflow-x-auto hide-scrollbar snap-x horizontal-safe-scroll pb-4">
        ${t.map((i,o)=>{const l=i.imageUrl||"",c=String(i.menuItemId||i.id||"").trim(),{safeImg:p,fallbackImg:g,imageAttrs:m,lazyAttrs:v}=W(l,{mode:a,priorityIndex:o,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:c?`menu-focus:${r}:${c}`:""}),h=String(i.menuItemId||"").trim(),$=a==="profile"&&h?`data-menu-open="${s(h)}" role="button"`:"";return`
  ...
  `}function jt(e,{mode:t="profile",priorityIndex:a=-1}={}){const n=q(e),r=t==="profile"?ie(e,{index:0}):"",{safeImg:i,fallbackImg:o,imageAttrs:l,lazyAttrs:c}=W(n,{mode:t,priorityIndex:a,stableKey:r,preferredSize:"small",candidateSizes:["small","medium"],variant:"grid"}),p=xe(e),g=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",{itemId:m,counts:v,isLiked:h}=Pt(e);return`
  ...
  `}function At(e,{mode:t="profile",priorityIndex:a=-1}={}){const n=xe(e),r=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",i=ts(e),l=(i.length?i:[q(e)||""]).filter(Boolean),c=l.length?l.slice(0,12):[""],p=c.length>1,{itemId:g,counts:m,isLiked:v}=Pt(e),h=E(Math.max(0,Number(m.likes)||0)),$=E(Math.max(0,Number(m.comments)||0));return`
    <div ${r} class="bg-white p-3.5 rounded-[2.2rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-5 group relative ${t==="profile"?"cursor-pointer":""}" style="padding:14px;border-radius:2.2rem;margin-bottom:20px;box-sizing:border-box;">
      <div class="w-full aspect-[16/9] rounded-[1.8rem] overflow-hidden bg-slate-100 mb-4 relative" style="aspect-ratio:16 / 9;border-radius:1.8rem;margin-bottom:16px;">
        ${p?`
          ...
          >
            ${c.map((I,y)=>{const P=t==="profile"?ie(e,{index:y}):"",w=W(I||"",{mode:t,priorityIndex:a,slideIndex:y,stableKey:P,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"}),k=y>0,S=k?U:w.safeImg,C=k?U:w.fallbackImg,T=k?w.loadingAttrs:w.imageAttrs,L=k?"":w.lazyAttrs||"",z=k?` data-menu-card-deferred-src="${s(w.safeImg)}"
        ...
        `:`
          ${c.map((I,y)=>{const P=t==="profile"?ie(e,{index:y}):"",{safeImg:w,fallbackImg:k,imageAttrs:S,lazyAttrs:C}=W(I||"",{mode:t,priorityIndex:a,slideIndex:y,stableKey:P,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"});return`
  ...
  `}function ss(e,t,{mode:a="profile",publicMenuSurfaceState:n=null,forceModernCards:r=!1}={}){const i=Se(Array.isArray(t)?t:[]),o=String(e?.restaurantId||"").trim(),l=a==="admin"||la(o),c=n?.focus?.canRenderFocus?{items:Array.isArray(n.focus.items)?n.focus.items:[],enabled:!0}:o&&l?fe(o):{items:[],enabled:!1},p=c.enabled?(Array.isArray(c.items)?c.items:[]).map(x=>Ge({...x,objectPosition:oe(x)})):[],g=i.filter(x=>Y(x)==="testfirst_focus"&&!De(x)).map(x=>Ge(x,{menuItemId:x.id||""})).filter(Boolean),m=new Set,v=[...p,...g].filter(x=>{const F=String(x.menuItemId||x.id||`${x.title}|${x.text}|${x.imageUrl}`);return!F||m.has(F)?!1:(m.add(F),!0)}),h=i.filter(x=>!De(x)),$=h.filter(x=>Y(x)!=="testfirst_focus"),I=$.length?$:h,y=$.length?v:[],P=I.filter(x=>le(x)==="drink"),w=I.filter(x=>le(x)!=="drink"),k=(x=[])=>{const F=[],j=[];return x.forEach(M=>{const N=Y(M);N==="testfirst_food"||N==="testfirst_special"&&Oe(M)==="food"?j.push(M):F.push(M)}),{gridItems:F,foodItems:j}},S=(x,F=-1)=>Y(x)==="testfirst_special"?Qe(x,{mode:a,priorityIndex:F}):jt(x,{mode:a,priorityIndex:F});let C=0;const T=()=>{const x=C;return C+=1,x},L=new Set,z=(x,F)=>!F.gridItems.length&&!F.foodItems.length?"":`
        ...
        ${F.foodItems.length?`
          <div class="menu-category-section pb-6 pt-4" data-menu-type="${s(x)}">
            <div class="app-content-inline">
              ${re(F.foodItems,j=>{const M=Y(j),N=T();return M==="testfirst_special"?Qe(j,{mode:a,size:"food",priorityIndex:N}):At(j,{mode:a,priorityIndex:N})},L)}
            </div>
          </div>
        `:""}
      </section>
  ...
  `}function Tt(e,{mode:t="profile",useTestfirstCardUi:a=!1,seenCategories:n=null,priorityOffset:r=0}={}){return e.length?a?`
      <div class="grid grid-cols-2 auto-rows-fr gap-3">
        ${re(e,(i,o)=>jt(i,{mode:t,priorityIndex:r+o}),n)}
      </div>
    `:`
    <div class="grid grid-cols-2 auto-rows-fr gap-4">
      ${re(e,(i,o)=>Ke(i,{mode:t,variant:"drink",priorityIndex:r+o}),n)}
    </div>
  `:""}function Lt(e,{mode:t="profile",useTestfirstCardUi:a=!1,seenCategories:n=null,priorityOffset:r=0}={}){return e.length?a?`
      <div>
        ${re(e,(i,o)=>Y(i)==="testfirst_special"&&Oe(i)==="food"?Qe(i,{mode:t,size:"food",priorityIndex:r+o}):At(i,{mode:t,priorityIndex:r+o}),n)}
      </div>
    `:`
    <div class="space-y-4">
      ${re(e,(i,o)=>Ke(i,{mode:t,variant:"food",priorityIndex:r+o}),n)}
    </div>
  `:""}function _t(e,{mode:t="profile"}={}){if(t==="admin"){const a=String(d?.menu?.filter||"all").trim().toLowerCase(),n=e.filter(c=>se(c?.type)==="drink"),r=e.filter(c=>se(c?.type)!=="drink"),i=(c,p,{addType:g=""}={})=>`
      <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
        <div class="flex items-center justify-between mb-4">
          <div>
  ...
  `:`
    ...
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(h=>{const $=B(h.imageUrl||"","thumb"),I=D($)?U:$,y=h.active!==!1?"Aktiv":"Inaktiv",P=h.active!==!1?"text-emerald-600":"text-slate-400";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function zt(e={}){if(!e?.restaurantId)return!1;const t=String(me(e)||"").trim().toLowerCase();return["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"].includes(t)?!1:te(e)||ne(e)||["restaurant","cafe","coffee","fastfood","food","ecommerce"].includes(t)||!t}function ns(e={}){if(e.active===!1)return{label:"Inaktiv",className:"text-slate-400"};const t=String(e.status||e.approvalStatus||"pending").trim().toLowerCase();return t==="approved"?{label:"Freigegeben",className:"text-emerald-600"}:t==="rejected"?{label:"Abgelehnt",className:"text-rose-600"}:{label:"Wartet auf Heart",className:"text-amber-600"}}function rs(e,t){if(!t||!zt(e))return"";const{items:a,loading:n}=ta(t,{includeInactive:!0}),r=E(a.length);return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(i=>{const o=B(i.imageUrl||"","thumb"),l=D(o)?U:o,c=ns(i),p=i.category||"RESTAURANT",g=i.priceSegment||"€€ - €€€";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function is(e){if(!qe(e)||!ut(e))return"";const a=Se((d.menu.items||[]).filter(n=>Y(n)==="testfirst_special"));return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(n=>{const r=B(q(n),"thumb"),i=D(r)?U:r,o=St(n),l=o.type==="link"?"Link":o.type==="product"?"Produkt-Modal":"Diese Karte",c=Oe(n)==="food"?"Food-Size":"Normal",p=ia(le(n));return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function Mt(e,{restaurantId:t="",suppressLoading:a=!1,allowAutoEnsure:n=!0,requirePublicMenuTruth:r=!0}={}){const i=String(t||e?.canonicalRestaurantId||e?.restaurantId||"").trim();if(!i||!ne(e))return"";const o=de(d,{profile:e,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:i});if(r&&o.menu.status!=="ready")return"";const l=!r||o.focus.canRenderFocus;if(n&&!d.focus.loading&&!l&&ue(dt(e,i)),r&&!l)return"";const{items:c,loading:p}=l?{items:Array.isArray(o.focus.items)?o.focus.items:[],loading:o.focus.loading}:fe(i);if(!(l?!0:fe(i).enabled)||!c.length&&!p||a&&p&&!c.length)return"";if(p&&!c.length)return`
    ...
    `;const m=aa(c),v=c[m]||c[0],{safeImg:h,fallbackImg:$,imageAttrs:I,lazyAttrs:y}=W(v.imageUrl||"",{mode:"profile",priorityIndex:0,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:v?.id?`focus-carousel:${i}:${String(v.id)}`:""}),P=v.text||"";return`
    <div id="focusCarousel" class="${ot()} rounded-[2.5rem] p-6 border shadow-sm">
      ...
      <div class="relative rounded-[2rem] overflow-hidden border border-slate-100 bg-slate-50">
        <img data-focus-image src="${s(h)}" data-fallback-src="${s($)}"${y} class="w-full h-56 object-cover" style="object-position:${oe(v)};" ${I} decoding="async" />
      </div>
      <div class="mt-4">
  ...
  `}function ls({profile:e,restaurantId:t,catalogLabel:a}){if(!t||!ne(e))return"";if(typeof et=="function"){const i=ge?ge(t):null;(!i||i.sameRestaurant!==!0||!i.loading&&!i.loaded&&!i.error)&&et(e)}const n=typeof ge=="function"?ge(t):{enabled:!0,count:0,tables:[],loading:!1,saving:!1,error:""},r=(n.tables||[]).map(i=>{const o=sa("apps/menyra-social/index.html",{r:t,tab:"menu",source:"qr",table:i});return Et({label:`Tisch ${i}`,url:o,caption:`${a} fuer Tisch ${i}`})}).join("");return`
  ...
  `}function cs(){const e=d.userProfile,t=e.restaurantId||"",a=String(d.user?.uid||"").trim(),n=String(d.__authBootstrapInFlightUid||"").trim(),r=!t&&!!a&&(!!d.__authProfileLoadPromise||n===a),i=ve(e),o=ne(e),l=d.profileView?.profile?.restaurantId?d.profileView.profile:null,c=Dt()&&!!l?.restaurantId&&ne(l),p=lt(tt(e)),g=t?be(t):null,m=g?.name||g?.restaurantName||e.name||"Business",v=t&&d.menu.restaurantId===t,h=String(d.menu.source||"").trim().toLowerCase(),$=!!v&&h==="collection",I=!!v&&h==="collection"&&d.menu.loading,y=!!t&&(I||!$),P=$?$t(d.menu.items,{filter:d.menu.filter,query:d.menu.query}):[],k=ut(e)?P:P.filter(T=>!pa(T)),S=Se(k),C=E(S.length);if(t&&i){ma(e);const T=String(d.focus?.truthSource||"").trim().toLowerCase();return!d.focus.loading&&(d.focus.restaurantId!==t||T!=="public-menu")&&ue(e),Ta(e)}return t&&o&&!$&&!I&&Kt(e),t&&o&&!d.focus.loading&&d.focus.restaurantId!==t&&ue(e),t&&zt(e)&&qt(e),o?`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      <div class="flex items-end justify-between mb-6">
        <div>
  ...
  `:c?Ce(l):`
    ...
    `;const l=dt(e,o),c=ne(l);c&&(i=de(d,{profile:l,routePayload:n,webDirectEntry:r,restaurantId:o,coordinateFocusWithMenu:!0}));const p=String(r?.canonicalRestaurantId||r?.restaurantId||"").trim(),g=new Set(i.targetIds),m=ms(i.focus.truthState||""),v=i.menu.status==="ready",h=i.focus.canRenderFocus,$=v&&c,I=i.focus.matches===!0&&i.focus.loading===!0,y=t==="landing",w=String(d?.profileView?.menuAccessSource||r?.menuAccessSource||n?.menuAccessSource||"").trim().toLowerCase()==="qr",k=r?.active===!0&&r?.webPriority===!0&&r?.menuFirst===!0&&String(d?.activeTab||"").trim().toLowerCase()==="profile"&&String(d?.profileTopTab||"").trim().toLowerCase()==="menu"&&(p===o||g.has(o)),S=k&&!w,C=["ready","empty","error"].includes(i.menu.status),T=k&&C,L=k&&(!$||i.menu.status!=="ready"),z=!$||i.focus.settled===!0||m==="knownEmpty"||i.menu.status!=="ready";a&&!T&&!C&&Vt(l),a&&!L&&!z&&!I&&v&&(!S||C)&&ue(l);const A=i.menu.canRenderItems?Se($t(i.menu.items,{filter:"all",query:""})).filter(O=>!De(O)):[],x=A.length>0,F=te(l),j=lt(tt(l)),M=i.menu.error||"",N=!!String(M||"").trim(),Z=i.menu.status==="loading"||i.menu.waitingForFocus===!0,J=A.filter(O=>le(O)==="drink"),X=A.filter(O=>le(O)!=="drink"),K=0,Pe=J.length,ee=es(l,{items:A,menuSurfaceState:i,mode:t}),Fe=new Set;x&&o&&(Gt(A,o),da(A,o));const je=o&&h?(Array.isArray(i.focus.items)?i.focus.items:[]).map(O=>Ge({...O,objectPosition:oe(O)})).filter(Boolean):[],ce=je.length?Ft(l,je,{mode:t,force:ee}):"";return y&&Z?'<div class="app-content-inline app-main-content-safe" style="min-height: 34vh;"></div>':ee?`
      <div class="app-main-content-safe">
        ...
        `:`
          ${x?ss(l,A,{mode:t,publicMenuSurfaceState:i,forceModernCards:ee}):N?`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${s(u("menu.loadError","Menu konnte nicht geladen werden"))}</div>`:ce||`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300">${s(u("menu.noProducts","Keine Produkte"))}</div>`}
            ...
            ${J.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="drink">
                ...
                <div data-menu-type="drink">
                  ${Tt(J,{mode:t,useTestfirstCardUi:ee,seenCategories:Fe,priorityOffset:K})}
                </div>
              </section>
            `:""}
            ${X.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="food">
                ...
                <div data-menu-type="food">
                  ${Lt(X,{mode:t,useTestfirstCardUi:ee,seenCategories:Fe,priorityOffset:Pe})}
                </div>
              </section>
            `:""}
          `}
