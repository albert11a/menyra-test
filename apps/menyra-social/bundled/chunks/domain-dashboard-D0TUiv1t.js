const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/business-composer-controller-B9HCTPxo.js","chunks/domain-feed-social-eager-RiaZHe-N.js","chunks/domain-auth-Aq-4Vdvh.js","chunks/domain-public-profile-mLQti0eH.js","chunks/domain-media-eager-DAUyCk2O.js","chunks/domain-menu-eager-nFsxObl9.js","chunks/profile-post-card-markup-utils-HwqIiXgP.js"])))=>i.map(i=>d[i]);
import{_ as be}from"./domain-auth-Aq-4Vdvh.js";import{f as P,r as ye,l as _e,s as G}from"./domain-analytics-BNpk5u6w.js";const ve=20,we=8;function k(e=""){return e==null?"":String(e).trim()}function N(e){if(e==null||e==="")return null;const a=Number(String(e).replace(",","."));return Number.isFinite(a)&&a>0?a:null}function ke(e=Date.now(),a=Math.random()){const t=Math.max(0,Number(e)||0).toString(36),o=Math.floor(Math.max(0,Math.min(.999999,Number(a)||0))*36**6).toString(36).padStart(6,"0");return`room_${t}_${o}`}function xe(e={}){const a=e&&typeof e=="object"?e:{},t=[...Array.isArray(a.images)?a.images:[],k(a.imageUrl??a.image??a.photoUrl)],o=[];return t.forEach(r=>{const d=k(r);d&&!o.includes(d)&&o.push(d)}),o.slice(0,we)}function Se(e={},{index:a=0}={}){const t=e&&typeof e=="object"?e:{},o=N(t.persons??t.guests??t.capacity),r=N(t.size??t.sizeSqm??t.area),d=xe(t);return{id:k(t.id)||ke(Date.now()+a),title:k(t.title??t.name),description:k(t.description??t.text).slice(0,400),imageUrl:d[0]||"",images:d,price:N(t.price??t.pricePerNight),currency:k(t.currency??t.currencyCode).toUpperCase()||"EUR",persons:o==null?null:Math.min(20,Math.round(o)),beds:k(t.beds??t.bedsLabel).slice(0,60),size:r==null?null:Math.min(500,Math.round(r)),tag:k(t.tag??t.badge).slice(0,40),active:t.active!==!1}}function Pe(e=[]){return(Array.isArray(e)?e:[]).slice(0,ve).map((a,t)=>Se(a,{index:t}))}function ze(e={}){return Pe((e&&typeof e=="object"?e:{}).hotelRooms).filter(t=>t.title)}function da(e={}){const a=[];return Number.isFinite(e?.persons)&&e.persons>0&&a.push({icon:"users",label:`${e.persons} persona`}),k(e?.beds)&&a.push({icon:"bed",label:k(e.beds)}),Number.isFinite(e?.size)&&e.size>0&&a.push({icon:"size",label:`${e.size} m²`}),a}function la(e={}){const a=Number(e?.price);if(!Number.isFinite(a)||a<=0)return"";const t=k(e?.currency).toUpperCase()||"EUR",o=Number.isInteger(a)?String(a):a.toFixed(2);return t==="EUR"?`€${o}`:`${o} ${t}`}const Z="mnyraDashboardStyles",De=`
.mnyra-dash {
...
`;function Fe(e=typeof document>"u"?null:document){if(!(!e||e.getElementById(Z)))try{const a=e.createElement("style");a.id=Z,a.textContent=De,e.head?.appendChild(a)}catch{}}function c(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function z(e,a,t=""){if(typeof e!="function")return"";try{return e(a,t)||""}catch{return""}}const Ce=Object.freeze(["hotel","motel","hostel","resort","accommodation","travel"]);function Be({businessType:e="",isShopCatalog:a=!1}={}){if(a)return"shop";const t=String(e||"").trim().toLowerCase();return Ce.includes(t)?"hotel":"restaurant"}function Re({kind:e="restaurant",isOwner:a=!1}={}){const t=[];return e==="hotel"?t.push({nav:"menu",iconName:"bed-double",label:"Hotel & Dhoma",sub:"Detaje, dhoma, oferta"}):e==="shop"?t.push({nav:"menu",iconName:"shopping-bag",label:"Ndrysho dyqanin",sub:"Produkte & Stok"}):t.push({nav:"menu",iconName:"utensils",label:"Ndrysho menune",sub:"Produkte & Kategorien"}),t.push({nav:"menu",iconName:"megaphone",label:"Oferta & Reklama",sub:"Im Editor verwalten"}),a&&t.push({nav:"businessAccounts",iconName:"users-round",label:"Team & Staff",sub:"Zugänge verwalten"}),t.push({nav:"settings",iconName:"settings",label:"Cilesimet",sub:"Profili & Kontakti"}),t}function $e(e="restaurant"){const a=[{key:"profileViews",label:"Profilaufrufe"},{key:"postImpressions",label:"Shtrirja e postimeve"},{key:"contactClicks",label:"Kontakt-Klicks"}];return e==="shop"?a.concat([{key:"ordersCompleted",label:"Porosite"},{key:"revenue",label:"Umsatz",unit:"€"},{key:"productViews",label:"Produkt-Aufrufe"}]):e==="hotel"?a.concat([{key:"uniqueVisitors",label:"Vizitore"},{key:"postLikes",label:"Likes"},{key:"feedImpressions",label:"Shtrirja ne feed"}]):a.concat([{key:"ordersCompleted",label:"Porosite"},{key:"revenue",label:"Umsatz",unit:"€"},{key:"qrScans",label:"QR-Scans"}])}function W(e=0,a=""){const t=P(e);return a?`${t} ${a}`:t}function je(e=new Date().getHours()){const a=Number.isFinite(Number(e))?(Math.trunc(Number(e))%24+24)%24:12;return a>=5&&a<=10?{dayPart:"mengjes",text:"Ju urojmë një mëngjes të mbarë!"}:a>=11&&a<=17?{dayPart:"dite",text:"Ju urojmë një ditë të mbarë!"}:a>=18&&a<=21?{dayPart:"mbremje",text:"Ju urojmë një mbrëmje të mbarë!"}:{dayPart:"nate",text:"Ju urojmë një natë të mbarë!"}}function Ke({name:e="",logoUrl:a="",hour:t=new Date().getHours(),iconFn:o}={}){const r=je(t),d=c(e||"Business");return`
    <div class="mnyra-dash__greet">
      <p class="mnyra-dash__greet-title">
        ...
        <span class="mnyra-dash__greet-logo">
          ${a?`<img src="${c(a)}" alt="${d}" title="${d}" loading="lazy" decoding="async" onerror="this.style.display='none'" />`:`<span class="mnyra-dash__greet-logo-fallback" title="${d}">${z(o,"store","w-4 h-4")}</span>`}
        </span>
      </p>
  ...
  `}function Ue({actions:e=[],iconFn:a}={}){return`<div class="mnyra-dash__actions">${(Array.isArray(e)?e:[]).map(o=>`
      <button type="button" class="mnyra-dash__action" data-nav="${c(o.nav)}">
        <span class="mnyra-dash__action-icon">${z(a,o.iconName,"w-4 h-4")}</span>
        <span>
    ...
    `).join("")}</div>`}function Me({cards:e=[],iconFn:a}={}){const t=(Array.isArray(e)?e:[]).filter(r=>r&&r.key);return t.length?`
    <div class="mnyra-dash__hl" data-dashboard-metrics>
      ...
      <span class="mnyra-dash__hl-plate">${z(a,r.iconName||"image","w-6 h-6")}</span>
      ${r.imageUrl?`<img class="mnyra-dash__hl-media" src="${c(r.imageUrl)}" alt="" ${_} decoding="async" onerror="this.style.display='none'" />`:""}
    `,x=r.withEye?`<span class="mnyra-dash__hl-eye">${z(a,"eye","w-4 h-4")}</span>`:"",h=r.locked?`<span class="mnyra-dash__hl-lock">${z(a,"lock","w-3 h-3")}Me pagesë</span>`:r.loading?'<span class="mnyra-dash__hl-value mnyra-dash__hl-value--pending" aria-hidden="true"></span>':`<span class="mnyra-dash__hl-value">${x}${c(r.value||"0")}</span>`,b=r.locked?`class="mnyra-dash__hl-card mnyra-dash__hl-card--locked" data-dashboard-metric-locked="${c(r.key)}"`:`class="mnyra-dash__hl-card"${r.nav?` data-nav="${c(r.nav)}"`:""}`,I=r.locked?`${m} – me pagesë`:`${m} ${r.value||""}`.trim();return`
      <button type="button" ${b} data-dashboard-metric="${c(r.key)}" aria-label="${c(I)}">
        ${v}
  ...
  `}function Ne({kpiDefs:e=[],week:a={},today:t={}}={}){return`
    ...
    <div class="mnyra-dash__kpi">
      ...
      <p class="mnyra-dash__kpi-value">${c(W(a?.[r.key]||0,r.unit||""))}</p>
      <p class="mnyra-dash__kpi-today">Heute: ${c(W(t?.[r.key]||0,r.unit||""))}</p>
    </div>
  `).join("")}</div>
    </div>
  `}function Te({posts:e=[],iconFn:a}={}){const t=Array.isArray(e)?e:[];let o="";return t.length?(o=t.map(r=>{const d=[r.dateLabel,`${P(r.likesCount||0)} Likes`,`${P(r.commentsCount||0)} Kommentare`];return Number(r.impressions||0)>0&&d.push(`${P(r.impressions)} shtrirje (7 dite)`),`
        <div class="mnyra-dash__post">
          <div class="mnyra-dash__post-thumb">
            ${r.thumbUrl?`<img src="${c(r.thumbUrl)}" alt="" loading="lazy" decoding="async" onerror="this.style.display='none'" />`:z(a,r.mediaType==="video"?"play":"image","w-5 h-5")}
          </div>
  ...
  `}const Ve="menyra_social_dashboard_cache_v1::",Q="menyra_social_composer_products_v1::",qe=2500,Ge=1200,Ze=6,We=3,Je=Object.freeze({menuImageUrl:"/apps/menyra-social/assets/panel/menu-scan.jpg",qrImageUrl:"/apps/menyra-social/assets/panel/qr-stand.jpg"}),Qe=Object.freeze({menuOpens:"Menü-Aufrufe",qrScans:"QR-Scans"});function f(e){const a=Number(e);return Number.isFinite(a)?a:0}function Ye(e={}){const a=String(e.createdAtClient||"").trim();if(a){const o=new Date(a);if(!Number.isNaN(o.getTime()))return o}const t=e.createdAt;if(t&&typeof t.toDate=="function")try{const o=t.toDate();if(o instanceof Date&&!Number.isNaN(o.getTime()))return o}catch{}return null}function Xe(e="",a={}){const t=Array.isArray(a.media)&&a.media.length?a.media[0]:{},o=String(t.type||a.mediaType||"image").trim().toLowerCase()==="video"?"video":"image",r=String(t.thumbUrl||(o==="image"?t.url:"")||a.thumbUrl||"").trim(),d=Ye(a);return{id:String(e||"").trim(),caption:String(a.caption||"").trim(),mediaType:o,thumbUrl:r,likesCount:f(a.likesCount),commentsCount:f(a.commentsCount),impressions:0,dateLabel:d?d.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit"}):"",createdAtMs:d?d.getTime():0}}function ea({days:e=[],todayKey:a="",rawPosts:t=[]}={}){const o=Array.isArray(e)?e:[],r=G(o),d=o.find(h=>String(h?.date||h?.id||"").trim()===String(a||"").trim()),m=G(d?[d]:[]),_=r.merged?.posts&&typeof r.merged.posts=="object"?r.merged.posts:{},v=(Array.isArray(t)?t:[]).map(h=>Xe(h?.id,h?.data||{})).filter(h=>h.id).map(h=>({...h,impressions:f(_[h.id]?.impressions)})),x=v.slice().sort((h,b)=>b.createdAtMs-h.createdAtMs).slice(0,We);return{day:String(a||"").trim(),week:r.summary,today:m.summary,posts:x,bestPost:aa(v)}}function aa(e=[]){const a=(Array.isArray(e)?e:[]).filter(t=>t&&t.id);return a.length?a.slice().sort((t,o)=>f(o.impressions)-f(t.impressions)||f(o.likesCount)-f(t.likesCount)||f(o.createdAtMs)-f(t.createdAtMs))[0]:null}const ta=Object.freeze(["pro","premium","plus","business","paid","active"]);function na({profile:e={},restaurant:a={}}={}){const t=[a||{},e||{}];for(const o of t){if(o.subscriptionActive===!0||o.isSubscriber===!0||o.hasSubscription===!0)return!0;const r=String(o.subscriptionPlan||o.planKey||o.plan||o.subscriptionStatus||"").trim().toLowerCase();if(r&&ta.includes(r))return!0}return!1}function ra(e={}){const a=e&&typeof e=="object"?e:{};return String(a.titleImageUrl||a.coverImageUrl||a.coverUrl||a.heroUrl||a.bannerUrl||"").trim()}function sa({model:e=null,coverUrl:a="",subscribed:t=!1,assets:o={}}={}){const r=e?.today||{},d=!e,m=e?.bestPost||null,_=[];return _.push(d?{key:"bestPost",label:"Postimi",pending:!0}:{key:"bestPost",label:"Postimi",value:P(f(m?.impressions)),withEye:!0,imageUrl:String(m?.thumbUrl||"").trim(),iconName:"image",nav:"analytics"}),_.push({key:"profileViews",label:"Profili sot",value:P(f(r.profileViews)),loading:d,imageUrl:String(a||"").trim(),iconName:"user",nav:"analytics"}),_.push({key:"menuOpens",label:"Menyja sot",value:P(f(r.menuOpens)),loading:d&&t,locked:!t,imageUrl:String(o.menuImageUrl||"").trim(),iconName:"book-open",nav:"analytics"}),_.push({key:"qrScans",label:"Skanime sot",value:P(f(r.qrScans)),loading:d&&t,locked:!t,imageUrl:String(o.qrImageUrl||"").trim(),iconName:"layout-grid",nav:"analytics"}),_}function ca({state:e,renderFn:a,documentObj:t,firestoreApi:o={},profileApi:r={},composerApi:d={},iconFn:m,storageObj:_}={}){const v=t||(typeof document>"u"?null:document),x=v?.defaultView||(typeof window>"u"?null:window),h=typeof a=="function"?a:()=>{},b=_||(typeof localStorage>"u"?null:localStorage),I=typeof r.getBusinessProfileTypeFn=="function"?r.getBusinessProfileTypeFn:(()=>""),Y=typeof r.isShopCatalogProfileFn=="function"?r.isShopCatalogProfileFn:(()=>!1),X=typeof r.isBusinessOwnerProfileFn=="function"?r.isBusinessOwnerProfileFn:(()=>!1),U=typeof r.getRestaurantMetaByIdFn=="function"?r.getRestaurantMetaByIdFn:(()=>null),ee=typeof r.resolveRestaurantLogoFn=="function"?r.resolveRestaurantLogoFn:(()=>""),ae=typeof r.resolveOwnAvatarUrlFn=="function"?r.resolveOwnAvatarUrlFn:(()=>"");let C=0,T=!1,D=null,B=null,R="",L=!1,A=()=>null;const te=300;function M(){const i=e?.userProfile||{};return Be({businessType:I(i),isShopCatalog:Y(i)})}function ne(i=""){const n=U(i)||{};return ze(n).map(s=>({id:s.id,name:s.title,price:s.price??"",category:s.beds||s.tag||"",type:"room",imageUrl:s.imageUrl||""}))}function re(i=""){if(!b)return null;try{const n=b.getItem(`${Q}${i}`);if(!n)return null;const s=JSON.parse(n),l=Array.isArray(s?.items)?s.items:null;return l&&l.length?l:null}catch{return null}}function se(i="",n=[]){if(b)try{b.setItem(`${Q}${i}`,JSON.stringify({savedAt:Date.now(),items:n}))}catch{}}async function ie(i=""){const{db:n,collectionFn:s,queryFn:l,limitFn:u,getDocsFn:p}=o;if(!n||typeof s!="function"||typeof p!="function")throw new Error("Produktet nuk u ngarkuan.");const w=s(n,"restaurants",i,"menuItems"),y=typeof l=="function"&&typeof u=="function"?l(w,u(te)):w,S=await p(y),g=[];return S.forEach(F=>{const K=A(F?.id,F?.data?.()||{});K&&g.push(K)}),g.sort((F,K)=>F.name.localeCompare(K.name,"sq")),g}async function oe(i="",n){const s=String(i||"").trim();if(!s)throw new Error("Produktet nuk u ngarkuan.");if(M()==="hotel")return ne(s);const l=ie(s).then(p=>(se(s,p),p)),u=re(s);return u?(typeof n=="function"?l.then(p=>n(p)).catch(()=>{}):l.catch(()=>{}),u):l}function O(){return D?Promise.resolve(D):(B||(B=be(()=>import("./business-composer-controller-B9HCTPxo.js"),__vite__mapDeps([0,1,2,3,4,5,6])).then(i=>(A=typeof i?.normalizeComposerProductCore=="function"?i.normalizeComposerProductCore:(()=>null),D=i.createBusinessComposerController({documentObj:v,windowObj:v?.defaultView||null,api:{getRestaurantIdFn:()=>$(),getBusinessMetaFn:()=>{const n=$();if(!n)return{name:"",logoUrl:"",city:""};const s=q(n),l=U(n)||{};return{name:s.name,logoUrl:s.logoUrl,city:String(l.city||"").trim()}},loadProductsFn:(n,s)=>oe(n,s),getBusinessKindFn:()=>M(),uploadImageFn:d.uploadImageFn,uploadVideoFn:d.uploadVideoFn,captureVideoPosterFn:d.captureVideoPosterFn,createPostFn:d.createPostFn,createStoryFn:d.createStoryFn,formatPriceFn:d.formatPriceFn,getOptimizedImageUrlFn:d.getOptimizedImageUrlFn,escapeHtmlFn:d.escapeHtmlFn,iconFn:typeof m=="function"?m:void 0,afterPublishFn:async n=>{try{await j({force:!0})}catch{}typeof d.afterPublishFn=="function"&&await d.afterPublishFn(n)}}}),D)).catch(i=>{throw B=null,console.error("[mnyra][dashboard] composer load failed",i),i})),B)}function de(){const i=x?.navigator?.connection;return!i||typeof i!="object"?!1:i.saveData===!0?!0:/(^|-)2g$/.test(String(i.effectiveType||"").trim().toLowerCase())}function le(){if(L||D||!x||de())return;L=!0;const i=()=>{if(O().catch(()=>{}),typeof d.prewarmFn=="function")try{d.prewarmFn()}catch{}};if(typeof x.requestIdleCallback=="function"){x.requestIdleCallback(i,{timeout:qe});return}x.setTimeout?.(i,Ge)}function ce(i="post"){const n=String(i||"").trim().toLowerCase(),s=n==="story"||n==="profile"?n:"post";if(typeof d.prewarmFn=="function")try{d.prewarmFn()}catch{}if(D){D.open(s);return}R=s,O().then(l=>{const u=R||s;R="",l?.open?.(u)}).catch(()=>{R=""})}function E(){return(!e.dashboardView||typeof e.dashboardView!="object")&&(e.dashboardView={status:"idle",error:"",model:null,loadedSignature:"",restaurantId:"",paywall:""}),e.dashboardView}function H(i=""){const n=E(),s=String(i||"").trim();return String(n.restaurantId||"")===s||(n.restaurantId=s,n.model=null,n.status="idle",n.error="",n.loadedSignature="",n.paywall="",C+=1),n}function $(){const i=e?.userProfile||{};return String(i.restaurantId||i.staffRestaurantId||"").trim()}function he(){const i=String(e?.user?.uid||"").trim();if(!i)return!1;const n=String(e?.__authBootstrapInFlightUid||"").trim();return!!e?.__authProfileLoadPromise||n===i}function V(i=""){return`${Ve}${i}`}function ue(i="",n=""){if(!b||!i)return null;try{const s=b.getItem(V(i));if(!s)return null;const l=JSON.parse(s);return!l||typeof l!="object"||String(l.day||"").trim()!==String(n||"").trim()||!l.model||typeof l.model!="object"?null:l.model}catch{return null}}function me(i="",n=null){if(!(!b||!i||!n))try{b.setItem(V(i),JSON.stringify({day:n.day,model:n}))}catch{}}async function pe(i=""){const{db:n,collectionFn:s,queryFn:l,orderByFn:u,limitFn:p,getDocsFn:w}=o;if(!n||typeof s!="function"||typeof l!="function"||typeof u!="function"||typeof p!="function"||typeof w!="function")return[];const y=s(n,"restaurants",i,"socialPosts");return(await w(l(y,u("createdAt","desc"),p(Ze)))).docs.map(g=>({id:g.id,data:g.data()||{}})).filter(g=>{const F=String(g.data.status||"active").trim().toLowerCase();return F!=="deleted"&&F!=="hidden"})}async function j({force:i=!1}={}){const n=$(),s=H(n);if(!n)return;const l=ye({rangeKey:"7d"});if(!l)return;const u=`${n}::${l.toDay}`;if(!i&&s.loadedSignature===u&&s.status==="ready")return;if(!s.model){const y=ue(n,l.toDay);y&&(s.model=y,s.status="ready",h())}C+=1;const p=C;s.model||(s.status="loading",s.error="",h());try{const y={db:o.db,collectionFn:o.collectionFn,queryFn:o.queryFn,whereFn:o.whereFn,documentIdFn:o.documentIdFn,getDocsFn:o.getDocsFn,restaurantId:n},[S,g]=await Promise.allSettled([_e({...y,fromDay:l.fromDay,toDay:l.toDay}),pe(n)]);if(p!==C)return;if(S.status==="rejected")throw S.reason;g.status==="rejected"&&console.error("[mnyra][dashboard] recent posts load failed",g.reason),s.model=ea({days:S.value,todayKey:l.toDay,rawPosts:g.status==="fulfilled"?g.value:[]}),s.status="ready",s.error="",s.loadedSignature=u,me(n,s.model)}catch(y){if(p!==C)return;console.error("[mnyra][dashboard] load failed",y),s.model||(s.status="error",s.error="Ju lutem kontrollo lidhjen dhe provo perseri.")}h()}function ge(){T||!v||(T=!0,v.addEventListener("click",i=>{try{if(String(e?.activeTab||"").trim().toLowerCase()!=="dashboard")return;if(i.target?.closest?.("[data-dashboard-retry]")){j({force:!0});return}if(i.target?.closest?.("[data-dashboard-paywall-close]")){i.preventDefault(),E().paywall="",h();return}const n=i.target?.closest?.("[data-dashboard-metric-locked]");if(n){i.preventDefault(),E().paywall=String(n.getAttribute("data-dashboard-metric-locked")||"").trim(),h();return}const s=i.target?.closest?.("[data-dashboard-composer]");s&&(i.preventDefault(),ce(s.getAttribute("data-dashboard-composer")))}catch{}}))}function q(i=""){const n=e?.userProfile||{},s=i?U(i)||{}:{},l=String(s.name||s.restaurantName||n.name||"").trim()||"Business";let u="";try{u=String(ae()||"").trim()}catch{}if(!u)try{u=String(ee(s)||"").trim()}catch{}return{name:l,logoUrl:u,kind:M(),coverUrl:ra(s),subscribed:na({profile:n,restaurant:s})}}function fe(){Fe(v),ge();const i=$(),n=H(i);let s="";if(!i)s=he()?`${Ae()}${J({kpiCount:6})}`:He();else{le();const l=q(i),u=Re({kind:l.kind,isOwner:X(e?.userProfile)}),p=$e(l.kind);n.status==="idle"&&(n.status="loading",queueMicrotask(()=>{j({force:!1})}));let w="";n.model?w=`
          ${Ne({kpiDefs:p,week:n.model.week,today:n.model.today})}
          ${Te({posts:n.model.posts,iconFn:m})}
        `:n.status==="error"?w=Oe({message:n.error}):w=J({kpiCount:p.length});const y=sa({model:n.model,coverUrl:l.coverUrl,subscribed:l.subscribed,assets:Je}),S=String(n.paywall||"").trim();s=`
        ${Ke({name:l.name,logoUrl:l.logoUrl,iconFn:m})}
        ${Me({cards:y,iconFn:m})}
        ${Ee(`
          ${Ie({iconFn:m})}
          ${Ue({actions:u,iconFn:m})}
          ${w}
        `)}
