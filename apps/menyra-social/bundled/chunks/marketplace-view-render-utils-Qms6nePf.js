const j=Object.freeze({restaurants:Object.freeze({key:"restaurants",title:"Restaurants",emptyTitle:"Noch keine Restaurants",emptyBody:"Keine passenden Profile gefunden.",icon:"utensils",typeKeys:Object.freeze(["restaurant","cafe","coffee","fastfood","food"])}),travel:Object.freeze({key:"travel",title:"Travel",emptyTitle:"Noch keine Travel-Profile",emptyBody:"Keine passenden Profile gefunden.",icon:"plane",typeKeys:Object.freeze(["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"])}),shopping:Object.freeze({key:"shopping",title:"Shopping",emptyTitle:"Noch keine Shopping-Profile",emptyBody:"Keine passenden Profile gefunden.",icon:"shopping-bag",typeKeys:Object.freeze(["ecommerce"])})}),F=new Map;Object.values(j).forEach(e=>{e.typeKeys.forEach(t=>{F.set(t,e.key)})});const M=8,$=24,G="#ff4f3f",Y="mnyra_social_feed_viewer_location_v1",x="#00cce5",J=Object.freeze([Object.freeze(["tirana","tirane"]),Object.freeze(["durres","durresi"]),Object.freeze(["vlora","vlore"]),Object.freeze(["shkoder","shkodra"]),Object.freeze(["shengjin","shëngjin","shen gjin","shengjini"]),Object.freeze(["ksamil","ksamili"]),Object.freeze(["dhermi","dhërmi","dhermiu"]),Object.freeze(["velipoje","velipojë","velipoja"]),Object.freeze(["theth","thethi"]),Object.freeze(["valbone","valbonë","valbona"]),Object.freeze(["elbasan","elbasani"]),Object.freeze(["fier","fieri"]),Object.freeze(["korce","korca"]),Object.freeze(["sarande","saranda"]),Object.freeze(["berat","berati"]),Object.freeze(["gjirokaster","gjirokastra"]),Object.freeze(["kukes","kukesi"]),Object.freeze(["lezhe","lezha"]),Object.freeze(["pogradec","pogradeci"]),Object.freeze(["kruje","kruja"]),Object.freeze(["fushe kruje","fushë krujë","fushe-kruje","fush kruje"]),Object.freeze(["lushnje","lushnja"]),Object.freeze(["himare","himarë","himara"]),Object.freeze(["kavaje","kavajë","kavaja"]),Object.freeze(["kamze","kamëz","kamza"]),Object.freeze(["vore","vorë","vora"]),Object.freeze(["divjake","divjakë","divjaka"]),Object.freeze(["permet","përmet","permeti"]),Object.freeze(["tepelene","tepelenë","tepelena"]),Object.freeze(["delvine","delvinë","delvina"]),Object.freeze(["peshkopi","peshkopia","diber","dibër"]),Object.freeze(["burrel","burreli","mat"]),Object.freeze(["puke","pukë","puka"]),Object.freeze(["bajram curri","bajramcurri","tropoje","tropojë"]),Object.freeze(["krume","krumë","has"]),Object.freeze(["lac","laç","kurbin"]),Object.freeze(["orikum","orikumi"]),Object.freeze(["golem","golemi"]),Object.freeze(["jale","jalë","jali"]),Object.freeze(["qepare","qeparo","qeparoi"]),Object.freeze(["borsh","borshi"]),Object.freeze(["lukove","lukovë","lukova"]),Object.freeze(["palase","palasë","palasa"]),Object.freeze(["drimadhe","drymades","drimadhes"]),Object.freeze(["spille","spilleja"]),Object.freeze(["gjiri i lalzit","lalzi","lalez","lalëz"])]);function E(e,t=()=>""){return typeof e=="function"?e:t}function l(e=""){return String(e||"").trim()}function y(e=""){const t=l(e).toLowerCase();return t?t.replace(/[ëèéê]/g,"e").replace(/[çćč]/g,"c").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/&/g,"and").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,""):""}function Q(e=""){const t=y(e);if(!t)return[];const a=new Set([t]);return J.forEach(s=>{const n=s.map(y).filter(Boolean);n.includes(t)&&n.forEach(i=>a.add(i))}),Array.from(a)}function P(e=""){const t=y(e);return t==="restaurant"?"restaurants":["hotel","hotels","motel","motels"].includes(t)?"travel":["shop","ecommerce","e_commerce","shopping"].includes(t)?"shopping":j[t]?t:"restaurants"}function K(e=""){const t=y(e);return t?t==="e_commerce"||t==="online_shop"||t==="onlineshop"||t==="shop"||t==="store"?"ecommerce":t==="coffee"||t==="coffe"||t==="kaffee"?"cafe":t==="fast_food"||t==="snack"||t==="imbiss"?"fastfood":t==="hotels"?"hotel":t==="motels"?"motel":t:""}function W(e={}){return[e.type,e.customerType,e.restaurantType,e.businessProfileType,e.profileType,e.catalogMode,e.category,e.kind,e.vertical,e.leadType]}function T(e={},{normalizeRestaurantType:t,normalizeLeadTypeKey:a}={}){const s=typeof t=="function"?t:(o=>o),n=typeof a=="function"?a:(o=>o),i=W(e);for(const o of i){const c=K(s(o)||n(o)||o);if(c)return c}const r=[e.name,e.restaurantName,e.businessName,e.description,e.bio].map(o=>l(o).toLowerCase()).join(" ");return/\bhotel(s)?\b/.test(r)?"hotel":/\bmotel(s)?\b/.test(r)?"motel":/\bcoffee\b|\bcoffe\b|\bcafe\b|\bcaffe\b/.test(r)?"cafe":/\bfast\s*food\b|\bfastfood\b/.test(r)?"fastfood":/\be-?commerce\b|\bonline\s*shop\b/.test(r)?"ecommerce":/\brestaurant\b|\brestoran\b|\bpizza\b|\bpizzeria\b/.test(r)?"restaurant":""}function X(e={},t={}){const a=T(e,t);return F.get(a)||""}function h(e={}){return l(e.canonicalRestaurantId||e.restaurantId||e.id||e.landingRestaurantId||"")}function g(e={}){return l(e.name||e.restaurantName||e.businessName||e.displayName||"Business")}function k(e={}){const t=l(e.city||e.locationCity||e.primaryCity),a=l(e.address||e.location||e.primaryAddress);return t&&a&&t!==a?`${t} - ${a}`:t||a||"Standort folgt"}function Z(e={}){const t=[e.id,e.restaurantId,e.canonicalRestaurantId,e.publicSlug,e.landingSlug,e.handle,e.type,e.customerType,e.restaurantType,e.businessProfileType,e.profileType,e.catalogMode,e.category,e.kind,e.vertical,e.leadType,e.city,e.locationCity,e.primaryCity,e.address,e.location,e.primaryAddress,e.country,e.region,e.district,e.name,e.restaurantName,e.businessName,e.displayName,e.description,e.bio,e.about];return Array.isArray(e.locations)&&e.locations.forEach(a=>{!a||typeof a!="object"||t.push(a.city,a.address,a.country,a.region,a.name)}),t}function ee(e={},t=""){const a=Q(t);if(!a.length)return!0;const s=Z(e).map(y).filter(Boolean).join("_");return a.some(n=>{const i=n.split("_").filter(Boolean);return s.includes(n)?!0:i.length>0&&i.every(r=>s.includes(r))})}function B(e={}){const t=[[e.lat,e.lng],[e.latitude,e.longitude],[e.gpsLat,e.gpsLng],[e.geo?.lat,e.geo?.lng],[e.geo?.latitude,e.geo?.longitude],[e.coords?.lat,e.coords?.lng],[e.coords?.latitude,e.coords?.longitude],[e.location?.lat,e.location?.lng]];for(const[a,s]of t){const n=Number(String(a??"").replace(",",".")),i=Number(String(s??"").replace(",","."));if(Number.isFinite(n)&&Number.isFinite(i)&&Math.abs(n)<=90&&Math.abs(i)<=180){if(Math.abs(n)<1e-6&&Math.abs(i)<1e-6)continue;return{lat:n,lng:i}}}if(Array.isArray(e.locations))for(const a of e.locations){const s=B(a||{});if(s)return s}return null}function U(e={}){const t=e.openingHours||e.openHours||e.hours||e.businessHours||e.workingHours||"";if(typeof t=="string"&&l(t))return l(t);if(t&&typeof t=="object"){const a=Object.values(t).map(l).filter(Boolean);if(a.length)return a[0]}return"Oeffnungszeiten folgen"}function te(e={}){return l(e.phone||e.telephone||e.contactPhone||e.ownerPhone||"")}function ae(e={}){return l(e.description||e.bio||e.about||e.shortDescription||"")}function z(e={}){const t=Number(e.rating??e.avgRating??e.score??e.publicRating??0);return!Number.isFinite(t)||t<=0?"":Math.min(5,Math.max(1,t)).toFixed(1)}function O(e={},{getOptimizedImageUrl:t,resolveRestaurantLogo:a,placeholderImage:s=""}={}){const n=h(e),i=l(e.logoUrl||e.logo||e.logoURL||e.heroUrl||e.coverUrl||e.imageUrl||e.img||""),o=(n&&typeof a=="function"?l(a(n,i,"medium")):i)||i||s;return(typeof t=="function"?l(t(o,"medium")):o)||s||""}function se(e={},{getOptimizedImageUrl:t,placeholderImage:a=""}={}){const n=l(e.titleImageUrl||e.coverImageUrl||e.coverImage||e.coverUrl||e.heroImageUrl||e.heroUrl||e.imageUrl||e.bestSpotLogoUrl||e.spotLogoUrl||e.logoUrl||e.logo||"")||a;return(typeof t=="function"?l(t(n,"large")):n)||a||""}function ne(e={}){return l(e.cuisine||e.kitchen||e.foodType||e.categoryLabel||e.__marketplaceTypeLabel||e.type||e.customerType||"")}function ie(e={}){return l(e.priceRange||e.priceLevel||e.priceLabel||e.budget||"")}function R(e,t=""){return typeof e=="string"?l(e):e===!0?l(t):""}function re(e={}){const t=e.restaurantFeatures&&typeof e.restaurantFeatures=="object"?e.restaurantFeatures:{},a=[R(e.gardenTerraceText||e.gardenTerrace||e.gardenOrTerrace||t.gardenTerrace,"Gastgarten"),R(e.accessibilityText||e.barrierFreeText||e.accessibleText||e.barrierefrei||e.accessible||t.accessibility,"Barrierefrei"),R(e.veganOptionsText||e.veganOptions||e.veganText||e.vegan||t.veganOptions,"Vegane Optionen")].filter(Boolean);if(a.length)return a.slice(0,3);const s=Array.isArray(e.features)?e.features.map(l).filter(Boolean):[];if(s.length)return s.slice(0,3);const n=l(e.features||e.amenities||"");return n?n.split(/[,;|]/).map(l).filter(Boolean).slice(0,3):[]}function oe(e={}){const t=Number(e.rating??e.avgRating??e.publicRating??0),a=Number(e.score??e.publicScore??0),s=Number(e.followersCount??e.followerCount??0),n=Number(e.postsCount??e.postCount??0),i=Number(e.updatedAt?.seconds||e.createdAt?.seconds||0);return(Number.isFinite(t)?t*1e3:0)+(Number.isFinite(a)?a:0)+(Number.isFinite(s)?Math.min(s,500):0)+(Number.isFinite(n)?Math.min(n,200):0)+(Number.isFinite(i)?Math.min(i/1e5,100):0)}function le(e={},t={}){const a=new Map,s=(n={})=>{if(!n||typeof n!="object")return;const i=h(n);if(!i)return;const r=a.get(i)||{};a.set(i,{...r,...n,id:i})};return(Array.isArray(e.bootstrapRestaurantPreview)?e.bootstrapRestaurantPreview:[]).forEach(s),(Array.isArray(e.restaurants)?e.restaurants:[]).forEach(s),Array.from(a.values()).map(n=>({...n,__marketplaceSection:X(n,t),__marketplaceScore:oe(n)})).filter(n=>n.__marketplaceSection).sort((n,i)=>i.__marketplaceScore-n.__marketplaceScore||g(n).localeCompare(g(i)))}function I(e={},t="",a={}){const s=P(t);return le(e,a).filter(n=>n.__marketplaceSection===s)}function w(e="",t="",{escapeHtml:a,isPlaceholderUrl:s,extraClass:n=""}={}){const i=l(e),r=!i||typeof s=="function"&&s(i);return`
    <img
      src="${a(i)}"
      alt="${a(t)}"
      loading="lazy"
    ...
    />
  `}function V(e={},t={}){const a=t.escapeHtml,s=t.icon,n=g(e),i=h(e),r=O(e,t),o=z(e),c=k(e);return`
  ...
  `}function q(e={},t={}){const a=t.escapeHtml,s=t.icon,n=g(e),i=h(e),r=O(e,t),o=z(e),c=k(e),u=U(e),b=ae(e),f=l(e.__marketplaceTypeLabel||e.type||e.customerType||"");return`
  ...
  `}function ce(e={},t={}){const a=t.escapeHtml,s=t.icon,n=g(e),i=h(e),r=se(e,t),o=O(e,t),c=z(e),u=Number(e.reviewsCount??e.reviewCount??e.ratingsCount??0),b=c||"0.0",f=Number.isFinite(u)&&u>0?u:0,p=ne(e),S=ie(e)||"€€ - €€€",L=k(e),d=te(e),C=U(e),v=re(e),N=e.isLiked===!0||e.liked===!0||e.favorite===!0||e.favorited===!0;return`
    <article class="w-full max-w-[340px] mx-auto bg-white rounded-[28px] overflow-hidden shadow-lg shadow-slate-200/80 border border-slate-100/60 relative flex flex-col" style="max-width:340px;border-radius:28px;border-color:rgba(241,245,249,0.6);box-shadow:0 10px 15px -3px rgba(226,232,240,0.8),0 4px 6px -4px rgba(226,232,240,0.8);">
      <div class="h-44 relative overflow-hidden group">
        ${w(r,n,{...t,extraClass:"transition-transform duration-700 group-hover:scale-105"})}
      ...
      <div class="px-5 pb-5 pt-12 relative flex-1 flex flex-col gap-3.5" style="padding-top:3rem;gap:0.875rem;">
        <div class="absolute -top-10 left-5 z-10" style="top:-2.5rem;left:1.25rem;">
          <div class="w-[76px] h-[76px] rounded-full p-1 bg-white shadow-md border border-slate-100 overflow-hidden" style="width:76px;height:76px;">
            ${w(o,`${n} Logo`,{...t,extraClass:"rounded-full"})}
          </div>
        </div>
        ...
        <div>
          <div class="flex items-center gap-1.5 mb-1">
            ...
            <span class="text-[11px] text-slate-400">(${a(String(f))} Bewertungen)</span>
          </div>

          <h2 class="text-lg font-black text-slate-900 leading-snug tracking-tight">${a(n)}</h2>
          ${p?`<p class="text-[10px] text-amber-600 font-bold uppercase tracking-wider mt-0.5" style="margin-top:0.125rem;">${a(p)}</p>`:""}
        </div>
        ...
        <div class="flex flex-col gap-2.5 text-slate-600">
          <div class="flex items-start gap-3">
            ...
            <span class="text-[11px] leading-relaxed text-slate-600">${a(L)}</span>
          </div>
          ${d?`
            <div class="flex items-center gap-3">
              ${s("phone","w-4 h-4 text-slate-400 shrink-0")}
              <span class="text-[11px] text-slate-600">${a(d)}</span>
            </div>
          `:""}
          <div class="flex items-center gap-3">
            ${s("clock","w-4 h-4 text-slate-400 shrink-0")}
            <span class="text-[11px] text-slate-600">${a(C)}</span>
          </div>
        </div>
  ...
  `}function A(e={},t={}){const a=l(e.__marketplaceType||e.type||e.customerType||""),s=K(a);return{...e,__marketplaceTypeLabel:{restaurant:"Restaurant",cafe:"Cafe",coffee:"Cafe",fastfood:"Fastfood",hotel:"Hotel",motel:"Motel",ecommerce:"E-Commerce"}[s]||t.title,__marketplaceType:s}}function _(e={},t={}){const a=t.escapeHtml,s=t.icon;return`
  ...
  `}function ue(){const e=globalThis?.localStorage||null;if(!e)return null;try{const t=e.getItem(Y);if(!t)return null;const a=JSON.parse(t),s=Number(a?.lat??a?.latitude),n=Number(a?.lng??a?.lon??a?.longitude);return!Number.isFinite(s)||!Number.isFinite(n)?null:{lat:s,lng:n,label:l(a?.label||a?.city||""),city:l(a?.city||a?.label||""),source:l(a?.source||"")}}catch{return null}}function pe({deps:e}={}){const t=e.icon;return`
  ...
  `}function fe({items:e=[],bestItems:t=[],section:a={},deps:s={}}={}){return e.length?`
  ...
  `:_(a,s)}function de({state:e,dataLoaded:t,section:a,deps:s}={}){const n=I(e,a.key,s).map(f=>A({...f,__marketplaceType:T(f,s)},a)),r=!!ue(),o=n.slice(0,$),c=o.slice(0,M),b=t?.restaurants===!0||n.length?fe({items:o,bestItems:c,section:a,deps:s}):H(a,s);return r?`
  ...
  `}function be(e={}){const t=e?.travelView&&typeof e.travelView=="object"?e.travelView:{},a=l(t.query||""),s=l(t.activeTab||"").toLowerCase(),n=["offers","hotels","map"].includes(s)?s:a?"hotels":"offers";return{query:a,activeTab:a?n:"offers",notice:l(t.notice||"")}}function me({travel:e,deps:t}={}){const a=t.escapeHtml,s=t.icon;return`
  ...
  `}function ge({activeTab:e,hasDestination:t,hotelCount:a,deps:s}={}){const n=s.escapeHtml;return`
  ...
  `}function he(e={},t={}){const a=t.escapeHtml,s=t.icon,n=g(e),i=h(e),r=O(e,t),o=k(e),c=z(e);return`
  ...
  `:_({emptyTitle:"Noch keine Angebote",emptyBody:"Keine passenden Hotel-Angebote gefunden.",icon:"plane"},t)}function D(e=[],t={}){return e.length?`
    <div class="space-y-4">
      ${e.map(a=>q(a,t)).join("")}
    </div>
  `:_({emptyTitle:"Keine Hotels gefunden",emptyBody:"Keine passenden Hotels fuer dieses Reiseziel gefunden.",icon:"plane"},t)}function xe(e={},t=0,a={}){const s=a.escapeHtml,n=B(e),i=g(e),r=h(e),o=k(e),c=18+t*23%58,u=22+t*17%46;return`
    <button
      type="button"
      ...
      style="left:${c}%; top:${u}%; transform:translate(-50%,-50%); color:${x};"
      title="${s(`${i} - ${o}`)}"
    >
  ...
  `}function ye(e=[],t={}){if(typeof t.renderMapView=="function")return t.renderMapView();const a=e.filter(s=>B(s)).slice(0,8);return e.length?`
    <div class="space-y-4">
  ...
  `:D(e,t)}function we({state:e,dataLoaded:t,section:a,deps:s}={}){const n=I(e,a.key,s).map(p=>A({...p,__marketplaceType:T(p,s)},a)),i=be(e),r=!!i.query,o=r?n.filter(p=>ee(p,i.query)):n.slice(0,$),c=o.slice(0,$),u=r?i.activeTab:"offers",b=t?.restaurants===!0,f=u==="map"?ye(c,s):u==="hotels"?D(c,s):ve(c,s);return`
    <section id="travelView" class="animate-in slide-in-from-right-10 duration-500" style="background:#f8fafc; min-height:100%;">
      ...
      <div id="travelBenko" data-travel-benko style="margin-top:-1.75rem; border-top-left-radius:2.5rem; border-top-right-radius:2.5rem; background:#f8fafc; padding:2rem 1.5rem 6.5rem;">
        ${ge({activeTab:u,hasDestination:r,hotelCount:o.length,deps:s})}
        <div class="mt-5">
          ${b||n.length?f:H(a,s)}
        </div>
      </div>
    </section>
  `}function ke({state:e={},dataLoaded:t=null,sectionKey:a="restaurants",escapeHtmlFn:s,iconFn:n,getOptimizedImageUrlFn:i,isPlaceholderUrlFn:r,placeholderImage:o="",normalizeRestaurantTypeFn:c,normalizeLeadTypeKeyFn:u,resolveRestaurantLogoFn:b,renderMapViewFn:f}={}){const p=j[P(a)]||j.restaurants,S=E(s,(m="")=>String(m||"")),L=E(n,()=>""),d={escapeHtml:S,icon:L,getOptimizedImageUrl:i,isPlaceholderUrl:r,placeholderImage:o,resolveRestaurantLogo:b,renderMapView:f,normalizeRestaurantType:c,normalizeLeadTypeKey:u},C=t?.restaurants===!0;if(p.key==="travel")return we({state:e,dataLoaded:t,section:p,deps:d});if(p.key==="restaurants")return de({state:e,dataLoaded:t,section:p,deps:d});const v=I(e,p.key,d).slice(0,$).map(m=>A({...m,__marketplaceType:T(m,d)},p)),N=v.slice(0,M);return`
    <section class="p-6 pb-24 animate-in slide-in-from-right-10 duration-500">
      ${v.length?`
        <div style="margin-bottom:2rem;">
          <div class="flex gap-3 overflow-x-auto hide-scrollbar snap-x" style="-webkit-overflow-scrolling:touch; scrollbar-width:none;">
  ...
  `}export{I as filterMarketplaceBusinessesCore,ke as renderMarketplaceViewCore,X as resolveMarketplaceSectionForBusinessCore};
