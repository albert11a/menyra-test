import{f as he,g as Jn,i as ra,h as Xn,j as es,k as xe,b as ts}from"../entry/social-app.js";import{t as as}from"./domain-app-events-rkgdN7NR.js";import"./domain-auth-GDqJX7rW.js";import"./firebase-config-DgqKKOmY.js";import"./vendor-firebase-DSh1wwGb.js";import"./domain-push-BPmJ5TmW.js";import"./startup-route-runtime-context-D7ndoYKY.js";import"./domain-follow-BXoKfGG0.js";import"./domain-notifications-CLcv8atr.js";import"./domain-feed-Ul-n5cS_.js";import"./domain-public-profile-BW4dw-Ab.js";import"./domain-stories-Bn5yWiQS.js";import"./domain-business-accounts-Czo_hlVf.js";import"./domain-leads-DKLm0wNx.js";import"./domain-map-BjqpyoLm.js";function xs(y={}){const d=y.state,ia=y.resolvePostCountsFn,n=y.escapeHtmlFn,U=y.getOptimizedImageUrlFn,x=y.iconFn,oa=y.isLocalBusinessProfileFn,la=typeof y.isCeoUserFn=="function"?y.isCeoUserFn:(()=>!1),ft=y.normalizeHandleFn,De=y.logoFitClassFn,B=y.formatCountFn,gt=y.renderProfileShopCartViewFn,mt=y.renderProfileShopFavoritesViewFn,da=typeof y.ensurePostsDataForProfileFn=="function"?y.ensurePostsDataForProfileFn:(()=>{}),ca=y.ensureMenuDataForProfileFn,ua=typeof y.ensureEditorMenuDataForProfileFn=="function"?y.ensureEditorMenuDataForProfileFn:(()=>{}),ve=y.ensureFocusDataForProfileFn,pa=typeof y.ensureAdsDataForProfileFn=="function"?y.ensureAdsDataForProfileFn:(()=>{}),bt=y.ensureTableQrStateForProfileFn,Q=y.isShopCatalogProfileFn,fa=y.getBusinessCatalogLabelFn,oe=y.normalizeMenuTypeFn,ga=y.primeMenuItemCountsFn,ma=typeof y.hydrateMenuCardViewerLikesFn=="function"?y.hydrateMenuCardViewerLikesFn:(()=>Promise.resolve()),ba=y.renderShopProductListFn,ha=y.getMenuLayoutThemeFn,xa=y.menuLayoutColors,Z=y.resolveMenuItemHeroFn,O=y.isPlaceholderUrlFn,N=y.placeholderImage,va=y.getFirebaseStorageUrlFn,wa=y.isDirectImageUrlFn,ht=y.formatPriceFn,ya=typeof y.resolveCurrencyCodeForMenuItemFn=="function"?y.resolveCurrencyCodeForMenuItemFn:(()=>""),xt=y.getMenuItemImagesFn,V=y.getMenuItemObjectPositionFn,we=y.getMenuItemSocialIdFn,vt=y.menuItemMetaKeyFn,wt=y.ensureMenuItemMetaFn,yt=y.resolveMenuItemCountsFn,ye=y.getFocusStateForRestaurantFn,$a=typeof y.getAdsStateForRestaurantFn=="function"?y.getAdsStateForRestaurantFn:(()=>({items:[],enabled:!0,loading:!1,same:!1})),$e=y.getTableQrStateForRestaurantFn,le=y.getFocusItemObjectPositionFn,He=y.getFocusCardClassFn,ka=y.getFocusIndexFn,se=y.isRestaurantCafeProfileFn,Oe=typeof y.getBusinessProfileTypeFn=="function"?y.getBusinessProfileTypeFn:(()=>""),pe=y.getRestaurantMetaByIdFn,Sa=y.buildUrlFn,Ia=y.normalizeSearchKeyFn,Ca=y.normalizeFollowHandleFn,ee={key:"",inFlightKey:""},$t=new Set,ke=()=>{try{if(globalThis?.__MENYRA_DEBUG_MENU_STATE__===!0||globalThis?.__MENYRA_DEBUG_PROFILE_RENDER__===!0)return!0;const e=new URLSearchParams(globalThis?.location?.search||"");return e.get("debug-menu-state")==="1"||e.get("debug-profile-render")==="1"}catch{return!1}},Pa=({profile:e=null,routePayload:t=null,surface:a=null,decision:s=null}={})=>{if(!ke())return;const i=a&&typeof a=="object"?a:{},r=i.menu&&typeof i.menu=="object"?i.menu:{},o=e&&typeof e=="object"?e:{},l=t&&typeof t=="object"?t:{},c=l?.businessSnapshot?.identity||l?.identity||{},f=String(i.authoritativeRestaurantId||i.restaurantId||r.restaurantId||"").trim(),u=String(o.publicSlug||o.landingSlug||o.handle||c.publicSlug||c.landingSlug||c.handle||"").trim(),p=`${f||"pending"}::${u||"no-slug"}`;if($t.has(p))return;$t.add(p);const m=Array.isArray(r.items)?r.items:[],b=new Set(m.map(v=>String(v?.category||"").trim()).filter(Boolean)).size,k=String(r.rawTruthState||r.truthState||"").trim();console.debug("[mnyra][public-menu.first-render]",{businessId:f,slug:u,itemsLength:m.length,categoriesLength:b,menuStatus:String(r.status||"loading"),truthState:k,isLoading:s?.isLoading===!0,isHydrating:r.hydrating===!0||k.toLowerCase()==="hydrating",confirmedEmpty:r.confirmedEmpty===!0,canRenderItems:r.canRenderItems===!0,shouldRenderNoProducts:s?.shouldRenderNoProducts===!0,source:String(r.source||"")})},ja=()=>{try{return String(globalThis?.__MNYRA_BUILD_TOKEN__||globalThis?.__MENYRA_SOCIAL_APP_VERSION__||"").trim()}catch{return""}},Ve=(e="")=>n(String(e||"")),de=(e="")=>n(String(e??"")),W=({renderer:e="profile-menu-focus-render-controller",skeleton:t="",source:a=""}={})=>{if(!ke())return"";const s=[e?`data-debug-renderer="${Ve(e)}"`:"",t?`data-debug-skeleton="${Ve(t)}"`:"",a?`data-debug-source="${Ve(a)}"`:""].filter(Boolean);return s.length?` ${s.join(" ")}`:""},Fa=(e={},t=[])=>{const a=Xn(e,t);return` ${[`data-menu-state="${de(a.menuState)}"`,`data-menu-item-count="${de(a.menuItemCount)}"`,`data-focus-state="${de(a.focusState)}"`,`data-focus-business-id="${de(a.focusBusinessId)}"`,`data-focus-item-count="${de(a.focusItemCount)}"`,`data-focus-source="${de(a.focusSource)}"`,`data-focus-stale="${a.focusStale?"true":"false"}"`].join(" ")}`},kt=({component:e="profile-menu-focus-render-controller",functionName:t="",profile:a=null,routePayload:s=null,surface:i=null,decision:r=null,items:o=null,rawItems:l=null,filteredItems:c=null,renderDecision:f="",source:u=""}={})=>{const p=i&&typeof i=="object"?i:{},m=p.menu&&typeof p.menu=="object"?p.menu:{},b=p.focus&&typeof p.focus=="object"?p.focus:{},k=a&&typeof a=="object"?a:d?.profileView?.profile&&typeof d.profileView.profile=="object"?d.profileView.profile:{},v=s&&typeof s=="object"?s:d?.profileView?.routePayload&&typeof d.profileView.routePayload=="object"?d.profileView.routePayload:{},S=v?.businessSnapshot&&typeof v.businessSnapshot=="object"?v.businessSnapshot:{},P=S?.identity&&typeof S.identity=="object"?S.identity:v?.identity&&typeof v.identity=="object"?v.identity:{},w=d?.__webDirectEntry&&typeof d.__webDirectEntry=="object"?d.__webDirectEntry:{},I=String(k.publicSlug||k.landingSlug||k.handle||P.publicSlug||P.landingSlug||P.handle||w.publicSlug||"").trim(),F=String(k.restaurantId||v.restaurantId||w.restaurantId||"").trim(),A=String(k.canonicalRestaurantId||v.canonicalRestaurantId||p.authoritativeRestaurantId||w.canonicalRestaurantId||S.restaurantId||"").trim();let L="";k.canonicalRestaurantId?L="profile.canonicalRestaurantId":v.canonicalRestaurantId?L="routePayload.canonicalRestaurantId":p.authoritativeRestaurantId?L="surface.authoritativeRestaurantId":w.canonicalRestaurantId?L="webDirectEntry.canonicalRestaurantId":S.restaurantId?L="routeSnapshot.restaurantId":k.restaurantId?L="profile.restaurantId":v.restaurantId?L="routePayload.restaurantId":w.restaurantId&&(L="webDirectEntry.restaurantId");const $=String(A||p.restaurantId||m.restaurantId||F||"").trim(),_=Array.isArray(l)?l:Array.isArray(m.items)?m.items:[],z=Array.isArray(o)?o:_,R=Array.isArray(c)?c:z,h=new Set(R.map(re=>String(re?.category||"").trim()).filter(Boolean)).size,j=String(m.status||(r?.isLoading?"loading":"")||"").trim(),T=String(m.rawTruthState||m.truthState||"").trim(),M=m.confirmedEmpty===!0||r?.confirmedEmpty===!0,E=r?.hasError===!0||j==="error"||!!String(m.error||"").trim(),q=!(R.length>0||r?.hasItems===!0)&&!M&&!E,G=A||F||$||"";return{component:e,functionName:t,slug:I,businessId:$,requestedRestaurantId:F,canonicalRestaurantId:A,restaurantIdSource:L,menuReadPath:G?`restaurants/${G}/public/menu`:"",activeTab:String(d?.activeTab||"").trim(),profileTopTab:String(d?.profileTopTab||"").trim(),profileContentTab:String(d?.profileContentTab||"").trim(),itemsLength:z.length,rawItemsLength:_.length,filteredItemsLength:R.length,categoriesLength:h,focusItemsLength:Array.isArray(b.items)?b.items.length:0,loading:m.loading===!0||r?.isLoading===!0||j==="loading",pending:q,hydrating:m.hydrating===!0||T.toLowerCase()==="hydrating",status:j,truthState:T,confirmedEmpty:M,canRenderItems:m.canRenderItems===!0,renderDecision:f||(r?.shouldRenderNoProducts?"no-products":r?.isLoading?"loading":""),source:u||String(m.source||""),buildToken:ja()}},Se=(e={})=>{ke()&&console.warn("[mnyra:no-products-render]",{...kt(e),stack:new Error().stack})},Ie=(e="",t={})=>{ke()&&console.info("[mnyra:skeleton-render]",{skeletonName:e,...kt({...t,renderDecision:t.renderDecision||"skeleton"}),reason:String(t.reason||"").trim()})},g=(e,t=e,a={})=>as(e,{fallback:t,params:a}),Aa=(e="")=>{const t=String(e||"").trim();if(!t)return g("nav.menu","Menue");const a=t.toLowerCase();return a==="menue"||a==="menu"||a==="menü"?g("nav.menu",t):a==="shop"?"Shop":t},St=(e="")=>{const t=String(e||"").trim();if(!t)return"";const a=t.toLowerCase();return["speisen","food","getraenke","getränke","drink","drinks","beverage","beverages"].includes(a)?g("menu.products","Produkte"):t},La=(e="food",t=!1)=>t?g("menu.products","Produkte"):String(e||"").trim().toLowerCase()==="drink"?g("menu.drinks","Getraenke"):g("menu.food","Speisen"),It=(e={},t=!1)=>{const a=oe(e?.type||"food");return t?g("menu.product","Produkt"):a==="drink"?g("menu.drinkItem","Getraenk"):g("menu.foodItem","Speise")},Ke=(e="",t="#111827")=>{const a=String(e||"").trim();return/^#[0-9a-fA-F]{6}$/.test(a)?a:t};function Ta(e=null,t=null){return he(d,{profile:e,routePayload:t,webDirectEntry:d?.__webDirectEntry}).restaurantId}function Ct(e=null,t=""){if(!e||typeof e!="object")return e;const a=String(t||"").trim();if(!a)return e;const s=String(e.canonicalRestaurantId||"").trim();return String(e.restaurantId||"").trim()===a&&s?e:{...e,restaurantId:a,...s?{canonicalRestaurantId:s}:{}}}function _a(e=""){const t=String(e||"").trim();return t?he(d,{profile:d?.profileView?.profile||d?.userProfile,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:t}).focus.canRenderFocus:!1}function fe(e={}){const t=String(ya(e)||"").trim();return t?ht(e?.price,t):ht(e?.price)}function za(e=[],t="",a=""){const s=String(t||"").trim(),i=String(a||"").trim();if(!s||!i)return"";const r=Array.isArray(e)?e:[];if(!r.length)return`${s}|${i}|empty`;const o=[];return r.forEach(l=>{const c=String(we(l)||l?.id||"").trim();c&&o.push(c)}),o.length?(o.sort(),`${s}|${i}|${o.join(",")}`):`${s}|${i}|empty`}function Ra(e=[],t=""){const a=String(d.user?.uid||"").trim(),s=za(e,t,a);s&&ee.inFlightKey!==s&&ee.key!==s&&(ee.key=s,ee.inFlightKey=s,ma(e,t).catch(i=>{console.error(i),ee.key===s&&(ee.key="")}).finally(()=>{ee.inFlightKey===s&&(ee.inFlightKey="")}))}function Ma(e={}){const t=String(e?.uid||"").trim();if(t&&d.followingTargetIds.includes(t))return!0;const a=String(e?.restaurantId||"").trim();if(a&&d.followingTargetIds.includes(a))return!0;const s=Ca(e?.handle||"");return!!(s&&d.followingHandles.includes(s))}function Pt(e={}){if(e?.specialEnabled===!0)return!0;if(e?.specialEnabled===!1)return!1;const t=String(e?.restaurantId||"").trim();if(!t)return!1;const a=typeof pe=="function"&&pe(t)||null;return a?.specialEnabled===!0?!0:(a?.specialEnabled===!1,!1)}function Ea(e={}){return ne(e)==="testfirst_special"?!0:String(e?.category||"").trim().toLowerCase()==="special"}function jt(e,t,a=!0,{includeImageKey:s=!0}={}){const i=ia(e),r=e.id?String(e.id):"",o=r?`data-open-post="${n(r)}"`:"",l=r?`data-post-like-count="${n(r)}"`:"",c=r?`data-post-comment-count="${n(r)}"`:"",f=s&&r?`data-img-key="profile-post:${n(r)}"`:"",u=e.type==="wide"||e.type==="hero",p=t&&u?"col-span-2":"",m=t&&u?"aspect-[1.8/1]":"aspect-[4/5]",b=U(e.url,u?"large":"medium",{stableKey:r?`profile-post:${r}`:"",variantGroup:"post-detail"}),k=u?800:400,v=u?400:500;return`
  ...
  `}function qe(e,t,a=!0,{includeImageKeys:s=!0}={}){const i=t==="grid";if(!e.length)return`
    ...
    `;const r=e.map(l=>jt(l,i,a,{includeImageKey:s})),o=e.reduce((l,c)=>{const f=c?.type==="wide"||c?.type==="hero";return l+(f?2:1)},0);return i&&o%2===1&&r.unshift(`
  ...
  `}function Lt(e={}){const t=Qe(e),a=Da(t),s=K(t,["address","primaryAddress","location","formattedAddress","street"]),i=K(t,["city","locationCity","primaryCity","region","country"]),r=K(t,["beachDistance","distanceToBeach","beachDistanceLabel","strandEntfernung"]),o=K(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),l=K(t,["rating","reviewRating","stars","hotelStars"]),c=K(t,["reviewCount","reviewsCount","ratingsCount","commentsCount"]),f=qa(t),u=a?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${a.lat},${a.lng}`)}`:s||i?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${s} ${i}`.trim())}`:"";return`
    <div class="app-content-inline flex flex-col gap-4 app-main-content-safe animate-in fade-in duration-300">
      ...
      <div class="grid grid-cols-1 gap-4">
        ...
        ${Fe({iconName:"waves",label:"Plazhi",value:r||(t.beachfront||t.onBeach?Ft:"Shto detajet")})}
  ...
  `}function an(e={}){const t=Qe(e),a=String(e?.restaurantId||t.restaurantId||t.id||"").trim(),s=t?.name||t?.restaurantName||e?.name||"Hotel",i=Va(a),r=String(i.status||"").trim(),o=i.saving===!0,l=Array.isArray(i.existingImages)?i.existingImages.map(_=>String(_||"").trim()).filter(Boolean):Ha(t),c=Array.isArray(i.imagePreviews)?i.imagePreviews.map(_=>String(_||"").trim()).filter(Boolean):[],f=String(i.imageUrlDraft||"").trim(),[u,p,m]=Ka(t),b=en(t,[u,p,m]),k=K(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),v=K(t,["distanceBeach","distanceToBeach","beachDistance","beachDistanceLabel","strandEntfernung","lakeDistance","distanceToLake"]),S=K(t,["hotelStartingPrice","startingPrice","priceFrom","fromPrice","bestPrice","roomStartingPrice"]),P=t.directCenter===!0||t.inCenter===!0||t.cityCenterDirect===!0,w=t.beachfront===!0||t.onBeach===!0||t.amStrand===!0,I=i.detailsOpen===!0||o,F=c[0]||l[0]||"",A=F?U(F,"thumb"):N,L=[k,v,S?`${S} €`:""].filter(Boolean).join(" · ")||"Plotëso detajet",$=r.includes("fehl")||r.includes("Bitte")||r.includes("Nuk");return`
      ...
      ${a?`
        ...
        <div data-hotel-card-editor="${n(a)}" data-hotel-card-details-panel class="${I?"":"hidden "}bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
            ...
            <div>
              ...
              ${tn({existingImages:l,newPreviews:c,imageUrlDraft:f})}
            </div>

            <div class="grid grid-cols-1 gap-4">
              ${At({idPrefix:"hotelCardDistanceCenter",iconName:"navigation",label:"Qendra",value:k,directLabel:Qa,direct:P})}
              ${At({idPrefix:"hotelCardDistanceBeach",iconName:"waves",label:"Plazhi",value:v,directLabel:Ft,direct:w})}
              <div>
            ...
            <div class="grid grid-cols-1 gap-4">
              ${We({id:"hotelCardFeatureOneText",iconName:"utensils",label:"Ushqimi",value:u,options:Wa})}
              ${We({id:"hotelCardFeatureTwoText",iconName:"waves",label:"Shezlongë",value:p,options:Ya})}
              ${We({id:"hotelCardFeatureThreeText",iconName:"square-parking",label:"Parking",value:m,options:Za})}
              <div>
...
`))}</textarea>
  ...
  `}function Ze(e=d.profileView?.profile||d.userProfile,{landingPreview:t=!1,selectedTabOverride:a="",compact:s=!1}={}){const i=Ce(e),r=String(a||Ae(e)).trim().toLowerCase()||"posts",o=Pe(e),l=Q(e),c=o?"Details":l?"Shop":g("nav.menu","Menue"),f=i?[{id:"posts",label:g("profile.posts","Beitraege")},{id:"menu",label:c,surface:o?"hotel-details":"menu"}]:[{id:"posts",label:g("profile.posts","Beitraege")},{id:"media",label:g("profile.media","Medien")},{id:"checkins",label:g("profile.checkins","Check-ins")}];return`
  ...
  `}function Et(e={},t={}){const a=t.mode==="self"?"self":"public",s=t.disabledBlockClass||"",i=un(e,a),r=a==="self"?"avatar:self":`avatar:public:${i}`,o=t.avatarUrl||U(e.avatar||"","avatar",{stableKey:r}),l=t.avatarFit||De(!!e.restaurantId),c=String(d?.profileCardInfoOpen||"")===i,f=Number(d?.profileCardInfoHeights?.[i]||0),u=c&&Number.isFinite(f)&&f>0?`height:${Math.ceil(f)}px;`:"",p=t.avatarImgKeyAttr||(a==="self"?'data-img-key="avatar:self"':`data-img-key="avatar:public:${n(i)}"`),m=t.renderAvatarImage===!0?!!String(o||"").trim()&&!O(o):t.renderAvatarImage!==!1&&!!String(o||"").trim()&&!O(o)&&!!String(e?.avatar||"").trim(),b=!!t.identityPending,k=t.followersLabel??B(e.followers),v=D(e?.name)||"User",S=D(t.typeLabel||e?.customerType||e?.type||"Business"),P=D(e?.location||"-"),w=a==="public"?`${P} / ${S}`:P,I=t.bioHtml||n(e?.bio||"").replace(/\n/g,"<br>")||n(g("profile.noBio","Noch keine Bio.")),F=`business-cover:${i}`,A=ln(e,i),L=gn(e,{cacheKeys:A,stableKey:F,allowCacheFallback:t.allowTitleImageCacheFallback===!0}),$=bn(e),_=pn(e),z=Le(_?{buttonAttrs:`data-marketplace-open-map="${n(_)}"`,label:g("profile.openMap","Karte oeffnen"),iconName:"map"}:{href:$,label:g("profile.openMap","Karte oeffnen"),iconName:"map"}),R=Mt(e?.instagramUrl||e?.instagram||e?.insta||"","instagram"),h=Mt(e?.tiktokUrl||e?.tiktok||e?.tikTok||"","tiktok"),j=D(e?.phone||e?.telephone||e?.contactPhone||""),T=mn(j),M=D(e?.address||e?.locationLabel||[e?.place||e?.locationPlace,e?.location||e?.city].map(q=>D(q)).filter(Boolean).join(", ")),E=[Te({href:R,iconName:"instagram",eyebrow:"Instagram",value:e?.instagram||e?.instagramUrl||e?.insta||""}),Te({href:h,iconName:"music-2",eyebrow:"TikTok",value:e?.tiktok||e?.tiktokUrl||e?.tikTok||""})].filter(Boolean).join(""),H=a==="self"?`
    ...
    `;if(c){const q=[Te({href:T,iconName:"phone",eyebrow:g("profile.call","Anrufen"),value:j}),Te({href:$,iconName:"map-pin",eyebrow:g("profile.address","Adresse"),value:M||P}),E].filter(Boolean).join("");return`
  ...
  `}function _e(e={},t=[],{topTabOverride:a="",tutorialMode:s=!1,contentTabOverride:i="",landingHideContent:r=!1,collapseIdentity:o=!1,contentReveal:l=!1,landingMode:c=!1}={}){const f=Ma(e),u=!!e.privateAccount&&e.uid&&String(e.uid)!==String(d.user?.uid||"")&&!f,p=!!e.pendingFollowRequest&&!f,m=e.restaurantId?"Business":g("nav.user","User"),b=String(e.handle||ft(e.name||"user")).replace(/^@/,""),v=n(e.bio||"").replace(/\n/g,"<br>")||n(g("profile.noBio","Noch keine Bio.")),S=Ce(e),P=String(a||Ye(e)).trim().toLowerCase()||"profile",w=String(i||Ae(e)).trim().toLowerCase()||"posts",I=w==="menu",F=w==="checkins",A=t,$={...d?.profileView&&typeof d.profileView=="object"?d.profileView:{},profile:e,posts:Array.isArray(A)?A:[]},_=es(d,{profileView:$,profileTopTab:P,profileContentTab:w}),z=String(_?.header?.status||"").trim().toLowerCase()||"loading",R=String(_?.posts?.status||"").trim().toLowerCase()||"loading",h=e.uid||e.restaurantId||b||"public",j=`avatar:public:${h}`,T=String(e?.avatar||"").trim(),M=U(T,"avatar",{stableKey:j}),E=De(!!e.restaurantId),H=c?"":`data-img-key="avatar:public:${n(h)}"`,q=!T&&!!String(M||"").trim()&&!O(M),G=!!T||q&&xe(z),re=pt=>{if(pt==null)return!1;const sa=Number(pt);return Number.isFinite(sa)&&sa>=0},ut=G||re(e?.followers)||re(e?.following),J=xe(z)&&!ut,ie=!!String(M||"").trim()&&!O(M)&&G,Me=J?"...":B(e.followers),Ee=J?"...":B(e.following),Ue=S?"pt-2":"pt-10",Be=f?g("profile.following","Following"):p?g("profile.requested","Requested"):u?g("profile.request","Request"):g("profile.follow","Follow"),me=f?"bg-slate-100 text-slate-600 shadow-none border border-slate-200":p?"bg-amber-50 text-amber-700 shadow-none border border-amber-200":"bg-gradient-to-r from-slate-900 to-slate-800 text-white border border-transparent",be=s?"select-none":"app-main-content-safe",X=s?"pointer-events-none":"",Y=!o,aa=!r,Ne=l?c?"transition-opacity duration-200":"animate-in fade-in duration-300":"",na=w==="posts"&&A.length>0,Yn=w!=="posts"||na||R==="empty"||R==="error",Zn=w==="posts"&&!na&&R==="error";return!s&&(w==="posts"||w==="media")&&e?.restaurantId&&xe(R)&&da(e),`
    <div class="${be}" ${s?'data-landing-tutorial-surface="true"':""}>
      ${P==="profile"||P==="menu"?`
      ${Y?`
        <div class="app-content-inline pb-2 ${Ue}">
          ${S?Et(e,{mode:"public",disabledBlockClass:X,avatarUrl:M,avatarFit:E,avatarImgKeyAttr:H,renderAvatarImage:ie,identityPending:J,followersLabel:Me,followLabel:Be,followTone:me,isFollowing:f,hasPendingFollowRequest:p,isLocked:u,bioHtml:v,typeLabel:m,allowTitleImageCacheFallback:xe(z)||xe(R)}):`
              ...
              <div class="flex justify-between items-start mb-8">
                <div class="relative">
                  <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500">
                    ${ie?`<img src="${n(M)}" data-fallback-src="${n(N)}" decoding="async" width="100" height="100" ${H} class="w-full h-full rounded-[1.8rem] ${E} border-2 border-white" />`:`<div class="w-full h-full rounded-[1.8rem] border-2 border-white bg-slate-100 flex items-center justify-center ${J?"animate-pulse":""}">${x(e.restaurantId?"store":"user","w-8 h-8 text-slate-300")}</div>`}
                  </div>
                  ${e.isPremium?`
                    <div class="absolute -bottom-1 -right-1 bg-white rounded-full p-1.5 shadow-lg text-blue-500 border-2 border-slate-50">
                      ${x("badge-check","w-4 h-4 fill-blue-500 text-white")}
      ...
      `:`
        ...
        ${aa?I?`
          <div class="${X} ${Ne}">
            ${Pe(e)?Lt(e):Re(e,{mode:c?"landing":"profile",allowAutoEnsure:!c})}
          </div>
        `:F?`
          <div class="${X} ${Ne}">
            ${Ge()}
      ...
      `}
      `:`
        ${P==="cart"?gt(e):P==="favorites"?mt(e):""}
      `}
    </div>
  `}function xn(){const e=d.profileView;if(!e||!e.profile)return"";const t=e.profile,a=e.posts||t.posts||[],s=Ye(t);return s==="landing"?rn(t):_e(t,a,{topTabOverride:s,tutorialMode:!1})}function Ut(e,{filter:t="all",query:a=""}={}){const s=Array.isArray(e)?e:[],i=Ia(a||"");return s.filter(r=>t==="all"||oe(r.type)===t?i?`${r.name||""} ${r.category||""} ${r.description||""}`.toLowerCase().includes(i):!0:!1)}function Bt(e,t=0){const a=Number(e);return Number.isFinite(a)?Math.max(0,Math.floor(a)):Math.max(0,Number(t)||0)}function ze(e=[]){return(Array.isArray(e)?e.slice():[]).map((a,s)=>({item:a,idx:s,order:Bt(a?.orderIndex,s)})).sort((a,s)=>a.order-s.order||a.idx-s.idx).map((a,s)=>({...a.item,orderIndex:Bt(a.item?.orderIndex,s)}))}function Xe(e={}){const t=String(e?.menuVisibility||"").trim().toLowerCase();return e?.menuHidden===!0||t==="hidden"}function ge(e={}){const t=String(e?.menuSection||e?.displaySection||e?.menuPlacement||"").trim().toLowerCase();return t==="drink"?"drink":t==="food"?"food":oe(e?.type||"food")==="drink"?"drink":"food"}function vn(e={}){return String(e?.category||g("menu.other","Sonstiges")).trim()||g("menu.other","Sonstiges")}function wn(e=""){const t=String(e||"").trim().toLowerCase();return t?(typeof t.normalize=="function"?t.normalize("NFD").replace(/[\u0300-\u036f]/g,""):t).replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""):""}const yn=4,$n={thumb:160,small:480,medium:768,large:1280};function Nt({mode:e="profile",priorityIndex:t=-1,slideIndex:a=0}={}){return(e==="profile"||e==="landing")&&Number.isFinite(t)&&t>=0&&t<yn&&a===0}function kn({mode:e="profile",priorityIndex:t=-1,slideIndex:a=0}={}){const s=Nt({mode:e,priorityIndex:t,slideIndex:a}),i=e==="profile"?' data-image-reveal="menu"':"";return s?`loading="eager" fetchpriority="high"${i}`:`loading="lazy" fetchpriority="low"${i}`}function Sn({variant:e="grid"}={}){return e==="thumb"?"(max-width: 640px) 64px, 64px":e==="hero"?"(max-width: 640px) 94vw, (max-width: 1200px) 74vw, 920px":"(max-width: 640px) 48vw, (max-width: 1200px) 28vw, 360px"}function ae(e,{mode:t="profile",priorityIndex:a=-1,slideIndex:s=0,stableKey:i="",preferredSize:r="small",candidateSizes:o=["small","medium","large"],variant:l="grid"}={}){const c=String(e||"").trim(),f=t==="profile"&&i?{stableKey:i}:null,u=Nt({mode:t,priorityIndex:a,slideIndex:s}),p=t==="profile"&&!u&&l!=="thumb",m=U(c,r,f),b=O(m)?N:m,k=va(c),v=wa(c)&&c!==b?c:k,S=[],P=new Set;o.forEach(h=>{const j=$n[h]||0;if(!j)return;const T=U(c,h,f);if(!T||O(T))return;const M=`${T}|${j}`;P.has(M)||(P.add(M),S.push(`${T} ${j}w`))});const w=S.length>1?S.join(", "):"",I=w?Sn({variant:l}):"",F=p?"":w,A=p?"":I,L=F?` srcset="${n(F)}"`:"",$=A?` sizes="${n(A)}"`:"",_=kn({mode:t,priorityIndex:a,slideIndex:s}),z=`${_}${L}${$}`,R=p?[`data-menu-lazy-src="${n(b)}"`,`data-menu-lazy-fallback="${n(v||N)}"`,w?`data-menu-lazy-srcset="${n(w)}"`:"",I?`data-menu-lazy-sizes="${n(I)}"`:""].filter(Boolean).join(" "):"";return{safeImg:p?N:b,fallbackImg:p?N:v,imageAttrs:z,lazyAttrs:R?` ${R}`:"",srcsetValue:w,sizesValue:I,loadingAttrs:_}}function ce(e=[],t,a=null){const s=a instanceof Set?a:new Set;return e.map((i,r)=>{const o=vn(i),l=wn(o),c=!!l&&!s.has(l);return c&&s.add(l),`<div${c?` data-menu-category-anchor="${n(l)}"`:""} class="h-full">${t(i,r)}</div>`}).join("")}function et(e={}){return String(e?.specialSize||e?.specialCardSize||"").trim().toLowerCase()==="food"?"food":"default"}function In(e=""){const t=String(e||"").trim();return t?/^(https?:\/\/|mailto:|tel:)/i.test(t)?t:`https://${t.replace(/^\/+/,"")}`:""}function Dt(e={}){const t=String(e?.specialActionType||e?.actionType||"").trim().toLowerCase(),a=In(e?.specialActionUrl||e?.linkUrl||e?.actionUrl||""),s=String(e?.specialActionProductId||e?.targetProductId||"").trim();return t==="link"&&a?{type:"link",url:a,productId:""}:t==="product"&&s?{type:"product",url:"",productId:s}:{type:"self",url:"",productId:""}}function Ht(){const e=Q(d.userProfile),t=String(d.menu.filter||"all").trim().toLowerCase()||"all",a=e&&t==="drink"?"all":t;return`
  ...
  `}function tt(e,{poster:t="",objectPosition:a="50% 50%"}={}){if(!ra(e))return"";const s=String(e.videoUrl||"").trim(),i=t?` poster="${n(t)}"`:"";return(s?`<video data-autoplay-video src="${n(s)}"${i} class="absolute inset-0 w-full h-full object-cover pointer-events-none z-[1]" style="object-position:${a};" muted loop playsinline autoplay preload="metadata"></video>`:"")+'<div class="absolute top-3 left-3 w-7 h-7 rounded-full bg-black/35 backdrop-blur-md text-white flex items-center justify-center pointer-events-none z-10"><svg viewBox="0 0 24 24" class="w-3.5 h-3.5 fill-white block"><path d="M8 5v14l11-7z"></path></svg></div>'}function at(e,{mode:t="profile",priorityIndex:a=-1}={}){const s=Z(e),i=t==="profile"?ue(e,{index:0}):"",{safeImg:r,fallbackImg:o,imageAttrs:l,lazyAttrs:c}=ae(s,{mode:t,priorityIndex:a,stableKey:i,preferredSize:"thumb",candidateSizes:["thumb","small"],variant:"thumb"}),f=fe(e),u=d.activeTab==="menu"?d.userProfile:d.profileView?.profile||d.userProfile,p=Q(u),m=It(e,p),b=p?St(e.category):e.category||"",k=e.description||"";return t==="admin"?`
  ...
  `}function nt(e,{mode:t="profile",variant:a="food",priorityIndex:s=-1}={}){const i=Z(e),r=t==="profile"?ue(e,{index:0}):"",o=a==="drink",{safeImg:l,fallbackImg:c,imageAttrs:f,lazyAttrs:u}=ae(i,{mode:t,priorityIndex:s,stableKey:r,preferredSize:o?"small":"medium",candidateSizes:o?["small","medium"]:["small","medium","large"],variant:o?"grid":"hero"}),p=fe(e),m=d.activeTab==="menu"?d.userProfile:d.profileView?.profile||d.userProfile,b=Q(m),k=It(e,b),v=b?St(e.category):e.category||"",S=e.description||"",P=t==="profile"?`data-menu-open="${n(e.id)}" role="button"`:"",w=d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"",I=we(e),F=vt(w,I),A=F?wt(F):{likes:[],comments:[],counts:{likes:0,comments:0}},L=yt(A),$=`
  ...
  `;return`
    <div ${P} class="w-full ${o?"h-full p-3 rounded-[1.6rem] flex flex-col":"p-4 rounded-[2rem]"} bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all ${t==="profile"?"cursor-pointer":""}">
      <div class="w-full ${o?"h-28 rounded-[1.4rem]":"h-44 rounded-[1.8rem]"} overflow-hidden bg-slate-100 relative">
        <img src="${n(l)}" data-fallback-src="${n(c)}"${u} class="w-full h-full object-cover" style="object-position:${V(e)};" ${f} decoding="async" />
        ${tt(e,{poster:l,objectPosition:V(e)})}
      </div>
      ${o?`
  ...
  `}function st(e={}){if(!e?.restaurantId||Q(e))return!1;const t=String(Oe(e)||"").trim().toLowerCase();return t?t==="restaurant"||t==="cafe"||t==="fastfood":se(e)}function Ot(e){const t=e?.restaurantId||d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"",a=we(e),s=vt(t,a),i=s?wt(s):{likes:[],comments:[],counts:{likes:0,comments:0}},r=String(d.user?.uid||"").trim(),o=String(d.user?.handle||"").trim().toLowerCase(),l=!!i.likes?.some(c=>{const f=String(c?.uid||"").trim();if(r&&f&&f===r)return!0;const u=String(c?.handle||"").trim().toLowerCase();return!!o&&!!u&&u===o});return{itemId:a,meta:i,counts:yt(i),isLiked:l}}function ue(e,{index:t=0}={}){const a=String(e?.restaurantId||d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"").trim(),s=String(e?.id||we(e)||"").trim();if(!a||!s)return"";const i=Number(t),r=Number.isFinite(i)?Math.max(0,Math.floor(i)):0;return`menu-detail:${a}:${s}:${r}`}function Pn(e){const t=typeof xt=="function"?xt(e):[],a=Array.isArray(t)?t.filter(Boolean):[];if(a.length)return a;const s=Z(e);return s?[s]:[]}function ne(e){return ts(e?.cardStyle||"",oe(e?.type||"food"))}function rt(e,{menuItemId:t=""}={}){if(!e)return null;const a=String(t||e.menuItemId||e.itemId||e.productId||"").trim();return{id:e.id||"",title:e.name||e.title||"Sot ne Fokus",text:e.description||e.text||"",imageUrl:Z(e)||e.imageUrl||"",objectPosition:e.objectPosition||V(e),menuItemId:a}}function C(e=""){return`<div aria-hidden="true" class="${e} bg-slate-100 animate-pulse"></div>`}function jn(e={}){return Ie("focus-carousel-skeleton",{...e,functionName:"renderFocusCarouselSkeleton",source:e?.source||"public-focus"}),`
  ...
  `}function Vt(e={}){return Ie("testfirst-menu-skeleton",{...e,functionName:"renderTestfirstMenuSkeleton",source:e?.source||"public-menu"}),`
  ...
  `}function Kt(e="food"){const t=e==="drink";return`
  ...
  `}function qt({isShop:e=!1,debugContext:t={}}={}){return Ie(e?"standard-shop-product-skeleton":"standard-menu-skeleton",{...t,functionName:"renderStandardMenuSkeleton",source:t?.source||"public-menu",reason:t?.reason||(e?"shop-products-loading":"menu-loading")}),e?`
      ...
      <div data-menu-skeleton="true"${W({skeleton:"standard-menu-skeleton",source:"public-menu"})} class="space-y-5">
        ...
        <div data-menu-type="drink">
          <div class="grid grid-cols-2 auto-rows-fr gap-4">
            ${Array.from({length:4},()=>Kt("drink")).join("")}
          </div>
        </div>
      </section>
      <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="food">
        ...
        <div data-menu-type="food">
          <div class="space-y-4">
            ${Array.from({length:2},()=>Kt("food")).join("")}
          </div>
        </div>
      </section>
    </div>
  `}function Gt(e,t=[],{mode:a="profile"}={}){const s=e?.restaurantId||"",i=st(e)||Q(e);return!s||!i||!t.length?"":`
    <div class="pt-2 pb-4">
      <div class="flex gap-4 overflow-x-auto hide-scrollbar snap-x horizontal-safe-scroll pb-4">
  ...
  `}function Qt(e,{mode:t="profile",priorityIndex:a=-1}={}){const s=Z(e),i=t==="profile"?ue(e,{index:0}):"",{safeImg:r,fallbackImg:o,imageAttrs:l,lazyAttrs:c}=ae(s,{mode:t,priorityIndex:a,stableKey:i,preferredSize:"small",candidateSizes:["small","medium"],variant:"grid"}),f=fe(e),u=t==="profile"?`data-menu-open="${n(e.id)}" role="button"`:"",{itemId:p,counts:m,isLiked:b}=Ot(e);return`
    <div ${u} class="h-full bg-white p-2.5 rounded-[1.8rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.03)] flex flex-col group relative ${t==="profile"?"cursor-pointer":""}">
      <div class="w-full aspect-square rounded-[1.4rem] overflow-hidden bg-slate-100 mb-3 relative">
        ...
        ${tt(e,{poster:r,objectPosition:V(e)})}
        <button
          type="button"
  ...
  `}function _n(e,t="profile"){if(t!=="profile")return"";const a=Dt(e);return a.type==="link"&&a.url?`data-menu-special-link="${n(a.url)}" role="button" tabindex="0"`:a.type==="product"&&a.productId?`data-menu-open="${n(a.productId)}" role="button"`:`data-menu-open="${n(e.id)}" role="button"`}function it(e,{mode:t="profile",size:a="default",priorityIndex:s=-1}={}){const i=Z(e),r=t==="profile"?ue(e,{index:0}):"",o=a==="food",{safeImg:l,fallbackImg:c,imageAttrs:f,lazyAttrs:u}=ae(i,{mode:t,priorityIndex:s,stableKey:r,preferredSize:o?"medium":"small",candidateSizes:o?["small","medium","large"]:["small","medium"],variant:o?"hero":"grid"}),p=_n(e,t),m=String(e.category||"Special").trim()||"Special",b=n(String(e.name||"Special")).replace(/\n/g,"<br>");return a==="food"?`
      <div ${p} class="rounded-[2.2rem] shadow-[0_8px_30px_rgb(0,0,0,0.06)] relative overflow-hidden mb-5 group aspect-[16/9] ${t==="profile"?"cursor-pointer":""}" style="border-radius:2.2rem;aspect-ratio:16 / 9;margin-bottom:20px;">
        <img src="${n(l)}" data-fallback-src="${n(c)}"${u} class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 select-none pointer-events-none" draggable="false" style="width:100%;height:100%;object-fit:cover;object-position:${V(e)};" ${f} decoding="async" />
        ${tt(e,{poster:l,objectPosition:V(e)})}
  ...
  `}function Wt(e,{mode:t="profile",priorityIndex:a=-1}={}){const s=fe(e),i=t==="profile"?`data-menu-open="${n(e.id)}" role="button"`:"",r=Pn(e),l=(r.length?r:[Z(e)||""]).filter(Boolean),c=l.length?l.slice(0,12):[""],f=c.length>1,{itemId:u,counts:p,isLiked:m}=Ot(e),b=B(Math.max(0,Number(p.likes)||0)),k=B(Math.max(0,Number(p.comments)||0));return`
  ...
  `}function zn(e,t,{mode:a="profile",publicMenuSurfaceState:s=null,focusFallbackHtml:i=""}={}){const r=ze(Array.isArray(t)?t:[]),o=String(e?.restaurantId||"").trim(),l=a==="admin"||_a(o),c=s?.focus?.canRenderFocus?{items:Array.isArray(s.focus.items)?s.focus.items:[],enabled:!0}:o&&l?ye(o):{items:[],enabled:!1},f=c.enabled?(Array.isArray(c.items)?c.items:[]).map(h=>rt({...h,objectPosition:le(h)})):[],u=r.filter(h=>ne(h)==="testfirst_focus"&&!Xe(h)).map(h=>rt(h,{menuItemId:h.id||""})).filter(Boolean),p=new Set,m=[...f,...u].filter(h=>{const j=String(h.menuItemId||h.id||`${h.title}|${h.text}|${h.imageUrl}`);return!j||p.has(j)?!1:(p.add(j),!0)}),b=r.filter(h=>!Xe(h)),k=b.filter(h=>ne(h)!=="testfirst_focus"),v=k.length?k:b,S=k.length?m:[],P=v.filter(h=>ge(h)==="drink"),w=v.filter(h=>ge(h)!=="drink"),I=(h=[])=>{const j=[],T=[];return h.forEach(M=>{const E=ne(M);E==="testfirst_food"||E==="testfirst_special"&&et(M)==="food"?T.push(M):j.push(M)}),{gridItems:j,foodItems:T}},F=(h,j=-1)=>ne(h)==="testfirst_special"?it(h,{mode:a,priorityIndex:j}):Qt(h,{mode:a,priorityIndex:j});let A=0;const L=()=>{const h=A;return A+=1,h},$=new Set,_=(h,j)=>!j.gridItems.length&&!j.foodItems.length?"":`
      <section class="menu-type-block relative" data-menu-type-block="${n(h)}">
        ...
        ${j.foodItems.length?`
          <div class="menu-category-section pb-6 pt-4" data-menu-type="${n(h)}">
            <div class="app-content-inline">
              ${ce(j.foodItems,T=>{const M=ne(T),E=L();return M==="testfirst_special"?it(T,{mode:a,size:"food",priorityIndex:E}):Wt(T,{mode:a,priorityIndex:E})},$)}
            </div>
          </div>
        `:""}
      </section>
  ...
  `}function Yt(e,{mode:t="profile",useTestfirstCardUi:a=!1,seenCategories:s=null,priorityOffset:i=0}={}){return e.length?a?`
      <div class="grid grid-cols-2 auto-rows-fr gap-3">
        ${ce(e,(r,o)=>Qt(r,{mode:t,priorityIndex:i+o}),s)}
      </div>
    `:`
    <div class="grid grid-cols-2 auto-rows-fr gap-4">
  ...
  `:""}function Zt(e,{mode:t="profile",useTestfirstCardUi:a=!1,seenCategories:s=null,priorityOffset:i=0}={}){return e.length?a?`
      <div>
        ${ce(e,(r,o)=>ne(r)==="testfirst_special"&&et(r)==="food"?it(r,{mode:t,size:"food",priorityIndex:i+o}):Wt(r,{mode:t,priorityIndex:i+o}),s)}
      </div>
    `:`
    <div class="space-y-4">
      ${ce(e,(r,o)=>nt(r,{mode:t,variant:"food",priorityIndex:i+o}),s)}
    </div>
  `:""}function Jt(e,{mode:t="profile"}={}){if(t==="admin"){const a=String(d?.menu?.filter||"all").trim().toLowerCase(),s=Q(d.userProfile),i=g("menu.products","Produkte"),r=e.filter(u=>oe(u?.type)==="drink"),o=e.filter(u=>oe(u?.type)!=="drink"),l=(u,p,{addType:m=""}={})=>`
      <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
        <div class="flex items-center justify-between mb-4">
          <div>
        ...
        ${p.length?`<div class="space-y-3">${p.map(b=>at(b,{mode:"admin"})).join("")}</div>`:(Se({functionName:"renderMenuList.adminSection",items:p,rawItems:p,filteredItems:p,renderDecision:"admin-section-no-products",source:"admin-menu"}),`<div class="text-center py-10 text-[10px] font-bold uppercase tracking-widest text-slate-300"${W({source:"admin-menu:no-products"})}>${n(g("menu.noProducts","Keine Produkte"))}</div>`)}
      </div>
  ...
  `}function Xt(e={}){if(!e?.restaurantId)return!1;const t=String(Oe(e)||"").trim().toLowerCase();return["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"].includes(t)||t==="ecommerce"||Q(e)?!1:se(e)||["restaurant","cafe","coffee","fastfood","food"].includes(t)||!t}function Rn(e={}){if(e.active===!1)return{label:"Inaktiv",className:"text-slate-400"};const t=String(e.status||e.approvalStatus||"pending").trim().toLowerCase();return t==="approved"?{label:"Freigegeben",className:"text-emerald-600"}:t==="rejected"?{label:"Abgelehnt",className:"text-rose-600"}:{label:"Wartet auf Heart",className:"text-amber-600"}}function Mn(e,t){if(!t||!Xt(e))return"";const{items:a,loading:s}=$a(t,{includeInactive:!0}),i=B(a.length);return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(r=>{const o=U(r.imageUrl||"","thumb"),l=O(o)?N:o,c=Rn(r),f=r.category||"RESTAURANT",u=r.priceSegment||"€€ - €€€";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
        ...
        <div class="rounded-[1.8rem] border border-slate-100 bg-slate-50 p-4">
          ...
          ${A.length?`
            <div class="grid grid-cols-1 gap-2">
              ${A.map($=>{const _=w.has($.id),z=$.imageUrl||N,R=String($.defaultImageRaw||$.imageCandidates[0]?.rawUrl||"").trim(),h=String($.cardImageUrl||"").trim(),j=String($.previewImageUrl||"").trim(),T=!!(j||h&&h!==R),M=j||(h&&!$.imageCandidates.some(E=>E.rawUrl===h)?h:"");return`
                    ...
                    ${_?`
                      <div class="mt-3 pt-3 border-t border-slate-100">
                        ...
                        <div class="flex gap-2 overflow-x-auto hide-scrollbar pb-1">
                          ${$.imageCandidates.map((E,H)=>{const q=H===0,G=j?!1:q?!T:h===E.rawUrl;return`
                              <label class="shrink-0 w-16">
                                <input type="radio" name="shoppingLandingProductImage_${n($.id)}" data-shopping-landing-product-image-choice="${n($.id)}" value="${q?"":n(E.rawUrl)}" class="hidden" ${G?"checked":""} />
                                <span class="block h-16 rounded-2xl overflow-hidden border ${G?"border-slate-900":"border-slate-100"} bg-slate-100">
                                  <img src="${n(E.imageUrl)}" class="w-full h-full object-cover" loading="lazy" decoding="async" />
                                </span>
                          ...
                          ${M?`
                            <label class="shrink-0 w-16">
                              <input type="radio" name="shoppingLandingProductImage_${n($.id)}" data-shopping-landing-product-image-choice="${n($.id)}" value="${n(M)}" class="hidden" checked />
                              <span class="block h-16 rounded-2xl overflow-hidden border border-slate-900 bg-slate-100">
                                <img src="${n(U(M,"thumb"))}" class="w-full h-full object-cover" loading="lazy" decoding="async" />
                              </span>
  ...
  `}function Kn(e){if(!st(e)||!Pt(e))return"";const a=ze((d.menu.items||[]).filter(s=>ne(s)==="testfirst_special"));return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      ${a.length?`
        <div class="space-y-3">
          ${a.map(s=>{const i=U(Z(s),"thumb"),r=O(i)?N:i,o=Dt(s),l=o.type==="link"?"Link":o.type==="product"?"Produkt-Modal":"Diese Karte",c=et(s)==="food"?"Food-Size":"Normal",f=La(ge(s));return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function ea(e,{restaurantId:t="",suppressLoading:a=!1,allowAutoEnsure:s=!0,requirePublicMenuTruth:i=!0}={}){const r=String(t||e?.canonicalRestaurantId||e?.restaurantId||"").trim();if(!r||!se(e))return"";const o=he(d,{profile:e,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:r});if(i&&o.menu.status!=="ready")return"";const l=!i||o.focus.canRenderFocus;if(s&&!d.focus.loading&&!l&&ve(Ct(e,r)),i&&!l)return"";const{items:c,loading:f}=l?{items:Array.isArray(o.focus.items)?o.focus.items:[],loading:o.focus.loading}:ye(r);if(!(l?!0:ye(r).enabled)||!c.length&&!f||a&&f&&!c.length)return"";if(f&&!c.length)return`
    ...
    `;const p=ka(c),m=c[p]||c[0],{safeImg:b,fallbackImg:k,imageAttrs:v,lazyAttrs:S}=ae(m.imageUrl||"",{mode:"profile",priorityIndex:0,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:m?.id?`focus-carousel:${r}:${String(m.id)}`:""}),P=m.text||"";return`
    <div id="focusCarousel" class="${He()} rounded-[2.5rem] p-6 border shadow-sm">
      ...
      ${c.length>1?`
        <div class="flex items-center justify-center gap-2 mt-4">
          ${c.map((I,F)=>`
            <button type="button" data-focus-dot="${F}" class="w-2.5 h-2.5 rounded-full ${F===p?"bg-slate-900":"bg-slate-200"}"></button>
          `).join("")}
        </div>
      `:""}
    </div>
  `}function qn(e,t=220){const a=encodeURIComponent(e||"");return`https://api.qrserver.com/v1/create-qr-code/?size=${t}x${t}&data=${a}`}function ta({label:e,url:t,caption:a}){if(!t)return"";const s=qn(t,240);return`
  ...
  `}function Gn({profile:e,restaurantId:t,catalogLabel:a}){if(!t||!se(e))return"";if(typeof bt=="function"){const r=$e?$e(t):null;(!r||r.sameRestaurant!==!0||!r.loading&&!r.loaded&&!r.error)&&bt(e)}const s=typeof $e=="function"?$e(t):{enabled:!0,count:0,tables:[],loading:!1,saving:!1,error:""},i=(s.tables||[]).map(r=>{const o=Sa("apps/menyra-social/index.html",{r:t,tab:"menu",source:"qr",table:r});return ta({label:`Tisch ${r}`,url:o,caption:`${a} fuer Tisch ${r}`})}).join("");return`
  ...
  `}function Qn(){const e=d.userProfile,t=e.restaurantId||"",a=String(d.user?.uid||"").trim(),s=String(d.__authBootstrapInFlightUid||"").trim(),i=!t&&!!a&&(!!d.__authProfileLoadPromise||s===a),r=Pe(e),o=se(e),l=d.profileView?.profile?.restaurantId?d.profileView.profile:null,c=la()&&!!l?.restaurantId&&se(l),f=Q(e),u=Aa(fa(e)),p=t?pe(t):null,m=p?.name||p?.restaurantName||e.name||"Business",b=t&&d.menu.restaurantId===t,k=String(d.menu.source||"").trim().toLowerCase(),v=!!b&&k==="collection",S=!!b&&k==="collection"&&d.menu.loading,P=!!t&&(S||!v),w=f?"all":d.menu.filter,I=v?Ut(d.menu.items,{filter:w,query:d.menu.query}):[],A=Pt(e)?I:I.filter(_=>!Ea(_)),L=ze(A),$=B(L.length);if(t&&r){Na(e);const _=String(d.focus?.truthSource||"").trim().toLowerCase();return!d.focus.loading&&(d.focus.restaurantId!==t||_!=="public-menu")&&ve(e),an(e)}return t&&o&&!v&&!S&&ua(e),t&&o&&!d.focus.loading&&d.focus.restaurantId!==t&&ve(e),t&&Xt(e)&&pa(e),o?`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      <div class="flex items-end justify-between mb-6">
        <div>
      ...
      ${t?`
        ...
        ${P?`<div class="text-center py-12 text-[10px] font-bold uppercase tracking-widest text-slate-400">${n(g("menu.loading",`${u} wird geladen...`,{label:u}))}</div>`:Jt(L,{mode:"admin"})}
  ...
  `:c?Re(l):`
    ...
    `;const l=Ct(e,o),c=Q(l),f=se(l)&&!c;f&&(r=he(d,{profile:l,routePayload:s,webDirectEntry:i,restaurantId:o}));const u=String(i?.canonicalRestaurantId||i?.restaurantId||"").trim(),p=new Set(r.targetIds),m=r.menu.status==="ready",b=r.focus.canRenderFocus,k=m&&f,v=r.focus.matches===!0&&r.focus.loading===!0,P=String(d?.profileView?.menuAccessSource||i?.menuAccessSource||s?.menuAccessSource||"").trim().toLowerCase()==="qr",w=i?.active===!0&&i?.webPriority===!0&&i?.menuFirst===!0&&String(d?.activeTab||"").trim().toLowerCase()==="profile"&&String(d?.profileTopTab||"").trim().toLowerCase()==="menu"&&(u===o||p.has(o)),I=w&&!P,F=["ready","empty","error"].includes(r.menu.status),A=w&&F,L=w&&(!k||r.menu.status!=="ready"),$=!k||r.focus.settled===!0||r.focus.confirmedEmpty===!0||r.menu.status!=="ready";a&&!A&&!F&&ca(l),a&&!L&&!$&&!v&&m&&(!I||F)&&ve(l);const z=r.menu.canRenderItems?ze(Ut(r.menu.items,{filter:"all",query:""})).filter(Y=>!Xe(Y)):[],R=r.menu.error||"",h=Jn(r.menu,z),{hasItems:j,hasError:T,isLoading:M,shouldRenderNoProducts:E}=h;Pa({profile:l,routePayload:s,surface:r,decision:h});const H={profile:l,routePayload:s,surface:r,decision:h,rawItems:r.menu.items,items:z,filteredItems:z,source:"public-menu"},q=Fa(r,z),G=z.filter(Y=>ge(Y)==="drink"),re=z.filter(Y=>ge(Y)!=="drink"),ut=0,J=G.length,ie=st(e),Me=ie||c,Ee=new Set;j&&o&&(ga(z,o),Ra(z,o));const Ue=o&&b?(Array.isArray(r.focus.items)?r.focus.items:[]).map(Y=>rt({...Y,objectPosition:le(Y)})).filter(Boolean):[],Be=r.focus.status==="empty"||r.focus.status==="error",me=f&&!b&&!Be&&r.menu.status!=="empty"&&r.menu.status!=="error",be=Ue.length?Gt(l,Ue,{mode:t}):me?Fn({...H,reason:"focus-truth-pending"}):"",X=Me?be:ea(l,{restaurantId:o,suppressLoading:!0,allowAutoEnsure:m&&(!I||F),requirePublicMenuTruth:!0})||(me?jn({...H,reason:"focus-truth-pending"}):"");return ie?`
      <div class="app-main-content-safe"${q}>
        ${M?`
          ${be}
          ${Vt({...H,reason:"menu-loading"})}
        `:`
          ${j?zn(l,z,{mode:t,publicMenuSurfaceState:r,focusFallbackHtml:be}):T?`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${n(g("menu.loadError","Menu konnte nicht geladen werden"))}</div>`:E?(Se({...H,functionName:"renderProfileMenuView",renderDecision:"testfirst-no-products"}),`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300"${W({source:"public-menu:no-products"})}>${n(g("menu.noProducts","Keine Produkte"))}</div>`):Vt({...H,reason:"menu-not-confirmed-empty"})}
    ...
    <div class="app-content-inline app-main-content-safe space-y-5"${q}>
      ${X}
      ${M?`
        ${qt({isShop:c,debugContext:{...H,reason:"menu-loading"}})}
      `:`
        ${j?`
          ${c?`
            ${ba(z,{profile:e})}
          `:`
            ${G.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="drink">
                ...
                <div data-menu-type="drink">
                  ${Yt(G,{mode:t,useTestfirstCardUi:ie,seenCategories:Ee,priorityOffset:ut})}
                </div>
              </section>
            `:""}
            ${re.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="food">
                ...
                <div data-menu-type="food">
                  ${Zt(re,{mode:t,useTestfirstCardUi:ie,seenCategories:Ee,priorityOffset:J})}
                </div>
              </section>
            `:""}
          `}
  ...
  `}function Wn(){const e=d.userProfile,t=oa(e),a=t?d.businessPosts:d.userPosts,s=String(d.user?.uid||e?.uid||"").trim(),i=String(e?.restaurantId||"").trim(),r=String(d.__userPostsLoadingUid||"").trim(),o=String(d.__businessPostsLoadingRestaurantId||"").trim(),l=String(d.__authBootstrapInFlightUid||"").trim(),c=!!s&&r===s,f=!!i&&o===i,u=!!s&&l===s,p=t?f||u&&!a.length:c||u&&!a.length,m=String(e.handle||ft(e.name||"user")).replace(/^@/,""),k=n(e.bio||"").replace(/\n/g,"<br>")||n(g("profile.noBio","Noch keine Bio.")),v=Ae(e),S=v==="menu",P=v==="checkins",w=a,I=U(e.avatar,"avatar"),F=De(t),A=Ye(e);return`
    <div class="app-main-content-safe">
      ...
      `}
      `:`
        ${A==="cart"?gt(e):A==="favorites"?mt(e):""}
      `}
    </div>
  `}return{renderProfilePostCardFancy:jt,renderProfilePostsFancy:qe,renderProfileCheckins:Ge,renderProfileTabs:Ze,renderProfileViewControls:Je,renderPublicProfileView:xn,renderMenuFilterRow:Ht,renderMenuLayoutSection:Cn,renderMenuItemCard:at,renderMenuItemCardStacked:nt,renderMenuDrinkGrid:Yt,renderMenuFoodList:Zt,renderMenuList:Jt,renderFocusAdminSection:ot,renderFocusCarousel:ea,renderMenuQrCard:ta,renderMenuAdminView:Qn,renderProfileMenuView:Re,renderProfileView:Wn}}export{xs as createProfileMenuFocusRenderController};
