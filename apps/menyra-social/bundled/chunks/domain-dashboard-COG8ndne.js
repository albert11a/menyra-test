const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/business-composer-controller-BSjvrr46.js","chunks/domain-feed-social-eager-D4CES9yO.js","chunks/domain-auth-Aq-4Vdvh.js","chunks/domain-public-profile-mLQti0eH.js","chunks/domain-media-eager-B3Bb4ghO.js","chunks/domain-menu-eager-QoBEIbVZ.js","chunks/domain-stories-L5z6TIba.js"])))=>i.map(i=>d[i]);
import{_ as oe}from"./domain-auth-Aq-4Vdvh.js";import{f as z,r as ie,l as de,s as M}from"./domain-analytics-jv5B-kA2.js";const U="mnyraDashboardStyles",le=`
.mnyra-dash {
...
`;function ce(e=typeof document>"u"?null:document){if(!(!e||e.getElementById(U)))try{const t=e.createElement("style");t.id=U,t.textContent=le,e.head?.appendChild(t)}catch{}}function m(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function $(e,t,o=""){if(typeof e!="function")return"";try{return e(t,o)||""}catch{return""}}const ue=Object.freeze(["hotel","motel","hostel","resort","accommodation","travel"]);function me({businessType:e="",isShopCatalog:t=!1}={}){if(t)return"shop";const o=String(e||"").trim().toLowerCase();return ue.includes(o)?"hotel":"restaurant"}function pe({kind:e="restaurant",isOwner:t=!1,canAccessOrders:o=!1}={}){const n=[{nav:"upload",uploadIntent:"chooser",iconName:"plus",label:"Neuer Beitrag",sub:"Posto foto ose video"},{nav:"upload",uploadIntent:"story",iconName:"camera",label:"Story",sub:"E dukshme 24h"}];return e==="hotel"?n.push({nav:"menu",iconName:"bed-double",label:"Hotel & Dhoma",sub:"Detaje, dhoma, oferta"}):e==="shop"?n.push({nav:"menu",iconName:"shopping-bag",label:"Ndrysho dyqanin",sub:"Produkte & Stok"}):n.push({nav:"menu",iconName:"utensils",label:"Ndrysho menune",sub:"Produkte & Kategorien"}),n.push({nav:"menu",iconName:"megaphone",label:"Oferta & Reklama",sub:"Im Editor verwalten"}),e!=="hotel"&&o&&n.push({nav:"orders",iconName:"shopping-cart",label:"Porosite",sub:"Hyrje & Status"}),n.push({nav:"analytics",iconName:"bar-chart-3",label:"Analytics",sub:"Te gjitha statistikat"}),t&&n.push({nav:"businessAccounts",iconName:"users-round",label:"Team & Staff",sub:"Zugänge verwalten"}),n.push({nav:"settings",iconName:"settings",label:"Cilesimet",sub:"Profili & Kontakti"}),n}function he(e="restaurant"){const t=[{key:"profileViews",label:"Profilaufrufe"},{key:"postImpressions",label:"Shtrirja e postimeve"},{key:"contactClicks",label:"Kontakt-Klicks"}];return e==="shop"?t.concat([{key:"ordersCompleted",label:"Porosite"},{key:"revenue",label:"Umsatz",unit:"€"},{key:"productViews",label:"Produkt-Aufrufe"}]):e==="hotel"?t.concat([{key:"uniqueVisitors",label:"Vizitore"},{key:"postLikes",label:"Likes"},{key:"feedImpressions",label:"Shtrirja ne feed"}]):t.concat([{key:"ordersCompleted",label:"Porosite"},{key:"revenue",label:"Umsatz",unit:"€"},{key:"qrScans",label:"QR-Scans"}])}function H(e=0,t=""){const o=z(e);return t?`${o} ${t}`:o}function fe(e=new Date().getHours()){const t=Number.isFinite(Number(e))?(Math.trunc(Number(e))%24+24)%24:12;return t>=5&&t<=10?{dayPart:"mengjes",text:"Ju urojmë një mëngjes të mbarë!"}:t>=11&&t<=17?{dayPart:"dite",text:"Ju urojmë një ditë të mbarë!"}:t>=18&&t<=21?{dayPart:"mbremje",text:"Ju urojmë një mbrëmje të mbarë!"}:{dayPart:"nate",text:"Ju urojmë një natë të mbarë!"}}function ye({name:e="",logoUrl:t="",hour:o=new Date().getHours(),iconFn:n}={}){const s=fe(o);return`
  ...
  `}function _e({kpiDefs:e=[],week:t={},today:o={}}={}){return`
    ...
    <div class="mnyra-dash__kpi">
      ...
      <p class="mnyra-dash__kpi-value">${m(H(t?.[s.key]||0,s.unit||""))}</p>
      <p class="mnyra-dash__kpi-today">Heute: ${m(H(o?.[s.key]||0,s.unit||""))}</p>
    </div>
  `).join("")}</div>
    </div>
  ...
  `}const Se="menyra_social_dashboard_cache_v1::",Pe=6,De=3;function N(e){const t=Number(e);return Number.isFinite(t)?t:0}function je(e={}){const t=String(e.createdAtClient||"").trim();if(t){const n=new Date(t);if(!Number.isNaN(n.getTime()))return n}const o=e.createdAt;if(o&&typeof o.toDate=="function")try{const n=o.toDate();if(n instanceof Date&&!Number.isNaN(n.getTime()))return n}catch{}return null}function Ce(e="",t={}){const o=Array.isArray(t.media)&&t.media.length?t.media[0]:{},n=String(o.type||t.mediaType||"image").trim().toLowerCase()==="video"?"video":"image",s=String(o.thumbUrl||(n==="image"?o.url:"")||t.thumbUrl||"").trim(),l=je(t);return{id:String(e||"").trim(),caption:String(t.caption||"").trim(),mediaType:n,thumbUrl:s,likesCount:N(t.likesCount),commentsCount:N(t.commentsCount),impressions:0,dateLabel:l?l.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit"}):"",createdAtMs:l?l.getTime():0}}function Fe({days:e=[],todayKey:t="",rawPosts:o=[]}={}){const n=Array.isArray(e)?e:[],s=M(n),l=n.find(c=>String(c?.date||c?.id||"").trim()===String(t||"").trim()),g=M(l?[l]:[]),I=s.merged?.posts&&typeof s.merged.posts=="object"?s.merged.posts:{},b=(Array.isArray(o)?o:[]).map(c=>Ce(c?.id,c?.data||{})).filter(c=>c.id).sort((c,_)=>_.createdAtMs-c.createdAtMs).slice(0,De).map(c=>({...c,impressions:N(I[c.id]?.impressions)}));return{day:String(t||"").trim(),week:s.summary,today:g.summary,posts:b}}function Ie({state:e,renderFn:t,documentObj:o,firestoreApi:n={},profileApi:s={},composerApi:l={},iconFn:g,storageObj:I}={}){const b=o||(typeof document>"u"?null:document),c=typeof t=="function"?t:()=>{},_=I||(typeof localStorage>"u"?null:localStorage),q=typeof s.getBusinessProfileTypeFn=="function"?s.getBusinessProfileTypeFn:(()=>""),K=typeof s.isShopCatalogProfileFn=="function"?s.isShopCatalogProfileFn:(()=>!1),V=typeof s.isBusinessOwnerProfileFn=="function"?s.isBusinessOwnerProfileFn:(()=>!1),J=typeof s.canAccessRestaurantOrdersFn=="function"?s.canAccessRestaurantOrdersFn:(()=>!1),T=typeof s.getRestaurantMetaByIdFn=="function"?s.getRestaurantMetaByIdFn:(()=>null),G=typeof s.resolveRestaurantLogoFn=="function"?s.resolveRestaurantLogoFn:(()=>""),Q=typeof s.resolveOwnAvatarUrlFn=="function"?s.resolveOwnAvatarUrlFn:(()=>"");let w=0,R=!1,v=null,S=null,P="",B=()=>null;const Y=300;async function Z(r=""){const{db:a,collectionFn:d,queryFn:i,limitFn:p,getDocsFn:u}=n,h=String(r||"").trim();if(!h||!a||typeof d!="function"||typeof u!="function")throw new Error("Produktet nuk u ngarkuan.");const f=d(a,"restaurants",h,"menuItems"),x=typeof i=="function"&&typeof p=="function"?i(f,p(Y)):f,y=await u(x),k=[];return y.forEach(C=>{const F=B(C?.id,C?.data?.()||{});F&&k.push(F)}),k.sort((C,F)=>C.name.localeCompare(F.name,"sq")),k}function W(){return v?Promise.resolve(v):(S||(S=oe(()=>import("./business-composer-controller-BSjvrr46.js"),__vite__mapDeps([0,1,2,3,4,5,6])).then(r=>(B=typeof r?.normalizeComposerProductCore=="function"?r.normalizeComposerProductCore:(()=>null),v=r.createBusinessComposerController({documentObj:b,windowObj:b?.defaultView||null,api:{getRestaurantIdFn:()=>D(),getBusinessMetaFn:()=>{const a=D();if(!a)return{name:"",logoUrl:"",city:""};const d=O(a),i=T(a)||{};return{name:d.name,logoUrl:d.logoUrl,city:String(i.city||"").trim()}},loadProductsFn:a=>Z(a),uploadImageFn:l.uploadImageFn,createPostFn:l.createPostFn,createStoryFn:l.createStoryFn,formatPriceFn:l.formatPriceFn,getOptimizedImageUrlFn:l.getOptimizedImageUrlFn,escapeHtmlFn:l.escapeHtmlFn,iconFn:typeof g=="function"?g:void 0,afterPublishFn:async a=>{try{await j({force:!0})}catch{}typeof l.afterPublishFn=="function"&&await l.afterPublishFn(a)}}}),v)).catch(r=>{throw S=null,console.error("[mnyra][dashboard] composer load failed",r),r})),S)}function X(r="post"){const a=String(r||"").trim().toLowerCase()==="story"?"story":"post";if(typeof l.prewarmFn=="function")try{l.prewarmFn()}catch{}if(v){v.open(a);return}P=a,W().then(d=>{const i=P||a;P="",d?.open?.(i)}).catch(()=>{P=""})}function L(){return(!e.dashboardView||typeof e.dashboardView!="object")&&(e.dashboardView={status:"idle",error:"",model:null,loadedSignature:""}),e.dashboardView}function D(){const r=e?.userProfile||{};return String(r.restaurantId||r.staffRestaurantId||"").trim()}function ee(){const r=String(e?.user?.uid||"").trim();if(!r)return!1;const a=String(e?.__authBootstrapInFlightUid||"").trim();return!!e?.__authProfileLoadPromise||a===r}function E(r=""){return`${Se}${r}`}function te(r="",a=""){if(!_||!r)return null;try{const d=_.getItem(E(r));if(!d)return null;const i=JSON.parse(d);return!i||typeof i!="object"||String(i.day||"").trim()!==String(a||"").trim()||!i.model||typeof i.model!="object"?null:i.model}catch{return null}}function ae(r="",a=null){if(!(!_||!r||!a))try{_.setItem(E(r),JSON.stringify({day:a.day,model:a}))}catch{}}async function ne(r=""){const{db:a,collectionFn:d,queryFn:i,orderByFn:p,limitFn:u,getDocsFn:h}=n;if(!a||typeof d!="function"||typeof i!="function"||typeof p!="function"||typeof u!="function"||typeof h!="function")return[];const f=d(a,"restaurants",r,"socialPosts");return(await h(i(f,p("createdAt","desc"),u(Pe)))).docs.map(y=>({id:y.id,data:y.data()||{}})).filter(y=>{const k=String(y.data.status||"active").trim().toLowerCase();return k!=="deleted"&&k!=="hidden"})}async function j({force:r=!1}={}){const a=L(),d=D();if(!d)return;const i=ie({rangeKey:"7d"});if(!i)return;const p=`${d}::${i.toDay}`;if(!r&&a.loadedSignature===p&&a.status==="ready")return;if(!a.model){const f=te(d,i.toDay);f&&(a.model=f,a.status="ready",c())}w+=1;const u=w;a.model||(a.status="loading",a.error="",c());try{const f={db:n.db,collectionFn:n.collectionFn,queryFn:n.queryFn,whereFn:n.whereFn,documentIdFn:n.documentIdFn,getDocsFn:n.getDocsFn,restaurantId:d},[x,y]=await Promise.allSettled([de({...f,fromDay:i.fromDay,toDay:i.toDay}),ne(d)]);if(u!==w)return;if(x.status==="rejected")throw x.reason;y.status==="rejected"&&console.error("[mnyra][dashboard] recent posts load failed",y.reason),a.model=Fe({days:x.value,todayKey:i.toDay,rawPosts:y.status==="fulfilled"?y.value:[]}),a.status="ready",a.error="",a.loadedSignature=p,ae(d,a.model)}catch(f){if(u!==w)return;console.error("[mnyra][dashboard] load failed",f),a.model||(a.status="error",a.error="Ju lutem kontrollo lidhjen dhe provo perseri.")}c()}function re(){R||!b||(R=!0,b.addEventListener("click",r=>{try{if(String(e?.activeTab||"").trim().toLowerCase()!=="dashboard")return;if(r.target?.closest?.("[data-dashboard-retry]")){j({force:!0});return}const a=r.target?.closest?.("[data-dashboard-composer]");a&&(r.preventDefault(),X(a.getAttribute("data-dashboard-composer")))}catch{}}))}function O(r=""){const a=e?.userProfile||{},d=r?T(r)||{}:{},i=q(a),p=String(d.name||d.restaurantName||a.name||"").trim()||"Business";let u="";try{u=String(Q()||"").trim()}catch{}if(!u)try{u=String(G(d)||"").trim()}catch{}return{name:p,logoUrl:u,kind:me({businessType:i,isShopCatalog:K(a)})}}function se(){ce(b),re();const r=L(),a=D();let d="";if(!a)d=ee()?`${xe()}${A({kpiCount:6})}`:we();else{const i=O(a),p=pe({kind:i.kind,isOwner:V(e?.userProfile),canAccessOrders:J(e?.userProfile)}),u=he(i.kind);r.status==="idle"&&(r.status="loading",queueMicrotask(()=>{j({force:!1})}));let h="";r.model?h=`
          ${_e({kpiDefs:u,week:r.model.week,today:r.model.today})}
          ${ve({posts:r.model.posts,iconFn:g})}
        `:r.status==="error"?h=ke({message:r.error}):h=A({kpiCount:u.length}),d=`
        ${ye({name:i.name,logoUrl:i.logoUrl,iconFn:g})}
        ${ge({iconFn:g})}
        ${be({actions:p,iconFn:g})}
        ${h}
      `}return`
