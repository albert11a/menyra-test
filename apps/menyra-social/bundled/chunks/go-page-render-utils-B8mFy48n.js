...
`,g=Object.freeze({brand:"Mnyra GO",partyQuestion:"Sa veta jeni?",partyOne:"person",partyMany:"veta",step:"Hapi",stepBack:"Kthehu një hap prapa",next:"Vazhdo",categoryQuestion:"Çka dëshironi?",whenQuestion:"Kur?",whenLaterLabel:"Zgjidh ditën dhe orën",placeQuestion:"Ku?",placeLabel:"Qyteti",placeEmpty:"Shto qytetin tënd",cityPlaceholder:"Shkruaj qytetin",locationChange:"Ndrysho",locationSave:"Ruaj",submit:"Shiko ofertat",searching:"Po kërkojmë...",resultsHeadline:"lokale kanë oferta për ju",offering:"po ju ofron",forGroup:"për grupin tuaj",accept:"Prano ofertën",confirming:"Po konfirmohet...",sponsored:"Sponsored",onlyGo:"Vetëm me Mnyra GO",tableIncluded:"Tavolinë",emptyTitle:"Nuk gjetëm ofertë GO që përputhet tani.",emptySubtitle:"Provo me një orë tjetër ose me një grup tjetër.",doneTitle:"U krye",reservationConfirmed:"Tavolina është konfirmuar",claimConfirmed:"Oferta është e juaja",menu:"Shiko menunë",directions:"Udhëzime",code:"Kodi",cancel:"Anulo",cancelConfirm:"Dëshiron ta anulosh?",cancelYes:"Po, anuloje",cancelNo:"Jo",saveToAccount:"Ruaje në llogarinë tënde",signIn:"Hyr",errorTitle:"Mnyra GO është përkohësisht i padisponueshëm.",errorRetry:"Provo prapë",alternatives:"alternativa për ju",peopleSuffix:"persona",now:"Tani",back:"Ndrysho kërkimin"}),w="/apps/menyra-social/assets/go/",k=Object.freeze([Object.freeze({file:"story-1-uritur.webp",alt:"Vajzë ulur në tavolinë, e uritur",side:"right",headline:Object.freeze(["A je ",Object.freeze({accent:"unt?"})]),text:Object.freeze(["Hape Mnyra GO edhe thuaj veç ",Object.freeze({accent:"sa veta jeni"})," edhe çka po ju hahet."])}),Object.freeze({file:"story-2-kerkim.webp",alt:"Vajzë që shikon telefonin, tuj kërku lokal",side:"left",headline:Object.freeze(["Ku me ",Object.freeze({accent:"shku?"})]),text:Object.freeze(["Po kërkon restorant a kafe, po s’po din ku? ",Object.freeze({accent:"Mos kërko"})," — lokalet t’gjejnë ty."])}),Object.freeze({file:"story-3-oferta.webp",alt:"Vajzë e gëzueme me telefon në dorë",side:"right",headline:Object.freeze(["Ofertat ",Object.freeze({accent:"t’vijn."})]),text:Object.freeze(["Lokalet përreth teje t’çojnë zbritje a diçka falas, ",Object.freeze({accent:"veç për grupin tënd"}),"."])}),Object.freeze({file:"story-4-tavolina.webp",alt:"Dy shoqe në tavolinë të lokalit",side:"right",headline:null,text:Object.freeze(["Zgjedh njënën, shko edhe ",Object.freeze({accent:"knaqu."})," Kaq âsht Mnyra GO."])})]);function b(a=[],e="mnyra-go-page__story-accent"){return(Array.isArray(a)?a:[a]).map(t=>{if(typeof t=="string")return n(t);const r=typeof t?.accent=="string"?t.accent:"";return r?`<span class="${e}">${n(r)}</span>`:""}).join("")}function ne(a=[]){return(Array.isArray(a)?a:[a]).map(e=>typeof e=="string"?e:String(e?.accent||"")).join("")}const D=Object.freeze({now:"zap",in30:"timer",in60:"clock",later:"calendar-clock"}),p=Object.freeze(["party","category","when","place"]),$=Object.freeze({party:"users",category:"utensils",when:"clock",place:"map-pin"});function n(a=""){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function f(a=""){const e=String(a||"").trim();return p.includes(e)?e:p[0]}function te(a=""){const e=p.indexOf(f(a));return p[Math.min(p.length-1,e+1)]}function re(a=""){const e=p.indexOf(f(a));return p[Math.max(0,e-1)]}function u(a){const e=Math.trunc(Number(a));return Number.isFinite(e)?Math.min(m,Math.max(l,e)):B}function S(a,e=g){return u(a)===1?e.partyOne||g.partyOne:e.partyMany||g.partyMany}function z(a,e=g){return`${u(a)} ${S(a,e)}`}function E(a){const e=u(a),t=m-l;return Math.round((e-l)/t*100)}function M(a,{active:e=!1,attr:t="",value:r="",iconName:i="",wide:s=!1}={}){return`
  ...
  `}function K(a={},e=g){const t=String(a.category||"all");return`
    <div class="mnyra-go-page__chips" role="group" aria-label="${n(e.categoryQuestion)}">
      ${_.map((r,i)=>M(r.label,{active:t===r.key,attr:"data-go-category",value:r.key,iconName:r.icon,wide:i===0})).join("")}
    </div>
  `}function P(a={},e=g){const t=String(a.when||"now");return`
    ...
    ${t==="later"?`
      ...
      />
    `:""}
  `}function R(a={},e=g){const t=String(a.city||"").trim();return a.editCity?`
  ...
  `}function L(a={},e=g){const t=f(a.step),r=p.indexOf(t),i=p.length,s=Math.round((r+1)/i*100);let d="",c="",h="";return t==="party"?(c=e.partyQuestion,d=T(a,e),h=`<button type="button" class="mnyra-go-page__cta" data-go-step-next>${n(e.next)}${o("chevron-right")}</button>`):t==="category"?(c=e.categoryQuestion,d=K(a,e)):t==="when"?(c=e.whenQuestion,d=P(a,e),String(a.when||"now")==="later"&&(h=`<button type="button" class="mnyra-go-page__cta" data-go-step-next>${n(e.next)}${o("chevron-right")}</button>`)):(c=e.placeQuestion,d=R(a,e),h=`<button type="button" class="mnyra-go-page__cta" data-go-submit>${o("search")}${n(e.submit)}</button>`),`
        ...
        <article class="mnyra-go-page__story-slide" data-go-story-slide="${s}">
          ...
          >
            <img
              ...
              onerror="this.remove()"
            />
            ${i.headline?`<figcaption class="mnyra-go-page__story-headline">${b(i.headline,"mnyra-go-page__story-headline-accent")}</figcaption>`:""}
          </figure>
          <p class="mnyra-go-page__story-text" ${r()}>${b(i.text)}</p>
        </article>
      `}).join("")}
    </div>
