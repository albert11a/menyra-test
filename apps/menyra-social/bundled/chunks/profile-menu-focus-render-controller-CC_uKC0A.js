import{e as ae,f as Bn,t as Rn,g as Un,h as Pt,a as Vn}from"../entry/social-app.js";import"./startup-route-runtime-context-Ba2-q0Mg.js";import"./vendor-firebase-V03pMX6J.js";function Kn(b={}){const l=b.state,jt=b.resolvePostCountsFn,s=b.escapeHtmlFn,E=b.getOptimizedImageUrlFn,v=b.iconFn,Tt=b.isLocalBusinessProfileFn,Lt=typeof b.isCeoUserFn=="function"?b.isCeoUserFn:(()=>!1),Ne=b.normalizeHandleFn,Oe=b.logoFitClassFn,z=b.formatCountFn,Ke=b.renderProfileShopCartViewFn,qe=b.renderProfileShopFavoritesViewFn,At=typeof b.ensurePostsDataForProfileFn=="function"?b.ensurePostsDataForProfileFn:(()=>{}),zt=b.ensureMenuDataForProfileFn,Mt=typeof b.ensureEditorMenuDataForProfileFn=="function"?b.ensureEditorMenuDataForProfileFn:(()=>{}),re=b.ensureFocusDataForProfileFn,Ge=b.ensureTableQrStateForProfileFn,ee=b.isShopCatalogProfileFn,We=b.getBusinessCatalogLabelFn,G=b.normalizeMenuTypeFn,_t=b.primeMenuItemCountsFn,Et=typeof b.hydrateMenuCardViewerLikesFn=="function"?b.hydrateMenuCardViewerLikesFn:(()=>Promise.resolve()),Dt=b.renderShopProductListFn,Bt=b.getMenuLayoutThemeFn,Rt=b.menuLayoutColors,V=b.resolveMenuItemHeroFn,ie=b.isPlaceholderUrlFn,B=b.placeholderImage,Ut=b.getFirebaseStorageUrlFn,Vt=b.isDirectImageUrlFn,Qe=b.formatPriceFn,Ht=typeof b.resolveCurrencyCodeForMenuItemFn=="function"?b.resolveCurrencyCodeForMenuItemFn:(()=>""),Ye=b.getMenuItemImagesFn,R=b.getMenuItemObjectPositionFn,oe=b.getMenuItemSocialIdFn,Ze=b.menuItemMetaKeyFn,Je=b.ensureMenuItemMetaFn,Xe=b.resolveMenuItemCountsFn,le=b.getFocusStateForRestaurantFn,ce=b.getTableQrStateForRestaurantFn,de=b.getFocusItemObjectPositionFn,et=b.getFocusCardClassFn,Nt=b.getFocusIndexFn,te=b.isRestaurantCafeProfileFn,tt=typeof b.getBusinessProfileTypeFn=="function"?b.getBusinessProfileTypeFn:(()=>""),ue=b.getRestaurantMetaByIdFn,Ot=b.buildUrlFn,Kt=b.normalizeSearchKeyFn,qt=b.normalizeFollowHandleFn,H={key:"",inFlightKey:""},u=(e,t=e,n={})=>Rn(e,{fallback:t,params:n}),nt=(e="")=>{const t=String(e||"").trim();if(!t)return u("nav.menu","Menue");const n=t.toLowerCase();return n==="menue"||n==="menu"||n==="menü"?u("nav.menu",t):n==="shop"?"Shop":t},Gt=(e="food")=>String(e||"").trim().toLowerCase()==="drink"?u("menu.drinks","Getraenke"):u("menu.food","Speisen"),st=(e={},t=!1)=>{const n=G(e?.type||"food");return t?n==="drink"?u("menu.variant","Variante"):u("menu.product","Produkt"):n==="drink"?u("menu.drinkItem","Getraenk"):u("menu.foodItem","Speise")};function Wt(e=null,t=null){return ae(l,{profile:e,routePayload:t,webDirectEntry:l?.__webDirectEntry}).restaurantId}function at(e=null,t=""){if(!e||typeof e!="object")return e;const n=String(t||"").trim();if(!n)return e;const a=String(e.canonicalRestaurantId||"").trim();return String(e.restaurantId||"").trim()===n&&a?e:{...e,restaurantId:n,...a?{canonicalRestaurantId:a}:{}}}function Qt(e=""){const t=String(e||"").trim();return t?ae(l,{profile:l?.profileView?.profile||l?.userProfile,routePayload:l?.profileView?.routePayload,webDirectEntry:l?.__webDirectEntry,restaurantId:t}).focus.canRenderFocus:!1}function pe(e={}){const t=String(Ht(e)||"").trim();return t?Qe(e?.price,t):Qe(e?.price)}function Yt(e=[],t="",n=""){const a=String(t||"").trim(),i=String(n||"").trim();if(!a||!i)return"";const r=Array.isArray(e)?e:[];if(!r.length)return`${a}|${i}|empty`;const o=[];return r.forEach(d=>{const c=String(oe(d)||d?.id||"").trim();c&&o.push(c)}),o.length?(o.sort(),`${a}|${i}|${o.join(",")}`):`${a}|${i}|empty`}function Zt(e=[],t=""){const n=String(l.user?.uid||"").trim(),a=Yt(e,t,n);a&&H.inFlightKey!==a&&H.key!==a&&(H.key=a,H.inFlightKey=a,Et(e,t).catch(i=>{console.error(i),H.key===a&&(H.key="")}).finally(()=>{H.inFlightKey===a&&(H.inFlightKey="")}))}function Jt(e={}){const t=String(e?.uid||"").trim();if(t&&l.followingTargetIds.includes(t))return!0;const n=String(e?.restaurantId||"").trim();if(n&&l.followingTargetIds.includes(n))return!0;const a=qt(e?.handle||"");return!!(a&&l.followingHandles.includes(a))}function rt(e={}){if(e?.specialEnabled===!0)return!0;if(e?.specialEnabled===!1)return!1;const t=String(e?.restaurantId||"").trim();if(!t)return!1;const n=typeof ue=="function"&&ue(t)||null;return n?.specialEnabled===!0?!0:(n?.specialEnabled===!1,!1)}function Xt(e={}){return K(e)==="testfirst_special"?!0:String(e?.category||"").trim().toLowerCase()==="special"}function it(e,t,n=!0,{includeImageKey:a=!0}={}){const i=jt(e),r=e.id?String(e.id):"",o=r?`data-open-post="${s(r)}"`:"",d=r?`data-post-like-count="${s(r)}"`:"",c=r?`data-post-comment-count="${s(r)}"`:"",p=a&&r?`data-img-key="profile-post:${s(r)}"`:"",g=e.type==="wide"||e.type==="hero",x=t&&g?"col-span-2":"",f=t&&g?"aspect-[1.8/1]":"aspect-[4/5]",w=E(e.url,g?"large":"medium",{stableKey:r?`profile-post:${r}`:"",variantGroup:"post-detail"}),k=g?800:400,S=g?400:500;return`
    <div ${o} role="button" tabindex="0" class="${x} relative ${f} rounded-[2rem] overflow-hidden bg-white shadow-[0_30px_60px_-12px_rgba(50,50,93,0.15),0_18px_36px_-18px_rgba(0,0,0,0.15)] cursor-pointer transition-transform">
      ...
      ${r&&n?`
        ...
        <div data-profile-menu="${s(r)}" class="absolute top-12 right-3 w-40 bg-white/95 backdrop-blur-xl rounded-2xl shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1),0_0_1px_rgba(0,0,0,0.1)] border border-slate-100 p-1.5 z-30 hidden origin-top-right flex flex-col gap-1">
          <button type="button" data-profile-post-toggle="${s(r)}" class="flex items-center gap-3 px-3 py-2.5 text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 rounded-xl transition-colors text-left w-full">
            ${v(g?"minimize-2":"maximize-2","w-3.5 h-3.5")}
            ${g?"Schmaler":"Breiter"}
          </button>
  ...
  `}function Fe(e,t,n=!0,{includeImageKeys:a=!0}={}){const i=t==="grid";if(!e.length)return`
    ...
    `;const r=e.map(d=>it(d,i,n,{includeImageKey:a})),o=e.reduce((d,c)=>{const p=c?.type==="wide"||c?.type==="hero";return d+(p?2:1)},0);return i&&o%2===1&&r.unshift(`
      <div data-profile-grid-placeholder="true" class="col-start-2 aspect-[4/5] rounded-[2rem] invisible pointer-events-none"></div>
    `),r.join("")}function Pe(){const e=l.profileCheckins||[];return e.length?`
    <div class="app-content-inline flex flex-col gap-4 app-main-content-safe animate-in fade-in duration-300">
      ${e.map(t=>{const n=E(t.image,"thumb");return`
  ...
  `:`
    ...
    `}function fe(e={}){return String(e?.canonicalRestaurantId||e?.restaurantId||"").trim()?!0:String(e?.role||"").trim().toLowerCase()==="business"}function ge(e={}){const t=String(tt(e)||"").trim().toLowerCase();return t==="hotel"||t==="motel"}function ot(e={}){const t=String(e?.canonicalRestaurantId||e?.restaurantId||"").trim(),n=t?ue(t):null;return{...n&&typeof n=="object"?n:{},...e&&typeof e=="object"?e:{}}}function en(e={}){const t=[e?.verifiedMapLocation,e?.mapLocation,e?.geo,e?.coordinates,e?.coords,e?.locationCoords,e];for(const n of t){if(!n||typeof n!="object")continue;const a=Number(n.lat??n.latitude),i=Number(n.lng??n.lon??n.longitude);if(Number.isFinite(a)&&Number.isFinite(i))return{lat:a,lng:i}}return null}function M(e={},t=[]){for(const n of t){const a=String(e?.[n]||"").trim();if(a)return a}return""}function be(e){if(Array.isArray(e))return e.map(n=>String(n||"").trim()).filter(Boolean);const t=String(e||"").trim();return t?t.split(/[\n,;|]/).map(n=>n.trim()).filter(Boolean):[]}function tn(e={}){const t=[...be(e.coverImages),...be(e.hotelCoverImages),...be(e.titleImages),e.titleImageUrl,e.coverImageUrl,e.coverUrl,e.heroUrl,e.imageUrl].map(a=>String(a||"").trim()).filter(Boolean),n=[];return t.forEach(a=>{n.includes(a)||n.push(a)}),n.slice(0,8)}function nn(e={}){const t=Array.isArray(e.features)?e.features.map(a=>String(a||"").trim()).filter(Boolean):[],n=e.restaurantFeatures&&typeof e.restaurantFeatures=="object"?e.restaurantFeatures:{};return[M(e,["hotelFeatureOneText","gardenTerraceText"])||String(n.gardenTerrace||"").trim()||t[0]||"",M(e,["hotelFeatureTwoText","accessibilityText"])||String(n.accessibility||"").trim()||t[1]||"",M(e,["hotelFeatureThreeText","veganOptionsText"])||String(n.veganOptions||"").trim()||t[2]||""]}function sn(e={}){const t=[],n=(a="")=>{const i=String(a||"").trim();i&&!t.includes(i)&&t.push(i)};return[e.amenities,e.features,e.included,e.facilities,e.hotelAmenities].forEach(a=>{Array.isArray(a)&&a.forEach(i=>{typeof i=="string"?n(i):i&&typeof i=="object"&&n(i.label||i.name||i.title)})}),(e.beachfront||e.onBeach||e.amStrand)&&n("Am Strand"),(e.restaurant||e.hasRestaurant)&&n("Restaurant"),(e.breakfast||e.breakfastIncluded)&&n("Fruehstueck"),(e.pool||e.hasPool)&&n("Pool"),(e.wifi||e.freeWifi||e.hasWifi)&&n("WLAN"),(e.parking||e.freeParking||e.hasParking)&&n("Parkplatz"),(e.spa||e.wellness)&&n("Wellness"),t.slice(0,8)}const an=[{value:"m",label:"m"},{value:"km",label:"km"}],rn=["Mëngjes i përfshirë","Gjysmë pension","Pension i plotë","All inclusive","Restorant në hotel","Pa ushqim"],on=["Shezlongë të përfshirë","Shezlongë me pagesë","Plazh privat me shezlongë","Pa shezlongë"],ln=["Parking falas","Parking privat","Parking me pagesë","Pa parking"];function N(e=""){return String(e||"").trim().toLowerCase().replace(/[ëèéê]/g,"e").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}function cn(e="",{direct:t=!1}={}){const n=String(e||"").trim(),a=N(n),i=t||a.includes("direkt")&&(a.includes("strand")||a.includes("zentrum")||a.includes("center"))||a.includes("am_strand")||a.includes("im_zentrum"),r=n.match(/(\d+(?:[.,]\d+)?)\s*(km|kilometer|m|meter)?/i),o=r?r[1].replace(",","."):"",c=(r?String(r[2]||"").trim().toLowerCase():"").startsWith("k")?"km":"m";return{amount:o,unit:c,isDirect:i}}function lt({idPrefix:e="",iconName:t="navigation",label:n="",value:a="",directLabel:i="",direct:r=!1}={}){const o=cn(a,{direct:r});return`
    <div class="rounded-[1.7rem] border border-slate-100 bg-slate-50 p-4 space-y-3">
      ...
      <div class="grid grid-cols-[1fr_92px] gap-2">
        ...
        <select id="${s(e)}Unit" class="w-full px-3 py-3 bg-white rounded-2xl text-sm font-black border border-slate-100 outline-none focus:ring-2 focus:ring-indigo-100">
          ${an.map(d=>`<option value="${s(d.value)}" ${o.unit===d.value?"selected":""}>${s(d.label)}</option>`).join("")}
        </select>
      </div>
  ...
  `}function dn(e=[],t=""){const n=String(t||"").trim(),a=new Set(e.map(N));return`
    <option value="">Auswählen</option>
    ${e.map(i=>`<option value="${s(i)}" ${N(i)===N(n)?"selected":""}>${s(i)}</option>`).join("")}
    ${n&&!a.has(N(n))?`<option value="${s(n)}" selected>Aktuell: ${s(n)}</option>`:""}
  `}function je({id:e="",iconName:t="badge-check",label:n="",value:a="",options:i=[]}={}){return`
  ...
  `}function un(e={},t=[]){const n=new Set(t.map(N).filter(Boolean)),a=[],i=(r="")=>{const o=String(r||"").trim();if(!o)return;const d=N(o);n.has(d)||a.some(c=>N(c)===d)||a.push(o)};return[e.features,e.hotelFeatures,e.amenities,e.facilities,e.hotelAmenities].forEach(r=>be(r).forEach(i)),a}function pn({existingImages:e=[],newPreviews:t=[],imageUrlDraft:n=""}={}){const a=[...t.map((o,d)=>({src:o,kind:"new",idx:d})),...e.map((o,d)=>({src:o,kind:"existing",idx:d}))].filter(o=>o.src),i=a[0]?.src||n||"",r=i?E(i,"large"):B;return`
    <div class="space-y-4">
  ...
  `}function ct(e={}){const t=ot(e),n=en(t),a=M(t,["address","primaryAddress","location","formattedAddress","street"]),i=M(t,["city","locationCity","primaryCity","region","country"]),r=M(t,["beachDistance","distanceToBeach","beachDistanceLabel","strandEntfernung"]),o=M(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),d=M(t,["rating","reviewRating","stars","hotelStars"]),c=M(t,["reviewCount","reviewsCount","ratingsCount","commentsCount"]),p=sn(t),g=n?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${n.lat},${n.lng}`)}`:a||i?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${a} ${i}`.trim())}`:"";return`
    <div class="app-content-inline flex flex-col gap-4 app-main-content-safe animate-in fade-in duration-300">
      ...
      <div class="grid grid-cols-1 gap-4">
        ${me({iconName:"map-pin",label:"Adresse",value:[a,i].filter(Boolean).join(", ")||"Standort folgt",helper:n?`${n.lat.toFixed(5)}, ${n.lng.toFixed(5)}`:""})}
        ${me({iconName:"navigation",label:"Zentrum",value:o||"Details folgen"})}
        ${me({iconName:"waves",label:"Strand",value:r||(t.beachfront||t.onBeach?"Direkt am Strand":"Details folgen")})}
        ${me({iconName:"star",label:"Bewertungen",value:d?`${d}${c?` / ${c} Bewertungen`:""}`:"Bewertungen folgen",helper:M(t,["reviewSummary","ratingSummary","commentsSummary"])})}
      </div>
  ...
  `}function fn(e={}){const t=ot(e),n=String(e?.restaurantId||t.restaurantId||t.id||"").trim(),a=t?.name||t?.restaurantName||e?.name||"Hotel",i=String(l.hotelCardEditor?.status||"").trim(),r=l.hotelCardEditor?.saving===!0,o=l.hotelCardEditor&&typeof l.hotelCardEditor=="object"?l.hotelCardEditor:{},d=Array.isArray(o.existingImages)?o.existingImages.map(y=>String(y||"").trim()).filter(Boolean):tn(t),c=Array.isArray(o.imagePreviews)?o.imagePreviews.map(y=>String(y||"").trim()).filter(Boolean):[],p=String(o.imageUrlDraft||"").trim(),[g,x,f]=nn(t),w=un(t,[g,x,f]),k=M(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),S=M(t,["distanceBeach","distanceToBeach","beachDistance","beachDistanceLabel","strandEntfernung","lakeDistance","distanceToLake"]),$=M(t,["hotelStartingPrice","startingPrice","priceFrom","fromPrice","bestPrice","roomStartingPrice"]),I=t.directCenter===!0||t.inCenter===!0||t.cityCenterDirect===!0,m=t.beachfront===!0||t.onBeach===!0||t.amStrand===!0;return`
      ...
      ${n?`
        <div data-hotel-card-editor="${s(n)}" class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5">
          ...
          <div>
            ...
            ${pn({existingImages:d,newPreviews:c,imageUrlDraft:p})}
          </div>

          <div class="grid grid-cols-1 gap-4">
            ${lt({idPrefix:"hotelCardDistanceCenter",iconName:"navigation",label:"Entfernung Zentrum",value:k,directLabel:"Direkt im Zentrum",direct:I})}
            ${lt({idPrefix:"hotelCardDistanceBeach",iconName:"waves",label:"Entfernung Strand",value:S,directLabel:"Direkt am Strand",direct:m})}
            <div>
          ...
          <div class="grid grid-cols-1 gap-4">
            ${je({id:"hotelCardFeatureOneText",iconName:"utensils",label:"Ushqimi",value:g,options:rn})}
            ${je({id:"hotelCardFeatureTwoText",iconName:"waves",label:"Shezlongët",value:x,options:on})}
            ${je({id:"hotelCardFeatureThreeText",iconName:"square-parking",label:"Parking",value:f,options:ln})}
            <div>
...
`))}</textarea>
  ...
  `}function Le(e=l.profileView?.profile||l.userProfile,{landingPreview:t=!1,selectedTabOverride:n="",compact:a=!1}={}){const i=fe(e),r=String(n||xe(e)).trim().toLowerCase()||"posts",o=ge(e),d=i?[{id:"posts",label:u("profile.posts","Beitraege")},{id:"menu",label:o?"Details":u("nav.menu","Menue"),surface:o?"hotel-details":"menu"}]:[{id:"posts",label:u("profile.posts","Beitraege")},{id:"media",label:u("profile.media","Medien")},{id:"checkins",label:u("profile.checkins","Check-ins")}];return`
  ...
  `}function he(e={},t=[],{topTabOverride:n="",tutorialMode:a=!1,contentTabOverride:i="",landingHideContent:r=!1,collapseIdentity:o=!1,contentReveal:d=!1,landingMode:c=!1}={}){const p=Jt(e),g=!!e.privateAccount&&e.uid&&String(e.uid)!==String(l.user?.uid||"")&&!p,x=!!e.pendingFollowRequest&&!p,f=e.restaurantId?"Business":u("nav.user","User"),w=String(e.handle||Ne(e.name||"user")).replace(/^@/,""),S=s(e.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),$=fe(e),I=String(n||Te(e)).trim().toLowerCase()||"profile",m=String(i||xe(e)).trim().toLowerCase()||"posts",y=m==="menu",F=m==="checkins",C=t,_={...l?.profileView&&typeof l.profileView=="object"?l.profileView:{},profile:e,posts:Array.isArray(C)?C:[]},D=Un(l,{profileView:_,profileTopTab:I,profileContentTab:m}),Y=String(D?.header?.status||"").trim().toLowerCase()||"loading",h=String(D?.posts?.status||"").trim().toLowerCase()||"loading",P=String(e?.avatar||"").trim(),j=P?E(P,"avatar"):"",T=Oe(!!e.restaurantId),A=e.uid||e.restaurantId||w||"public",$e=c?"":`data-img-key="avatar:public:${s(A)}"`,Z=!!P,J=He=>{if(He==null)return!1;const Ft=Number(He);return Number.isFinite(Ft)&&Ft>=0},ye=Z||J(e?.followers)||J(e?.following),q=Pt(Y)&&!ye,Ve=!!String(j||"").trim()&&Z,se=q?"...":z(e.followers),ke=q?"...":z(e.following),Se=$?I==="profile"?"pt-2":"pt-4":"pt-10",Ie=p?u("profile.following","Following"):x?u("profile.requested","Requested"):g?u("profile.request","Request"):u("profile.follow","Follow"),U=p?"bg-slate-100 text-slate-600 shadow-none border border-slate-200":x?"bg-amber-50 text-amber-700 shadow-none border border-amber-200":"bg-gradient-to-r from-slate-900 to-slate-800 text-white border border-transparent",Mn=a?"select-none":"app-main-content-safe",X=a?"pointer-events-none":"",_n=!o,It=!r,Ce=d?c?"transition-opacity duration-200":"animate-in fade-in duration-300":"",Ct=m==="posts"&&C.length>0,En=m!=="posts"||Ct||h==="empty"||h==="error",Dn=m==="posts"&&!Ct&&h==="error";return!a&&(m==="posts"||m==="media")&&e?.restaurantId&&Pt(h)&&At(e),`
    <div class="${Mn}" ${a?'data-landing-tutorial-surface="true"':""}>
      ${I==="profile"||I==="menu"?`
      ${_n?`
          ...
          <div data-landing-tutorial-target="identity" class="bg-white rounded-[2.5rem] p-8 relative overflow-hidden z-10 border border-slate-100 ${X}">
            <div class="relative z-10">
              <div class="flex justify-between items-start mb-8">
                <div class="relative">
                  <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500">
                    ${Ve?`<img src="${s(j)}" decoding="async" width="100" height="100" ${$e} class="w-full h-full rounded-[1.8rem] ${T} border-2 border-white" />`:`<div class="w-full h-full rounded-[1.8rem] border-2 border-white bg-slate-100 flex items-center justify-center ${q?"animate-pulse":""}">${v(e.restaurantId?"store":"user","w-8 h-8 text-slate-300")}</div>`}
                  </div>
                  ${e.isPremium?`
              ...
              <div class="flex gap-4">
                <button data-landing-tutorial-target="follow" data-public-profile-follow="${s(e.handle)}" data-target-type="${s(e.restaurantId?"restaurant":e.uid?"user":"")}" data-target-id="${s(e.restaurantId||e.uid||"")}" data-target-name="${s(e.name||"")}" data-target-avatar="${s(e.avatar||"")}" ${x?"disabled":""} class="flex-1 h-[56px] rounded-[1.2rem] font-bold text-xs uppercase tracking-widest shadow-[0_10px_20px_-5px_rgba(15,23,42,0.25)] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden ${U} ${x?"opacity-90 cursor-default":""}">
      ...
      `:`
        ...
        ${It?y?`
          <div class="${X} ${Ce}">
            ${ge(e)?ct(e):we(e,{mode:c?"landing":"profile",allowAutoEnsure:!c})}
          </div>
        `:F?`
          <div class="${X} ${Ce}">
            ${Pe()}
  ...
  `}function xn(){const e=l.profileView;if(!e||!e.profile)return"";const t=e.profile,n=e.posts||t.posts||[],a=Te(t);return a==="landing"?mn(t):he(t,n,{topTabOverride:a,tutorialMode:!1})}function ut(e,{filter:t="all",query:n=""}={}){const a=Array.isArray(e)?e:[],i=Kt(n||"");return a.filter(r=>t==="all"||G(r.type)===t?i?`${r.name||""} ${r.category||""} ${r.description||""}`.toLowerCase().includes(i):!0:!1)}function pt(e,t=0){const n=Number(e);return Number.isFinite(n)?Math.max(0,Math.floor(n)):Math.max(0,Number(t)||0)}function ve(e=[]){return(Array.isArray(e)?e.slice():[]).map((n,a)=>({item:n,idx:a,order:pt(n?.orderIndex,a)})).sort((n,a)=>n.order-a.order||n.idx-a.idx).map((n,a)=>({...n.item,orderIndex:pt(n.item?.orderIndex,a)}))}function ze(e={}){const t=String(e?.menuVisibility||"").trim().toLowerCase();return e?.menuHidden===!0||t==="hidden"}function ne(e={}){const t=String(e?.menuSection||e?.displaySection||e?.menuPlacement||"").trim().toLowerCase();return t==="drink"?"drink":t==="food"?"food":G(e?.type||"food")==="drink"?"drink":"food"}function hn(e={}){return String(e?.category||u("menu.other","Sonstiges")).trim()||u("menu.other","Sonstiges")}function vn(e=""){const t=String(e||"").trim().toLowerCase();return t?(typeof t.normalize=="function"?t.normalize("NFD").replace(/[\u0300-\u036f]/g,""):t).replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""):""}const wn=4,$n={thumb:160,small:480,medium:768,large:1280};function ft({mode:e="profile",priorityIndex:t=-1,slideIndex:n=0}={}){return(e==="profile"||e==="landing")&&Number.isFinite(t)&&t>=0&&t<wn&&n===0}function yn({mode:e="profile",priorityIndex:t=-1,slideIndex:n=0}={}){const a=ft({mode:e,priorityIndex:t,slideIndex:n}),i=e==="profile"?' data-image-reveal="menu"':"";return a?`loading="eager" fetchpriority="high"${i}`:`loading="lazy" fetchpriority="low"${i}`}function kn({variant:e="grid"}={}){return e==="thumb"?"(max-width: 640px) 64px, 64px":e==="hero"?"(max-width: 640px) 94vw, (max-width: 1200px) 74vw, 920px":"(max-width: 640px) 48vw, (max-width: 1200px) 28vw, 360px"}function O(e,{mode:t="profile",priorityIndex:n=-1,slideIndex:a=0,stableKey:i="",preferredSize:r="small",candidateSizes:o=["small","medium","large"],variant:d="grid"}={}){const c=String(e||"").trim(),p=t==="profile"&&i?{stableKey:i}:null,g=ft({mode:t,priorityIndex:n,slideIndex:a}),x=t==="profile"&&!g&&d!=="thumb",f=E(c,r,p),w=ie(f)?B:f,k=Ut(c),S=Vt(c)&&c!==w?c:k,$=[],I=new Set;o.forEach(P=>{const j=$n[P]||0;if(!j)return;const T=E(c,P,p);if(!T||ie(T))return;const A=`${T}|${j}`;I.has(A)||(I.add(A),$.push(`${T} ${j}w`))});const m=$.length>1?$.join(", "):"",y=m?kn({variant:d}):"",F=x?"":m,C=x?"":y,L=F?` srcset="${s(F)}"`:"",_=C?` sizes="${s(C)}"`:"",D=yn({mode:t,priorityIndex:n,slideIndex:a}),Y=`${D}${L}${_}`,h=x?[`data-menu-lazy-src="${s(w)}"`,`data-menu-lazy-fallback="${s(S||B)}"`,m?`data-menu-lazy-srcset="${s(m)}"`:"",y?`data-menu-lazy-sizes="${s(y)}"`:""].filter(Boolean).join(" "):"";return{safeImg:x?B:w,fallbackImg:x?B:S,imageAttrs:Y,lazyAttrs:h?` ${h}`:"",srcsetValue:m,sizesValue:y,loadingAttrs:D}}function W(e=[],t,n=null){const a=n instanceof Set?n:new Set;return e.map((i,r)=>{const o=hn(i),d=vn(o),c=!!d&&!a.has(d);return c&&a.add(d),`<div${c?` data-menu-category-anchor="${s(d)}"`:""} class="h-full">${t(i,r)}</div>`}).join("")}function Me(e={}){return String(e?.specialSize||e?.specialCardSize||"").trim().toLowerCase()==="food"?"food":"default"}function Sn(e=""){const t=String(e||"").trim();return t?/^(https?:\/\/|mailto:|tel:)/i.test(t)?t:`https://${t.replace(/^\/+/,"")}`:""}function gt(e={}){const t=String(e?.specialActionType||e?.actionType||"").trim().toLowerCase(),n=Sn(e?.specialActionUrl||e?.linkUrl||e?.actionUrl||""),a=String(e?.specialActionProductId||e?.targetProductId||"").trim();return t==="link"&&n?{type:"link",url:n,productId:""}:t==="product"&&a?{type:"product",url:"",productId:a}:{type:"self",url:"",productId:""}}function bt(){const e=l.menu.filter||"all";return`
  ...
  `}function In(){const e=Bt().id;return`
    <div class="mb-5 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      <div class="flex flex-wrap gap-3">
        ${Rt.map(t=>{const n=t.id===e,a=t.id==="white"?"text-slate-700":"text-white";return`
  ...
  `}function Ee(e,{mode:t="profile",variant:n="food",priorityIndex:a=-1}={}){const i=V(e),r=t==="profile"?Q(e,{index:0}):"",o=n==="drink",{safeImg:d,fallbackImg:c,imageAttrs:p,lazyAttrs:g}=O(i,{mode:t,priorityIndex:a,stableKey:r,preferredSize:o?"small":"medium",candidateSizes:o?["small","medium"]:["small","medium","large"],variant:o?"grid":"hero"}),x=pe(e),f=l.activeTab==="menu"?l.userProfile:l.profileView?.profile||l.userProfile,w=ee(f),k=st(e,w),S=e.category||"",$=e.description||"",I=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",m=l.menu.restaurantId||l.profileView?.profile?.restaurantId||l.userProfile.restaurantId||"",y=oe(e),F=Ze(m,y),C=F?Je(F):{likes:[],comments:[],counts:{likes:0,comments:0}},L=Xe(C),_=`
    <div class="mt-2 flex items-center gap-3 text-[10px] font-bold text-slate-400">
      <span class="inline-flex items-center gap-1">
        ${v("heart","w-3 h-3 text-rose-400")} <span data-menu-like-count="${s(y)}">${s(z(L.likes))}</span>
      </span>
      <span class="inline-flex items-center gap-1">
        ${v("message-circle","w-3 h-3 text-indigo-400")} <span data-menu-comment-count="${s(y)}">${s(z(L.comments))}</span>
      </span>
    </div>
  `;return`
  ...
  `}function De(e={}){if(!e?.restaurantId||ee(e))return!1;const t=String(tt(e)||"").trim().toLowerCase();return t==="restaurant"||t==="cafe"||t==="fastfood"}function mt(e){const t=e?.restaurantId||l.menu.restaurantId||l.profileView?.profile?.restaurantId||l.userProfile.restaurantId||"",n=oe(e),a=Ze(t,n),i=a?Je(a):{likes:[],comments:[],counts:{likes:0,comments:0}},r=String(l.user?.uid||"").trim(),o=String(l.user?.handle||"").trim().toLowerCase(),d=!!i.likes?.some(c=>{const p=String(c?.uid||"").trim();if(r&&p&&p===r)return!0;const g=String(c?.handle||"").trim().toLowerCase();return!!o&&!!g&&g===o});return{itemId:n,meta:i,counts:Xe(i),isLiked:d}}function Q(e,{index:t=0}={}){const n=String(e?.restaurantId||l.menu.restaurantId||l.profileView?.profile?.restaurantId||l.userProfile.restaurantId||"").trim(),a=String(e?.id||oe(e)||"").trim();if(!n||!a)return"";const i=Number(t),r=Number.isFinite(i)?Math.max(0,Math.floor(i)):0;return`menu-detail:${n}:${a}:${r}`}function Cn(e){const t=typeof Ye=="function"?Ye(e):[],n=Array.isArray(t)?t.filter(Boolean):[];if(n.length)return n;const a=V(e);return a?[a]:[]}function K(e){return Vn(e?.cardStyle||"",G(e?.type||"food"))}function Be(e,{menuItemId:t=""}={}){if(!e)return null;const n=String(t||e.menuItemId||e.itemId||e.productId||"").trim();return{id:e.id||"",title:e.name||e.title||"Sot ne Fokus",text:e.description||e.text||"",imageUrl:V(e)||e.imageUrl||"",objectPosition:e.objectPosition||R(e),menuItemId:n}}function xt(e,t=[],{mode:n="profile"}={}){const a=e?.restaurantId||"";return!a||!De(e)||!t.length?"":`
    <div class="pt-2 pb-4">
      <div class="flex gap-4 overflow-x-auto hide-scrollbar snap-x horizontal-safe-scroll pb-4">
        ${t.map((i,r)=>{const o=i.imageUrl||"",d=String(i.menuItemId||i.id||"").trim(),{safeImg:c,fallbackImg:p,imageAttrs:g,lazyAttrs:x}=O(o,{mode:n,priorityIndex:r,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:d?`menu-focus:${a}:${d}`:""}),f=String(i.menuItemId||"").trim(),w=n==="profile"&&f?`data-menu-open="${s(f)}" role="button"`:"";return`
  ...
  `}function ht(e,{mode:t="profile",priorityIndex:n=-1}={}){const a=V(e),i=t==="profile"?Q(e,{index:0}):"",{safeImg:r,fallbackImg:o,imageAttrs:d,lazyAttrs:c}=O(a,{mode:t,priorityIndex:n,stableKey:i,preferredSize:"small",candidateSizes:["small","medium"],variant:"grid"}),p=pe(e),g=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",{itemId:x,counts:f,isLiked:w}=mt(e);return`
    <div ${g} class="h-full bg-white p-2.5 rounded-[1.8rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.03)] flex flex-col group relative ${t==="profile"?"cursor-pointer":""}">
      ...
      <div class="px-1.5 pb-1 flex flex-col flex-1">
        ...
        <div class="hidden">
          <span data-menu-like-count="${s(x)}">${s(z(f.likes))}</span>
          <span data-menu-comment-count="${s(x)}">${s(z(f.comments))}</span>
        </div>
      </div>
    </div>
  `}function Fn(e,t="profile"){if(t!=="profile")return"";const n=gt(e);return n.type==="link"&&n.url?`data-menu-special-link="${s(n.url)}" role="button" tabindex="0"`:n.type==="product"&&n.productId?`data-menu-open="${s(n.productId)}" role="button"`:`data-menu-open="${s(e.id)}" role="button"`}function Re(e,{mode:t="profile",size:n="default",priorityIndex:a=-1}={}){const i=V(e),r=t==="profile"?Q(e,{index:0}):"",o=n==="food",{safeImg:d,fallbackImg:c,imageAttrs:p,lazyAttrs:g}=O(i,{mode:t,priorityIndex:a,stableKey:r,preferredSize:o?"medium":"small",candidateSizes:o?["small","medium","large"]:["small","medium"],variant:o?"hero":"grid"}),x=Fn(e,t),f=String(e.category||"Special").trim()||"Special",w=s(String(e.name||"Special")).replace(/\n/g,"<br>");return n==="food"?`
  ...
  `}function vt(e,{mode:t="profile",priorityIndex:n=-1}={}){const a=pe(e),i=t==="profile"?`data-menu-open="${s(e.id)}" role="button"`:"",r=Cn(e),d=(r.length?r:[V(e)||""]).filter(Boolean),c=d.length?d.slice(0,12):[""],p=c.length>1,{itemId:g,counts:x,isLiked:f}=mt(e),w=z(Math.max(0,Number(x.likes)||0)),k=z(Math.max(0,Number(x.comments)||0));return`
    <div ${i} class="bg-white p-3.5 rounded-[2.2rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-5 group relative ${t==="profile"?"cursor-pointer":""}" style="padding:14px;border-radius:2.2rem;margin-bottom:20px;box-sizing:border-box;">
      <div class="w-full aspect-[16/9] rounded-[1.8rem] overflow-hidden bg-slate-100 mb-4 relative" style="aspect-ratio:16 / 9;border-radius:1.8rem;margin-bottom:16px;">
        ${p?`
          ...
          >
            ${c.map((S,$)=>{const I=t==="profile"?Q(e,{index:$}):"",m=O(S||"",{mode:t,priorityIndex:n,slideIndex:$,stableKey:I,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"}),y=$>0,F=y?B:m.safeImg,C=y?B:m.fallbackImg,L=y?m.loadingAttrs:m.imageAttrs,_=y?"":m.lazyAttrs||"",D=y?` data-menu-card-deferred-src="${s(m.safeImg)}"
                ...
                <div class="min-w-full h-full snap-center relative" data-menu-card-gallery-slide="${$}" style="min-width:100%;width:100%;height:100%;scroll-snap-align:center;">
                  <img src="${s(F)}" data-fallback-src="${s(C)}"${_}${D} class="w-full h-full object-cover select-none pointer-events-none" draggable="false" style="object-position:${R(e)};" ${L} decoding="async" />
                </div>
              `}).join("")}
          </div>
        `:`
          ${c.map((S,$)=>{const I=t==="profile"?Q(e,{index:$}):"",{safeImg:m,fallbackImg:y,imageAttrs:F,lazyAttrs:C}=O(S||"",{mode:t,priorityIndex:n,slideIndex:$,stableKey:I,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"});return`
              <div class="w-full h-full">
                <img src="${s(m)}" data-fallback-src="${s(y)}"${C} class="w-full h-full object-cover select-none pointer-events-none" draggable="false" style="object-position:${R(e)};" ${F} decoding="async" />
              </div>
            `}).join("")}
        `}
        <button
  ...
  `}function Pn(e,t,{mode:n="profile",publicMenuSurfaceState:a=null}={}){const i=ve(Array.isArray(t)?t:[]),r=String(e?.restaurantId||"").trim(),o=n==="admin"||Qt(r),d=a?.focus?.canRenderFocus?{items:Array.isArray(a.focus.items)?a.focus.items:[],enabled:!0}:r&&o?le(r):{items:[],enabled:!1},c=d.enabled?(Array.isArray(d.items)?d.items:[]).map(h=>Be({...h,objectPosition:de(h)})):[],p=i.filter(h=>K(h)==="testfirst_focus"&&!ze(h)).map(h=>Be(h,{menuItemId:h.id||""})).filter(Boolean),g=new Set,x=[...c,...p].filter(h=>{const P=String(h.menuItemId||h.id||`${h.title}|${h.text}|${h.imageUrl}`);return!P||g.has(P)?!1:(g.add(P),!0)}),f=i.filter(h=>!ze(h)),w=f.filter(h=>K(h)!=="testfirst_focus"),k=w.length?w:f,S=w.length?x:[],$=k.filter(h=>ne(h)==="drink"),I=k.filter(h=>ne(h)!=="drink"),m=(h=[])=>{const P=[],j=[];return h.forEach(T=>{const A=K(T);A==="testfirst_food"||A==="testfirst_special"&&Me(T)==="food"?j.push(T):P.push(T)}),{gridItems:P,foodItems:j}},y=(h,P=-1)=>K(h)==="testfirst_special"?Re(h,{mode:n,priorityIndex:P}):ht(h,{mode:n,priorityIndex:P});let F=0;const C=()=>{const h=F;return F+=1,h},L=new Set,_=(h,P)=>!P.gridItems.length&&!P.foodItems.length?"":`
      <section class="menu-type-block relative" data-menu-type-block="${s(h)}">
        ${P.gridItems.length?`
          <div class="menu-category-section pb-6 pt-4" data-menu-type="${s(h)}">
            <div class="grid grid-cols-2 auto-rows-fr gap-3 app-content-inline">
              ${W(P.gridItems,j=>y(j,C()),L)}
            </div>
          </div>
        `:""}
        ${P.foodItems.length?`
          <div class="menu-category-section pb-6 pt-4" data-menu-type="${s(h)}">
            <div class="app-content-inline">
              ${W(P.foodItems,j=>{const T=K(j),A=C();return T==="testfirst_special"?Re(j,{mode:n,size:"food",priorityIndex:A}):vt(j,{mode:n,priorityIndex:A})},L)}
            </div>
          </div>
        `:""}
      </section>
  ...
  `}function wt(e,{mode:t="profile",useTestfirstCardUi:n=!1,seenCategories:a=null,priorityOffset:i=0}={}){return e.length?n?`
      <div class="grid grid-cols-2 auto-rows-fr gap-3">
        ${W(e,(r,o)=>ht(r,{mode:t,priorityIndex:i+o}),a)}
      </div>
    `:`
    <div class="grid grid-cols-2 auto-rows-fr gap-4">
      ${W(e,(r,o)=>Ee(r,{mode:t,variant:"drink",priorityIndex:i+o}),a)}
    </div>
  `:""}function $t(e,{mode:t="profile",useTestfirstCardUi:n=!1,seenCategories:a=null,priorityOffset:i=0}={}){return e.length?n?`
      <div>
        ${W(e,(r,o)=>K(r)==="testfirst_special"&&Me(r)==="food"?Re(r,{mode:t,size:"food",priorityIndex:i+o}):vt(r,{mode:t,priorityIndex:i+o}),a)}
      </div>
    `:`
    <div class="space-y-4">
      ${W(e,(r,o)=>Ee(r,{mode:t,variant:"food",priorityIndex:i+o}),a)}
    </div>
  `:""}function yt(e,{mode:t="profile"}={}){if(t==="admin"){const n=String(l?.menu?.filter||"all").trim().toLowerCase(),a=e.filter(c=>G(c?.type)==="drink"),i=e.filter(c=>G(c?.type)!=="drink"),r=(c,p,{addType:g=""}={})=>`
      <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
        ...
        ${p.length?`<div class="space-y-3">${p.map(x=>_e(x,{mode:"admin"})).join("")}</div>`:`<div class="text-center py-10 text-[10px] font-bold uppercase tracking-widest text-slate-300">${s(u("menu.noProducts","Keine Produkte"))}</div>`}
      </div>
    ...
    <div class="space-y-4">
      ${e.map((n,a)=>_e(n,{mode:t,priorityIndex:a})).join("")}
    </div>
  `:`
    ...
    `}function Ue(e,{variant:t="focus"}={}){if(!e)return"";const{items:n,enabled:a,loading:i}=le(e,{includeInactive:!0}),r=z(n.length),o=String(t||"").trim().toLowerCase()==="travel-offers",d=o?"Ofertat":"Sot ne Fokus",c=o?"Oferta":"Highlights",p=o?"Im Travel und Profil sichtbar":"Im Profil sichtbar",g=o?"Ofertat werden geladen...":u("focus.loading","Fokus wird geladen..."),x=o?"Noch keine Oferta-Eintraege":"Noch keine Fokus-Eintraege";return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      `:n.length?`
        <div class="space-y-3">
          ${n.map(f=>{const w=E(f.imageUrl||"","thumb"),k=ie(w)?B:w,S=f.active!==!1?"Aktiv":"Inaktiv",$=f.active!==!1?"text-emerald-600":"text-slate-400";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function jn(e){if(!De(e)||!rt(e))return"";const n=ve((l.menu.items||[]).filter(a=>K(a)==="testfirst_special"));return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
          ...
          <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">${s(z(n.length))} Karten</p>
        </div>
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(a=>{const i=E(V(a),"thumb"),r=ie(i)?B:i,o=gt(a),d=o.type==="link"?"Link":o.type==="product"?"Produkt-Modal":"Diese Karte",c=Me(a)==="food"?"Food-Size":"Normal",p=Gt(ne(a));return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function kt(e,{restaurantId:t="",suppressLoading:n=!1,allowAutoEnsure:a=!0,requirePublicMenuTruth:i=!0}={}){const r=String(t||e?.canonicalRestaurantId||e?.restaurantId||"").trim();if(!r||!te(e))return"";const o=ae(l,{profile:e,routePayload:l?.profileView?.routePayload,webDirectEntry:l?.__webDirectEntry,restaurantId:r});if(i&&o.menu.status!=="ready")return"";const d=!i||o.focus.canRenderFocus;if(a&&!l.focus.loading&&!d&&re(at(e,r)),i&&!d)return"";const{items:c,loading:p}=d?{items:Array.isArray(o.focus.items)?o.focus.items:[],loading:o.focus.loading}:le(r);if(!(d?!0:le(r).enabled)||!c.length&&!p||n&&p&&!c.length)return"";if(p&&!c.length)return`
    ...
    `;const x=Nt(c),f=c[x]||c[0],{safeImg:w,fallbackImg:k,imageAttrs:S,lazyAttrs:$}=O(f.imageUrl||"",{mode:"profile",priorityIndex:0,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:f?.id?`focus-carousel:${r}:${String(f.id)}`:""}),I=f.text||"";return`
  ...
  `}function Tn(e,t=220){const n=encodeURIComponent(e||"");return`https://api.qrserver.com/v1/create-qr-code/?size=${t}x${t}&data=${n}`}function St({label:e,url:t,caption:n}){if(!t)return"";const a=Tn(t,240);return`
  ...
  `}function Ln({profile:e,restaurantId:t,catalogLabel:n}){if(!t||!te(e))return"";if(typeof Ge=="function"){const r=ce?ce(t):null;(!r||r.sameRestaurant!==!0||!r.loading&&!r.loaded&&!r.error)&&Ge(e)}const a=typeof ce=="function"?ce(t):{enabled:!0,count:0,tables:[],loading:!1,saving:!1,error:""},i=(a.tables||[]).map(r=>{const o=Ot("apps/menyra-social/index.html",{r:t,tab:"menu",source:"qr",table:r});return St({label:`Tisch ${r}`,url:o,caption:`${n} fuer Tisch ${r}`})}).join("");return`
  ...
  `}function An(){const e=l.userProfile,t=e.restaurantId||"",n=String(l.user?.uid||"").trim(),a=String(l.__authBootstrapInFlightUid||"").trim(),i=!t&&!!n&&(!!l.__authProfileLoadPromise||a===n),r=ge(e),o=te(e),d=l.profileView?.profile?.restaurantId?l.profileView.profile:null,c=Lt()&&!!d?.restaurantId&&te(d),p=nt(We(e)),g=t?ue(t):null,x=g?.name||g?.restaurantName||e.name||"Business",f=t&&l.menu.restaurantId===t,w=String(l.menu.source||"").trim().toLowerCase(),k=!!f&&w==="collection",S=!!f&&w==="collection"&&l.menu.loading,$=!!t&&(S||!k),I=k?ut(l.menu.items,{filter:l.menu.filter,query:l.menu.query}):[],y=rt(e)?I:I.filter(L=>!Xt(L)),F=ve(y),C=z(F.length);return t&&r?(!l.focus.loading&&l.focus.restaurantId!==t&&re(e),fn(e)):(t&&o&&!k&&!S&&Mt(e),t&&o&&!l.focus.loading&&l.focus.restaurantId!==t&&re(e),o?`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      <div class="flex items-end justify-between mb-6">
        <div>
      ...
      ${t?`
        ...
        ${$?`<div class="text-center py-12 text-[10px] font-bold uppercase tracking-widest text-slate-400">${s(u("menu.loading",`${p} wird geladen...`,{label:p}))}</div>`:yt(F,{mode:"admin"})}
        ${l.menu.error?`<div class="text-center text-[10px] font-bold uppercase tracking-widest text-rose-500 mt-4">${s(l.menu.error)}</div>`:""}
        ${Ln({profile:e,restaurantId:t,catalogLabel:p})}
      `:""}
  ...
  `:c?we(d):`
    ...
    `)}function we(e,{mode:t="profile",allowAutoEnsure:n=!0}={}){const a=l?.profileView?.routePayload&&typeof l.profileView.routePayload=="object"?l.profileView.routePayload:null,i=l?.__webDirectEntry&&typeof l.__webDirectEntry=="object"&&l.__webDirectEntry.active===!0?l.__webDirectEntry:null;let r=ae(l,{profile:e,routePayload:a,webDirectEntry:i});const o=r.restaurantId||Wt(e,a);if(!o)return`
    ...
    `;const d=at(e,o),c=te(d);c&&(r=ae(l,{profile:d,routePayload:a,webDirectEntry:i,restaurantId:o,coordinateFocusWithMenu:!0}));const p=String(i?.canonicalRestaurantId||i?.restaurantId||"").trim(),g=new Set(r.targetIds),x=Bn(r.focus.truthState||""),f=r.menu.status==="ready",w=r.focus.canRenderFocus,k=f&&c,S=r.focus.matches===!0&&r.focus.loading===!0,$=t==="landing",m=String(l?.profileView?.menuAccessSource||i?.menuAccessSource||a?.menuAccessSource||"").trim().toLowerCase()==="qr",y=i?.active===!0&&i?.webPriority===!0&&i?.menuFirst===!0&&String(l?.activeTab||"").trim().toLowerCase()==="profile"&&String(l?.profileTopTab||"").trim().toLowerCase()==="menu"&&(p===o||g.has(o)),F=y&&!m,C=["ready","empty","error"].includes(r.menu.status),L=y&&C,_=y&&(!k||r.menu.status!=="ready"),D=!k||r.focus.settled===!0||x==="knownEmpty"||r.menu.status!=="ready";n&&!L&&!C&&zt(d),n&&!_&&!D&&!S&&f&&(!F||C)&&re(d);const h=r.menu.canRenderItems?ve(ut(r.menu.items,{filter:"all",query:""})).filter(U=>!ze(U)):[],P=h.length>0,j=ee(e),T=nt(We(e)),A=r.menu.error||"",$e=!!String(A||"").trim(),Z=r.menu.status==="loading"||r.menu.waitingForFocus===!0,J=h.filter(U=>ne(U)==="drink"),ye=h.filter(U=>ne(U)!=="drink"),q=0,Ve=J.length,se=De(e),ke=new Set;P&&o&&(_t(h,o),Zt(h,o));const Se=o&&w?(Array.isArray(r.focus.items)?r.focus.items:[]).map(U=>Be({...U,objectPosition:de(U)})).filter(Boolean):[],Ie=Se.length?xt(d,Se,{mode:t}):"";return $&&Z?'<div class="app-content-inline app-main-content-safe" style="min-height: 34vh;"></div>':se?`
      <div class="app-main-content-safe">
        ...
        `:`
          ${P?Pn(d,h,{mode:t,publicMenuSurfaceState:r}):$e?`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${s(u("menu.loadError","Menu konnte nicht geladen werden"))}</div>`:Ie||`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300">${s(u("menu.noProducts","Keine Produkte"))}</div>`}
    ...
    <div class="app-content-inline app-main-content-safe space-y-5">
      ${kt(d,{restaurantId:o,suppressLoading:!0,allowAutoEnsure:f&&(!F||C),requirePublicMenuTruth:!0})}
      ${Z?`
            ...
            ${J.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="drink">
                ...
                <div data-menu-type="drink">
                  ${wt(J,{mode:t,useTestfirstCardUi:se,seenCategories:ke,priorityOffset:q})}
                </div>
              </section>
            `:""}
            ${ye.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="food">
                ...
                <div data-menu-type="food">
                  ${$t(ye,{mode:t,useTestfirstCardUi:se,seenCategories:ke,priorityOffset:Ve})}
                </div>
              </section>
            `:""}
          `}
  ...
  `}function zn(){const e=l.userProfile,t=Tt(e),n=t?l.businessPosts:l.userPosts,a=String(l.user?.uid||e?.uid||"").trim(),i=String(e?.restaurantId||"").trim(),r=String(l.__userPostsLoadingUid||"").trim(),o=String(l.__businessPostsLoadingRestaurantId||"").trim(),d=String(l.__authBootstrapInFlightUid||"").trim(),c=!!a&&r===a,p=!!i&&o===i,g=!!a&&d===a,x=t?p||g&&!n.length:c||g&&!n.length,f=String(e.handle||Ne(e.name||"user")).replace(/^@/,""),k=s(e.bio||"").replace(/\n/g,"<br>")||s(u("profile.noBio","Noch keine Bio.")),S=xe(e),$=S==="menu",I=S==="checkins",m=n,y=E(e.avatar,"avatar"),F=Oe(t),C=Te(e);return`
    <div class="app-main-content-safe">
      ${C==="profile"||C==="menu"?`
  ...
  `}return{renderProfilePostCardFancy:it,renderProfilePostsFancy:Fe,renderProfileCheckins:Pe,renderProfileTabs:Le,renderProfileViewControls:Ae,renderPublicProfileView:xn,renderMenuFilterRow:bt,renderMenuLayoutSection:In,renderMenuItemCard:_e,renderMenuItemCardStacked:Ee,renderMenuDrinkGrid:wt,renderMenuFoodList:$t,renderMenuList:yt,renderFocusAdminSection:Ue,renderFocusCarousel:kt,renderMenuQrCard:St,renderMenuAdminView:An,renderProfileMenuView:we,renderProfileView:zn}}export{Kn as createProfileMenuFocusRenderController};
