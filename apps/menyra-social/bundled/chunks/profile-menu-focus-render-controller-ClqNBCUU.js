import{e as ge,f as qa,t as Ga,g as Qa,h as Me,a as Wa}from"../entry/social-app.js";import"./startup-route-runtime-context-6Co7bthZ.js";import"./vendor-firebase-CBvY-Eat.js";function Xa(w={}){const d=w.state,tn=w.resolvePostCountsFn,a=w.escapeHtmlFn,U=w.getOptimizedImageUrlFn,x=w.iconFn,nn=w.isLocalBusinessProfileFn,an=typeof w.isCeoUserFn=="function"?w.isCeoUserFn:(()=>!1),ct=w.normalizeHandleFn,Ue=w.logoFitClassFn,B=w.formatCountFn,ut=w.renderProfileShopCartViewFn,pt=w.renderProfileShopFavoritesViewFn,sn=typeof w.ensurePostsDataForProfileFn=="function"?w.ensurePostsDataForProfileFn:(()=>{}),rn=w.ensureMenuDataForProfileFn,on=typeof w.ensureEditorMenuDataForProfileFn=="function"?w.ensureEditorMenuDataForProfileFn:(()=>{}),me=w.ensureFocusDataForProfileFn,ln=typeof w.ensureAdsDataForProfileFn=="function"?w.ensureAdsDataForProfileFn:(()=>{}),ft=w.ensureTableQrStateForProfileFn,K=w.isShopCatalogProfileFn,dn=w.getBusinessCatalogLabelFn,ie=w.normalizeMenuTypeFn,cn=w.primeMenuItemCountsFn,un=typeof w.hydrateMenuCardViewerLikesFn=="function"?w.hydrateMenuCardViewerLikesFn:(()=>Promise.resolve()),pn=w.renderShopProductListFn,fn=w.getMenuLayoutThemeFn,gn=w.menuLayoutColors,X=w.resolveMenuItemHeroFn,V=w.isPlaceholderUrlFn,H=w.placeholderImage,mn=w.getFirebaseStorageUrlFn,bn=w.isDirectImageUrlFn,gt=w.formatPriceFn,hn=typeof w.resolveCurrencyCodeForMenuItemFn=="function"?w.resolveCurrencyCodeForMenuItemFn:(()=>""),mt=w.getMenuItemImagesFn,q=w.getMenuItemObjectPositionFn,be=w.getMenuItemSocialIdFn,bt=w.menuItemMetaKeyFn,ht=w.ensureMenuItemMetaFn,xt=w.resolveMenuItemCountsFn,he=w.getFocusStateForRestaurantFn,xn=typeof w.getAdsStateForRestaurantFn=="function"?w.getAdsStateForRestaurantFn:(()=>({items:[],enabled:!0,loading:!1,same:!1})),xe=w.getTableQrStateForRestaurantFn,de=w.getFocusItemObjectPositionFn,Be=w.getFocusCardClassFn,vn=w.getFocusIndexFn,se=w.isRestaurantCafeProfileFn,Ne=typeof w.getBusinessProfileTypeFn=="function"?w.getBusinessProfileTypeFn:(()=>""),ce=w.getRestaurantMetaByIdFn,wn=w.buildUrlFn,yn=w.normalizeSearchKeyFn,$n=w.normalizeFollowHandleFn,ee={key:"",inFlightKey:""},vt=new Set,ve=()=>{try{if(globalThis?.__MENYRA_DEBUG_MENU_STATE__===!0||globalThis?.__MENYRA_DEBUG_PROFILE_RENDER__===!0)return!0;const e=new URLSearchParams(globalThis?.location?.search||"");return e.get("debug-menu-state")==="1"||e.get("debug-profile-render")==="1"}catch{return!1}},kn=({profile:e=null,routePayload:t=null,surface:n=null,decision:s=null}={})=>{if(!ve())return;const i=n&&typeof n=="object"?n:{},r=i.menu&&typeof i.menu=="object"?i.menu:{},o=e&&typeof e=="object"?e:{},l=t&&typeof t=="object"?t:{},c=l?.businessSnapshot?.identity||l?.identity||{},g=String(i.authoritativeRestaurantId||i.restaurantId||r.restaurantId||"").trim(),u=String(o.publicSlug||o.landingSlug||o.handle||c.publicSlug||c.landingSlug||c.handle||"").trim(),p=`${g||"pending"}::${u||"no-slug"}`;if(vt.has(p))return;vt.add(p);const m=Array.isArray(r.items)?r.items:[],b=new Set(m.map(y=>String(y?.category||"").trim()).filter(Boolean)).size,k=String(r.rawTruthState||r.truthState||"").trim();console.debug("[mnyra][public-menu.first-render]",{businessId:g,slug:u,itemsLength:m.length,categoriesLength:b,menuStatus:String(r.status||"loading"),truthState:k,isLoading:s?.isLoading===!0,isHydrating:r.hydrating===!0||k.toLowerCase()==="hydrating",confirmedEmpty:r.confirmedEmpty===!0,canRenderItems:r.canRenderItems===!0,shouldRenderNoProducts:s?.shouldRenderNoProducts===!0,source:String(r.source||"")})},In=()=>{try{return String(globalThis?.__MNYRA_BUILD_TOKEN__||globalThis?.__MENYRA_SOCIAL_APP_VERSION__||"").trim()}catch{return""}},De=(e="")=>a(String(e||"")),Z=({renderer:e="profile-menu-focus-render-controller",skeleton:t="",source:n=""}={})=>{if(!ve())return"";const s=[e?`data-debug-renderer="${De(e)}"`:"",t?`data-debug-skeleton="${De(t)}"`:"",n?`data-debug-source="${De(n)}"`:""].filter(Boolean);return s.length?` ${s.join(" ")}`:""},wt=({component:e="profile-menu-focus-render-controller",functionName:t="",profile:n=null,routePayload:s=null,surface:i=null,decision:r=null,items:o=null,rawItems:l=null,filteredItems:c=null,renderDecision:g="",source:u=""}={})=>{const p=i&&typeof i=="object"?i:{},m=p.menu&&typeof p.menu=="object"?p.menu:{},b=p.focus&&typeof p.focus=="object"?p.focus:{},k=n&&typeof n=="object"?n:d?.profileView?.profile&&typeof d.profileView.profile=="object"?d.profileView.profile:{},y=s&&typeof s=="object"?s:d?.profileView?.routePayload&&typeof d.profileView.routePayload=="object"?d.profileView.routePayload:{},I=y?.businessSnapshot&&typeof y.businessSnapshot=="object"?y.businessSnapshot:{},j=I?.identity&&typeof I.identity=="object"?I.identity:y?.identity&&typeof y.identity=="object"?y.identity:{},v=d?.__webDirectEntry&&typeof d.__webDirectEntry=="object"?d.__webDirectEntry:{},S=String(k.publicSlug||k.landingSlug||k.handle||j.publicSlug||j.landingSlug||j.handle||v.publicSlug||"").trim(),A=String(k.restaurantId||y.restaurantId||v.restaurantId||"").trim(),F=String(k.canonicalRestaurantId||y.canonicalRestaurantId||p.authoritativeRestaurantId||v.canonicalRestaurantId||I.restaurantId||"").trim();let L="";k.canonicalRestaurantId?L="profile.canonicalRestaurantId":y.canonicalRestaurantId?L="routePayload.canonicalRestaurantId":p.authoritativeRestaurantId?L="surface.authoritativeRestaurantId":v.canonicalRestaurantId?L="webDirectEntry.canonicalRestaurantId":I.restaurantId?L="routeSnapshot.restaurantId":k.restaurantId?L="profile.restaurantId":y.restaurantId?L="routePayload.restaurantId":v.restaurantId&&(L="webDirectEntry.restaurantId");const $=String(F||p.restaurantId||m.restaurantId||A||"").trim(),_=Array.isArray(l)?l:Array.isArray(m.items)?m.items:[],z=Array.isArray(o)?o:_,R=Array.isArray(c)?c:z,h=new Set(R.map(Q=>String(Q?.category||"").trim()).filter(Boolean)).size,P=String(m.status||(r?.isLoading?"loading":"")||"").trim(),T=String(m.rawTruthState||m.truthState||"").trim(),E=m.confirmedEmpty===!0||r?.confirmedEmpty===!0,M=r?.hasError===!0||P==="error"||!!String(m.error||"").trim(),G=!(R.length>0||r?.hasItems===!0)&&!E&&!M,J=F||A||$||"";return{component:e,functionName:t,slug:S,businessId:$,requestedRestaurantId:A,canonicalRestaurantId:F,restaurantIdSource:L,menuReadPath:J?`restaurants/${J}/public/menu`:"",activeTab:String(d?.activeTab||"").trim(),profileTopTab:String(d?.profileTopTab||"").trim(),profileContentTab:String(d?.profileContentTab||"").trim(),itemsLength:z.length,rawItemsLength:_.length,filteredItemsLength:R.length,categoriesLength:h,focusItemsLength:Array.isArray(b.items)?b.items.length:0,loading:m.loading===!0||r?.isLoading===!0||P==="loading",pending:G,hydrating:m.hydrating===!0||T.toLowerCase()==="hydrating",status:P,truthState:T,confirmedEmpty:E,canRenderItems:m.canRenderItems===!0,renderDecision:g||(r?.shouldRenderNoProducts?"no-products":r?.isLoading?"loading":""),source:u||String(m.source||""),buildToken:In()}},we=(e={})=>{ve()&&console.warn("[mnyra:no-products-render]",{...wt(e),stack:new Error().stack})},ye=(e="",t={})=>{ve()&&console.info("[mnyra:skeleton-render]",{skeletonName:e,...wt({...t,renderDecision:t.renderDecision||"skeleton"}),reason:String(t.reason||"").trim()})},f=(e,t=e,n={})=>Ga(e,{fallback:t,params:n}),Sn=(e="")=>{const t=String(e||"").trim();if(!t)return f("nav.menu","Menue");const n=t.toLowerCase();return n==="menue"||n==="menu"||n==="menü"?f("nav.menu",t):n==="shop"?"Shop":t},yt=(e="")=>{const t=String(e||"").trim();if(!t)return"";const n=t.toLowerCase();return["speisen","food","getraenke","getränke","drink","drinks","beverage","beverages"].includes(n)?f("menu.products","Produkte"):t},Cn=(e="food",t=!1)=>t?f("menu.products","Produkte"):String(e||"").trim().toLowerCase()==="drink"?f("menu.drinks","Getraenke"):f("menu.food","Speisen"),$t=(e={},t=!1)=>{const n=ie(e?.type||"food");return t?f("menu.product","Produkt"):n==="drink"?f("menu.drinkItem","Getraenk"):f("menu.foodItem","Speise")},He=(e="",t="#111827")=>{const n=String(e||"").trim();return/^#[0-9a-fA-F]{6}$/.test(n)?n:t};function Pn(e=null,t=null){return ge(d,{profile:e,routePayload:t,webDirectEntry:d?.__webDirectEntry}).restaurantId}function kt(e=null,t=""){if(!e||typeof e!="object")return e;const n=String(t||"").trim();if(!n)return e;const s=String(e.canonicalRestaurantId||"").trim();return String(e.restaurantId||"").trim()===n&&s?e:{...e,restaurantId:n,...s?{canonicalRestaurantId:s}:{}}}function Fn(e=""){const t=String(e||"").trim();return t?ge(d,{profile:d?.profileView?.profile||d?.userProfile,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:t}).focus.canRenderFocus:!1}function ue(e={}){const t=String(hn(e)||"").trim();return t?gt(e?.price,t):gt(e?.price)}function jn(e=[],t="",n=""){const s=String(t||"").trim(),i=String(n||"").trim();if(!s||!i)return"";const r=Array.isArray(e)?e:[];if(!r.length)return`${s}|${i}|empty`;const o=[];return r.forEach(l=>{const c=String(be(l)||l?.id||"").trim();c&&o.push(c)}),o.length?(o.sort(),`${s}|${i}|${o.join(",")}`):`${s}|${i}|empty`}function An(e=[],t=""){const n=String(d.user?.uid||"").trim(),s=jn(e,t,n);s&&ee.inFlightKey!==s&&ee.key!==s&&(ee.key=s,ee.inFlightKey=s,un(e,t).catch(i=>{console.error(i),ee.key===s&&(ee.key="")}).finally(()=>{ee.inFlightKey===s&&(ee.inFlightKey="")}))}function Ln(e={}){const t=String(e?.uid||"").trim();if(t&&d.followingTargetIds.includes(t))return!0;const n=String(e?.restaurantId||"").trim();if(n&&d.followingTargetIds.includes(n))return!0;const s=$n(e?.handle||"");return!!(s&&d.followingHandles.includes(s))}function It(e={}){if(e?.specialEnabled===!0)return!0;if(e?.specialEnabled===!1)return!1;const t=String(e?.restaurantId||"").trim();if(!t)return!1;const n=typeof ce=="function"&&ce(t)||null;return n?.specialEnabled===!0?!0:(n?.specialEnabled===!1,!1)}function Tn(e={}){return ae(e)==="testfirst_special"?!0:String(e?.category||"").trim().toLowerCase()==="special"}function St(e,t,n=!0,{includeImageKey:s=!0}={}){const i=tn(e),r=e.id?String(e.id):"",o=r?`data-open-post="${a(r)}"`:"",l=r?`data-post-like-count="${a(r)}"`:"",c=r?`data-post-comment-count="${a(r)}"`:"",g=s&&r?`data-img-key="profile-post:${a(r)}"`:"",u=e.type==="wide"||e.type==="hero",p=t&&u?"col-span-2":"",m=t&&u?"aspect-[1.8/1]":"aspect-[4/5]",b=U(e.url,u?"large":"medium",{stableKey:r?`profile-post:${r}`:"",variantGroup:"post-detail"}),k=u?800:400,y=u?400:500;return`
    <div ${o} role="button" tabindex="0" class="${p} relative ${m} rounded-[2rem] overflow-hidden bg-white shadow-[0_30px_60px_-12px_rgba(50,50,93,0.15),0_18px_36px_-18px_rgba(0,0,0,0.15)] cursor-pointer transition-transform">
      <div class="absolute inset-0 rounded-[2rem] overflow-hidden active:scale-[0.98] transition-transform">
        <img src="${a(b)}" loading="lazy" decoding="async" width="${k}" height="${y}" ${g} class="w-full h-full object-cover" />
  ...
  `}function Oe(e,t,n=!0,{includeImageKeys:s=!0}={}){const i=t==="grid";if(!e.length)return`
    ...
    `;const r=e.map(l=>St(l,i,n,{includeImageKey:s})),o=e.reduce((l,c)=>{const g=c?.type==="wide"||c?.type==="hero";return l+(g?2:1)},0);return i&&o%2===1&&r.unshift(`
    ...
    <div class="app-content-inline flex flex-col gap-4 app-main-content-safe animate-in fade-in duration-300">
      ${e.map(t=>{const n=U(t.image,"thumb");return`
  ...
  `}function Wn(e={},t=[]){const n=new Set(t.map(te).filter(Boolean)),s=[],i=(r="")=>{const o=String(r||"").trim();if(!o)return;const l=te(o);n.has(l)||s.some(c=>te(c)===l)||s.push(o)};return[e.features,e.hotelFeatures,e.amenities,e.facilities,e.hotelAmenities].forEach(r=>Ie(r).forEach(i)),s}function Yn({existingImages:e=[],newPreviews:t=[],imageUrlDraft:n=""}={}){const s=[...t.map((o,l)=>({src:o,kind:"new",idx:l})),...e.map((o,l)=>({src:o,kind:"existing",idx:l}))].filter(o=>o.src),i=s[0]?.src||n||"",r=i?U(i,"large"):H;return`
    <div class="space-y-4">
      ...
      <div class="relative rounded-[2.5rem] overflow-hidden border border-slate-100 bg-slate-50">
        <img id="hotelCardCoverHeroPreview" src="${a(r||H)}" class="w-full h-52 object-cover bg-white" />
          ...
          <div class="grid grid-cols-3 gap-2">
            ${s.map(o=>`
              <div class="relative rounded-xl overflow-hidden border border-slate-100 bg-slate-50 aspect-square">
                ...
                <img src="${a(U(o.src,"thumb"))}" class="w-full h-full object-cover" />
  ...
  `}function Se({iconName:e="info",label:t="",value:n="",helper:s=""}={}){return`
  ...
  `}function Ft(e={}){const t=Ke(e),n=En(t),s=O(t,["address","primaryAddress","location","formattedAddress","street"]),i=O(t,["city","locationCity","primaryCity","region","country"]),r=O(t,["beachDistance","distanceToBeach","beachDistanceLabel","strandEntfernung"]),o=O(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),l=O(t,["rating","reviewRating","stars","hotelStars"]),c=O(t,["reviewCount","reviewsCount","ratingsCount","commentsCount"]),g=Dn(t),u=n?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${n.lat},${n.lng}`)}`:s||i?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${s} ${i}`.trim())}`:"";return`
    <div class="app-content-inline flex flex-col gap-4 app-main-content-safe animate-in fade-in duration-300">
      ...
      <div class="grid grid-cols-1 gap-4">
        ${Se({iconName:"map-pin",label:"Adresa",value:[s,i].filter(Boolean).join(", ")||"Shto lokacionin",helper:n?`${n.lat.toFixed(5)}, ${n.lng.toFixed(5)}`:""})}
        ${Se({iconName:"navigation",label:"Qendra",value:o||"Shto detajet"})}
        ${Se({iconName:"waves",label:"Plazhi",value:r||(t.beachfront||t.onBeach?Ct:"Shto detajet")})}
        ${Se({iconName:"star",label:"Vlerësime",value:l?`${l}${c?` / ${c} vlerësime`:""}`:"Pa vlerësime",helper:O(t,["reviewSummary","ratingSummary","commentsSummary"])})}
      </div>
  ...
  `}function Zn(e={}){const t=Ke(e),n=String(e?.restaurantId||t.restaurantId||t.id||"").trim(),s=t?.name||t?.restaurantName||e?.name||"Hotel",i=Bn(n),r=String(i.status||"").trim(),o=i.saving===!0,l=Array.isArray(i.existingImages)?i.existingImages.map(_=>String(_||"").trim()).filter(Boolean):Mn(t),c=Array.isArray(i.imagePreviews)?i.imagePreviews.map(_=>String(_||"").trim()).filter(Boolean):[],g=String(i.imageUrlDraft||"").trim(),[u,p,m]=Nn(t),b=Wn(t,[u,p,m]),k=O(t,["distanceCenter","distanceToCenter","centerDistance","cityCenterDistance","centerDistanceLabel","zentrumEntfernung","distanceCentre"]),y=O(t,["distanceBeach","distanceToBeach","beachDistance","beachDistanceLabel","strandEntfernung","lakeDistance","distanceToLake"]),I=O(t,["hotelStartingPrice","startingPrice","priceFrom","fromPrice","bestPrice","roomStartingPrice"]),j=t.directCenter===!0||t.inCenter===!0||t.cityCenterDirect===!0,v=t.beachfront===!0||t.onBeach===!0||t.amStrand===!0,S=i.detailsOpen===!0||o,A=c[0]||l[0]||"",F=A?U(A,"thumb"):H,L=[k,y,I?`${I} €`:""].filter(Boolean).join(" · ")||"Plotëso detajet",$=r.includes("fehl")||r.includes("Bitte")||r.includes("Nuk");return`
      ...
      ${n?`
        <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
          ...
          <button type="button" data-hotel-card-details-open aria-expanded="${S?"true":"false"}" class="w-full flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100 text-left active:scale-[0.99] transition-transform">
            <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
              <img src="${a(F||H)}" class="w-full h-full object-cover" loading="lazy" decoding="async" />
            </div>
          ...
          ${r&&!S?`<div class="text-center text-[10px] font-black uppercase tracking-widest mt-4 ${$?"text-rose-500":"text-slate-500"}">${a(r)}</div>`:""}
        </div>
        ...
        <div data-hotel-card-editor="${a(n)}" data-hotel-card-details-panel class="${S?"":"hidden "}bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-5 mb-6">
            ...
            <div class="grid grid-cols-1 gap-4">
              ...
              ${Pt({idPrefix:"hotelCardDistanceBeach",iconName:"waves",label:"Plazhi",value:y,directLabel:Ct,direct:v})}
              <div>
                <label class="text-[10px] font-black text-slate-400 uppercase ml-2">Çmimi më i mirë</label>
                <input id="hotelCardStartingPrice" type="text" value="${a(I)}" placeholder="145" inputmode="decimal" class="w-full mt-2 px-5 py-4 bg-slate-50 rounded-2xl text-sm font-bold border-none outline-none focus:ring-2 focus:ring-indigo-100" />
              </div>
            </div>
...
`))}</textarea>
    ...
    <section data-landing-swipe-root="true" class="relative w-full overflow-hidden font-sans" style="height: calc((var(--viewport-height, 1vh) * 100) - var(--smart-header-total-height, 4.5rem)); min-height: calc((var(--viewport-height, 1vh) * 100) - var(--smart-header-total-height, 4.5rem)); overscroll-behavior: none; -webkit-overflow-scrolling: auto; touch-action: none; user-select: none; background: #F8F9FA; --landing-panel-duration: 460ms; --landing-greeting-duration: 720ms; --landing-top-gap: 14px; --landing-swipe-bottom: 0.45rem;">
      ...
      <div data-landing-panel="0" class="absolute inset-0 z-50 flex flex-col items-start justify-center transition-transform ${n===0?"translate-y-0":"-translate-y-full pointer-events-none"}" style="background: #F8F9FA; color: #111827; padding-top: var(--landing-top-gap); opacity: ${n===0?"1":"0"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        ...
        <div class="flex flex-col items-start relative z-10 w-full" style="padding-left: 2.5rem; padding-right: 2.5rem;">
          <div class="relative w-full flex justify-start items-center mb-5" style="height: 40px;">
            ${t.map((R,h)=>{const P=h===s,T=h===(s-1+t.length)%t.length;return`
                <h1 data-landing-greeting-item="${h}" class="absolute left-0 font-medium text-indigo-600 origin-left" style="font-family: 'Playfair Display', Georgia, 'Times New Roman', serif; font-size: 1.875rem; line-height: 2.25rem; transition: all var(--landing-greeting-duration) cubic-bezier(0.23,1,0.32,1); ${P?"opacity: 1; transform: translateY(0) scale(1);":T?"opacity: 0; transform: translateY(-1.5rem) scale(0.95); pointer-events: none;":!P&&!T?"opacity: 0; transform: translateY(1.5rem) scale(0.95); pointer-events: none;":"opacity: 0;"}">
                  ${a(R)}
                </h1>
              `}).join("")}
          </div>
          <div class="flex items-center gap-3 mb-6">
            <div class="rounded-full shadow-sm border border-slate-200 flex items-center justify-center overflow-hidden shrink-0" style="width:48px;height:48px;min-width:48px;min-height:48px;max-width:48px;max-height:48px;flex:0 0 48px;background:#f8fafc;">
              <img src="${a(v)}" alt="${a(`${r} Logo`)}" class="block rounded-full" style="width:100%;height:100%;min-width:100%;min-height:100%;object-fit:cover;object-position:center;max-width:none;max-height:none;" />
            </div>
            <h2 class="font-black text-left flex flex-wrap items-baseline" style="font-size:56px;line-height:48px;letter-spacing:-0.05em;column-gap:0.16em;row-gap:0;">
              <span style="color:${a(c)};">${a(k)}</span>${y?`<span style="color:${a(g)};">${a(y)}</span>`:""}
            </h2>
          </div>
      ...
      <div data-landing-panel="1" class="absolute inset-0 transition-transform ${n<1?"translate-y-full":n===1?"translate-y-0":"-translate-y-full"}" style="background: #F8F9FA; opacity: ${n===1?"1":"0"}; pointer-events: ${n===1?"auto":"none"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        <div data-landing-panel-scroll="1" class="h-full overflow-y-auto overscroll-contain" style="-webkit-overflow-scrolling: touch; touch-action: pan-y; overscroll-behavior-y: none; padding-top: var(--landing-top-gap); padding-bottom: 0;">
          ${je(e,$,{topTabOverride:"profile",tutorialMode:!0,contentTabOverride:"posts",landingHideContent:!0,collapseIdentity:!1,landingMode:!0})}
        </div>
        ${z}
      </div>
      ...
      <div data-landing-panel="2" class="absolute inset-0 transition-transform ${n<2?"translate-y-full":n===2?"translate-y-0":"-translate-y-full"}" style="background: #F8F9FA; opacity: ${n===2?"1":"0"}; pointer-events: ${n===2?"auto":"none"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        <div data-landing-panel-scroll="2" class="h-full overflow-y-auto overscroll-contain" style="-webkit-overflow-scrolling: touch; touch-action: pan-y; overscroll-behavior-y: none; padding-top: var(--landing-top-gap); padding-bottom: 0;">
          ${F?je(e,$,{topTabOverride:"profile",tutorialMode:!0,contentTabOverride:"posts",landingHideContent:!1,collapseIdentity:!0,contentReveal:!0,landingMode:!0}):""}
        </div>
        ${z}
      </div>
      ...
      <div data-landing-panel="3" class="absolute inset-0 transition-transform ${n<3?"translate-y-full":"translate-y-0"}" style="background: #F8F9FA; opacity: ${n===3?"1":"0"}; pointer-events: ${n===3?"auto":"none"}; transition-property: transform, opacity; transition-duration: var(--landing-panel-duration); transition-timing-function: cubic-bezier(0.23,1,0.32,1); will-change: transform, opacity;">
        <div data-landing-panel-scroll="3" class="h-full overflow-y-auto overscroll-contain" style="-webkit-overflow-scrolling: touch; touch-action: pan-y; overscroll-behavior-y: none; padding-top: var(--landing-top-gap); padding-bottom: 0;">
          ${L?je(e,$,{topTabOverride:"profile",tutorialMode:!0,contentTabOverride:"menu",landingHideContent:!1,collapseIdentity:!0,contentReveal:!0,landingMode:!0}):""}
        </div>
      </div>
    </section>
  `}function Qe(e=d.profileView?.profile||d.userProfile,{landingPreview:t=!1,selectedTabOverride:n="",compact:s=!1}={}){const i=$e(e),r=String(n||Ce(e)).trim().toLowerCase()||"posts",o=ke(e),l=K(e),c=o?"Details":l?"Shop":f("nav.menu","Menue"),g=i?[{id:"posts",label:f("profile.posts","Beitraege")},{id:"menu",label:c,surface:o?"hotel-details":"menu"}]:[{id:"posts",label:f("profile.posts","Beitraege")},{id:"media",label:f("profile.media","Medien")},{id:"checkins",label:f("profile.checkins","Check-ins")}];return`
  ...
  `}function We(e=d.profileView?.profile||d.userProfile,{disabled:t=!1}={}){const n=Ce(e);return n==="checkins"||n==="menu"?"":`
  ...
  `}function N(e=""){return String(e||"").trim()}const At="mnyra_business_title_image_cache_v1",Lt=80;function Tt(){if(!d)return{};const e=d.businessTitleImageCache&&typeof d.businessTitleImageCache=="object"?d.businessTitleImageCache:null;if(e?.loaded===!0&&e.items&&typeof e.items=="object")return e.items;let t={};try{const s=(typeof window<"u"?window.localStorage:null)?.getItem?.(At)||"",i=s?JSON.parse(s):{};i&&typeof i=="object"&&Object.entries(i).forEach(([r,o])=>{const l=N(r),c=N(o);l&&c&&!V(c)&&(t[l]=c)})}catch{}return d.businessTitleImageCache={loaded:!0,items:t},t}function ta(e={}){try{const t=typeof window<"u"?window.localStorage:null;if(!t)return;t.setItem(At,JSON.stringify(e))}catch{}}function na(e={},t="business"){const n=[e?.restaurantId,e?.canonicalRestaurantId,e?.uid,e?.handle,e?.publicSlug,e?.landingSlug,e?.name,t].map(s=>N(s)).filter(Boolean);return[...new Set(n)]}function aa(e=[],t=""){const n=N(t);if(!n||V(n))return;const s=Tt();let i=!1;e.forEach(o=>{const l=N(o);!l||s[l]===n||(s[l]=n,i=!0)});const r=Object.entries(s);if(r.length>Lt){const o=r.slice(r.length-Lt);Object.keys(s).forEach(l=>delete s[l]),o.forEach(([l,c])=>{s[l]=c}),i=!0}i&&ta(s)}function sa(e=[]){const t=Tt();for(const n of e){const s=N(n),i=s?N(t[s]):"";if(i&&!V(i))return i}return""}function ra(e={},t="business"){return String(e?.restaurantId||e?.canonicalRestaurantId||e?.uid||e?.handle||e?.name||t).trim()||t}function ia(e={}){return String(e?.canonicalRestaurantId||e?.restaurantId||e?.id||e?.landingRestaurantId||e?.documentId||"").trim()}function oa(e={}){const n=(Array.isArray(e?.coverImages)?e.coverImages:Array.isArray(e?.titleImages)?e.titleImages:[]).map(s=>String(s||"").trim()).find(Boolean)||"";return String(e?.titleImageUrl||e?.coverImageUrl||e?.coverUrl||e?.heroUrl||n||"").trim()}function la(e={},t={}){const n=oa(e),s=Array.isArray(t.cacheKeys)?t.cacheKeys:[],i=N(t.stableKey||s[0]||"");if(!n){if(t.allowCacheFallback===!0){const o=sa(s);if(o)return o;const l=i?U("","medium",{stableKey:i}):"";return l&&!V(l)?l:""}return""}const r=U(n,"medium",i?{stableKey:i}:void 0);return r&&!V(r)?(aa(s,r),r):""}function _t(e="",t=""){const n=N(e);if(!n)return"";if(/^https?:\/\//i.test(n))return n;const s=n.replace(/^@+/,"").replace(/^instagram\.com\//i,"").replace(/^www\.instagram\.com\//i,"").replace(/^tiktok\.com\/@?/i,"").replace(/^www\.tiktok\.com\/@?/i,"").replace(/^\/+/,"").trim();return s?t==="tiktok"?`https://www.tiktok.com/@${encodeURIComponent(s)}`:t==="instagram"?`https://www.instagram.com/${encodeURIComponent(s)}`:"":""}function da(e=""){const t=N(e);if(!t)return"";const n=t.replace(/[^\d+]/g,"");return n?`tel:${n}`:""}function ca(e={}){const t=Number(e?.gpsLat??e?.lat),n=Number(e?.gpsLng??e?.lng);if(Number.isFinite(t)&&Number.isFinite(n))return`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${t},${n}`)}`;const s=[e?.address,e?.locationPlace||e?.place,e?.location,e?.city,e?.country].map(i=>N(i)).filter(Boolean).join(", ");return s?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(s)}`:""}function Pe({href:e="",label:t="",iconName:n="",body:s="",buttonAttrs:i=""}={}){const r=N(e),o=String(i||"").trim();if(!r&&!o)return"";const l=s||x(n,"w-4 h-4"),c="w-9 h-9 rounded-full bg-white text-slate-900 shadow-lg border border-white/80 flex items-center justify-center active:scale-95 transition-transform";return o?`
  ...
  `}function Fe({href:e="",buttonAttrs:t="",iconName:n="",eyebrow:s="",value:i=""}={}){const r=N(i);if(!r)return"";const o=`
  ...
  `}function Rt(e={},t={}){const n=t.mode==="self"?"self":"public",s=t.disabledBlockClass||"",i=t.avatarUrl||U(e.avatar||"","avatar"),r=t.avatarFit||Ue(!!e.restaurantId),o=ra(e,n),l=String(d?.profileCardInfoOpen||"")===o,c=Number(d?.profileCardInfoHeights?.[o]||0),g=l&&Number.isFinite(c)&&c>0?`height:${Math.ceil(c)}px;`:"",u=t.avatarImgKeyAttr||(n==="self"?'data-img-key="avatar:self"':`data-img-key="avatar:public:${a(o)}"`),p=t.renderAvatarImage!==!1&&!!String(i||"").trim()&&!!String(e?.avatar||"").trim(),m=!!t.identityPending,b=t.followersLabel??B(e.followers),k=N(e?.name)||"User",y=N(t.typeLabel||e?.customerType||e?.type||"Business"),I=N(e?.location||"-"),j=n==="public"?`${I} / ${y}`:I,v=t.bioHtml||a(e?.bio||"").replace(/\n/g,"<br>")||a(f("profile.noBio","Noch keine Bio.")),S=`business-cover:${o}`,A=na(e,o),F=la(e,{cacheKeys:A,stableKey:S,allowCacheFallback:t.allowTitleImageCacheFallback===!0}),L=ca(e),$=ia(e),_=Pe($?{buttonAttrs:`data-marketplace-open-map="${a($)}"`,label:f("profile.openMap","Karte oeffnen"),iconName:"map"}:{href:L,label:f("profile.openMap","Karte oeffnen"),iconName:"map"}),z=_t(e?.instagramUrl||e?.instagram||e?.insta||"","instagram"),R=_t(e?.tiktokUrl||e?.tiktok||e?.tikTok||"","tiktok"),h=N(e?.phone||e?.telephone||e?.contactPhone||""),P=da(h),T=N(e?.address||e?.locationLabel||[e?.place||e?.locationPlace,e?.location||e?.city].map(D=>N(D)).filter(Boolean).join(", ")),E=[Fe({href:z,iconName:"instagram",eyebrow:"Instagram",value:e?.instagram||e?.instagramUrl||e?.insta||""}),Fe({href:R,iconName:"music-2",eyebrow:"TikTok",value:e?.tiktok||e?.tiktokUrl||e?.tikTok||""})].filter(Boolean).join(""),M=n==="self"?`
    ...
    `;if(l){const D=[Fe({href:P,iconName:"phone",eyebrow:f("profile.call","Anrufen"),value:h}),Fe({href:L,iconName:"map-pin",eyebrow:f("profile.address","Adresse"),value:T||I}),E].filter(Boolean).join("");return`
      <div data-landing-tutorial-target="identity" data-business-profile-card="${a(o)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${s}" style="${g}min-height: var(--business-profile-card-min-height, 440px);display:grid;grid-template-columns:minmax(0,1fr);width:100%;max-width:100%;min-width:0;box-sizing:border-box;">
        ${ua({profileName:k,safeBio:v,metaLine:j,identityPending:m,followersLabel:b})}
        <div class="p-8 min-w-0 max-w-full overflow-hidden flex flex-col justify-between" style="grid-area:1/1;min-height:100%;width:100%;max-width:100%;box-sizing:border-box;">
          ...
          <div class="pr-10 min-w-0 max-w-full overflow-hidden">
            ...
            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-4">${a(I)}</p>
          </div>
          <div class="mt-8 flex flex-col gap-4 min-w-0 max-w-full overflow-hidden">
            ${D||`<div class="py-10 text-center text-[10px] font-bold uppercase tracking-widest text-slate-300">${a(f("profile.noContactInfo","Noch keine Kontaktdaten"))}</div>`}
          </div>
    ...
    <div data-landing-tutorial-target="identity" data-business-profile-card="${a(o)}" class="bg-white rounded-[2.5rem] relative overflow-hidden z-10 border border-slate-100 shadow-sm ${s}" style="min-height: var(--business-profile-card-min-height, 440px);">
      <div class="h-40 w-full bg-slate-900 relative overflow-hidden flex items-center justify-center select-none">
        ...
        <div class="absolute top-4 right-4 flex items-center gap-2 z-30">
          ${_}
          ${Pe({href:R,label:"TikTok",iconName:"music-2"})}
          ${Pe({href:z,label:"Instagram",iconName:"instagram"})}
        </div>
      </div>
      <div class="px-8 pb-8 relative z-20" style="margin-top:-3rem;">
        <div class="flex items-end justify-between w-full">
  ...
  `}function je(e={},t=[],{topTabOverride:n="",tutorialMode:s=!1,contentTabOverride:i="",landingHideContent:r=!1,collapseIdentity:o=!1,contentReveal:l=!1,landingMode:c=!1}={}){const g=Ln(e),u=!!e.privateAccount&&e.uid&&String(e.uid)!==String(d.user?.uid||"")&&!g,p=!!e.pendingFollowRequest&&!g,m=e.restaurantId?"Business":f("nav.user","User"),b=String(e.handle||ct(e.name||"user")).replace(/^@/,""),y=a(e.bio||"").replace(/\n/g,"<br>")||a(f("profile.noBio","Noch keine Bio.")),I=$e(e),j=String(n||Ge(e)).trim().toLowerCase()||"profile",v=String(i||Ce(e)).trim().toLowerCase()||"posts",S=v==="menu",A=v==="checkins",F=t,$={...d?.profileView&&typeof d.profileView=="object"?d.profileView:{},profile:e,posts:Array.isArray(F)?F:[]},_=Qa(d,{profileView:$,profileTopTab:j,profileContentTab:v}),z=String(_?.header?.status||"").trim().toLowerCase()||"loading",R=String(_?.posts?.status||"").trim().toLowerCase()||"loading",h=String(e?.avatar||"").trim(),P=h?U(h,"avatar"):"",T=Ue(!!e.restaurantId),E=e.uid||e.restaurantId||b||"public",M=c?"":`data-img-key="avatar:public:${a(E)}"`,D=!!h,G=dt=>{if(dt==null)return!1;const en=Number(dt);return Number.isFinite(en)&&en>=0},J=D||G(e?.followers)||G(e?.following),Q=Me(z)&&!J,Te=!!String(P||"").trim()&&D,re=Q?"...":B(e.followers),ot=Q?"...":B(e.following),_e=I?"pt-2":"pt-10",fe=g?f("profile.following","Following"):p?f("profile.requested","Requested"):u?f("profile.request","Request"):f("profile.follow","Follow"),Re=g?"bg-slate-100 text-slate-600 shadow-none border border-slate-200":p?"bg-amber-50 text-amber-700 shadow-none border border-amber-200":"bg-gradient-to-r from-slate-900 to-slate-800 text-white border border-transparent",ze=s?"select-none":"app-main-content-safe",W=s?"pointer-events-none":"",lt=!o,Y=!r,Ee=l?c?"transition-opacity duration-200":"animate-in fade-in duration-300":"",Xt=v==="posts"&&F.length>0,Va=v!=="posts"||Xt||R==="empty"||R==="error",Ka=v==="posts"&&!Xt&&R==="error";return!s&&(v==="posts"||v==="media")&&e?.restaurantId&&Me(R)&&sn(e),`
    <div class="${ze}" ${s?'data-landing-tutorial-surface="true"':""}>
      ${j==="profile"||j==="menu"?`
      ${lt?`
        <div class="app-content-inline pb-2 ${_e}">
          ${I?Rt(e,{mode:"public",disabledBlockClass:W,avatarUrl:P,avatarFit:T,avatarImgKeyAttr:M,renderAvatarImage:Te,identityPending:Q,followersLabel:re,followLabel:fe,followTone:Re,isFollowing:g,hasPendingFollowRequest:p,isLocked:u,bioHtml:y,typeLabel:m,allowTitleImageCacheFallback:Me(z)||Me(R)}):`
          <div data-landing-tutorial-target="identity" class="bg-white rounded-[2.5rem] p-8 relative overflow-hidden z-10 border border-slate-100 ${W}">
            <div class="relative z-10">
              <div class="flex justify-between items-start mb-8">
                <div class="relative">
                  <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500">
                    ${Te?`<img src="${a(P)}" decoding="async" width="100" height="100" ${M} class="w-full h-full rounded-[1.8rem] ${T} border-2 border-white" />`:`<div class="w-full h-full rounded-[1.8rem] border-2 border-white bg-slate-100 flex items-center justify-center ${Q?"animate-pulse":""}">${x(e.restaurantId?"store":"user","w-8 h-8 text-slate-300")}</div>`}
                  </div>
                  ${e.isPremium?`
                    <div class="absolute -bottom-1 -right-1 bg-white rounded-full p-1.5 shadow-lg text-blue-500 border-2 border-slate-50">
                      ${x("badge-check","w-4 h-4 fill-blue-500 text-white")}
                ...
                <div class="flex items-center gap-6 pt-3 pr-2">
                   <div data-landing-tutorial-target="fans" class="flex flex-col items-center">
                      <span class="font-black text-2xl ${Q?"text-slate-300":"text-slate-900"} leading-none mb-1">${a(re)}</span>
                      <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest opacity-80">${a(f("profile.fans","Fans"))}</span>
                   </div>
                   <div class="w-px h-8 bg-slate-100"></div>
                   <div class="flex flex-col items-center">
                      <span class="font-black text-2xl ${Q?"text-slate-300":"text-slate-900"} leading-none mb-1">${a(ot)}</span>
              ...
              <div class="mb-8">
                ...
                ${I?"":`<p class="text-[11px] font-bold text-slate-400 uppercase tracking-[0.3em] mb-2">@${a(b)}</p>`}
                ...
                ${Q?`<p class="text-[9px] font-bold text-slate-300 uppercase tracking-widest mt-2">${a(f("profile.headLoading","Profilkopf wird geladen..."))}</p>`:""}
              </div>

              <div class="flex gap-4">
                <button data-landing-tutorial-target="follow" data-public-profile-follow="${a(e.handle)}" data-target-type="${a(e.restaurantId?"restaurant":e.uid?"user":"")}" data-target-id="${a(e.restaurantId||e.uid||"")}" data-target-name="${a(e.name||"")}" data-target-avatar="${a(e.avatar||"")}" ${p?"disabled":""} class="flex-1 h-[56px] rounded-[1.2rem] font-bold text-xs uppercase tracking-widest shadow-[0_10px_20px_-5px_rgba(15,23,42,0.25)] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden ${Re} ${p?"opacity-90 cursor-default":""}">
                  <span class="relative z-10 flex items-center gap-2">
                    ${g?x("check","w-4 h-4"):""}
                    ${fe}
                  </span>
      ...
      `:`
        ${Qe(e,{landingPreview:s,selectedTabOverride:v,compact:o})}
        ${Y?We(e,{disabled:s}):""}

        ${Y?S?`
          <div class="${W} ${Ee}">
            ${ke(e)?Ft(e):Le(e,{mode:c?"landing":"profile",allowAutoEnsure:!c})}
          </div>
        `:A?`
          <div class="${W} ${Ee}">
            ${Ve()}
        ...
        `:`
          ${Va?`
            ...
            `:`
              <div class="${d.profileViewMode==="grid"?"grid grid-cols-2 gap-4 app-content-inline grid-flow-dense":"flex flex-col gap-8 app-content-inline"} ${W} ${Ee}">
                ${Oe(F,d.profileViewMode,!1,{includeImageKeys:!c})}
              </div>
            `}
          `:`
            <div class="app-content-inline ${W}">
  ...
  `}function pa(){const e=d.profileView;if(!e||!e.profile)return"";const t=e.profile,n=e.posts||t.posts||[],s=Ge(t);return s==="landing"?ea(t):je(t,n,{topTabOverride:s,tutorialMode:!1})}function zt(e,{filter:t="all",query:n=""}={}){const s=Array.isArray(e)?e:[],i=yn(n||"");return s.filter(r=>t==="all"||ie(r.type)===t?i?`${r.name||""} ${r.category||""} ${r.description||""}`.toLowerCase().includes(i):!0:!1)}function Et(e,t=0){const n=Number(e);return Number.isFinite(n)?Math.max(0,Math.floor(n)):Math.max(0,Number(t)||0)}function Ae(e=[]){return(Array.isArray(e)?e.slice():[]).map((n,s)=>({item:n,idx:s,order:Et(n?.orderIndex,s)})).sort((n,s)=>n.order-s.order||n.idx-s.idx).map((n,s)=>({...n.item,orderIndex:Et(n.item?.orderIndex,s)}))}function Ye(e={}){const t=String(e?.menuVisibility||"").trim().toLowerCase();return e?.menuHidden===!0||t==="hidden"}function pe(e={}){const t=String(e?.menuSection||e?.displaySection||e?.menuPlacement||"").trim().toLowerCase();return t==="drink"?"drink":t==="food"?"food":ie(e?.type||"food")==="drink"?"drink":"food"}function fa(e={}){return String(e?.category||f("menu.other","Sonstiges")).trim()||f("menu.other","Sonstiges")}function ga(e=""){const t=String(e||"").trim().toLowerCase();return t?(typeof t.normalize=="function"?t.normalize("NFD").replace(/[\u0300-\u036f]/g,""):t).replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""):""}const ma=4,ba={thumb:160,small:480,medium:768,large:1280};function Mt({mode:e="profile",priorityIndex:t=-1,slideIndex:n=0}={}){return(e==="profile"||e==="landing")&&Number.isFinite(t)&&t>=0&&t<ma&&n===0}function ha({mode:e="profile",priorityIndex:t=-1,slideIndex:n=0}={}){const s=Mt({mode:e,priorityIndex:t,slideIndex:n}),i=e==="profile"?' data-image-reveal="menu"':"";return s?`loading="eager" fetchpriority="high"${i}`:`loading="lazy" fetchpriority="low"${i}`}function xa({variant:e="grid"}={}){return e==="thumb"?"(max-width: 640px) 64px, 64px":e==="hero"?"(max-width: 640px) 94vw, (max-width: 1200px) 74vw, 920px":"(max-width: 640px) 48vw, (max-width: 1200px) 28vw, 360px"}function ne(e,{mode:t="profile",priorityIndex:n=-1,slideIndex:s=0,stableKey:i="",preferredSize:r="small",candidateSizes:o=["small","medium","large"],variant:l="grid"}={}){const c=String(e||"").trim(),g=t==="profile"&&i?{stableKey:i}:null,u=Mt({mode:t,priorityIndex:n,slideIndex:s}),p=t==="profile"&&!u&&l!=="thumb",m=U(c,r,g),b=V(m)?H:m,k=mn(c),y=bn(c)&&c!==b?c:k,I=[],j=new Set;o.forEach(h=>{const P=ba[h]||0;if(!P)return;const T=U(c,h,g);if(!T||V(T))return;const E=`${T}|${P}`;j.has(E)||(j.add(E),I.push(`${T} ${P}w`))});const v=I.length>1?I.join(", "):"",S=v?xa({variant:l}):"",A=p?"":v,F=p?"":S,L=A?` srcset="${a(A)}"`:"",$=F?` sizes="${a(F)}"`:"",_=ha({mode:t,priorityIndex:n,slideIndex:s}),z=`${_}${L}${$}`,R=p?[`data-menu-lazy-src="${a(b)}"`,`data-menu-lazy-fallback="${a(y||H)}"`,v?`data-menu-lazy-srcset="${a(v)}"`:"",S?`data-menu-lazy-sizes="${a(S)}"`:""].filter(Boolean).join(" "):"";return{safeImg:p?H:b,fallbackImg:p?H:y,imageAttrs:z,lazyAttrs:R?` ${R}`:"",srcsetValue:v,sizesValue:S,loadingAttrs:_}}function oe(e=[],t,n=null){const s=n instanceof Set?n:new Set;return e.map((i,r)=>{const o=fa(i),l=ga(o),c=!!l&&!s.has(l);return c&&s.add(l),`<div${c?` data-menu-category-anchor="${a(l)}"`:""} class="h-full">${t(i,r)}</div>`}).join("")}function Ze(e={}){return String(e?.specialSize||e?.specialCardSize||"").trim().toLowerCase()==="food"?"food":"default"}function va(e=""){const t=String(e||"").trim();return t?/^(https?:\/\/|mailto:|tel:)/i.test(t)?t:`https://${t.replace(/^\/+/,"")}`:""}function Ut(e={}){const t=String(e?.specialActionType||e?.actionType||"").trim().toLowerCase(),n=va(e?.specialActionUrl||e?.linkUrl||e?.actionUrl||""),s=String(e?.specialActionProductId||e?.targetProductId||"").trim();return t==="link"&&n?{type:"link",url:n,productId:""}:t==="product"&&s?{type:"product",url:"",productId:s}:{type:"self",url:"",productId:""}}function Bt(){const e=K(d.userProfile),t=String(d.menu.filter||"all").trim().toLowerCase()||"all",n=e&&t==="drink"?"all":t;return`
  ...
  `}function Je(e,{mode:t="profile",priorityIndex:n=-1}={}){const s=X(e),i=t==="profile"?le(e,{index:0}):"",{safeImg:r,fallbackImg:o,imageAttrs:l,lazyAttrs:c}=ne(s,{mode:t,priorityIndex:n,stableKey:i,preferredSize:"thumb",candidateSizes:["thumb","small"],variant:"thumb"}),g=ue(e),u=d.activeTab==="menu"?d.userProfile:d.profileView?.profile||d.userProfile,p=K(u),m=$t(e,p),b=p?yt(e.category):e.category||"",k=e.description||"";return t==="admin"?`
      <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
        <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
          <img src="${a(r)}" data-fallback-src="${a(o)}"${c} class="w-full h-full object-cover" style="object-position:${q(e)};" ${l} decoding="async" />
        </div>
        <div class="flex-1 min-w-0">
  ...
  `}function Xe(e,{mode:t="profile",variant:n="food",priorityIndex:s=-1}={}){const i=X(e),r=t==="profile"?le(e,{index:0}):"",o=n==="drink",{safeImg:l,fallbackImg:c,imageAttrs:g,lazyAttrs:u}=ne(i,{mode:t,priorityIndex:s,stableKey:r,preferredSize:o?"small":"medium",candidateSizes:o?["small","medium"]:["small","medium","large"],variant:o?"grid":"hero"}),p=ue(e),m=d.activeTab==="menu"?d.userProfile:d.profileView?.profile||d.userProfile,b=K(m),k=$t(e,b),y=b?yt(e.category):e.category||"",I=e.description||"",j=t==="profile"?`data-menu-open="${a(e.id)}" role="button"`:"",v=d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"",S=be(e),A=bt(v,S),F=A?ht(A):{likes:[],comments:[],counts:{likes:0,comments:0}},L=xt(F),$=`
    <div class="mt-2 flex items-center gap-3 text-[10px] font-bold text-slate-400">
      <span class="inline-flex items-center gap-1">
        ${x("heart","w-3 h-3 text-rose-400")} <span data-menu-like-count="${a(S)}">${a(B(L.likes))}</span>
      </span>
      <span class="inline-flex items-center gap-1">
        ${x("message-circle","w-3 h-3 text-indigo-400")} <span data-menu-comment-count="${a(S)}">${a(B(L.comments))}</span>
      </span>
    </div>
  `;return`
    <div ${j} class="w-full ${o?"h-full p-3 rounded-[1.6rem] flex flex-col":"p-4 rounded-[2rem]"} bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all ${t==="profile"?"cursor-pointer":""}">
      <div class="w-full ${o?"h-28 rounded-[1.4rem]":"h-44 rounded-[1.8rem]"} overflow-hidden bg-slate-100">
        <img src="${a(l)}" data-fallback-src="${a(c)}"${u} class="w-full h-full object-cover" style="object-position:${q(e)};" ${g} decoding="async" />
      </div>
      ${o?`
  ...
  `}function et(e={}){if(!e?.restaurantId||K(e))return!1;const t=String(Ne(e)||"").trim().toLowerCase();return t?t==="restaurant"||t==="cafe"||t==="fastfood":se(e)}function Nt(e){const t=e?.restaurantId||d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"",n=be(e),s=bt(t,n),i=s?ht(s):{likes:[],comments:[],counts:{likes:0,comments:0}},r=String(d.user?.uid||"").trim(),o=String(d.user?.handle||"").trim().toLowerCase(),l=!!i.likes?.some(c=>{const g=String(c?.uid||"").trim();if(r&&g&&g===r)return!0;const u=String(c?.handle||"").trim().toLowerCase();return!!o&&!!u&&u===o});return{itemId:n,meta:i,counts:xt(i),isLiked:l}}function le(e,{index:t=0}={}){const n=String(e?.restaurantId||d.menu.restaurantId||d.profileView?.profile?.restaurantId||d.userProfile.restaurantId||"").trim(),s=String(e?.id||be(e)||"").trim();if(!n||!s)return"";const i=Number(t),r=Number.isFinite(i)?Math.max(0,Math.floor(i)):0;return`menu-detail:${n}:${s}:${r}`}function ya(e){const t=typeof mt=="function"?mt(e):[],n=Array.isArray(t)?t.filter(Boolean):[];if(n.length)return n;const s=X(e);return s?[s]:[]}function ae(e){return Wa(e?.cardStyle||"",ie(e?.type||"food"))}function tt(e,{menuItemId:t=""}={}){if(!e)return null;const n=String(t||e.menuItemId||e.itemId||e.productId||"").trim();return{id:e.id||"",title:e.name||e.title||"Sot ne Fokus",text:e.description||e.text||"",imageUrl:X(e)||e.imageUrl||"",objectPosition:e.objectPosition||q(e),menuItemId:n}}function C(e=""){return`<div aria-hidden="true" class="${e} bg-slate-100 animate-pulse"></div>`}function $a(e={}){return ye("focus-carousel-skeleton",{...e,functionName:"renderFocusCarouselSkeleton",source:e?.source||"public-focus"}),`
  ...
  `}function ka(e={}){return ye("testfirst-focus-skeleton",{...e,functionName:"renderTestfirstFocusSkeleton",source:e?.source||"public-focus"}),`
  ...
  `}function Dt(e={}){return ye("testfirst-menu-skeleton",{...e,functionName:"renderTestfirstMenuSkeleton",source:e?.source||"public-menu"}),`
  ...
  `}function Ot({isShop:e=!1,debugContext:t={}}={}){return ye(e?"standard-shop-product-skeleton":"standard-menu-skeleton",{...t,functionName:"renderStandardMenuSkeleton",source:t?.source||"public-menu",reason:t?.reason||(e?"shop-products-loading":"menu-loading")}),e?`
  ...
  `}function Vt(e,t=[],{mode:n="profile"}={}){const s=e?.restaurantId||"",i=et(e)||K(e);return!s||!i||!t.length?"":`
    <div class="pt-2 pb-4">
      <div class="flex gap-4 overflow-x-auto hide-scrollbar snap-x horizontal-safe-scroll pb-4">
  ...
  `}function Kt(e,{mode:t="profile",priorityIndex:n=-1}={}){const s=X(e),i=t==="profile"?le(e,{index:0}):"",{safeImg:r,fallbackImg:o,imageAttrs:l,lazyAttrs:c}=ne(s,{mode:t,priorityIndex:n,stableKey:i,preferredSize:"small",candidateSizes:["small","medium"],variant:"grid"}),g=ue(e),u=t==="profile"?`data-menu-open="${a(e.id)}" role="button"`:"",{itemId:p,counts:m,isLiked:b}=Nt(e);return`
    <div ${u} class="h-full bg-white p-2.5 rounded-[1.8rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.03)] flex flex-col group relative ${t==="profile"?"cursor-pointer":""}">
      <div class="w-full aspect-square rounded-[1.4rem] overflow-hidden bg-slate-100 mb-3 relative">
        <img src="${a(r)}" data-fallback-src="${a(o)}"${c} class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105 select-none pointer-events-none" draggable="false" style="width:100%;height:100%;object-fit:cover;object-position:${q(e)};" ${l} decoding="async" />
        <button
          type="button"
  ...
  `}function Pa(e,t="profile"){if(t!=="profile")return"";const n=Ut(e);return n.type==="link"&&n.url?`data-menu-special-link="${a(n.url)}" role="button" tabindex="0"`:n.type==="product"&&n.productId?`data-menu-open="${a(n.productId)}" role="button"`:`data-menu-open="${a(e.id)}" role="button"`}function nt(e,{mode:t="profile",size:n="default",priorityIndex:s=-1}={}){const i=X(e),r=t==="profile"?le(e,{index:0}):"",o=n==="food",{safeImg:l,fallbackImg:c,imageAttrs:g,lazyAttrs:u}=ne(i,{mode:t,priorityIndex:s,stableKey:r,preferredSize:o?"medium":"small",candidateSizes:o?["small","medium","large"]:["small","medium"],variant:o?"hero":"grid"}),p=Pa(e,t),m=String(e.category||"Special").trim()||"Special",b=a(String(e.name||"Special")).replace(/\n/g,"<br>");return n==="food"?`
      <div ${p} class="rounded-[2.2rem] shadow-[0_8px_30px_rgb(0,0,0,0.06)] relative overflow-hidden mb-5 group aspect-[16/9] ${t==="profile"?"cursor-pointer":""}" style="border-radius:2.2rem;aspect-ratio:16 / 9;margin-bottom:20px;">
        <img src="${a(l)}" data-fallback-src="${a(c)}"${u} class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 select-none pointer-events-none" draggable="false" style="width:100%;height:100%;object-fit:cover;object-position:${q(e)};" ${g} decoding="async" />
  ...
  `}function qt(e,{mode:t="profile",priorityIndex:n=-1}={}){const s=ue(e),i=t==="profile"?`data-menu-open="${a(e.id)}" role="button"`:"",r=ya(e),l=(r.length?r:[X(e)||""]).filter(Boolean),c=l.length?l.slice(0,12):[""],g=c.length>1,{itemId:u,counts:p,isLiked:m}=Nt(e),b=B(Math.max(0,Number(p.likes)||0)),k=B(Math.max(0,Number(p.comments)||0));return`
    <div ${i} class="bg-white p-3.5 rounded-[2.2rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-5 group relative ${t==="profile"?"cursor-pointer":""}" style="padding:14px;border-radius:2.2rem;margin-bottom:20px;box-sizing:border-box;">
      <div class="w-full aspect-[16/9] rounded-[1.8rem] overflow-hidden bg-slate-100 mb-4 relative" style="aspect-ratio:16 / 9;border-radius:1.8rem;margin-bottom:16px;">
        ${g?`
          ...
          >
            ${c.map((y,I)=>{const j=t==="profile"?le(e,{index:I}):"",v=ne(y||"",{mode:t,priorityIndex:n,slideIndex:I,stableKey:j,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"}),S=I>0,A=S?H:v.safeImg,F=S?H:v.fallbackImg,L=S?v.loadingAttrs:v.imageAttrs,$=S?"":v.lazyAttrs||"",_=S?` data-menu-card-deferred-src="${a(v.safeImg)}"
                    data-menu-card-deferred-fallback="${a(v.fallbackImg)}"
                    ${v.srcsetValue?`data-menu-card-deferred-srcset="${a(v.srcsetValue)}"`:""}
                    ${v.sizesValue?`data-menu-card-deferred-sizes="${a(v.sizesValue)}"`:""}`:"";return`
                <div class="min-w-full h-full snap-center relative" data-menu-card-gallery-slide="${I}" style="min-width:100%;width:100%;height:100%;scroll-snap-align:center;">
                  <img src="${a(A)}" data-fallback-src="${a(F)}"${$}${_} class="w-full h-full object-cover select-none pointer-events-none" draggable="false" style="object-position:${q(e)};" ${L} decoding="async" />
                </div>
              `}).join("")}
          </div>
        `:`
          ${c.map((y,I)=>{const j=t==="profile"?le(e,{index:I}):"",{safeImg:v,fallbackImg:S,imageAttrs:A,lazyAttrs:F}=ne(y||"",{mode:t,priorityIndex:n,slideIndex:I,stableKey:j,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero"});return`
              <div class="w-full h-full">
                <img src="${a(v)}" data-fallback-src="${a(S)}"${F} class="w-full h-full object-cover select-none pointer-events-none" draggable="false" style="object-position:${q(e)};" ${A} decoding="async" />
              </div>
            `}).join("")}
        `}
        <button
          ...
          <div class="absolute bottom-4 left-0 right-0 flex justify-center gap-1.5 z-10 pointer-events-none">
            ${c.map((y,I)=>`
              <div
                ...
                data-menu-card-gallery-index="${I}"
                class="${I===0?"w-4 h-1.5 bg-white rounded-full shadow-sm":"w-1.5 h-1.5 bg-white/60 rounded-full shadow-sm"}"
              ></div>
            `).join("")}
          </div>
        `:""}
  ...
  `}function Fa(e,t,{mode:n="profile",publicMenuSurfaceState:s=null,focusFallbackHtml:i=""}={}){const r=Ae(Array.isArray(t)?t:[]),o=String(e?.restaurantId||"").trim(),l=n==="admin"||Fn(o),c=s?.focus?.canRenderFocus?{items:Array.isArray(s.focus.items)?s.focus.items:[],enabled:!0}:o&&l?he(o):{items:[],enabled:!1},g=c.enabled?(Array.isArray(c.items)?c.items:[]).map(h=>tt({...h,objectPosition:de(h)})):[],u=r.filter(h=>ae(h)==="testfirst_focus"&&!Ye(h)).map(h=>tt(h,{menuItemId:h.id||""})).filter(Boolean),p=new Set,m=[...g,...u].filter(h=>{const P=String(h.menuItemId||h.id||`${h.title}|${h.text}|${h.imageUrl}`);return!P||p.has(P)?!1:(p.add(P),!0)}),b=r.filter(h=>!Ye(h)),k=b.filter(h=>ae(h)!=="testfirst_focus"),y=k.length?k:b,I=k.length?m:[],j=y.filter(h=>pe(h)==="drink"),v=y.filter(h=>pe(h)!=="drink"),S=(h=[])=>{const P=[],T=[];return h.forEach(E=>{const M=ae(E);M==="testfirst_food"||M==="testfirst_special"&&Ze(E)==="food"?T.push(E):P.push(E)}),{gridItems:P,foodItems:T}},A=(h,P=-1)=>ae(h)==="testfirst_special"?nt(h,{mode:n,priorityIndex:P}):Kt(h,{mode:n,priorityIndex:P});let F=0;const L=()=>{const h=F;return F+=1,h},$=new Set,_=(h,P)=>!P.gridItems.length&&!P.foodItems.length?"":`
      <section class="menu-type-block relative" data-menu-type-block="${a(h)}">
        ...
        ${P.foodItems.length?`
          <div class="menu-category-section pb-6 pt-4" data-menu-type="${a(h)}">
            <div class="app-content-inline">
              ${oe(P.foodItems,T=>{const E=ae(T),M=L();return E==="testfirst_special"?nt(T,{mode:n,size:"food",priorityIndex:M}):qt(T,{mode:n,priorityIndex:M})},$)}
            </div>
          </div>
        `:""}
      </section>
  ...
  `}function Gt(e,{mode:t="profile",useTestfirstCardUi:n=!1,seenCategories:s=null,priorityOffset:i=0}={}){return e.length?n?`
      <div class="grid grid-cols-2 auto-rows-fr gap-3">
        ${oe(e,(r,o)=>Kt(r,{mode:t,priorityIndex:i+o}),s)}
      </div>
    `:`
    <div class="grid grid-cols-2 auto-rows-fr gap-4">
      ${oe(e,(r,o)=>Xe(r,{mode:t,variant:"drink",priorityIndex:i+o}),s)}
    </div>
  `:""}function Qt(e,{mode:t="profile",useTestfirstCardUi:n=!1,seenCategories:s=null,priorityOffset:i=0}={}){return e.length?n?`
      <div>
        ${oe(e,(r,o)=>ae(r)==="testfirst_special"&&Ze(r)==="food"?nt(r,{mode:t,size:"food",priorityIndex:i+o}):qt(r,{mode:t,priorityIndex:i+o}),s)}
      </div>
    `:`
    <div class="space-y-4">
      ${oe(e,(r,o)=>Xe(r,{mode:t,variant:"food",priorityIndex:i+o}),s)}
    </div>
  `:""}function Wt(e,{mode:t="profile"}={}){if(t==="admin"){const n=String(d?.menu?.filter||"all").trim().toLowerCase(),s=K(d.userProfile),i=f("menu.products","Produkte"),r=e.filter(u=>ie(u?.type)==="drink"),o=e.filter(u=>ie(u?.type)!=="drink"),l=(u,p,{addType:m=""}={})=>`
      <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
        <div class="flex items-center justify-between mb-4">
          <div>
            ...
            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">${a(B(p.length))} Eintraege</p>
          </div>
          ${m?`
        ...
        ${p.length?`<div class="space-y-3">${p.map(b=>Je(b,{mode:"admin"})).join("")}</div>`:(we({functionName:"renderMenuList.adminSection",items:p,rawItems:p,filteredItems:p,renderDecision:"admin-section-no-products",source:"admin-menu"}),`<div class="text-center py-10 text-[10px] font-bold uppercase tracking-widest text-slate-300"${Z({source:"admin-menu:no-products"})}>${a(f("menu.noProducts","Keine Produkte"))}</div>`)}
      </div>
  ...
  `:(we({functionName:"renderMenuList",items:e,rawItems:e,filteredItems:e,renderDecision:"menu-list-no-products",source:t}),`
    ...
    `)}function at(e,{variant:t="focus",suppressLoading:n=!1}={}){if(!e)return"";const{items:s,enabled:i,loading:r}=he(e,{includeInactive:!0}),o=B(s.length),l=String(t||"").trim().toLowerCase()==="travel-offers",c=l?"Ofertat":"Sot ne Fokus",g=l?"Oferta":"Highlights",u=l?"Im Travel und Profil sichtbar":"Im Profil sichtbar",p=l?"Ofertat werden geladen...":f("focus.loading","Fokus wird geladen..."),m=l?"Noch keine Oferta-Eintraege":"Noch keine Fokus-Eintraege";return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
      ...
      ${s.length?`
        <div class="space-y-3">
          ${s.map(b=>{const k=U(b.imageUrl||"","thumb"),y=V(k)?H:k,I=b.active!==!1?"Aktiv":"Inaktiv",j=b.active!==!1?"text-emerald-600":"text-slate-400";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
                  <img src="${a(y)}" class="w-full h-full object-cover" style="object-position:${de(b)};" loading="lazy" decoding="async" />
                </div>
                <div class="flex-1 min-w-0">
                  ...
                  <p class="text-[9px] font-black uppercase tracking-widest mt-2 ${j}">${I}</p>
                </div>
  ...
  `}function Yt(e={}){if(!e?.restaurantId)return!1;const t=String(Ne(e)||"").trim().toLowerCase();return["hotel","hotels","motel","motels","travel","hostel","resort","accommodation"].includes(t)||t==="ecommerce"||K(e)?!1:se(e)||["restaurant","cafe","coffee","fastfood","food"].includes(t)||!t}function ja(e={}){if(e.active===!1)return{label:"Inaktiv",className:"text-slate-400"};const t=String(e.status||e.approvalStatus||"pending").trim().toLowerCase();return t==="approved"?{label:"Freigegeben",className:"text-emerald-600"}:t==="rejected"?{label:"Abgelehnt",className:"text-rose-600"}:{label:"Wartet auf Heart",className:"text-amber-600"}}function Aa(e,t){if(!t||!Yt(e))return"";const{items:n,loading:s}=xn(t,{includeInactive:!0}),i=B(n.length);return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(r=>{const o=U(r.imageUrl||"","thumb"),l=V(o)?H:o,c=ja(r),g=r.category||"RESTAURANT",u=r.priceSegment||"€€ - €€€";return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
  ...
  `}function st(e){if(Array.isArray(e))return e.map(n=>String(n||"").trim()).filter(Boolean);const t=String(e||"").trim();return t?t.split(/[\n,;|]/).map(n=>n.trim()).filter(Boolean):[]}function La(e={}){const t=String(e?.restaurantId||"").trim(),n=t?ce(t):null;return{...n&&typeof n=="object"?n:{},...e&&typeof e=="object"?e:{},...t?{restaurantId:t}:{}}}function rt(e={}){return e.shoppingLandingCard&&typeof e.shoppingLandingCard=="object"?e.shoppingLandingCard:{}}function Ta(e={}){const t=rt(e);return[...st(t.productIds),...st(e.shoppingLandingCardProductIds),...st(e.shoppingLandingProductIds)].filter(Boolean)}function it(e={}){return!e||typeof e!="object"?{}:Object.entries(e).reduce((t,[n,s])=>{const i=String(n||"").trim(),r=String(s||"").trim();return i&&r&&(t[i]=r),t},{})}function _a(e={}){const t=rt(e);return{...it(e.shoppingLandingProductImageOverrides),...it(t.productImageOverrides)}}function Ra(e=""){const t=String(e||"").trim(),n=d.shoppingLandingCardEditor&&typeof d.shoppingLandingCardEditor=="object"?d.shoppingLandingCardEditor:{},s=String(n.restaurantId||"").trim();return s&&s!==t?{}:n}function za(e){return e?typeof e=="string"?e.trim():typeof e!="object"?String(e||"").trim():String(e.url||e.src||e.cdnUrl||e.imageUrl||e.image||e.photoUrl||e.thumbnail||"").trim():""}function Ea(e={}){const n=[X(e),...Array.isArray(e.imageUrls)?e.imageUrls:[],...Array.isArray(e.images)?e.images:[],e.imageUrl,e.image,e.photoUrl,e.coverUrl,e.img,e.thumbnail].map(za).filter(Boolean);return n.filter((s,i)=>n.indexOf(s)===i)}function Ma(e={},t={},n={}){const s=String(e?.id||e?.productId||e?.menuItemId||"").trim();if(!s)return null;const i=Ea(e).map(u=>({rawUrl:u,imageUrl:U(u,"thumb")})).filter(u=>u.rawUrl&&!V(u.imageUrl)),r=i[0]?.rawUrl||"",o=String(t?.[s]||"").trim(),l=String(n?.[s]||"").trim(),c=l||o||r,g=c?U(c,"thumb"):"";return{id:s,name:String(e.name||e.title||"Produkt").trim(),price:ue(e),imageUrl:g&&!V(g)?g:"",defaultImageRaw:r,cardImageUrl:o,previewImageUrl:l,imageCandidates:i,objectPosition:q(e)}}function Ua(e={},t="",n=[]){if(!t||!K(e))return"";const s=La(e),i=rt(s),r=Ra(t),o=r.saving===!0,l=String(r.status||"").trim(),c=/fehl|error|nicht|nuk|kein/i.test(l),g=String(i.imageUrl||s.shoppingLandingCardImageUrl||s.shoppingLandingImageUrl||"").trim(),u=String(s.logoUrl||s.logo||s.logoURL||s.avatar||e.avatar||"").trim(),p=String(r.imageUrlDraft??g).trim(),m=String(r.imagePreview||p||u||"").trim(),b=m?U(m,"large"):H,k=String(r.titleDraft??(i.title||s.shoppingLandingCardTitle||e.name||"")).trim(),y=r.active!==void 0?r.active!==!1:i.active!==!1&&s.shoppingLandingCardEnabled!==!1,I=Ta(s),j=Array.isArray(r.productIds)?r.productIds.map($=>String($||"").trim()).filter(Boolean):null,v=new Set(j||I),S={..._a(s),...it(r.productImageOverrides)},A=r.productImagePreviews&&typeof r.productImagePreviews=="object"?r.productImagePreviews:{},F=(Array.isArray(n)?n:[]).filter($=>$&&String($.id||"").trim()&&$.hidden!==!0&&$.available!==!1).map($=>Ma($,S,A)).filter(Boolean),L=v.size?`${B(v.size)} ausgewaehlt`:"Keine Auswahl = alle Produkte";return`
    <div data-shopping-landing-card-editor="${a(t)}" class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      ...
      <div class="relative h-44 rounded-2xl overflow-hidden bg-slate-100 border border-slate-100 mb-4">
        <img src="${a(b||H)}" class="w-full h-full object-cover" loading="lazy" decoding="async" />
      ...
      <div class="grid grid-cols-1 gap-4">
        ...
        <label class="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
          ...
          <input id="shoppingLandingActiveToggle" type="checkbox" class="w-5 h-5 accent-amber-500" style="accent-color:#f97316;" ${y?"checked":""} />
        </label>
        ...
        <div class="rounded-[1.8rem] border border-slate-100 bg-slate-50 p-4">
          <div class="flex items-center justify-between mb-3">
            ...
            <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest">${a(B(F.length))}</span>
          </div>
          ${F.length?`
            <div class="grid grid-cols-1 gap-2">
              ${F.map($=>{const _=v.has($.id),z=$.imageUrl||H,R=String($.defaultImageRaw||$.imageCandidates[0]?.rawUrl||"").trim(),h=String($.cardImageUrl||"").trim(),P=String($.previewImageUrl||"").trim(),T=!!(P||h&&h!==R),E=P||(h&&!$.imageCandidates.some(M=>M.rawUrl===h)?h:"");return`
                  <div class="rounded-2xl bg-white border border-slate-100 p-3">
                    <label class="flex items-center gap-3">
                      <input type="checkbox" data-shopping-landing-product="${a($.id)}" class="w-4 h-4 accent-amber-500" style="accent-color:#f97316;" ${_?"checked":""} />
                      <span class="w-12 h-12 rounded-xl overflow-hidden bg-slate-100 shrink-0">
                        <img src="${a(z)}" class="w-full h-full object-cover" style="object-position:${a($.objectPosition||"50% 50%")};" loading="lazy" decoding="async" />
                      </span>
                    ...
                    ${_?`
                      <div class="mt-3 pt-3 border-t border-slate-100">
                        ...
                        <div class="flex gap-2 overflow-x-auto hide-scrollbar pb-1">
                          ${$.imageCandidates.map((M,D)=>{const G=D===0,J=P?!1:G?!T:h===M.rawUrl;return`
                              <label class="shrink-0 w-16">
                                <input type="radio" name="shoppingLandingProductImage_${a($.id)}" data-shopping-landing-product-image-choice="${a($.id)}" value="${G?"":a(M.rawUrl)}" class="hidden" ${J?"checked":""} />
                                <span class="block h-16 rounded-2xl overflow-hidden border ${J?"border-slate-900":"border-slate-100"} bg-slate-100">
                                  <img src="${a(M.imageUrl)}" class="w-full h-full object-cover" loading="lazy" decoding="async" />
                                </span>
                                <span class="block mt-1 text-[8px] font-black uppercase tracking-widest text-center text-slate-400">${D+1}</span>
                              </label>
                            `}).join("")}
                          ${E?`
                            <label class="shrink-0 w-16">
                              <input type="radio" name="shoppingLandingProductImage_${a($.id)}" data-shopping-landing-product-image-choice="${a($.id)}" value="${a(E)}" class="hidden" checked />
                              <span class="block h-16 rounded-2xl overflow-hidden border border-slate-900 bg-slate-100">
                                <img src="${a(U(E,"thumb"))}" class="w-full h-full object-cover" loading="lazy" decoding="async" />
                              </span>
  ...
  `}function Ba(e){if(!et(e)||!It(e))return"";const n=Ae((d.menu.items||[]).filter(s=>ae(s)==="testfirst_special"));return`
    <div class="mb-6 bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
          ...
          <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">${a(B(n.length))} Karten</p>
        </div>
      ...
      ${n.length?`
        <div class="space-y-3">
          ${n.map(s=>{const i=U(X(s),"thumb"),r=V(i)?H:i,o=Ut(s),l=o.type==="link"?"Link":o.type==="product"?"Produkt-Modal":"Diese Karte",c=Ze(s)==="food"?"Food-Size":"Normal",g=Cn(pe(s));return`
              <div class="flex items-start gap-4 p-4 rounded-[1.6rem] bg-slate-50 border border-slate-100">
                <div class="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0">
                  <img src="${a(r)}" class="w-full h-full object-cover" style="object-position:${q(s)};" loading="lazy" decoding="async" />
                </div>
                <div class="flex-1 min-w-0">
  ...
  `}function Zt(e,{restaurantId:t="",suppressLoading:n=!1,allowAutoEnsure:s=!0,requirePublicMenuTruth:i=!0}={}){const r=String(t||e?.canonicalRestaurantId||e?.restaurantId||"").trim();if(!r||!se(e))return"";const o=ge(d,{profile:e,routePayload:d?.profileView?.routePayload,webDirectEntry:d?.__webDirectEntry,restaurantId:r});if(i&&o.menu.status!=="ready")return"";const l=!i||o.focus.canRenderFocus;if(s&&!d.focus.loading&&!l&&me(kt(e,r)),i&&!l)return"";const{items:c,loading:g}=l?{items:Array.isArray(o.focus.items)?o.focus.items:[],loading:o.focus.loading}:he(r);if(!(l?!0:he(r).enabled)||!c.length&&!g||n&&g&&!c.length)return"";if(g&&!c.length)return`
    ...
    `;const p=vn(c),m=c[p]||c[0],{safeImg:b,fallbackImg:k,imageAttrs:y,lazyAttrs:I}=ne(m.imageUrl||"",{mode:"profile",priorityIndex:0,preferredSize:"medium",candidateSizes:["small","medium","large"],variant:"hero",stableKey:m?.id?`focus-carousel:${r}:${String(m.id)}`:""}),j=m.text||"";return`
    <div id="focusCarousel" class="${Be()} rounded-[2.5rem] p-6 border shadow-sm">
      ...
      <div class="relative rounded-[2rem] overflow-hidden border border-slate-100 bg-slate-50">
        <img data-focus-image src="${a(b)}" data-fallback-src="${a(k)}"${I} class="w-full h-56 object-cover" style="object-position:${de(m)};" ${y} decoding="async" />
      </div>
      <div class="mt-4">
  ...
  `}function Da({profile:e,restaurantId:t,catalogLabel:n}){if(!t||!se(e))return"";if(typeof ft=="function"){const r=xe?xe(t):null;(!r||r.sameRestaurant!==!0||!r.loading&&!r.loaded&&!r.error)&&ft(e)}const s=typeof xe=="function"?xe(t):{enabled:!0,count:0,tables:[],loading:!1,saving:!1,error:""},i=(s.tables||[]).map(r=>{const o=wn("apps/menyra-social/index.html",{r:t,tab:"menu",source:"qr",table:r});return Jt({label:`Tisch ${r}`,url:o,caption:`${n} fuer Tisch ${r}`})}).join("");return`
  ...
  `}function Ha(){const e=d.userProfile,t=e.restaurantId||"",n=String(d.user?.uid||"").trim(),s=String(d.__authBootstrapInFlightUid||"").trim(),i=!t&&!!n&&(!!d.__authProfileLoadPromise||s===n),r=ke(e),o=se(e),l=d.profileView?.profile?.restaurantId?d.profileView.profile:null,c=an()&&!!l?.restaurantId&&se(l),g=K(e),u=Sn(dn(e)),p=t?ce(t):null,m=p?.name||p?.restaurantName||e.name||"Business",b=t&&d.menu.restaurantId===t,k=String(d.menu.source||"").trim().toLowerCase(),y=!!b&&k==="collection",I=!!b&&k==="collection"&&d.menu.loading,j=!!t&&(I||!y),v=g?"all":d.menu.filter,S=y?zt(d.menu.items,{filter:v,query:d.menu.query}):[],F=It(e)?S:S.filter(_=>!Tn(_)),L=Ae(F),$=B(L.length);if(t&&r){zn(e);const _=String(d.focus?.truthSource||"").trim().toLowerCase();return!d.focus.loading&&(d.focus.restaurantId!==t||_!=="public-menu")&&me(e),Zn(e)}return t&&o&&!y&&!I&&on(e),t&&o&&!d.focus.loading&&d.focus.restaurantId!==t&&me(e),t&&Yt(e)&&ln(e),o?`
    <div class="p-6 app-main-content-safe animate-in slide-in-from-right-10 duration-500">
      <div class="flex items-end justify-between mb-6">
        <div>
  ...
  `:c?Le(l):`
    ...
    `;const l=kt(e,o),c=K(l),g=se(l)&&!c;g&&(r=ge(d,{profile:l,routePayload:s,webDirectEntry:i,restaurantId:o}));const u=String(i?.canonicalRestaurantId||i?.restaurantId||"").trim(),p=new Set(r.targetIds),m=r.menu.status==="ready",b=r.focus.canRenderFocus,k=m&&g,y=r.focus.matches===!0&&r.focus.loading===!0,j=String(d?.profileView?.menuAccessSource||i?.menuAccessSource||s?.menuAccessSource||"").trim().toLowerCase()==="qr",v=i?.active===!0&&i?.webPriority===!0&&i?.menuFirst===!0&&String(d?.activeTab||"").trim().toLowerCase()==="profile"&&String(d?.profileTopTab||"").trim().toLowerCase()==="menu"&&(u===o||p.has(o)),S=v&&!j,A=["ready","empty","error"].includes(r.menu.status),F=v&&A,L=v&&(!k||r.menu.status!=="ready"),$=!k||r.focus.settled===!0||r.focus.confirmedEmpty===!0||r.menu.status!=="ready";n&&!F&&!A&&rn(l),n&&!L&&!$&&!y&&m&&(!S||A)&&me(l);const z=r.menu.canRenderItems?Ae(zt(r.menu.items,{filter:"all",query:""})).filter(Y=>!Ye(Y)):[],R=r.menu.error||"",h=qa(r.menu,z),{hasItems:P,hasError:T,isLoading:E,shouldRenderNoProducts:M}=h;kn({profile:l,routePayload:s,surface:r,decision:h});const D={profile:l,routePayload:s,surface:r,decision:h,rawItems:r.menu.items,items:z,filteredItems:z,source:"public-menu"},G=z.filter(Y=>pe(Y)==="drink"),J=z.filter(Y=>pe(Y)!=="drink"),Q=0,Te=G.length,re=et(e),ot=re||c,_e=new Set;P&&o&&(cn(z,o),An(z,o));const fe=o&&b?(Array.isArray(r.focus.items)?r.focus.items:[]).map(Y=>tt({...Y,objectPosition:de(Y)})).filter(Boolean):[],Re=r.focus.status==="empty"||r.focus.status==="error",ze=g&&!b&&!Re&&r.menu.status!=="empty"&&r.menu.status!=="error",W=fe.length?Vt(l,fe,{mode:t}):ze?ka({...D,reason:"focus-truth-pending"}):"",lt=ot?W:Zt(l,{restaurantId:o,suppressLoading:!0,allowAutoEnsure:m&&(!S||A),requirePublicMenuTruth:!0})||(ze?$a({...D,reason:"focus-truth-pending"}):"");return re?`
      <div class="app-main-content-safe">
        ${E?`
          ${W}
          ${Dt({...D,reason:"menu-loading"})}
        `:`
          ${P?Fa(l,z,{mode:t,publicMenuSurfaceState:r,focusFallbackHtml:W}):T?`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${a(f("menu.loadError","Menu konnte nicht geladen werden"))}</div>`:M?(we({...D,functionName:"renderProfileMenuView",renderDecision:"testfirst-no-products"}),`<div class="app-content-inline pt-6 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300"${Z({source:"public-menu:no-products"})}>${a(f("menu.noProducts","Keine Produkte"))}</div>`):Dt({...D,reason:"menu-not-confirmed-empty"})}
          ${R?`<div class="app-content-inline pt-4 text-center text-[10px] font-bold uppercase tracking-widest text-rose-500">${a(R)}</div>`:""}
        `}
      </div>
    `:`
    <div class="app-content-inline app-main-content-safe space-y-5">
      ${lt}
      ${E?`
        ${Ot({isShop:c,debugContext:{...D,reason:"menu-loading"}})}
      `:`
        ${P?`
          ${c?`
            ${pn(z,{profile:e})}
          `:`
            ${G.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="drink">
                ...
                <div data-menu-type="drink">
                  ${Gt(G,{mode:t,useTestfirstCardUi:re,seenCategories:_e,priorityOffset:Q})}
                </div>
              </section>
            `:""}
            ${J.length?`
              <section class="menu-type-block bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm" data-menu-type-block="food">
                ...
                <div data-menu-type="food">
                  ${Qt(J,{mode:t,useTestfirstCardUi:re,seenCategories:_e,priorityOffset:Te})}
                </div>
              </section>
            `:""}
          `}
  ...
  `}function Oa(){const e=d.userProfile,t=nn(e),n=t?d.businessPosts:d.userPosts,s=String(d.user?.uid||e?.uid||"").trim(),i=String(e?.restaurantId||"").trim(),r=String(d.__userPostsLoadingUid||"").trim(),o=String(d.__businessPostsLoadingRestaurantId||"").trim(),l=String(d.__authBootstrapInFlightUid||"").trim(),c=!!s&&r===s,g=!!i&&o===i,u=!!s&&l===s,p=t?g||u&&!n.length:c||u&&!n.length,m=String(e.handle||ct(e.name||"user")).replace(/^@/,""),k=a(e.bio||"").replace(/\n/g,"<br>")||a(f("profile.noBio","Noch keine Bio.")),y=Ce(e),I=y==="menu",j=y==="checkins",v=n,S=U(e.avatar,"avatar"),A=Ue(t),F=Ge(e);return`
    <div class="app-main-content-safe">
          ...
          <div class="relative z-10">
            <div class="flex justify-between items-start mb-8">
              <div id="profileAvatarTrigger" class="relative cursor-pointer group">
                <div class="relative w-[100px] h-[100px] rounded-[2rem] p-[3px] bg-gradient-to-br from-indigo-500 to-purple-500">
                  <img src="${a(S)}" decoding="async" width="100" height="100" data-img-key="avatar:self" class="w-full h-full rounded-[1.8rem] ${A} border-2 border-white" />
                </div>
                ${e.isPremium?`
                  <div class="absolute -bottom-1 -right-1 bg-white rounded-full p-1.5 shadow-lg text-blue-500 border-2 border-slate-50">
                    ${x("badge-check","w-4 h-4 fill-blue-500 text-white")}
              ...
              <div class="flex items-center gap-6 pt-3 pr-2">
                 <div class="flex flex-col items-center">
                    <span class="font-black text-2xl text-slate-900 leading-none mb-1">${a(B(e.followers))}</span>
                    <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest opacity-80">${a(f("profile.fans","Fans"))}</span>
                 </div>
                 <div class="w-px h-8 bg-slate-100"></div>
                 <div class="flex flex-col items-center">
                    <span class="font-black text-2xl text-slate-900 leading-none mb-1">${a(B(e.following))}</span>
                    <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest opacity-80">${a(f("profile.followingCount","Folgt"))}</span>
                 </div>
              </div>
            </div>
      ...
      `}
      `:`
        ${F==="cart"?ut(e):F==="favorites"?pt(e):""}
      `}
    </div>
  `}return{renderProfilePostCardFancy:St,renderProfilePostsFancy:Oe,renderProfileCheckins:Ve,renderProfileTabs:Qe,renderProfileViewControls:We,renderPublicProfileView:pa,renderMenuFilterRow:Bt,renderMenuLayoutSection:wa,renderMenuItemCard:Je,renderMenuItemCardStacked:Xe,renderMenuDrinkGrid:Gt,renderMenuFoodList:Qt,renderMenuList:Wt,renderFocusAdminSection:at,renderFocusCarousel:Zt,renderMenuQrCard:Jt,renderMenuAdminView:Ha,renderProfileMenuView:Le,renderProfileView:Oa}}export{Xa as createProfileMenuFocusRenderController};
