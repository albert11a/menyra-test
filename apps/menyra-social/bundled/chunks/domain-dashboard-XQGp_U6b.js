const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/business-composer-controller-DCEVXUPf.js","chunks/domain-feed-social-eager-cwXf9eXG.js","chunks/domain-auth-Aq-4Vdvh.js","chunks/domain-public-profile-mLQti0eH.js","chunks/domain-media-eager-DAUyCk2O.js","chunks/domain-menu-eager-CZHfF-pU.js","chunks/profile-post-card-markup-utils-HwqIiXgP.js"])))=>i.map(i=>d[i]);
import{_ as fe}from"./domain-auth-Aq-4Vdvh.js";import{f as P,r as be,l as ye,s as V}from"./domain-analytics-jv5B-kA2.js";const _e=20,ve=8;function w(e=""){return e==null?"":String(e).trim()}function M(e){if(e==null||e==="")return null;const a=Number(String(e).replace(",","."));return Number.isFinite(a)&&a>0?a:null}function ke(e=Date.now(),a=Math.random()){const t=Math.max(0,Number(e)||0).toString(36),s=Math.floor(Math.max(0,Math.min(.999999,Number(a)||0))*36**6).toString(36).padStart(6,"0");return`room_${t}_${s}`}function we(e={}){const a=e&&typeof e=="object"?e:{},t=[...Array.isArray(a.images)?a.images:[],w(a.imageUrl??a.image??a.photoUrl)],s=[];return t.forEach(r=>{const d=w(r);d&&!s.includes(d)&&s.push(d)}),s.slice(0,ve)}function xe(e={},{index:a=0}={}){const t=e&&typeof e=="object"?e:{},s=M(t.persons??t.guests??t.capacity),r=M(t.size??t.sizeSqm??t.area),d=we(t);return{id:w(t.id)||ke(Date.now()+a),title:w(t.title??t.name),description:w(t.description??t.text).slice(0,400),imageUrl:d[0]||"",images:d,price:M(t.price??t.pricePerNight),currency:w(t.currency??t.currencyCode).toUpperCase()||"EUR",persons:s==null?null:Math.min(20,Math.round(s)),beds:w(t.beds??t.bedsLabel).slice(0,60),size:r==null?null:Math.min(500,Math.round(r)),tag:w(t.tag??t.badge).slice(0,40),active:t.active!==!1}}function Se(e=[]){return(Array.isArray(e)?e:[]).slice(0,_e).map((a,t)=>xe(a,{index:t}))}function Pe(e={}){return Se((e&&typeof e=="object"?e:{}).hotelRooms).filter(t=>t.title)}function oa(e={}){const a=[];return Number.isFinite(e?.persons)&&e.persons>0&&a.push({icon:"users",label:`${e.persons} persona`}),w(e?.beds)&&a.push({icon:"bed",label:w(e.beds)}),Number.isFinite(e?.size)&&e.size>0&&a.push({icon:"size",label:`${e.size} m²`}),a}function da(e={}){const a=Number(e?.price);if(!Number.isFinite(a)||a<=0)return"";const t=w(e?.currency).toUpperCase()||"EUR",s=Number.isInteger(a)?String(a):a.toFixed(2);return t==="EUR"?`€${s}`:`${s} ${t}`}const q="mnyraDashboardStyles",ze=`
.mnyra-dash {
...
`;function De(e=typeof document>"u"?null:document){if(!(!e||e.getElementById(q)))try{const a=e.createElement("style");a.id=q,a.textContent=ze,e.head?.appendChild(a)}catch{}}function c(e=""){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function C(e,a,t=""){if(typeof e!="function")return"";try{return e(a,t)||""}catch{return""}}const Ce=Object.freeze(["hotel","motel","hostel","resort","accommodation","travel"]);function Fe({businessType:e="",isShopCatalog:a=!1}={}){if(a)return"shop";const t=String(e||"").trim().toLowerCase();return Ce.includes(t)?"hotel":"restaurant"}function Re({kind:e="restaurant",isOwner:a=!1}={}){const t=[];return e==="hotel"?t.push({nav:"menu",iconName:"bed-double",label:"Hotel & Dhoma",sub:"Detaje, dhoma, oferta"}):e==="shop"?t.push({nav:"menu",iconName:"shopping-bag",label:"Ndrysho dyqanin",sub:"Produkte & Stok"}):t.push({nav:"menu",iconName:"utensils",label:"Ndrysho menune",sub:"Produkte & Kategorien"}),t.push({nav:"menu",iconName:"megaphone",label:"Oferta & Reklama",sub:"Im Editor verwalten"}),a&&t.push({nav:"businessAccounts",iconName:"users-round",label:"Team & Staff",sub:"Zugänge verwalten"}),t.push({nav:"settings",iconName:"settings",label:"Cilesimet",sub:"Profili & Kontakti"}),t}function $e(e="restaurant"){const a=[{key:"profileViews",label:"Profilaufrufe"},{key:"postImpressions",label:"Shtrirja e postimeve"},{key:"contactClicks",label:"Kontakt-Klicks"}];return e==="shop"?a.concat([{key:"ordersCompleted",label:"Porosite"},{key:"revenue",label:"Umsatz",unit:"€"},{key:"productViews",label:"Produkt-Aufrufe"}]):e==="hotel"?a.concat([{key:"uniqueVisitors",label:"Vizitore"},{key:"postLikes",label:"Likes"},{key:"feedImpressions",label:"Shtrirja ne feed"}]):a.concat([{key:"ordersCompleted",label:"Porosite"},{key:"revenue",label:"Umsatz",unit:"€"},{key:"qrScans",label:"QR-Scans"}])}function G(e=0,a=""){const t=P(e);return a?`${t} ${a}`:t}function Be(e=new Date().getHours()){const a=Number.isFinite(Number(e))?(Math.trunc(Number(e))%24+24)%24:12;return a>=5&&a<=10?{dayPart:"mengjes",text:"Ju urojmë një mëngjes të mbarë!"}:a>=11&&a<=17?{dayPart:"dite",text:"Ju urojmë një ditë të mbarë!"}:a>=18&&a<=21?{dayPart:"mbremje",text:"Ju urojmë një mbrëmje të mbarë!"}:{dayPart:"nate",text:"Ju urojmë një natë të mbarë!"}}function je({name:e="",logoUrl:a="",hour:t=new Date().getHours(),iconFn:s}={}){const r=Be(t),d=c(e||"Business");return`
    <div class="mnyra-dash__greet">
      <p class="mnyra-dash__greet-title">
        ...
        <span class="mnyra-dash__greet-logo">
          ${a?`<img src="${c(a)}" alt="${d}" title="${d}" loading="lazy" decoding="async" onerror="this.style.display='none'" />`:`<span class="mnyra-dash__greet-logo-fallback" title="${d}">${C(s,"store","w-4 h-4")}</span>`}
        </span>
      </p>
  ...
  `}function Ie({iconFn:e}={}){return`
    <button type="button" class="mnyra-dash__composer mnyra-dash__composer--tap" data-dashboard-composer-card data-dashboard-composer="post">
      ...
      <span class="mnyra-dash__composer-cta">
        <span class="mnyra-dash__composer-cta-icon">${C(e,"plus","w-4 h-4")}</span>
        <span class="mnyra-dash__composer-cta-label">Posto</span>
        <span class="mnyra-dash__composer-cta-chevron">${C(e,"chevron-right","w-4 h-4")}</span>
      </span>
    </button>
  `}function Ke({actions:e=[],iconFn:a}={}){return`<div class="mnyra-dash__actions">${(Array.isArray(e)?e:[]).map(s=>`
      <button type="button" class="mnyra-dash__action" data-nav="${c(s.nav)}">
        <span class="mnyra-dash__action-icon">${C(a,s.iconName,"w-4 h-4")}</span>
        <span>
  ...
  `}function Ne({posts:e=[],iconFn:a}={}){const t=Array.isArray(e)?e:[];let s="";return t.length?(s=t.map(r=>{const d=[r.dateLabel,`${P(r.likesCount||0)} Likes`,`${P(r.commentsCount||0)} Kommentare`];return Number(r.impressions||0)>0&&d.push(`${P(r.impressions)} shtrirje (7 dite)`),`
        <div class="mnyra-dash__post">
          <div class="mnyra-dash__post-thumb">
            ${r.thumbUrl?`<img src="${c(r.thumbUrl)}" alt="" loading="lazy" decoding="async" onerror="this.style.display='none'" />`:C(a,r.mediaType==="video"?"play":"image","w-5 h-5")}
          </div>
  ...
  `}function Ae(){return'<div class="mnyra-dash__skeleton" style="min-height:44px; border-radius:14px; margin: 4px 0 16px;"></div>'}function Le({message:e=""}={}){return`
  ...
  `}const He="menyra_social_dashboard_cache_v1::",J="menyra_social_composer_products_v1::",Ve=2500,qe=1200,Ge=6,Ze=3,Je=Object.freeze({menuImageUrl:"/apps/menyra-social/assets/panel/menu-scan.jpg",qrImageUrl:"/apps/menyra-social/assets/panel/qr-stand.jpg"}),We=Object.freeze({menuOpens:"Menü-Aufrufe",qrScans:"QR-Scans"});function f(e){const a=Number(e);return Number.isFinite(a)?a:0}function Qe(e={}){const a=String(e.createdAtClient||"").trim();if(a){const s=new Date(a);if(!Number.isNaN(s.getTime()))return s}const t=e.createdAt;if(t&&typeof t.toDate=="function")try{const s=t.toDate();if(s instanceof Date&&!Number.isNaN(s.getTime()))return s}catch{}return null}function Ye(e="",a={}){const t=Array.isArray(a.media)&&a.media.length?a.media[0]:{},s=String(t.type||a.mediaType||"image").trim().toLowerCase()==="video"?"video":"image",r=String(t.thumbUrl||(s==="image"?t.url:"")||a.thumbUrl||"").trim(),d=Qe(a);return{id:String(e||"").trim(),caption:String(a.caption||"").trim(),mediaType:s,thumbUrl:r,likesCount:f(a.likesCount),commentsCount:f(a.commentsCount),impressions:0,dateLabel:d?d.toLocaleDateString("de-DE",{day:"2-digit",month:"2-digit"}):"",createdAtMs:d?d.getTime():0}}function Xe({days:e=[],todayKey:a="",rawPosts:t=[]}={}){const s=Array.isArray(e)?e:[],r=V(s),d=s.find(h=>String(h?.date||h?.id||"").trim()===String(a||"").trim()),m=V(d?[d]:[]),_=r.merged?.posts&&typeof r.merged.posts=="object"?r.merged.posts:{},v=(Array.isArray(t)?t:[]).map(h=>Ye(h?.id,h?.data||{})).filter(h=>h.id).map(h=>({...h,impressions:f(_[h.id]?.impressions)})),x=v.slice().sort((h,b)=>b.createdAtMs-h.createdAtMs).slice(0,Ze);return{day:String(a||"").trim(),week:r.summary,today:m.summary,posts:x,bestPost:ea(v)}}function ea(e=[]){const a=(Array.isArray(e)?e:[]).filter(t=>t&&t.id);return a.length?a.slice().sort((t,s)=>f(s.impressions)-f(t.impressions)||f(s.likesCount)-f(t.likesCount)||f(s.createdAtMs)-f(t.createdAtMs))[0]:null}const aa=Object.freeze(["pro","premium","plus","business","paid","active"]);function ta({profile:e={},restaurant:a={}}={}){const t=[a||{},e||{}];for(const s of t){if(s.subscriptionActive===!0||s.isSubscriber===!0||s.hasSubscription===!0)return!0;const r=String(s.subscriptionPlan||s.planKey||s.plan||s.subscriptionStatus||"").trim().toLowerCase();if(r&&aa.includes(r))return!0}return!1}function na(e={}){const a=e&&typeof e=="object"?e:{};return String(a.titleImageUrl||a.coverImageUrl||a.coverUrl||a.heroUrl||a.bannerUrl||"").trim()}function ra({model:e=null,coverUrl:a="",subscribed:t=!1,assets:s={}}={}){const r=e?.today||{},d=!e,m=e?.bestPost||null,_=[];return _.push(d?{key:"bestPost",label:"Reichweite",pending:!0}:{key:"bestPost",label:"Reichweite",value:P(f(m?.impressions)),imageUrl:String(m?.thumbUrl||"").trim(),iconName:"image",nav:"analytics"}),_.push({key:"profileViews",label:"Profilbesuche heute",value:P(f(r.profileViews)),loading:d,imageUrl:String(a||"").trim(),iconName:"user",nav:"analytics"}),_.push({key:"menuOpens",label:"Menü-Aufrufe heute",value:P(f(r.menuOpens)),loading:d&&t,locked:!t,imageUrl:String(s.menuImageUrl||"").trim(),iconName:"book-open",nav:"analytics"}),_.push({key:"qrScans",label:"QR-Scans heute",value:P(f(r.qrScans)),loading:d&&t,locked:!t,imageUrl:String(s.qrImageUrl||"").trim(),iconName:"qr-code",nav:"analytics"}),_}function la({state:e,renderFn:a,documentObj:t,firestoreApi:s={},profileApi:r={},composerApi:d={},iconFn:m,storageObj:_}={}){const v=t||(typeof document>"u"?null:document),x=v?.defaultView||(typeof window>"u"?null:window),h=typeof a=="function"?a:()=>{},b=_||(typeof localStorage>"u"?null:localStorage),W=typeof r.getBusinessProfileTypeFn=="function"?r.getBusinessProfileTypeFn:(()=>""),Q=typeof r.isShopCatalogProfileFn=="function"?r.isShopCatalogProfileFn:(()=>!1),Y=typeof r.isBusinessOwnerProfileFn=="function"?r.isBusinessOwnerProfileFn:(()=>!1),U=typeof r.getRestaurantMetaByIdFn=="function"?r.getRestaurantMetaByIdFn:(()=>null),X=typeof r.resolveRestaurantLogoFn=="function"?r.resolveRestaurantLogoFn:(()=>""),ee=typeof r.resolveOwnAvatarUrlFn=="function"?r.resolveOwnAvatarUrlFn:(()=>"");let F=0,N=!1,z=null,R=null,$="",T=!1,A=()=>null;const ae=300;function E(){const n=e?.userProfile||{};return Fe({businessType:W(n),isShopCatalog:Q(n)})}function te(n=""){const i=U(n)||{};return Pe(i).map(o=>({id:o.id,name:o.title,price:o.price??"",category:o.beds||o.tag||"",type:"room",imageUrl:o.imageUrl||""}))}function ne(n=""){if(!b)return null;try{const i=b.getItem(`${J}${n}`);if(!i)return null;const o=JSON.parse(i),l=Array.isArray(o?.items)?o.items:null;return l&&l.length?l:null}catch{return null}}function re(n="",i=[]){if(b)try{b.setItem(`${J}${n}`,JSON.stringify({savedAt:Date.now(),items:i}))}catch{}}async function se(n=""){const{db:i,collectionFn:o,queryFn:l,limitFn:u,getDocsFn:p}=s;if(!i||typeof o!="function"||typeof p!="function")throw new Error("Produktet nuk u ngarkuan.");const k=o(i,"restaurants",n,"menuItems"),y=typeof l=="function"&&typeof u=="function"?l(k,u(ae)):k,S=await p(y),g=[];return S.forEach(D=>{const K=A(D?.id,D?.data?.()||{});K&&g.push(K)}),g.sort((D,K)=>D.name.localeCompare(K.name,"sq")),g}async function ie(n="",i){const o=String(n||"").trim();if(!o)throw new Error("Produktet nuk u ngarkuan.");if(E()==="hotel")return te(o);const l=se(o).then(p=>(re(o,p),p)),u=ne(o);return u?(typeof i=="function"?l.then(p=>i(p)).catch(()=>{}):l.catch(()=>{}),u):l}function L(){return z?Promise.resolve(z):(R||(R=fe(()=>import("./business-composer-controller-DCEVXUPf.js"),__vite__mapDeps([0,1,2,3,4,5,6])).then(n=>(A=typeof n?.normalizeComposerProductCore=="function"?n.normalizeComposerProductCore:(()=>null),z=n.createBusinessComposerController({documentObj:v,windowObj:v?.defaultView||null,api:{getRestaurantIdFn:()=>j(),getBusinessMetaFn:()=>{const i=j();if(!i)return{name:"",logoUrl:"",city:""};const o=H(i),l=U(i)||{};return{name:o.name,logoUrl:o.logoUrl,city:String(l.city||"").trim()}},loadProductsFn:(i,o)=>ie(i,o),getBusinessKindFn:()=>E(),uploadImageFn:d.uploadImageFn,uploadVideoFn:d.uploadVideoFn,captureVideoPosterFn:d.captureVideoPosterFn,createPostFn:d.createPostFn,createStoryFn:d.createStoryFn,formatPriceFn:d.formatPriceFn,getOptimizedImageUrlFn:d.getOptimizedImageUrlFn,escapeHtmlFn:d.escapeHtmlFn,iconFn:typeof m=="function"?m:void 0,afterPublishFn:async i=>{try{await I({force:!0})}catch{}typeof d.afterPublishFn=="function"&&await d.afterPublishFn(i)}}}),z)).catch(n=>{throw R=null,console.error("[mnyra][dashboard] composer load failed",n),n})),R)}function oe(){const n=x?.navigator?.connection;return!n||typeof n!="object"?!1:n.saveData===!0?!0:/(^|-)2g$/.test(String(n.effectiveType||"").trim().toLowerCase())}function de(){if(T||z||!x||oe())return;T=!0;const n=()=>{if(L().catch(()=>{}),typeof d.prewarmFn=="function")try{d.prewarmFn()}catch{}};if(typeof x.requestIdleCallback=="function"){x.requestIdleCallback(n,{timeout:Ve});return}x.setTimeout?.(n,qe)}function le(n="post"){const i=String(n||"").trim().toLowerCase(),o=i==="story"||i==="profile"?i:"post";if(typeof d.prewarmFn=="function")try{d.prewarmFn()}catch{}if(z){z.open(o);return}$=o,L().then(l=>{const u=$||o;$="",l?.open?.(u)}).catch(()=>{$=""})}function B(){return(!e.dashboardView||typeof e.dashboardView!="object")&&(e.dashboardView={status:"idle",error:"",model:null,loadedSignature:"",paywall:""}),e.dashboardView}function j(){const n=e?.userProfile||{};return String(n.restaurantId||n.staffRestaurantId||"").trim()}function ce(){const n=String(e?.user?.uid||"").trim();if(!n)return!1;const i=String(e?.__authBootstrapInFlightUid||"").trim();return!!e?.__authProfileLoadPromise||i===n}function O(n=""){return`${He}${n}`}function he(n="",i=""){if(!b||!n)return null;try{const o=b.getItem(O(n));if(!o)return null;const l=JSON.parse(o);return!l||typeof l!="object"||String(l.day||"").trim()!==String(i||"").trim()||!l.model||typeof l.model!="object"?null:l.model}catch{return null}}function ue(n="",i=null){if(!(!b||!n||!i))try{b.setItem(O(n),JSON.stringify({day:i.day,model:i}))}catch{}}async function me(n=""){const{db:i,collectionFn:o,queryFn:l,orderByFn:u,limitFn:p,getDocsFn:k}=s;if(!i||typeof o!="function"||typeof l!="function"||typeof u!="function"||typeof p!="function"||typeof k!="function")return[];const y=o(i,"restaurants",n,"socialPosts");return(await k(l(y,u("createdAt","desc"),p(Ge)))).docs.map(g=>({id:g.id,data:g.data()||{}})).filter(g=>{const D=String(g.data.status||"active").trim().toLowerCase();return D!=="deleted"&&D!=="hidden"})}async function I({force:n=!1}={}){const i=B(),o=j();if(!o)return;const l=be({rangeKey:"7d"});if(!l)return;const u=`${o}::${l.toDay}`;if(!n&&i.loadedSignature===u&&i.status==="ready")return;if(!i.model){const y=he(o,l.toDay);y&&(i.model=y,i.status="ready",h())}F+=1;const p=F;i.model||(i.status="loading",i.error="",h());try{const y={db:s.db,collectionFn:s.collectionFn,queryFn:s.queryFn,whereFn:s.whereFn,documentIdFn:s.documentIdFn,getDocsFn:s.getDocsFn,restaurantId:o},[S,g]=await Promise.allSettled([ye({...y,fromDay:l.fromDay,toDay:l.toDay}),me(o)]);if(p!==F)return;if(S.status==="rejected")throw S.reason;g.status==="rejected"&&console.error("[mnyra][dashboard] recent posts load failed",g.reason),i.model=Xe({days:S.value,todayKey:l.toDay,rawPosts:g.status==="fulfilled"?g.value:[]}),i.status="ready",i.error="",i.loadedSignature=u,ue(o,i.model)}catch(y){if(p!==F)return;console.error("[mnyra][dashboard] load failed",y),i.model||(i.status="error",i.error="Ju lutem kontrollo lidhjen dhe provo perseri.")}h()}function pe(){N||!v||(N=!0,v.addEventListener("click",n=>{try{if(String(e?.activeTab||"").trim().toLowerCase()!=="dashboard")return;if(n.target?.closest?.("[data-dashboard-retry]")){I({force:!0});return}if(n.target?.closest?.("[data-dashboard-paywall-close]")){n.preventDefault(),B().paywall="",h();return}const i=n.target?.closest?.("[data-dashboard-metric-locked]");if(i){n.preventDefault(),B().paywall=String(i.getAttribute("data-dashboard-metric-locked")||"").trim(),h();return}const o=n.target?.closest?.("[data-dashboard-composer]");o&&(n.preventDefault(),le(o.getAttribute("data-dashboard-composer")))}catch{}}))}function H(n=""){const i=e?.userProfile||{},o=n?U(n)||{}:{},l=String(o.name||o.restaurantName||i.name||"").trim()||"Business";let u="";try{u=String(ee()||"").trim()}catch{}if(!u)try{u=String(X(o)||"").trim()}catch{}return{name:l,logoUrl:u,kind:E(),coverUrl:na(o),subscribed:ta({profile:i,restaurant:o})}}function ge(){De(v),pe();const n=B(),i=j();let o="";if(!i)o=ce()?`${Ae()}${Z({kpiCount:6})}`:Oe();else{de();const l=H(i),u=Re({kind:l.kind,isOwner:Y(e?.userProfile)}),p=$e(l.kind);n.status==="idle"&&(n.status="loading",queueMicrotask(()=>{I({force:!1})}));let k="";n.model?k=`
          ${Me({kpiDefs:p,week:n.model.week,today:n.model.today})}
          ${Ne({posts:n.model.posts,iconFn:m})}
        `:n.status==="error"?k=Le({message:n.error}):k=Z({kpiCount:p.length});const y=ra({model:n.model,coverUrl:l.coverUrl,subscribed:l.subscribed,assets:Je}),S=String(n.paywall||"").trim();o=`
        ${je({name:l.name,logoUrl:l.logoUrl,iconFn:m})}
        ${Ue({cards:y,iconFn:m})}
        ${Ee(`
          ${Ie({iconFn:m})}
          ${Ke({actions:u,iconFn:m})}
          ${k}
        `)}
    ...
    `}return Object.freeze({renderDashboardView:ge,loadDashboard:I})}export{ve as M,la as a,Pe as b,ke as c,oa as d,da as f,Se as n};
