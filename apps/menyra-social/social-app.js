...
} from "./core/app-shell/social-app-cache-config.js";
import {
  normalizeInitialTab,
  normalizeAuthMode
...
function scheduleRuntimeDiagnosticsStartup() {
  ...
  if (window.__MENYRA_SOCIAL_PUBLIC_WEBSITE_STARTUP__ === true) {
    if (typeof window.requestIdleCallback === "function") {
      window.requestIdleCallback(runDiagnostics, { timeout: 7000 });
      return;
    }
    if (typeof window.setTimeout === "function") {
      window.setTimeout(runDiagnostics, 2600);
      return;
    }
  }
...
const profileIdentityRuntimeCluster = createProfileIdentityRuntimeCluster({
  ...
  firebaseApi: {
    ...
    getDocFromCacheFn: getDocFromCache,
    getDocsFn: getDocs,
...
const INLINE_LUCIDE_ICON_NODES = Object.freeze({
  ...
  // Der Zbulo-Filter steht in der ersten Bildschirmzeile - das Symbol muss
  // inline vorliegen, sonst bleibt der Knopf leer, solange Lucide nachlaedt.
  "sliders-horizontal": Object.freeze([["line", { x1: "21", x2: "14", y1: "4", y2: "4" }], ["line", { x1: "10", x2: "3", y1: "4", y2: "4" }], ["line", { x1: "21", x2: "12", y1: "12", y2: "12" }], ["line", { x1: "8", x2: "3", y1: "12", y2: "12" }], ["line", { x1: "21", x2: "16", y1: "20", y2: "20" }], ["line", { x1: "12", x2: "3", y1: "20", y2: "20" }], ["line", { x1: "14", x2: "14", y1: "2", y2: "6" }], ["line", { x1: "8", x2: "8", y1: "10", y2: "14" }], ["line", { x1: "16", x2: "16", y1: "18", y2: "22" }]]),
