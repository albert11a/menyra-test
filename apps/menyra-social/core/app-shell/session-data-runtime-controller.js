...
export function createSessionDataRuntimeController({
  ...
  function resetUserScopedState() {
    ...
    state.__authBackgroundBusinessRestaurant = null;
    state.__authBusinessReconcilePending = false;
    state.__authBusinessReconcileUid = "";
    state.__profilePostsOwnerType = "";
    state.__profilePostsWarmupPendingCount = 0;
    state.__profilePostsWarmupInFlight = false;
