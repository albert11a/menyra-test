...
import { createFeedSearchMapRouteRuntime } from "./feed-search-map-runtime.js";
...
export function createAppControllerBridge({
  ...
  const deeplinkFlowController = createDeeplinkFlowControllerCore({
    ...
    isPendingProfileAlreadyOpen: ({ pendingProfileRestaurantId = "" } = {}) => deeplink.isPendingProfileAlreadyOpenCore({
      ...
      currentProfileCanonicalRestaurantId: deeplink.state.profileView?.profile?.canonicalRestaurantId || "",
      currentProfilePublicSlug: deeplink.state.profileView?.profile?.publicSlug || "",
      currentProfileLandingSlug: deeplink.state.profileView?.profile?.landingSlug || "",
      currentProfileHandle: deeplink.state.profileView?.profile?.handle || "",
      currentRoutePayload: deeplink.state.profileView?.routePayload || null,
  ...
  const feedSearchMapRouteRuntime = createFeedSearchMapRouteRuntime({
    feed: {
  ...
  const bridgeApi = {
    ...
    renderHomeView: feedSearchMapBridge.renderHomeView,
    renderFeedView: feedSearchMapBridge.renderFeedView,
    renderStoryItem: feedSearchMapBridge.renderStoryItem,
    renderStoriesRow: feedSearchMapBridge.renderStoriesRow,
    renderFeedItem: feedSearchMapBridge.renderFeedItem,
    renderFeedList: feedSearchMapBridge.renderFeedList,
    patchFeedList: feedSearchMapBridge.patchFeedList,
    patchStoriesRow: feedSearchMapBridge.patchStoriesRow,
    updateFeedDom: feedSearchMapBridge.updateFeedDom,
    bindFeedDelegation: feedSearchMapBridge.bindFeedDelegation,
    ...
    buildRestaurantLocations: feedSearchMapBridge.buildRestaurantLocations,
    ensureLeafletLoaded: feedSearchMapBridge.ensureLeafletLoaded,
    cleanupLeaflet: feedSearchMapBridge.cleanupLeaflet,
    updateMapSheet: feedSearchMapBridge.updateMapSheet,
    initLeafletIfNeeded: feedSearchMapBridge.initLeafletIfNeeded,
    mapLocate: feedSearchMapBridge.mapLocate,
    renderMapView: feedSearchMapBridge.renderMapView,
    buildLocalBusinessResults: feedSearchMapBridge.buildLocalBusinessResults,
    handleSearchInput: feedSearchMapBridge.handleSearchInput,
    renderSearchView: feedSearchMapBridge.renderSearchView,
    refreshSearchView: feedSearchMapBridge.refreshSearchView
  };
