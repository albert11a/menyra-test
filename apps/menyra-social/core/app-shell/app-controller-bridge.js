...
export function createAppControllerBridge({
  ...
  const profileOpenFlowController = createProfileOpenFlowControllerCore({
    ...
    ensureMenuDataForProfile: (profileValue) => profile.ensureMenuDataForProfile(profileValue),
    ensureFocusDataForProfile: (profileValue) => profile.ensureFocusDataForProfile(profileValue),
    ...
    businessProfileCache: profile.businessProfileCache,
