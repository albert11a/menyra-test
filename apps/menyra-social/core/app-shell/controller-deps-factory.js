...
export function buildAppShellRuntimeControllerDeps({
  ...
  return {
    ...
    loadUserScopedPersistedFn: loadUserScopedPersisted,
    safeStorageObj: safeStorage,
    profileKeyFn: profileKey,
...
export function createBridgeShellBootstrapBundle({
  ...
  const bridgeBindings = {
    ...
    openLeadModal: bridgeApi.openLeadModal,
    closeLeadModal: bridgeApi.closeLeadModal,
    openCustomerModal: bridgeApi.openCustomerModal,
    closeCustomerModal: bridgeApi.closeCustomerModal,
  ...
  const createShellRuntimeController = () => createAppShellRuntimeController(buildAppShellRuntimeControllerDeps({
    ...
    hydrateLeadGeoFieldsFromCoords,
    refineLeadLocationAddressIndex,
    openLeadModal: bridgeBindings.openLeadModal,
    openCustomerModal: bridgeBindings.openCustomerModal,
    closeStaffEditor,
    openStaffEditor,
    syncStaffDerivedEmailField,
    normalizeCeoCountry,
