export function createSelfProfileRuntimeController({
  ...
  function normalizeBusinessProfile(rest = {}, user) {
    ...
    return {
      ...
      tiktok: rest?.tiktok || rest?.tikTok || "",
      tiktokUrl: rest?.tiktokUrl || rest?.tikTokUrl || "",
      titleImageUrl: rest?.titleImageUrl || rest?.coverImageUrl || rest?.coverUrl || rest?.heroUrl || "",
      coverImageUrl: rest?.coverImageUrl || rest?.titleImageUrl || "",
      coverUrl: rest?.coverUrl || rest?.titleImageUrl || "",
      heroUrl: rest?.heroUrl || rest?.titleImageUrl || "",
      coverImages: Array.isArray(rest?.coverImages) ? rest.coverImages : [],
  ...
  function applyLiveBusinessProfileSnapshot(restData = {}, restaurantId = "") {
    ...
    const seed = {
      ...
      instagramUrl: state.userProfile?.instagramUrl || "",
      tiktok: state.userProfile?.tiktok || "",
      tiktokUrl: state.userProfile?.tiktokUrl || "",
      titleImageUrl: state.userProfile?.titleImageUrl || "",
      coverImageUrl: state.userProfile?.coverImageUrl || "",
      coverUrl: state.userProfile?.coverUrl || "",
      heroUrl: state.userProfile?.heroUrl || "",
      coverImages: Array.isArray(state.userProfile?.coverImages) ? state.userProfile.coverImages : [],
