...
test("Heart gibt den Prompt aus, der hier liegt", () => {
  ...
  assert.match(lies("apps/mnyra-heart/heart.js"), /'\/docs\/lifeskin-prompt-v9-pa-foto\.txt' : '\/docs\/lifeskin-prompt-v9\.txt'/);
  ...
  assert.match(lies("scripts/build-vercel-static-output.mjs"), /docs\/lifeskin-prompt-v9-pa-foto\.txt/);
  assert.match(lies("scripts/build-vercel-static-output.mjs"), /docs\/lifeskin-prompt-v9\.txt/,
