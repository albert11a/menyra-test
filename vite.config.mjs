...
// Passive bundle preparation only:
// - current apps/menyra-social/index.html still loads the raw source entries
// - generated files live below apps/menyra-social/bundled/
// - only Firebase is manually chunked; existing dynamic imports define feature chunk boundaries
// - switch production only after manual network, QR, cart, checkout, PWA, and fallback verification
