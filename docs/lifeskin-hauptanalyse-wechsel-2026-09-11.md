...
**Der Briefkopf trägt die Farbe der Browserleiste.** `--kopf: #171c1f` ist aus einem Screenshot der Instagram-In-App-Leiste ausgemessen (einheitlich über Statusleiste, Adressleiste und untere Kante), nicht geschätzt — und von dort kommt fast jeder Besucher. Das Band geht über die **volle Breite** und berührt die Ecke; ein Punkt Papier daneben wäre genau die Kante, die es vermeiden soll. Der Inhalt darin bleibt über das Polster auf der Lesebreite. Die Höhe ist von 116/94/87 px auf **64/58/54 px** gefallen: Darunter stehen Befund und Diagnose, und was davon auf den ersten Bildschirm passt, entscheidet diese Zahl mit. Auf dem Band steht helle Schrift, im Fuß bleibt dieselbe Marke grün, und im Druck bleibt der Kopf hell.

**Der Seitengrund bleibt Papier.** Der Briefkopf ist ein Band am oberen Rand, nicht die Fläche der Seite: Ginge der Grund mit, wäre unten die Kaufleiste wieder die falsche Farbe. In iOS Safari lässt sich deshalb nur eine der beiden Kanten nahtlos machen — `theme-color` färbt obere und untere Leiste gemeinsam. Die Wahl fiel auf unten, weil der In-App-Browser von Instagram seine eigene dunkle Leiste zeichnet und `theme-color` dort ohnehin nicht greift; oben trägt stattdessen der Briefkopf selbst die passende Farbe.
