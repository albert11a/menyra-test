...
- `200 / concurrency 25`: `No-Go` (aktuell `94%`, Ziel `>=99%`)
...
3. Restliche Checkout-/CTA-Fehlerpfade auf `>=99%` Passrate bringen und denselben 200er Lauf erneut fahren.
