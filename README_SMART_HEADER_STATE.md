...
- Beim App-Start stehen die Tabs immer offen: die erste Bindung von `initMainHeaderTabsRuntime()` setzt eine mitgebrachte Scroll-Position einmalig zurueck und erzwingt den offenen Zustand (`mainHeaderTabsBootSyncPending`).
