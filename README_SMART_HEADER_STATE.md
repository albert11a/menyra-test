...
- Ganz nach oben gescrollt macht die Zeile wieder auf: dort ist ihr Platz, und niemand sucht am Seitenanfang einen Pfeil, um etwas zurueckzuholen, das dort sowieso hingehoert. Ausgeloest wird das nur beim **Ankommen** von weiter unten (`previous > MAIN_HEADER_TABS_TOP_EPS_PX`) - sonst wuerde ein Zumachen am Seitenanfang im selben Atemzug wieder aufgehen.
